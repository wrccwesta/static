...
(() => {
    var t, e, i, s = {
            6554: (t, e, i) => {
                ...
                class y {
                    static add() {
                        for (var t of y.supportedFontExtensions) v.kC.setExtensionLoadType(t, v.kC.LOAD_TYPE.XHR), v.kC.setExtensionXhrType(t, v.kC.XHR_RESPONSE_TYPE.BUFFER)
                    }
                    static use(t, e) {
                        y.supportedFontExtensions.some((e => t.extension.endsWith(e))) ? y.loadFromBuffer(t).finally((() => e())) : e()
                    }
                    static loadFromBuffer(t) {
                        var e, i, s, o, n, a, h, r, l, d, c, u, p, g, m, A, b, v, f, w = null !== (e = null === (i = t.metadata) || void 0 === i || null === (s = i.font) || void 0 === s ? void 0 : s.family) && void 0 !== e ? e : t.name;
                        ...
                        }, null === (m = t.metadata) || void 0 === m || null === (A = m.font) || void 0 === A ? void 0 : A.testString, null !== (b = null === (v = t.metadata) || void 0 === v || null === (f = v.font) || void 0 === f ? void 0 : f.timeout) && void 0 !== b ? b : t.timeout)
                    }
                ...
                var f = i(9900),
                    ...
                    B = S.b_,
                    C = null === S.Q3 || void 0 === S.Q3 ? void 0 : S.Q3.ticker,
                    P = {
                        Linear: S.bJ,
                        Back: S.eJ,
                        Elastic: S.tQ,
                ...
                class W {
                    static pre(t, e) {
                        t && W.supportedSoundExtensions.includes(t.extension) ? (t.load = function(t) {
                            ...
                            }), this.type = v.kC.TYPE.AUDIO, this.loadType = v.kC.LOAD_TYPE.AUDIO, this._setFlag(v.kC.STATUS_FLAGS.LOADING, !0), this.onStart.dispatch(this), this.data.on("loaderror", this._boundOnError, !1), this.data.on("load", this._boundComplete, !1), this.sound = this.data))
                        }, t.complete = function() {
                            var t;
                            ...
                            this._setFlag(v.kC.STATUS_FLAGS.COMPLETE, !0), this._setFlag(v.kC.STATUS_FLAGS.LOADING, !1);
                ...
                }(0, n.Z)(W, "extension", c.n.Loader), (0, n.Z)(W, "supportedSoundExtensions", ["mp3"]);
                var M, F = i(1293),
                    I = i(9534),
                    D = i(1162),
                    L = i(1368),
                ...
                F.Xd.BLEND_ADD_UNITY = !0, (0, F.Gu)(I.SpineBase.prototype),
                    function(t) {
                ...
                class V {
                    ...
                    readSkeletonData(t, e) {
                        ...
                        var s = i.readString(),
                            o = _(s),
                            n = null;
                        if (o === M.VER38 && (n = new j.SkeletonBinary(new j.AtlasAttachmentLoader(t))), (i = new I.BinaryInput(e)).readInt32(), i.readInt32(), (o = _(s = i.readString())) !== M.VER40 && o !== M.VER41 || (n = new N.SkeletonBinary(new N.AtlasAttachmentLoader(t))), !n) {
                ...
                class z {
                    ...
                    readSkeletonData(t, e) {
                        var i = e.skeleton.spine,
                            s = _(i),
                            o = null;
                        if (s === M.VER37 && (o = new L.SkeletonJson(new L.AtlasAttachmentLoader(t))), s === M.VER38 && (o = new j.SkeletonJson(new j.AtlasAttachmentLoader(t))), s !== M.VER40 && s !== M.VER41 || (o = new N.SkeletonJson(new N.AtlasAttachmentLoader(t))), !o) {
                ...
                var H = i(512),
                    ...
                    it = i(798),
                    st = i(5277);
                u.TC.nextRoundedRectBehavior = !0, A.xv.nextLineHeightBehavior = !0, c.R.add(p.bx, g.B9, d.Bv, a.c, h.Q, r.T, l.O, b.vl, m.o, G, y, W), window.PIXI = s;
                var ot = i(3233),
                    nt = i.n(ot);
                ...
                class Bt extends st.EventEmitter {
                    constructor(t) {
                        super(), (0, n.Z)(this, "loader", new v.aN), this.device = t, this.loader.onError.add((t => this.emit("error", t))), this.loader.onComplete.add((t => this.emit("complete", t)))
                    }
                    load(t) {
                        var e = this;
                ...
                class Vt {
                    ...
                    set(t, e) {
                        _t().set("".concat(this.prefix, ":").concat(t), e)
                    }
                    get(t, e) {
                        return _t().get("".concat(this.prefix, ":").concat(t), e)
                    }
                    clear() {
                        _t().clearAll()
                    }
                ...
                class ye extends(Gt(Y.W2, {
                    ...
                    constructor() {
                        super(), (0, n.Z)(this, "name", "StopItemFeatureBonus"), (0, n.Z)(this, "state", "inactive"), (0, n.Z)(this, "checkbox", void 0), (0, n.Z)(this, "onClickCheckbox", new(x())), (0, n.Z)(this, "onChange", new(x())), this.checkbox = this.addChild(new pe("AutoPlaySettingsStopCondCheckboxFeatureBonus")), this.checkbox.onClick.add((() => {
                ...
                class Ee extends A.xv {
                    ...
                    updateText() {
                        if (this.withPrivateMembers().dirty) {
                            ...
                            for (var y = m + g, f = [], w = 0; w < s.length; w++) {
                                var x = s[w],
                                    S = void 0;
                                ...
                                for (var k = 0; k < x.length; k++) {
                                    ...
                                    switch (B.valign) {
                                        ...
                                        case "bottom":
                                            ...
                                            break;
                                        default:
                                            Z += a[w] - P.ascent - B.valign
                                    }
                                    if (0 === B.letterSpacing) f.push({
                                        text: C,
                                        style: B,
                                        x: S,
                                        y: Z,
                                        ...
                                        for (var R = 0; R < C.length; R++) {
                                            (R > 0 || k > 0) && (S += B.letterSpacing / 2);
                                            var W = this.context.measureText(C.charAt(R)).width;
                                            f.push({
                                                text: C.charAt(R),
                                                style: B,
                                                x: S,
                                                ...
                                                descent: P.descent,
                                                tag: O
                                            }), S += W, (R < C.length - 1 || k < x.length - 1) && (S += B.letterSpacing / 2)
                                        }
                                    }
                                }
                                y += a[w] - n[w]
                            ...
                            })), Ee.debugOptions.objects.enabled && (Ee.debugOptions.objects.bounding && (this.context.fillStyle = Ee.debugOptions.objects.bounding, this.context.beginPath(), this.context.rect(0, 0, b, v), this.context.fill()), Ee.debugOptions.objects.text && (this.context.fillStyle = "#ffffff", this.context.strokeStyle = "#000000", this.context.lineWidth = 2, this.context.font = "8px monospace", this.context.strokeText("".concat(b.toFixed(2), "x").concat(v.toFixed(2)), 0, 8, b), this.context.fillText("".concat(b.toFixed(2), "x").concat(v.toFixed(2)), 0, 8, b))), this.updateTexture()
                        }
                    }
                    wordWrap(t) {
                        var e = "",
                ...
                class We extends(Gt(Y.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "content", void 0), this.title = this.addChild(new Re(this.game.i18n.t("GameRulesAdvancedAutoPlayTitle"))), this.content = this.addChild(new Ze(this.game.i18n.t("GameRulesAdvancedAutoPlayContent")))
                    }
                    resize() {
                ...
                class Me extends(Gt(Y.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "content", void 0), this.title = this.addChild(new Re(this.game.i18n.t("GameRulesAutoPlayTitle"))), this.content = this.addChild(new Ze(this.game.i18n.t("GameRulesAutoPlayContent")))
                    }
                    resize() {
                        this.content.position.set(0, this.title.y + this.title.height + 30)
                    }
                ...
                class De extends(Gt(Y.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "gameName", void 0), (0, n.Z)(this, "gameTRTP", void 0), this.title = this.addChild(new Re(this.game.i18n.t("GameRulesGeneralTitle"))), this.gameName = this.addChild(new Ze(this.game.config.get("gameName")));
                ...
                class je extends(Gt(Y.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "content", void 0), this.title = this.addChild(new Re(this.game.i18n.t("GameRulesInterfaceTitle"))), this.content = this.addChild(new Ze(this.game.i18n.t("GameRulesInterfaceContent"))), this.addItems()
                    }
                    addItems() {
                        this.addChild(new Le(this.game.i18n.t("GameRulesInterfaceSpin"), this.game.loader.getAsset("gameRulesButtonSpin"), "itemSpin")), this.addChild(new Le(this.game.i18n.t("GameRulesInterfaceMenu"), this.game.loader.getAsset("iconMenu"), "itemMenu"));
                        var t = new Le(this.game.i18n.t("GameRulesInterfaceQuickSpin"), this.game.loader.getAsset("iconQuickSpin"), "itemQuickSpin");
                        this.game.config.get("quickSpin.available", !0) && this.addChild(t);
                        var e = new Le(this.game.i18n.t("GameRulesInterfaceAutoPlay"), this.game.loader.getAsset("iconAuto"), "itemAutoPlay");
                        this.game.config.get("autoPlay.available", !0) && this.addChild(e), this.addChild(new Le(this.game.i18n.t("GameRulesInterfaceBetLevel"), this.game.loader.getAsset("ex" === this.game.i18n.language ? "gameRulesButtonPlayLevel" : "gameRulesButtonBetLevel"), "itemBetLevel")), this.addChild(new Le(this.game.i18n.t("GameRulesInterfaceWin"), this.game.loader.getAsset("gameRulesItemWin"), "itemWin")), this.game.config.get("balanceHide", !1) || this.addChild(new Le(this.game.i18n.t("GameRulesInterfaceBalance"), this.game.loader.getAsset("gameRulesItemBalance"), "itemBalance")), this.addChild(new Le(this.game.i18n.t("GameRulesInterfaceSound"), this.game.loader.getAsset("gameRulesButtonSound"), "itemSound"))
                    }
                    resize() {
                        var t = 0;
                        this.children.forEach((e => {
                ...
                class _e extends(Gt(Y.W2)) {
                    ...
                    addSections() {
                        this.content.addChild(new De), this.content.addChild(new je), this.content.addChild(new Ne), this.addAutoPlaySection(), this.content.addChild(new Ie), this.content.addChild(new Fe), this.content.addChild(new Ue)
                    }
                    addAutoPlaySection() {
                        this.game.config.get("autoPlay.available", !0) && (this.content.addChild(new Me), this.content.addChild(new We))
                    }
                    open() {
                ...
                class He extends(Gt(Y.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "Menu"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "contentItems", void 0), (0, n.Z)(this, "bottom", void 0), (0, n.Z)(this, "items", void 0), (0, n.Z)(this, "homeButton", void 0), (0, n.Z)(this, "closeButton", void 0), (0, n.Z)(this, "bottomBackgroundTexture", void 0), (0, n.Z)(this, "bottomBackgroundMobileTexture", void 0), (0, n.Z)(this, "spaceKey", void 0), (0, n.Z)(this, "currentIndex", 0), (0, n.Z)(this, "onClickHome", void 0), (0, n.Z)(this, "onClickClose", void 0), this.visible = !1, this.interactive = !0, this.bottomBackgroundTexture = d.xE.from(Qt), this.bottomBackgroundMobileTexture = d.xE.from(Yt), this.overlay = this.addChild(new $t), this.contentItems = this.addChild(new Y.W2), this.bottom = this.addChild(new tt.j(this.bottomBackgroundMobileTexture)), this.items = this.addChild(new Y.W2), this.homeButton = this.addChild(new ze), this.closeButton = this.addChild(new qt), this.closeButton.onClick.add((() => this.close())), this.spaceKey = this.game.keyboard.register(this.game.keyboard.KEY_CODE.Escape), this.spaceKey.onPress.add(this.close, this), this.spaceKey.disable()
                    }
                    get opened() {
                        return this.visible
                    }
                ...
                class ti extends(Gt(Y.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "state", void 0), (0, n.Z)(this, "textBet", void 0), (0, n.Z)(this, "textWin", void 0), (0, n.Z)(this, "textBalance", void 0), (0, n.Z)(this, "textFreeRound", void 0), (0, n.Z)(this, "textFree", void 0), (0, n.Z)(this, "textTotalWin", void 0), (0, n.Z)(this, "textBonus", void 0), (0, n.Z)(this, "delimiter", void 0), this.state = qe.Normal, this.textBet = new Ee("", Xe(Xe({}, Je), {}, {
                            default: Xe(Xe({}, Je.default), {}, {
                                align: "left"
                            })
                        })), this.textBet.anchor.set(0, 0), this.textWin = new Ee("", Je), this.textWin.anchor.set(.5, 0), this.textBalance = new Ee("", Xe(Xe({}, Je), {}, {
                            default: Xe(Xe({}, Je.default), {}, {
                                align: "right"
                            })
                        })), this.textBalance.anchor.set(1, 0), this.textFreeRound = new Ee("", Xe(Xe({}, Je), {}, {
                            default: Xe(Xe({}, Je.default), {}, {
                                align: "center",
                                wordWrap: !0,
                                wordWrapWidth: 300
                            })
                        })), this.textFreeRound.anchor.set(1, 1), this.textFree = new Ee("", Xe(Xe({}, $e), {}, {
                            default: Xe(Xe({}, $e.default), {}, {
                                fontSize: 30,
                                wordWrapWidth: 340
                            })
                        })), this.textFree.anchor.set(0, 1), this.textTotalWin = new Ee("", Xe(Xe({}, $e), {}, {
                            default: Xe(Xe({}, $e.default), {}, {
                                fontFamily: "Avenir-Bold",
                                fill: this.game.config.get("colors.primary"),
                                fontSize: 30,
                        ...
                        })), this.textTotalWin.anchor.set(.5, 1), this.textBonus = new Ee("", Xe(Xe({}, $e), {}, {
                            default: Xe(Xe({}, $e.default), {}, {
                                fontSize: 27,
                                wordWrapWidth: 340
                            })
                ...
                class ai {
                    constructor(t) {
                        (0, n.Z)(this, "watcher", void 0), (0, n.Z)(this, "enabled", !1), (0, n.Z)(this, "onToggle", new(x())), (0, n.Z)(this, "onTryEnable", new(x())), this.config = t, this.watcher = new ni(t)
                    }
                    get available() {
                ...
                const Ri = class extends Lt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupFreeRound"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "icon", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContinue", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new $t, this.content = new Y.W2, this.icon = new Pi(wi), this.icon.anchor.x = .5, this.title = new Zi(this.game.i18n.t("PopupFreeRoundStartTitle")), this.title.anchor.x = .5, this.message = new Ti("", {
                            wordWrap: !0,
                            wordWrapWidth: 600
                ...
                const Wi = class extends Lt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupMaxLimit"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContinue", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new $t(.7), this.content = new Y.W2, this.background = new tt.j(this.game.loader.getAsset(ki)), this.background.anchor.set(.5), this.background.interactive = !0, this.background.name = "PopupBackground", this.title = new Zi(this.game.i18n.t("PopupMaxLimitTitle")), this.title.anchor.x = .5, this.message = new Ti(this.game.i18n.t("PopupMaxLimitMessage"), {
                            wordWrap: !0
                ...
                const Mi = class extends Lt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupNetworkError"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "icon", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionReload", void 0), (0, n.Z)(this, "_resolver", null), this.overlay = this.addChild(new $t), this.content = this.addChild(new Y.W2), this.icon = new Pi(xi), this.icon.anchor.x = .5, this.title = new Zi(this.game.i18n.t("PopupNetworkErrorTitle"), {
                            align: "center"
                        }), this.title.anchor.x = .5, this.message = new Ti(this.game.i18n.t("PopupNetworkErrorMessage"), {
                            fontSize: 36
                ...
                class Fi extends Lt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupQuickSpin"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionEnable", void 0), (0, n.Z)(this, "actionClose", void 0), (0, n.Z)(this, "escKey", void 0), (0, n.Z)(this, "enterKey", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new $t(.7), this.content = new Y.W2, this.background = new tt.j(this.game.loader.getAsset(ki)), this.background.anchor.set(.5), this.background.interactive = !0, this.background.name = "PopupBackground", this.title = new Zi(this.game.i18n.t("PopupQuickSpinTitle")), this.title.anchor.x = .5, this.message = new Ti(this.game.i18n.t("PopupQuickSpinMessage"), {
                            fontSize: 35,
                            wordWrap: !0,
                            wordWrapWidth: 600
                ...
                const Ii = class extends Lt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupRestore"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "icon", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContinue", void 0), (0, n.Z)(this, "resolver", null), this.overlay = this.addChild(new $t), this.content = this.addChild(new Y.W2), this.icon = new Pi(wi), this.icon.anchor.x = .5, this.message = new Ti(this.game.i18n.t("PopupRestoreMessage"), {
                            wordWrap: !0,
                            wordWrapWidth: 320
                        }), this.message.anchor.x = .5, this.actionContinue = new Ci(this.game.i18n.t("PopupActionContinue"), {
                            fill: 16777215
                ...
                const Li = class extends Lt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupSound"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "icon", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContainer", void 0), (0, n.Z)(this, "actionYes", void 0), (0, n.Z)(this, "actionNo", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new $t, this.content = new Y.W2, this.icon = new Pi(Si), this.icon.anchor.x = .5, this.message = new Ti(this.game.i18n.t("PopupSoundMessage"), {
                            wordWrap: !0
                ...
                const ji = class extends Lt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupSpendingBudget"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContinue", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new $t(.7), this.content = new Y.W2, this.background = new tt.j(this.game.loader.getAsset(ki)), this.background.anchor.set(.5), this.background.interactive = !0, this.background.name = "PopupBackground", this.title = new Zi(this.game.i18n.t("PopupSpendingBudgetTitle")), this.title.anchor.x = .5, this.message = new Ti(this.game.i18n.t("PopupSpendingBudgetMessage"), {
                            wordWrap: !0
                        }), this.message.anchor.x = .5, this.actionContinue = new Ci(this.game.i18n.t("PopupActionContinue"), {
                            fill: 10066329
                        }), this.actionContinue.anchor.x = .5, this.game.interaction.out(this.actionContinue, (() => this.actionContinue.style.fill = 10066329)), this.game.interaction.hover(this.actionContinue, (() => this.actionContinue.style.fill = 16777215)), this.game.interaction.click(this.actionContinue, (() => this.hide())), this.content.addChild(this.title), this.content.addChild(this.message), this.content.addChild(this.actionContinue), this.addChild(this.overlay), this.addChild(this.background), this.addChild(this.content)
                ...
                class Ui extends Lt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupWilds"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionEnable", void 0), (0, n.Z)(this, "actionClose", void 0), (0, n.Z)(this, "escKey", void 0), (0, n.Z)(this, "spaceKey", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new $t(.7), this.content = new Y.W2, this.background = new tt.j(this.game.loader.getAsset(ki)), this.background.anchor.set(.5), this.background.interactive = !0, this.background.name = "PopupBackground", this.title = new Zi(this.game.i18n.t("PopupWildsTitle"), {
                            ...
                            align: "center"
                        }), this.title.anchor.x = .5, this.message = new Ti(this.game.i18n.t("PopupWildsMessage"), {
                            fontSize: 35,
                            wordWrap: !0,
                            wordWrapWidth: 600
                ...
                const _i = class extends Lt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupZeroBalance"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContinue", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new $t(.7), this.content = new Y.W2, this.background = new tt.j(this.game.loader.getAsset(ki)), this.background.anchor.set(.5), this.background.interactive = !0, this.background.name = "PopupBackground", this.title = new Zi(this.game.i18n.t("PopupZeroBalanceTitle")), this.title.anchor.x = .5, this.message = new Ti(this.game.i18n.t("PopupZeroBalanceMessage"), {
                            wordWrap: !0
                        }), this.message.anchor.x = .5, this.actionContinue = new Ci(this.game.i18n.t("PopupActionContinue"), {
                            fill: 10066329
                        }), this.actionContinue.anchor.x = .5, this.game.interaction.out(this.actionContinue, (() => this.actionContinue.style.fill = 10066329)), this.game.interaction.hover(this.actionContinue, (() => this.actionContinue.style.fill = 16777215)), this.game.interaction.click(this.actionContinue, (() => this.hide())), this.content.addChild(this.title), this.content.addChild(this.message), this.content.addChild(this.actionContinue), this.addChild(this.overlay), this.addChild(this.background), this.addChild(this.content)
                ...
                const Qi = [...[{
                    ...
                    url: "assets/audio/bonusUpdate.mp3",
                    name: "bonusUpdate",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"],
                        audioMetadata: {
                    ...
                    url: "assets/audio/stickyAppear.mp3",
                    name: "stickyAppear",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"],
                        audioMetadata: {
                    ...
                    url: "assets/images/background/bgIntro.jpg",
                    name: "bgIntro",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                    ...
                    url: "assets/images/background/grid.png",
                    name: "grid",
                    metadata: {
                        platform: ["desktop", "phone", "tablet"]
                    }
                    ...
                    url: "assets/images/labels/textFreeRespin.png",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    ...
                    url: "assets/images/effects/grid/skeleton.json",
                    name: "gridAnimation",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                    ...
                    url: "assets/images/effects/symbols/symbolsMagic/skeleton.json",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    ...
                    url: "assets/images/scale/texture.json",
                    name: "scale",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                        ...
                        layout: {
                            ...
                            default: [{
                                ...
                                animation: {
                                    ...
                                    skin: "pinkScullNoWord"
                                }
                            }, {
                                textureAtlas: "symbols_static",
                                assetName: "goldScullNoWord",
                                animation: {
                                    assetName: "symbolAnimation",
                                    effectName: {
                                        normal: "win",
                                    ...
                                    skin: "goldScullNoWord"
                                }
                            }, {
                                textureAtlas: "symbols_static",
                                assetName: "violetScull",
                                animation: {
                                    assetName: "symbolAnimation",
                                    effectName: {
                                        normal: "win",
                ...
                const ts = {
                    init() {
                        function t(t) {
                            var e = nt()(t, "feature", ""),
                                i = nt()(t, "bonus.multiplier", 0),
                                s = nt()(t, "bonus.modificator", 0),
                                o = nt()(t, "bonuses", []);
                            Nt.store.set("bonus:bonuses", o), Nt.store.set("bonus:finalChance", nt()(t, "finalChance.pos", [])), Nt.store.set("bonus:finalChanceCount", nt()(t, "finalChance.count", 0)), Nt.store.set("bonus:bonus", nt()(t, "bonus", !1)), Nt.store.set("bonus:win", nt()(t, "bonus.win", 0));
                            var n = Nt.store.get("bonus:left", 0);
                            Nt.store.set("bonus:prevLeft", n);
                            var a = nt()(t, "bonus.left", -1),
                                h = nt()(t, "bonus.played", -1);
                            Nt.store.set("bonus:isBonus", "bonus" === e), Nt.store.set("bonus:left", a), Nt.store.set("bonus:played", h), Nt.store.set("bonus:total", nt()(t, "bonus.total", -1)), Nt.store.set("bonus:isStart", 0 === h && "bonus" === nt()(t, "nextAction", "")), Nt.store.set("bonus:isEnd", (0 === a || $i.isBonus()) && "basic" === e), Nt.store.set("bonus:multiplier", i), Nt.store.set("bonus:modificator", s);
                            var r = 0;
                            o.forEach((t => {
                                t.isNew && "string" == typeof t.sym && 1 === t.sym.length && "U" === t.sym.slice(0, 1) && r++
                            })), Nt.store.set("bonus:winAdditional", r > 0), Nt.store.set("bonus:additionalCount", r)
                        }
                        Nt.store.set("bonus:isStart", !1), Nt.store.set("bonus:isEnd", !1), Nt.store.set("bonus:isFree", !1), Nt.store.set("bonus:isBonus", !1), Nt.store.set("bonus:bonus", !1), Nt.store.set("bonus:bonuses", []), Nt.store.set("bonus:left", -1), Nt.store.set("bonus:total", -1), Nt.store.set("bonus:prevLeft", -1), Nt.store.set("bonus:isEnd", !1), Nt.store.set("bonus:multiplier", 0), Nt.store.set("bonus:played", -1), Nt.store.set("bonus:multiplier", 0), Nt.store.set("bonus:modificator", 0), Nt.store.set("bonus:win", 0), Nt.store.set("bonus:finalChance", []), Nt.store.set("bonus:finalChanceCount", 0), Nt.store.set("bonus:winAdditional", !1), Nt.store.set("bonus:additionalCount", 0), Nt.server.on("response:init", t), Nt.server.on("response:spin", t), Nt.server.on("response:buyin", t), Nt.server.on("response:risk", t)
                    }
                };
                var es = [
                        [6, 2, 3],
                ...
                const ss = {
                        init() {
                            function t(t) {
                                var e = nt()(t, "buyin", !1),
                                    i = nt()(t, "risk", !1);
                                Nt.store.set("isRiskNBuy", e || i), (i || e) && (Nt.store.set("risk", i), Nt.store.set("buy", e))
                            }

                            function e(e) {
                                var i = nt()(e, "win", 0),
                                    s = nt()(e, "scatters", !1);
                                Nt.store.set("reward:win", i), Nt.store.set("reward:lines", nt()(e, "lines", [])), Nt.store.set("reward:reels", nt()(e, "reels", e.error ? es : [])), Nt.store.set("reward:nReels", nt()(e, "nReels", e.error ? is : [])), Nt.store.set("reward:preReels", nt()(e, "preSpin.reels", [])), Nt.store.set("reward:bonusReels", nt()(e, "bonusReels", [])), Nt.store.set("reward:scatters", s), Nt.store.set("reward:isWin", i > 0 || s), Nt.store.set("reward:numberWinSymbol", nt()(e, "winSyms", 0)), Nt.store.set("sticky", nt()(e, "sticky", []));
                                var o = nt()(e, "feature", Ki.Basic);
                                Nt.store.set("reward:feature", o), t(e)
                            }
                            ...
                            Nt.store.set("reward:win", 0), Nt.store.set("reward:isWin", !1), Nt.store.set("reward:lines", []), Nt.store.set("reward:reels", []), Nt.store.set("reward:nReels", []), Nt.store.set("reward:preReels", []), Nt.store.set("reward:bonusReels", []), Nt.store.set("reward:numberWinSymbol", 0), Nt.store.set("reward:scatters", !1), Nt.store.set("reward:feature", ""), Nt.store.set("isRiskNBuy", !1), Nt.store.set("risk", !1), Nt.store.set("buy", !1), Nt.store.set("sticky", []), Nt.server.on("response:init", e), Nt.server.on("response:spin", e), Nt.server.on("response:buyin", i), Nt.server.on("response:risk", i)
                        }
                    },
                    os = {
                        init() {
                            Nt.store.set("spin:isSpin", !1), Nt.store.set("spin:isFast", !1), Nt.action.on("spin:start", (function() {
                                var t = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0];
                                Nt.store.get("spin:isSpin") ? t && !Nt.store.get("spin:isFast") && Nt.config.get("quickSpin.available", !0) && (Nt.store.set("spin:isFast", !0), Nt.action.emit("spin:fast")) : (Nt.store.set("spin:isSpin", !0), Nt.state.goTo("spin"))
                            })), Nt.action.on("state:stop_exit", (function() {
                                Nt.store.set("spin:isSpin", !1), Nt.store.set("spin:isFast", !1)
                            }))
                        }
                    },
                    ns = {
                ...
                class as extends R {
                    constructor(t, e, i) {
                        super(t, e, i), (0, n.Z)(this, "backgroundNormal", void 0), (0, n.Z)(this, "backgroundBonus", void 0), (0, n.Z)(this, "bigWin", void 0), (0, n.Z)(this, "clickNormal", void 0), (0, n.Z)(this, "currentWinSound", void 0), (0, n.Z)(this, "giantWin", void 0), (0, n.Z)(this, "spinFast", void 0), (0, n.Z)(this, "spinStart", void 0), (0, n.Z)(this, "twinReels", void 0), (0, n.Z)(this, "wheelStop", void 0), (0, n.Z)(this, "winNormal1", void 0), (0, n.Z)(this, "winNormal2", void 0), (0, n.Z)(this, "winNormal3", void 0), (0, n.Z)(this, "bonusStart", void 0), (0, n.Z)(this, "bonusEnd", void 0), (0, n.Z)(this, "bonusUpdate", void 0), (0, n.Z)(this, "bonusScaleUp", void 0), (0, n.Z)(this, "bonusScaleDown", void 0), (0, n.Z)(this, "bonusTotalWin", void 0), (0, n.Z)(this, "bonusWin", void 0), (0, n.Z)(this, "bonusVars", void 0), (0, n.Z)(this, "bonusMultiplierUpdate", void 0), (0, n.Z)(this, "bonusModificatorUpdate", void 0), (0, n.Z)(this, "respin", void 0), (0, n.Z)(this, "stickyAppear", void 0), (0, n.Z)(this, "bonusWinSymbol", void 0), this.backgroundNormal = this.get("backgroundNormal"), this.backgroundBonus = this.get("backgroundBonus"), this.bonusStart = this.get("bonusStart"), this.bonusEnd = this.get("bonusEnd"), this.winNormal1 = this.get("win_normal_1"), this.winNormal2 = this.get("win_normal_2"), this.winNormal3 = this.get("win_normal_3"), this.bigWin = this.get("bigWin"), this.giantWin = this.get("giantWin"), this.spinStart = this.get("spinStart"), this.spinFast = this.get("spinFast"), this.clickNormal = this.get("clickNormal"), this.wheelStop = this.get("wheelStop"), this.bonusUpdate = this.get("bonusUpdate"), this.bonusScaleUp = this.get("bonusScaleUp"), this.bonusScaleDown = this.get("bonusScaleDown"), this.bonusTotalWin = this.get("bonusTotalWin"), this.bonusWin = this.get("bonusWin"), this.bonusVars = this.get("bonusVars"), this.bonusMultiplierUpdate = this.get("bonusMultiplierUpdate"), this.bonusModificatorUpdate = this.get("bonusModificatorUpdate"), this.respin = this.get("respin"), this.stickyAppear = this.get("stickyAppear"), this.bonusWinSymbol = this.get("bonusWinSymbol"), this.currentWinSound = null, this._setupEvents()
                    }
                    _setupEvents() {
                        Nt.action.on("sound:win", (t => {
                            this.currentWinSound = this["winNormal".concat(t)], this.currentWinSound.play()
                        })), Nt.action.on("sound:bigWin", (() => {
                            this.bigWin.play()
                        })), Nt.action.on("sound:giantWin", (() => {
                            this.bigWin.stop(), this.giantWin.play()
                        })), Nt.action.on("state:spin_enter", this._onSpinEnter, this), Nt.action.on("state:finish_enter", this._onFinishEnter, this), Nt.action.on("sound:spinFast", this._onFastSpin, this), Nt.action.on("wheel:stop_down", this._onWheelStop, this), Nt.action.on("sound:bonus_start", this._onBonusStart, this), Nt.action.on("sound:bonus_stop", this._onbonusEnd, this), Nt.action.on("bonus:select_start", this._onSelectBonusStart, this), Nt.action.on("bonus:select_stop", this._onSelectbonusEnd, this), Nt.action.on("sound:click", this.click, this), Nt.action.on("sound:bonusUpdate", (() => {})), Nt.action.on("sound:scaleUp", (() => {
                            this.bonusScaleUp.play()
                        })), Nt.action.on("sound:scaleDown", (() => {
                            this.bonusScaleDown.play()
                        })), Nt.action.on("sound:bonusTotalWin", (() => {
                            this.bonusTotalWin.play()
                        })), Nt.action.on("sound:bonusWin", (() => {
                            this.bonusWin.play()
                        })), Nt.action.on("sound:bonusVars", (() => {
                            this.bonusVars.play()
                        })), Nt.action.on("sound:bonusMultiplierUpdate", (() => {
                            this.bonusMultiplierUpdate.play()
                        })), Nt.action.on("sound:bonusModificatorUpdate", (() => {
                            this.bonusModificatorUpdate.play()
                        })), Nt.action.on("sound:respin", (() => {
                            this.respin.play()
                        })), Nt.action.on("sound:stickyAppear", (() => {
                            this.stickyAppear.play()
                        })), Nt.action.on("sound:bonusWinSymbol", (() => {
                    ...
                    _onSpinEnter() {
                        this.currentWinSound && (this.currentWinSound.stop(), this.currentWinSound = null), Nt.autoPlay.enabled || $i.isBonus() || this.spinStart.play()
                    }
                    _onWheelStop() {
                        Nt.store.get("spin:isFast", !1) || this.wheelStop.play()
                    }
                    click() {
                    ...
                    _onSelectBonusStart() {
                        this.bonusStart.stop(), this.backgroundBonus.playing() || this.backgroundBonus.fade(2)
                    }
                    _onSelectbonusEnd() {
                ...
                const ys = JSON.parse('{"AutoPlaySettingsStopCondButtonReset":"Reset","AutoPlaySettingsStopCondCheckboxBalance":"If Balance Increases By","AutoPlaySettingsStopCondCheckboxBalanceDrop":"If Balance Decreases By","AutoPlaySettingsStopCondCheckboxFeatureBonus":"If Bonus Game Won","AutoPlaySettingsStopCondCheckboxFeatureFreeSpin":"If Free Spins Won","AutoPlaySettingsStopCondCheckboxWin":"If Win","AutoPlaySettingsStopCondCheckboxWinAny":"Any","AutoPlaySettingsStopCondCheckboxWinBig":"Big","AutoPlaySettingsStopCondCheckboxWinGiant":"Giant","AutoPlaySettingsStopCondTitle":"STOP AUTOPLAY","AutoPlaySettingsSubTitle":"Setup your best autoplay conditions","AutoPlaySettingsTitle":"AUTOPLAY","BetSettingsLines":"LINES\\n<value>%s</value>","BetSettingsTitle":"BET SETTINGS","BetSettingsWays":"WAYS\\n<value>%s</value>","ControlsDesktopAutoPlayStart":"AUTOPLAY","ControlsDesktopAutoPlayStop":"STOP AUTO","ControlsDesktopBalance":"BALANCE%s\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopBet":"BET %s\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopFreeRoundLeft":"FREE ROUND\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopFreeRoundWin":"TOTAL WIN %s\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopFreeRoundWinEmpty":"TOTAL WIN","ControlsDesktopFreeSpinsLast":"FREE SPINS LEFT\\n<delimiter> \\n</delimiter><value>LAST</value>","ControlsDesktopFreeSpinsLeft":"FREE SPINS LEFT\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopLines":"LINES\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopMaxBet":"MAX BET","ControlsDesktopTotalWin":"TOTAL WIN %s\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopWays":"WAYS\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopWin":"WIN %s\\n<delimiter> \\n</delimiter><value>%s</value>","Currency":"CURRENCY\\n<value>%s</value>","GameRulesAdvancedAutoPlayContent":"Advanced autoplay settings are available in the section with standard autoplay settings. You can set the conditions for stopping the game in automatic mode:\\n\\n<bold>if win any/big/giant</bold> - autoplay will be stopped after any/big/giant win\\n\\n<bold>if balance increased by 10%-100%</bold> - autoplay will stop when your balance increases by the selected %\\n\\n<bold>if balance decreased by 10%-100%</bold> - autoplay will be interrupted when your balance decreases by the selected %\\n\\nClick <bold>Reset</bold> to reset all autoplay settings","GameRulesAdvancedAutoPlayTitle":"Advanced Autoplay Settings","GameRulesAutoPlayContent":"Select the number of game rounds to play in automatic mode by pressing the button with the corresponding number, or press the button with the infinity sign to play in automatic mode until the autoplay is manually canceled or until the balance runs out. Your choice must be confirmed with the Start button.","GameRulesAutoPlayTitle":"Autoplay Options","GameRulesBestExperience":"Please note that you can only play one game at a time on each account. Therefore, you cannot play a game on more than one device, or multiple games on the same device simultaneously. Doing so may lead to various errors.\\n\\nFor the best gaming experience, we recommend using the latest version of the relevant software.","GameRulesGeneralRTP":"Theoretical RTP: %s %","GameRulesGeneralTitle":"General Info","GameRulesInterfaceAutoPlay":"Click to go to autoplay menu","GameRulesInterfaceBalance":"Here is your current balance","GameRulesInterfaceBetLevel":"Your current bet and a button to go to the bet size selection menu","GameRulesInterfaceContent":"All buttons of the game interface are listed below. Please note that the appearance and location of the buttons may differ slightly depending on the format in which the game is launched and what feature it is currently in.","GameRulesInterfaceMenu":"Click to access the game menu","GameRulesInterfaceQuickSpin":"Click to enable/disable quick spin","GameRulesInterfaceSound":"Turn game sound on/off and adjust sound volume","GameRulesInterfaceSpin":"Click to start the game round at the current bet. In the desktop version of the game, the button may have an alternative design","GameRulesInterfaceTitle":"Game Interface","GameRulesInterfaceWin":"Here is the win in the current game round","GameRulesSettingsContent":"To go to the settings menu, click the cogwheel icon in the game menu","GameRulesSettingsContentItemBackgroundSound":"<bold>Background music</bold> - turns on/off background music in the game","GameRulesSettingsContentItemFullscreen":"<bold>Full Screen</bold> - enables/disables full screen mode","GameRulesSettingsContentItemGameSound":"<bold>Game sound</bold> - turns on/off the sound effects of the game","GameRulesSettingsContentItemQuickSpin":"<bold>Quick Spin</bold> - turns on/off the function of the accelerated mode of rotation and stop of the reels","GameRulesSettingsTitle":"Game Settings","GameSettingsBackgroundSounds":"Background Music","GameSettingsFullscreen":"Full Screen","GameSettingsGameSounds":"Game Sounds","GameSettingsIntroScreen":"Intro Screen","GameSettingsLeftHand":"Left Hand Mode","GameSettingsQuickSpin":"Quick Spin","GameSettingsRiskFeatureCheckbox":"Risk&Buy","GameSettingsTitle":"GAME SETTINGS","IntroScreenHideButtonText":"Don\'t show next time","IntroScreenLoaderText":"LOADING","MenuDesktopButtonFullscreen":"FULLSCREEN","MenuDesktopButtonHome":"HOME","MenuDesktopButtonPaytable":"PAYTABLE","MenuDesktopButtonQuickspin":"QUICKSPIN","MenuDesktopButtonSound":"SOUND","MenuGameRules":"GAME INFORMATION","MenuMobileBetSettingsTitle":"BET SETTINGS","MenuMobileGameSettingsLeftHand":"Left Hand Mode","MenuMobileGameSettingsQuickspin":"Quick Spin","MenuMobileGameSettingsSounds":"Game Sounds","MenuMobileGameSettingsTitle":"GAME SETTINGS","MenuMobilePaytableTitle":"PAYTABLE","MenuPaytable":"PAYTABLE","MenuSettings":"SETTINGS","NetPositionTitle":"Net Position: %s","PopupActionClose":"Close","PopupActionContinue":"Continue","PopupActionEnable":"Enable","PopupActionNo":"No","PopupActionReload":"Reload","PopupActionYes":"Yes","PopupFreeRoundEndMessage":"The next spins will use your bonus amount","PopupFreeRoundEndTitle":"Free Rounds Finished","PopupFreeRoundLastMessage":"Congratulations, you have\\n last free round","PopupFreeRoundStartMessage":"Congratulations, you have\\n%s free rounds","PopupFreeRoundStartTitle":"Free Rounds Bonus","PopupFreeSpinsButton":"CLICK ANYWHERE TO CONTINUE","PopupFreeSpinsStopDescription":"<value>%s FREE SPINS</value> PLAYED","PopupFreeSpinsStopDescriptionNew":"%s Free Spins played","PopupFreeSpinsTitle":"CONGRATULATIONS","PopupFreeSpinsTitleNew":"CONGRATULATIONS! YOU WON","PopupFreeSpinsTitleRestore":"IN-GAME FEATURE RESTORED!","PopupFreeSpinsWinRestore":"<value>%s FREE SPINS</value> LEFT","PopupFreeSpinsWinRestoreLast":"<value>LAST FREE SPIN</value> LEFT","PopupFreeSpinsWinStart":"YOU WON <value>%s FREE SPINS</value>","PopupFreeSpinsWinStartNew":"%s FREE SPINS","PopupFreeSpinsWinStop":"YOU WON <value>%s</value>","PopupFreeSpinsWinStopNew":"<value>%s</value>","PopupMaxLimitMessage":"Bet exceeded max bet limit.","PopupMaxLimitTitle":"Max limit","PopupNetworkErrorMessage":"Please reload the game.","PopupNetworkErrorTitle":"Connection Lost","PopupQuickSpinMessage":"It seems you prefer to play a bit faster.\\nWould you like to enable Quick Spin?","PopupQuickSpinTitle":"Quick Spin","PopupRestoreMessage":"In-game feature restored!","PopupRiskNBuyContentBuy":"Buy in a feature for %s\\nthat will play at the bet %s","PopupRiskNBuyContentRisk":"Take the risk of winning %s\\nto get a feature at the bet %s","PopupRiskNBuyTitleBuy":"BUY IN FEATURE","PopupRiskNBuyTitleRisk":"RISK FEATURE","PopupSoundMessage":"Play with sound?","PopupSpendingBudgetMessage":"You have reached your play limit.\\nWelcome back later.","PopupSpendingBudgetTitle":"Play limit","PopupUnexpectedErrorMessage":"An unexpected situation.\\nReload the page.","PopupUnexpectedErrorTitle":"Unexpected situation","PopupZeroBalanceMessage":"Please change your BET LEVEL or top up your balance","PopupZeroBalanceTitle":"Insufficient funds","RiskNBuyBuyFor":"BUY FOR %s","RiskNBuyFreeSpinsText":"FREE SPINS","RiskNBuyOnBet":"ON BET %s","RiskNBuySubHeader":"RISK YOUR WIN\\nTO PLAY","StatusBarMobileBalance":"BALANCE %s\\n","StatusBarMobileBet":"BET %s\\n","StatusBarMobileFreeLast":"FREE SPINS LEFT\\n<value>LAST</value>","StatusBarMobileFreeLeft":"FREE SPINS LEFT\\n<value>%s</value>","StatusBarMobileFreePlayed":"FREE SPINS PLAYED\\n","StatusBarMobileFreeRoundLeft":"FREE ROUND\\n","StatusBarMobileTotalWin":"TOTAL WIN %s\\n","StatusBarMobileWin":"WIN %s\\n","TimeElapsedTitle":"Time Elapsed: %s"}'),
                    fs = JSON.parse('{"ControlsDesktopBonusLast":"BONUS SPINS LEFT\\n<delimiter> \\n</delimiter><value>LAST</value>","ControlsDesktopBonusLeft":"BONUS SPINS LEFT\\n<delimiter> \\n</delimiter><value>%s</value>","IntroScreenDescription0":"Each win triggers the Sticky Respin feature","IntroScreenDescription1":"Get a bet multiplier and its modifiers in the Bonus game","IntroScreenDescription2":"Buy the Bonus game or risk your winnings for it","PaytableSectionBetLinesContent1":"Only the highest win per bet line is paid. Bet line wins are paid out from left to right and right to left, starting from the outermost reel. A combination of 5 symbols is paid only once. The payout values are based on the currently selected bet and change proportionally with its changes. The game is played with fixed bet lines. Malfunction voids all pays and plays.","PaytableSectionBetLinesTitle":"Bet lines","PaytableSectionBonusGameContent1":"The Bonus game starts with 3 bonus spins. Each time a winning symbol appears on the screen, the number of bonus spins is reset to 3. The Bonus game will be played on the bet on which it was won by the player.\\n\\nDuring the Bonus game, only the following symbols can appear.","PaytableSectionBonusGameContent2":"Multiplier. Adds a multiplier to the total win multiplier.","PaytableSectionBonusGameContent3":"Super multiplier. Adds a super multiplier to the total win multiplier.","PaytableSectionBonusGameContent4":"Modifier. Multiplies the total win multiplier.","PaytableSectionBonusGameContent5":"Upgrade. Adds 1 to the bonus spins number. The maximum possible number of bonus spins is 5. When the number of bonus spins reaches the maximum, all subsequent Upgrade symbols will turn into Modifier symbols.","PaytableSectionBonusGameContent6":"During the Bonus Game, the symbols don\'t have their own payouts. At the end of the Bonus Game, the total win multiplier is calculated and applied to the total bet.","PaytableSectionBonusGameTitle":"Bonus game","PaytableSectionExtraBonusContent1":"If all reels are filled with winning symbols and there are still bonus spins remaining the Bonus Game will end and the number of remaining bonus spins will be used as a Modifier.","PaytableSectionExtraBonusTitle":"Extra Bonus feature","PaytableSectionPayoutTitle":"Symbol payout values","PaytableSectionRespinContent1":"Any win line or 2 and more Scatter symbols triggers the Sticky Respin feature. Free Respin starts, and all winning symbols remain in their places. The Sticky Respin feature continues as long as new wins appear or until the entire screen is filled with winning symbols. When the Sticky Respin feature ends, the total win for the current spin is calculated.","PaytableSectionRespinTitle":"Sticky Respin feature","PaytableSectionRiskContent1":"The Risk\'n\'Buy feature is offered to the player in the main game after each spin, regardless of whether they win or not. The Risk\'n\'Buy feature will offer to either risk the current win and immediately go to the Bonus game, or buy the Bonus game at the specified cost and immediately go to it.\\n\\nThe player has the freedom to choose whether they want to launch the suggested version of the Risk\'n\'Buy feature or continue to the main game. If they choose to risk their current winnings, these will be deducted from their balance in the form of a bet. If the player decides to buy the Bonus game, the cost of the feature will also be deducted from their balance in the form of a bet. Bonus game earned through the Risk\'n\'Buy feature will be triggered on the same bet that it was received by the player. The Risk’n’Buy feature is not available in autoplay mode.","PaytableSectionRiskTitle":"Risk\'n\'Buy feature","PaytableSectionScatterContent1":"Winnings are paid out if 2 or more Gold Scull Scatter symbols appear anywhere on the reels.\\n3 and more of any Scatter symbols in any combination triggers the Bonus game. The symbols that triggered the Bonus Game go into it, unlocking win multipliers. The Bonus game starts after the end of the Sticky Respin feature.","PaytableSectionScatterTitle":"Scatter symbols","PaytableSectionWildContent1":"Wild symbols substitute for all symbols exсept for Scatter symbols.","PaytableSectionWildTitle":"Wild symbol","PopupBonusDescription":"","PopupBonusTitle":"CONGRATULATIONS","PopupBonusWinStart":"YOU WON <value>THE BONUS GAME</value>","PopupBonusWinStop":"YOU WON <value>%s</value>","PopupBonusWinStopDescription":"<value>%s</value> BONUS SPINS PLAYED","StatusBarMobileBonusLast":"BONUS SPINS LEFT\\n<value>LAST</value>","StatusBarMobileBonusLeft":"BONUS SPINS LEFT\\n<value>%s</value>"}');
                ...
                class ks extends(Gt(Y.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "timeline", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "mulTitle", void 0), (0, n.Z)(this, "mulValue", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "value", void 0), (0, n.Z)(this, "coins", void 0), (0, n.Z)(this, "onPress", void 0), (0, n.Z)(this, "onBeforeEnd", void 0), this.visible = !1, this.interactive = !0, this.onPress = new(x()), this.onBeforeEnd = new(x()), this.game.interaction.click(this, (() => this.onPress.dispatch())), this.timeline = new B, this.content = new Y.W2, this.overlay = new $t(.75), this.mulTitle = new tt.j(this.game.loader.getAsset("assets/images/labels/textTotalMultiplier.png")), this.mulTitle.anchor.set(.5), this.mulTitle.alpha = 0, this.mulValue = new b.Xz("", {
                            fontName: "WinFont"
                        }), this.mulValue.anchor.set(.5), this.mulValue.scale.set(.4), this.mulValue.text = "", this.mulValue.alpha = 0, this.title = new tt.j(this.game.loader.getAsset("assets/images/labels/textBonusWin.png")), this.title.anchor.set(.5), this.title.alpha = 0, this.value = new b.Xz("", {
                            fontName: "WinFont"
                    ...
                    show(t, e) {
                        return this.visible = !0, this.resize(), this.mulValue.text = "X".concat(e), this.mulValue.position.set(this.game.device.desktop || this.game.device.landscape ? -660 : -418, this.game.device.desktop || this.game.device.landscape ? 240 : -70), new Promise((e => {
                            this.timeline.eventCallback("onComplete", (() => {
                                e()
                            })), this.game.action.emit("sound:bonusTotalWin");
                            var i = {
                                coins: 0
                            };
                ...
                class Bs extends(Gt(Y.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "BonusWinText"), (0, n.Z)(this, "multiplierTitleText", void 0), (0, n.Z)(this, "multiplierValueText", void 0), (0, n.Z)(this, "multiplierValue", 0), (0, n.Z)(this, "modTitleText", void 0), (0, n.Z)(this, "modValueText", void 0), (0, n.Z)(this, "modValue", 0), (0, n.Z)(this, "leftCount", void 0), this.leftCount = new b.Xz("", {
                            fontName: "WinFont"
                        }), this.leftCount.scale.set(.3), this.leftCount.text = "", this.visible = !1, this.multiplierTitleText = new Ee("", {
                            default: {
                                fill: "#ffffff",
                                fontFamily: "PT Sans Narrow Bold",
                                fontSize: 40,
                        ...
                        }), this.multiplierTitleText.text = "MULTIPLIER:", this.multiplierTitleText.alpha = 0, this.multiplierValueText = new b.Xz("", {
                            fontName: "WinFont"
                        }), this.multiplierValueText.text = "", this.multiplierValueText.position.set(0, this.multiplierTitleText.height + 20), this.modTitleText = new Ee("", {
                            default: {
                                fill: "#ffffff",
                                fontFamily: "PT Sans Narrow Bold",
                                fontSize: 35,
                        ...
                        }), this.modTitleText.text = "MODIFIER:", this.modTitleText.position.set(0, 200), this.modTitleText.alpha = 0, this.modValueText = new b.Xz("", {
                            fontName: "WinFont"
                        }), this.modValueText.scale.set(.5), this.modValueText.text = "", this.modValueText.position.set(0, this.modTitleText.y + this.modTitleText.height + 5), this.addChild(this.multiplierTitleText, this.multiplierValueText, this.modTitleText, this.modValueText, this.leftCount), this.multiplierValueText.scale.set(.21), this.modValueText.scale.set(.2), this.game.action.on("bonus:select_start", this.show, this)
                    }
                    updateAll() {
                        var t = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
                        ...
                        if ($i.isBonus() || t) {
                            ...
                            this.multiplierTitleText.alpha = s > 0 ? 1 : 0, this.multiplierValueText.text = s > 0 ? "".concat(s) : "", this.multiplierValue = s, this.modTitleText.alpha = o > 0 ? 1 : 0, this.modValueText.text = o > 0 ? "X".concat(o) : "", this.modValue = o
                        }
                    }
                    bonusLeftToModificators() {
                        ...
                        return (0, o.Z)((function*() {
                            ...
                            t.leftCount.text = "".concat(i), yield k.to(t.leftCount, .3, {
                                pixi: {
                                    y: t.modValueText.y,
                                    x: t.modValueText.x
                                },
                            ...
                            }), t.game.action.emit("sound:bonusModificatorUpdate"), yield t.game.helpers.delay(500)
                        }))()
                    }
                    totalWin() {
                        var t = this;
                        return (0, o.Z)((function*() {
                            ...
                            yield t.game.helpers.delay(200), yield k.to(t.modValueText, .6, {
                                pixi: {
                                    y: t.multiplierValueText.y
                                },
                                onComplete: () => {
                                    t.modValueText.text = "", t.modTitleText.alpha = 0
                                }
                            }), i > 0 && t.game.action.emit("sound:bonusMultiplierUpdate"), t.multiplierValueText.text = "".concat(0 === i ? e : i * e), yield t.game.helpers.delay(0 === i ? 0 : 1e3)
                        }))()
                    }
                    reset() {
                        this.multiplierTitleText.alpha = 0, this.multiplierValueText.text = "", this.multiplierValue = 0, this.modTitleText.alpha = 0, this.modValueText.text = "", this.modValue = 0, this.modValueText.position.set(0, this.modTitleText.y + this.modTitleText.height + 5), this.leftCount.text = "", this.leftCount.position.set(-1e3, 600)
                    }
                    resize() {
                        this.game.device.desktop || this.game.device.landscape ? (this.game.leftHand.enabled ? this.position.set(1380, 330) : this.position.set(1420, 380), this.leftCount.scale.set(.3), this.leftCount.position.set(520)) : (this.position.set(70, 940), this.leftCount.scale.set(.6), this.leftCount.position.set(200, 1e3))
                    }
                }
                class Cs extends hi {
                    get dropCoins() {
                ...
                class Ts extends U.PY {
                    ...
                    update(t) {
                        ...
                        if (t > e && (t = e), this.state.update(t), this.state.apply(this.skeleton), this.skeleton) {
                                ...
                                if (l) {
                                    ...
                                    switch (l.type) {
                                        case I.AttachmentType.Region:
                                            ...
                                            d.transform.setFromMatrix(r.bone.matrix), r.currentSprite.color ? c = r.currentSprite.color : (Es[0] = o[0] * r.color.r * u.r, Es[1] = o[1] * r.color.g * u.g, Es[2] = o[2] * r.color.b * u.b, r.currentSprite.tint = st.rgb2hex(Es)), r.currentSprite.blendMode = r.blendMode;
                                            break;
                                        case I.AttachmentType.Mesh:
                                            ...
                                            l.computeWorldVerticesOld(r, r.currentMesh.vertices), r.currentMesh.color ? c = r.currentMesh.color : (Es[0] = o[0] * r.color.r * u.r, Es[1] = o[1] * r.color.g * u.g, Es[2] = o[2] * r.color.b * u.b, r.currentMesh.tint = st.rgb2hex(Es)), r.currentMesh.blendMode = r.blendMode;
                                            break;
                            ...
                            for (var k = this.skeleton.drawOrder, B = null, C = null, P = 0, E = k.length; P < E; P++) {
                                var T = i[k[P].data.index],
                                    O = this.slotContainers[k[P].data.index];
                                if (C || null !== O.parent && O.parent !== this && (O.parent.removeChild(O), O.parent = this), T.currentGraphics && T.getAttachment()) C = T.clippingContainer, B = T.getAttachment(), C.children.length = 0, this.children[P] = O, B.endSlot === T.data && (B.endSlot = null);
                                else if (C) {
                                    var Z = this.tempClipContainers[P];
                                    Z || ((Z = this.tempClipContainers[P] = this.newContainer()).visible = !1), this.children[P] = Z, O.parent = null, C.addChild(O), B.endSlot == T.data && (C.renderable = !0, C = null, B = null)
                ...
                class Zs extends(Gt(Y.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "featureBackground", void 0), (0, n.Z)(this, "bgln", void 0), (0, n.Z)(this, "bglf", void 0), (0, n.Z)(this, "bgpn", void 0), (0, n.Z)(this, "bgpf", void 0), (0, n.Z)(this, "bgIntro", void 0), (0, n.Z)(this, "bglnAnimation1", void 0), (0, n.Z)(this, "bglnAnimation2", void 0), (0, n.Z)(this, "bglfAnimation1", void 0), (0, n.Z)(this, "bglfAnimation2", void 0), (0, n.Z)(this, "animationContainer", void 0), this.background = new tt.j(this.game.loader.getAsset("bgln")), this.featureBackground = new tt.j(this.game.loader.getAsset("bglf")), this.featureBackground.alpha = 0, this.bgln = this.game.loader.getAsset("bgln"), this.bglf = this.game.loader.getAsset("bglf"), this.bgpn = this.game.loader.getAsset("bgpn"), this.bgpf = this.game.loader.getAsset("bgpf"), this.bglnAnimation1 = new Ts(this.game.loader.getAsset("bglnAnimation")), this.bglnAnimation1.play("animation", !0), this.bglnAnimation2 = new Ts(this.game.loader.getAsset("bglnAnimation")), this.bglnAnimation2.play("animation2", !0), this.bglfAnimation1 = new Ts(this.game.loader.getAsset("bglfAnimation")), this.bglfAnimation1.play("animation", !0), this.bglfAnimation1.alpha = 0, this.bglfAnimation2 = new Ts(this.game.loader.getAsset("bglfAnimation")), this.bglfAnimation2.play("animation2", !0), this.bglfAnimation2.alpha = 0, this.bgIntro = new tt.j(this.game.loader.getAsset("bgIntro")), this.bgIntro.visible = !1, this.animationContainer = new Os(1), this.addChild(this.background), this.addChild(this.featureBackground), this.animationContainer.addChild(this.bglnAnimation1), this.animationContainer.addChild(this.bglnAnimation2), this.animationContainer.addChild(this.bglfAnimation1), this.animationContainer.addChild(this.bglfAnimation2), this.addChild(this.animationContainer), this.addChild(this.bgIntro), this.setupEvents()
                    }
                    setupEvents() {
                        var t = this;
                        this.game.action.on("state:setup_enter", (() => {
                            $i.isBonus() && (this.featureBackground.texture = this.game.device.portrait && !this.game.device.desktop ? this.bgpf : this.bglf, this.featureBackground.alpha = 1, this.bglfAnimation1.alpha = 1, this.bglfAnimation2.alpha = 1, this.bglnAnimation1.alpha = 0, this.bglnAnimation2.alpha = 0)
                        })), this.game.action.on("bonus:select_stop", (0, o.Z)((function*() {
                            t.featureBackground.alpha = 0, t.bglfAnimation1.alpha = 0, t.bglfAnimation2.alpha = 0, t.bglnAnimation1.alpha = 1, t.bglnAnimation2.alpha = 1
                        }))), this.game.action.on("bonus:select_start", (0, o.Z)((function*() {
                            0 === t.featureBackground.alpha && k.fromTo(t.featureBackground, .5, {
                                pixi: {
                                    alpha: 0
                                }
                            }, {
                            ...
                            }), t.bglfAnimation1.alpha = 1, t.bglfAnimation2.alpha = 1, t.bglnAnimation1.alpha = 0, t.bglnAnimation2.alpha = 0
                        })))
                    }
                    resize() {
                        this.game.device.portrait && !this.game.device.desktop ? (this.background.texture = this.bgpn, this.background.anchor.set(0), this.background.width = 2 * this.game.viewport.paddingX + this.game.viewport.width, this.background.height = 2 * this.game.viewport.paddingY + this.game.viewport.height, this.background.position.set(-this.game.viewport.paddingX, 0), this.featureBackground.texture = this.bgpf, this.featureBackground.anchor.set(0), this.featureBackground.width = 2 * this.game.viewport.paddingX + this.game.viewport.width, this.featureBackground.height = 2 * this.game.viewport.paddingY + this.game.viewport.height, this.featureBackground.position.set(-this.game.viewport.paddingX, 0), this.bglfAnimation1.renderable = !1, this.bglfAnimation2.renderable = !1, this.bglnAnimation1.renderable = !1, this.bglnAnimation2.renderable = !1) : (this.background.texture = this.bgln, this.background.anchor.set(.5), this.background.anchor.set(.5), this.background.width = this.game.viewport.width, this.background.height = this.game.viewport.height, this.background.position.set(this.game.viewport.width / 2, this.game.viewport.height / 2), this.featureBackground.texture = this.bglf, this.featureBackground.anchor.set(.5), this.featureBackground.width = this.game.viewport.width, this.featureBackground.height = this.game.viewport.height, this.featureBackground.position.set(this.game.viewport.width / 2, this.game.viewport.height / 2), this.bglfAnimation1.renderable = !0, this.bglfAnimation2.renderable = !0, this.bglnAnimation1.renderable = !0, this.bglnAnimation2.renderable = !0)
                    }
                }! function(t) {
                ...
                class Rs extends(Gt(Y.W2)) {
                    constructor() {
                        ...
                        })), this._description.anchor.set(.5), this._description.position.set(0, 490), this._buttonText = this._content.addChild(new Ee("", {
                            default: {
                                fontFamily: "PT Sans Narrow Bold",
                                fill: "#ffffff",
                                fontSize: 65,
                        ...
                        })), this._buttonText.anchor.set(.5, 0), this._buttonText.position.set(0, 600), this._timeline = new B({
                            paused: !0
                    ...
                    show(t) {
                        ...
                        return new Promise((i => {
                            ...
                            var s = "";
                            if (t === Ps.START) s = "bonus:start", this.game.action.emit("sound:bonus_start"), this._title.text = this.game.i18n.t("PopupBonusTitle"), this._win.text = this.game.i18n.t("PopupBonusWinStart"), this._description.text = this.game.i18n.t("PopupBonusDescription"), this._buttonText.text = this.game.i18n.t("PopupFreeSpinsButton"), e && (this.tweenAutoTimeout = k.to(this._buttonText, 1, {
                                pixi: {
                                    scale: 1.1
                                },
                                repeat: 5,
                                ...
                                this._title.text = this.game.i18n.t("PopupFreeSpinsTitle"), this._win.text = this.game.i18n.t("PopupBonusWinStop", "".concat(o, "\t").concat(this.game.i18n.currency())), this._description.text = this.game.i18n.t("PopupBonusWinStopDescription", Nt.store.get("bonus:played", -1)), this._buttonText.text = this.game.i18n.t("PopupFreeSpinsButton"), e && (this.tweenAutoTimeout = k.to(this._buttonText, 1, {
                                    pixi: {
                                        scale: 1.1
                                    },
                                    repeat: 5,
                            ...
                            } else t === Ps.RESTORE && (s = "bonus:restore", this.game.action.emit("sound:bonus_start"), this._title.text = this.game.i18n.t("PopupFreeSpinsTitleRestore"), this._win.text = "", this._description.text = "", this._buttonText.text = this.game.i18n.t("PopupFreeSpinsButton"), this._title.position.set(0, 210), this._buttonText.position.set(0, 400));
                    ...
                    showContent(t) {
                        return t === Ps.RESTORE ? Promise.resolve() : new Promise((t => {
                    ...
                    resize() {
                        this.hitArea = new K.Rectangle(-this.game.viewport.paddingX, 0, this.game.viewport.width + 2 * this.game.viewport.paddingX, this.game.viewport.height), this._title.setTagStyle("default", {
                            wordWrapWidth: this.game.viewport.width - 40,
                ...
                class Us extends Y.W2 {
                    constructor() {
                        super(), this.interactive = !0
                    }
                }
                class _s extends tt.j {
                    constructor(t, e) {
                        super(t), this.tint = e
                    }
                }
                class Vs extends u.TC {
                    constructor(t, e, i, s) {
                ...
                class to extends Ee {
                    constructor() {
                        super("", $s($s({}, qs.Common), {}, {
                            default: $s($s({}, qs.Common.default), {}, {
                                fill: Nt.config.get("colors.primary"),
                                fontFamily: "Avenir-Bold"
                            }),
                            value: $s($s({}, qs.Common.value), {}, {
                                fontSize: 66
                            })
                        }))
                    }
                    update(t) {
                        this.text = Nt.i18n.t("ControlsDesktopTotalWin", Nt.i18n.currency({
                            withBrace: !0
                ...
                class ao extends so {
                    constructor(t) {
                        super(), (0, n.Z)(this, "betLevel", void 0), (0, n.Z)(this, "betLevelText", void 0), (0, n.Z)(this, "updateAll", (() => {
                        ...
                        })), this.betLevel = t, this.betLevelText = this.addChild(new Ee("", no(no({}, qs.Common), {}, {
                            default: no(no({}, qs.Common.default), {}, {
                                align: "left"
                            })
                            ...
                            !$i.isBasic() || this.game.autoPlay.enabled || this.game.freeRound.enabled || "respin" === this.game.store.get("server:nextAction") || this.enable()
                        })), this.game.action.on("state:spin_enter", (() => {
                            this.disable()
                        })), this.disable()
                    }
                }
                class ho extends tt.j {
                    constructor(t) {
                        var {
                            icon: e,
                            textures: i
                ...
                const co = function(t) {
                    var e = new Ee("", lo(lo({}, t), {}, {
                        default: lo(lo({}, t.default), {}, {
                            wordWrap: !0,
                            wordWrapWidth: 200
                        })
                    }));
                    return e.visible = !1, e.anchor.set(.5, 1), {
                        ...
                        updateLeft: function(t) {
                            e.text = Nt.i18n.t("ControlsDesktopFreeRoundLeft", t)
                        }
                    }
                };
                const uo = function(t) {
                    ...
                    function i(t) {
                        e.text = Nt.i18n.t("ControlsDesktopFreeRoundWin", Nt.i18n.currency({
                            withBrace: !0
                        }), t > 0 ? Nt.helpers.toMoney(t) : "")
                    }
                    return e.visible = !1, e.anchor.x = .5, Nt.action.on("update:win", (() => {
                        i(Nt.wallet.totalCoins)
                    })), {
                        container: e,
                        hide: function() {
                            e.visible = !1
                ...
                class mo extends Ee {
                    constructor() {
                        super("", go(go({}, qs.Common), {}, {
                            default: go(go({}, qs.Common.default), {}, {
                                align: "right"
                            })
                        }))
                    }
                    update(t) {
                        t >= 0 && (Nt.action.emit("balance_updated", t), this.text = Nt.i18n.t("ControlsDesktopBalance", Nt.i18n.currency({
                            withBrace: !0,
                            withSpace: !0
                        }), Nt.helpers.toMoney(t)))
                    }
                ...
                class Ao extends Ee {
                    ...
                    change(t) {
                        this.text = 0 === t ? Nt.i18n.t("ControlsDesktopBonusLast") : Nt.i18n.t("ControlsDesktopBonusLeft", t), k.to(this, .3, {
                            pixi: {
                                scale: 1.3
                            },
                            yoyo: !0,
                ...
                class bo extends Ee {
                    constructor() {
                        super("", qs.Common), this.anchor.x = .5
                    }
                    update(t) {
                        var e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
                        this.text = Nt.i18n.t("ControlsDesktopWin", Nt.i18n.currency({
                            withBrace: !0
                        }), t > 0 || e ? Nt.helpers.toMoney(t) : "")
                    }
                }
                class vo extends io {
                    constructor() {
                        ...
                        this.background = tt.j.from("data:image/png;base64,"), this.background.alpha = .4, this.background.anchor.set(0, 1), this.background.position.set(0, this.game.viewport.height), this.buttonMenu = new Is, this.buttonMenu.position.set(77, 1013), this.buttonMaxBet = new ao(this.game.betLevel), this.buttonMaxBet.position.set(213, 1013), this.buttonAutoPlay = new Ms, this.buttonAutoPlay.position.set(833, 1013), this.buttonQuickSpin = new Ds, this.buttonQuickSpin.position.set(1084, 1014), this.buttonSound = new Hs, this.buttonSound.position.set(1840, 1012), this.buttonSpin = function() {
                            ...
                            e.scale.set(.9), e.hitArea = new K.Rectangle(0, 10, 140, 120), e.name = "buttonSpin";
                            var i = Nt.keyboard.register(Nt.keyboard.KEY_CODE.Space);
                            i.onPress.add(o), i.disable();
                            var s = new Ts(Nt.loader.getAsset("effectSpin"));

                            function o() {
                                t.handlers(!0) ? t.dispatch() : (Nt.store.get("spin:isSpin", !1) || s.play("press", !1), Nt.action.emit("clickSpin"))
                            }
                            return e.addChild(s), s.play("inactive"), e.onClick.add(o), e.onHover.add((() => {
                                s.play("hover")
                            })), Nt.action.on("spin:fast", (function() {
                                s.play("inactive", !1), e.disable(), i.disable()
                            })), Nt.action.on("state:ready_enter", (function() {
                                $i.isBasic() && i.enable(), $i.isBonus() || (e.visible = !0, e.enable(), s.play("active"))
                            })), Nt.action.on("state:finish_exit", (function() {
                                i.enable(), $i.isBasic() && (e.enable(), s.play("active"))
                            })), {
                                container: e,
                                hide() {
                                    e.visible = !1
                                ...
                                enable() {
                                    e.enable(), i.enable(), s.play("active")
                                },
                                disable() {
                                    e.disable(), i.disable(), t.handlers(!0) && t.detachAll()
                                }
                            }
                        }(t.btn_spin_active, t.btn_spin_hover, t.btn_spin_press, t.btn_spin_inactive), this.buttonSpin.container.position.set(888, 936), this.buttonAccept = new Fs, this.buttonAccept.position.set(958, 1013), this.textWin = new bo, this.textWin.anchor.x = .5, this.textWin.position.set(1400, 980), this.textBalance = new mo, this.textBalance.anchor.x = 1, this.textBalance.position.set(1760, 980), this.freeRoundLeft = co(qs.Common), this.freeRoundLeft.container.position.set(1700, 1054), this.freeRoundTotalWin = uo(qs.Common), this.freeRoundTotalWin.container.position.set(1400, 980), this.textBonusLeft = new Ao, this.textBonusLeft.visible = !1, this.textBonusLeft.anchor.x = .5, this.textBonusLeft.position.set(640, 980), this.textBonusTotalWin = new to, this.textBonusTotalWin.visible = !1, this.textBonusTotalWin.anchor.x = .5, this.textBonusTotalWin.position.set(960, 955), this.addChild(this.background), this.addChild(this.buttonMenu), this.addChild(this.buttonMaxBet), this.addChild(this.buttonSpin.container), this.game.config.get("autoPlay.available", !0) && this.addChild(this.buttonAutoPlay), this.game.config.get("quickSpin.available", !0) && this.addChild(this.buttonQuickSpin), this.addChild(this.buttonSound), this.addChild(this.buttonAccept), this.addChild(this.textWin), this.game.config.get("balanceHide", !1) || this.addChild(this.textBalance), this.addChild(this.freeRoundTotalWin.container), this.addChild(this.freeRoundLeft.container), this.addChild(this.textBonusLeft), this.addChild(this.textBonusTotalWin), this.textWin.update(this.game.wallet.coins), this.textBalance.update(this.game.wallet.balance), this.game.freeRound.onStart.once((t => {
                            ...
                            this.buttonAutoPlay.visible = !1, this.buttonAutoPlay.disable(), this.textWin.visible = !1, this.textBonusLeft.visible = !0, this.updateBonusLeft(t), this.textBonusTotalWin.update(this.game.wallet.totalCoins - this.game.wallet.bonusCoins), this.textBonusTotalWin.visible = !0, this.game.freeRound.enabled && (this.freeRoundTotalWin.container.visible = !1, this.textWin.visible = !1), this.game.device.desktop && this.buttonQuickSpin.position.set(1233, 1014)
                        })), this.game.action.on("bonus:start", (() => {
                            var t = this.game.store.get("bonus:left", 0);
                            this.buttonAutoPlay.visible = !1, this.buttonAutoPlay.disable(), this.textWin.visible = !1, this.textBonusLeft.visible = !0, this.updateBonusLeft(t), this.textBonusTotalWin.update(this.game.wallet.totalCoins), this.textBonusTotalWin.visible = !0, this.game.freeRound.enabled && (this.freeRoundTotalWin.container.visible = !1, this.textWin.visible = !1), this.game.device.desktop && this.buttonQuickSpin.position.set(1233, 1013)
                        })), this.game.action.on("bonus:stop", (() => {
                            this.buttonAutoPlay.visible = !0, this.textWin.visible = !0, this.buttonAutoPlay.disable(), this.buttonMenu.disable(), this.buttonMaxBet.disable(), this.textBonusLeft.visible = !1, this.textBonusLeft.text = "", this.textBonusTotalWin.visible = !1, this.textBonusTotalWin.text = "", this.textWin.update(this.game.wallet.totalCoins, !0), this.textBalance.update(this.game.wallet.balance), this.game.freeRound.enabled && (this.freeRoundTotalWin.container.visible = !0, this.textWin.visible = !1), this.game.device.desktop && this.buttonQuickSpin.position.set(1084, 1014)
                        })), this.game.action.on("bonus:select_start", (() => {
                            this.buttonSpin.hide(), this.buttonSpin.disable(), k.fromTo(this, .5, {
                                pixi: {
                            ...
                            this.buttonSpin.show(), k.fromTo(this, .5, {
                                pixi: {
                                    y: this.y + this.height
                                }
                            }, {
                            ...
                            this.game.autoPlay.enabled || this.buttonAutoPlay.disable(), $i.isBasic() && "respin" !== this.game.store.get("server:nextAction") && (this.freeRoundLeft.updateLeft(this.game.freeRound.left - 1), this.textBalance.update(this.game.wallet.balance - this.game.betLevel.toCoins()))
                        })), this.game.action.on("state:finish_exit", (() => {
                            $i.isBasic() && "respin" !== this.game.store.get("server:nextAction") && (this.game.autoPlay.enabled || this.buttonMenu.enable(), this.buttonAutoPlay.enable())
                            ...
                            $i.isBonus() || "respin" === this.game.store.get("server:nextAction") || (this.buttonMenu.enable(), this.buttonAutoPlay.enable()), this.game.autoPlay.enabled && "respin" !== this.game.store.get("server:nextAction") && this.buttonMenu.disable()
                        }))
                    }
                    lock() {
                    ...
                    onFinishEnter() {}
                    onRNBStart() {
                        this.buttonMaxBet.disable(), this.buttonMenu.disable(), this.game.store.get("risk", !1) && this.textWin.update(0)
                    }
                    onPopupShow() {
                ...
                class fo extends io {
                    constructor() {
                        super(), (0, n.Z)(this, "autoPlayButton", void 0), (0, n.Z)(this, "betButton", void 0), (0, n.Z)(this, "buttonAccept", void 0), (0, n.Z)(this, "buttonMenu", void 0), (0, n.Z)(this, "buttonQuickSpin", void 0), (0, n.Z)(this, "buttonSound", void 0), (0, n.Z)(this, "buttonSpin", void 0), (0, n.Z)(this, "onPressButtonSpin", void 0), (0, n.Z)(this, "state", void 0), (0, n.Z)(this, "statusBar", void 0), this.state = qe.Normal, this.onPressButtonSpin = new(x()), this.statusBar = new ti, this.statusBar.changeState(this.state), this.game.freeRound.enabled ? (this.statusBar.update({
                        ...
                        })), this.buttonMenu = new Is, this.buttonSound = new Hs, this.buttonSpin = new yo, this.game.interaction.hover(this.buttonSpin, (() => {
                        ...
                        })), this.buttonAccept = new Fs, this.buttonQuickSpin = new Ds, this.autoPlayButton = new Ms, this.autoPlayButton.scale.set(1.6), this.betButton = new so, this.betButton.disable(), this.betButton.onClick.add((() => this.game.action.emit("clickMaxBet"))), this.game.action.on("update:win", (() => {
                            ...
                            !$i.isBasic() || this.game.autoPlay.enabled || this.game.freeRound.enabled || "respin" === this.game.store.get("server:nextAction") || (this.betButton.show(), this.betButton.enable(), this.buttonSpin.interactive = !0, this.buttonMenu.enable(), this.autoPlayButton.enable(), this.buttonQuickSpin.enable()), this.game.freeRound.enabled && $i.isBasic() && "respin" !== this.game.store.get("server:nextAction") && (this.buttonSpin.interactive = !0, this.buttonMenu.enable(), this.autoPlayButton.enable(), this.buttonQuickSpin.enable())
                        })), this.game.action.on("state:spin_enter", (() => {
                            var t = this.game.autoPlay.enabled,
                                e = this.game.store.get("free:isFree", !1);
                            $i.isBonus();
                            this.betButton.disable(), t || this.autoPlayButton.disable();
                            ...
                            }), $i.isBasic() && "respin" !== this.game.store.get("server:nextAction") && this.statusBar.update({
                            ...
                            this.buttonSpin.interactive = !0, $i.isBasic() && !this.game.autoPlay.enabled && "respin" !== this.game.store.get("server:nextAction") && (this.buttonQuickSpin.show(), this.autoPlayButton.show(), this.autoPlayButton.enable(), this.buttonMenu.show(), this.buttonMenu.enable())
                ...
                class ko extends(Gt(Y.W2)) {
                    constructor(t) {
                        super(), (0, n.Z)(this, "left", void 0), (0, n.Z)(this, "right", void 0), this.renderable = t > 1, this.left = this.addChild(new So("left")), this.left.position.set(0, 0), this.right = this.addChild(new So("right")), this.right.position.set(910, 0)
                    }
                    get allArrows() {
                ...
                class Eo extends(Gt(Y.W2)) {
                    constructor(t) {
                        super(), (0, n.Z)(this, "button", void 0), (0, n.Z)(this, "buttonText", void 0), (0, n.Z)(this, "checked", void 0), (0, n.Z)(this, "onClick", void 0), this.interactive = !0, this.cursor = "pointer", this.checked = !1, this.onClick = new(x()), this.button = this.addChild(new Bo), this.buttonText = this.addChild(new Ee("", {
                            default: {
                                fill: t,
                                fontFamily: "Avenir-Bold",
                                fontSize: 20,
                ...
                class To extends Eo {
                    resize() {
                        this.game.device.desktop ? (this.position.set(1250, 875), this.button.scale.set(1), this.buttonText.position.set(40, 20)) : (this.position.set(this.game.device.landscape ? 1250 : 310, this.game.device.landscape ? 875 : 1330), this.button.scale.set(1.6), this.buttonText.scale.set(1.5), this.buttonText.position.set(60, 29))
                    }
                }
                ...
                class Zo extends Oo {
                    constructor(t) {
                        super(t, arguments.length > 1 && void 0 !== arguments[1] && arguments[1]), this.featurePreview.anchor.x = .5, this.featurePreview.position.set(0, 0), this.description.anchor.x = .5, this.description.position.set(0, 830)
                    }
                    resize() {
                        this.description.setTagStyle("default", {
                            wordWrapWidth: this.game.viewport.width / 2.4,
                            breakWords: "ja" === this.game.i18n.language
                        }), this.game.device.desktop ? (this.scale.set(1), this.position.set(960, -90)) : this.game.device.landscape ? (this.description.setTagStyle("default", {
                            wordWrapWidth: this.game.viewport.width / 2.4
                        }), this.scale.set(1), this.position.set(960, -90)) : (this.description.setTagStyle("default", {
                            wordWrapWidth: this.game.viewport.width / 1.5
                        }), this.scale.set(1.3), this.position.set(550, 40))
                    }
                }
                class Ro extends xo {
                    constructor() {
                        super(), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "logo", void 0), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "playButtonBg", void 0), this.overlay = this.addChild(new $t(.75)), this.content = this.addChild(new Y.W2), this.slides.push(this.content.addChild(new Zo(0))), this.slides.push(this.content.addChild(new Zo(1))), this.slides.push(this.content.addChild(new Zo(2, !0))), this.logo = this.content.addChild(new tt.j(this.game.loader.getAsset("assets/images/introScreen/texture.json", "logoIntro"))), this.logo.anchor.x = .5, this.pagination = this.content.addChild(new Co(this.visibleViewsCount, 40)), this.hideButton = this.content.addChild(new To("#e3a750")), this.arrows = this.content.addChild(new ko(this.visibleViewsCount)), this.arrows.right.position.set(980, 0), this.arrows.position.set(470, 400), this.playButton = this.content.addChild(new Po), this.playButton.anchor.set(.5), this.setupArrows(), this.setupPagination(), this.setupHideButton(), this.setupSlides()
                    }
                    resize() {
                ...
                class jo extends(Gt(Y.W2)) {
                    constructor(t) {
                        var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [];
                        super(), (0, n.Z)(this, "_payTableBetLineBoxs", void 0), (0, n.Z)(this, "_payTableParagraph", void 0), (0, n.Z)(this, "_payTableTitle", void 0), this._payTableBetLineBoxs = new Y.W2, this._payTableTitle = new Lo(this.game.i18n.t("PaytableSectionBetLinesTitle").toUpperCase()), this._payTableParagraph = new Do(this.game.i18n.t("PaytableSectionBetLinesContent1")), t.forEach(((t, i) => {
                ...
                class _o extends(Gt(Y.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "_sectionParagraph1", void 0), (0, n.Z)(this, "_sectionTitle", void 0), this.visible = this.game.config.get("rnb", !0), this._sectionTitle = new Lo(this.game.i18n.t("PaytableSectionRiskTitle").toUpperCase()), this._sectionTitle.position.set(0, 0), this._sectionParagraph1 = new Do(this.game.i18n.t("PaytableSectionRiskContent1")), this._sectionParagraph1.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this.addChild(this._sectionTitle), this.addChild(this._sectionParagraph1)
                    }
                    resize() {
                ...
                class Vo extends(Gt(Y.W2)) {
                    ...
                    updateBet(t) {
                        this.payoutText.text = "\n", this.payouts.filter((t => t.sym === this.findIndex)).forEach((e => {
                            var i;
                            e.n > 0 && e.mul > 0 && (i = "scatter" === e.type ? t.toCoins() * e.mul : t.bet * e.mul, this.payoutText.text += "<mul>".concat("scatter" === e.type && 5 === e.n ? "".concat(e.n, "+") : e.n, "</mul>\t\t").concat(this.game.helpers.toMoney(i, t.bet), "\n"))
                        }))
                    }
                    resize() {
                ...
                class zo extends(Gt(Y.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "sectionTitle", void 0), (0, n.Z)(this, "symbol1", void 0), (0, n.Z)(this, "symbol2", void 0), (0, n.Z)(this, "symbol3", void 0), (0, n.Z)(this, "symbol4", void 0), (0, n.Z)(this, "symbol5", void 0), (0, n.Z)(this, "symbol6", void 0), (0, n.Z)(this, "symbol7", void 0), (0, n.Z)(this, "symbol8", void 0), (0, n.Z)(this, "symbols", void 0), this.sectionTitle = new Lo(this.game.i18n.t("PaytableSectionPayoutTitle").toUpperCase()), this.symbol1 = new Vo("skeleton"), this.symbol1.position.set(0, this.sectionTitle.y + this.sectionTitle.height + 30), this.symbol2 = new Vo("girl"), this.symbol2.position.set(600, this.sectionTitle.y + this.sectionTitle.height + 30), this.symbol3 = new Vo("man"), this.symbol3.position.set(0, this.symbol1.y + this.symbol1.height + 30), this.symbol4 = new Vo("tequila"), this.symbol4.position.set(600, this.symbol2.y + this.symbol2.height + 30), this.symbol5 = new Vo("hearth"), this.symbol5.position.set(0, this.symbol3.y + this.symbol3.height + 30), this.symbol6 = new Vo("clubs"), this.symbol6.position.set(600, this.symbol4.y + this.symbol4.height + 30), this.symbol7 = new Vo("spades"), this.symbol7.position.set(0, this.symbol5.y + this.symbol5.height + 30), this.symbol8 = new Vo("diamonds"), this.symbol8.position.set(600, this.symbol6.y + this.symbol6.height + 30), this.symbols = [this.symbol1, this.symbol2, this.symbol3, this.symbol4, this.symbol5, this.symbol6, this.symbol7, this.symbol8], this.addChild(this.sectionTitle, ...this.symbols)
                    }
                    updateBet(t) {
                ...
                class Go extends(Gt(Y.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "content1", void 0), this.title = new Lo(Nt.i18n.t("PaytableSectionRespinTitle").toUpperCase()), this.title.position.set(0, 0), this.content1 = new Do(Nt.i18n.t("PaytableSectionRespinContent1")), this.content1.position.set(0, this.title.height + this.title.y + 30), this.addChild(this.title, this.content1)
                    }
                    resize() {
                ...
                class Ho extends(Gt(Y.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "content1", void 0), (0, n.Z)(this, "symbol1", void 0), (0, n.Z)(this, "symbol2", void 0), this.title = new Lo(Nt.i18n.t("PaytableSectionScatterTitle").toUpperCase()), this.title.position.set(0, 0), this.symbol1 = new Vo("goldScull"), this.symbol1.position.set(0, this.title.height + this.title.y + 30), this.symbol2 = new Vo("pinkScull"), this.symbol2.position.set(this.symbol1.width + this.symbol1.x + 30, this.title.height + this.title.y + 30), this.symbol2.withoutPayout(), this.content1 = new Do(Nt.i18n.t("PaytableSectionScatterContent1")), this.content1.position.set(0, this.symbol2.height + this.symbol2.y + 30), this.addChild(this.title, this.content1, this.symbol1, this.symbol2)
                    }
                    updateBet(t) {
                        this.symbol1.updateBet(t), this.resize()
                    }
                    resize() {
                        this.game.device.desktop || (this.game.device.landscape ? (this.content1.setTagStyle("default", {
                            wordWrapWidth: 690
                        }), this.symbol1.position.set(0, this.title.height + this.title.y + 30), this.symbol2.position.set(this.symbol1.width + this.symbol1.x + 30, this.title.height + this.title.y + 30), this.content1.position.set(0, this.symbol2.height + this.symbol2.y + 30)) : (this.symbol1.position.set(0, this.title.height + this.title.y + 60), this.symbol2.position.set(0, this.symbol1.height + this.symbol1.y + 60), this.content1.position.set(0, this.symbol2.height + this.symbol2.y + 60), this.content1.setTagStyle("default", {
                            wordWrapWidth: 390
                        })))
                    }
                }
                class Qo extends(Gt(Y.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "symbol1", void 0), (0, n.Z)(this, "content1", void 0), this.title = new Lo(Nt.i18n.t("PaytableSectionWildTitle").toUpperCase()), this.title.position.set(0, 0), this.symbol1 = new Vo("wild"), this.symbol1.position.set(0, this.title.y + this.title.height + 30), this.symbol1.withoutPayout(), this.content1 = new Do(Nt.i18n.t("PaytableSectionWildContent1")), this.content1.position.set(this.symbol1.x + this.symbol1.width + 30, this.symbol1.height / 2 + this.symbol1.y - this.content1.height / 2), this.content1.setTagStyle("default", {
                            wordWrapWidth: 690
                        }), this.addChild(this.title, this.symbol1, this.content1)
                    }
                    resize() {
                        this.game.device.desktop || (this.game.device.landscape ? (this.symbol1.position.set(0, this.title.y + this.title.height + 30), this.content1.position.set(this.symbol1.x + this.symbol1.width + 30, this.title.height + this.title.y + 30), this.content1.setTagStyle("default", {
                            wordWrapWidth: 490
                        })) : (this.symbol1.position.set(0, this.title.y + this.title.height + 30), this.content1.position.set(0, this.symbol1.height + this.symbol1.y + 30), this.content1.setTagStyle("default", {
                            wordWrapWidth: 390
                        })))
                    }
                }
                class Yo extends(Gt(Y.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "symbol1", void 0), (0, n.Z)(this, "symbol2", void 0), (0, n.Z)(this, "symbol3", void 0), (0, n.Z)(this, "symbol4", void 0), (0, n.Z)(this, "content1", void 0), (0, n.Z)(this, "content2", void 0), (0, n.Z)(this, "content3", void 0), (0, n.Z)(this, "content4", void 0), (0, n.Z)(this, "content5", void 0), (0, n.Z)(this, "content6", void 0), this.title = new Lo(this.game.i18n.t("PaytableSectionBonusGameTitle").toUpperCase()), this.title.position.set(0, 0), this.content1 = new Do(this.game.i18n.t("PaytableSectionBonusGameContent1")), this.content1.position.set(0, this.title.height + this.title.y + 30), this.symbol1 = new Vo("pinkScullNoWord"), this.symbol1.position.set(0, this.content1.y + this.content1.height + 30), this.symbol1.withoutPayout(), this.content2 = new Do(this.game.i18n.t("PaytableSectionBonusGameContent2")), this.content2.position.set(this.symbol1.x + this.symbol1.width + 30, this.symbol1.y + this.symbol1.height / 2 - this.content2.height / 2), this.content2.setTagStyle("default", {
                            wordWrapWidth: 620
                        }), this.symbol2 = new Vo("goldScullNoWord"), this.symbol2.position.set(0, this.symbol1.y + this.symbol1.height + 30), this.symbol2.withoutPayout(), this.content3 = new Do(this.game.i18n.t("PaytableSectionBonusGameContent3")), this.content3.position.set(this.symbol2.x + this.symbol2.width + 30, this.symbol2.y + this.symbol2.height / 2 - this.content3.height / 2), this.content3.setTagStyle("default", {
                            wordWrapWidth: 620
                        }), this.symbol3 = new Vo("violetScull"), this.symbol3.position.set(0, this.symbol2.y + this.symbol2.height + 30), this.symbol3.withoutPayout(), this.content4 = new Do(this.game.i18n.t("PaytableSectionBonusGameContent4")), this.content4.position.set(this.symbol3.x + this.symbol3.width + 30, this.symbol3.y + this.symbol3.height / 2 - this.content4.height / 2), this.content4.setTagStyle("default", {
                            wordWrapWidth: 620
                        }), this.symbol4 = new Vo("yellowScull"), this.symbol4.position.set(0, this.symbol3.y + this.symbol3.height + 30), this.symbol4.withoutPayout(), this.content5 = new Do(this.game.i18n.t("PaytableSectionBonusGameContent5")), this.content5.position.set(this.symbol4.x + this.symbol4.width + 30, this.symbol4.y + this.symbol4.height / 2 - this.content5.height / 2), this.content5.setTagStyle("default", {
                            wordWrapWidth: 620
                        }), this.content6 = new Do(this.game.i18n.t("PaytableSectionBonusGameContent6")), this.content6.position.set(0, this.symbol4.y + this.symbol4.height + 30), this.addChild(this.title, this.symbol1, this.symbol2, this.symbol3, this.symbol4, this.content1, this.content2, this.content3, this.content4, this.content5, this.content6)
                    }
                    resize() {
                        this.game.device.desktop || (this.game.device.landscape ? (this.content1.position.set(0, this.title.height + this.title.y + 30), this.symbol1.position.set(0, this.content1.y + this.content1.height + 30), this.content2.position.set(this.symbol1.x + this.symbol1.width + 30, this.content1.y + this.content1.height + 30), this.content2.setTagStyle("default", {
                            wordWrapWidth: 420
                        }), this.symbol2.position.set(0, this.symbol1.y + this.symbol1.height + 30), this.content3.position.set(this.symbol2.x + this.symbol2.width + 30, this.symbol1.y + this.symbol1.height + 30), this.content3.setTagStyle("default", {
                            wordWrapWidth: 420
                        }), this.symbol3.position.set(0, this.symbol2.y + this.symbol2.height + 30), this.content4.position.set(this.symbol3.x + this.symbol3.width + 30, this.symbol2.y + this.symbol2.height + 30), this.content4.setTagStyle("default", {
                            wordWrapWidth: 420
                        }), this.symbol4.position.set(0, this.symbol3.y + this.symbol3.height + 30), this.content5.position.set(this.symbol4.x + this.symbol4.width + 30, this.symbol3.y + this.symbol3.height + 30), this.content5.setTagStyle("default", {
                            wordWrapWidth: 420
                        }), this.content6.position.set(0, this.symbol4.y + this.symbol4.height + 30)) : (this.content1.position.set(0, this.title.height + this.title.y + 30), this.symbol1.position.set(0, this.content1.y + this.content1.height + 30), this.content2.position.set(0, this.symbol1.y + this.symbol1.height + 30), this.symbol2.position.set(0, this.content2.y + this.content2.height + 30), this.content3.position.set(0, this.symbol2.y + this.symbol2.height + 30), this.symbol3.position.set(0, this.content3.y + this.content3.height + 30), this.content4.position.set(0, this.symbol3.y + this.symbol3.height + 30), this.symbol4.position.set(0, this.content4.y + this.content4.height + 30), this.content5.position.set(0, this.symbol4.y + this.symbol4.height + 30), this.content6.position.set(0, this.content5.y + this.content5.height + 30)))
                    }
                }
                class Xo extends(Gt(Y.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "content1", void 0), this.title = new Lo(Nt.i18n.t("PaytableSectionExtraBonusTitle").toUpperCase()), this.title.position.set(0, 0), this.content1 = new Do(Nt.i18n.t("PaytableSectionExtraBonusContent1")), this.content1.position.set(0, this.title.height + this.title.y + 30), this.addChild(this.title, this.content1)
                    }
                    resize() {
                        this.game.device.desktop || (this.game.device.landscape ? (this.content1.position.set(0, this.title.height + this.title.y + 30), this.content1.setTagStyle("default", {
                            wordWrapWidth: 690
                        })) : (this.content1.position.set(0, this.title.height + this.title.y + 30), this.content1.setTagStyle("default", {
                            wordWrapWidth: 390
                        })))
                    }
                }
                class Ko extends Wo {
                    constructor(t) {
                        super(), (0, n.Z)(this, "_paytableSectionRNB", void 0), (0, n.Z)(this, "_paytableSectionPayout", void 0), (0, n.Z)(this, "_paytableSectionWild", void 0), (0, n.Z)(this, "_paytableSectionScatter", void 0), (0, n.Z)(this, "_paytableSectionRespin", void 0), (0, n.Z)(this, "_paytableSectionBonusGame", void 0), (0, n.Z)(this, "_paytableSectionExtraBonus", void 0), (0, n.Z)(this, "_payTableDelimiter", void 0), (0, n.Z)(this, "_paytableSectionBetLines", void 0), this._paytableSectionRNB = new _o, this._paytableSectionPayout = new zo, this._paytableSectionWild = new Qo, this._paytableSectionScatter = new Ho, this._paytableSectionRespin = new Go, this._paytableSectionBonusGame = new Yo, this._paytableSectionExtraBonus = new Xo, this._payTableDelimiter = new Uo, this._paytableSectionBetLines = new No(t, [5, 3]), this.content.addChild(this._paytableSectionRNB, this._paytableSectionPayout, this._paytableSectionWild, this._paytableSectionScatter, this._paytableSectionRespin, this._paytableSectionBonusGame, this._paytableSectionExtraBonus, this._payTableDelimiter, this._paytableSectionBetLines)
                    }
                    updateBet(t) {
                        this._paytableSectionPayout.updateBet(t), this._paytableSectionScatter.updateBet(t), this.resize()
                    }
                }
                ...
                function un(t) {
                    for (var e = 1; e < arguments.length; e++) {
                        var i = null != arguments[e] ? arguments[e] : {};
                        e % 2 ? cn(Object(i), !0).forEach((function(e) {
                            (0, n.Z)(t, e, i[e])
                        })) : Object.getOwnPropertyDescriptors ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(i)) : cn(Object(i)).forEach((function(e) {
                            Object.defineProperty(t, e, Object.getOwnPropertyDescriptor(i, e))
                        }))
                    }
                    return t
                }
                class pn extends(Gt(Ee)) {
                    constructor() {
                        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                        super("", un(un({}, t), {}, {
                            default: un({
                ...
                class gn extends on {
                    constructor() {
                        super(), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "backgroundContent", void 0), (0, n.Z)(this, "buyFor", void 0), (0, n.Z)(this, "buyValue", void 0), (0, n.Z)(this, "onBet", void 0), (0, n.Z)(this, "onBetValue", void 0), (0, n.Z)(this, "featureButton", void 0), (0, n.Z)(this, "bonusHeader", void 0), (0, n.Z)(this, "header", void 0), (0, n.Z)(this, "onPress", void 0), this.onPress = new(x()), this.background = this.addChild(new tt.j(this.game.loader.getAsset("risk", "bg"))), this.backgroundContent = this.addChild(new Y.W2), this.header = this.backgroundContent.addChild(new hn({
                            default: {
                                fontSize: 24,
                                wordWrapWidth: 200,
                                fill: "#ffffff"
                            }
                        })), this.bonusHeader = this.backgroundContent.addChild(new tt.j(this.game.loader.getAsset("risk", "bonus"))), this.bonusHeader.anchor.set(.5), this.buyFor = this.backgroundContent.addChild(new $o({
                            default: {
                                fill: 16759817,
                                fontSize: 26,
                                wordWrapWidth: 220
                            }
                        })), this.buyValue = this.backgroundContent.addChild(new sn({
                            default: {
                                fontSize: 46
                            }
                        })), this.onBet = this.backgroundContent.addChild(new dn({
                            default: {
                                fill: 16759817,
                                fontSize: 26,
                                wordWrapWidth: 220
                            }
                        })), this.onBetValue = this.backgroundContent.addChild(new pn({
                            default: {
                                fontSize: 46
                            }
                        })), this.featureButton = this.addChild(new tt.j(this.game.loader.getAsset("risk", "buy"))), this.featureButton.texture = this.game.loader.getAsset("risk", "risk"), this.featureButton.cursor = "pointer", this.featureButton.interactive = !1, this.game.interaction.click(this.featureButton, (() => {
                    ...
                    show(t) {
                        if (this.game.store.get("isRiskNBuy") && (super.show(t), this.visible)) {
                            ...
                            this.featureButton.interactive = !0, this.featureButton.texture = this.game.loader.getAsset("risk", e ? "risk" : "buy"), e ? (this.header.show(), this.buyFor.hide(), this.buyValue.hide(), this.onBetValue.text = "".concat(Nt.helpers.toMoneySS(this.game.betLevel.toCoins())), this.header.position.set(0, 10), this.bonusHeader.position.set(0, 120), this.onBet.position.set(0, this.bonusHeader.y + this.bonusHeader.height), this.onBetValue.position.set(0, this.onBet.y + this.onBet.height), this.featureButton.position.set(26, 550), this.backgroundContent.position.set(155, 120)) : (this.header.hide(), this.buyFor.show(), this.buyValue.show(), this.buyValue.text = "".concat(Nt.helpers.toMoneySS(i.bet)), this.onBetValue.text = "".concat(Nt.helpers.toMoneySS(this.game.betLevel.toCoins())), this.bonusHeader.position.set(0, -120), this.buyFor.position.set(0, -40), this.buyValue.position.set(0, this.buyFor.height + this.buyFor.y), this.onBet.position.set(0, this.buyValue.height + this.buyValue.y + 30), this.onBetValue.position.set(0, this.onBet.height + this.onBet.y), this.featureButton.position.set(56, 550), this.backgroundContent.position.set(155, 280))
                        }
                    }
                    hide() {
                    ...
                    resize() {
                        this.game.device.desktop ? this.position.set(1570, 100) : this.game.device.landscape ? (this.scale.set(1.15), this.game.leftHand.enabled ? this.position.set(1550, 20) : this.position.set(10, 20)) : (this.scale.set(1.2), this.position.set(670, 370))
                    }
                }
                class mn extends X.K3 {
                    constructor(t) {
                ...
                class bn extends(Gt(Y.W2)) {
                    constructor(t) {
                        var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [];
                        super(), (0, n.Z)(this, "lines", void 0), (0, n.Z)(this, "points", new Map), this.lines = t.map((t => this.addChild(new mn(t)))), this.game.device.desktop && e.map((t => this.points.set(t.line, t.position.map((e => {
                            var i = this.addChild(new An(t.line));
                ...
                class vn extends(Gt(b.Xz)) {
                    constructor() {
                        super("", {
                            fontName: "WinFont"
                        }), (0, n.Z)(this, "tween", void 0), (0, n.Z)(this, "savedScale", 0), this.alpha = 0, this.anchor = .5, this.tween = null
                    }
                    show(t, e, i) {
                ...
                var wn = Symbol("BonusScale"),
                    xn = 454;
                class Sn extends(Gt(Y.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "id", wn), (0, n.Z)(this, "frame", void 0), (0, n.Z)(this, "progressLine", void 0), (0, n.Z)(this, "text", void 0), (0, n.Z)(this, "scaleConut", void 0), (0, n.Z)(this, "currentBonusValue", void 0), (0, n.Z)(this, "currentNormalNumber", void 0), (0, n.Z)(this, "progressMask", void 0), this.hide(), this.frame = new tt.j(this.game.loader.getAsset("scale", "frame")), this.progressLine = new tt.j(this.game.loader.getAsset("scale", "scale")), this.progressLine.position.set(0, 0), this.text = new tt.j(this.game.loader.getAsset("scale", "textBonusSpins")), this.text.position.set(-9, -130), this.progressMask = this.addChild(new u.TC), this.progressMask.beginFill(0, 1), this.progressMask.drawRect(0, 30, 160, 454), this.progressMask.endFill(), this.progressLine.mask = this.progressMask, this.scaleConut = new Ee("", {
                            default: {
                                fill: "#ffffff",
                                fontFamily: "PT Sans Narrow Bold",
                                fontSize: 45,
                        ...
                        }), this.scaleConut.anchor.x = .5, this.addChild(this.frame, this.progressLine, this.scaleConut, this.text), this.update(this.game.store.get("bonus:left", 0), !0)
                    }
                    update(t) {
                        var e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                            i = arguments.length > 2 && void 0 !== arguments[2] && arguments[2],
                            s = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 0,
                            o = Nt.store.get("bonus:total", 0),
                            n = 454 / (i ? o - s : o);
                        this.scaleConut.text = "".concat(t, "/").concat(i ? o - s : o), this.scaleConut.position.set(76, 480), 0 === t && this.progressLine.y === xn || (e || (this.currentBonusValue > t ? this.game.action.emit("sound:scaleDown") : this.currentBonusValue < t && this.game.action.emit("sound:scaleUp")), k.to(this.progressMask, e ? 0 : .2, {
                            pixi: {
                                y: t >= 0 ? xn - n * t : xn
                            }
                        }))
                    ...
                    reset() {
                        this.progressMask.y = xn
                    }
                    resize() {
                        this.game.device.desktop || this.game.device.landscape ? this.game.leftHand.enabled ? this.position.set(1580, 290) : this.position.set(-134, 230) : this.position.set(1390, 250)
                    }
                }
                class kn extends(Gt(Y.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "timeline", void 0), (0, n.Z)(this, "textDescription", void 0), this.timeline = new B, this.alpha = 0, this.textDescription = new tt.j(this.game.loader.getAsset("assets/images/labels/textFreeRespin.png")), this.addChild(this.textDescription)
                    }
                    show() {
                        var t = this.y;
                        return new Promise((e => {
                            Nt.action.emit("sound:respin"), this.timeline.clear(), this.timeline.vars = {
                                onComplete: () => {
                                    e(), this.y = t
                                }
                ...
                const Cn = class extends Bn {
                    constructor(t) {
                        super(), (0, n.Z)(this, "_flushInterval", void 0), (0, n.Z)(this, "_wins", void 0), (0, n.Z)(this, "_scatters", void 0), (0, n.Z)(this, "slot", void 0), this.slot = t, this._wins = [], this._scatters = [], this._flushInterval = null
                    }
                    get isStop() {
                        return super.isStop || !$i.isBasic()
                    }
                    stop() {
                        this.slot.lines.hide(), this._wins.length = 0, this._scatters.length = 0, clearInterval(this._flushInterval), this.slot.reels.forEach((t => t.stopAnimation())), Nt.action.emit("stopAnimation"), this.slot.textLineWin.clear(), this.slot.lines.hide(), "respin" === this.game.store.get("server:action") && "respin" !== this.game.store.get("server:nextAction") && this.slot.sticky.hide()
                    }
                    _getWinSoundNumber() {
                        var t = Nt.store.get("reward:numberWinSymbol", 0);
                        return t <= 9 ? 1 : t > 9 && t <= 13 ? 2 : 3
                    }
                    mixPayment(t, e) {
                        var i = this;
                        return (0, o.Z)((function*() {
                            i.slot.reels.forEach((t => t.overlay())), i.slot.lines.show(t);
                            for (var s = 0, o = t.length; s < o; s++) {
                                var n = t[s];
                                i._wins.push(n), i._runSymbolAnimation(n, !1)
                            }
                            e && (i._runScatterSymbolAnimation(e, "stickyWin"), i._scatters = e), i.slot.sticky.mixWin(t, e);
                            var a = i._getWinSoundNumber();
                            Nt.action.emit("sound:win", a), yield i.slot.textTotalWin.show(Nt.wallet.coins, (() => {
                                Nt.action.emit("update:win"), Nt.action.emit("update:balance")
                            }))
                        }))()
                    }
                    allPayment(t) {
                        ...
                        return (0, o.Z)((function*() {
                            ...
                            for (var i = 0, s = t.length; i < s; i++) {
                                var o = t[i];
                                e.slot.sticky.win(o), e._wins.push(o), e._runSymbolAnimation(o, !1)
                            }
                            var n = e._getWinSoundNumber();
                            Nt.action.emit("sound:win", n), yield e.slot.textTotalWin.show(Nt.wallet.coins, (() => {
                                Nt.action.emit("update:win"), Nt.action.emit("update:balance")
                            }))
                        }))()
                    }
                    scatterPayment(t) {
                        var e = this;
                        return (0, o.Z)((function*() {
                            e.slot.lines.hide(), e.slot.reels.forEach((t => t.clearAnimation())), e.slot.textLineWin.clear(), e.slot.sticky.winScatters(t), e.slot.reels.forEach((t => t.overlay())), e.game.action.emit("sound:bonusWin"), e._runScatterSymbolAnimation(t), yield e.game.helpers.delay(Ji.get("reward_scatter")), e.slot.reels.forEach((t => t.stopAnimation()))
                        }))()
                    }
                    bonusPayment(t) {
                        var e = this;
                    ...
                    complete() {
                        this.isStop ? this.stop() : (this._wins.length > 0 || this._scatters.length > 0) && this._flush()
                    }
                    _flush() {
                        var t = !0,
                            e = e => {
                                ...
                                var i = this._wins[e];
                                this.slot.sticky.win(i), this._runSymbolAnimation(i), t && this._showLineText(i), this.slot.lines.show([i])
                            },
                            i = () => {
                                this.slot.reels.forEach((t => t.overlay())), this.slot.reels.forEach((t => t.clearAnimation()));
                                var t = this._scatters;
                                this.slot.sticky.winScatters(t), this._runScatterSymbolAnimation(t, "stickyWin"), this.slot.lines.show([t])
                            },
                            s = 0;
                        this._wins.length > 0 ? e(s++) : this._scatters.length > 0 ? i() : e(s++), this._flushInterval = setInterval((() => {
                            s >= this._wins.length && (t = !1, s = 0, this._scatters.length > 0 && i()), e(s++)
                        }), Ji.get("reward_flush"))
                    }
                    _runSymbolAnimation(t) {
                        ...
                        for (var s = 0; s < e.length; s++)
                            if (-1 !== e[s]) {
                                var o = e[s];
                                this.slot.getSymbolByPosition(s, o).playAnimation("respin" === this.game.store.get("server:action") ? "stickyWin" : i)
                            }
                    }
                    _runScatterSymbolAnimation(t) {
                        var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "bonus";
                        t.forEach((t => {
                            var {
                                pos: i,
                                sym: s
                            ...
                            i.forEach((t => {
                                var [i, s] = t;
                                this.slot.getSymbolByPosition(i, s).playAnimation(e)
                            }))
                        }))
                    }
                    _runBonusSymbolAnimation(t) {
                        ...
                        return (0, o.Z)((function*() {
                            t.forEach((t => {
                                e.slot.getSymbolByPosition(t.pos[0], t.pos[1]).playAnimation("win")
                    ...
                    _showLineText(t) {
                        ...
                        }), -1), a = this.slot.getReelByPosition(n, e[n]), h = this.slot.getSymbolByPosition(n, e[n]), r = a.x + h.width / 2, l = a.y + h.height / 2;
                        this.slot.textLineWin.show(r, l, i)
                    }
                };
                class Pn extends(Gt(Os)) {
                    constructor(t) {
                        super(), (0, n.Z)(this, "slot", void 0), (0, n.Z)(this, "winSoundPlay", void 0), this.slot = t
                    }
                    showSticky(t) {
                        var e = arguments,
                            i = this;
                        return (0, o.Z)((function*() {
                            ...
                            i.slot.reels.forEach((t => t.stopAnimation()));
                            var o = i.game.config.get("slot.reels"),
                                n = 0;
                            i._update(t), t.forEach((t => {
                                if (t.isNew || s) {
                                    var e = i.slot.getSymbolByPosition(t.pos[0], t.pos[1]);
                                    e.parentReel.visible = !1;
                                    var a = e.data.assetName,
                                        h = i.addChild(new Ts(i.game.loader.getAsset("symbolAnimation")));
                                    h.position.set(e.parentReel.x, e.parentReel.y), h.changeSkin(a), h.index = t.pos[0] + t.pos[1] * o, s ? h.play("sticky", !0) : (n = 500, Nt.action.emit("sound:stickyAppear"), h.play("stickyStart").then((() => {
                                        h.play("sticky", !0)
                                    })))
                                }
                            })), yield i.game.helpers.delay(n)
                        }))()
                    }
                    mixWin(t, e) {
                        ...
                        this.children.forEach((t => {
                            ...
                            t.pos.forEach(((t, e) => {
                                var s = e + t * i,
                                    o = this.children.find((t => t.index === s));
                                o && (o.visible = !1)
                            }))
                        })), e && e.forEach((t => {
                            t.pos.forEach((t => {
                                var e = t[0] + t[1] * i,
                                    s = this.children.find((t => t.index === e));
                                s && (s.visible = !1)
                            }))
                        }))
                    }
                    win(t) {
                        var e = this.game.config.get("slot.reels");
                        this.children.forEach((t => {
                            t.visible = !0
                        })), t.pos.forEach(((t, i) => {
                            var s = i + t * e,
                    ...
                    winScatters(t) {
                        ...
                        this.children.forEach((t => {
                            ...
                            t.pos.forEach((t => {
                                var i = t[0] + t[1] * e,
                                    s = this.children.find((t => t.index === i));
                                s && (s.visible = !1)
                            }))
                        }))
                    }
                    hide() {
                        this.removeChildren(), this.slot.reels.forEach((t => {
                            t.visible = !0
                        }))
                    }
                    removeUnusedSticky() {
                        this.children.forEach(((t, e) => {
                            t.renderable || this.removeChildAt(e)
                        }))
                    }
                    _update(t) {
                        this.children.forEach((t => {
                            ...
                            this.slot.getSymbolByPosition(t.pos[0], t.pos[1]).parentReel.visible = !1;
                            var e = this.children.find((e => e.index === t.pos[0] + t.pos[1] * this.game.config.get("slot.reels")));
                            e && (e.renderable = !0)
                        })), this.removeUnusedSticky()
                    }
                }
                class En extends(Gt(tt.j)) {
                    constructor() {
                        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : -1;
                ...
                class Wn extends En {
                    constructor(t) {
                        super(t), (0, n.Z)(this, "data", void 0), (0, n.Z)(this, "layoutType", void 0), (0, n.Z)(this, "symbolAnimation", void 0), (0, n.Z)(this, "isPlaying", !1), this.layoutType = "default", this.symbolAnimation = new Ts(this.game.loader.getAsset("symbolAnimation")), this.symbolAnimation.renderable = !1, this.replaceTexture(t)
                    }
                    replaceTexture(t) {
                        var e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                            i = arguments.length > 2 && void 0 !== arguments[2] && arguments[2];
                        ("bonus" === this.game.store.get("reward:feature") || "bonus" === this.game.store.get("server:action")) && $i.isBonus() && !e || i ? (t = "string" == typeof t ? t.slice(0, 1) : t, this.currentTextureIndex = 0 === t || -1 === t ? 0 : t >= 1 && t <= 5 ? 21 : t > 5 && t <= 50 ? 22 : "M" === t ? 23 : 24) : this.currentTextureIndex = +(t > -1 ? t : 0), this.data = this.game.config.get("slot.layout.".concat(this.layoutType, "[").concat(this.currentTextureIndex, "]"), null), this.texture = this.game.loader.getAsset(this.data.textureAtlas, this.data.assetName)
                    }
                    blur() {
                    ...
                    playAnimation(t) {
                        var e;
                        this.hide(), Zn.addChild(this.symbolAnimation);
                        var i = On(On({}, this.data.animation), t);
                        if (!(!this.visible || this.symbolAnimation.renderable && this.symbolAnimation.playing && this.symbolAnimation.skinName === i.skin && this.symbolAnimation.animationName === i.effectName)) {
                            this.isPlaying = !0, this.symbolAnimation.position.set(this.parentReel.x, this.parentReel.y), i.skin && this.symbolAnimation.changeSkin(i.skin);
                    ...
                    get isBonus() {
                        return 21 === this.currentTextureIndex || 22 === this.currentTextureIndex || 23 === this.currentTextureIndex || 24 === this.currentTextureIndex
                    }
                    clearAnimation() {
                        this.isPlaying && (this.show(), this.symbolAnimation.stop(), this.symbolAnimation.renderable = !1)
                    }
                    stopAnimation() {
                        this.isPlaying = !1, this.show(), this.symbolAnimation.stop(), this.symbolAnimation.renderable = !1, Zn.removeChild(this.symbolAnimation)
                    }
                    overlay() {
                        this.tint = 10000536
                    }
                ...
                class Fn extends(Gt(Y.W2)) {
                    ...
                    showSticky(t) {
                        ...
                        return (0, o.Z)((function*() {
                            var s = e.length > 1 && void 0 !== e[1] && e[1],
                                o = e.length > 3 && void 0 !== e[3] && e[3];
                            if (0 !== t.length) {
                                t.forEach((t => {
                                    if (t.isNew || s) {
                                        var e = i.slot.getReelByPosition(t.pos[0], t.pos[1]);
                                        e.renderable = !1, e.children.forEach((t => {
                                            t.visible = !1
                                        }));
                                        var o = "string" == typeof t.sym ? t.sym.slice(0, 1) : t.sym,
                                            n = 0 === o || -1 === o ? 0 : o >= 1 && o <= 5 ? 21 : o > 5 && o <= 50 ? 22 : "M" === o ? 23 : 24,
                                            a = i.game.config.get("slot.layout.default[".concat(n, "]")).assetName;
                                        i.stickyAnimation = i.stickyContainer.addChild(new Ts(i.game.loader.getAsset("symbolAnimation"))), i.stickyAnimation.position.set(e.x, e.y), i.stickyAnimation.changeSkin(a), i.stickyAnimation.play("idle"), i.showBonusText(t.sym, i.stickyAnimation)
                                    }
                                })), t.some((t => t.isNew)) && (yield i.game.helpers.delay(s ? 0 : 300));
                                var n = i.game.get("BonusWinText");
                                s ? n.updateAll(!0) : yield i.updateValues(t, o)
                            }
                        }))()
                    }
                    showBonusText(t, e) {
                        return (0, o.Z)((function*() {
                            var i = new Mn;
                            e.addChild(i);
                            var s = "string" == typeof t && "M" === t.slice(0, 1) ? "x".concat(t.slice(1)) : "string" == typeof t && 1 === t.length && "U" === t.slice(0, 1) ? "" : "string" == typeof t && 1 !== t.length && "U" === t.slice(0, 1) ? "x".concat(t.slice(1)) : "+".concat(t);
                            return i.text = s, i.position.set(e.width / 2, e.height / 2), i.type = "string" == typeof t ? "fs" : "mul", i.value = "string" == typeof t ? parseInt(t.slice(2) + t.slice(0, 2), 10) : t, i.renderable = !0, k.fromTo(i, .5, {
                                pixi: {
                                    scale: 1.5
                                }
                            }, {
                    ...
                    updateValues(t) {
                        ...
                        return (0, o.Z)((function*() {
                            ...
                            t.forEach((t => {
                                if (t.isNew) {
                                    var e = i.slot.getReelByPosition(t.pos[0], t.pos[1]),
                                        n = i.game.device.portrait && !i.game.device.desktop ? [-80, 835] : [1280, 200],
                                        a = i.game.device.portrait && !i.game.device.desktop ? [-80, 1025] : [1280, 350],
                                        h = i.game.device.portrait && !i.game.device.desktop ? [1280, 200] : [-200, 400],
                                        r = i.updateContainer.addChild(new Ts(i.game.loader.getAsset("assets/images/effects/symbols/symbolsMagic/skeleton.json")));
                                    r.position.set(e.x, e.y), r.play("win", !0);
                ...
                class In extends(Gt(Y.W2)) {
                    constructor(t, e) {
                        ...
                        }), this._spinTween = new k(this._symbolsContainer, Nt.config.get("wheel.durationSpin"), {
                            paused: !0,
                            roundProps: ["y"],
                            pixi: {
                                y: Nt.config.get("symbol.y")
                            },
                            ease: "Linear.easeNone",
                            repeat: -1,
                            repeatDelay: 0,
                            onRepeat: this._spin.bind(this)
                        }), this._endTween = new k(this._symbolsContainer, .01, {
                            paused: !0,
                            roundProps: ["y"],
                            pixi: {
                                y: Nt.config.get("wheel.deltaStop")
                    ...
                    start() {
                        ...
                        return (0, o.Z)((function*() {
                            ...
                            var e = Nt.config.get("slot.reels"),
                                i = Nt.store.get("reward:nReels", [])[t._reelIndex % e].concat();
                            ...
                            var s = Nt.quickSpin.enabled ? Nt.config.get("wheel.durationQuickDelta") : Nt.config.get("wheel.durationDelta");
                            t._endTween.duration(s), t._stopTimeoutDuration = Nt.quickSpin.enabled ? Nt.config.get("wheel.durationQuickStop") : Nt.config.get("wheel.durationStop"), t._startTween.restart()
                        }))()
                    }
                    stop() {
                        if (!this.isStop) {
                            var t = Nt.config.get("slot.reels"),
                                e = Nt.store.get("reward:nReels", []);
                            this._nReel = e[this._reelIndex % t].concat();
                            var i = Nt.store.get("reward:reels", []);
                            if (this._reel = [i[this._reelIndex % t][Math.floor(this._reelIndex / t)]], Nt.store.get("spin:isFast", !1)) Nt.action.emit("sound:spinFast"), clearTimeout(this._stopTimeout), this.isStop = !0;
                            else {
                                ...
                                this._stopTimeout = setTimeout((() => this.isStop = !0), Nt.quickSpin.enabled ? this._stopTimeoutDuration * (s + 1) : this._stopTimeoutDuration * o)
                            }
                        }
                    }
                    overlay() {
                    ...
                    _setup() {
                        var t = Nt.config.get("slot.reels"),
                            e = Nt.config.get("symbol.width"),
                            i = Nt.config.get("symbol.height"),
                            s = Nt.store.get("reward:nReels", []);
                        this._nReel = s[this._reelIndex % t].concat();
                        var o = Nt.store.get("reward:reels", []);
                        this._reel = [o[this._reelIndex % t][Math.floor(this._reelIndex / t)]];
                        var n = this._reelIndex % t * e,
                            a = Math.floor(this._reelIndex / t) * i;
                        this._symbolsContainer.addChild(new Wn(this._nReel[this.game.helpers.random(0, s.length - 1)])).position.set(0, 15 - i);
                        var h = this._symbolsContainer.addChild(new Wn(this._reel[0]));
                        h.position.set(0, 0), this._symbolsContainer.addChild(new Wn(this._nReel[this.game.helpers.random(0, s.length - 1)])).position.set(0, i - 15), this.visibleSymbols.push(h), this.rectMask = this.addChild(new u.TC), this.rectMask.alpha = 0, this.rectMask.beginFill(), this.rectMask.drawRect(63, 78, e, i - 14), this.rectMask.endFill(), this.x = n, this.y = a, this._startY = this._symbolsContainer.children[0].y, this.showNReel(!1)
                    }
                    _spin() {
                        if (this._flip(), this.isStop)
                            ...
                            } else this._symbolsContainer.y = 0, this._symbolsContainer.children[0].y = this._startY, this._updateVisibleSymbols(), this._spinTween.pause(), this._endTween.restart()
                    }
                    _flip() {
                    ...
                    _complete() {
                        this._symbolsContainer.y = 0, this._reel.length = 0, this._endTween.pause(), this.showNReel(!1), this.disableMask(), clearTimeout(this._stopTimeout), Nt.action.emit("wheel:stop", this._reelIndex)
                    }
                    update(t) {
                        var e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                            i = arguments.length > 2 && void 0 !== arguments[2] && arguments[2];
                ...
                class Dn extends yn {
                    constructor() {
                        super(), (0, n.Z)(this, "animation", void 0), (0, n.Z)(this, "reels", void 0), (0, n.Z)(this, "reelsContainer", void 0), (0, n.Z)(this, "stopReelCounter", void 0), (0, n.Z)(this, "symbolsPositions", void 0), (0, n.Z)(this, "textLineWin", void 0), (0, n.Z)(this, "textTotalWin", void 0), (0, n.Z)(this, "lines", void 0), (0, n.Z)(this, "slotData", void 0), (0, n.Z)(this, "grid", void 0), (0, n.Z)(this, "field", void 0), (0, n.Z)(this, "logo", void 0), (0, n.Z)(this, "gridAnimation", void 0), (0, n.Z)(this, "sticky", void 0), (0, n.Z)(this, "stickyBonus", void 0), (0, n.Z)(this, "textFreeRespin", void 0), (0, n.Z)(this, "bonusScale", void 0), (0, n.Z)(this, "isBonus", void 0), this.reels = [], this.symbolsPositions = this.game.config.get("slot.symbolsPositions", []), this.animation = new Cn(this), this.stopReelCounter = 0, this.init(), this.setupEvents()
                    }
                    init() {
                        var t, e;
                        this.reelsContainer = new Y.W2;
                        for (var i = this.game.config.get("slot.size[0]"), s = 0; s < i; s++) {
                            var o = this.symbolsPositions[s],
                                n = new In(s, o);
                            this.reels.push(n), this.reelsContainer.addChild(n)
                        }
                        this.slotData = {
                            reels: this.reels.map((t => t.visibleSymbols)),
                            lines: null !== (t = null === (e = this.game.server) || void 0 === e ? void 0 : e.response.lines) && void 0 !== t ? t : []
                        }, this.lines = new bn(this.slotData.lines.map((t => ({
                            color: 16763904,
                            width: 4,
                            padding: 125,
                            points: t.map(((t, e) => {
                                var i = this.getReelByPosition(e, t),
                                    s = this.getSymbolByPosition(e, t);
                                return {
                                    position: [i.x, i.y],
                                    size: [s.width, s.height]
                                }
                            }))
                        })))), this.textTotalWin = new fn(.9, "1.4"), this.textTotalWin.position.set(726, 700), this.textLineWin = new vn, this.textLineWin.scale.set(.5), this.grid = new tt.j(this.game.loader.getAsset("grid")), this.grid.position.set(-154, -6), this.field = new tt.j(this.game.loader.getAsset("field")), this.sticky = new Pn(this), this.stickyBonus = new Fn(this), this.bonusScale = new Sn, this.textFreeRespin = new kn, this.textFreeRespin.position.set(377, 410), this.logo = new tt.j(this.game.loader.getAsset("logo")), this.gridAnimation = new Ts(this.game.loader.getAsset("gridAnimation")), this.gridAnimation.x = -156, this.gridAnimation.play("animation", !0), this.addChild(this.bonusScale), this.addChild(this.field), this.addChild(this.reelsContainer), this.addChild(this.lines), this.addChild(this.grid), this.addChild(this.sticky), this.addChild(Zn), this.addChild(Rn), this.addChild(this.stickyBonus), this.addChild(this.textLineWin), this.addChild(this.textTotalWin), this.addChild(this.textFreeRespin), this.addChild(this.gridAnimation), this.addChild(this.logo)
                    }
                    setupEvents() {
                        var t = this;
                        this.game.action.on("state:ready_enter", this._onReadyEnter, this), this.game.action.on("state:spin_enter", this._onSpinEnter, this), this.game.action.on("state:stop_enter", this._onStopEnter, this), this.game.action.on("state:finish_enter", this._onFinishEnter, this), this.game.action.on("wheel:stop", this._onStopWheel, this), this.game.action.on("spin:fast", this._onFastStop, this), this.game.action.on("reward:reset", this._onResetReward, this), this.game.action.on("bonus:start", (0, o.Z)((function*() {
                            ...
                            this.animation.stop(), t.forEach(((t, e) => {
                                t.forEach(((t, i) => {
                                    this.getSymbolByPosition(e, i).replaceTexture(t, !0)
                                }))
                            }))
                        })), this.game.action.on("bonus:select_stop", (0, o.Z)((function*() {
                            t.stickyBonus.hide(), t.alpha = 1, t.field.alpha = 1, t.isBonus = !1, t.gridAnimation.alpha = 1, !t.game.device.desktop && t.game.device.portrait && t.scale.set(.8)
                        }))), this.game.action.on("bonus:select_start", (0, o.Z)((function*() {
                            t.field.alpha = 1, t.bonusScale.show(), t.sticky.hide(), t.animation.stop(), t.gridAnimation.alpha = 1, k.fromTo(t, .5, {
                                pixi: {
                                    alpha: 0
                                }
                            }, {
                            ...
                            }), t.isBonus = !0, !t.game.device.desktop && t.game.device.portrait && t.scale.set(.7)
                        })))
                    }
                    _onReadyEnter() {
                        var t = this;
                        return (0, o.Z)((function*() {
                            "respin" === t.game.store.get("server:nextAction") || t.game.autoPlay.enabled ? setTimeout((() => {
                                t.game.action.emit("spin:start")
                            }), Ji.get("before_spin_auto")) : $i.isBonus() ? setTimeout((() => {
                                t.game.action.emit("spin:start")
                            }), 500) : 0 !== t.game.store.get("reward:lines", []).length && "init" !== t.game.store.get("server:action") || t.runSymbolAnimation({
                                animationName: "idle"
                            })
                        }))()
                    }
                    ...
                    _onSpinEnter() {
                        var t = this;
                        return (0, o.Z)((function*() {
                            t.lines.disable(), t.animation.stop(), t.sticky.removeUnusedSticky();
                            try {
                                "respin" === t.game.store.get("server:nextAction") && (yield t.textFreeRespin.show()), yield t.game.beforeSpin(), t.updateBonusLeft(), $i.isBonus() && t.bonusScale.update(t.game.store.get("bonus:left", 0) - 1), yield Promise.all([...t.reels.map((t => t.start())), yield t.requestSpin()]), t.game.state.goTo("stop")
                            } catch (e) {
                    ...
                    _onStopEnter() {
                        this.reels.forEach((t => t.stop())), Nt.action.emit("wheel:stop_down")
                    }
                    _onFastStop() {
                    ...
                    _onFinishEnter() {
                        var t = this;
                        return (0, o.Z)((function*() {
                            t.stopReelCounter = 0, $i.set(t.game.store.get("reward:feature")), "respin" !== t.game.store.get("server:nextAction") && "bonus" !== t.game.store.get("server:nextAction") && (yield t.game.freeRound.finish()), t.game.autoPlay.enabled ? t.game.checkBalance().then((() => {
                    ...
                    _onStopWheel(t) {
                        var e = this;
                        return (0, o.Z)((function*() {
                            var i = e.game.store.get("sticky", []);
                            try {
                                e.stopReelCounter++, !e.isBonus && e.reels[t].visible && e.reels[t].visibleSymbols[0].playAnimation("wheelStop"), e.stopReelCounter >= e.reels.length && (e.game.afterReelsStop(), $i.isBonus() && (e.game.store.get("bonus:winAdditional", !1) || e.bonusScale.update(e.game.store.get("bonus:left", 0))), e.isBonus || (yield e.game.helpers.delay(100 * e.game.config.get("slot.reels"))), 0 !== i.length && (yield e.sticky.showSticky(i)), e.game.state.goTo("reward"))
                            } catch (t) {
                    ...
                    beforeFreeSpinsPopup() {
                        this.alpha = 0, this.field.alpha = 0, this.gridAnimation.alpha = 0
                    }
                    resize() {
                        this.game.device.desktop || this.game.device.landscape ? (this.scale.set(1), this.field.position.set(-160, 0), this.position.set(155, 4), this.logo.scale.set(1), this.logo.position.set(420, -23), this.gridAnimation.renderable = !0) : (this.isBonus ? this.scale.set(.7) : this.scale.set(.8), this.field.position.set(-160, 0), this.position.set(-30, 380), this.logo.scale.set(2), this.logo.position.set(160, -134), this.gridAnimation.renderable = !1)
                    }
                }
                class Ln extends(Gt(Y.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "timeline", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "value", void 0), (0, n.Z)(this, "light", void 0), (0, n.Z)(this, "coins", void 0), (0, n.Z)(this, "onPress", void 0), this.visible = !1, this.interactive = !0, this.onPress = new(x()), this.game.interaction.click(this, (() => this.onPress.dispatch())), this.timeline = new B, this.content = new Y.W2, this.overlay = new $t(.75), this.title = new tt.j, this.title.anchor.set(.5), this.title.alpha = 0, this.value = new b.Xz("", {
                            fontName: "WinFont"
                        }), this.value.anchor = .5, this.light = new Ts(this.game.loader.getAsset("effectBigWin")), this.light.alpha = 0, this.coins = new Ts(this.game.loader.getAsset("effectGiantWin")), this.coins.alpha = 0, this.content.addChild(this.title), this.content.addChild(this.value), this.addChild(this.overlay), this.addChild(this.light), this.addChild(this.coins), this.addChild(this.content)
                    }
                    show(t, e) {
                        var i = this;
                        return (0, o.Z)((function*() {
                            var s = 0;
                            t === we ? (s = 9, i.game.action.emit("sound:bigWin")) : t === xe && (s = 18, i.game.action.emit("sound:giantWin")), i.title.texture = i.game.loader.getAsset("textBigWin");
                            var o = !1;
                            return new Promise((n => {
                                ...
                                i.timeline.to(i.value, .5, {
                                    ...
                                    onUpdate: () => {
                                        !o && t === xe && a.coins > e / 2 && (i.title.texture = i.game.loader.getAsset("textGiantWin"), o = !0, i.coins.play("animation", !0), i.coins.alpha = 1, k.to(i.value, s / 2, {
                                            pixi: {
                                                scale: 1
                                            }
                ...
                new class extends class extends class extends class {
                    constructor(t) {
                        ...
                        (0, n.Z)(this, "rootNode", void 0), (0, n.Z)(this, "renderer", void 0), (0, n.Z)(this, "logger", void 0), (0, n.Z)(this, "i18n", void 0), (0, n.Z)(this, "helpers", void 0), (0, n.Z)(this, "keyboard", void 0), (0, n.Z)(this, "device", void 0), (0, n.Z)(this, "viewport", void 0), (0, n.Z)(this, "leftHand", void 0), (0, n.Z)(this, "fullscreen", void 0), (0, n.Z)(this, "visibility", void 0), (0, n.Z)(this, "preferences", void 0), (0, n.Z)(this, "sound", void 0), (0, n.Z)(this, "state", void 0), (0, n.Z)(this, "store", void 0), (0, n.Z)(this, "action", void 0), (0, n.Z)(this, "config", void 0), (0, n.Z)(this, "loader", void 0), (0, n.Z)(this, "error", void 0), (0, n.Z)(this, "interaction", void 0), (0, n.Z)(this, "popupManager", void 0), (0, n.Z)(this, "externalApi", void 0), (0, n.Z)(this, "_globals", new Map), (0, n.Z)(this, "settings", {
                            ...
                            C.removeEventListener("tick", this.tick), it.vB.shared.destroy(), st.destroyTextureCache(), this.renderer.destroy(), this.loader.destroy()
                        })), Nt = this, it.vB.shared.autoStart = !1, it.vB.shared.stop(), this.config = new rt(It), this.logger = new Ct, this.rootNode = this.createRootNode(), this.renderer = new Pt, this.i18n = new yt(e), this.helpers = new vt(this.config), this.keyboard = new xt, this.device = new At(this.renderer), this.viewport = new Wt, this.leftHand = new pt, this.fullscreen = this.device.ios || this.device.iPadPro ? new ct : new ut(this.device), this.visibility = new zt, this.preferences = new Vt, this.sound = new R(this.device, this.visibility, this.preferences), this.state = new Rt, this.store = new rt, this.action = new mt, this.loader = new Bt(this.device), this.error = new bt, this.interaction = new ft(this.device), this.externalApi = new Ft(this), this.popupManager = new jt(this.rootNode), this.create(), this.initAnalytics()
                    }
                    initAnalytics() {
                        return (0, o.Z)((function*() {
                            try {
                    ...
                    create() {
                        ...
                        C.addEventListener("tick", this.tick), window.addEventListener("unload", this.destroy), window.addEventListener("resize", e), window.addEventListener("load", e), window.addEventListener("orientationchange", (() => setTimeout(e, 350))), document.addEventListener("keydown", (t => {
                    ...
                    initPopups() {
                        this.popupManager.add([new Li, new Fi, new Ii, new Ri, new _i, new Mi, new ji, new Ni, new Di, new Wi, new Ui])
                    }
                    loadAssets(t) {
                    ...
                    connect(t) {
                        var e = this;
                        return (0, o.Z)((function*() {
                            e.launcher = e.rootNode.addChild(new fi);
                            try {
                    ...
                    constructor() {
                        super({}), (0, n.Z)(this, "autoPlaySettings", void 0), (0, n.Z)(this, "betSettings", void 0), (0, n.Z)(this, "introScreen", void 0), (0, n.Z)(this, "bigWinAnimation", void 0), (0, n.Z)(this, "fastStopLayout", void 0), (0, n.Z)(this, "gameRules", void 0), (0, n.Z)(this, "menu", void 0), (0, n.Z)(this, "paytable", void 0), (0, n.Z)(this, "bonusWinText", void 0), (0, n.Z)(this, "bonusOverlay", void 0), (0, n.Z)(this, "bonusTotalWin", void 0), (0, n.Z)(this, "slot", void 0), (0, n.Z)(this, "background", void 0), ns.init(), this.init(Qi, Xi)
                    }
                    loadTranslations() {
                    ...
                    showIntroScreen() {
                        ...
                        return (0, o.Z)((function*() {
                            var e;
                            if (t.background = t.rootNode.addChild(new Zs), null === (e = t.sound.get("backgroundNormal")) || void 0 === e || e.fade(2), t.preferences.get("showIntroScreen", !0) && "bonus" !== t.server.response.feature && "respin" !== t.server.response.nextAction) return t.background.bgIntro.visible = t.device.desktop || t.device.landscape, t.introScreen = t.rootNode.addChild(new Ro), t.introScreen.play()
                        }))()
                    }
                    initModules(t) {
                        super.initModules(t), this.wallet = new Cs(this.server), this.sound = new as(this.device, this.visibility, this.preferences)
                    }
                    initViews() {
                        var t, e, i, s, n, a = this;
                        super.initViews(), $i.set(null !== (t = null === (e = this.server) || void 0 === e || null === (i = e.response) || void 0 === i ? void 0 : i.feature) && void 0 !== t ? t : Ki.Basic), this.background.bgIntro.visible = !1, this.slot = this.rootNode.addChild(new Dn), this.riskFeature = this.rootNode.addChild(new gn), this.bonusTotalWin = new ks, this.rootNode.addChild(this.bonusTotalWin), this.bonusWinText = this.slot.addChild(new Bs), this.paytable = new Ko(null !== (s = null === (n = this.server) || void 0 === n ? void 0 : n.response.lines) && void 0 !== s ? s : []), this.gameSettings = new Ve, this.config.get("quickSpin.available", !0) && this.gameSettings.addItem(this.createQuickSpinCheckbox()), this.gameSettings.addItem(this.createFullscreenCheckbox()), this.gameSettings.addItem(this.createLeftHandCheckbox()), this.gameSettings.addItem(this.createGameSoundsCheckbox()), this.gameSettings.addItem(this.createBackgroundSoundsCheckbox()), this.gameSettings.addItem(this.createIntroScreenCheckbox()), this.gameSettings.addItem(this.createRiskFeatureCheckbox()), this.bigWinAnimation = new Ln, this.fastStopLayout = new Oe, this.controls = this.device.desktop ? new vo : new fo, this.betSettings = this.rootNode.addChild(new Te), this.betSettings.setBets(this.betLevel.bets, this.betLevel.betCoins), this.betSettings.setPayLines("15"), this.betSettings.setBet(this.betLevel.bet), this.autoPlaySettings = this.rootNode.addChild(new ce), this.autoPlaySettings.setAutoPlayCounts(this.autoPlay.counts), this.autoPlaySettings.stopSection.addItem(new ke), this.autoPlaySettings.stopSection.addItem(new ye), this.autoPlaySettings.stopSection.addItem(new be), this.autoPlaySettings.stopSection.addItem(new ve), this.gameRules = new _e, this.menu = new He, this.menu.addItem(this.loader.getAsset("iconPaytable"), this.paytable), this.menu.addItem(this.loader.getAsset("iconSettings"), this.gameSettings), this.menu.addItem(this.loader.getAsset("iconRules"), this.gameRules), this.rootNode.addChild(this.fastStopLayout), this.rootNode.addChild(this.menu), this.rootNode.addChild(this.controls), this.rootNode.addChild(this.bigWinAnimation), this.bonusOverlay = this.rootNode.addChild(new Rs), this.paytable.updateBet(this.betLevel), this.controls.updateBet(this.betLevel), this.betSettings.on("open", (() => {
                            ...
                            this.betLevel.set(this.betLevel.bets.indexOf(t)), this.riskFeature.show(this.betLevel.bet), this.slot.sticky.hide()
                            ...
                            if (a.action.emit("sound:click"), a.onPopupShow(), a.riskFeature.hide(), a.wallet.balance - a.store.get("buy").bet < 0) yield a.popupManager.show("PopupZeroBalance"), a.onPopupHide();
                                ...
                                try {
                                    ...
                                    }), $i.set(a.store.get("reward:feature", Ki.Basic)), a.onRNBStart(), a.slot.bonusScale.update(a.store.get("bonus:left", 0), !0), yield a.checkBonus(), setTimeout((() => {
                            ...
                            this.riskFeature.hide(), this.riskFeature.updateCurrentBet(this.betLevel.bet), this.autoPlay.enabled && $i.isBasic() && "respin" !== this.store.get("server:nextAction") && (this.autoPlay.setCount(this.autoPlay.count - 1), this.controls.setAutoPlayCount(this.autoPlay.count)), this.controls.onSpinEnter()
                    ...
                    beforeFreeSpinsPopup() {
                        this.bonusWinText.reset(), this.slot.bonusScale.hide(), this.slot.beforeFreeSpinsPopup(), this.controls.beforeFreeSpinsPopup()
                    }
                    start() {
                        var t = () => super.start,
                            e = this;
                        return (0, o.Z)((function*() {
                            ...
                            var i = "bonus" === e.store.get("reward:feature"),
                                s = e.store.get("sticky", []);
                            yield e.freeRound.start(), "respin" === e.store.get("server:nextAction") && (yield e.popupManager.show("PopupRestore")), e.state.goTo("setup"), i ? yield e.checkBonus(!0): yield e.slot.sticky.showSticky(s, !0), e.state.goTo("ready")
                        }))()
                    }
                    reward() {
                        var t = this,
                        ...
                        return (0, o.Z)((function*() {
                            var o;
                            e(), null !== (o = t.bigWin) && void 0 !== o && o.available(t.wallet.coins) && !$i.isBonus() && "respin" !== t.store.get("server:nextAction") && (t.bigWinAnimation.press(i), t.controls.pressButtonSpin(i), yield t.bigWinAnimation.show(t.bigWin.type(t.wallet.coins), t.wallet.coins), t.sound.stopBigWin(), e());
                            var a = t.store.get("reward:lines", []).concat(),
                                h = t.store.get("reward:scatters", !1),
                                r = t.store.get("bonus:bonuses", []),
                                l = r.filter((t => t.isNew)),
                                d = t.store.get("bonus:winAdditional", !1),
                                c = t.store.get("bonus:additionalCount", 0),
                                u = t.store.get("bonus:left", 0);
                            t.store.get("sticky", []);
                            if ("respin" !== t.store.get("server:nextAction")) {
                                if (a.length > 0 || h ? (t.controls.disableButtonSpin(), t.slot.textTotalWin.once("show", (() => {
                                        t.fastStopLayout.press(n, !1), t.controls.pressButtonSpin(n)
                                    })), yield t.slot.animation.mixPayment(a, h), t.store.get("bonus:isStart") && (yield t.slot.animation.scatterPayment(h)), e()) : a.length > 0 && (t.controls.disableButtonSpin(), t.slot.textTotalWin.once("show", (() => {
                                        t.fastStopLayout.press(n, !1), t.controls.pressButtonSpin(n)
                                    })), yield t.slot.animation.allPayment(a), e()), l.length > 0 && !t.store.get("bonus:isStart", !1) && (t.controls.disableButtonSpin(), t.controls.updateBonusLeft(d ? u - c : u), t.slot.bonusScale.update(d ? u - c : u, !1, d, c), yield t.slot.animation.bonusPayment(l), yield t.slot.stickyBonus.showSticky(r, !1, !1, t.store.get("bonus:isEnd")), t.store.get("bonus:winAdditional", !1) && (t.slot.bonusScale.update(u), t.controls.updateBonusLeft(u), t.action.emit("sound:bonusScaleUpdate"))), t.store.get("bonus:isEnd") && t.wallet.bonusCoins > 0) {
                                    var p = t.store.get("bonus:multiplier", 0),
                                        g = t.store.get("bonus:modificator", 0);
                                    yield t.helpers.delay(1e3), t.store.get("bonus:left", 0) > 0 && (t.device.desktop ? t.controls.textBonusLeft.hide() : t.controls.statusBar.update({
                                        type: Ke.BonusLeft,
                                        value: -1
                                    }), yield t.bonusWinText.bonusLeftToModificators()), yield t.bonusWinText.totalWin(), t.bonusWinText.reset(), t.slot.bonusScale.reset(), t.bonusTotalWin.press(s), t.controls.pressButtonSpin(s), t.bonusTotalWin.onBeforeEnd.once((() => {
                                        t.action.emit("update:win", t.wallet.dropCoins, t.wallet.totalCoins), t.sound.stopBonusTotalWin()
                                    })), t.bonusTotalWin.onBeforeEnd.once((() => {
                                        t.action.emit("update:win", t.wallet.dropCoins, t.wallet.totalCoins)
                                    })), yield t.bonusTotalWin.show(t.wallet.bonusCoins, 0 === g ? p : g * p), e()
                                }
                                t.bonusTotalWin.hide(), yield t.checkBonus(), t.slot.animation.complete(), t.action.emit("update:balance"), t.state.goTo("finish")
                            } else t.state.goTo("finish")
                        }))
                    }
                    checkBonus() {
                        var t = arguments,
                        ...
                        return (0, o.Z)((function*() {
                            ...
                            if (i) e.action.emit("update:win", e.wallet.dropCoins, e.freeRound.enabled && $i.isBonus() ? e.wallet.preSpinTotalCoins : e.wallet.totalCoins), yield e.slot.stickyBonus.showSticky(s, !0), e.beforeFreeSpinsPopup(), yield e.bonusOverlay.show(Ps.RESTORE), e.bonusWinText.updateAll(!0);
                            else if (e.store.get("bonus:isStart", !1)) {
                                var o = s.filter((t => t.isNew));
                                e.bonusWinText.reset(), e.slot.bonusScale.update(e.store.get("bonus:left", 0), !0), e.beforeFreeSpinsPopup(), yield e.bonusOverlay.show(Ps.START), e.action.emit("update:balance"), yield e.slot.animation.bonusPayment(o), yield e.slot.stickyBonus.showSticky(s), e.bonusWinText.updateAll(!0)
                            } else e.store.get("bonus:isEnd", !1) && (e.bonusWinText.reset(), e.beforeFreeSpinsPopup(), yield e.bonusOverlay.show(Ps.END))
                        }))()
                    }
                    checkBalance() {
                        var t = this;
                    ...
                    beforeSpin() {
                        var t = this;
                        return (0, o.Z)((function*() {
                            t.autoPlay.enabled || $i.isBonus() || "respin" === t.store.get("server:nextAction") || (yield t.quickSpin.tryEnable())
                        }))()
                    }
                    afterReelsStop() {
    ...
    n.m = s, t = [], n.O = (e, i, s, o) => {
    ...
    }), t), n.o = (t, e) => Object.prototype.hasOwnProperty.call(t, e), e = {}, i = "la_fiesta_de_muertos:", n.l = (t, s, o, a) => {
        if (e[t]) e[t].push(s);
        else {
            var h, r;
            if (void 0 !== o)
        ...
        var e = (e, i) => {
            ...
            i = self.webpackChunkla_fiesta_de_muertos = self.webpackChunkla_fiesta_de_muertos || [];
        i.forEach(e.bind(null, 0)), i.push = e.bind(null, i.push.bind(i))
    })();
    var a = n.O(void 0, [216], (() => n(6554)));
    a = n.O(a)
})();