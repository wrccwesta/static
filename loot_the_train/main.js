...
(() => {
    var t, e, i, s = {
            1512: (t, e, i) => {
                ...
                }(0, n.Z)(M, "extension", c.n.Loader), (0, n.Z)(M, "supportedSoundExtensions", ["mp3"]);
                i(1293);
                var W, F = i(9534),
                    I = i(1162),
                    D = i(1368),
                ...
                class U {
                    ...
                    readSkeletonData(t, e) {
                        var i = new F.BinaryInput(e);
                        i.readString();
                        var s = i.readString(),
                            o = _(s),
                            n = null;
                        if (o === W.VER38 && (n = new j.SkeletonBinary(new j.AtlasAttachmentLoader(t))), (i = new F.BinaryInput(e)).readInt32(), i.readInt32(), (o = _(s = i.readString())) !== W.VER40 && o !== W.VER41 || (n = new L.SkeletonBinary(new L.AtlasAttachmentLoader(t))), !n) {
                ...
                class V {
                    ...
                    readSkeletonData(t, e) {
                        var i = e.skeleton.spine,
                            s = _(i),
                            o = null;
                        if (s === W.VER37 && (o = new D.SkeletonJson(new D.AtlasAttachmentLoader(t))), s === W.VER38 && (o = new j.SkeletonJson(new j.AtlasAttachmentLoader(t))), s !== W.VER40 && s !== W.VER41 || (o = new L.SkeletonJson(new L.AtlasAttachmentLoader(t))), !o) {
                ...
                var G = i(512),
                    ...
                    et = i(798),
                    it = i(5277);
                u.TC.nextRoundedRectBehavior = !0, A.xv.nextLineHeightBehavior = !0, c.R.add(p.bx, g.B9, d.Bv, a.c, h.Q, r.T, l.O, b.vl, m.o, z, y, M), window.PIXI = s;
                var st = i(3233),
                    ot = i.n(st);
                ...
                class Pe extends A.xv {
                    ...
                    getTagRegex(t, e) {
                        ...
                        var o = s === Be ? "\\".concat(Ce.bbcode[0]).concat(i, "(?:\\=(?:[A-Za-z0-9_\\-\\#]+|'(?:[^']+|\\\\')*'))*\\s*\\").concat(Ce.bbcode[1], "|\\").concat(Ce.bbcode[0], "\\/").concat(i, "\\s*\\").concat(Ce.bbcode[1]) : "\\".concat(Ce.xml[0]).concat(i, "(?:\\s+[A-Za-z0-9_\\-]+=(?:\"(?:[^\"]+|\\\\\")*\"|'(?:[^']+|\\\\')*'))*\\s*\\").concat(Ce.xml[1], "|\\").concat(Ce.xml[0], "\\/").concat(i, "\\s*\\").concat(Ce.xml[1]);
                    ...
                    _getTextDataPerLine(t) {
                        ...
                        return i[i.length - 1].map((t => {
                            t.text.includes(Ce[v][0]) && (t.text = t.text.match(v === Be ? /^(.*)\[/ : /^(.*)\</)[1])
                        })), i
                    }
                    getFontString(t) {
                                ...
                                for (var k = 0; k < x.length; k++) {
                                    ...
                                    if (0 === B.letterSpacing) f.push({
                                        ...
                                        for (var R = 0; R < C.length; R++) {
                                            ...
                                            var M = this.context.measureText(C.charAt(R)).width;
                                            f.push({
                                                text: C.charAt(R),
                                                style: B,
                                                x: S,
                                                ...
                                                descent: P.descent,
                                                tag: O
                                            }), S += M, (R < C.length - 1 || k < x.length - 1) && (S += B.letterSpacing / 2)
                                        }
                                    }
                                }
                                y += a[w] - n[w]
                ...
                class Re extends(zt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "content", void 0), this.title = this.addChild(new Ze(this.game.i18n.t("GameRulesAdvancedAutoPlayTitle"))), this.content = this.addChild(new Oe(this.game.i18n.t("GameRulesAdvancedAutoPlayContent")))
                    }
                    resize() {
                ...
                class Me extends(zt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "content", void 0), this.title = this.addChild(new Ze(this.game.i18n.t("GameRulesAutoPlayTitle"))), this.content = this.addChild(new Oe(this.game.i18n.t("GameRulesAutoPlayContent")))
                    }
                    resize() {
                        this.content.position.set(0, this.title.y + this.title.height + 30)
                    }
                ...
                class We extends(zt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "content", void 0), this.content = this.addChild(new Oe(this.game.i18n.t("GameRulesBestExperience")))
                    }
                    resize() {
                        this.content.position.set(0, 0)
                    }
                }
                class Fe extends(zt($.j)) {
                    constructor() {
                ...
                class Ie extends(zt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "gameName", void 0), (0, n.Z)(this, "gameTRTP", void 0), this.title = this.addChild(new Ze(this.game.i18n.t("GameRulesGeneralTitle"))), this.gameName = this.addChild(new Oe(this.game.config.get("gameName")));
                        var t = this.game.config.get("trtp");
                        this.gameTRTP = this.addChild(new Oe(this.game.i18n.t("GameRulesGeneralRTP", t))), this.gameTRTP.visible = !!t
                    }
                    resize() {
                ...
                class De extends(zt(Q.W2, {
                    ...
                    constructor(t, e, i) {
                        super(), (0, n.Z)(this, "icon", void 0), (0, n.Z)(this, "text", void 0), this.name = i, this.icon = this.addChild(new $.j(e)), this.text = this.addChild(new Oe(t))
                    }
                    resize() {
                ...
                class je extends(zt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "content", void 0), this.title = this.addChild(new Ze(this.game.i18n.t("GameRulesInterfaceTitle"))), this.content = this.addChild(new Oe(this.game.i18n.t("GameRulesInterfaceContent"))), this.addItems()
                    }
                    addItems() {
                ...
                class Le extends(zt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "itemQuickSpin", void 0), (0, n.Z)(this, "itemFullscreen", void 0), (0, n.Z)(this, "itemGameSound", void 0), (0, n.Z)(this, "itemBackgroundSound", void 0), this.title = this.addChild(new Ze(this.game.i18n.t("GameRulesSettingsTitle"))), this.content = this.addChild(new Oe(this.game.i18n.t("GameRulesSettingsContent"))), this.game.config.get("quickSpin.available", !0) && (this.itemQuickSpin = this.addChild(new Oe(this.game.i18n.t("GameRulesSettingsContentItemQuickSpin")))), this.itemFullscreen = this.addChild(new Oe(this.game.i18n.t("GameRulesSettingsContentItemFullscreen"))), this.itemGameSound = this.addChild(new Oe(this.game.i18n.t("GameRulesSettingsContentItemGameSound"))), this.itemBackgroundSound = this.addChild(new Oe(this.game.i18n.t("GameRulesSettingsContentItemBackgroundSound")))
                    }
                    resize() {
                        var t;
                ...
                class Ne extends(zt(Q.W2)) {
                    constructor() {
                        var t, e;
                        super(), (0, n.Z)(this, "content", void 0), this.content = this.addChild(new Oe("".concat(null !== (t = window.RELEASE_VERSION) && void 0 !== t ? t : "", "\n").concat(null !== (e = window.RELEASE_DATE) && void 0 !== e ? e : "")))
                    }
                    resize() {
                        var t;
                ...
                class _e extends(zt(Q.W2)) {
                    ...
                    addSections() {
                        this.content.addChild(new Ie), this.content.addChild(new je), this.content.addChild(new Le), this.addAutoPlaySection(), this.content.addChild(new Fe), this.content.addChild(new We), this.content.addChild(new Ne)
                    }
                    addAutoPlaySection() {
                ...
                var qe = {
                    ...
                    Je = Ye(Ye({}, qe), {}, {
                        value: Ye(Ye({}, qe.value), {}, {
                            fill: 16777215
                        })
                    });
                class $e extends(zt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "state", void 0), (0, n.Z)(this, "textBet", void 0), (0, n.Z)(this, "textWin", void 0), (0, n.Z)(this, "textBalance", void 0), (0, n.Z)(this, "textFreeRound", void 0), (0, n.Z)(this, "textFree", void 0), (0, n.Z)(this, "textTotalWin", void 0), (0, n.Z)(this, "textBonus", void 0), (0, n.Z)(this, "delimiter", void 0), this.state = Ke.Normal, this.textBet = new Pe("", Ye(Ye({}, qe), {}, {
                            default: Ye(Ye({}, qe.default), {}, {
                                align: "left"
                            })
                        })), this.textBet.anchor.set(0, 0), this.textWin = new Pe("", qe), this.textWin.anchor.set(.5, 0), this.textBalance = new Pe("", Ye(Ye({}, qe), {}, {
                            default: Ye(Ye({}, qe.default), {}, {
                                align: "right"
                            })
                        })), this.textBalance.anchor.set(1, 0), this.textFreeRound = new Pe("", Ye(Ye({}, qe), {}, {
                            default: Ye(Ye({}, qe.default), {}, {
                                align: "center",
                                wordWrap: !0,
                                wordWrapWidth: 300
                            })
                        })), this.textFreeRound.anchor.set(1, 1), this.textFree = new Pe("", Ye(Ye({}, Je), {}, {
                            default: Ye(Ye({}, Je.default), {}, {
                                fontSize: 30,
                                wordWrapWidth: 340
                            })
                        })), this.textFree.anchor.set(0, 1), this.textTotalWin = new Pe("", Ye(Ye({}, Je), {}, {
                            default: Ye(Ye({}, Je.default), {}, {
                                fontFamily: "Avenir-Bold",
                                fill: this.game.config.get("colors.primary"),
                                fontSize: 30,
                            ...
                            value: Ye(Ye({}, Je.value), {}, {
                                fill: this.game.config.get("colors.primary")
                            })
                        })), this.textTotalWin.anchor.set(.5, 1), this.textBonus = new Pe("", Ye(Ye({}, Je), {}, {
                            default: Ye(Ye({}, Je.default), {}, {
                                fontSize: 27,
                                wordWrapWidth: 340
                            })
                        })), this.textBonus.anchor.set(0, 1), this.delimiter = new He(16777215, .5), this.addChild(...[this.textBet, this.textWin, !this.game.config.get("balanceHide", !1) && this.textBalance, this.textFreeRound, this.textFree, this.textTotalWin, this.textBonus, this.delimiter].filter(Boolean)), this.game.freeRound.onStart.once((() => {
                    ...
                    resize() {
                        var t = this.state === Ke.Free,
                            e = this.state === Ke.Bonus;
                    ...
                    changeState(t) {
                        this.state = t, t === Ke.Free ? (this.textFree.visible = !0, this.textTotalWin.visible = !0, this.textWin.visible = !0, this.textBonus.visible = !1, this.visible = !0) : t === Ke.Normal ? (this.textFree.visible = !1, this.textTotalWin.visible = !1, this.textWin.visible = !0, this.textBonus.visible = !1, this.visible = !0) : t === Ke.Bonus && (this.textBonus.visible = !0, this.textTotalWin.visible = !0, this.textWin.visible = !1, this.visible = !0), this.resize()
                    }
                }
                var ti = {
                    counts: [10, 25, 50, 100, 150, 300, 1 / 0]
                };
                class ei extends it.EventEmitter {
                    constructor() {
                ...
                class ni {
                    constructor(t) {
                        (0, n.Z)(this, "watcher", void 0), (0, n.Z)(this, "enabled", !1), (0, n.Z)(this, "onToggle", new(x())), (0, n.Z)(this, "onTryEnable", new(x())), this.config = t, this.watcher = new oi(t)
                    }
                    get available() {
                ...
                class Ei extends A.xv {
                    constructor(t) {
                        super(t, function(t) {
                            for (var e = 1; e < arguments.length; e++) {
                                var i = null != arguments[e] ? arguments[e] : {};
                                e % 2 ? Pi(Object(i), !0).forEach((function(e) {
                                    (0, n.Z)(t, e, i[e])
                                })) : Object.getOwnPropertyDescriptors ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(i)) : Pi(Object(i)).forEach((function(e) {
                                    Object.defineProperty(t, e, Object.getOwnPropertyDescriptor(i, e))
                                }))
                            }
                            return t
                ...
                const Zi = class extends Dt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupFreeRound"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "icon", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContinue", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt, this.content = new Q.W2, this.icon = new Ci(fi), this.icon.anchor.x = .5, this.title = new Oi(this.game.i18n.t("PopupFreeRoundStartTitle")), this.title.anchor.x = .5, this.message = new Ei("", {
                            wordWrap: !0,
                            wordWrapWidth: 600
                ...
                const Ri = class extends Dt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupMaxLimit"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContinue", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt(.7), this.content = new Q.W2, this.background = new $.j(this.game.loader.getAsset(Si)), this.background.anchor.set(.5), this.background.interactive = !0, this.background.name = "PopupBackground", this.title = new Oi(this.game.i18n.t("PopupMaxLimitTitle")), this.title.anchor.x = .5, this.message = new Ei(this.game.i18n.t("PopupMaxLimitMessage"), {
                            wordWrap: !0
                ...
                const Mi = class extends Dt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupNetworkError"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "icon", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionReload", void 0), (0, n.Z)(this, "_resolver", null), this.overlay = this.addChild(new Jt), this.content = this.addChild(new Q.W2), this.icon = new Ci(wi), this.icon.anchor.x = .5, this.title = new Oi(this.game.i18n.t("PopupNetworkErrorTitle"), {
                            align: "center"
                ...
                class Wi extends Dt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupQuickSpin"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionEnable", void 0), (0, n.Z)(this, "actionClose", void 0), (0, n.Z)(this, "escKey", void 0), (0, n.Z)(this, "enterKey", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt(.7), this.content = new Q.W2, this.background = new $.j(this.game.loader.getAsset(Si)), this.background.anchor.set(.5), this.background.interactive = !0, this.background.name = "PopupBackground", this.title = new Oi(this.game.i18n.t("PopupQuickSpinTitle")), this.title.anchor.x = .5, this.message = new Ei(this.game.i18n.t("PopupQuickSpinMessage"), {
                            fontSize: 35,
                            wordWrap: !0,
                            wordWrapWidth: 600
                ...
                const Fi = class extends Dt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupRestore"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "icon", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContinue", void 0), (0, n.Z)(this, "resolver", null), this.overlay = this.addChild(new Jt), this.content = this.addChild(new Q.W2), this.icon = new Ci(fi), this.icon.anchor.x = .5, this.message = new Ei(this.game.i18n.t("PopupRestoreMessage"), {
                            wordWrap: !0,
                            wordWrapWidth: 320
                        }), this.message.anchor.x = .5, this.actionContinue = new Bi(this.game.i18n.t("PopupActionContinue"), {
                            fill: 16777215
                ...
                const Ii = class extends Dt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupRiskNBuy"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionYes", void 0), (0, n.Z)(this, "actionNo", void 0), (0, n.Z)(this, "escKey", void 0), (0, n.Z)(this, "enterKey", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt(.7), this.content = new Q.W2, this.background = new $.j(this.game.loader.getAsset(Si)), this.background.anchor.set(.5), this.background.interactive = !0, this.background.name = "PopupBackground", this.title = new Oi("RISK FEATURE"), this.title.anchor.x = .5, this.message = new Ei("", {
                            wordWrap: !0,
                            whiteSpace: "normal",
                            breakWords: !0
                ...
                const Di = class extends Dt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupSound"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "icon", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContainer", void 0), (0, n.Z)(this, "actionYes", void 0), (0, n.Z)(this, "actionNo", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt, this.content = new Q.W2, this.icon = new Ci(xi), this.icon.anchor.x = .5, this.message = new Ei(this.game.i18n.t("PopupSoundMessage"), {
                            wordWrap: !0
                        }), this.message.anchor.x = .5, this.actionContainer = new Q.W2, this.actionYes = new Bi(this.game.i18n.t("PopupActionYes"), {
                            fill: 16777215
                ...
                const ji = class extends Dt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupSpendingBudget"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContinue", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt(.7), this.content = new Q.W2, this.background = new $.j(this.game.loader.getAsset(Si)), this.background.anchor.set(.5), this.background.interactive = !0, this.background.name = "PopupBackground", this.title = new Oi(this.game.i18n.t("PopupSpendingBudgetTitle")), this.title.anchor.x = .5, this.message = new Ei(this.game.i18n.t("PopupSpendingBudgetMessage"), {
                            wordWrap: !0
                        }), this.message.anchor.x = .5, this.actionContinue = new Bi(this.game.i18n.t("PopupActionContinue"), {
                            fill: 10066329
                        }), this.actionContinue.anchor.x = .5, this.game.interaction.out(this.actionContinue, (() => this.actionContinue.style.fill = 10066329)), this.game.interaction.hover(this.actionContinue, (() => this.actionContinue.style.fill = 16777215)), this.game.interaction.click(this.actionContinue, (() => this.hide())), this.content.addChild(this.title), this.content.addChild(this.message), this.content.addChild(this.actionContinue), this.addChild(this.overlay), this.addChild(this.background), this.addChild(this.content)
                ...
                const Li = class extends Dt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupUnexpectedError"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContinue", void 0), (0, n.Z)(this, "_resolver", null), this.overlay = new Jt(.7), this.content = new Q.W2, this.background = new $.j(this.game.loader.getAsset(Si)), this.background.anchor.set(.5), this.background.interactive = !0, this.background.name = "PopupBackground", this.title = new Oi(this.game.i18n.t("PopupUnexpectedErrorTitle")), this.title.anchor.x = .5, this.message = new Ei(this.game.i18n.t("PopupUnexpectedErrorMessage")), this.message.anchor.x = .5, this.actionContinue = new Bi(this.game.i18n.t("PopupActionReload"), {
                            fill: 10066329
                        }), this.actionContinue.anchor.x = .5, this.game.interaction.out(this.actionContinue, (() => this.actionContinue.style.fill = 10066329)), this.game.interaction.hover(this.actionContinue, (() => this.actionContinue.style.fill = 16777215)), this.game.interaction.click(this.actionContinue, (() => this.hide())), this.content.addChild(this.title), this.content.addChild(this.message), this.content.addChild(this.actionContinue), this.addChild(this.overlay), this.addChild(this.background), this.addChild(this.content)
                    }
                    resize() {
                ...
                class Ni extends Dt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupWilds"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionEnable", void 0), (0, n.Z)(this, "actionClose", void 0), (0, n.Z)(this, "escKey", void 0), (0, n.Z)(this, "spaceKey", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt(.7), this.content = new Q.W2, this.background = new $.j(this.game.loader.getAsset(Si)), this.background.anchor.set(.5), this.background.interactive = !0, this.background.name = "PopupBackground", this.title = new Oi(this.game.i18n.t("PopupWildsTitle"), {
                            fontSize: 40,
                            wordWrap: !0,
                            wordWrapWidth: 600,
                ...
                const _i = class extends Dt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupZeroBalance"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContinue", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt(.7), this.content = new Q.W2, this.background = new $.j(this.game.loader.getAsset(Si)), this.background.anchor.set(.5), this.background.interactive = !0, this.background.name = "PopupBackground", this.title = new Oi(this.game.i18n.t("PopupZeroBalanceTitle")), this.title.anchor.x = .5, this.message = new Ei(this.game.i18n.t("PopupZeroBalanceMessage"), {
                            wordWrap: !0
                        }), this.message.anchor.x = .5, this.actionContinue = new Bi(this.game.i18n.t("PopupActionContinue"), {
                            fill: 10066329
                        }), this.actionContinue.anchor.x = .5, this.game.interaction.out(this.actionContinue, (() => this.actionContinue.style.fill = 10066329)), this.game.interaction.hover(this.actionContinue, (() => this.actionContinue.style.fill = 16777215)), this.game.interaction.click(this.actionContinue, (() => this.hide())), this.content.addChild(this.title), this.content.addChild(this.message), this.content.addChild(this.actionContinue), this.addChild(this.overlay), this.addChild(this.background), this.addChild(this.content)
                ...
                const Hi = [...[{
                    ...
                    metadata: {
                        ...
                        audioMetadata: {
                            type: "background",
                            volume: Gi.get("background_normal"),
                            loop: !0
                        }
                    }
                }, {
                    ...
                    url: "assets/audio/bonusScaleUpdate.mp3",
                    name: "bonusScaleUpdate",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"],
                        audioMetadata: {
                            type: "effects",
                    ...
                    url: "assets/images/background/bgbackln_1.png",
                    name: "bgbackln_1",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/background/bgbackln_2.png",
                    name: "bgbackln_2",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/background/bgfrontln_1.png",
                    name: "bgfrontln_1",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/background/bgfrontln_2.png",
                    name: "bgfrontln_2",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/background/bgcloudsln_1.png",
                    name: "bgcloudsln_1",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/background/bgcloudsln_2.png",
                    name: "bgcloudsln_2",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/background/bgskyln_1.jpg",
                    name: "bgskyln_1",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/background/bgskyln_2.jpg",
                    name: "bgskyln_2",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/background/bgmobile.png",
                    name: "bgmobile",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/background/bgitem_1.png",
                    name: "bgitem_1",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/background/bgitem_2.png",
                    name: "bgitem_2",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/background/bgitem_3.png",
                    name: "bgitem_3",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/background/bgitem_4.png",
                    name: "bgitem_4",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/background/grid-bottom.png",
                    name: "grid-bottom",
                    metadata: {
                    ...
                    url: "assets/images/background/train.png",
                    name: "train",
                    metadata: {
                        platform: ["desktop", "phone", "tablet"]
                    }
                    ...
                    url: "assets/images/background/knobs.png",
                    metadata: {
                        platform: ["desktop", "phone", "tablet"]
                    }
                }, {
                    ...
                    url: "assets/images/paytable/feature.jpg",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    ...
                    url: "assets/images/effects/train/skeleton.json",
                    name: "effectTrain",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/effects/train-wheel/skeleton.json",
                    name: "effectTrainWheels",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/effects/train-bottom/skeleton.json",
                    name: "effectTrainBottom",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    ...
                    url: "assets/images/effects/symbols/sym-magic/skeleton.json",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    ...
                    url: "assets/images/effects/bonus-gauge/skeleton.json",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    ...
                    slot: {
                        ...
                        layout: {
                            blur: [{
                                ...
                                textureAtlas: "symbols_static",
                                assetName: "cowboy_girl_blur",
                                animation: {}
                            }, {
                                textureAtlas: "symbols_static",
                                assetName: "indian_girl_blur",
                                animation: {}
                            }, {
                                textureAtlas: "symbols_static",
                                assetName: "oldman_blur",
                                animation: {}
                            }, {
                                textureAtlas: "symbols_static",
                                assetName: "bandit_blur",
                                animation: {}
                            }, {
                                textureAtlas: "symbols_static",
                                assetName: "gun_blur",
                                ...
                                textureAtlas: "symbols_static",
                                assetName: "bonus1_blur",
                                animation: {}
                            }, {
                                textureAtlas: "symbols_static",
                                assetName: "bonus1-no-word_blur",
                                animation: {}
                            }, {}, {}, {}, {}, {}, {}, {}, {}, {
                                textureAtlas: "symbols_static",
                                assetName: "bonus2_blur",
                                animation: {}
                            }, {
                                textureAtlas: "symbols_static",
                                assetName: "bonus2-no-word_blur",
                                animation: {}
                            }],
                            default: [{
                                textureAtlas: "symbols_static",
                ...
                var Ji = new class {
                    ...
                    isBasic() {
                        return this.currentFeature.includes(Xi.Basic)
                    }
                    isAuto() {
                        return this.currentFeature === Xi.Auto
                    }
                    isRespin() {
                        return this.currentFeature === Xi.Respin
                    }
                    isFreespin() {
                        return this.currentFeature === Xi.Freespin
                    }
                    isBonus() {
                        return this.currentFeature === Xi.Bonus
                    }
                };
                const $i = {
                    init() {
                        function t(t) {
                            var e = ot()(t, "feature", ""),
                                i = ot()(t, "bonus.multiplier", 0),
                                s = ot()(t, "bonus.modificator", 0),
                                o = ot()(t, "bonuses", []);
                            Lt.store.set("bonus:bonuses", o), Lt.store.set("bonus:finalChance", ot()(t, "finalChance.pos", [])), Lt.store.set("bonus:finalChanceCount", ot()(t, "finalChance.count", 0)), Lt.store.set("bonus:bonus", ot()(t, "bonus", !1)), Lt.store.set("bonus:win", ot()(t, "bonus.win", 0));
                            var n = Lt.store.get("bonus:left", 0);
                            Lt.store.set("bonus:prevLeft", n);
                            var a = ot()(t, "bonus.left", -1),
                                h = ot()(t, "bonus.played", -1);
                            Lt.store.set("bonus:isBonus", "bonus" === e), Lt.store.set("bonus:left", a), Lt.store.set("bonus:played", h), Lt.store.set("bonus:isStart", 0 === h && "bonus" === ot()(t, "nextAction", "")), Lt.store.set("bonus:isEnd", (0 === a || Ji.isBonus()) && "basic" === e), Lt.store.set("bonus:multiplier", i), Lt.store.set("bonus:modificator", s);
                            var r = 0;
                            o.forEach((t => {
                                t.isNew && "string" == typeof t.sym && 1 === t.sym.length && "U" === t.sym.slice(0, 1) && r++
                            })), Lt.store.set("bonus:winAdditional", r > 0), Lt.store.set("bonus:additionalCount", r)
                        }
                        Lt.store.set("bonus:isStart", !1), Lt.store.set("bonus:isEnd", !1), Lt.store.set("bonus:isFree", !1), Lt.store.set("bonus:isBonus", !1), Lt.store.set("bonus:bonus", !1), Lt.store.set("bonus:bonuses", []), Lt.store.set("bonus:left", -1), Lt.store.set("bonus:prevLeft", -1), Lt.store.set("bonus:isEnd", !1), Lt.store.set("bonus:multiplier", 0), Lt.store.set("bonus:played", -1), Lt.store.set("bonus:multiplier", 0), Lt.store.set("bonus:modificator", 0), Lt.store.set("bonus:win", 0), Lt.store.set("bonus:finalChance", []), Lt.store.set("bonus:finalChanceCount", 0), Lt.store.set("bonus:winAdditional", !1), Lt.store.set("bonus:additionalCount", 0), Lt.server.on("response:init", t), Lt.server.on("response:spin", t), Lt.server.on("response:buyin", t), Lt.server.on("response:risk", t)
                    }
                };
                var ts = [
                        [11, 9, 2, 6],
                ...
                const is = {
                        init() {
                            ...
                            function e(e) {
                                var i = ot()(e, "win", 0),
                                    s = ot()(e, "scatters", !1);
                                Lt.store.set("reward:win", i), Lt.store.set("reward:lines", ot()(e, "lines", [])), Lt.store.set("reward:reels", ot()(e, "reels", e.error ? ts : [])), Lt.store.set("reward:nReels", ot()(e, "nReels", e.error ? es : [])), Lt.store.set("reward:preReels", ot()(e, "preSpin.reels", [])), Lt.store.set("reward:bonusReels", ot()(e, "bonusReels", [])), Lt.store.set("reward:scatters", s), Lt.store.set("reward:isWin", i > 0 || s), Lt.store.set("reward:numberWinSymbol", ot()(e, "winSyms", 0));
                                var o = ot()(e, "feature", Xi.Basic);
                                Lt.store.set("reward:feature", o), t(e)
                            }
                            ...
                            Lt.store.set("reward:win", 0), Lt.store.set("reward:isWin", !1), Lt.store.set("reward:lines", []), Lt.store.set("reward:reels", []), Lt.store.set("reward:nReels", []), Lt.store.set("reward:preReels", []), Lt.store.set("reward:bonusReels", []), Lt.store.set("reward:numberWinSymbol", 0), Lt.store.set("reward:scatters", !1), Lt.store.set("reward:feature", ""), Lt.store.set("isRiskNBuy", !1), Lt.store.set("risk", !1), Lt.store.set("buy", !1), Lt.server.on("response:init", e), Lt.server.on("response:spin", e), Lt.server.on("response:buyin", i), Lt.server.on("response:risk", i)
                        }
                    },
                    ss = {
                        init() {
                    ...
                    os = {
                        init() {
                            ss.init(), is.init(), $i.init()
                        }
                    };
                class ns extends R {
                    constructor(t, e, i) {
                        super(t, e, i), (0, n.Z)(this, "backgroundNormal", void 0), (0, n.Z)(this, "backgroundBonus", void 0), (0, n.Z)(this, "bigWin", void 0), (0, n.Z)(this, "clickNormal", void 0), (0, n.Z)(this, "currentWinSound", void 0), (0, n.Z)(this, "giantWin", void 0), (0, n.Z)(this, "spinFast", void 0), (0, n.Z)(this, "spinStart", void 0), (0, n.Z)(this, "twinReels", void 0), (0, n.Z)(this, "wheelStop", void 0), (0, n.Z)(this, "winNormal1", void 0), (0, n.Z)(this, "winNormal2", void 0), (0, n.Z)(this, "winNormal3", void 0), (0, n.Z)(this, "bonusStart", void 0), (0, n.Z)(this, "bonusEnd", void 0), (0, n.Z)(this, "bonusUpdate", void 0), (0, n.Z)(this, "bonusScaleUpdate", void 0), (0, n.Z)(this, "bonusTotalWin", void 0), (0, n.Z)(this, "bonusWin", void 0), (0, n.Z)(this, "bonusWinSymbol", void 0), (0, n.Z)(this, "bonusMultiplierUpdate", void 0), (0, n.Z)(this, "bonusModificatorUpdate", void 0), (0, n.Z)(this, "trainRun", void 0), this.backgroundNormal = this.get("backgroundNormal"), this.backgroundBonus = this.get("backgroundBonus"), this.bonusStart = this.get("bonusStart"), this.bonusEnd = this.get("bonusEnd"), this.winNormal1 = this.get("win_normal_1"), this.winNormal2 = this.get("win_normal_2"), this.winNormal3 = this.get("win_normal_3"), this.bigWin = this.get("bigWin"), this.giantWin = this.get("giantWin"), this.spinStart = this.get("spinStart"), this.spinFast = this.get("spinFast"), this.clickNormal = this.get("clickNormal"), this.wheelStop = this.get("wheelStop"), this.bonusUpdate = this.get("bonusUpdate"), this.bonusScaleUpdate = this.get("bonusScaleUpdate"), this.bonusTotalWin = this.get("bonusTotalWin"), this.bonusWin = this.get("bonusWin"), this.bonusWinSymbol = this.get("bonusWinSymbol"), this.bonusMultiplierUpdate = this.get("bonusMultiplierUpdate"), this.bonusModificatorUpdate = this.get("bonusModificatorUpdate"), this.trainRun = this.get("trainRun"), this.currentWinSound = null, this._setupEvents()
                    }
                    _setupEvents() {
                        ...
                        })), Lt.action.on("state:spin_enter", this._onSpinEnter, this), Lt.action.on("state:finish_enter", this._onFinishEnter, this), Lt.action.on("sound:spinFast", this._onFastSpin, this), Lt.action.on("wheel:stop_down", this._onWheelStop, this), Lt.action.on("sound:bonus_start", this._onBonusStart, this), Lt.action.on("sound:bonus_stop", this._onbonusEnd, this), Lt.action.on("bonus:select_start", this._onSelectBonusStart, this), Lt.action.on("bonus:select_stop", this._onSelectbonusEnd, this), Lt.action.on("sound:click", this.click, this), Lt.action.on("sound:bonusUpdate", (() => {
                            this.bonusUpdate.play()
                        })), Lt.action.on("sound:bonusScaleUpdate", (() => {
                            this.bonusScaleUpdate.play()
                        ...
                        })), Lt.action.on("sound:bonusModificatorUpdate", (() => {
                            this.bonusModificatorUpdate.play()
                        })), Lt.action.on("sound:trainRun", (() => {
                            this.trainRun.play()
                        }))
                    }
                    stopBigWin() {
                    ...
                    _onSpinEnter() {
                        this.currentWinSound && (this.currentWinSound.stop(), this.currentWinSound = null), Lt.autoPlay.enabled || Ji.isBonus() || this.spinStart.play()
                    }
                    _onWheelStop() {
                ...
                class cs extends ds {
                    get stopIfWin() {
                        ...
                        return e.coins > 0 && this.stopItemWin.checked && (this.stopItemWin.type === ye || !i && (null === (t = this.game.bigWin) || void 0 === t ? void 0 : t.available(e.coins)) && this.game.bigWin.type(e.coins) >= this.stopItemWin.type)
                    }
                }
                class us extends Gt {
                    constructor() {
                    ...
                    show(t, e) {
                        return this.visible = !0, this.resize(), this.mulValue.text = "X".concat(e), this.mulValue.position.set(this.game.device.desktop || this.game.device.landscape ? -660 : -418, this.game.device.desktop || this.game.device.landscape ? 240 : -70), new Promise((e => {
                            ...
                            this.timeline.set([this.mulTitle, this.mulValue, this.title, this.value], {
                                ...
                                roundProps: ["coins"],
                                onStart: () => {
                                    this.game.action.emit("sound:bonusTotalWin"), this.interactive = !0
                                },
                                onUpdate: () => {
                                    k.to(this.value, 2, {
                                        pixi: {
                ...
                class Bs extends(zt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "BonusWinText"), (0, n.Z)(this, "multiplierTitleText", void 0), (0, n.Z)(this, "multiplierValueText", void 0), (0, n.Z)(this, "multiplierValue", 0), (0, n.Z)(this, "modTitleText", void 0), (0, n.Z)(this, "modValueText", void 0), (0, n.Z)(this, "modValue", 0), (0, n.Z)(this, "leftCount", void 0), this.leftCount = new b.Xz("", {
                            fontName: "WinFont"
                        }), this.leftCount.scale.set(.3), this.leftCount.text = "", this.visible = !1, this.multiplierTitleText = new Pe("", {
                            default: {
                                fill: "#ffffff",
                                fontFamily: "PT Sans Narrow Bold",
                                fontSize: 40,
                            ...
                            fontName: "WinFont"
                        }), this.multiplierValueText.text = "", this.multiplierValueText.position.set(0, this.multiplierTitleText.height + 20), this.modTitleText = new Pe("", {
                            default: {
                                fill: "#ffffff",
                                fontFamily: "PT Sans Narrow Bold",
                                fontSize: 35,
                    ...
                    totalWin() {
                        ...
                        return (0, o.Z)((function*() {
                            ...
                            }), t.game.action.emit("sound:bonusMultiplierUpdate"), t.multiplierValueText.text = "".concat(0 === i ? e : i * e), yield t.game.helpers.delay(0 === i ? 0 : 1e3)
                        }))()
                    }
                    reset() {
                        this.multiplierTitleText.alpha = 0, this.multiplierValueText.text = "", this.multiplierValue = 0, this.modTitleText.alpha = 0, this.modValueText.text = "", this.modValue = 0, this.modValueText.position.set(0, this.modTitleText.y + this.modTitleText.height + 5), this.leftCount.text = "", this.leftCount.position.set(520)
                    }
                    resize() {
                        this.game.device.desktop || this.game.device.landscape ? (this.position.set(-230, 420), this.leftCount.scale.set(.3), this.leftCount.position.set(520)) : (this.position.set(-230, 420), this.leftCount.scale.set(.6), this.leftCount.position.set(200, 1e3))
                    }
                }
                class Cs extends ai {
                    get dropCoins() {
                ...
                class Ps extends(zt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "logo", void 0), (0, n.Z)(this, "bgback", void 0), (0, n.Z)(this, "bgfront", void 0), (0, n.Z)(this, "bgsky", void 0), (0, n.Z)(this, "bgclouds", void 0), (0, n.Z)(this, "bgmobile", void 0), (0, n.Z)(this, "bgitems", void 0), this.logo = new $.j(this.game.loader.getAsset("logo")), this.bgback = new Q.W2, this.bgback.addChild(new $.j(this.game.loader.getAsset("bgbackln_1"))).position.set(0, 0), this.bgback.addChild(new $.j(this.game.loader.getAsset("bgbackln_2"))).position.set(2880, 0), this.bgfront = new Q.W2, this.bgfront.addChild(new $.j(this.game.loader.getAsset("bgfrontln_1"))).position.set(0, 0), this.bgfront.addChild(new $.j(this.game.loader.getAsset("bgfrontln_2"))).position.set(2880, 0), this.bgsky = new Q.W2, this.bgsky.addChild(new $.j(this.game.loader.getAsset("bgskyln_1"))).position.set(0, 0), this.bgsky.addChild(new $.j(this.game.loader.getAsset("bgskyln_2"))).position.set(2880, 0), this.bgclouds = new Q.W2, this.bgclouds.addChild(new $.j(this.game.loader.getAsset("bgcloudsln_1"))).position.set(0, 0), this.bgclouds.addChild(new $.j(this.game.loader.getAsset("bgcloudsln_2"))).position.set(2880, 0), this.bgmobile = new $.j(this.game.loader.getAsset("bgmobile")), this.bgmobile.visible = !0, this.bgitems = new Q.W2, this.bgitems.addChild(new $.j(this.game.loader.getAsset("bgitem_1"))), this.bgitems.addChild(new $.j(this.game.loader.getAsset("bgitem_2"))), this.bgitems.addChild(new $.j(this.game.loader.getAsset("bgitem_3"))), this.bgitems.addChild(new $.j(this.game.loader.getAsset("bgitem_4"))), this.bgitems.children.forEach((t => {
                            t.anchor.set(.5, 1), t.scale.set(.7), t.position.set(this.game.helpers.random(0, 1920), 1080), t.visible = !1
                        })), this.addChild(this.bgsky), this.addChild(this.bgclouds), this.addChild(this.bgmobile), this.addChild(this.bgback), this.addChild(this.bgfront), this.addChild(this.logo), k.to(this.bgclouds, 30, {
                            pixi: {
                                x: this.game.device.desktop ? -2880 : -3240
                            },
                            roundProps: ["x"],
                            ease: P.Linear.easeNone,
                            repeatDelay: 0,
                            repeat: -1,
                            onRepeat: () => this.swapTexture(this.bgclouds)
                        }), k.to(this.bgsky, 20, {
                            pixi: {
                                x: this.game.device.desktop ? -2880 : -3240
                            },
                            ...
                            repeatDelay: 0,
                            repeat: -1,
                            onRepeat: () => this.swapTexture(this.bgsky)
                        }), this.setupEvents()
                    }
                    startTrain() {
                        k.to(this.bgback, 10, {
                            pixi: {
                                positionX: this.game.device.desktop ? -2880 : -3240
                            },
                            roundProps: ["x"],
                            ease: P.Linear.easeNone,
                            repeatDelay: 0,
                            repeat: -1,
                            onRepeat: () => this.swapTexture(this.bgback)
                        }), k.to(this.bgfront, 10, {
                            pixi: {
                                positionX: this.game.device.desktop ? -2880 : -3240
                            },
                            roundProps: ["x"],
                            ease: P.Linear.easeInOut,
                            repeatDelay: 0,
                            repeat: -1,
                            onRepeat: () => this.swapTexture(this.bgfront)
                        }), setInterval((() => {
                            if (this.game.visibility.isVisible) {
                                var t = this.bgitems.children[this.game.helpers.random(0, this.bgitems.children.length - 1)];
                                t.visible = !0, t.x = 2400, k.to(t, 3, {
                                    pixi: {
                                        x: -480
                                    },
                                    onComplete: () => {
                    ...
                    setupEvents() {}
                    resize() {
                        this.game.device.portrait && !this.game.device.desktop ? (this.bgfront.position.set(2 * -this.game.viewport.paddingX, 0), this.bgback.position.set(2 * -this.game.viewport.paddingX, 0), this.bgclouds.position.set(2 * -this.game.viewport.paddingX, 0), this.bgsky.position.set(2 * -this.game.viewport.paddingX, 0), this.bgmobile.position.set(2 * -this.game.viewport.paddingX, -1310), this.bgmobile.scale.set(2), this.bgmobile.visible = !0, this.logo.scale.set(1.5), this.logo.position.set(320, 40)) : (this.bgfront.position.set(0), this.bgback.position.set(0), this.bgclouds.position.set(0), this.bgsky.position.set(0), this.bgmobile.visible = !1, this.logo.scale.set(.9), this.logo.position.set(10, 20))
                    }
                    swapTexture(t) {
                        var e = t.children[0].texture;
                        t.children[0].texture = t.children[1].texture, t.children[1].texture = e
                    }
                }! function(t) {
                    t[t.START = 0] = "START", t[t.END = 1] = "END", t[t.RESTORE = 2] = "RESTORE"
                }(xs || (xs = {}));
                class Es extends(zt(Q.W2)) {
                    constructor() {
                    ...
                    show(t) {
                        ...
                        return new Promise((i => {
                            ...
                            var s = "";
                            if (t === xs.START) s = "bonus:start", this.game.action.emit("sound:bonus_start"), this._title.text = this.game.i18n.t("PopupBonusTitle"), this._win.text = this.game.i18n.t("PopupBonusWinStart"), this._description.text = this.game.i18n.t("PopupBonusDescription"), this._buttonText.text = this.game.i18n.t("PopupFreeSpinsButton"), e && (this.tweenAutoTimeout = k.to(this._buttonText, 1, {
                                pixi: {
                                    scale: 1.1
                                },
                                repeat: 5,
                                ...
                                var o = this.game.helpers.toMoney(this.game.wallet.totalCoins);
                            ...
                            } else t === xs.RESTORE && (s = "bonus:restore", this.game.action.emit("sound:bonus_start"), this._title.text = this.game.i18n.t("PopupFreeSpinsTitleRestore"), this._win.text = "", this._description.text = "", this._buttonText.text = this.game.i18n.t("PopupFreeSpinsButton"), this._title.position.set(0, 210), this._buttonText.position.set(0, 400));
                    ...
                    showContent(t) {
                        return t === xs.RESTORE ? Promise.resolve() : new Promise((t => {
                ...
                class Ks extends Pe {
                    constructor() {
                        super("", Xs(Xs({}, Qs.Common), {}, {
                            default: Xs(Xs({}, Qs.Common.default), {}, {
                                fill: Lt.config.get("colors.primary"),
                                fontFamily: "Avenir-Bold"
                            }),
                            value: Xs(Xs({}, Qs.Common.value), {}, {
                                fontSize: 66
                            })
                        }))
                    }
                ...
                function eo(t) {
                    for (var e = 1; e < arguments.length; e++) {
                        var i = null != arguments[e] ? arguments[e] : {};
                        e % 2 ? to(Object(i), !0).forEach((function(e) {
                            (0, n.Z)(t, e, i[e])
                        })) : Object.getOwnPropertyDescriptors ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(i)) : to(Object(i)).forEach((function(e) {
                            Object.defineProperty(t, e, Object.getOwnPropertyDescriptor(i, e))
                        }))
                    }
                    return t
                ...
                class io extends $s {
                    constructor(t) {
                        ...
                        })), this.betLevel = t, this.betLevelText = this.addChild(new Pe("", eo(eo({}, Qs.Common), {}, {
                            default: eo(eo({}, Qs.Common.default), {}, {
                                align: "left"
                            })
                                ...
                                if (l) {
                                    ...
                                    switch (l.type) {
                                        case F.AttachmentType.Region:
                                            ...
                                            d.transform.setFromMatrix(r.bone.matrix), r.currentSprite.color ? c = r.currentSprite.color : (so[0] = o[0] * r.color.r * u.r, so[1] = o[1] * r.color.g * u.g, so[2] = o[2] * r.color.b * u.b, r.currentSprite.tint = it.rgb2hex(so)), r.currentSprite.blendMode = r.blendMode;
                                            break;
                                        case F.AttachmentType.Mesh:
                                            if (r.currentSprite) {
                                            ...
                                            l.computeWorldVerticesOld(r, r.currentMesh.vertices), r.currentMesh.color ? c = r.currentMesh.color : (so[0] = o[0] * r.color.r * u.r, so[1] = o[1] * r.color.g * u.g, so[2] = o[2] * r.color.b * u.b, r.currentMesh.tint = it.rgb2hex(so)), r.currentMesh.blendMode = r.blendMode;
                                            break;
                                        case F.AttachmentType.Clipping:
                ...
                const ro = function(t) {
                    var e = new Pe("", ho(ho({}, t), {}, {
                        default: ho(ho({}, t.default), {}, {
                            wordWrap: !0,
                            wordWrapWidth: 200
                        })
                    }));
                ...
                function uo(t) {
                    for (var e = 1; e < arguments.length; e++) {
                        var i = null != arguments[e] ? arguments[e] : {};
                        e % 2 ? co(Object(i), !0).forEach((function(e) {
                            (0, n.Z)(t, e, i[e])
                        })) : Object.getOwnPropertyDescriptors ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(i)) : co(Object(i)).forEach((function(e) {
                            Object.defineProperty(t, e, Object.getOwnPropertyDescriptor(i, e))
                        }))
                    }
                    return t
                ...
                class po extends Pe {
                    constructor() {
                        super("", uo(uo({}, Qs.Common), {}, {
                            default: uo(uo({}, Qs.Common.default), {}, {
                                align: "right"
                            })
                        }))
                    }
                ...
                class go extends Pe {
                    ...
                    change(t) {
                        this.text = 0 === t ? Lt.i18n.t("ControlsDesktopBonusLast") : Lt.i18n.t("ControlsDesktopBonusLeft", t), k.to(this, .3, {
                            pixi: {
                                scale: 1.3
                            },
                            yoyo: !0,
                ...
                class Ao extends Js {
                    constructor() {
                        ...
                        this.background = $.j.from("data:image/png;base64,"), this.background.alpha = .4, this.background.anchor.set(0, 1), this.background.position.set(0, this.game.viewport.height), this.buttonMenu = new Rs, this.buttonMenu.position.set(77, 1013), this.buttonMaxBet = new io(this.game.betLevel), this.buttonMaxBet.position.set(213, 1013), this.buttonAutoPlay = new Os, this.buttonAutoPlay.position.set(833, 1013), this.buttonQuickSpin = new Ms, this.buttonQuickSpin.position.set(1084, 1014), this.buttonSound = new Us, this.buttonSound.position.set(1840, 1012), this.buttonSpin = function() {
                            ...
                            e.scale.set(.9), e.hitArea = new X.Rectangle(0, 10, 140, 120), e.name = "buttonSpin";
                            var i = Lt.keyboard.register(Lt.keyboard.KEY_CODE.Space);
                            i.onPress.add(o), i.disable();
                            var s = new oo(Lt.loader.getAsset("effectSpin"));
                            ...
                            return e.addChild(s), s.play("inactive"), e.onClick.add(o), e.onHover.add((() => {
                                ...
                                Ji.isBasic() && i.enable(), Ji.isBonus() || (e.visible = !0, e.enable(), s.play("active"))
                            })), Lt.action.on("state:finish_exit", (function() {
                                i.enable(), Ji.isBasic() && (e.enable(), s.play("active"))
                            })), {
                                container: e,
                                hide() {
                                    e.visible = !1
                        ...
                        }(t.btn_spin_active, t.btn_spin_hover, t.btn_spin_press, t.btn_spin_inactive), this.buttonSpin.container.position.set(896, 950), this.buttonAccept = new Zs, this.buttonAccept.position.set(958, 1013), this.textWin = new mo, this.textWin.anchor.x = .5, this.textWin.position.set(1400, 980), this.textBalance = new po, this.textBalance.anchor.x = 1, this.textBalance.position.set(1760, 980), this.freeRoundLeft = ro(Qs.Common), this.freeRoundLeft.container.position.set(1700, 1054), this.freeRoundTotalWin = lo(Qs.Common), this.freeRoundTotalWin.container.position.set(1400, 980), this.textBonusLeft = new go, this.textBonusLeft.visible = !1, this.textBonusLeft.anchor.x = .5, this.textBonusLeft.position.set(640, 980), this.textBonusTotalWin = new Ks, this.textBonusTotalWin.visible = !1, this.textBonusTotalWin.anchor.x = .5, this.textBonusTotalWin.position.set(960, 955), this.addChild(this.background), this.addChild(this.buttonMenu), this.addChild(this.buttonMaxBet), this.addChild(this.buttonSpin.container), this.game.config.get("autoPlay.available", !0) && this.addChild(this.buttonAutoPlay), this.game.config.get("quickSpin.available", !0) && this.addChild(this.buttonQuickSpin), this.addChild(this.buttonSound), this.addChild(this.buttonAccept), this.addChild(this.textWin), this.game.config.get("balanceHide", !1) || this.addChild(this.textBalance), this.addChild(this.freeRoundTotalWin.container), this.addChild(this.freeRoundLeft.container), this.addChild(this.textBonusLeft), this.addChild(this.textBonusTotalWin), this.textWin.update(this.game.wallet.coins), this.textBalance.update(this.game.wallet.balance), this.game.freeRound.onStart.once((t => {
                            ...
                            this.buttonAutoPlay.visible = !0, this.textWin.visible = !0, this.textBonusLeft.visible = !1, this.textBonusLeft.text = "", this.textBonusTotalWin.visible = !1, this.textBonusTotalWin.text = "", this.textWin.update(this.game.wallet.totalCoins, !0), this.textBalance.update(this.game.wallet.balance), this.game.freeRound.enabled && (this.freeRoundTotalWin.container.visible = !0, this.textWin.visible = !1), this.game.device.desktop && this.buttonQuickSpin.position.set(1084, 1014)
                            ...
                            this.game.autoPlay.enabled || this.buttonAutoPlay.disable(), Ji.isBasic() && (this.freeRoundLeft.updateLeft(this.game.freeRound.left - 1), this.textBalance.update(this.game.wallet.balance - this.game.betLevel.toCoins()))
                            ...
                            this.textWin.update(this.game.wallet.coins), Ji.isBonus() && this.textBonusTotalWin.update(this.game.wallet.totalCoins)
                        })), this.game.action.on("update:balance", (() => {
                            this.textBalance.update(this.game.wallet.balance)
                        })), this.game.action.on("state:setup_enter", (() => {
                            this.buttonMenu.disable(), this.buttonSpin.disable(), this.buttonAutoPlay.disable(), Ji.isBonus() && (this.y = this.y + this.height + 100, this.buttonMenu.disable(), this.buttonSpin.disable(), this.buttonSpin.hide(), this.buttonAutoPlay.disable())
                        })), this.game.action.on("state:ready_enter", (() => {
                            Ji.isBonus() || (this.buttonMenu.enable(), this.buttonAutoPlay.enable()), this.game.autoPlay.enabled && this.buttonMenu.disable()
                        }))
                    }
                    lock() {
                ...
                class vo extends Js {
                    constructor() {
                        super(), (0, n.Z)(this, "autoPlayButton", void 0), (0, n.Z)(this, "betButton", void 0), (0, n.Z)(this, "buttonAccept", void 0), (0, n.Z)(this, "buttonMenu", void 0), (0, n.Z)(this, "buttonQuickSpin", void 0), (0, n.Z)(this, "buttonSound", void 0), (0, n.Z)(this, "buttonSpin", void 0), (0, n.Z)(this, "onPressButtonSpin", void 0), (0, n.Z)(this, "state", void 0), (0, n.Z)(this, "statusBar", void 0), this.state = Ke.Normal, this.onPressButtonSpin = new(x()), this.statusBar = new $e, this.statusBar.changeState(this.state), this.game.freeRound.enabled ? (this.statusBar.update({
                        ...
                        })), this.buttonMenu = new Rs, this.buttonSound = new Us, this.buttonSpin = new bo, this.game.interaction.hover(this.buttonSpin, (() => {
                        ...
                        })), this.buttonAccept = new Zs, this.buttonQuickSpin = new Ms, this.autoPlayButton = new Os, this.autoPlayButton.scale.set(1.6), this.betButton = new $s, this.betButton.disable(), this.betButton.onClick.add((() => this.game.action.emit("clickMaxBet"))), this.game.action.on("update:win", (() => {
                            this.game.freeRound.enabled || this.game.store.get("free:isStart", !1) ? (this.statusBar.update({
                                ...
                                type: Xe.TotalWin,
                                value: this.game.wallet.totalCoins
                            })) : Ji.isBonus() ? (this.statusBar.update({
                                type: Xe.Win,
                                value: this.game.wallet.coins
                            }), this.statusBar.update({
                                type: Xe.TotalWin,
                            ...
                            this.game.freeRound.enabled || Ji.isBonus() || this.statusBar.update({
                                type: Xe.Balance,
                                value: this.game.wallet.balance
                            })
                        })), this.game.action.on("reward:reset", (() => {
                            ...
                            !Ji.isBasic() || this.game.autoPlay.enabled || this.game.freeRound.enabled || (this.betButton.show(), this.betButton.enable(), this.buttonSpin.interactive = !0, this.buttonMenu.enable(), this.autoPlayButton.enable(), this.buttonQuickSpin.enable()), this.game.freeRound.enabled && Ji.isBasic() && (this.buttonSpin.interactive = !0, this.buttonMenu.enable(), this.autoPlayButton.enable(), this.buttonQuickSpin.enable())
                        })), this.game.action.on("state:spin_enter", (() => {
                            ...
                            }), Ji.isBasic() && this.statusBar.update({
                                type: this.game.freeRound.enabled ? Xe.FreeRoundLeft : Xe.Balance,
                                value: this.game.freeRound.enabled ? this.game.freeRound.left - 1 : i - s
                            })
                        })), this.game.action.on("state:finish_exit", (() => {
                            this.buttonSpin.interactive = !0, Ji.isBasic() && !this.game.autoPlay.enabled && (this.buttonQuickSpin.show(), this.autoPlayButton.show(), this.autoPlayButton.enable(), this.buttonMenu.show(), this.buttonMenu.enable())
                        })), this.game.action.on("state:stop_exit", (() => {
                            var t = this.game.autoPlay.enabled,
                                e = Ji.isBonus();
                            t && !e && (this.buttonSpin.visible = !0, this.buttonSpin.interactive = !0)
                        })), this.game.action.on("state:setup_enter", (() => {
                            this.buttonMenu.disable(), this.buttonSpin.interactive = !1, this.autoPlayButton.disable(), Ji.isBonus() && (this.alpha = 0)
                        })), this.game.action.on("bonus:restore", (() => {
                            this.state = Ke.Bonus, this.buttonMenu.hide(), this.buttonSpin.visible = !1, this.betButton.hide(), this.autoPlayButton.hide(), this.buttonSound.show(), this.statusBar.changeState(this.state), this.statusBar.update({
                                type: Xe.TotalWin,
                            ...
                            this.state = Ke.Normal, this.buttonMenu.show(), this.buttonSpin.visible = !0, this.betButton.show(), this.buttonQuickSpin.show(), this.autoPlayButton.show(), this.buttonSound.hide(), this.statusBar.changeState(this.state), this.game.freeRound.enabled || this.statusBar.update({
                                type: Xe.Balance,
                                value: this.game.wallet.balance
                            }), this.statusBar.update({
                                type: Xe.Win,
                    ...
                    resize() {
                        ...
                        if (this.game.device.landscape) this.betButton.position.set(120, 980), e && this.betButton.show(), i ? (this.buttonSound.position.set(120, this.state === Ke.Bonus ? 300 : 780), this.buttonMenu.position.set(120, 120), this.buttonQuickSpin.position.set(120, 780), this.autoPlayButton.position.set(120, 300), this.buttonSpin.position.set(160, this.game.viewport.height / 2), this.buttonAccept.position.set(160, this.game.viewport.height / 2)) : (this.buttonSound.position.set(1780, this.state === Ke.Bonus ? 300 : 780), this.buttonMenu.position.set(1780, 120), this.buttonQuickSpin.position.set(1780, 780), this.autoPlayButton.position.set(1780, 300), this.buttonSpin.position.set(1760, this.game.viewport.height / 2), this.buttonAccept.position.set(1760, this.game.viewport.height / 2));
                        else {
                            var s = 2 * this.game.viewport.paddingY + this.game.viewport.height;
                            this.buttonSound.position.set(110, this.state === Ke.Bonus ? 100 : s - 318), this.autoPlayButton.position.set(540, s - 318), this.buttonQuickSpin.position.set(this.state === Ke.Normal ? 748 : 955, s - 318), this.buttonMenu.position.set(955, s - 318), this.betButton.position.set(332, s - 318), e && this.betButton.hide(), this.buttonSpin.scale.set(1), this.buttonSpin.position.set(this.game.viewport.width / 2, s - 590), this.buttonAccept.position.set(this.game.viewport.width / 2, s - 590)
                        }
                    }
                    lock() {
                ...
                class fo extends(zt(Q.W2)) {
                    ...
                    createLoadingText(t) {
                        return this.addChild(new yo(t))
                    }
                }
                class wo extends(zt($.j)) {
                    constructor(t) {
                ...
                class xo extends(zt(Q.W2)) {
                    constructor(t) {
                        super(), (0, n.Z)(this, "left", void 0), (0, n.Z)(this, "right", void 0), this.renderable = t > 1, this.left = this.addChild(new wo("left")), this.left.position.set(0, 0), this.right = this.addChild(new wo("right")), this.right.position.set(910, 0)
                    }
                    get allArrows() {
                ...
                class To extends Eo {
                    constructor(t) {
                        super(t, arguments.length > 1 && void 0 !== arguments[1] && arguments[1]), this.featurePreview.anchor.x = .5, this.featurePreview.position.set(0, 0), this.description.anchor.x = .5, this.description.position.set(0, this.featurePreview.y + this.featurePreview.height)
                    }
                    resize() {
                        this.description.setTagStyle("default", {
                            wordWrapWidth: this.game.viewport.width / 2.4,
                            breakWords: "ja" === this.game.i18n.language
                        }), this.game.device.desktop ? (this.scale.set(1), this.position.set(960, -130)) : this.game.device.landscape ? (this.description.setTagStyle("default", {
                            wordWrapWidth: this.game.viewport.width / 2.4
                        }), this.scale.set(1), this.position.set(960, -130)) : (this.description.setTagStyle("default", {
                ...
                class Oo extends fo {
                    constructor() {
                        super(), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "logo", void 0), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "playButtonBg", void 0), this.overlay = this.addChild(new Jt(.75)), this.content = this.addChild(new Q.W2), this.slides.push(this.content.addChild(new To(0))), this.slides.push(this.content.addChild(new To(1, !0))), this.logo = this.content.addChild(new $.j(this.game.loader.getAsset("logo"))), this.logo.anchor.x = .5, this.pagination = this.content.addChild(new ko(this.visibleViewsCount, 40)), this.hideButton = this.content.addChild(new Po("#e3a750")), this.arrows = this.content.addChild(new xo(this.visibleViewsCount)), this.arrows.right.position.set(980, 0), this.arrows.position.set(470, 400), this.playButton = this.content.addChild(new Bo), this.playButton.anchor.set(.5), this.setupArrows(), this.setupPagination(), this.setupHideButton(), this.setupSlides()
                    }
                    resize() {
                ...
                function Wo(t) {
                    for (var e = 1; e < arguments.length; e++) {
                        var i = null != arguments[e] ? arguments[e] : {};
                        e % 2 ? Mo(Object(i), !0).forEach((function(e) {
                            (0, n.Z)(t, e, i[e])
                        })) : Object.getOwnPropertyDescriptors ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(i)) : Mo(Object(i)).forEach((function(e) {
                            Object.defineProperty(t, e, Object.getOwnPropertyDescriptor(i, e))
                        }))
                    }
                    return t
                }
                class Fo extends(zt(A.xv)) {
                    constructor(t) {
                        super(t, {
                            fill: "white",
                            fontSize: 21,
                ...
                class Do extends(zt(Q.W2)) {
                    constructor(t) {
                        var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [];
                        super(), (0, n.Z)(this, "_payTableBetLineBoxs", void 0), (0, n.Z)(this, "_payTableParagraph", void 0), (0, n.Z)(this, "_payTableTitle", void 0), this._payTableBetLineBoxs = new Q.W2, this._payTableTitle = new Io(this.game.i18n.t("PaytableSectionBetLinesTitle").toUpperCase()), this._payTableParagraph = new Fo(this.game.i18n.t("PaytableSectionBetLinesContent1")), t.forEach(((t, i) => {
                            var s = new Ro(i + 1, t, e);
                ...
                class No extends(zt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "_sectionParagraph1", void 0), (0, n.Z)(this, "_sectionTitle", void 0), this.visible = this.game.config.get("rnb", !0), this._sectionTitle = new Io(this.game.i18n.t("PaytableSectionRiskTitle").toUpperCase()), this._sectionTitle.position.set(0, 0), this._sectionParagraph1 = new Fo(this.game.i18n.t("PaytableSectionRiskContent1")), this._sectionParagraph1.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this.addChild(this._sectionTitle), this.addChild(this._sectionParagraph1)
                    }
                    resize() {
                ...
                class Uo extends(zt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "symbol1", void 0), (0, n.Z)(this, "symbol2", void 0), (0, n.Z)(this, "content1", void 0), this.title = new Io(Lt.i18n.t("PaytableSectionBonusSymbolsTitle").toUpperCase()), this.title.position.set(0, 0), this.symbol1 = new _o("bonus1"), this.symbol1.position.set(0, this.title.y + this.title.height + 30), this.symbol1.withoutPayout(), this.symbol2 = new _o("bonus2"), this.symbol2.position.set(this.symbol1.x + this.symbol1.width + 30, this.title.y + this.title.height + 30), this.symbol2.withoutPayout(), this.content1 = new Fo(Lt.i18n.t("PaytableSectionBonusSymbolsContent1")), this.content1.position.set(0, this.symbol1.height + this.symbol1.y + 30), this.addChild(this.title, this.symbol1, this.symbol2, this.content1)
                    }
                    resize() {
                        this.game.device.desktop || (this.game.device.landscape ? (this.symbol1.position.set(0, this.title.y + this.title.height + 30), this.symbol2.position.set(this.symbol1.x + this.symbol1.width + 30, this.title.y + this.title.height + 30), this.content1.position.set(0, this.symbol1.height + this.symbol1.y + 30)) : (this.symbol1.position.set(0, this.title.y + this.title.height + 30), this.symbol2.position.set(0, this.symbol1.y + this.symbol1.height + 30), this.content1.position.set(0, this.symbol2.height + this.symbol2.y + 30)))
                    }
                }
                class Vo extends(zt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "sectionTitle", void 0), (0, n.Z)(this, "symbol1", void 0), (0, n.Z)(this, "symbol2", void 0), (0, n.Z)(this, "symbol3", void 0), (0, n.Z)(this, "symbol4", void 0), (0, n.Z)(this, "symbol5", void 0), (0, n.Z)(this, "symbol6", void 0), (0, n.Z)(this, "symbol7", void 0), (0, n.Z)(this, "symbol8", void 0), (0, n.Z)(this, "symbol9", void 0), (0, n.Z)(this, "symbol10", void 0), (0, n.Z)(this, "symbols", void 0), this.sectionTitle = new Io(this.game.i18n.t("PaytableSectionPayoutTitle").toUpperCase()), this.symbol1 = new _o("cowboy_girl"), this.symbol1.position.set(0, this.sectionTitle.y + this.sectionTitle.height + 30), this.symbol2 = new _o("indian_girl"), this.symbol2.position.set(600, this.sectionTitle.y + this.sectionTitle.height + 30), this.symbol3 = new _o("oldman"), this.symbol3.position.set(0, this.symbol1.y + this.symbol1.height + 30), this.symbol4 = new _o("bandit"), this.symbol4.position.set(600, this.symbol2.y + this.symbol2.height + 30), this.symbol5 = new _o("gun"), this.symbol5.position.set(0, this.symbol3.y + this.symbol3.height + 30), this.symbol6 = new _o("A"), this.symbol6.position.set(600, this.symbol4.y + this.symbol4.height + 30), this.symbol7 = new _o("K"), this.symbol7.position.set(0, this.symbol5.y + this.symbol5.height + 30), this.symbol8 = new _o("Q"), this.symbol8.position.set(600, this.symbol6.y + this.symbol6.height + 30), this.symbol9 = new _o("J"), this.symbol9.position.set(0, this.symbol7.y + this.symbol7.height + 30), this.symbol10 = new _o("Ten"), this.symbol10.position.set(600, this.symbol8.y + this.symbol8.height + 30), this.symbols = [this.symbol1, this.symbol2, this.symbol3, this.symbol4, this.symbol5, this.symbol6, this.symbol7, this.symbol8, this.symbol9, this.symbol10], this.addChild(this.sectionTitle, ...this.symbols)
                    }
                    updateBet(t) {
                        this.symbols.forEach((e => e.updateBet(t))), this.resize()
                    }
                    resize() {
                        this.game.device.desktop || (this.game.device.landscape ? (this.symbol1.position.set(0, this.sectionTitle.y + this.sectionTitle.height + 30), this.symbol2.position.set(820, this.sectionTitle.y + this.sectionTitle.height + 30), this.symbol3.position.set(0, this.symbol1.y + this.symbol1.height + 30), this.symbol4.position.set(820, this.symbol2.y + this.symbol2.height + 30), this.symbol5.position.set(0, this.symbol3.y + this.symbol3.height + 30), this.symbol6.position.set(820, this.symbol4.y + this.symbol4.height + 30), this.symbol7.position.set(0, this.symbol5.y + this.symbol5.height + 30), this.symbol8.position.set(820, this.symbol6.y + this.symbol6.height + 30), this.symbol9.position.set(0, this.symbol7.y + this.symbol7.height + 30), this.symbol10.position.set(820, this.symbol8.y + this.symbol8.height + 30)) : this.game.device.portrait && !this.game.device.desktop && (this.symbol1.position.set(0, this.sectionTitle.y + this.sectionTitle.height + 30), this.symbol2.position.set(0, this.symbol1.y + this.symbol1.height + 30), this.symbol3.position.set(0, this.symbol2.y + this.symbol2.height + 30), this.symbol4.position.set(0, this.symbol3.y + this.symbol3.height + 30), this.symbol5.position.set(0, this.symbol4.y + this.symbol4.height + 30), this.symbol6.position.set(0, this.symbol5.y + this.symbol5.height + 30), this.symbol7.position.set(0, this.symbol6.y + this.symbol6.height + 30), this.symbol8.position.set(0, this.symbol7.y + this.symbol7.height + 30), this.symbol9.position.set(0, this.symbol8.y + this.symbol8.height + 30), this.symbol10.position.set(0, this.symbol9.y + this.symbol9.height + 30)))
                    }
                }
                class zo extends(zt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "content1", void 0), this.title = new Io(Lt.i18n.t("PaytableSectionExtraBonusTitle").toUpperCase()), this.title.position.set(0, 0), this.content1 = new Fo(Lt.i18n.t("PaytableSectionExtraBonusContent1")), this.content1.position.set(0, this.title.height + this.title.y + 30), this.addChild(this.title, this.content1)
                    }
                    resize() {
                ...
                class Go extends(zt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "symbol1", void 0), (0, n.Z)(this, "content1", void 0), this.title = new Io(Lt.i18n.t("PaytableSectionWildTitle").toUpperCase()), this.title.position.set(0, 0), this.symbol1 = new _o("wild"), this.symbol1.position.set(0, this.title.y + this.title.height + 30), this.symbol1.withoutPayout(), this.content1 = new Fo(Lt.i18n.t("PaytableSectionWildContent1")), this.content1.position.set(this.symbol1.x + this.symbol1.width + 30, this.title.height + this.title.y + 30), this.content1.setTagStyle("default", {
                            wordWrapWidth: 690
                ...
                class Ho extends(zt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "symbol1", void 0), (0, n.Z)(this, "symbol2", void 0), (0, n.Z)(this, "symbol3", void 0), (0, n.Z)(this, "symbol4", void 0), (0, n.Z)(this, "content1", void 0), (0, n.Z)(this, "content2", void 0), (0, n.Z)(this, "content3", void 0), (0, n.Z)(this, "content4", void 0), (0, n.Z)(this, "content5", void 0), (0, n.Z)(this, "content6", void 0), this.title = new Io(this.game.i18n.t("PaytableSectionBonusGameTitle").toUpperCase()), this.title.position.set(0, 0), this.content1 = new Fo(this.game.i18n.t("PaytableSectionBonusGameContent1")), this.content1.position.set(0, this.title.height + this.title.y + 30), this.symbol1 = new _o("bonus1-no-word"), this.symbol1.position.set(0, this.content1.y + this.content1.height + 30), this.symbol1.withoutPayout(), this.content2 = new Fo(this.game.i18n.t("PaytableSectionBonusGameContent2")), this.content2.position.set(this.symbol1.x + this.symbol1.width + 30, this.content1.y + this.content1.height + 30), this.content2.setTagStyle("default", {
                            wordWrapWidth: 620
                        }), this.symbol2 = new _o("bonus2-no-word"), this.symbol2.position.set(0, this.symbol1.y + this.symbol1.height + 30), this.symbol2.withoutPayout(), this.content3 = new Fo(this.game.i18n.t("PaytableSectionBonusGameContent3")), this.content3.position.set(this.symbol2.x + this.symbol2.width + 30, this.symbol1.y + this.symbol1.height + 30), this.content3.setTagStyle("default", {
                            wordWrapWidth: 620
                        }), this.symbol3 = new _o("cowboy_girl"), this.symbol3.position.set(0, this.symbol2.y + this.symbol2.height + 30), this.symbol3.withoutPayout(), this.content4 = new Fo(this.game.i18n.t("PaytableSectionBonusGameContent4")), this.content4.position.set(this.symbol3.x + this.symbol3.width + 30, this.symbol2.y + this.symbol2.height + 30), this.content4.setTagStyle("default", {
                            wordWrapWidth: 620
                        }), this.symbol4 = new _o("indian_girl"), this.symbol4.position.set(0, this.symbol3.y + this.symbol3.height + 30), this.symbol4.withoutPayout(), this.content5 = new Fo(this.game.i18n.t("PaytableSectionBonusGameContent5")), this.content5.position.set(this.symbol4.x + this.symbol4.width + 30, this.symbol3.y + this.symbol3.height + 30), this.content5.setTagStyle("default", {
                            wordWrapWidth: 620
                        }), this.content6 = new Fo(this.game.i18n.t("PaytableSectionBonusGameContent6")), this.content6.position.set(0, this.symbol4.y + this.symbol4.height + 30), this.addChild(this.title, this.symbol1, this.symbol2, this.symbol3, this.symbol4, this.content1, this.content2, this.content3, this.content4, this.content5, this.content6)
                    }
                    resize() {
                ...
                class Qo extends Zo {
                    constructor(t) {
                        super(), (0, n.Z)(this, "_paytableSectionRNB", void 0), (0, n.Z)(this, "_paytableSectionPayout", void 0), (0, n.Z)(this, "_paytableSectionWild", void 0), (0, n.Z)(this, "_paytableSectionBonusSymbols", void 0), (0, n.Z)(this, "_paytableSectionBonusGame", void 0), (0, n.Z)(this, "_paytableSectionExtraBonus", void 0), (0, n.Z)(this, "_payTableDelimiter", void 0), (0, n.Z)(this, "_paytableSectionBetLines", void 0), this._paytableSectionRNB = new No, this._paytableSectionPayout = new Vo, this._paytableSectionWild = new Go, this._paytableSectionBonusSymbols = new Uo, this._paytableSectionBonusGame = new Ho, this._paytableSectionExtraBonus = new zo, this._payTableDelimiter = new Lo, this._paytableSectionBetLines = new jo(t, [5, 4]), this.content.addChild(this._paytableSectionRNB, this._paytableSectionPayout, this._paytableSectionWild, this._paytableSectionBonusSymbols, this._paytableSectionBonusGame, this._paytableSectionExtraBonus, this._payTableDelimiter, this._paytableSectionBetLines)
                    }
                    updateBet(t) {
                ...
                class cn extends tn {
                    constructor() {
                        super(), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "backgroundContent", void 0), (0, n.Z)(this, "buyFor", void 0), (0, n.Z)(this, "buyValue", void 0), (0, n.Z)(this, "onBet", void 0), (0, n.Z)(this, "onBetValue", void 0), (0, n.Z)(this, "featureButton", void 0), (0, n.Z)(this, "bonusHeader", void 0), (0, n.Z)(this, "header", void 0), (0, n.Z)(this, "onPress", void 0), this.onPress = new(x()), this.background = this.addChild(new $.j(this.game.loader.getAsset("risk", "bg"))), this.backgroundContent = this.addChild(new Q.W2), this.header = this.backgroundContent.addChild(new on({
                            default: {
                                fontSize: 24,
                                wordWrapWidth: 200,
                                fill: "#ffffff"
                            }
                        })), this.bonusHeader = this.backgroundContent.addChild(new $.j(this.game.loader.getAsset("risk", "bonus"))), this.bonusHeader.anchor.set(.5), this.buyFor = this.backgroundContent.addChild(new Ko({
                            default: {
                                fill: 16762931,
                                fontSize: 26,
                                wordWrapWidth: 220
                        ...
                        })), this.onBet = this.backgroundContent.addChild(new hn({
                            default: {
                                fill: 16762931,
                                fontSize: 26,
                                wordWrapWidth: 220
                            }
                        })), this.onBetValue = this.backgroundContent.addChild(new dn({
                            default: {
                                fontSize: 46
                            }
                        })), this.featureButton = this.addChild(new $.j(this.game.loader.getAsset("risk", "buy"))), this.featureButton.texture = this.game.loader.getAsset("risk", "risk"), this.featureButton.cursor = "pointer", this.featureButton.interactive = !1, this.game.interaction.click(this.featureButton, (() => {
                    ...
                    resize() {
                        this.game.device.desktop ? this.position.set(1600, 100) : this.game.device.landscape ? (this.scale.set(1.15), this.game.leftHand.enabled ? this.position.set(1600, 100) : this.position.set(60, 100)) : (this.scale.set(1.2), this.position.set(760, 370))
                    }
                }
                class un extends Y.K3 {
                    constructor(t) {
                ...
                class gn extends(zt(Q.W2)) {
                    constructor(t) {
                        var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [];
                        super(), (0, n.Z)(this, "lines", void 0), (0, n.Z)(this, "points", new Map), this.lines = t.map((t => this.addChild(new un(t)))), this.game.device.desktop && e.map((t => this.points.set(t.line, t.position.map((e => {
                            var i = this.addChild(new pn(t.line));
                ...
                var vn = Symbol("BonusScale");
                class yn extends(zt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "id", vn), (0, n.Z)(this, "gemsContainer", void 0), (0, n.Z)(this, "levelx1", void 0), (0, n.Z)(this, "levelx2", void 0), (0, n.Z)(this, "levelx3", void 0), (0, n.Z)(this, "levelx4", void 0), (0, n.Z)(this, "levelx5", void 0), this.hide(), this.gemsContainer = this.addChild(new Q.W2), this.levelx5 = new oo(this.game.loader.getAsset("assets/images/effects/bonus-gauge/skeleton.json")), this.levelx5.changeSkin("5"), this.levelx5.isActive = !0, this.levelx5.position.set(-33, 53), this.levelx4 = new oo(this.game.loader.getAsset("assets/images/effects/bonus-gauge/skeleton.json")), this.levelx4.changeSkin("4"), this.levelx4.isActive = !0, this.levelx4.position.set(23, 119), this.levelx3 = new oo(this.game.loader.getAsset("assets/images/effects/bonus-gauge/skeleton.json")), this.levelx3.changeSkin("3"), this.levelx3.isActive = !0, this.levelx3.position.set(70, 192), this.levelx2 = new oo(this.game.loader.getAsset("assets/images/effects/bonus-gauge/skeleton.json")), this.levelx2.changeSkin("2"), this.levelx2.isActive = !0, this.levelx2.position.set(93, 274), this.levelx1 = new oo(this.game.loader.getAsset("assets/images/effects/bonus-gauge/skeleton.json")), this.levelx1.changeSkin("1"), this.levelx1.isActive = !0, this.levelx1.position.set(110, 361), this.gemsContainer.addChild(this.levelx1, this.levelx2, this.levelx3, this.levelx4, this.levelx5), this.update(this.game.store.get("bonus:left", 0), !0)
                    }
                    update(t) {
                        for (var e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], i = [!1, !1, !1, !1, !1], s = -1; s < t; s++) i[s] = !0;
                        this.gemsContainer.children.forEach(((t, s) => {
                            i[s] && !t.isActive ? (t.alpha = 1, e ? t.play("idle", !0) : t.play("show").then((() => {
                                t.play("idle", !0)
                            })), t.isActive = !0) : !i[s] && t.isActive && (t.alpha = 0, t.isActive = !1)
                        }))
                    }
                    reset() {
                        this.gemsContainer.children.forEach((t => {
                            t.alpha = 0, t.isActive = !1
                        }))
                    }
                    resize() {
                        this.game.device.desktop || this.game.device.landscape, this.position.set(1270, 180)
                    }
                }
                ...
                const wn = class extends fn {
                    ...
                    get isStop() {
                        return super.isStop || !Ji.isBasic()
                    }
                    stop() {
                        this.slot.lines.hide(), this._wins.length = 0, clearInterval(this._flushInterval), this.slot.reels.forEach((t => t.stopAnimation())), Lt.action.emit("stopAnimation"), this.slot.textLineWin.clear(), this.slot.lines.hide()
                    }
                    _getWinSoundNumber() {
                    ...
                    scatterPayment(t) {
                        var e = this;
                        return (0, o.Z)((function*() {
                            e.slot.reels.forEach((t => t.overlay())), e.game.action.emit("sound:bonusWin"), e._runScatterSymbolAnimation(t), yield e.game.helpers.delay(qi.get("reward_scatter")), e.slot.reels.forEach((t => t.stopAnimation()))
                        }))()
                    }
                    bonusPayment(t) {
                        var e = this;
                    ...
                    _runSymbolAnimation(t) {
                        ...
                        for (var s = 0; s < e.length; s++)
                            if (-1 !== e[s]) {
                                var o = e[s];
                                this.slot.getSymbolByPosition(s, o).playAnimation(i)
                            }
                    }
                ...
                class xn {
                    constructor() {
                        (0, n.Z)(this, "container", void 0), (0, n.Z)(this, "tween", void 0), this.container = new b.Xz("", {
                            fontName: "WinFont"
                ...
                class En extends Sn {
                    constructor(t) {
                        super(t), (0, n.Z)(this, "data", void 0), (0, n.Z)(this, "layoutType", void 0), (0, n.Z)(this, "symbolAnimation", void 0), (0, n.Z)(this, "isPlaying", !1), this.layoutType = "default", this.symbolAnimation = new oo(this.game.loader.getAsset("symbolAnimation")), this.symbolAnimation.renderable = !1, this.replaceTexture(t)
                    }
                    replaceTexture(t) {
                        var e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                            i = arguments.length > 2 && void 0 !== arguments[2] && arguments[2];
                        ("bonus" === this.game.store.get("reward:feature") || "bonus" === this.game.store.get("server:action")) && Ji.isBonus() && !e || i ? (t = "string" == typeof t ? t.slice(0, 1) : t, this.currentTextureIndex = 0 === t || -1 === t ? 0 : t <= 10 ? 21 : t > 10 ? 31 : "M" === t ? 2 : 3) : this.currentTextureIndex = +(t > -1 ? t : 0), this.data = this.game.config.get("slot.layout.".concat(this.layoutType, "[").concat(this.currentTextureIndex, "]"), null), this.texture = this.game.loader.getAsset(this.data.textureAtlas, this.data.assetName)
                    }
                    blur() {
                    ...
                    playAnimation(t) {
                        var e;
                        this.hide(), Cn.addChild(this.symbolAnimation);
                        var i = Bn(Bn({}, this.data.animation), t);
                    ...
                    get isBonus() {
                        return 21 === this.currentTextureIndex || 31 === this.currentTextureIndex || 2 === this.currentTextureIndex || 3 === this.currentTextureIndex
                    }
                    clearAnimation() {
                        this.isPlaying && (this.show(), this.symbolAnimation.stop(), this.symbolAnimation.renderable = !1)
                    }
                    stopAnimation() {
                        this.isPlaying = !1, this.show(), this.symbolAnimation.stop(), this.symbolAnimation.renderable = !1, Cn.removeChild(this.symbolAnimation)
                    }
                    overlay() {
                        this.tint = 10000536
                    }
                ...
                class On extends(zt(Q.W2)) {
                    constructor(t) {
                        super(), (0, n.Z)(this, "stickyAnimation", void 0), (0, n.Z)(this, "slot", void 0), (0, n.Z)(this, "stickyContainer", void 0), (0, n.Z)(this, "updateContainer", void 0), (0, n.Z)(this, "winSoundPlay", void 0), this.slot = t, this.stickyContainer = this.addChild(new Q.W2), this.updateContainer = this.addChild(new Q.W2)
                    }
                    showSticky(t) {
                        var e = arguments,
                            i = this;
                                ...
                                t.forEach((t => {
                                    if (t.isNew || s) {
                                        var e = i.slot.getReelByPosition(t.pos[0], t.pos[1]),
                                            ...
                                            n = 0 === o || -1 === o ? 0 : o <= 10 ? 21 : o > 10 ? 31 : "M" === o ? 2 : 3,
                                            a = i.game.config.get("slot.layout.default[".concat(n, "]")).assetName;
                                        i.stickyAnimation = i.stickyContainer.addChild(new oo(i.game.loader.getAsset("symbolAnimation"))), i.stickyAnimation.position.set(e.x, e.y), i.stickyAnimation.changeSkin(a), i.stickyAnimation.play("idle"), i.showBonusText(t.sym, i.stickyAnimation)
                                    }
                                })), t.some((t => t.isNew)) && (yield i.game.helpers.delay(s ? 0 : 300));
                                var n = i.game.get("BonusWinText");
                                s ? n.updateAll() : yield i.updateValues(t, o)
                            }
                        }))()
                    }
                    showBonusText(t, e) {
                        return (0, o.Z)((function*() {
                            ...
                            return i.text = s, i.position.set("string" != typeof t ? e.width / 2 + 20 : e.width / 2, e.height / 2), i.type = "string" == typeof t ? "fs" : "mul", i.value = "string" == typeof t ? parseInt(t.slice(2) + t.slice(0, 2), 10) : t, i.renderable = !0, k.fromTo(i, .5, {
                                pixi: {
                                    scale: 1.5
                                }
                            }, {
                            ...
                            t.forEach((t => {
                                if (t.isNew) {
                                    var e = i.slot.getReelByPosition(t.pos[0], t.pos[1]),
                                        ...
                                        a = [-300, 500],
                                        h = [1300, 400],
                                        r = i.updateContainer.addChild(new oo(i.game.loader.getAsset("assets/images/effects/symbols/sym-magic/skeleton.json")));
                ...
                class Zn extends(zt(Q.W2)) {
                    constructor(t, e) {
                        ...
                        }), this._spinTween = new k(this._symbolsContainer, Lt.config.get("wheel.durationSpin"), {
                            paused: !0,
                            roundProps: ["y"],
                            pixi: {
                    ...
                    _setup() {
                        ...
                        this._symbolsContainer.addChild(new En(this._nReel[this.game.helpers.random(0, s.length - 1)])).position.set(0, 15 - i);
                        var h = this._symbolsContainer.addChild(new En(this._reel[0]));
                        h.position.set(0, 0), this._symbolsContainer.addChild(new En(this._nReel[this.game.helpers.random(0, s.length - 1)])).position.set(0, i - 15), this.visibleSymbols.push(h), this.rectMask = this.addChild(new u.TC), this.rectMask.alpha = 0, this.rectMask.beginFill(), this.rectMask.drawRect(63, 63, e, i), this.rectMask.endFill(), this.x = n, this.y = a, this._startY = this._symbolsContainer.children[0].y, this.showNReel(!1)
                    }
                    _spin() {
                ...
                class Rn extends mn {
                    constructor() {
                        super(), (0, n.Z)(this, "animation", void 0), (0, n.Z)(this, "reels", void 0), (0, n.Z)(this, "reelsContainer", void 0), (0, n.Z)(this, "stopReelCounter", void 0), (0, n.Z)(this, "symbolsPositions", void 0), (0, n.Z)(this, "textLineWin", void 0), (0, n.Z)(this, "textTotalWin", void 0), (0, n.Z)(this, "lines", void 0), (0, n.Z)(this, "slotData", void 0), (0, n.Z)(this, "gridBack", void 0), (0, n.Z)(this, "grid", void 0), (0, n.Z)(this, "train", void 0), (0, n.Z)(this, "trainBoard", void 0), (0, n.Z)(this, "trainEffect", void 0), (0, n.Z)(this, "trainEffectWheels", void 0), (0, n.Z)(this, "trainEffectBottom", void 0), (0, n.Z)(this, "sticky", void 0), (0, n.Z)(this, "bonusScale", void 0), this.pivot.set(2670, 0), this.reels = [], this.symbolsPositions = this.game.config.get("slot.symbolsPositions", []), this.animation = new wn(this), this.stopReelCounter = 0, this.init(), this.setupEvents()
                    }
                    init() {
                        var t, e;
                        this.reelsContainer = new Q.W2;
                        ...
                        this.slotData = {
                        ...
                        }, this.lines = new gn(this.slotData.lines.map((t => ({
                            color: 16763904,
                            width: 4,
                            padding: 125,
                            points: t.map(((t, e) => {
                        ...
                        })))), this.textTotalWin = new bn(.9, "1.4"), this.textTotalWin.position.set(667, 700), this.textLineWin = new xn, this.gridBack = new $.j(this.game.loader.getAsset("grid-bottom")), this.gridBack.position.set(-311, 41), this.grid = new $.j(this.game.loader.getAsset("grid")), this.grid.position.set(-311, 41), this.train = new $.j(this.game.loader.getAsset("train")), this.train.position.set(-311, 41), k.to(this.train, .5, {
                            pixi: {
                                y: 45
                            },
                            yoyo: !0,
                            repeat: 1 / 0,
                            repeatDelay: 0
                        }), this.trainBoard = new $.j(this.game.loader.getAsset("board")), this.trainBoard.position.set(-311, 41), this.trainBoard.alpha = 0, k.to(this.train, .5, {
                            pixi: {
                                y: 45
                            },
                            yoyo: !0,
                            repeat: 1 / 0,
                            repeatDelay: 0
                        }), this.trainEffect = new An(1), this.trainEffect.position.set(-311, 41), this.trainEffect.addChild(new oo(this.game.loader.getAsset("effectTrain"))).play("animation", !0), this.trainEffectWheels = new An(1), this.trainEffectWheels.position.set(-311, 41), this.trainEffectWheels.addChild(new oo(this.game.loader.getAsset("effectTrainWheels"))).play("animation", !0), this.trainEffectBottom = new An(1), this.trainEffectBottom.position.set(-311, 41), this.trainEffectBottom.addChild(new oo(this.game.loader.getAsset("effectTrainBottom"))).play("animation", !0), this.sticky = new On(this), this.bonusScale = new yn, this.addChild(this.bonusScale), this.addChild(this.train), this.addChild(this.trainEffectBottom), this.addChild(this.gridBack), this.addChild(this.reelsContainer), this.addChild(this.lines), this.addChild(Cn), this.addChild(Pn), this.addChild(this.grid), this.addChild(this.textLineWin.container), this.addChild(this.textTotalWin), this.addChild(this.trainEffect), this.addChild(this.trainBoard), this.addChild(this.sticky), this.addChild(this.trainEffectWheels)
                    }
                    setupEvents() {
                        var t = this;
                        this.game.action.on("state:ready_enter", this._onReadyEnter, this), this.game.action.on("state:spin_enter", this._onSpinEnter, this), this.game.action.on("state:stop_enter", this._onStopEnter, this), this.game.action.on("state:finish_enter", this._onFinishEnter, this), this.game.action.on("wheel:stop", this._onStopWheel, this), this.game.action.on("spin:fast", this._onFastStop, this), this.game.action.on("reward:reset", this._onResetReward, this), this.game.action.on("bonus:start", (0, o.Z)((function*() {
                            ...
                            t.sticky.hide(), t.trainBoard.alpha = 0, t.alpha = 1
                        }))), this.game.action.on("bonus:select_start", (0, o.Z)((function*() {
                            t.bonusScale.show(), t.animation.stop(), t.trainBoard.alpha = 1, k.fromTo(t, .5, {
                                pixi: {
                                    alpha: 0
                                }
                            }, {
                    ...
                    startTrain() {
                        var t = this;
                        return (0, o.Z)((function*() {
                            t.game.action.emit("sound:trainRun"), yield k.to(t, 1.35, {
                                pixi: {
                                    pivotX: 750
                                },
                                delay: .5,
                    ...
                    bonusTrain() {
                        var t = this;
                        return (0, o.Z)((function*() {
                            t.lines.hide(), t.game.action.emit("sound:trainRun"), yield k.to(t, 1, {
                                pixi: {
                                    pivotX: -1350
                                },
                                delay: .5,
                    ...
                    _onReadyEnter() {
                        ...
                        return (0, o.Z)((function*() {
                            ...
                            }), qi.get("before_spin_auto")) : Ji.isBonus() && setTimeout((() => {
                                t.game.action.emit("spin:start")
                            }), 500)
                        }))()
                    }
                    updateBonusLeft() {
                        if (Ji.isBonus() && "drop" !== this.game.store.get("server:nextAction")) {
                    ...
                    _onSpinEnter() {
                        var t = this;
                        return (0, o.Z)((function*() {
                            t.lines.disable(), t.animation.stop();
                            try {
                                yield t.game.beforeSpin(), t.updateBonusLeft(), Ji.isBonus() && t.bonusScale.update(t.game.store.get("bonus:left", 0) - 1), yield Promise.all([...t.reels.map((t => t.start())), yield t.requestSpin()]), t.game.state.goTo("stop")
                            } catch (e) {
                    ...
                    _onStopEnter() {
                        this.reels.forEach((t => t.stop())), Lt.action.emit("wheel:stop_down")
                    }
                    _onFastStop() {
                    ...
                    _onFinishEnter() {
                        var t = this;
                        return (0, o.Z)((function*() {
                            t.stopReelCounter = 0, Ji.set(t.game.store.get("reward:feature")), Ji.isBonus() || (yield t.game.freeRound.finish()), t.game.autoPlay.enabled ? t.game.checkBalance().then((() => {
                    ...
                    beforeFreeSpinsPopup() {
                        this.alpha = 0, this.pivot.x = 2670
                    }
                    resize() {
                        this.game.device.desktop || this.game.device.landscape ? (this.scale.set(1), this.position.set(1053, -50)) : (this.scale.set(.6), this.position.set(600, 380))
                    }
                }
                class Mn extends(zt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "timeline", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "value", void 0), (0, n.Z)(this, "light", void 0), (0, n.Z)(this, "coins", void 0), (0, n.Z)(this, "onPress", void 0), this.visible = !1, this.interactive = !0, this.onPress = new(x()), this.game.interaction.click(this, (() => this.onPress.dispatch())), this.timeline = new B, this.content = new Q.W2, this.overlay = new Jt(.75), this.title = new $.j, this.title.anchor.set(.5), this.title.alpha = 0, this.value = new b.Xz("", {
                            fontName: "WinFont"
                        }), this.value.anchor = .5, this.light = new oo(this.game.loader.getAsset("effectBigWin")), this.light.alpha = 0, this.coins = new oo(this.game.loader.getAsset("effectGiantWin")), this.coins.alpha = 0, this.content.addChild(this.title), this.content.addChild(this.value), this.addChild(this.overlay), this.addChild(this.light), this.addChild(this.coins), this.addChild(this.content)
                    }
                    show(t, e) {
                        var i = this;
                        return (0, o.Z)((function*() {
                            var s = 0;
                            t === fe ? (s = 9, i.game.action.emit("sound:bigWin")) : t === we && (s = 18, i.game.action.emit("sound:giantWin")), i.title.texture = i.game.loader.getAsset("textBigWin");
                            var o = !1;
                            ...
                            return new Promise((a => {
                                ...
                                i.timeline.to(i.value, .5, {
                                    ...
                                    onUpdate: () => {
                                        !o && t === we && h.coins > e / 2 && (i.title.texture = i.game.loader.getAsset("textGiantWin"), o = !0, i.coins.play("animation", !0), i.coins.alpha = 1, k.to(i.value, s / 2, {
                                            pixi: {
                                                scale: n + .2
                                            }
                ...
                new class extends class extends class extends class {
                    constructor(t) {
                        ...
                        (0, n.Z)(this, "rootNode", void 0), (0, n.Z)(this, "renderer", void 0), (0, n.Z)(this, "logger", void 0), (0, n.Z)(this, "i18n", void 0), (0, n.Z)(this, "helpers", void 0), (0, n.Z)(this, "keyboard", void 0), (0, n.Z)(this, "device", void 0), (0, n.Z)(this, "viewport", void 0), (0, n.Z)(this, "leftHand", void 0), (0, n.Z)(this, "fullscreen", void 0), (0, n.Z)(this, "visibility", void 0), (0, n.Z)(this, "preferences", void 0), (0, n.Z)(this, "sound", void 0), (0, n.Z)(this, "state", void 0), (0, n.Z)(this, "store", void 0), (0, n.Z)(this, "action", void 0), (0, n.Z)(this, "config", void 0), (0, n.Z)(this, "loader", void 0), (0, n.Z)(this, "error", void 0), (0, n.Z)(this, "interaction", void 0), (0, n.Z)(this, "popupManager", void 0), (0, n.Z)(this, "externalApi", void 0), (0, n.Z)(this, "_globals", new Map), (0, n.Z)(this, "settings", {
                            ...
                            C.removeEventListener("tick", this.tick), et.vB.shared.destroy(), it.destroyTextureCache(), this.renderer.destroy(), this.loader.destroy()
                        })), Lt = this, et.vB.shared.autoStart = !1, et.vB.shared.stop(), this.config = new ht(Ft), this.logger = new Bt, this.rootNode = this.createRootNode(), this.renderer = new Ct, this.i18n = new vt(e), this.helpers = new bt(this.config), this.keyboard = new wt, this.device = new mt(this.renderer), this.viewport = new Rt, this.leftHand = new ut, this.fullscreen = this.device.ios || this.device.iPadPro ? new dt : new ct(this.device), this.visibility = new Vt, this.preferences = new Ut, this.sound = new R(this.device, this.visibility, this.preferences), this.state = new Zt, this.store = new ht, this.action = new gt, this.loader = new kt(this.device), this.error = new At, this.interaction = new yt(this.device), this.externalApi = new Wt(this), this.popupManager = new jt(this.rootNode), this.create(), this.initAnalytics()
                    }
                    initAnalytics() {
                        return (0, o.Z)((function*() {
                            try {
                    ...
                    initPopups() {
                        this.popupManager.add([new Di, new Wi, new Fi, new Zi, new _i, new Mi, new ji, new Li, new Ii, new Ri, new Ni])
                    }
                    loadAssets(t) {
                    ...
                    connect(t) {
                        var e = this;
                        return (0, o.Z)((function*() {
                            e.launcher = e.rootNode.addChild(new yi);
                            try {
                    ...
                    constructor() {
                        super(...arguments), (0, n.Z)(this, "wallet", void 0), (0, n.Z)(this, "bigWin", void 0), (0, n.Z)(this, "autoPlay", void 0), (0, n.Z)(this, "betLevel", void 0), (0, n.Z)(this, "freeRound", void 0), (0, n.Z)(this, "quickSpin", void 0), (0, n.Z)(this, "netPosition", new ci), (0, n.Z)(this, "currentTime", void 0), (0, n.Z)(this, "elapsedTime", void 0), (0, n.Z)(this, "copyright", void 0), (0, n.Z)(this, "menu", void 0), (0, n.Z)(this, "betSettings", void 0), (0, n.Z)(this, "autoPlaySettings", void 0), (0, n.Z)(this, "controls", void 0), (0, n.Z)(this, "riskFeature", void 0), (0, n.Z)(this, "nextRiskFeature", void 0), (0, n.Z)(this, "gameSettings", void 0), (0, n.Z)(this, "checkboxLeftHand", void 0), (0, n.Z)(this, "checkboxGameSounds", void 0), (0, n.Z)(this, "checkboxBackgroundSounds", void 0), (0, n.Z)(this, "checkboxQuickSpin", void 0), (0, n.Z)(this, "checkboxFullscreen", void 0), (0, n.Z)(this, "checkboxRiskFeature", void 0), (0, n.Z)(this, "checkboxIntroScreen", void 0)
                    }
                    initModules(t) {
                        var e, i, s;
                        super.initModules(t);
                        var o = this.server.response;
                        this.wallet = new ai(this.server), this.betLevel = new It(null == o ? void 0 : o.bet, null == o ? void 0 : o.bets, null !== (e = null == o ? void 0 : o.betCoins) && void 0 !== e ? e : 1), this.autoPlay = new ei({
                            counts: this.config.get("autoPlay.counts", [10, 25, 50, 100, 150, 300, -1]).map((t => {
                                var e = Number(t);
                                return -1 === e ? 1 / 0 : e
                            })).filter((t => t > 0))
                        }), this.freeRound = new si, this.quickSpin = new ni(this.config), this.bigWin = new ii(this.config.get("bigWin.bigMultiplier"), this.config.get("bigWin.giantMultiplier"), this.betLevel), this.config.set("autoPlay.available", this.autoPlay.available), this.config.set("quickSpin.available", this.quickSpin.available), this.netPosition.setEnabled(null !== (i = null == o || null === (s = o.gameConfig) || void 0 === s ? void 0 : s.netPosition) && void 0 !== i && i)
                    }
                    initViews() {
                        super.initViews(), this.currentTime = new ri, this.elapsedTime = new li, this.copyright = new hi
                    }
                    mountViews() {
                        super.mountViews(), this.netPosition.enabled && (this.rootNode.addChild(this.netPosition.toView(new di)), this.rootNode.addChild(this.elapsedTime)), this.rootNode.addChild(this.currentTime), this.rootNode.addChild(this.copyright)
                    }
                    start() {
                    ...
                    createQuickSpinCheckbox() {
                        return this.checkboxQuickSpin = new bi, this.checkboxQuickSpin.onClick.add((() => {
                            this.quickSpin.toggle()
                        })), this.checkboxQuickSpin
                    }
                    createFullscreenCheckbox() {
                        return this.checkboxFullscreen = new pi, this.checkboxFullscreen.onClick.add((() => {
                    ...
                    createLeftHandCheckbox() {
                        return this.checkboxLeftHand = new Ai, this.checkboxLeftHand.onClick.add((() => {
                            this.leftHand.toggle()
                        })), this.checkboxLeftHand
                    }
                    createGameSoundsCheckbox() {
                        return this.checkboxGameSounds = new gi, this.checkboxGameSounds.onClick.add((() => {
                            this.sound.toggle("effects")
                        })), this.checkboxGameSounds
                    }
                    createBackgroundSoundsCheckbox() {
                        return this.checkboxBackgroundSounds = new ui, this.checkboxBackgroundSounds.onClick.add((() => {
                            this.sound.toggle("background")
                        })), this.checkboxBackgroundSounds
                    }
                    createRiskFeatureCheckbox() {
                        if (this.config.get("rnb", !0)) return this.checkboxRiskFeature = new vi, this.checkboxRiskFeature.setChecked(this.preferences.get("showRiskFeature", !0)), this.checkboxRiskFeature.onClick.add((t => {
                            var e, i;
                    ...
                    createIntroScreenCheckbox() {
                        return this.checkboxIntroScreen = new mi, this.checkboxIntroScreen.setChecked(this.preferences.get("showIntroScreen", !0)), this.checkboxIntroScreen.onClick.add((t => {
                            this.preferences.set("showIntroScreen", t)
                        })), this.checkboxIntroScreen
                    }
                } {
                    constructor() {
                        super({}), (0, n.Z)(this, "autoPlaySettings", void 0), (0, n.Z)(this, "betSettings", void 0), (0, n.Z)(this, "introScreen", void 0), (0, n.Z)(this, "bigWinAnimation", void 0), (0, n.Z)(this, "fastStopLayout", void 0), (0, n.Z)(this, "gameRules", void 0), (0, n.Z)(this, "menu", void 0), (0, n.Z)(this, "paytable", void 0), (0, n.Z)(this, "bonusWinText", void 0), (0, n.Z)(this, "bonusOverlay", void 0), (0, n.Z)(this, "bonusTotalWin", void 0), (0, n.Z)(this, "slot", void 0), (0, n.Z)(this, "background", void 0), os.init(), this.init(Hi, Yi)
                    }
                    loadTranslations() {
                    ...
                    showIntroScreen() {
                        ...
                        return (0, o.Z)((function*() {
                            var e;
                            if (t.background = t.rootNode.addChild(new Ps), null === (e = t.sound.get("backgroundNormal")) || void 0 === e || e.fade(2), t.preferences.get("showIntroScreen", !0) && "bonus" !== t.server.response.feature) return t.introScreen = t.rootNode.addChild(new Oo), t.introScreen.play()
                        }))()
                    }
                    initModules(t) {
                        super.initModules(t), this.wallet = new Cs(this.server), this.sound = new ns(this.device, this.visibility, this.preferences)
                    }
                    initViews() {
                        var t, e, i, s, n, a = this;
                        super.initViews(), Ji.set(null !== (t = null === (e = this.server) || void 0 === e || null === (i = e.response) || void 0 === i ? void 0 : i.feature) && void 0 !== t ? t : Xi.Basic), this.background.logo.alpha = 1, this.slot = this.rootNode.addChild(new Rn), this.rootNode.addChild(this.background.bgitems), this.riskFeature = this.rootNode.addChild(new cn), this.bonusTotalWin = new ks, this.rootNode.addChild(this.bonusTotalWin), this.bonusWinText = this.slot.addChild(new Bs), this.paytable = new Qo(null !== (s = null === (n = this.server) || void 0 === n ? void 0 : n.response.lines) && void 0 !== s ? s : []), this.gameSettings = new Ue, this.config.get("quickSpin.available", !0) && this.gameSettings.addItem(this.createQuickSpinCheckbox()), this.gameSettings.addItem(this.createFullscreenCheckbox()), this.gameSettings.addItem(this.createLeftHandCheckbox()), this.gameSettings.addItem(this.createGameSoundsCheckbox()), this.gameSettings.addItem(this.createBackgroundSoundsCheckbox()), this.gameSettings.addItem(this.createIntroScreenCheckbox()), this.gameSettings.addItem(this.createRiskFeatureCheckbox()), this.bigWinAnimation = new Mn, this.fastStopLayout = new Te, this.controls = this.device.desktop ? new Ao : new vo, this.betSettings = this.rootNode.addChild(new Ee), this.betSettings.setBets(this.betLevel.bets, this.betLevel.betCoins), this.betSettings.setPayLines("20"), this.betSettings.setBet(this.betLevel.bet), this.autoPlaySettings = this.rootNode.addChild(new de), this.autoPlaySettings.setAutoPlayCounts(this.autoPlay.counts), this.autoPlaySettings.stopSection.addItem(new Se), this.autoPlaySettings.stopSection.addItem(new ve), this.autoPlaySettings.stopSection.addItem(new Ae), this.autoPlaySettings.stopSection.addItem(new be), this.gameRules = new _e, this.menu = new Ge, this.menu.addItem(this.loader.getAsset("iconPaytable"), this.paytable), this.menu.addItem(this.loader.getAsset("iconSettings"), this.gameSettings), this.menu.addItem(this.loader.getAsset("iconRules"), this.gameRules), this.rootNode.addChild(this.fastStopLayout), this.rootNode.addChild(this.menu), this.rootNode.addChild(this.controls), this.rootNode.addChild(this.bigWinAnimation), this.bonusOverlay = this.rootNode.addChild(new Es), this.paytable.updateBet(this.betLevel), this.controls.updateBet(this.betLevel), this.betSettings.on("open", (() => {
                            ...
                            if (a.action.emit("sound:click"), a.onPopupShow(), a.riskFeature.hide(), a.wallet.balance - a.store.get("buy").bet < 0) yield a.popupManager.show("PopupZeroBalance"), a.onPopupHide();
                                ...
                                try {
                                    ...
                                    }), Ji.set(a.store.get("reward:feature", Xi.Basic)), a.onRNBStart(), a.slot.bonusScale.update(a.store.get("bonus:left", 0), !0), yield a.checkBonus(), setTimeout((() => {
                                        a.controls.unlock(), a.action.emit("spin:start")
                                    }), qi.get("beforeFreeSpins"))), a.onPopupHide()
                                } catch (t) {
                            ...
                            this.riskFeature.hide(), this.riskFeature.updateCurrentBet(this.betLevel.bet), this.autoPlay.enabled && Ji.isBasic() && (this.autoPlay.setCount(this.autoPlay.count - 1), this.controls.setAutoPlayCount(this.autoPlay.count)), this.controls.onSpinEnter()
                        })), this.action.on("state:finish_enter", (() => {
                            this.autoPlay.count <= 0 && this.autoPlay.disable(), this.controls.onFinishEnter()
                        }))
                    }
                    initStates() {
                        super.initStates(), this.state.add("setup", new ps(this), ["ready"]), this.state.add("ready", new ls(this), ["spin"]), this.state.add("spin", new ms(this), ["stop"]), this.state.add("stop", new bs(this), ["reward"]), this.state.add("reward", new cs(this), ["finish"]), this.state.add("finish", new hs(this), ["ready"])
                    }
                    beforeFreeSpinsPopup() {
                    ...
                    start() {
                        ...
                        return (0, o.Z)((function*() {
                            ...
                            yield e.freeRound.start(), e.state.goTo("setup"), i || (yield e.slot.startTrain(), e.background.startTrain()), i && (yield e.checkBonus(!0)), e.state.goTo("ready")
                        }))()
                    }
                    reward() {
                        var t = this,
                        ...
                        return (0, o.Z)((function*() {
                            var o;
                            e(), null !== (o = t.bigWin) && void 0 !== o && o.available(t.wallet.coins) && !Ji.isBonus() && (t.bigWinAnimation.press(i), t.controls.pressButtonSpin(i), yield t.bigWinAnimation.show(t.bigWin.type(t.wallet.coins), t.wallet.coins), t.sound.stopBigWin(), e());
                            ...
                            if (a.length > 0 && (t.controls.disableButtonSpin(), t.slot.textTotalWin.once("show", (() => {
                                ...
                                yield t.helpers.delay(1e3), t.store.get("bonus:left", 0) > 0 && (t.device.desktop ? t.controls.textBonusLeft.hide() : t.controls.statusBar.update({
                                    type: Xe.BonusLeft,
                                    value: -1
                                }), yield t.bonusWinText.bonusLeftToModificators()), yield t.bonusWinText.totalWin(), t.bonusWinText.reset(), t.slot.bonusScale.reset(), t.bonusTotalWin.press(s), t.sound.stopBonusTotalWin(), t.controls.pressButtonSpin(s), t.bonusTotalWin.onBeforeEnd.once((() => {
                    ...
                    checkBonus() {
                        ...
                        return (0, o.Z)((function*() {
                            ...
                            if (i) e.action.emit("update:win", e.wallet.dropCoins, e.freeRound.enabled && Ji.isBonus() ? e.wallet.preSpinTotalCoins : e.wallet.totalCoins), e.background.startTrain(), yield e.slot.sticky.showSticky(s, !0), yield e.bonusOverlay.show(xs.RESTORE), yield e.slot.startTrain();
                            else if (e.store.get("bonus:isStart", !1)) {
                                var o = s.filter((t => t.isNew));
                                e.bonusWinText.reset(), e.slot.bonusScale.update(e.store.get("bonus:left", 0), !0), yield e.slot.bonusTrain(), e.beforeFreeSpinsPopup(), yield e.bonusOverlay.show(xs.START), e.action.emit("update:balance"), yield e.slot.startTrain(), yield e.slot.animation.bonusPayment(o), yield e.slot.sticky.showSticky(s, !1, !0)
                            } else e.store.get("bonus:isEnd", !1) && (yield e.delay(qi.get("afterFreeSpins")), yield e.slot.bonusTrain(), e.bonusWinText.reset(), e.beforeFreeSpinsPopup(), yield e.bonusOverlay.show(xs.END), yield e.slot.startTrain(), yield e.delay(300))
                        }))()
                    }
                    checkBalance() {
                        var t = this;
                    ...
                    beforeSpin() {
                        var t = this;
                        return (0, o.Z)((function*() {
                            t.autoPlay.enabled || Ji.isBonus() || (yield t.quickSpin.tryEnable())
                        }))()
                    }
                    afterReelsStop() {
                        !this.store.get("spin:isFast", !1) || this.autoPlay.enabled || Ji.isBonus() || this.quickSpin.update()
                    }
                }
            },
            6599: () => {},
    ...
    n.m = s, t = [], n.O = (e, i, s, o) => {
    ...
    }), t), n.o = (t, e) => Object.prototype.hasOwnProperty.call(t, e), e = {}, i = "loot_the_train:", n.l = (t, s, o, a) => {
        if (e[t]) e[t].push(s);
        else {
            var h, r;
            if (void 0 !== o)
        ...
        var e = (e, i) => {
            ...
            i = self.webpackChunkloot_the_train = self.webpackChunkloot_the_train || [];
        i.forEach(e.bind(null, 0)), i.push = e.bind(null, i.push.bind(i))
    })();
    var a = n.O(void 0, [216], (() => n(1512)));
    a = n.O(a)
})();