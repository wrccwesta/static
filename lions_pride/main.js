...
(() => {
            ...
            1621: (t, e, i) => {
                ...
                class y {
                    ...
                    static loadFromBuffer(t) {
                        var e, i, s, o, n, a, h, r, l, c, d, u, p, g, A, m, v, b, f, w = null !== (e = null === (i = t.metadata) || void 0 === i || null === (s = i.font) || void 0 === s ? void 0 : s.family) && void 0 !== e ? e : t.name;
                ...
                class z {
                    ...
                    readSkeletonData(t, e) {
                        var i = e.skeleton.spine,
                            s = N(i),
                            o = null;
                        if (s === M.VER37 && (o = new I.SkeletonJson(new I.AtlasAttachmentLoader(t))), s === M.VER38 && (o = new D.SkeletonJson(new D.AtlasAttachmentLoader(t))), s !== M.VER40 && s !== M.VER41 || (o = new L.SkeletonJson(new L.AtlasAttachmentLoader(t))), !o) {
                ...
                var V = i(512),
                    ...
                    et = i(798),
                    it = i(5277);
                u.TC.nextRoundedRectBehavior = !0, m.xv.nextLineHeightBehavior = !0, d.R.add(p.bx, g.B9, c.Bv, a.c, h.Q, r.T, l.O, v.vl, A.o, G, y, R), window.PIXI = s;
                var st = i(3233),
                    ot = i.n(st);
                                ...
                                for (var k = 0; k < x.length; k++) {
                                    ...
                                    switch (C.valign) {
                                        ...
                                        case "baseline":
                                            ...
                                            break;
                                        case "middle":
                                            O += (a[w] - n[w] - B.ascent - B.descent) / 2;
                                            break;
                                        case "bottom":
                                            O += a[w] - n[w] - B.ascent - B.descent;
                                            break;
                                        default:
                                            O += a[w] - B.ascent - C.valign
                                    }
                                    if (0 === C.letterSpacing) f.push({
                                        ...
                                        for (var Z = 0; Z < P.length; Z++) {
                                            ...
                                            var R = this.context.measureText(P.charAt(Z)).width;
                                            f.push({
                                                text: P.charAt(Z),
                                                style: C,
                                                x: S,
                                                ...
                                                descent: B.descent,
                                                tag: F
                                            }), S += R, (Z < P.length - 1 || k < x.length - 1) && (S += C.letterSpacing / 2)
                                        }
                                    }
                                }
                                y += a[w] - n[w]
                ...
                class Ne extends(Gt(H.W2)) {
                    ...
                    addSections() {
                        this.content.addChild(new We), this.content.addChild(new De), this.content.addChild(new Le), this.addAutoPlaySection(), this.content.addChild(new _e), this.content.addChild(new Me), this.content.addChild(new je)
                    }
                    addAutoPlaySection() {
                ...
                const Si = class extends It {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupFreeRound"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "icon", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContinue", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt, this.content = new H.W2, this.icon = new bi(ui), this.icon.anchor.x = .5, this.title = new xi(this.game.i18n.t("PopupFreeRoundStartTitle")), this.title.anchor.x = .5, this.message = new fi("", {
                            wordWrap: !0,
                            wordWrapWidth: 600
                ...
                const Bi = class extends It {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupRestore"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "icon", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContinue", void 0), (0, n.Z)(this, "resolver", null), this.overlay = this.addChild(new Jt), this.content = this.addChild(new H.W2), this.icon = new bi(ui), this.icon.anchor.x = .5, this.message = new fi(this.game.i18n.t("PopupRestoreMessage"), {
                            wordWrap: !0,
                            wordWrapWidth: 320
                        }), this.message.anchor.x = .5, this.actionContinue = new vi(this.game.i18n.t("PopupActionContinue"), {
                            fill: 16777215
                ...
                const Ti = class extends It {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupSound"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "icon", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContainer", void 0), (0, n.Z)(this, "actionYes", void 0), (0, n.Z)(this, "actionNo", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt, this.content = new H.W2, this.icon = new bi(gi), this.icon.anchor.x = .5, this.message = new fi(this.game.i18n.t("PopupSoundMessage"), {
                            wordWrap: !0
                ...
                const Di = [...[{
                    ...
                    url: "assets/images/effects/spin_periodic/skeleton.json",
                    name: "effectSpinPeriodic",
                    metadata: {
                        platform: ["desktop"]
                    }
                }, {
                    ...
                    url: "assets/images/effects/symbols/giraffee/skeleton.json",
                    name: "effectGiraffee",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/effects/symbols/hyena/skeleton.json",
                    name: "effectHyena",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/effects/symbols/pride/skeleton.json",
                    name: "effectPride",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/effects/symbols/zebra/skeleton.json",
                    name: "effectZebra",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                    ...
                    slot: {
                        ...
                        layout: {
                            blur: [{
                                ...
                                textureAtlas: "symbols_static",
                                assetName: "pride_blur"
                            }, {
                                textureAtlas: "symbols_static",
                                assetName: "giraffee_blur"
                            }, {
                                textureAtlas: "symbols_static",
                                assetName: "hyena_blur"
                            }, {
                                textureAtlas: "symbols_static",
                                assetName: "zebra_blur"
                            }, {
                                textureAtlas: "symbols_static",
                                assetName: "a_blur"
                            }, {
                ...
                const Ui = {
                    init() {
                        function t(t) {
                            ...
                            Lt.store.set("free:win", e), Lt.store.set("free:coins", ot()(t, "freespins.coins", 0)), Lt.store.set("free:left", o), Lt.store.set("free:played", n), Lt.store.set("free:count", o + n), Lt.store.set("free:isStart", 0 === n), Lt.store.set("free:isEnd", 0 === o), Lt.store.set("free:isFree", "freespin" === i), Lt.store.set("free:winAdditional", o > s)
                        }
                        ...
                        init() {
                            function t(t) {
                                var e = ot()(t, "win", 0),
                                    i = ot()(t, "scatters", !1),
                                    s = ot()(t, "overlayWilds", []);
                                Lt.store.set("reward:win", e), Lt.store.set("reward:lines", ot()(t, "lines", [])), Lt.store.set("reward:reels", ot()(t, "reels", t.error ? Vi : [])), Lt.store.set("reward:nReels", ot()(t, "nReels", t.error ? Qi : [])), Lt.store.set("reward:fsReels", ot()(t, "fsReels", [])), Lt.store.set("reward:preReels", ot()(t, "preSpin.reels", [])), Lt.store.set("reward:scatters", i), Lt.store.set("reward:stickyWilds", s), Lt.store.set("reward:isWin", e > 0 || i || s.length > 0), Lt.store.set("reward:numberWinSymbol", ot()(t, "winSyms", 0));
                                var o = ot()(t, "feature", zi.Basic);
                                Lt.store.set("reward:feature", o)
                            }
                            Lt.store.set("reward:win", 0), Lt.store.set("reward:isWin", !1), Lt.store.set("reward:lines", []), Lt.store.set("reward:reels", []), Lt.store.set("reward:nReels", []), Lt.store.set("reward:fsReels", []), Lt.store.set("reward:preReels", []), Lt.store.set("reward:scatters", !1), Lt.store.set("reward:stickyWilds", []), Lt.store.set("reward:numberWinSymbol", 0), Lt.store.set("reward:feature", ""), Lt.server.on("response:init", t), Lt.server.on("response:spin", t), Lt.action.on("free:stop", (function() {
                ...
                const ls = JSON.parse('{"AutoPlaySettingsStopCondButtonReset":"Reset","AutoPlaySettingsStopCondCheckboxBalance":"If Balance Increases By","AutoPlaySettingsStopCondCheckboxBalanceDrop":"If Balance Decreases By","AutoPlaySettingsStopCondCheckboxFeatureBonus":"If Bonus Game Won","AutoPlaySettingsStopCondCheckboxFeatureFreeSpin":"If Free Spins Won","AutoPlaySettingsStopCondCheckboxWin":"If Win","AutoPlaySettingsStopCondCheckboxWinAny":"Any","AutoPlaySettingsStopCondCheckboxWinBig":"Big","AutoPlaySettingsStopCondCheckboxWinGiant":"Giant","AutoPlaySettingsStopCondTitle":"STOP AUTOPLAY","AutoPlaySettingsSubTitle":"Setup your best autoplay conditions","AutoPlaySettingsTitle":"AUTOPLAY","BetSettingsLines":"LINES\\n<value>%s</value>","BetSettingsTitle":"BET SETTINGS","BetSettingsWays":"WAYS\\n<value>%s</value>","ControlsDesktopAutoPlayStart":"AUTOPLAY","ControlsDesktopAutoPlayStop":"STOP AUTO","ControlsDesktopBalance":"BALANCE%s\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopBet":"BET %s\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopFreeRoundLeft":"FREE ROUND\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopFreeRoundWin":"TOTAL WIN %s\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopFreeRoundWinEmpty":"TOTAL WIN","ControlsDesktopFreeSpinsLast":"FREE SPINS LEFT\\n<delimiter> \\n</delimiter><value>LAST</value>","ControlsDesktopFreeSpinsLeft":"FREE SPINS LEFT\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopLines":"LINES\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopMaxBet":"MAX BET","ControlsDesktopTotalWin":"TOTAL WIN %s\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopWays":"WAYS\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopWin":"WIN %s\\n<delimiter> \\n</delimiter><value>%s</value>","Currency":"CURRENCY\\n<value>%s</value>","GameRulesAdvancedAutoPlayContent":"Advanced autoplay settings are available in the section with standard autoplay settings. You can set the conditions for stopping the game in automatic mode:\\n\\n<bold>if win any/big/giant</bold> - autoplay will be stopped after any/big/giant win\\n\\n<bold>if balance increased by 10%-100%</bold> - autoplay will stop when your balance increases by the selected %\\n\\n<bold>if balance decreased by 10%-100%</bold> - autoplay will be interrupted when your balance decreases by the selected %\\n\\nClick <bold>Reset</bold> to reset all autoplay settings","GameRulesAdvancedAutoPlayTitle":"Advanced Autoplay Settings","GameRulesAutoPlayContent":"Select the number of game rounds to play in automatic mode by pressing the button with the corresponding number, or press the button with the infinity sign to play in automatic mode until the autoplay is manually canceled or until the balance runs out. Your choice must be confirmed with the Start button.","GameRulesAutoPlayTitle":"Autoplay Options","GameRulesBestExperience":"Please note that you can only play one game at a time on each account. Therefore, you cannot play a game on more than one device, or multiple games on the same device simultaneously. Doing so may lead to various errors.\\n\\nFor the best gaming experience, we recommend using the latest version of the relevant software.","GameRulesGeneralRTP":"Theoretical RTP: %s %","GameRulesGeneralTitle":"General Info","GameRulesInterfaceAutoPlay":"Click to go to autoplay menu","GameRulesInterfaceBalance":"Here is your current balance","GameRulesInterfaceBetLevel":"Your current bet and a button to go to the bet size selection menu","GameRulesInterfaceContent":"All buttons of the game interface are listed below. Please note that the appearance and location of the buttons may differ slightly depending on the format in which the game is launched and what feature it is currently in.","GameRulesInterfaceMenu":"Click to access the game menu","GameRulesInterfaceQuickSpin":"Click to enable/disable quick spin","GameRulesInterfaceSound":"Turn game sound on/off and adjust sound volume","GameRulesInterfaceSpin":"Click to start the game round at the current bet. In the desktop version of the game, the button may have an alternative design","GameRulesInterfaceTitle":"Game Interface","GameRulesInterfaceWin":"Here is the win in the current game round","GameRulesSettingsContent":"To go to the settings menu, click the cogwheel icon in the game menu","GameRulesSettingsContentItemBackgroundSound":"<bold>Background music</bold> - turns on/off background music in the game","GameRulesSettingsContentItemFullscreen":"<bold>Full Screen</bold> - enables/disables full screen mode","GameRulesSettingsContentItemGameSound":"<bold>Game sound</bold> - turns on/off the sound effects of the game","GameRulesSettingsContentItemQuickSpin":"<bold>Quick Spin</bold> - turns on/off the function of the accelerated mode of rotation and stop of the reels","GameRulesSettingsTitle":"Game Settings","GameSettingsBackgroundSounds":"Background Music","GameSettingsFullscreen":"Full Screen","GameSettingsGameSounds":"Game Sounds","GameSettingsIntroScreen":"Intro Screen","GameSettingsLeftHand":"Left Hand Mode","GameSettingsQuickSpin":"Quick Spin","GameSettingsRiskFeatureCheckbox":"Risk&Buy","GameSettingsTitle":"GAME SETTINGS","IntroScreenHideButtonText":"Don\'t show next time","IntroScreenLoaderText":"LOADING","MenuDesktopButtonFullscreen":"FULLSCREEN","MenuDesktopButtonHome":"HOME","MenuDesktopButtonPaytable":"PAYTABLE","MenuDesktopButtonQuickspin":"QUICKSPIN","MenuDesktopButtonSound":"SOUND","MenuGameRules":"GAME INFORMATION","MenuMobileBetSettingsTitle":"BET SETTINGS","MenuMobileGameSettingsLeftHand":"Left Hand Mode","MenuMobileGameSettingsQuickspin":"Quick Spin","MenuMobileGameSettingsSounds":"Game Sounds","MenuMobileGameSettingsTitle":"GAME SETTINGS","MenuMobilePaytableTitle":"PAYTABLE","MenuPaytable":"PAYTABLE","MenuSettings":"SETTINGS","NetPositionTitle":"Net Position: %s","PopupActionClose":"Close","PopupActionContinue":"Continue","PopupActionEnable":"Enable","PopupActionNo":"No","PopupActionReload":"Reload","PopupActionYes":"Yes","PopupFreeRoundEndMessage":"The next spins will use your bonus amount","PopupFreeRoundEndTitle":"Free Rounds Finished","PopupFreeRoundLastMessage":"Congratulations, you have\\n last free round","PopupFreeRoundStartMessage":"Congratulations, you have\\n%s free rounds","PopupFreeRoundStartTitle":"Free Rounds Bonus","PopupFreeSpinsButton":"CLICK ANYWHERE TO CONTINUE","PopupFreeSpinsStopDescription":"<value>%s FREE SPINS</value> PLAYED","PopupFreeSpinsStopDescriptionNew":"%s Free Spins played","PopupFreeSpinsTitle":"CONGRATULATIONS","PopupFreeSpinsTitleNew":"CONGRATULATIONS! YOU WON","PopupFreeSpinsTitleRestore":"IN-GAME FEATURE RESTORED!","PopupFreeSpinsWinRestore":"<value>%s FREE SPINS</value> LEFT","PopupFreeSpinsWinRestoreLast":"<value>LAST FREE SPIN</value> LEFT","PopupFreeSpinsWinStart":"YOU WON <value>%s FREE SPINS</value>","PopupFreeSpinsWinStartNew":"%s FREE SPINS","PopupFreeSpinsWinStop":"YOU WON <value>%s</value>","PopupFreeSpinsWinStopNew":"<value>%s</value>","PopupMaxLimitMessage":"Bet exceeded max bet limit.","PopupMaxLimitTitle":"Max limit","PopupNetworkErrorMessage":"Please reload the game.","PopupNetworkErrorTitle":"Connection Lost","PopupQuickSpinMessage":"It seems you prefer to play a bit faster.\\nWould you like to enable Quick Spin?","PopupQuickSpinTitle":"Quick Spin","PopupRestoreMessage":"In-game feature restored!","PopupRiskNBuyContentBuy":"Buy in a feature for %s\\nthat will play at the bet %s","PopupRiskNBuyContentRisk":"Take the risk of winning %s\\nto get a feature at the bet %s","PopupRiskNBuyTitleBuy":"BUY IN FEATURE","PopupRiskNBuyTitleRisk":"RISK FEATURE","PopupSoundMessage":"Play with sound?","PopupSpendingBudgetMessage":"You have reached your play limit.\\nWelcome back later.","PopupSpendingBudgetTitle":"Play limit","PopupUnexpectedErrorMessage":"An unexpected situation.\\nReload the page.","PopupUnexpectedErrorTitle":"Unexpected situation","PopupZeroBalanceMessage":"Please change your BET LEVEL or top up your balance","PopupZeroBalanceTitle":"Insufficient funds","RiskNBuyBuyFor":"BUY FOR %s","RiskNBuyFreeSpinsText":"FREE SPINS","RiskNBuyOnBet":"ON BET %s","RiskNBuySubHeader":"RISK YOUR WIN\\nTO PLAY","StatusBarMobileBalance":"BALANCE %s\\n","StatusBarMobileBet":"BET %s\\n","StatusBarMobileFreeLast":"FREE SPINS LEFT\\n<value>LAST</value>","StatusBarMobileFreeLeft":"FREE SPINS LEFT\\n<value>%s</value>","StatusBarMobileFreePlayed":"FREE SPINS PLAYED\\n","StatusBarMobileFreeRoundLeft":"FREE ROUND\\n","StatusBarMobileTotalWin":"TOTAL WIN %s\\n","StatusBarMobileWin":"WIN %s\\n","TimeElapsedTitle":"Time Elapsed: %s"}'),
                    cs = JSON.parse('{"PaytableSectionBetLinesContent1":"Only the highest win per bet line is paid. All prizes are for combinations left to right, beginning from the leftmost reel. The payout values are based on the currently selected bet and change proportionally with its changes. The game is played with fixed bet lines. Malfunction voids all pays and plays.","PaytableSectionBetLinesTitle":"Bet Lines","PaytableSectionFreeContent1":"Free Spins play automatically at the bet at which they were won. All payments are made in accordance with the paytable.","PaytableSectionFreeContent2":"Every Free Spin one additional Wild symbol is added to initial reels, forming stacks of Wild symbols, starting from minimal stack of two Wilds and more on first Free Spin.","PaytableSectionFreeContent3":"Additional Free Spins can not be won in the current Free Spins series.","PaytableSectionFreeTitle":"Free Spins feature with Extra Wilds stacks","PaytableSectionMassivePayContent1":"A full screen filled with the Lions symbol, together with a Wild or without it, is paid in double size in the main game and in the fifth size in the Free spins.","PaytableSectionMassivePayDesc1":"In the main game","PaytableSectionMassivePayDesc2":"In Free Spins","PaytableSectionMassivePayPayout1":"<mul>20</mul> pays X2","PaytableSectionMassivePayPayout2":"<mul>20</mul> pays X5","PaytableSectionMassivePayTitle":"Massive pays Feature","PaytableSectionPayoutTitle":"Symbol payout values","PaytableSectionScatterContent1":"Scatter symbols can appear in the main game only on reels 1, 2 and 3 only. 3 Scatter symbols award 10 Free spins with extra Wilds stacks.","PaytableSectionScatterTitle":"Scatter symbol","PaytableSectionWildContent1":"Wild symbols substitute all symbols except for Scatter symbol.","PaytableSectionWildTitle":"Wild symbol","PopupFreeSpinsDescription":"WITH EXTRA WILDS STACKS"}');
                ...
                class gs extends(Gt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "backgroundLTextureFree", void 0), (0, n.Z)(this, "backgroundLTextureNormal", void 0), (0, n.Z)(this, "backgroundPTextureFree", void 0), (0, n.Z)(this, "backgroundPTextureNormal", void 0), (0, n.Z)(this, "backgroundTextureLandscape", void 0), (0, n.Z)(this, "backgroundTexturePortrait", void 0), (0, n.Z)(this, "featureBackground", void 0), (0, n.Z)(this, "logo", void 0), (0, n.Z)(this, "paylineLeft", void 0), (0, n.Z)(this, "paylineRight", void 0), this.backgroundLTextureNormal = this.game.loader.getAsset("bgln"), this.backgroundLTextureFree = this.game.loader.getAsset("bglf"), this.backgroundPTextureNormal = this.game.loader.getAsset("bgpn"), this.backgroundPTextureFree = this.game.loader.getAsset("bgpf"), this.backgroundTextureLandscape = this.backgroundLTextureNormal, this.backgroundTexturePortrait = this.backgroundPTextureNormal, this.background = new $.j(this.backgroundTextureLandscape), this.background.name = "background", this.featureBackground = new $.j(this.backgroundLTextureFree), this.featureBackground.name = "featureBackground", this.featureBackground.alpha = 0, this.logo = new $.j(this.game.loader.getAsset("logo")), this.logo.name = "logo", this.logo.anchor.x = .5, this.logo.x = this.game.config.get("application.width") / 2, this.paylineLeft = new $.j(this.game.loader.getAsset("payline")), this.paylineLeft.name = "paylineLeft", this.paylineLeft.anchor.set(.5), this.paylineLeft.x = 120, this.paylineLeft.y = 482, this.paylineRight = new $.j(this.game.loader.getAsset("payline")), this.paylineRight.name = "paylineRight", this.paylineRight.anchor.set(.5), this.paylineRight.x = this.background.width - 120, this.paylineRight.y = 482, this.addChild(this.background), this.addChild(this.featureBackground), this.addChild(this.paylineLeft), this.addChild(this.paylineRight), this.addChild(this.logo), this.setupEvents()
                    }
                    setupEvents() {
                        this.game.action.on("state:setup_enter", (() => {
                            this.featureBackground.texture = this.game.device.portrait && !this.game.device.desktop ? this.backgroundPTextureFree : this.backgroundLTextureFree, this.game.store.get("free:isFree", !1) && (this.featureBackground.alpha = 1, this.paylineLeft.renderable = !1, this.paylineRight.renderable = !1)
                            ...
                            this.featureBackground.texture = this.game.device.portrait && !this.game.device.desktop ? this.backgroundPTextureFree : this.backgroundLTextureFree, 0 === this.featureBackground.alpha && k.fromTo(this.featureBackground, .5, {
                                pixi: {
                                    alpha: 0
                                }
                            }, {
                ...
                class Ds extends Fs {
                    constructor(t) {
                        ...
                        })), this.betLevel = t, this.betLevelText = this.addChild(new Be("", Is(Is({}, _s.Common), {}, {
                            default: Is(Is({}, _s.Common.default), {}, {
                                align: "left"
                            })
                        ...
                        if (t > e && (t = e), this.state.update(t), this.state.apply(this.skeleton), this.skeleton) {
                                ...
                                if (l) {
                                    ...
                                    switch (l.type) {
                                        case _.AttachmentType.Region:
                                            ...
                                            c.transform.setFromMatrix(r.bone.matrix), r.currentSprite.color ? d = r.currentSprite.color : (Ls[0] = o[0] * r.color.r * u.r, Ls[1] = o[1] * r.color.g * u.g, Ls[2] = o[2] * r.color.b * u.b, r.currentSprite.tint = it.rgb2hex(Ls)), r.currentSprite.blendMode = r.blendMode;
                                            break;
                                        case _.AttachmentType.Mesh:
                                            ...
                                            l.computeWorldVerticesOld(r, r.currentMesh.vertices), r.currentMesh.color ? d = r.currentMesh.color : (Ls[0] = o[0] * r.color.r * u.r, Ls[1] = o[1] * r.color.g * u.g, Ls[2] = o[2] * r.color.b * u.b, r.currentMesh.tint = it.rgb2hex(Ls)), r.currentMesh.blendMode = r.blendMode;
                                            break;
                            ...
                            for (var k = this.skeleton.drawOrder, C = null, P = null, B = 0, E = k.length; B < E; B++) {
                                ...
                                if (P || null !== F.parent && F.parent !== this && (F.parent.removeChild(F), F.parent = this), T.currentGraphics && T.getAttachment()) P = T.clippingContainer, C = T.getAttachment(), P.children.length = 0, this.children[B] = F, C.endSlot === T.data && (C.endSlot = null);
                                    ...
                                    var O = this.tempClipContainers[B];
                                    O || ((O = this.tempClipContainers[B] = this.newContainer()).visible = !1), this.children[B] = O, F.parent = null, P.addChild(F), C.endSlot == T.data && (P.renderable = !0, P = null, C = null)
                ...
                class Ys extends Be {
                    constructor() {
                        super("", Hs(Hs({}, _s.Common), {}, {
                            default: Hs(Hs({}, _s.Common.default), {}, {
                                align: "right"
                            })
                        }))
                    }
                ...
                class Xs extends Be {
                    constructor() {
                        super("", _s.FreeSpins), this.visible = !1
                    }
                    change(t) {
                ...
                class Js extends Be {
                    constructor() {
                        super("", qs(qs({}, _s.Common), {}, {
                            default: qs(qs({}, _s.Common.default), {}, {
                                fill: Lt.config.get("colors.primary"),
                                fontFamily: "Avenir-Bold"
                            }),
                            value: qs(qs({}, _s.Common.value), {}, {
                                fontSize: 66
                            })
                        })), this.visible = !1
                    }
                ...
                class $s extends Be {
                    constructor() {
                        super("", _s.Common), this.anchor.x = .5
                    }
                    update(t) {
                        var e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
                ...
                class to extends Ts {
                    constructor() {
                        ...
                        this.background = $.j.from("data:image/png;base64,"), this.background.alpha = .4, this.background.anchor.set(0, 1), this.background.position.set(0, this.game.viewport.height), this.buttonMenu = new bs, this.buttonMenu.position.set(77, 1013), this.buttonMaxBet = new Ds(this.game.betLevel), this.buttonMaxBet.position.set(213, 1013), this.buttonAutoPlay = new ms, this.buttonAutoPlay.position.set(833, 1013), this.buttonQuickSpin = new ys, this.buttonQuickSpin.position.set(1084, 1014), this.buttonSound = new Es, this.buttonSound.position.set(1840, 1012), this.buttonSpin = function() {
                            ...
                            e.name = "buttonSpin", e.hitArea = new X.Rectangle(-60, -55, 120, 130);
                            var i = new js(Lt.loader.getAsset("effectSpinPeriodic"));
                            i.alpha = 0, i.position.set(-67, -67);
                            var s = new js(Lt.loader.getAsset("effectSpin"));
                            s.play("static", !1), e.addChild(i), e.addChild(s), e.onClick.add(n), e.onHover.add((() => {
                                s.play("hover", !1), i.alpha = 1, i.play("periodic", !1).then((() => {
                                    i.alpha = 0
                                }))
                            })), e.onLeave.add((() => {
                                s.play("static", !1)
                            }));
                            var o = Lt.keyboard.register(Lt.keyboard.KEY_CODE.Space);
                            ...
                            function a() {
                                o.disable(), e.visible = !1
                            }
                            return o.onPress.add(n), o.disable(), Lt.action.on("spin:fast", (function() {
                                s.play("inactive", !1), e.disable(), o.disable()
                            })), Lt.action.on("state:ready_enter", (function() {
                                o.enable(), Gi.isFreespin() || (e.visible = !0)
                            })), Lt.action.on("state:finish_exit", (function() {
                                Gi.isFreespin() || (s.play("static", !1), e.enable(), o.enable())
                            })), Lt.action.on("free:start", a), Lt.action.on("free:restore", a), Lt.action.on("free:stop", (() => {
                                e.visible = !0, e.disable(), o.disable()
                ...
                class lo extends(Gt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "state", void 0), (0, n.Z)(this, "textBet", void 0), (0, n.Z)(this, "textWin", void 0), (0, n.Z)(this, "textBalance", void 0), (0, n.Z)(this, "textFreeRound", void 0), (0, n.Z)(this, "textFree", void 0), (0, n.Z)(this, "textTotalWin", void 0), (0, n.Z)(this, "textBonus", void 0), (0, n.Z)(this, "delimiter", void 0), this.state = no.Normal, this.textBet = new Be("", so(so({}, ho), {}, {
                            default: so(so({}, ho.default), {}, {
                                align: "left"
                            })
                        })), this.textBet.anchor.set(0, 0), this.textWin = new Be("", ho), this.textWin.anchor.set(.5, 0), this.textBalance = new Be("", so(so({}, ho), {}, {
                            default: so(so({}, ho.default), {}, {
                                align: "right"
                            })
                        })), this.textBalance.anchor.set(1, 0), this.textFreeRound = new Be("", so(so({}, ho), {}, {
                            default: so(so({}, ho.default), {}, {
                                align: "center",
                                wordWrap: !0,
                                wordWrapWidth: 300
                            })
                        })), this.textFreeRound.anchor.set(1, 1), this.textFree = new Be("", so(so({}, ro), {}, {
                            default: so(so({}, ro.default), {}, {
                                fontSize: 30,
                                wordWrapWidth: 340
                            })
                        })), this.textFree.anchor.set(0, 1), this.textTotalWin = new Be("", so(so({}, ro), {}, {
                            default: so(so({}, ro.default), {}, {
                                fontFamily: "Avenir-Bold",
                                fill: this.game.config.get("colors.primary"),
                                fontSize: 30,
                        ...
                        })), this.textTotalWin.anchor.set(.5, 1), this.textBonus = new Be("", so(so({}, ro), {}, {
                            default: so(so({}, ro.default), {}, {
                                fontSize: 27,
                                wordWrapWidth: 340
                            })
                ...
                class uo extends Ts {
                    constructor() {
                        ...
                        })), this.buttonAccept = new vs, this.buttonQuickSpin = new ys, this.autoPlayButton = new ms, this.autoPlayButton.scale.set(1.6), this.betButton = new Fs, this.betButton.disable(), this.betButton.onClick.add((() => this.game.action.emit("clickMaxBet"))), this.game.action.on("update:win", (() => {
                ...
                class fo extends(Gt(H.W2)) {
                    constructor(t) {
                        var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [];
                        super(), (0, n.Z)(this, "_payTableBetLineBoxs", void 0), (0, n.Z)(this, "_payTableParagraph", void 0), (0, n.Z)(this, "_payTableTitle", void 0), this._payTableBetLineBoxs = new H.W2, this._payTableTitle = new yo(this.game.i18n.t("PaytableSectionBetLinesTitle").toUpperCase()), this._payTableParagraph = new bo(this.game.i18n.t("PaytableSectionBetLinesContent1")), t.forEach(((t, i) => {
                            var s = new Ao(i + 1, t, e);
                ...
                class So extends(Gt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "_sectionParagraph", void 0), (0, n.Z)(this, "_sectionTitle", void 0), this._sectionTitle = new yo(this.game.i18n.t("PaytableSectionFreeTitle").toUpperCase()), this._sectionTitle.position.set(0, 0), this._sectionParagraph = new bo(this.game.i18n.t("PaytableSectionFreeContent1") + "\n\n" + this.game.i18n.t("PaytableSectionFreeContent2") + "\n\n" + this.game.i18n.t("PaytableSectionFreeContent3")), this._sectionParagraph.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this.addChild(this._sectionTitle), this.addChild(this._sectionParagraph)
                    }
                    resize() {
                        this.game.device.desktop || (this.game.device.landscape, this._sectionParagraph.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30))
                    }
                }
                class ko extends(Gt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "_payOutText1", void 0), (0, n.Z)(this, "_payOutText2", void 0), (0, n.Z)(this, "_payTableParagraph1", void 0), (0, n.Z)(this, "_payTableParagraph2", void 0), (0, n.Z)(this, "_payTableParagraph3", void 0), (0, n.Z)(this, "_payTableSymbol1", void 0), (0, n.Z)(this, "_payTableSymbol2", void 0), (0, n.Z)(this, "_sectionTitle", void 0), this._sectionTitle = new yo(this.game.i18n.t("PaytableSectionMassivePayTitle").toUpperCase());
                        var t = this.game.loader.getAsset("symbols_static", "pride");
                        this._payTableSymbol1 = new $.j(t), this._payTableSymbol1.position.set(220, this._sectionTitle.y + this._sectionTitle.height + 30), this._payTableSymbol2 = new $.j(t), this._payTableSymbol2.position.set(220, this._payTableSymbol1.y + this._payTableSymbol1.height + 30), this._payTableParagraph1 = new bo(this.game.i18n.t("PaytableSectionMassivePayDesc1")), this._payTableParagraph1.position.set(0, this._payTableSymbol1.y + (this._payTableSymbol1.height - this._payTableParagraph1.height) / 2), this._payTableParagraph2 = new bo(this.game.i18n.t("PaytableSectionMassivePayDesc2")), this._payTableParagraph2.position.set(0, this._payTableSymbol2.y + (this._payTableSymbol2.height - this._payTableParagraph2.height) / 2), this._payTableParagraph3 = new bo(this.game.i18n.t("PaytableSectionMassivePayContent1")), this._payTableParagraph3.position.set(0, this._payTableSymbol2.y + this._payTableSymbol2.height + 30);
                        var e = {
                            default: {
                                fill: "white",
                                fontSize: 36,
                        ...
                        this._payOutText1 = new Be(this.game.i18n.t("PaytableSectionMassivePayPayout1"), e), this._payOutText1.position.set(510, this._payTableSymbol1.y + (this._payTableSymbol1.height - this._payOutText1.height) / 2), this._payOutText2 = new Be(this.game.i18n.t("PaytableSectionMassivePayPayout2"), e), this._payOutText2.position.set(510, this._payTableSymbol2.y + (this._payTableSymbol2.height - this._payOutText2.height) / 2), this.addChild(this._sectionTitle), this.addChild(this._payTableParagraph1), this.addChild(this._payTableParagraph2), this.addChild(this._payTableParagraph3), this.addChild(this._payTableSymbol1), this.addChild(this._payTableSymbol2), this.addChild(this._payOutText1), this.addChild(this._payOutText2)
                    }
                    resize() {
                        this.game.device.desktop || (this.game.device.landscape ? (this._payTableSymbol1.scale.set(1.3), this._payTableSymbol1.position.set(420, this._sectionTitle.y + this._sectionTitle.height + 30), this._payTableSymbol2.scale.set(1.3), this._payTableSymbol2.position.set(420, this._payTableSymbol1.y + this._payTableSymbol1.height + 30), this._payTableParagraph1.position.set(0, this._payTableSymbol1.y + (this._payTableSymbol1.height - this._payTableParagraph1.height) / 2), this._payTableParagraph2.position.set(0, this._payTableSymbol2.y + (this._payTableSymbol2.height - this._payTableParagraph2.height) / 2), this._payTableParagraph3.position.set(0, this._payTableSymbol2.y + this._payTableSymbol2.height + 30), this._payOutText1.scale.set(1.3), this._payOutText1.position.set(750, this._payTableSymbol1.y + (this._payTableSymbol1.height - this._payOutText1.height) / 2), this._payOutText2.scale.set(1.3), this._payOutText2.position.set(750, this._payTableSymbol2.y + (this._payTableSymbol2.height - this._payOutText2.height) / 2)) : (this._payTableSymbol1.scale.set(1.2), this._payTableSymbol1.position.set(360, this._sectionTitle.y + this._sectionTitle.height + 30), this._payTableSymbol2.scale.set(1.2), this._payTableSymbol2.position.set(360, this._payTableSymbol1.y + this._payTableSymbol1.height + 30), this._payTableParagraph1.position.set(0, this._payTableSymbol1.y + (this._payTableSymbol1.height - this._payTableParagraph1.height) / 2), this._payTableParagraph1.setTagStyle("default", {
                            wordWrapWidth: 180
                        }), this._payTableParagraph2.position.set(0, this._payTableSymbol2.y + (this._payTableSymbol2.height - this._payTableParagraph2.height) / 2), this._payTableParagraph2.setTagStyle("default", {
                            wordWrapWidth: 180
                        }), this._payTableParagraph3.position.set(0, this._payTableSymbol2.y + this._payTableSymbol2.height + 30), this._payOutText1.scale.set(1.2), this._payOutText1.position.set(680, this._payTableSymbol1.y + (this._payTableSymbol1.height - this._payOutText1.height) / 2), this._payOutText2.scale.set(1.2), this._payOutText2.position.set(680, this._payTableSymbol2.y + (this._payTableSymbol2.height - this._payOutText2.height) / 2)))
                    }
                }
                class Co extends(Gt(H.W2)) {
                    constructor(t) {
                ...
                class Po extends(Gt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "sectionTitle", void 0), (0, n.Z)(this, "symbol10", void 0), (0, n.Z)(this, "symbol9", void 0), (0, n.Z)(this, "symbolA", void 0), (0, n.Z)(this, "symbolGiraffee", void 0), (0, n.Z)(this, "symbolHyena", void 0), (0, n.Z)(this, "symbolJ", void 0), (0, n.Z)(this, "symbolK", void 0), (0, n.Z)(this, "symbolPride", void 0), (0, n.Z)(this, "symbolQ", void 0), (0, n.Z)(this, "symbolZebra", void 0), (0, n.Z)(this, "symbols", void 0), this.sectionTitle = new yo(this.game.i18n.t("PaytableSectionPayoutTitle").toUpperCase()), this.symbolPride = new Co("pride"), this.symbolPride.position.set(0, this.sectionTitle.y + this.sectionTitle.height + 30), this.symbolGiraffee = new Co("giraffee"), this.symbolGiraffee.position.set(600, this.sectionTitle.y + this.sectionTitle.height + 30), this.symbolHyena = new Co("hyena"), this.symbolHyena.position.set(0, this.symbolPride.y + this.symbolPride.height + 30), this.symbolZebra = new Co("zebra"), this.symbolZebra.position.set(600, this.symbolGiraffee.y + this.symbolGiraffee.height + 30), this.symbolA = new Co("a"), this.symbolA.position.set(0, this.symbolHyena.y + this.symbolHyena.height + 30), this.symbolK = new Co("k"), this.symbolK.position.set(600, this.symbolZebra.y + this.symbolZebra.height + 30), this.symbolQ = new Co("q"), this.symbolQ.position.set(0, this.symbolA.y + this.symbolA.height + 30), this.symbolJ = new Co("j"), this.symbolJ.position.set(600, this.symbolK.y + this.symbolK.height + 30), this.symbol10 = new Co("10"), this.symbol10.position.set(0, this.symbolQ.y + this.symbolQ.height + 30), this.symbol9 = new Co("9"), this.symbol9.position.set(600, this.symbolJ.y + this.symbolJ.height + 30), this.symbols = [this.symbolPride, this.symbolGiraffee, this.symbolHyena, this.symbolZebra, this.symbolA, this.symbolK, this.symbolQ, this.symbolJ, this.symbol10, this.symbol9], this.addChild(this.sectionTitle, ...this.symbols)
                    }
                    updateBet(t) {
                        this.symbols.forEach((e => e.updateBet(t)))
                    }
                    resize() {
                        this.game.device.desktop || (this.game.device.landscape ? (this.symbolPride.position.set(0, this.sectionTitle.y + this.sectionTitle.height + 30), this.symbolGiraffee.position.set(820, this.sectionTitle.y + this.sectionTitle.height + 30), this.symbolHyena.position.set(0, this.symbolPride.y + this.symbolPride.height + 30), this.symbolZebra.position.set(820, this.symbolGiraffee.y + this.symbolGiraffee.height + 30), this.symbolA.position.set(0, this.symbolHyena.y + this.symbolHyena.height + 30), this.symbolK.position.set(820, this.symbolZebra.y + this.symbolZebra.height + 30), this.symbolQ.position.set(0, this.symbolA.y + this.symbolA.height + 30), this.symbolJ.position.set(820, this.symbolK.y + this.symbolK.height + 30), this.symbol10.position.set(0, this.symbolQ.y + this.symbolQ.height + 30), this.symbol9.position.set(820, this.symbolJ.y + this.symbolJ.height + 30)) : (this.symbolPride.position.set(0, this.sectionTitle.y + this.sectionTitle.height + 30), this.symbolGiraffee.position.set(0, this.symbolPride.y + this.symbolPride.height + 30), this.symbolHyena.position.set(0, this.symbolGiraffee.y + this.symbolGiraffee.height + 30), this.symbolZebra.position.set(0, this.symbolHyena.y + this.symbolHyena.height + 30), this.symbolA.position.set(0, this.symbolZebra.y + this.symbolZebra.height + 30), this.symbolK.position.set(0, this.symbolA.y + this.symbolA.height + 30), this.symbolQ.position.set(0, this.symbolK.y + this.symbolK.height + 30), this.symbolJ.position.set(0, this.symbolQ.y + this.symbolQ.height + 30), this.symbol10.position.set(0, this.symbolJ.y + this.symbolJ.height + 30), this.symbol9.position.set(0, this.symbol10.y + this.symbol10.height + 30)))
                    }
                }
                class Bo extends(Gt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "_sectionParagraph", void 0), (0, n.Z)(this, "_sectionTitle", void 0), (0, n.Z)(this, "_symbolScatter", void 0), this._sectionTitle = new yo(this.game.i18n.t("PaytableSectionScatterTitle").toUpperCase()), this._sectionTitle.position.set(0, 0), this._symbolScatter = new Co("scatter"), this._symbolScatter.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this._sectionParagraph = new bo(this.game.i18n.t("PaytableSectionScatterContent1")), this._sectionParagraph.position.set(0, this._symbolScatter.y + this._symbolScatter.height + 30), this.addChild(this._sectionTitle), this.addChild(this._sectionParagraph), this.addChild(this._symbolScatter)
                    }
                    updateBet(t) {
                ...
                class Eo extends(Gt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "_sectionParagraph1", void 0), (0, n.Z)(this, "_sectionTitle", void 0), (0, n.Z)(this, "_symbol1", void 0), this._sectionTitle = new yo(this.game.i18n.t("PaytableSectionWildTitle").toUpperCase()), this._sectionTitle.position.set(0, 0), this._symbol1 = new Co("wild"), this._symbol1.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this._symbol1.withoutPayout(), this._sectionParagraph1 = new bo(this.game.i18n.t("PaytableSectionWildContent1")), this._sectionParagraph1.position.set(this._symbol1.x + this._symbol1.width, this._sectionTitle.y + this._sectionTitle.height + 30), this._sectionParagraph1.setTagStyle("default", {
                            wordWrapWidth: 690
                ...
                class To extends go {
                    constructor(t) {
                        super(), (0, n.Z)(this, "_paytableSectionBetLines", void 0), (0, n.Z)(this, "_paytableSectionFree", void 0), (0, n.Z)(this, "_paytableSectionMasivePay", void 0), (0, n.Z)(this, "_paytableSectionPayout", void 0), (0, n.Z)(this, "_paytableSectionScatter", void 0), (0, n.Z)(this, "_paytableSectionWild", void 0), (0, n.Z)(this, "payTableDelimiter", void 0), this.payTableDelimiter = new xo, this._paytableSectionPayout = new Po, this._paytableSectionWild = new Eo, this._paytableSectionScatter = new Bo, this._paytableSectionFree = new So, this._paytableSectionBetLines = new wo(t), this._paytableSectionMasivePay = new ko, this.content.addChild(this._paytableSectionPayout, this._paytableSectionWild, this._paytableSectionScatter, this._paytableSectionMasivePay, this._paytableSectionFree, this.payTableDelimiter, this._paytableSectionBetLines)
                    }
                    updateBet(t) {
                ...
                const Io = class extends Wo {
                    ...
                    allPayment(t) {
                        ...
                        return (0, o.Z)((function*() {
                            ...
                            for (var i = 0, s = t.length; i < s; i++) {
                                var o = t[i];
                                e._wins.push(o), e._runSymbolAnimation(o, !1), e._showFrame(o)
                            }
                    ...
                    scatterPayment(t) {
                        var e = this;
                        return (0, o.Z)((function*() {
                            Lt.action.emit("sound:scatterWin"), e.slot.reels.forEach((t => t.overlay())), e.slot.lines.hide(), Lt.action.emit("textLineWin:hide"), e._runSymbolAnimation(t, !0, "free"), yield Lt.delay(Ni.get("reward_scatter"))
                        }))()
                    }
                    complete() {
                    ...
                    _showFrame(t) {
                        ...
                        e.forEach(((t, e) => {
                            -1 !== t && (this._findSymbol(e, t).getData().hasFrame && this.slot.frames.show([e, t], "win"))
                        }))
                    }
                    _findSymbol(t, e) {
                        ...
                        if (! function(t, i) {
                            ...
                            if (e.push({
                                ...
                                var n = new js(Lt.loader.getAsset(o.assetName)),
                                    a = n.width / 2,
                                    h = n.height / 2;
                                if (n.name = o.assetName, n.pivot.set(a, h), n.position.set(i + a, s + h), n.alpha = 1, o.scale > 1 && k.to(n, .5, {
                                        pixi: {
                                            scale: o.scale
                                        }
                                    }), t.addChild(n), "string" == typeof o.effectName) n.play(o.effectName, !1);
                                else {
                                    var r = o.effectName[o.type] || o.effectName.normal;
                                    n.play(r, !1)
                                }
                            } else {
                                var l = new $.j(o.texture);
                ...
                function Vo(t, e, i) {
                    ...
                    var h = new $.j(Lt.loader.getAsset(a.textureAtlas, a.assetName));

                    function r() {
                        a.animation && (Lt.action.emit("symbol:stopAnimation", a.animation), s && (h.alpha = Uo))
                    }

                    function l(t) {
                        o = t, a = Lt.config.get("slot.layout.".concat(n, "[").concat(t, "]"), null), h.texture = Lt.loader.getAsset(a.textureAtlas, a.assetName)
                    }
                    return h.position.set(t, e), Object.assign(h, {
                        ...
                        playAnimation(t) {
                            s = !0, h.alpha = zo, Lt.action.emit("symbol:playAnimation", h.x, h.y, No(No({}, a.animation), {}, {
                                type: t,
                                texture: h.texture
                            }))
                        },
                ...
                class Qo extends H.W2 {
                    constructor(t, e) {
                        super(), (0, n.Z)(this, "_endTween", void 0), (0, n.Z)(this, "_endY", void 0), (0, n.Z)(this, "_nReel", void 0), (0, n.Z)(this, "_numberSpinToComplete", void 0), (0, n.Z)(this, "_reel", void 0), (0, n.Z)(this, "_reelIndex", void 0), (0, n.Z)(this, "_spinTween", void 0), (0, n.Z)(this, "_startTween", void 0), (0, n.Z)(this, "_startY", void 0), (0, n.Z)(this, "_stopTimeout", void 0), (0, n.Z)(this, "_stopTimeoutDuration", void 0), (0, n.Z)(this, "isStop", void 0), (0, n.Z)(this, "symbolsPositions", void 0), (0, n.Z)(this, "visibleSymbols", void 0), this.interactiveChildren = !1, this.visibleSymbols = [], this.symbolsPositions = e, this._startY = 0, this._endY = 0, this._reel = [], this._nReel = [], this._reelIndex = t, this._numberSpinToComplete = 0, this.isStop = !1, this._stopTimeout = null, this._stopTimeoutDuration = 0, this._startTween = new k(this, Lt.config.get("wheel.durationSpin"), {
                            ...
                            repeat: 1,
                            repeatDelay: 0,
                            onComplete: () => this._spinTween.restart()
                    ...
                    start() {
                        ...
                        this._endTween.duration(t), this._stopTimeoutDuration = Lt.quickSpin.enabled ? Lt.config.get("wheel.durationQuickStop") : Lt.config.get("wheel.durationStop"), this.children[0].alpha = 1, this.children[this.children.length - 1].alpha = 1, this.children.forEach((t => t.blur())), this._startTween.restart()
                    }
                    stop() {
                        if (!this.isStop) {
                            ...
                            this._reel = e[this._reelIndex].concat(), Lt.store.get("spin:isFast", !1) ? (Lt.action.emit("sound:spinFast"), clearTimeout(this._stopTimeout), this.children.forEach((t => t.unblur())), this.isStop = !0) : this._stopTimeout = setTimeout((() => {
                    ...
                    _setup() {
                        ...
                        for (var i = 0, s = this._nReel.length; i < s; i++) {
                            var [o, n] = this.symbolsPositions[i], a = Vo(o, n, 0 === i || i === s - 1 ? this._nReel[i] : this._reel[i - 1]);
                ...
                class Ho extends Ro {
                    constructor() {
                        super(), (0, n.Z)(this, "animation", void 0), (0, n.Z)(this, "frames", void 0), (0, n.Z)(this, "lines", void 0), (0, n.Z)(this, "reels", void 0), (0, n.Z)(this, "reelsContainer", void 0), (0, n.Z)(this, "scatterWaiting", void 0), (0, n.Z)(this, "slotData", void 0), (0, n.Z)(this, "stopReelCounter", void 0), (0, n.Z)(this, "symbolsPositions", void 0), (0, n.Z)(this, "textFreeLeft", void 0), (0, n.Z)(this, "textLineWin", void 0), (0, n.Z)(this, "textTotalWin", void 0), this.pivot.set(665, 0), this.reels = [], this.symbolsPositions = this.game.config.get("slot.symbolsPositions", []), this.animation = new Io(this), this.stopReelCounter = 0, this.init(), this.setupEvents()
                    }
                    ...
                    createMask() {
                        if (this.game.device.desktop && it.isWebGLSupported()) {
                            var t = this.createGradientMask(this.game.config.get("slot.width"), this.game.config.get("slot.height") + 120),
                                e = new $.j(t);
                            return e.position.y = -55, e
                        }
                        var i = new u.TC;
                    ...
                    init() {
                        ...
                        this.slotData = {
                        ...
                        }, this.lines = new Zo(this.slotData.lines.map((t => ({
                            color: 11206515,
                            width: 4,
                            padding: 133,
                            points: t.map(((t, e) => {
                            ...
                            n.push([]), t.forEach((t => {
                                var i = new js(Lt.loader.getAsset("effectScatter"));
                        ...
                        }), this.textFreeLeft = new _o, this.textFreeLeft.container.position.set(660, 660), this.textTotalWin = new Mo(.7), this.textTotalWin.position.set(630, 660), this.textLineWin = new Lo, this.addChild(this.reelsContainer), this.addChild(this.frames.container), this.addChild(this.lines), this.addChild(Do()), this.addChild(this.textLineWin.container), this.addChild(this.scatterWaiting.getContainer()), this.addChild(this.textTotalWin), this.addChild(this.textFreeLeft.container)
                    }
                    setupEvents() {
                    ...
                    resize() {
                        this.game.device.desktop || this.game.device.landscape ? (this.scale.set(1, 1), this.position.set(960, 70)) : (this.scale.set(.759375), this.position.set(540, 191.25))
                    }
                }
                class Yo extends(Gt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "timeline", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "value", void 0), (0, n.Z)(this, "light", void 0), (0, n.Z)(this, "coins", void 0), (0, n.Z)(this, "onPress", void 0), this.visible = !1, this.interactive = !0, this.onPress = new(x()), this.game.interaction.click(this, (() => this.onPress.dispatch())), this.timeline = new C, this.content = new H.W2, this.overlay = new u.TC, this.overlay.beginFill(0, .75), this.overlay.drawRect(0, 0, 1920, 1080), this.overlay.endFill(), this.title = new $.j, this.title.anchor.set(.5), this.value = new v.Xz("", {
                            fontName: "WinFont"
                        }), this.value.anchor = .5, this.light = new js(this.game.loader.getAsset("effectBigWinLight")), this.light.pivot.set(0, this.game.config.get("application.height")), this.light.alpha = 0, this.coins = new js(this.game.loader.getAsset("effectBigWinCoins")), this.coins.pivot.set(0, this.game.config.get("application.height")), this.coins.alpha = 0, this.content.addChild(this.title), this.content.addChild(this.value), this.addChild(this.overlay), this.addChild(this.light), this.addChild(this.coins), this.addChild(this.content)
                    }
                    show(t, e) {
                        var i = 0;
                        t === fe ? (i = 9, this.game.action.emit("sound:bigWin")) : t === we && (i = 18, this.game.action.emit("sound:giantWin")), this.title.texture = this.game.loader.getAsset("textBigWin");
                        var s = !1,
                            o = e > 1e6 ? .68 : .8;
                        return this.value.scale.set(o), new Promise((n => {
                            this.alpha = 0, this.value.alpha = 0, this.timeline.eventCallback("onComplete", (() => {
                                this.hide(), n()
                            }));
                            var a = {
                                coins: 0
                            };
                            this.timeline.to(this, .35, {
                                pixi: {
                                    alpha: 1
                                }
                            }, 0).to(this.value, .5, {
                                ...
                                onUpdate: () => {
                                    !s && t === we && a.coins > e / 2 && (this.title.texture = this.game.loader.getAsset("textGiantWin"), s = !0, this.coins.play("coins", !0), this.coins.alpha = 1, k.to(this.value, i / 2, {
                                        pixi: {
                                            scale: o + .1
                                        }
                            ...
                            }, .35), this.timeline.addLabel("break", "+=0.75"), this.timeline.to(this, .2, {
                                pixi: {
                                    alpha: 0
                                }
                ...
                new class extends class extends class extends class {
                    constructor(t) {
                        ...
                        })), Lt = this, et.vB.shared.autoStart = !1, et.vB.shared.stop(), this.config = new ht(_t), this.logger = new Ct, this.rootNode = this.createRootNode(), this.renderer = new Pt, this.i18n = new bt(e), this.helpers = new vt(this.config), this.keyboard = new wt, this.device = new At(this.renderer), this.viewport = new Zt, this.leftHand = new ut, this.fullscreen = this.device.ios || this.device.iPadPro ? new ct : new dt(this.device), this.visibility = new zt, this.preferences = new Ut, this.sound = new Z(this.device, this.visibility, this.preferences), this.state = new Ot, this.store = new ht, this.action = new gt, this.loader = new kt(this.device), this.error = new mt, this.interaction = new yt(this.device), this.externalApi = new Mt(this), this.popupManager = new Dt(this.rootNode), this.create(), this.initAnalytics()
                    }
                    initAnalytics() {
                        return (0, o.Z)((function*() {
                            try {
                    ...
                    initPopups() {
                        this.popupManager.add([new Ti, new Pi, new Bi, new Si, new Ri, new Ci, new Fi, new Oi, new Ei, new ki, new Zi])
                    }
                    loadAssets(t) {
                    ...
                    initViews() {
                        var t, e, i = this;
                        super.initViews(), this.background = this.rootNode.addChild(new gs), this.slot = this.rootNode.addChild(new Ho), this.controls = this.device.desktop ? new to : new uo, this.fastStopLayout = new Te, this.paytable = new To(null !== (t = null === (e = this.server) || void 0 === e ? void 0 : e.response.lines) && void 0 !== t ? t : []), this.gameSettings = new Ue, this.config.get("quickSpin.available", !0) && this.gameSettings.addItem(this.createQuickSpinCheckbox()), this.gameSettings.addItem(this.createFullscreenCheckbox()), this.gameSettings.addItem(this.createLeftHandCheckbox()), this.gameSettings.addItem(this.createGameSoundsCheckbox()), this.gameSettings.addItem(this.createBackgroundSoundsCheckbox()), this.bigWinAnimation = new Yo, this.betSettings = this.rootNode.addChild(new Ee), this.betSettings.setBets(this.betLevel.bets, this.betLevel.betCoins), this.betSettings.setPayLines(40), this.betSettings.setBet(this.betLevel.bet), this.autoPlaySettings = this.rootNode.addChild(new ce), this.autoPlaySettings.setAutoPlayCounts(this.autoPlay.counts), this.autoPlaySettings.stopSection.addItem(new Se), this.autoPlaySettings.stopSection.addItem(new be), this.autoPlaySettings.stopSection.addItem(new me), this.autoPlaySettings.stopSection.addItem(new ve), this.gameRules = new Ne, this.menu = new Ve, this.menu.addItem(this.loader.getAsset("iconPaytable"), this.paytable), this.menu.addItem(this.loader.getAsset("iconSettings"), this.gameSettings), this.menu.addItem(this.loader.getAsset("iconRules"), this.gameRules), this.rootNode.addChild(this.fastStopLayout), this.rootNode.addChild(this.menu), this.rootNode.addChild(this.controls), this.rootNode.addChild(this.bigWinAnimation), this.freeOverlay = this.rootNode.addChild(new po), this.paytable.updateBet(this.betLevel), this.controls.updateBet(this.betLevel), this.betSettings.on("open", (() => {
    ...
    n.m = s, t = [], n.O = (e, i, s, o) => {
    ...
    }), t), n.o = (t, e) => Object.prototype.hasOwnProperty.call(t, e), e = {}, i = "lions_pride:", n.l = (t, s, o, a) => {
        if (e[t]) e[t].push(s);
        else {
            var h, r;
            if (void 0 !== o)
        ...
        var e = (e, i) => {
            ...
            i = self.webpackChunklions_pride = self.webpackChunklions_pride || [];
        i.forEach(e.bind(null, 0)), i.push = e.bind(null, i.push.bind(i))
    })();
    var a = n.O(void 0, [216], (() => n(1621)));
    a = n.O(a)
})();