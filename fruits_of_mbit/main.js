/*! @mascot-banner branch: task-486-fruits-of-mbit - commit: 024cab97f9191927ae7f369c0832ebf4f585ba8d */
(() => {
    var t, e, i, s = {
            8522: (t, e, i) => {
                "use strict";
                ...
                var V = i(512),
                    ...
                    et = i(798),
                    it = i(5277);
                u.TC.nextRoundedRectBehavior = !0, m.xv.nextLineHeightBehavior = !0, c.R.add(p.bx, g.B9, d.Bv, a.c, h.Q, r.T, l.O, v.vl, A.o, z, w, F), window.PIXI = s;
                var st = i(3233),
                    ot = i.n(st);
                ...
                class Ce extends m.xv {
                    ...
                    set styles(t) {
                        for (var e in this.textStyles = {}, this.textStyles.default = this.assign({}, Ce.DEFAULT_TAG_STYLE), t) "default" === e ? this.assign(this.textStyles.default, t[e]) : this.textStyles[e] = this.assign({}, t[e]);
                    ...
                    deleteTagStyle(t) {
                        "default" === t ? this.textStyles.default = this.assign({}, Ce.DEFAULT_TAG_STYLE) : delete this.textStyles[t], this.withPrivateMembers()._style = new m.pn(this.textStyles.default), this.withPrivateMembers().dirty = !0
                    }
                    getTagRegex(t, e) {
                        ...
                        var o = s === ke ? "\\".concat(Be.bbcode[0]).concat(i, "(?:\\=(?:[A-Za-z0-9_\\-\\#]+|'(?:[^']+|\\\\')*'))*\\s*\\").concat(Be.bbcode[1], "|\\").concat(Be.bbcode[0], "\\/").concat(i, "\\s*\\").concat(Be.bbcode[1]) : "\\".concat(Be.xml[0]).concat(i, "(?:\\s+[A-Za-z0-9_\\-]+=(?:\"(?:[^\"]+|\\\\\")*\"|'(?:[^']+|\\\\')*'))*\\s*\\").concat(Be.xml[1], "|\\").concat(Be.xml[0], "\\/").concat(i, "\\s*\\").concat(Be.xml[1]);
                    ...
                    _getTextDataPerLine(t) {
                        ...
                        return i[i.length - 1].map((t => {
                            t.text.includes(Be[b][0]) && (t.text = t.text.match(b === ke ? /^(.*)\[/ : /^(.*)\</)[1])
                        })), i
                    }
                    getFontString(t) {
                    ...
                    updateText() {
                        if (this.withPrivateMembers().dirty) {
                                ...
                                for (var k = 0; k < x.length; k++) {
                                    ...
                                    if (0 === B.letterSpacing) y.push({
                                        ...
                                        for (var Z = 0; Z < C.length; Z++) {
                                            (Z > 0 || k > 0) && (S += B.letterSpacing / 2);
                                            var F = this.context.measureText(C.charAt(Z)).width;
                                            y.push({
                                                text: C.charAt(Z),
                                                style: B,
                                                x: S,
                                                ...
                                                descent: P.descent,
                                                tag: O
                                            }), S += F, (Z < C.length - 1 || k < x.length - 1) && (S += B.letterSpacing / 2)
                                        }
                                    }
                                }
                                w += a[f] - n[f]
                            ...
                            this.context.save(), y.forEach((t => {
                                ...
                                }), (void 0 === e.debug ? Ce.debugOptions.spans.enabled : e.debug) && (this.context.lineWidth = 1, Ce.debugOptions.spans.bounding && (this.context.fillStyle = Ce.debugOptions.spans.bounding, this.context.strokeStyle = Ce.debugOptions.spans.bounding, this.context.beginPath(), this.context.rect(s, o - a, n, a + h), this.context.fill(), this.context.stroke(), this.context.stroke()), Ce.debugOptions.spans.baseline && (this.context.strokeStyle = Ce.debugOptions.spans.baseline, this.context.beginPath(), this.context.moveTo(s, o), this.context.lineTo(s + n, o), this.context.closePath(), this.context.stroke()), Ce.debugOptions.spans.top && (this.context.strokeStyle = Ce.debugOptions.spans.top, this.context.beginPath(), this.context.moveTo(s, o - a), this.context.lineTo(s + n, o - a), this.context.closePath(), this.context.stroke()), Ce.debugOptions.spans.bottom && (this.context.strokeStyle = Ce.debugOptions.spans.bottom, this.context.beginPath(), this.context.moveTo(s, o + h), this.context.lineTo(s + n, o + h), this.context.closePath(), this.context.stroke()), Ce.debugOptions.spans.text && (this.context.fillStyle = "#ffffff", this.context.strokeStyle = "#000000", this.context.lineWidth = 2, this.context.font = "8px monospace", this.context.strokeText(r.name, s, o - a + 8), this.context.fillText(r.name, s, o - a + 8), this.context.strokeText("".concat(n.toFixed(2), "x").concat((a + h).toFixed(2)), s, o - a + 16), this.context.fillText("".concat(n.toFixed(2), "x").concat((a + h).toFixed(2)), s, o - a + 16)))
                            })), Ce.debugOptions.objects.enabled && (Ce.debugOptions.objects.bounding && (this.context.fillStyle = Ce.debugOptions.objects.bounding, this.context.beginPath(), this.context.rect(0, 0, v, b), this.context.fill()), Ce.debugOptions.objects.text && (this.context.fillStyle = "#ffffff", this.context.strokeStyle = "#000000", this.context.lineWidth = 2, this.context.font = "8px monospace", this.context.strokeText("".concat(v.toFixed(2), "x").concat(b.toFixed(2)), 0, 8, v), this.context.fillText("".concat(v.toFixed(2), "x").concat(b.toFixed(2)), 0, 8, v))), this.updateTexture()
                        }
                    }
                    wordWrap(t) {
                        var e = "",
                ...
                class Pe extends(zt(qt)) {
                    constructor() {
                        ...
                        })), this.paylines.anchor.set(.5, 0), this.currency = new Ce(this.game.i18n.t("Currency", this.game.i18n.currency()), {
                            default: {
                                align: "center",
                                fill: 16777215,
                                fontSize: 24,
                ...
                class ze extends(zt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "Menu"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "contentItems", void 0), (0, n.Z)(this, "bottom", void 0), (0, n.Z)(this, "items", void 0), (0, n.Z)(this, "homeButton", void 0), (0, n.Z)(this, "closeButton", void 0), (0, n.Z)(this, "bottomBackgroundTexture", void 0), (0, n.Z)(this, "bottomBackgroundMobileTexture", void 0), (0, n.Z)(this, "spaceKey", void 0), (0, n.Z)(this, "currentIndex", 0), (0, n.Z)(this, "onClickHome", void 0), (0, n.Z)(this, "onClickClose", void 0), this.visible = !1, this.interactive = !0, this.bottomBackgroundTexture = d.xE.from(Ht), this.bottomBackgroundMobileTexture = d.xE.from(Qt), this.overlay = this.addChild(new Jt), this.contentItems = this.addChild(new Q.W2), this.bottom = this.addChild(new $.j(this.bottomBackgroundMobileTexture)), this.items = this.addChild(new Q.W2), this.homeButton = this.addChild(new Ge), this.closeButton = this.addChild(new Kt), this.closeButton.onClick.add((() => this.close())), this.spaceKey = this.game.keyboard.register(this.game.keyboard.KEY_CODE.Escape), this.spaceKey.onPress.add(this.close, this), this.spaceKey.disable()
                    }
                    get opened() {
                        return this.visible
                    }
                        ...
                        if (t > e && (t = e), this.state.update(t), this.state.apply(this.skeleton), this.skeleton) {
                            ...
                            for (var k = this.skeleton.drawOrder, B = null, C = null, P = 0, E = k.length; P < E; P++) {
                                ...
                                if (C || null !== O.parent && O.parent !== this && (O.parent.removeChild(O), O.parent = this), T.currentGraphics && T.getAttachment()) C = T.clippingContainer, B = T.getAttachment(), C.children.length = 0, this.children[P] = O, B.endSlot === T.data && (B.endSlot = null);
                                    ...
                                    R || ((R = this.tempClipContainers[P] = this.newContainer()).visible = !1), this.children[P] = R, O.parent = null, C.addChild(O), B.endSlot == T.data && (C.renderable = !0, C = null, B = null)
                ...
                class ps extends(zt(Q.W2)) {
                    ...
                    resize() {
                        if (this.game.device.portrait && !this.game.device.desktop) {
                            ...
                            this.background.width = t + this.game.viewport.width, this.background.height = t + this.game.viewport.height, this.background.position.set(-this.game.viewport.paddingX, 0), this.logo.scale.set(1.5), this.logo.position.set(this.game.viewport.width / 2, 190), this.animation.renderable = !1
                        } else this.scale.set(1), this.background.texture = this.backgroundTextureLandscape, this.background.width = this.game.viewport.width, this.background.height = this.game.viewport.height, this.background.position.set(0, 0), this.logo.scale.set(1), this.logo.position.set(150, 100), this.animation.renderable = !0
                    }
                }
                ...
                class Ds extends Ts {
                    constructor(t) {
                        ...
                        })), this.betLevel = t, this.betLevelText = this.addChild(new Ce("", Ws(Ws({}, Ms.Common), {}, {
                ...
                class Qs extends Es {
                    constructor() {
                        ...
                        this.background = $.j.from("data:image/png;base64,"), this.background.alpha = .4, this.background.anchor.set(0, 1), this.background.position.set(0, this.game.viewport.height), this.buttonMenu = new vs, this.buttonMenu.position.set(77, 1013), this.buttonMaxBet = new Ds(this.game.betLevel), this.buttonMaxBet.position.set(213, 1013), this.buttonAutoPlay = new As, this.buttonAutoPlay.position.set(833, 1013), this.buttonQuickSpin = new bs, this.buttonQuickSpin.position.set(1084, 1014), this.buttonSound = new Ps, this.buttonSound.position.set(1840, 1012), this.buttonSpin = function() {
                            ...
                            function h() {
                                Hi.isBasic() && i.enable(), Ut.autoPlay.enabled || s.play("active"), e.visible = !0
                            }
                ...
                class eo extends(zt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "state", void 0), (0, n.Z)(this, "textBet", void 0), (0, n.Z)(this, "textWin", void 0), (0, n.Z)(this, "textBalance", void 0), (0, n.Z)(this, "textFreeRound", void 0), (0, n.Z)(this, "textFree", void 0), (0, n.Z)(this, "textTotalWin", void 0), (0, n.Z)(this, "textBonus", void 0), (0, n.Z)(this, "delimiter", void 0), this.state = Js.Normal, this.textBet = new Ce("", Ks(Ks({}, $s), {}, {
                            default: Ks(Ks({}, $s.default), {}, {
                                align: "left"
                            })
                        })), this.textBet.anchor.set(0, 0), this.textWin = new Ce("", $s), this.textWin.anchor.set(.5, 0), this.textBalance = new Ce("", Ks(Ks({}, $s), {}, {
                            default: Ks(Ks({}, $s.default), {}, {
                                align: "right"
                            })
                        })), this.textBalance.anchor.set(1, 0), this.textFreeRound = new Ce("", Ks(Ks({}, $s), {}, {
                            default: Ks(Ks({}, $s.default), {}, {
                                align: "center",
                                wordWrap: !0,
                                wordWrapWidth: 300
                            })
                        })), this.textFreeRound.anchor.set(1, 1), this.textFree = new Ce("", Ks(Ks({}, to), {}, {
                            default: Ks(Ks({}, to.default), {}, {
                                fontSize: 30,
                                wordWrapWidth: 340
                            })
                        })), this.textFree.anchor.set(0, 1), this.textTotalWin = new Ce("", Ks(Ks({}, to), {}, {
                            default: Ks(Ks({}, to.default), {}, {
                                fontFamily: "Avenir-Bold",
                                fill: this.game.config.get("colors.primary"),
                                fontSize: 30,
                        ...
                        })), this.textTotalWin.anchor.set(.5, 1), this.textBonus = new Ce("", Ks(Ks({}, to), {}, {
                            default: Ks(Ks({}, to.default), {}, {
                                fontSize: 27,
                                wordWrapWidth: 340
                            })
                ...
                class Ao extends(zt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "sectionTitle", void 0), (0, n.Z)(this, "symbolBlueGrape", void 0), (0, n.Z)(this, "symbolRed", void 0), (0, n.Z)(this, "symbolStar", void 0), (0, n.Z)(this, "symbolCross", void 0), (0, n.Z)(this, "symbolBlueGrapes", void 0), (0, n.Z)(this, "symbolGrape", void 0), (0, n.Z)(this, "symbolPharaoh", void 0), (0, n.Z)(this, "symbolSeven", void 0), (0, n.Z)(this, "symbolB", void 0), (0, n.Z)(this, "symbolStrawberries", void 0), (0, n.Z)(this, "symbols", void 0), this.sectionTitle = new lo(this.game.i18n.t("PaytableSectionPayoutTitle").toUpperCase()), this.symbolPharaoh = new go("1_pharaoh"), this.symbolPharaoh.position.set(0, this.sectionTitle.y + this.sectionTitle.height + 30), this.symbolCross = new go("2_cross"), this.symbolCross.position.set(600, this.sectionTitle.y + this.sectionTitle.height + 30), this.symbolB = new go("3_b"), this.symbolB.position.set(0, this.symbolPharaoh.y + this.symbolPharaoh.height + 30), this.symbolSeven = new go("4_seven"), this.symbolSeven.position.set(600, this.symbolCross.y + this.symbolCross.height + 30), this.symbolStar = new go("5_star"), this.symbolStar.position.set(0, this.symbolB.y + this.symbolB.height + 30), this.symbolGrape = new go("6_grapePink"), this.symbolGrape.position.set(600, this.symbolSeven.y + this.symbolSeven.height + 30), this.symbolBlueGrapes = new go("7_apples"), this.symbolBlueGrapes.position.set(0, this.symbolStar.y + this.symbolStar.height + 30), this.symbolStrawberries = new go("8_strawberries"), this.symbolStrawberries.position.set(600, this.symbolGrape.y + this.symbolGrape.height + 30), this.symbolBlueGrape = new go("9_blueGrape"), this.symbolBlueGrape.position.set(0, this.symbolBlueGrapes.y + this.symbolBlueGrapes.height + 30), this.symbolRed = new go("10_appleRed"), this.symbolRed.position.set(600, this.symbolStrawberries.y + this.symbolStrawberries.height + 30), this.symbols = [this.symbolPharaoh, this.symbolCross, this.symbolB, this.symbolSeven, this.symbolStar, this.symbolGrape, this.symbolBlueGrapes, this.symbolStrawberries, this.symbolBlueGrape, this.symbolRed], this.addChild(this.sectionTitle, ...this.symbols)
                    }
                    updateBet(t) {
                        this.symbols.forEach((e => e.updateBet(t)))
                    }
                    resize() {
                        this.game.device.desktop || (this.game.device.landscape ? (this.symbolPharaoh.position.set(0, this.sectionTitle.y + this.sectionTitle.height + 30), this.symbolCross.position.set(820, this.sectionTitle.y + this.sectionTitle.height + 30), this.symbolB.position.set(0, this.symbolPharaoh.y + this.symbolPharaoh.height + 30), this.symbolSeven.position.set(820, this.symbolCross.y + this.symbolCross.height + 30), this.symbolStar.position.set(0, this.symbolB.y + this.symbolB.height + 30), this.symbolGrape.position.set(820, this.symbolSeven.y + this.symbolSeven.height + 30), this.symbolBlueGrapes.position.set(0, this.symbolStar.y + this.symbolStar.height + 30), this.symbolStrawberries.position.set(820, this.symbolGrape.y + this.symbolGrape.height + 30), this.symbolBlueGrape.position.set(0, this.symbolBlueGrapes.y + this.symbolBlueGrapes.height + 30), this.symbolRed.position.set(820, this.symbolStrawberries.y + this.symbolStrawberries.height + 30)) : (this.symbolPharaoh.position.set(0, this.sectionTitle.y + this.sectionTitle.height + 30), this.symbolCross.position.set(0, this.symbolPharaoh.y + this.symbolPharaoh.height + 30), this.symbolB.position.set(0, this.symbolCross.y + this.symbolCross.height + 30), this.symbolSeven.position.set(0, this.symbolB.y + this.symbolB.height + 30), this.symbolStar.position.set(0, this.symbolSeven.y + this.symbolSeven.height + 30), this.symbolGrape.position.set(0, this.symbolStar.y + this.symbolStar.height + 30), this.symbolBlueGrapes.position.set(0, this.symbolGrape.y + this.symbolGrape.height + 30), this.symbolStrawberries.position.set(0, this.symbolBlueGrapes.y + this.symbolBlueGrapes.height + 30), this.symbolBlueGrape.position.set(0, this.symbolStrawberries.y + this.symbolStrawberries.height + 30), this.symbolRed.position.set(0, this.symbolBlueGrape.y + this.symbolBlueGrape.height + 30)))
                    }
                }
                class mo extends(zt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "_sectionParagraph1", void 0), (0, n.Z)(this, "_sectionParagraph2", void 0), (0, n.Z)(this, "_sectionParagraph3", void 0), (0, n.Z)(this, "_sectionTitle", void 0), (0, n.Z)(this, "_symbol1", void 0), this._sectionTitle = new lo(Ut.i18n.t("PaytableSectionWildTitle").toUpperCase()), this._sectionTitle.position.set(0, 0), this._symbol1 = new go("0_wild"), this._symbol1.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this._symbol1.withoutPayout(), this._sectionParagraph1 = new ro(Ut.i18n.t("PaytableSectionWildContent1")), this._sectionParagraph1.position.set(this._symbol1.x + this._symbol1.width, this._sectionTitle.height + this._sectionTitle.y + 30), this._sectionParagraph1.setTagStyle("default", {
                            wordWrapWidth: 690
                        }), this._sectionParagraph1.position.set(this._symbol1.x + this._symbol1.width + 30, this._symbol1.y + this._symbol1.height / 2 - this._sectionParagraph1.height / 2), this._sectionParagraph2 = new ro(Ut.i18n.t("PaytableSectionWildContent2")), this._sectionParagraph2.position.set(0, this._symbol1.height + this._symbol1.y + 30), this._sectionParagraph3 = new ro(Ut.i18n.t("PaytableSectionWildContent3")), this._sectionParagraph3.position.set(0, this._sectionParagraph2.height + this._sectionParagraph2.y + 30), this.addChild(this._sectionTitle, this._symbol1, this._sectionParagraph1, this._sectionParagraph2, this._sectionParagraph3)
                    }
                    updateBet(t) {
                ...
                class Oo extends Co {
                    ...
                    playAnimation(t) {
                        ...
                        var i = Eo(Eo({}, this.data.animation), t);
                        if (this.visible && this.renderable && (!this.symbolAnimation.renderable || !this.symbolAnimation.playing || this.symbolAnimation.skinName !== i.skin || this.symbolAnimation.animationName !== i.effectName)) {
                            this.isPlaying = !0, i.skin && this.symbolAnimation.changeSkin(i.skin), this.symbolAnimation.renderable = !0, this.symbolAnimation.position.set(this.x, this.y);
                            var s = "string" == typeof i.effectName[t] ? i.effectName[t] : i.effectName[i.animationName] || i.effectName.normal;
                            "win" === s && (this.timeoutId = setTimeout((() => {
                                var t;
                                this.symbolAnimation.play(s, !1, null !== (t = i.trackIndex) && void 0 !== t ? t : 0)
                            }), e))
                        }
                    }
                    ...
                    spawn() {
                        this.wildPositions.forEach(((t, e) => {
                            ...
                            if (this.children[e]) {
                                ...
                                a.position.set(n.x, n.y), a.changeSkin("0_wild"), a.play("stickyTransform").then((() => {
                                    a.play("wildSticky", !0)
                ...
                class Io extends(zt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "description", void 0), (0, n.Z)(this, "timeline", void 0), (0, n.Z)(this, "resolveTimeline", void 0), this.alpha = 0, this.description = this.addChild(new $.j(this.game.loader.getAsset("respinsText"))), this.timeline = new B({
                            onComplete: () => {
                ...
                class Do extends fo {
                    ...
                    _onStopEnter() {
                        var t, e, i;
                        Hi.set(null !== (t = null === (e = this.game.server) || void 0 === e || null === (i = e.response) || void 0 === i ? void 0 : i.feature) && void 0 !== t ? t : Vi.Basic), this.reels.forEach((t => t.stop()))
                    }
                    _onFinishEnter() {
                        var t = this;
                        return (0, o.Z)((function*() {
                ...
                new class extends class extends class extends class {
                    ...
                    initPopups() {
                        this.popupManager.add([new Ei, new Bi, new Ci, new xi, new Zi, new ki, new Ti, new Oi, new Pi, new Si, new Ri])
                    }
                    loadAssets(t) {
                    ...
                    constructor() {
                        super({}), (0, n.Z)(this, "autoPlaySettings", void 0), (0, n.Z)(this, "betSettings", void 0), (0, n.Z)(this, "bigWinAnimation", void 0), (0, n.Z)(this, "fastStopLayout", void 0), (0, n.Z)(this, "gameRules", void 0), (0, n.Z)(this, "menu", void 0), (0, n.Z)(this, "paytable", void 0), (0, n.Z)(this, "slot", void 0), zi.init(), this.init(Di, Ui)
                    }
                    loadTranslations() {
                    ...
                    start() {
                        ...
                        return (0, o.Z)((function*() {
                            var i, s, o;
                            t().call(e), Hi.set(null !== (i = null === (s = e.server.response) || void 0 === s ? void 0 : s.feature) && void 0 !== i ? i : Vi.Basic), yield e.freeRound.start(), null === (o = e.sound.get("backgroundNormal")) || void 0 === o || o.fade(2), e.state.goTo("setup"), Hi.isRespin() && (yield e.popupManager.show("PopupRestore"), yield e.slot.tryRespin()), e.state.goTo("ready")
                        }))()
                    }
                    reward() {
                        var t = this,
    ...
    n.m = s, t = [], n.O = (e, i, s, o) => {
    ...
    }), t), n.o = (t, e) => Object.prototype.hasOwnProperty.call(t, e), e = {}, i = "fruits_of_mbit:", n.l = (t, s, o, a) => {
        if (e[t]) e[t].push(s);
        else {
            var h, r;
            if (void 0 !== o)
        ...
        var e = (e, i) => {
            ...
            i = self.webpackChunkfruits_of_mbit = self.webpackChunkfruits_of_mbit || [];
