...
(() => {
            ...
            1469: (t, e, i) => {
                ...
                class f {
                    ...
                    static loadFromBuffer(t) {
                        var e, i, s, o, n, a, r, h, l, c, d, u, p, g, m, A, v, b, w, y = null !== (e = null === (i = t.metadata) || void 0 === i || null === (s = i.font) || void 0 === s ? void 0 : s.family) && void 0 !== e ? e : t.name;
                ...
                class O {
                    ...
                    set volume(t) {
                        t <= 0 && !this.mutedAll ? R.forEach((t => this.setMuteBySound(t, !0))) : t > 0 && this.mutedAll && R.forEach((t => this.setMuteBySound(t, !1))), this.savedVolume = t, this.setGlobalVolume(t), this.onChangeVolume.dispatch(t)
                    }
                    get volume() {
                    ...
                    get(t) {
                        var e;
                        return null === (e = R.get(t)) || void 0 === e ? void 0 : e.sound
                    }
                    play(t) {
                ...
                class Z {
                    static pre(t, e) {
                        t && Z.supportedSoundExtensions.includes(t.extension) ? (t.load = function(t) {
                            ...
                            R.set(e, T(T({}, this.metadata.audioMetadata), {}, {
                                id: e,
                                sound: this.sound,
                                muted: !1
                ...
                class U {
                    ...
                    readSkeletonData(t, e) {
                        ...
                        var s = i.readString(),
                            o = N(s),
                            n = null;
                        if (o === W.VER38 && (n = new L.SkeletonBinary(new L.AtlasAttachmentLoader(t))), (i = new _.BinaryInput(e)).readInt32(), i.readInt32(), (o = N(s = i.readString())) !== W.VER40 && o !== W.VER41 || (n = new D.SkeletonBinary(new D.AtlasAttachmentLoader(t))), !n) {
                ...
                var G = i(512),
                    ...
                    et = i(798),
                    it = i(5277);
                u.TC.nextRoundedRectBehavior = !0, A.xv.nextLineHeightBehavior = !0, d.R.add(p.bx, g.B9, c.Bv, a.c, r.Q, h.T, l.O, v.vl, m.o, V, f, Z), window.PIXI = s;
                var st = i(3233),
                    ot = i.n(st);
                ...
                class kt extends it.EventEmitter {
                    ...
                    getAsset(t) {
                        ...
                        if (t) {
                            ...
                            return r ? null !== (i = null !== (s = null !== (o = null !== (n = r.texture) && void 0 !== n ? n : r.spineData) && void 0 !== o ? o : r.sound) && void 0 !== s ? s : null === (a = r.textures) || void 0 === a ? void 0 : a[e]) && void 0 !== i ? i : r.textures : c.xE.from(t)
                        }
                    }
                    destroy() {
                        this.loader.destroy()
                ...
                class Ft {
                    constructor() {
                        (0, n.Z)(this, "transitions", Object.create(null)), (0, n.Z)(this, "transition", Rt)
                    }
                    is(t) {
                        var e;
                ...
                class Be extends A.xv {
                        ...
                        for (var e = this, i = [], s = this.getTagRegex(!0, !1), o = [this.assign({}, this.textStyles.default)], n = [{
                            ...
                            if (0 === h.length) r.push(this.createTextData(t[a], o[o.length - 1], n[n.length - 1]));
                                ...
                                for (var c = 0, d = 0; d < h.length; d++) {
                                    if (h[d].index > c && r.push(this.createTextData(t[a].substring(c, h[d].index), o[o.length - 1], n[n.length - 1])), "/" === h[d][0][1]) o.length > 1 && (o.pop(), n.pop());
                                    else {
                                        for (var u = {}, p = this.getPropertyRegex(), g = void 0; g = p.exec(h[d][0]);) u[g[1]] = g[2] || g[3];
                                        n.push({
                                            name: h[d][1],
                                            properties: u
                                        });
                                        ...
                                        if (m === Ce && h[d][0].includes("=") && this.textStyles[h[d][1]]) ! function() {
                                            var t = e.getBBcodePropertyRegex().exec(h[d][0]),
                                                i = {};
                                            Object.entries(e.textStyles[h[d][1]]).forEach((e => {
                    ...
                    updateText() {
                        if (this.withPrivateMembers().dirty) {
                            ...
                            for (var i = e.split(/(?:\r\n|\r|\n)/), s = this._getTextDataPerLine(i), o = [], n = [], a = [], r = 0, h = 0; h < i.length; h++) {
                                for (var l = 0, c = 0, d = 0, u = 0; u < s[h].length; u++) {
                                    var p = s[h][u].style;
                                    this.context.font = this.getFontString(p), s[h][u].width = this.context.measureText(s[h][u].text).width, 0 !== s[h][u].text.length && (s[h][u].width += (s[h][u].text.length - 1) * p.letterSpacing, u > 0 && (l += p.letterSpacing / 2), u < s[h].length - 1 && (l += p.letterSpacing / 2)), l += s[h][u].width, s[h][u].fontProperties = A._A.measureFont(this.context.font), s[h][u].height = s[h][u].fontProperties.fontSize, "number" == typeof p.valign ? (c = Math.min(c, p.valign - s[h][u].fontProperties.descent), d = Math.max(d, p.valign + s[h][u].fontProperties.ascent)) : (c = Math.min(c, -s[h][u].fontProperties.descent), d = Math.max(d, s[h][u].fontProperties.ascent))
                                }
                                o[h] = l, n[h] = c, a[h] = d, r = Math.max(r, l)
                            }
                                ...
                                for (var k = 0; k < x.length; k++) {
                                    ...
                                    switch (C.valign) {
                                        ...
                                        case "baseline":
                                            ...
                                            break;
                                        case "middle":
                                            F += (a[y] - n[y] - B.ascent - B.descent) / 2;
                                            break;
                                        case "bottom":
                                            F += a[y] - n[y] - B.ascent - B.descent;
                                            break;
                                        default:
                                            F += a[y] - B.ascent - C.valign
                                    }
                            ...
                            this.context.save(), w.forEach((t => {
                                ...
                                }), (void 0 === e.debug ? Be.debugOptions.spans.enabled : e.debug) && (this.context.lineWidth = 1, Be.debugOptions.spans.bounding && (this.context.fillStyle = Be.debugOptions.spans.bounding, this.context.strokeStyle = Be.debugOptions.spans.bounding, this.context.beginPath(), this.context.rect(s, o - a, n, a + r), this.context.fill(), this.context.stroke(), this.context.stroke()), Be.debugOptions.spans.baseline && (this.context.strokeStyle = Be.debugOptions.spans.baseline, this.context.beginPath(), this.context.moveTo(s, o), this.context.lineTo(s + n, o), this.context.closePath(), this.context.stroke()), Be.debugOptions.spans.top && (this.context.strokeStyle = Be.debugOptions.spans.top, this.context.beginPath(), this.context.moveTo(s, o - a), this.context.lineTo(s + n, o - a), this.context.closePath(), this.context.stroke()), Be.debugOptions.spans.bottom && (this.context.strokeStyle = Be.debugOptions.spans.bottom, this.context.beginPath(), this.context.moveTo(s, o + r), this.context.lineTo(s + n, o + r), this.context.closePath(), this.context.stroke()), Be.debugOptions.spans.text && (this.context.fillStyle = "#ffffff", this.context.strokeStyle = "#000000", this.context.lineWidth = 2, this.context.font = "8px monospace", this.context.strokeText(h.name, s, o - a + 8), this.context.fillText(h.name, s, o - a + 8), this.context.strokeText("".concat(n.toFixed(2), "x").concat((a + r).toFixed(2)), s, o - a + 16), this.context.fillText("".concat(n.toFixed(2), "x").concat((a + r).toFixed(2)), s, o - a + 16)))
                    ...
                    wordWrap(t) {
                        ...
                        for (var a = 0; a < s.length; a++) {
                            for (var r = o, h = s[a].split(i), l = !0, c = 0; c < h.length; c++)
                                if (i.test(h[c])) {
                                    if (e += h[c], "/" === h[c][1]) c += 2, n.pop();
                                    else {
                                        var d = h[++c];
                                    ...
                                    for (var u = h[c].split(" "), p = 0; p < u.length; p++) {
                ...
                class Oe extends(Vt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "content", void 0), this.title = this.addChild(new Fe(this.game.i18n.t("GameRulesAdvancedAutoPlayTitle"))), this.content = this.addChild(new Re(this.game.i18n.t("GameRulesAdvancedAutoPlayContent")))
                    }
                    resize() {
                ...
                class Ze extends(Vt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "content", void 0), this.title = this.addChild(new Fe(this.game.i18n.t("GameRulesAutoPlayTitle"))), this.content = this.addChild(new Re(this.game.i18n.t("GameRulesAutoPlayContent")))
                    }
                    resize() {
                        this.content.position.set(0, this.title.y + this.title.height + 30)
                    }
                ...
                class We extends(Vt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "content", void 0), this.content = this.addChild(new Re(this.game.i18n.t("GameRulesBestExperience")))
                    }
                    resize() {
                        this.content.position.set(0, 0)
                    }
                }
                class _e extends(Vt($.j)) {
                    constructor() {
                ...
                class Me extends(Vt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "gameName", void 0), (0, n.Z)(this, "gameTRTP", void 0), this.title = this.addChild(new Fe(this.game.i18n.t("GameRulesGeneralTitle"))), this.gameName = this.addChild(new Re(this.game.config.get("gameName")));
                        var t = this.game.config.get("trtp");
                        this.gameTRTP = this.addChild(new Re(this.game.i18n.t("GameRulesGeneralRTP", t))), this.gameTRTP.visible = !!t
                    }
                    resize() {
                ...
                class Ie extends(Vt(Q.W2, {
                    ...
                    constructor(t, e, i) {
                        super(), (0, n.Z)(this, "icon", void 0), (0, n.Z)(this, "text", void 0), this.name = i, this.icon = this.addChild(new $.j(e)), this.text = this.addChild(new Re(t))
                    }
                    resize() {
                ...
                class Le extends(Vt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "content", void 0), this.title = this.addChild(new Fe(this.game.i18n.t("GameRulesInterfaceTitle"))), this.content = this.addChild(new Re(this.game.i18n.t("GameRulesInterfaceContent"))), this.addItems()
                    }
                    addItems() {
                ...
                class De extends(Vt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "itemQuickSpin", void 0), (0, n.Z)(this, "itemFullscreen", void 0), (0, n.Z)(this, "itemGameSound", void 0), (0, n.Z)(this, "itemBackgroundSound", void 0), this.title = this.addChild(new Fe(this.game.i18n.t("GameRulesSettingsTitle"))), this.content = this.addChild(new Re(this.game.i18n.t("GameRulesSettingsContent"))), this.game.config.get("quickSpin.available", !0) && (this.itemQuickSpin = this.addChild(new Re(this.game.i18n.t("GameRulesSettingsContentItemQuickSpin")))), this.itemFullscreen = this.addChild(new Re(this.game.i18n.t("GameRulesSettingsContentItemFullscreen"))), this.itemGameSound = this.addChild(new Re(this.game.i18n.t("GameRulesSettingsContentItemGameSound"))), this.itemBackgroundSound = this.addChild(new Re(this.game.i18n.t("GameRulesSettingsContentItemBackgroundSound")))
                    }
                    resize() {
                        var t;
                ...
                class je extends(Vt(Q.W2)) {
                    constructor() {
                        var t, e;
                        super(), (0, n.Z)(this, "content", void 0), this.content = this.addChild(new Re("".concat(null !== (t = window.RELEASE_VERSION) && void 0 !== t ? t : "", "\n").concat(null !== (e = window.RELEASE_DATE) && void 0 !== e ? e : "")))
                    }
                    resize() {
                        var t;
                ...
                class Ne extends(Vt(Q.W2)) {
                    ...
                    addSections() {
                        this.content.addChild(new Me), this.content.addChild(new Le), this.content.addChild(new De), this.addAutoPlaySection(), this.content.addChild(new _e), this.content.addChild(new We), this.content.addChild(new je)
                    }
                    addAutoPlaySection() {
                ...
                const Li = [...[{
                    ...
                    url: "assets/audio/coin_wild.mp3",
                    name: "coinWild",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"],
                        audioMetadata: {
                    ...
                    url: "assets/audio/coin_wild_mermaid.mp3",
                    name: "coinWildMermaid",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"],
                        audioMetadata: {
                            type: "effects",
                    ...
                    url: "assets/audio/respin_mermaid_start.mp3",
                    name: "respinStart",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"],
                        audioMetadata: {
                    ...
                    url: "assets/images/respinsText.png",
                    name: "respinsText",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                    ...
                    url: "assets/images/bg_respin.jpg",
                    name: "respinBg",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/slotbg.png",
                    name: "wheelBg",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/bg_normal_left.png",
                    name: "backgroundLeft",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/leaves right top.png",
                    name: "leafesRight",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/flag1.png",
                    name: "flag1",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/flag2.png",
                    name: "flag2",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/flag3.png",
                    name: "flag3",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/flag4.png",
                    name: "flag4",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                    ...
                    url: "assets/images/effects/top_leaves/skeleton.json",
                    name: "topLeaves",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/effects/right_leaves/skeleton.json",
                    name: "rightLeaves",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/effects/rock_left/skeleton.json",
                    name: "rockLeft",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/effects/symbols/symEffect/skeleton.json",
                    name: "symEffect",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/effects/symbols/portraitEffect/skeleton.json",
                    name: "portraitEffect",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/effects/symbols/wildEffect/skeleton.json",
                    name: "wildEffect",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                    ...
                    name: "scatterWinEffect",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/effects/left_feature/skeleton.json",
                    name: "leftFeature",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/effects/flag_big/skeleton.json",
                    name: "flagAnimation",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/effects/flag/skeleton.json",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                ...
                var ji = {
                        ...
                        before_spin_free: 200,
                        free_end: 700,
                        after_free_start: 300
                    },
                    Ni = {
                        get: t => ji[t],
                        set(t, e) {}
                ...
                const Ui = {
                    init() {
                        function t(t) {
                            ...
                            Dt.store.set("free:win", e), Dt.store.set("free:coins", ot()(t, "freespins.coins", 0)), Dt.store.set("free:left", o), Dt.store.set("free:played", n), Dt.store.set("free:count", o + n), Dt.store.set("free:isStart", 0 === n), Dt.store.set("free:isEnd", 0 === o), Dt.store.set("free:isFree", "freespin" === i), 0 !== n && (Dt.store.set("free:winAdditional", o > s), Dt.store.set("free:winAdditionalCount", ot()(t, "scatters.freespins", 0))), Dt.store.set("free:scattersFree", ot()(t, "scatters.freespins", 0))
                        }
                        Dt.store.set("free:win", 0), Dt.store.set("free:coins", 0), Dt.store.set("free:count", 0), Dt.store.set("free:left", -1), Dt.store.set("free:played", -1), Dt.store.set("free:end", 0), Dt.store.set("free:isStart", !1), Dt.store.set("free:isEnd", !1), Dt.store.set("free:isFree", !1), Dt.store.set("free:winAdditional", !1), Dt.store.set("free:scattersFree", 0), Dt.server.on("response:init", t), Dt.server.on("response:spin", t), Dt.server.on("response:buyin", t), Dt.server.on("response:risk", t)
                    }
                };
                var zi;
                ! function(t) {
                        ...
                        init() {
                            ...
                            function e(e) {
                                var i = ot()(e, "win", 0),
                                    ...
                                    o = ot()(e, "wilds", []),
                                    n = ot()(e, "respins");
                                void 0 === n && (n = 0), Dt.store.set("reward:win", i), Dt.store.set("reward:lines", ot()(e, "lines", [])), Dt.store.set("reward:reels", ot()(e, "reels", e.error ? Gi : [])), Dt.store.set("reward:nReels", ot()(e, "nReels", e.error ? Hi : [])), Dt.store.set("reward:fsReels", ot()(e, "fsReels", [])), Dt.store.set("reward:preReels", ot()(e, "preSpin.reels", [])), Dt.store.set("reward:preWilds", ot()(e, "preSpin.wilds", [])), Dt.store.set("reward:preScatters", ot()(e, "preSpin.scatters", [])), Dt.store.set("reward:respins", n), Dt.store.set("reward:scatters", s), Dt.store.set("reward:wildReel", o), Dt.store.set("reward:isWin", i > 0 || s), Dt.store.set("reward:numberWinSymbol", ot()(e, "winSyms", 0));
                                var a = ot()(e, "feature", zi.Basic);
                                Dt.store.set("reward:feature", a), t(e)
                            }
                            ...
                            function i(e) {
                                ...
                                Dt.store.set("reward:feature", "basic" === s ? s : "freespin"), "freespin" === Dt.store.get("reward:feature") && Vi.set("freespin"), t(e)
                            }
                            Dt.store.set("reward:win", 0), Dt.store.set("reward:isWin", !1), Dt.store.set("reward:lines", []), Dt.store.set("reward:reels", []), Dt.store.set("reward:nReels", []), Dt.store.set("reward:fsReels", []), Dt.store.set("reward:preReels", []), Dt.store.set("reward:preWilds", []), Dt.store.set("reward:preScatters", []), Dt.store.set("reward:scatters", !1), Dt.store.set("reward:wildReel", []), Dt.store.set("reward:numberWinSymbol", 0), Dt.store.set("reward:respins", 0), Dt.store.set("reward:feature", ""), Dt.store.set("isRiskNBuy", !1), Dt.store.set("risk", !1), Dt.store.set("buy", !1), Dt.server.on("response:init", e), Dt.server.on("response:spin", e), Dt.server.on("response:buyin", i), Dt.server.on("response:risk", i)
                        }
                    },
                    Yi = {
                        init() {
                ...
                class Ki extends O {
                    constructor(t, e, i) {
                        super(t, e, i), (0, n.Z)(this, "backgroundFree", void 0), (0, n.Z)(this, "backgroundNormal", void 0), (0, n.Z)(this, "bigWin", void 0), (0, n.Z)(this, "bonusEnd", void 0), (0, n.Z)(this, "bonusStart", void 0), (0, n.Z)(this, "changeWild", void 0), (0, n.Z)(this, "clickNormal", void 0), (0, n.Z)(this, "currentWinSound", void 0), (0, n.Z)(this, "giantWin", void 0), (0, n.Z)(this, "scatterReel", void 0), (0, n.Z)(this, "scatterWin", void 0), (0, n.Z)(this, "spinFast", void 0), (0, n.Z)(this, "spinStart", void 0), (0, n.Z)(this, "wheelStop", void 0), (0, n.Z)(this, "wildCoin", void 0), (0, n.Z)(this, "wildRespin", void 0), (0, n.Z)(this, "winFree1", void 0), (0, n.Z)(this, "winFree2", void 0), (0, n.Z)(this, "winFree3", void 0), (0, n.Z)(this, "winNormal1", void 0), (0, n.Z)(this, "winNormal2", void 0), (0, n.Z)(this, "winNormal3", void 0), this.backgroundNormal = this.get("backgroundNormal"), this.backgroundFree = this.get("backgroundFree"), this.bonusStart = this.get("bonusStart"), this.bonusEnd = this.get("bonusEnd"), this.winNormal1 = this.get("win_normal_1"), this.winNormal2 = this.get("win_normal_2"), this.winNormal3 = this.get("win_normal_3"), this.winFree1 = this.get("win_free_1"), this.winFree2 = this.get("win_free_2"), this.winFree3 = this.get("win_free_3"), this.bigWin = this.get("bigWin"), this.giantWin = this.get("giantWin"), this.spinStart = this.get("spinStart"), this.spinFast = this.get("spinFast"), this.clickNormal = this.get("clickNormal"), this.wheelStop = this.get("wheelStop"), this.scatterWin = this.get("scatterWin"), this.scatterReel = this.get("scatterReel"), this.wildRespin = this.get("respinStart"), this.changeWild = this.get("coinWildMermaid"), this.wildCoin = this.get("coinWild"), this.currentWinSound = null, this._setupEvents()
                    }
                    _setupEvents() {
                        ...
                        })), Dt.action.on("sound:scatterWheel", (() => {
                            this.scatterReel.play()
                        })), Dt.action.on("sound:wildRespin", (() => {
                            this.wildRespin.play()
                        })), Dt.action.on("sound:changeWild", (() => {
                            this.changeWild.play()
                        })), Dt.action.on("sound:wildCoin", (() => {
                            this.wildCoin.play()
                        })), Dt.action.on("state:spin_enter", this._onSpinEnter, this), Dt.action.on("state:finish_enter", this._onFinishEnter, this), Dt.action.on("sound:spinFast", this._onFastSpin, this), Dt.action.on("wheel:stop_down", this._onWheelStop, this), Dt.action.on("sound:click", this.click, this), Dt.action.on("sound:free_start", this._onFreeStart, this), Dt.action.on("sound:free_stop", this._onFreeStop, this), Dt.action.on("free:select_start", this._onSelectFreeStart, this), Dt.action.on("free:select_stop", this._onSelectFreeStop, this)
                    }
                    stopBigWin() {
                ...
                class ms extends j.PY {
                        ...
                        if (t > e && (t = e), this.state.update(t), this.state.apply(this.skeleton), this.skeleton) {
                                ...
                                if (l) {
                                    ...
                                    switch (l.type) {
                                        case _.AttachmentType.Region:
                                            ...
                                            c.transform.setFromMatrix(h.bone.matrix), h.currentSprite.color ? d = h.currentSprite.color : (gs[0] = o[0] * h.color.r * u.r, gs[1] = o[1] * h.color.g * u.g, gs[2] = o[2] * h.color.b * u.b, h.currentSprite.tint = it.rgb2hex(gs)), h.currentSprite.blendMode = h.blendMode;
                                            break;
                                        case _.AttachmentType.Mesh:
                                            ...
                                            l.computeWorldVerticesOld(h, h.currentMesh.vertices), h.currentMesh.color ? d = h.currentMesh.color : (gs[0] = o[0] * h.color.r * u.r, gs[1] = o[1] * h.color.g * u.g, gs[2] = o[2] * h.color.b * u.b, h.currentMesh.tint = it.rgb2hex(gs)), h.currentMesh.blendMode = h.blendMode;
                                            break;
                                        case _.AttachmentType.Clipping:
                                            h.currentGraphics || (this.createGraphics(h, l), c.addChild(h.clippingContainer), c.addChild(h.currentGraphics)), this.updateGraphics(h, l), c.alpha = 1, c.visible = !0;
                                            continue;
                                        default:
                                            c.visible = !1;
                                            continue
                                    ...
                                    if (c.visible = !0, d) {
                                        var y = h.color.r * u.r,
                                            x = h.color.g * u.g,
                                            S = h.color.b * u.b;
                                        d.setLight(o[0] * y + n[0] * (1 - y), o[1] * x + n[1] * (1 - x), o[2] * S + n[2] * (1 - S)), h.darkColor ? (y = h.darkColor.r, x = h.darkColor.g, S = h.darkColor.b) : (y = 0, x = 0, S = 0), d.setDark(o[0] * y + n[0] * (1 - y), o[1] * x + n[1] * (1 - x), o[2] * S + n[2] * (1 - S))
                                    }
                                    c.alpha = h.color.a
                                } else c.visible = !1
                            }
                            for (var k = this.skeleton.drawOrder, C = null, P = null, B = 0, E = k.length; B < E; B++) {
                                var T = i[k[B].data.index],
                                    R = this.slotContainers[k[B].data.index];
                                if (P || null !== R.parent && R.parent !== this && (R.parent.removeChild(R), R.parent = this), T.currentGraphics && T.getAttachment()) P = T.clippingContainer, C = T.getAttachment(), P.children.length = 0, this.children[B] = R, C.endSlot === T.data && (C.endSlot = null);
                                else if (P) {
                                    var F = this.tempClipContainers[B];
                                    F || ((F = this.tempClipContainers[B] = this.newContainer()).visible = !1), this.children[B] = F, R.parent = null, P.addChild(R), C.endSlot == T.data && (P.renderable = !0, P = null, C = null)
                                } else this.children[B] = R
                            }
                        }
                    }
                    createGraphics(t, e) {
                    ...
                    updateGraphics(t, e) {
                        ...
                        if (s instanceof X.Polygon) {
                            ...
                            var h = a[4] - a[0],
                                l = a[5] - a[1],
                                c = h > 0 ? a[0] : a[0] - Math.abs(h),
                                d = l > 0 ? a[1] : a[1] - Math.abs(l);
                            s.x = c, s.y = d, s.width = Math.abs(h), s.height = Math.abs(l)
                        }
                        i.invalidate()
                    }
                }
                class As extends(Vt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "backgroundLTextureFree", void 0), (0, n.Z)(this, "backgroundLTextureNormal", void 0), (0, n.Z)(this, "backgroundLeft", void 0), (0, n.Z)(this, "backgroundPTextureFree", void 0), (0, n.Z)(this, "backgroundPTextureNormal", void 0), (0, n.Z)(this, "backgroundTextureLandscape", void 0), (0, n.Z)(this, "backgroundTexturePortrait", void 0), (0, n.Z)(this, "featureBackground", void 0), (0, n.Z)(this, "leafesLeft", void 0), (0, n.Z)(this, "leafesRight", void 0), (0, n.Z)(this, "logo", void 0), (0, n.Z)(this, "respin", void 0), (0, n.Z)(this, "respinBg", void 0), this.respin = !1, this.backgroundLTextureNormal = this.game.loader.getAsset("bgln"), this.backgroundLTextureFree = this.game.loader.getAsset("bglf"), this.backgroundPTextureNormal = this.game.loader.getAsset("bgpn"), this.backgroundPTextureFree = this.game.loader.getAsset("bgpf"), this.backgroundTextureLandscape = this.backgroundLTextureNormal, this.backgroundTexturePortrait = this.backgroundPTextureNormal, this.background = new $.j(this.backgroundTextureLandscape), this.background.name = "background", this.backgroundLeft = new ms(this.game.loader.getAsset("rockLeft")), this.backgroundLeft.play("static", !0), this.leafesLeft = new ms(this.game.loader.getAsset("topLeaves")), this.leafesLeft.play("static", !0), this.leafesRight = new ms(this.game.loader.getAsset("rightLeaves")), this.leafesRight.x = 6, this.leafesRight.play("static", !0), this.logo = new $.j(this.game.loader.getAsset("logo")), this.logo.name = "logo", this.logo.anchor.x = .5, this.logo.scale.set(.9), this.featureBackground = new $.j(this.backgroundPTextureFree), this.featureBackground.name = "featureBackground", this.featureBackground.alpha = 0, this.featureBackground.y = 1, this.respinBg = new $.j(this.game.loader.getAsset("respinBg")), this.respinBg.alpha = 0, this.respinBg.y = 1, this.addChild(this.background), this.addChild(this.backgroundLeft), this.addChild(this.featureBackground), this.addChild(this.respinBg), this.addChild(this.leafesLeft), this.addChild(this.leafesRight), this.addChild(this.logo), this.setupEvents()
                    }
                    setupEvents() {
                        this.game.action.on("state:setup_enter", (() => {
                            this.game.store.get("free:isFree", !1) && (this.featureBackground.alpha = 1)
                        })), this.game.action.on("respin:start", (() => {
                            !1 !== this.respin || this.game.store.get("free:isFree", !1) || (k.fromTo(this.respinBg, 1, {
                                pixi: {
                                    alpha: 0
                                }
                            }, {
                        ...
                        })), this.game.action.on("respin:end", (() => {
                            !0 !== this.respin || this.game.store.get("free:isFree", !1) || (k.fromTo(this.respinBg, 1, {
                                pixi: {
                                    alpha: 1
                                }
                            }, {
                            ...
                            this.respinBg.alpha = 0, this.respin = !1, 1 !== this.featureBackground.alpha && k.fromTo(this.featureBackground, .5, {
                                pixi: {
                                    alpha: 0
                                }
                            }, {
                            ...
                            this.backgroundTextureLandscape = this.backgroundLTextureNormal, this.backgroundTexturePortrait = this.backgroundPTextureNormal, this.background.texture = this.game.device.portrait && !this.game.device.desktop ? this.backgroundTexturePortrait : this.backgroundTextureLandscape, k.fromTo(this.featureBackground, .5, {
                                pixi: {
                                    alpha: 1
                                }
                            }, {
                ...
                class Ts extends(Vt(Q.W2)) {
                    constructor() {
                        ...
                        var e = new Ps(c.xE.from(Ss), 0);
                        e.width = 12, e.height = 151;
                        var i = new Ps(c.xE.from(Ss), 4914792);
                ...
                class js extends Os {
                    constructor(t) {
                        ...
                        })), this.betLevel = t, this.betLevelText = this.addChild(new Be("", Ds(Ds({}, Is.Common), {}, {
                            default: Ds(Ds({}, Is.Common.default), {}, {
                                align: "left"
                            })
                ...
                class to extends Fs {
                    constructor() {
                        ...
                        this.background = $.j.from("data:image/png;base64,"), this.background.alpha = .4, this.background.anchor.set(0, 1), this.background.position.set(0, this.game.viewport.height), this.buttonMenu = new ws, this.buttonMenu.position.set(77, 1013), this.buttonMaxBet = new js(this.game.betLevel), this.buttonMaxBet.position.set(213, 1013), this.buttonAutoPlay = new bs, this.buttonAutoPlay.position.set(833, 1013), this.buttonQuickSpin = new ys, this.buttonQuickSpin.position.set(1084, 1014), this.buttonSound = new Rs, this.buttonSound.position.set(1840, 1012), this.buttonSpin = function() {
                            ...
                            e.hitArea = new X.Rectangle(0, 0, e.width, e.height), e.name = "buttonSpin", e.onClick.add(o);
                            var i = new ms(Dt.loader.getAsset("spinButtonAnimation"));
                            e.addChild(i), i.play("normal", !1);
                            var s = Dt.keyboard.register(Dt.keyboard.KEY_CODE.Space);

                            function o() {
                                t.handlers(!0) ? t.dispatch() : (Dt.store.get("spin:isSpin", !1) || i.play("press", !1), Dt.action.emit("clickSpin"))
                            }
                            ...
                            function a() {
                                Vi.isFreespin() || (e.enable(), s.enable(), i.play("normal", !1))
                            }
                            ...
                            function l() {
                                s.enable(), Vi.isFreespin() || Dt.autoPlay.enabled || (e.visible = !0, i.play("normal", !1))
                            }
                            return s.onPress.add(o), s.disable(), e.onHover.add((() => {
                                i.play("hover", !1)
                            })), e.onLeave.add((() => {
                                i.play("normal", !1)
                            })), Dt.action.on("spin:fast", n), Dt.action.on("state:ready_enter", l), Dt.action.on("state:finish_exit", a), Dt.action.on("free:start", r), Dt.action.on("free:restore", r), Dt.action.on("free:stop", (() => {
                            ...
                            "respin" === this.game.store.get("reward:feature") && (this.buttonAutoPlay.disable(), this.buttonMenu.disable()), Vi.isFreespin() && (this.y = this.y + this.height + 100)
                            ...
                            var t = this.game.store.get("free:isFree", !1),
                                e = "respin" === this.game.store.get("reward:feature");
                            ...
                            this.game.autoPlay.enabled || this.buttonAutoPlay.disable()
                        })), this.game.action.on("respin:stop", (() => {
                            this.buttonAutoPlay.enable()
                        })), this.game.action.on("free:restore", (() => {
                ...
                class lo extends(Vt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "state", void 0), (0, n.Z)(this, "textBet", void 0), (0, n.Z)(this, "textWin", void 0), (0, n.Z)(this, "textBalance", void 0), (0, n.Z)(this, "textFreeRound", void 0), (0, n.Z)(this, "textFree", void 0), (0, n.Z)(this, "textTotalWin", void 0), (0, n.Z)(this, "textBonus", void 0), (0, n.Z)(this, "delimiter", void 0), this.state = no.Normal, this.textBet = new Be("", so(so({}, ro), {}, {
                            default: so(so({}, ro.default), {}, {
                                align: "left"
                            })
                        })), this.textBet.anchor.set(0, 0), this.textWin = new Be("", ro), this.textWin.anchor.set(.5, 0), this.textBalance = new Be("", so(so({}, ro), {}, {
                            default: so(so({}, ro.default), {}, {
                                align: "right"
                            })
                        })), this.textBalance.anchor.set(1, 0), this.textFreeRound = new Be("", so(so({}, ro), {}, {
                            default: so(so({}, ro.default), {}, {
                                align: "center",
                                wordWrap: !0,
                                wordWrapWidth: 300
                            })
                        })), this.textFreeRound.anchor.set(1, 1), this.textFree = new Be("", so(so({}, ho), {}, {
                            default: so(so({}, ho.default), {}, {
                                fontSize: 30,
                                wordWrapWidth: 340
                            })
                        })), this.textFree.anchor.set(0, 1), this.textTotalWin = new Be("", so(so({}, ho), {}, {
                            default: so(so({}, ho.default), {}, {
                                fontFamily: "Avenir-Bold",
                                fill: this.game.config.get("colors.primary"),
                                fontSize: 30,
                        ...
                        })), this.textTotalWin.anchor.set(.5, 1), this.textBonus = new Be("", so(so({}, ho), {}, {
                            default: so(so({}, ho.default), {}, {
                                fontSize: 27,
                                wordWrapWidth: 340
                            })
                ...
                class uo extends Fs {
                    constructor() {
                        super(), (0, n.Z)(this, "autoPlayButton", void 0), (0, n.Z)(this, "betButton", void 0), (0, n.Z)(this, "buttonAccept", void 0), (0, n.Z)(this, "buttonMenu", void 0), (0, n.Z)(this, "buttonQuickSpin", void 0), (0, n.Z)(this, "buttonSound", void 0), (0, n.Z)(this, "buttonSpin", void 0), (0, n.Z)(this, "onPressButtonSpin", void 0), (0, n.Z)(this, "state", void 0), (0, n.Z)(this, "statusBar", void 0), this.state = no.Normal, this.onPressButtonSpin = new(x()), this.statusBar = new lo, this.statusBar.changeState(this.state), this.game.freeRound.enabled ? (this.statusBar.update({
                        ...
                        })), this.buttonMenu = new ws, this.buttonSound = new Rs, this.buttonSpin = new co, this.game.interaction.hover(this.buttonSpin, (() => {
                        ...
                        })), this.buttonAccept = new fs, this.buttonQuickSpin = new ys, this.autoPlayButton = new bs, this.autoPlayButton.scale.set(1.6), this.betButton = new Os, this.betButton.disable(), this.betButton.onClick.add((() => this.game.action.emit("clickMaxBet"))), this.game.action.on("update:win", (() => {
                            ...
                            var t = this.game.autoPlay.enabled,
                                e = Vi.isFreespin(),
                                i = "respin" === this.game.store.get("reward:feature");
                            if (this.buttonSpin.interactive = !0, this.betButton.disable(), t || this.autoPlayButton.disable(), this.statusBar.update({
                                ...
                                }), !this.game.freeRound.enabled || e || i || this.statusBar.update({
                                    type: oo.FreeRoundLeft,
                                    value: this.game.freeRound.left - 1
                                }), !this.game.freeRound.enabled && !e && !i) {
                            ...
                            var t = this.game.autoPlay.enabled,
                                e = Vi.isFreespin(),
                                i = this.game.store.get("reward:feature");
                            e || t || "respin" === i || (this.buttonSpin.visible = !0, this.buttonSpin.interactive = !0, this.buttonQuickSpin.show(), this.autoPlayButton.show(), this.autoPlayButton.enable(), this.buttonMenu.show(), this.buttonMenu.enable())
                        })), this.game.action.on("state:setup_enter", (() => {
                            "respin" === this.game.store.get("reward:feature") && (this.autoPlayButton.disable(), this.buttonMenu.disable()), Vi.isFreespin() && (this.alpha = 0)
                        })), this.game.action.on("free:select_start", (() => {
                ...
                class po extends(Vt(Q.W2)) {
                    constructor() {
                        ...
                        })), this._title.anchor.set(.5, 1), this._title.position.set(0, 100), this._win = this._content.addChild(new Be("", {
                            default: {
                                fill: "#ffffff",
                                fontFamily: "PT Sans Narrow Bold",
                                align: "center",
                        ...
                        })), this._win.anchor.set(.5), this._win.position.set(0, 300), this._description = this._content.addChild(new Be("", {
                            default: {
                                fontFamily: "PT Sans Narrow Bold",
                                fill: "#ffffff",
                                align: "center",
                        ...
                        })), this._description.anchor.set(.5), this._description.position.set(0, 450), this._buttonText = this._content.addChild(new Be("", {
                            default: {
                                fontFamily: "PT Sans Narrow Bold",
                                fill: "#ebab00",
                                fontSize: 65,
                    ...
                    show(t) {
                        ...
                        return new Promise((i => {
                            ...
                            if (t === ao.START) {
                                ...
                                0 === r ? (this._title.text = this.game.i18n.t("PopupFreeSpinsTitleRestore"), this._win.text = this.game.i18n.t("PopupFreeSpinsWinRestoreLast"), this._description.text = "", this._buttonText.text = this.game.i18n.t("PopupFreeSpinsButton")) : (this._title.text = this.game.i18n.t("PopupFreeSpinsTitleRestore"), this._win.text = this.game.i18n.t("PopupFreeSpinsWinRestore", r), this._description.text = "", this._buttonText.text = this.game.i18n.t("PopupFreeSpinsButton"))
                            }
                ...
                class Bo extends(Vt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "sectionTitle", void 0), (0, n.Z)(this, "symbol10", void 0), (0, n.Z)(this, "symbol9", void 0), (0, n.Z)(this, "symbolA", void 0), (0, n.Z)(this, "symbolCrab", void 0), (0, n.Z)(this, "symbolFishes", void 0), (0, n.Z)(this, "symbolHorse", void 0), (0, n.Z)(this, "symbolJ", void 0), (0, n.Z)(this, "symbolK", void 0), (0, n.Z)(this, "symbolQ", void 0), (0, n.Z)(this, "symbols", void 0);
                        var t = this.game.i18n.t("PaytableSectionPayoutTitle");
                        this.sectionTitle = new fo(t.toUpperCase()), this.symbolFishes = new Po("general"), this.symbolFishes.position.set(0, this.sectionTitle.y + this.sectionTitle.height + 30), this.symbolCrab = new Po("girl"), this.symbolCrab.position.set(600, this.sectionTitle.y + this.sectionTitle.height + 30), this.symbolHorse = new Po("soldier"), this.symbolHorse.position.set(0, this.symbolFishes.y + this.symbolFishes.height + 30), this.symbolA = new Po("a"), this.symbolA.position.set(600, this.symbolCrab.y + this.symbolCrab.height + 30), this.symbolK = new Po("k"), this.symbolK.position.set(0, this.symbolHorse.y + this.symbolHorse.height + 30), this.symbolQ = new Po("q"), this.symbolQ.position.set(600, this.symbolA.y + this.symbolA.height + 30), this.symbolJ = new Po("j"), this.symbolJ.position.set(0, this.symbolK.y + this.symbolK.height + 30), this.symbol10 = new Po("10"), this.symbol10.position.set(600, this.symbolQ.y + this.symbolQ.height + 30), this.symbol9 = new Po("9"), this.symbol9.position.set(0, this.symbolJ.y + this.symbolJ.height + 30), this.symbols = [this.symbolFishes, this.symbolCrab, this.symbolHorse, this.symbolA, this.symbolK, this.symbolQ, this.symbolJ, this.symbol10, this.symbol9], this.addChild(this.sectionTitle, ...this.symbols)
                    }
                    updateBet(t) {
                        this.symbols.forEach((e => e.updateBet(t)))
                    }
                    resize() {
                        this.game.device.desktop || (this.game.device.landscape ? (this.symbolFishes.position.set(0, this.sectionTitle.y + this.sectionTitle.height + 30), this.symbolCrab.position.set(820, this.sectionTitle.y + this.sectionTitle.height + 30), this.symbolHorse.position.set(0, this.symbolFishes.y + this.symbolFishes.height + 30), this.symbolA.position.set(820, this.symbolCrab.y + this.symbolCrab.height + 30), this.symbolK.position.set(0, this.symbolHorse.y + this.symbolHorse.height + 30), this.symbolQ.position.set(820, this.symbolA.y + this.symbolA.height + 30), this.symbolJ.position.set(0, this.symbolK.y + this.symbolK.height + 30), this.symbol10.position.set(820, this.symbolQ.y + this.symbolQ.height + 30), this.symbol9.position.set(0, this.symbolJ.y + this.symbolJ.height + 30)) : (this.symbolFishes.position.set(0, this.sectionTitle.y + this.sectionTitle.height + 30), this.symbolCrab.position.set(0, this.symbolFishes.y + this.symbolFishes.height + 30), this.symbolHorse.position.set(0, this.symbolCrab.y + this.symbolCrab.height + 30), this.symbolA.position.set(0, this.symbolHorse.y + this.symbolHorse.height + 30), this.symbolK.position.set(0, this.symbolA.y + this.symbolA.height + 30), this.symbolQ.position.set(0, this.symbolK.y + this.symbolK.height + 30), this.symbolJ.position.set(0, this.symbolQ.y + this.symbolQ.height + 30), this.symbol10.position.set(0, this.symbolJ.y + this.symbolJ.height + 30), this.symbol9.position.set(0, this.symbol10.y + this.symbol10.height + 30)))
                    }
                }
                ...
                class To extends(Vt(Q.W2)) {
                    constructor(t) {
                        super(), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "image", void 0), this.background = $.j.from(Co), this.background.y = -20, this.background.width = 460, this.background.height = 900, this.image = new $.j(t), this.image.anchor.x = .5, this.image.x = 230, this.addChild(this.background), this.addChild(this.image)
                    }
                }
                class Ro extends(Vt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "_sectionParagraph1", void 0), (0, n.Z)(this, "_sectionParagraph2", void 0), (0, n.Z)(this, "_sectionParagraph3", void 0), (0, n.Z)(this, "_sectionParagraph4", void 0), (0, n.Z)(this, "_sectionTitle", void 0), (0, n.Z)(this, "_symbol1", void 0), (0, n.Z)(this, "_symbol2", void 0), (0, n.Z)(this, "_symbol2Container", void 0), (0, n.Z)(this, "_symbol3", void 0), (0, n.Z)(this, "_symbol4", void 0), (0, n.Z)(this, "_symbol5", void 0), (0, n.Z)(this, "_symbol5Container", void 0), (0, n.Z)(this, "_textureAtlas", void 0), (0, n.Z)(this, "foreground1", void 0), (0, n.Z)(this, "foreground2", void 0);
                        var t = this.game.i18n.t("PaytableSectionWildTitle");
                        this._sectionTitle = new fo(t.toUpperCase()), this._sectionTitle.position.set(0, 0), this._textureAtlas = this.game.loader.getAsset("symbols_static"), this._symbol1 = new Po("wild"), this._symbol1.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this._symbol1.withoutPayout(), this._sectionParagraph1 = new bo(this.game.i18n.t("PaytableSectionWildContent1")), this._sectionParagraph1.position.set(this._symbol1.x + this._symbol1.width, this._sectionTitle.y + this._sectionTitle.height + 30), this._sectionParagraph1.setTagStyle("default", {
                            wordWrapWidth: 690
                        }), this.foreground1 = $.j.from(Co), this.foreground1.width = 329, this.foreground1.height = 361, this._symbol2 = new $.j(this.game.loader.getAsset("flag4")), this._symbol2.position.set(28, 44), this._symbol2Container = new Q.W2, this._symbol2Container.addChild(this.foreground1), this._symbol2Container.addChild(this._symbol2), this._symbol2Container.position.set(0, this._symbol1.y + this._symbol1.height + 30), this._sectionParagraph2 = new bo(this.game.i18n.t("PaytableSectionWildContent2")), this._sectionParagraph2.position.set(this._symbol2Container.x + this._symbol2Container.width + 28, this._symbol1.y + this._symbol1.height + 30), this._sectionParagraph2.setTagStyle("default", {
                            wordWrapWidth: 690
                        }), this._symbol3 = new To(this.game.loader.getAsset("flag2")), this._symbol3.position.set(0, this._symbol2Container.y + this._symbol2Container.height + 40), this._symbol3.scale.set(.5), this._symbol4 = new To(this.game.loader.getAsset("flag3")), this._symbol4.position.set(260, this._symbol2Container.y + this._symbol2Container.height + 40), this._symbol4.scale.set(.5), this._sectionParagraph3 = new bo(this.game.i18n.t("PaytableSectionWildContent3")), this._sectionParagraph3.position.set(0, this._symbol3.y + this._symbol3.height + 30), this.foreground2 = $.j.from(Co), this.foreground2.width = 329, this.foreground2.height = 361, this._symbol5 = new $.j(this.game.loader.getAsset("flag1")), this._symbol5.position.set(28, 40), this._symbol5Container = new Q.W2, this._symbol5Container.position.set(0, this._sectionParagraph3.height + this._sectionParagraph3.y + 30), this._symbol5Container.addChild(this.foreground2), this._symbol5Container.addChild(this._symbol5), this._sectionParagraph4 = new bo(this.game.i18n.t("PaytableSectionWildContent4")), this._sectionParagraph4.position.set(this._symbol5Container.x + this._symbol5Container.width + 28, this._sectionParagraph3.height + this._sectionParagraph3.y + 30), this._sectionParagraph4.setTagStyle("default", {
                            wordWrapWidth: 690
                        }), this.addChild(this._sectionTitle, this._symbol1, this._sectionParagraph1, this._symbol2Container, this._sectionParagraph2, this._symbol3, this._symbol4, this._sectionParagraph3, this._symbol5Container, this._sectionParagraph4)
                    }
                    updateBet(t) {
                        this._symbol1.updateBet(t)
                    }
                    resize() {
                        this.game.device.desktop || (this.game.device.landscape ? (this._symbol1.scale.set(1.3), this._symbol1.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this._sectionParagraph1.position.set(this._symbol1.x + this._symbol1.width, this._sectionTitle.y + this._sectionTitle.height + 30), this._sectionParagraph1.setTagStyle("default", {
                            wordWrapWidth: 490
                        }), this._symbol2Container.scale.set(1.3), this._symbol2Container.position.set(0, this._symbol1.y + this._symbol1.height + 30), this._sectionParagraph2.position.set(this._symbol2Container.x + this._symbol2Container.width + 28, this._symbol1.y + this._symbol1.height + 30), this._sectionParagraph2.setTagStyle("default", {
                            wordWrapWidth: 490
                        }), this._symbol3.scale.set(.7), this._symbol3.position.set(0, this._symbol2Container.y + this._symbol2Container.height + 60), this._symbol4.scale.set(.7), this._symbol4.position.set(365, this._symbol2Container.y + this._symbol2Container.height + 60), this._sectionParagraph3.position.set(0, this._symbol3.y + this._symbol3.height + 30), this._symbol5Container.scale.set(1.3), this._symbol5Container.position.set(0, this._sectionParagraph3.height + this._sectionParagraph3.y + 30), this._sectionParagraph4.position.set(this._symbol5Container.x + this._symbol5Container.width + 28, this._sectionParagraph3.height + this._sectionParagraph3.y + 30), this._sectionParagraph4.setTagStyle("default", {
                            wordWrapWidth: 490
                        })) : (this._symbol1.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this._symbol1.scale.set(1.9), this._sectionParagraph1.position.set(0, this._symbol1.y + this._symbol1.height + 30), this._sectionParagraph1.setTagStyle("default", {
                            wordWrapWidth: 390
                        }), this._symbol2Container.scale.set(1.9), this._symbol2Container.position.set(0, this._sectionParagraph1.y + this._sectionParagraph1.height + 30), this._sectionParagraph2.position.set(0, this._symbol2Container.y + this._symbol2Container.height + 30), this._sectionParagraph2.setTagStyle("default", {
                            wordWrapWidth: 390
                        }), this._symbol3.scale.set(1), this._symbol3.position.set(0, this._sectionParagraph2.y + this._sectionParagraph2.height + 60), this._symbol4.scale.set(1), this._symbol4.position.set(500, this._sectionParagraph2.y + this._sectionParagraph2.height + 60), this._sectionParagraph3.position.set(0, this._symbol3.y + this._symbol3.height + 30), this._symbol5Container.scale.set(1.9), this._symbol5Container.position.set(0, this._sectionParagraph3.height + this._sectionParagraph3.y + 30), this._sectionParagraph4.position.set(0, this._symbol5Container.height + this._symbol5Container.y + 30), this._sectionParagraph4.setTagStyle("default", {
                            wordWrapWidth: 390
                        })))
                    }
                }
                ...
                class qo extends Lo {
                    constructor() {
                        super(), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "backgroundContent", void 0), (0, n.Z)(this, "betValue", void 0), (0, n.Z)(this, "buyFor", void 0), (0, n.Z)(this, "buyValue", void 0), (0, n.Z)(this, "featureButton", void 0), (0, n.Z)(this, "freespinsText", void 0), (0, n.Z)(this, "header", void 0), (0, n.Z)(this, "label", void 0), (0, n.Z)(this, "labelCount", void 0), (0, n.Z)(this, "onBet", void 0), (0, n.Z)(this, "onPress", void 0), this.position.set(1690, 280), this.onPress = new(x()), this.backgroundContent = this.addChild(new Q.W2), this.backgroundContent.renderable = !1, this.background = this.backgroundContent.addChild(new ms(this.game.loader.getAsset("assets/images/effects/flag/skeleton.json"))), this.background.position.set(-1690, -280), this.label = this.backgroundContent.addChild(new $.j(this.game.loader.getAsset("risk_textures", "head"))), this.label.position.set(0, -80), this.header = this.label.addChild(new Vo({
                            default: {
                                fontSize: 22
                            }
                        })), this.labelCount = this.label.addChild(new v.Xz("", {
                            fontName: "WinFont"
                        })), this.labelCount.anchor.x = .5, this.labelCount.scale.set(.4), this.labelCount.text = "10", this.labelCount.letterSpacing = -10, this.freespinsText = this.backgroundContent.addChild(new No({
                            default: {
                                fontSize: 30
                            }
                        })), this.buyFor = this.backgroundContent.addChild(new Wo({
                            default: {
                                fill: "#ffce46",
                                fontSize: 21,
                                wordWrapWidth: 220
                            }
                        })), this.buyValue = this.backgroundContent.addChild(new Io({
                            default: {
                                fontSize: 35
                            }
                        ...
                        })), this.featureButton = this.backgroundContent.addChild(new $.j(this.game.loader.getAsset("risk_textures", "ex" === this.game.i18n.language ? "btn-get" : "btn_buy"))), this.featureButton.position.set(6, 370), this.featureButton.cursor = "pointer", this.featureButton.interactive = !1, this.game.interaction.click(this.featureButton, (() => {
                    ...
                    show(t) {
                        if (this.game.store.get("isRiskNBuy") && (super.show(t), this.visible)) {
                            ...
                            }), 150), this.background.play(this.game.device.portrait ? "show_mobile" : "show").then((() => {
                                this.background.play(this.game.device.portrait ? "stati_mobile" : "static")
                            })), e ? (this.buyFor.hide(), this.buyValue.hide(), this.header.show(), this.featureButton.texture = this.game.loader.getAsset("risk_textures", "ex" === this.game.i18n.language ? "btn-play" : "btn_risk"), this.betValue.text = "".concat(Dt.helpers.toMoneySS(this.game.betLevel.toCoins())), this.labelCount.text = e.freespins, this.label.position.set(-40, 60), this.header.position.set(92, -32), this.labelCount.position.set(96, -20), this.freespinsText.position.set(52, 206), this.buyFor.position.set(55, 180), this.buyValue.position.set(55, this.buyFor.y + this.buyFor.height), this.onBet.position.set(55, 265), this.betValue.position.set(55, this.onBet.y + this.onBet.height), this.featureButton.position.set(-17, 420)) : (this.buyFor.show(), this.buyValue.show(), this.header.hide(), this.featureButton.texture = this.game.loader.getAsset("risk_textures", "ex" === this.game.i18n.language ? "btn-get" : "btn_buy"), this.buyValue.text = "".concat(Dt.helpers.toMoneySS(i.bet)), this.betValue.text = "".concat(Dt.helpers.toMoneySS(this.game.betLevel.toCoins())), this.labelCount.text = i.freespins, this.label.position.set(-40, -30), this.labelCount.position.set(96, -20), this.freespinsText.position.set(52, 116), this.buyFor.position.set(55, 165), this.buyValue.position.set(55, this.buyFor.y + this.buyFor.height), this.onBet.position.set(55, 274), this.betValue.position.set(55, this.onBet.y + this.onBet.height), this.featureButton.position.set(-17, 420)), this.resize()
                        }
                    }
                    hide() {
                    ...
                    resize() {
                        this.game.device.desktop || this.game.device.landscape ? (this.scale.set(1), this.position.set(1690, 280), this.game.device.desktop || (this.scale.set(1.3), this.game.leftHand.enabled ? this.position.set(1630, 180) : this.position.set(148, 180))) : (this.scale.set(1.5), this.position.set(750, 230))
                    }
                }
                ...
                class en extends(Vt(Q.W2)) {
                    constructor(t) {
                        var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [];
                        super(), (0, n.Z)(this, "lines", void 0), (0, n.Z)(this, "points", new Map), this.lines = t.map((t => this.addChild(new $o(t)))), this.game.device.desktop && e.map((t => this.points.set(t.line, t.position.map((e => {
                            var i = this.addChild(new tn(t.line));
                ...
                class nn {
                    ...
                    show(t) {
                        ...
                        return new Promise((i => {
                            ...
                            var s = Dt.store.get("reward:wildReel"),
                                o = !1;
                            s.forEach((function(t) {
                                "WRRESPIN2" == t.type && 1 == t.new && (o = !0)
                            })), o ? (this.textValue.text = "", this.textDescription.texture = Dt.loader.getAsset("respinsText"), this.textDescription.pivot.set(this.textDescription.width / 2, 0), this.container.alpha = 0) : t < 1 ? (this.textValue.text = "", this.textDescription.texture = Dt.loader.getAsset("textLastFreeSpin"), this.textDescription.pivot.set(this.textDescription.width / 2, 0), this.timeline.set(this.container, {
                                pixi: {
                                    y: e,
                                    alpha: 0,
                                    scale: 1
                ...
                const rn = class extends an {
                    ...
                    get isStop() {
                        return super.isStop || Dt.store.get("free:isFree", !1) || Dt.store.get("free:isEnd", !1) || this.slot.wildReels.isRespin()
                    }
                    stop() {
                    ...
                    _wildReelReward() {
                        var t = this;
                        return (0, o.Z)((function*() {
                            Dt.store.get("reward:wildReel").length > 0 && t.slot.wildReels.animate()
                        }))()
                    }
                    allPayment(t) {
                        var e = this;
                        return (0, o.Z)((function*() {
                            ...
                            for (var i = 0, s = t.length; i < s; i++) {
                                var o = t[i];
                                e._wins.push(o), e._runSymbolAnimation(o, !1), e._wildReelReward()
                            }
                    ...
                    scatterPayment(t) {
                        var e = this;
                        return (0, o.Z)((function*() {
                            if (e.slot.wildReels.checkWin(), Dt.action.emit("sound:scatterWin"), e.slot.lines.hide(), e.slot.reels.forEach((t => t.overlay())), Dt.store.set("scatter:lineWin", 0), e._runSymbolAnimation(t, !0, "free"), e._showFrame(t, "win"), Dt.store.get("free:winAdditional", !1)) {
                            ...
                            } else yield Dt.delay(Ni.get("reward_scatter"))
                        }))()
                    }
                    complete() {
                    ...
                    _flush() {
                        var t = !0,
                            e = e => {
                                ...
                                var i = this._wins[e];
                                this._runSymbolAnimation(i), this.slot.wildReels.flush(), t && this._showLineText(i), this.slot.lines.show([i]), this._showFrame(i, "end")
                            },
                            i = 0;
                    ...
                    _showFrame(t, e) {
                        ...
                        i.forEach(((t, e) => {
                            if (-1 !== t) this._findSymbol(e, t).getData()
                        }))
                    }
                    _findSymbol(t, e) {
                    ...
                    _runSymbolAnimation(t) {
                        ...
                        for (var s = Dt.store.get("reward:wildReel"), o = 0; o < e.length; o++)
                            if (-1 !== e[o]) {
                                var n = void 0,
                                    a = void 0;
                                if (s.length > 0 && s.forEach((function(t) {
                                        t.pos[0] === o && ("MULTIPLIER2" === t.type || "FREE" === t.type ? a = t.pos[1] : n = o)
                                    })), n !== o) {
                                    var r = e[o];
                                    if (r !== a) this._findSymbol(o, r).playAnimation(i)
                                }
                            }
                    }
                    _showLineText(t) {
                ...
                function hn() {
                    var t = new Q.W2,
                        e = [];
                    return Dt.action.on("symbol:playAnimation", ((i, s, o, n) => {
                        if (! function(t, i) {
                            ...
                            if (n.assetName) {
                                var a = new ms(Dt.loader.getAsset(n.assetName));
                                if (a.name = n.assetName, a.alpha = 1, a.position.set(i, s), n.skin) {
                                    var r = a.skeleton;
                                    r.setSkin(null), r.setSkinByName(n.skin)
                                }
                                if (t.addChild(a), "string" == typeof n.effectName) a.play(n.effectName, !1);
                                else {
                                    var h = n.effectName[n.type] || n.effectName.normal;
                                    a.play(h, !1)
                                }
                            } else {
                                var l = new $.j(n.texture);
                                l.alpha = 1, l.position.set(i, s), t.addChild(l)
                            }
                ...
                class cn {
                    constructor() {
                        (0, n.Z)(this, "container", void 0), (0, n.Z)(this, "description", void 0), (0, n.Z)(this, "timeline", void 0), (0, n.Z)(this, "resolveTimeline", void 0), this.container = new Q.W2, this.container.name = "RespinsText", this.container.alpha = 0, this.description = new $.j(Dt.loader.getAsset("respinsText")), this.container.addChild(this.description), this.description.position.set(0, 80), this.timeline = new C({
                            onComplete: () => {
                    ...
                    show(t) {
                        var e = this.container.y + 50;
                        return new Promise((t => {
                            this.resolveTimeline = t, this.container.pivot.set(this.container.width / 2, this.container.height / 2), this.timeline.set(this.container, {
                                pixi: {
                                    alpha: 0,
                                    y: e
                                }
                ...
                function An(t, e, i) {
                    var s = !1,
                        o = "default",
                        n = Dt.config.get("slot.layout.".concat(o, "[").concat(i, "]"), null);
                    if (!n) throw new Error("Symbol data not found");
                    var a = new $.j(Dt.loader.getAsset(n.textureAtlas, n.assetName));

                    function r() {
                        n.animation && (Dt.action.emit("symbol:stopAnimation", n.animation), s && (a.alpha = pn))
                    }
                    return a.position.set(t, e), Object.assign(a, {
                        ...
                        getData: () => n,
                        playAnimation(t) {
                            s = !0, a.alpha = gn, Dt.action.emit("symbol:playAnimation", a.x, a.y, a, un(un({}, n.animation), {}, {
                                type: t,
                                texture: a.texture
                            }))
                        },
                        ...
                        replaceTexture(t) {
                            n = Dt.config.get("slot.layout.".concat(o, "[").concat(t, "]"), null), a.texture = Dt.loader.getAsset(n.textureAtlas, n.assetName)
                        }
                    })
                }
                class vn extends Q.W2 {
                    constructor(t, e) {
                    ...
                    _setup() {
                        ...
                        for (var i = 0, s = this._nReel.length; i < s; i++) {
                            var [o, n] = this.symbolsPositions[i], a = An(o, n, 0 === i || i === s - 1 ? this._nReel[i] : this._reel[i - 1]);
                    ...
                    _spin() {
                        if (this._flip(), this.isStop)
                            ...
                            } else this.y = 0, this.children[0].y = this._startY, this._updateVisibleSymbols(), !1 !== this.children[1].visible && Dt.action.emit("wheel:stop_down"), this._spinTween.pause(), this._endTween.restart()
                    }
                    _flip() {
                ...
                function fn() {
                    ...
                    s.name = "changeCoins";
                    var n, a = new u.TC;
                    a.beginFill(0), a.drawRect(-170, 0, 1470, 831), a.endFill();
                    for (var r = 0; r < 5; r++)(n = new ms(Dt.loader.getAsset("flagAnimation"))).position.set(bn[r][0], bn[r][1] - 27), n.alpha = 0, e.addChild(n);
                    return t.addChild(e), t.addChild(i), t.addChild(s), {
                        container: t,
                        resize(e, i) {
                            "phone" === e && "portrait" === i ? (t.mask = a, t.addChild(a)) : (t.mask = null, t.removeChild(a))
                        },
                        changeStart: t => (0, o.Z)((function*() {
                            var e = Dt.store.get("reward:wildReel"),
                                o = Dt.store.get("reward:lines", []);
                            if (!(e <= 0)) {
                                var n = !1;
                                if (e.forEach((function(t) {
                                    ...
                                    e.forEach((function(e, n) {
                                        if ("MULTIPLIER2" == e.type || "FREE" == e.type) {
                                            var h = t[e.pos[0]].children[e.pos[1] + 1],
                                                l = new ms(Dt.loader.getAsset("wildEffect"));
                                            "MULTIPLIER2" == e.type ? l.changeSkin("wild_x2") : l.changeSkin("wild_free"), i.addChild(l), "FREE" == e.type && (l.win = 1), l.x = h.x, l.y = h.y, l.play("transform", !1), h.visible = !1, o.forEach((function(t) {
                                                t.pos[e.pos[0]] === e.pos[1] && "MULTIPLIER2" == e.type && (l.win = 1)
                                            })), setTimeout((() => {
                                                var t = Dt.store.get("free:left", 0),
                                                    e = Dt.store.get("free:scattersFree", 0);
                                                Dt.action.emit("free:updateLeft", t - e)
                                            }), 1500), Dt.action.emit("wildReels:plusFree"), Dt.action.emit("sound:wildCoin")
                                        } else if ("MULTIPLIER2" !== e.type && "FREE" !== e.type && !0 === e.new) {
                                            r = 1200;
                                            var c = new ms(Dt.loader.getAsset("wildEffect"));
                                            c.changeSkin("wild_big");
                                            var d = t[e.pos[0]].children[e.pos[1] + 1];
                                            t[e.pos[0]].children[e.pos[1] + 1].visible = !1, c.position.set(d.x, d.y), c.play("transform", !1), !0 === e.new && (s.addChild(c), a = !0)
                                        }
                                    })), !0 === a && Dt.action.emit("sound:changeWild"), yield Dt.delay(r)
                                }
                            }
                        }))(),
                        initShow: t => (0, o.Z)((function*() {
                            Dt.store.get("reward:lines", []);
                            Dt.store.get("reward:wildReel").forEach((function(s, o) {
                                if ("MULTIPLIER2" === s.type || "FREE" === s.type) {
                                    var n = t[s.pos[0]].children[s.pos[1] + 1],
                                        a = new $.j;
                                    "MULTIPLIER2" === s.type ? a.texture = Dt.loader.getAsset("flag1") : a.texture = Dt.loader.getAsset("flag4"), i.addChild(a), a.x = n.x, a.y = n.y, n.visible = !1
                                } else {
                                    var r = e.children[s.pos[0]];
                                    r.alpha = 1, r.y = 0, "WILDREEL" == s.type ? r.changeSkin("wild_reel") : "WILDREEL2" == s.type ? r.changeSkin("wild_reel_x2") : "WRRESPIN" == s.type ? r.changeSkin("wild_reel_respin") : "WRRESPIN2" == s.type && r.changeSkin("wild_reel_respin_x2"), r.play("static", !0), r.active = 1, t[s.pos[0]].children.forEach((function(t) {
                                        t.visible = !1
                                    }))
                                }
                            })), Dt.action.emit("initShowWildFlag"), yield Dt.delay(1e3)
                        }))(),
                        show: t => (0, o.Z)((function*() {
                            Dt.store.get("reward:wildReel").forEach((function(i, s) {
                                if ("MULTIPLIER2" !== i.type && "FREE" !== i.type) {
                                    var o = Dt.store.get("reward:lines", []),
                                        n = e.children[i.pos[0]];
                                    if (n.active) return;
                                    "WILDREEL" == i.type ? n.changeSkin("wild_reel") : "WILDREEL2" == i.type ? n.changeSkin("wild_reel_x2") : "WRRESPIN" == i.type ? n.changeSkin("wild_reel_respin") : "WRRESPIN2" == i.type && n.changeSkin("wild_reel_respin_x2"), k.fromTo(n, .5, {
                                        pixi: {
                                            alpha: 0,
                                            y: -30
                                        }
                                    ...
                                    }), n.play("static", !0), n.active = 1, t[i.pos[0]].children.forEach((function(t) {
                                        t.visible = !1
                                    })), o.forEach((function(t, s) {
                                        -1 !== t.pos[s] && (e.children[i.pos[0]].win = 1)
                                    }))
                                }
                            })), yield Dt.delay(1100)
                        }))(),
                        showAfterFree(t) {
                            Dt.store.get("reward:preWilds", []).forEach((function(s, o) {
                                if ("MULTIPLIER2" == s.type) {
                                    var n = t[s.pos[0]].children[s.pos[1] + 1],
                                        a = new ms(Dt.loader.getAsset("wildEffect"));
                                    a.changeSkin("wild_x2"), i.addChild(a), a.x = n.x, a.y = n.y, a.play("static", !0), n.visible = !1
                                } else {
                                    var r = e.children[s.pos[0]];
                                    r.alpha = 1, r.y = -27, "WILDREEL" == s.type ? r.changeSkin("wild_reel") : "WRRESPIN" == s.type && r.changeSkin("wild_reel_respin"), r.play("static", !0), r.active = 1, t[s.pos[0]].children.forEach((function(t) {
                                        t.visible = !1
                                    }))
                                }
                            }))
                        ...
                        animate() {
                            var t = Dt.store.get("reward:lines", []);
                            Dt.store.get("reward:wildReel").forEach((function(s, o) {
                                "WILDREEL" == s.type || "WILDREEL2" == s.type ? e.children.forEach((function(e, i) {
                                    if (1 === e.active) {
                                        var s = !1;
                                        t.forEach((t => {
                                            -1 !== t.pos[i] && (s = !0)
                                        })), s ? e.play("win", !1).then((() => e.play("static", !1))) : e.alpha = .3
                                    }
                                })) : "WRRESPIN" == s.type || "WRRESPIN2" == s.type ? (t.forEach((function(t) {
                                    t.pos.forEach((function(i, o) {
                                        -1 !== t.pos[o] && (e.children[s.pos[0]].win = 1)
                                    }))
                                ...
                                }))) : "MULTIPLIER2" == s.type ? i.children.forEach((function(t) {
                                    1 === t.win ? t.play("win", !1) : t.alpha = .3
                                })) : "FREE" == s.type && i.children.forEach((function(t) {
                                    t.play("win", !1)
                                }))
                            }))
                        },
                        flush() {
                            var t = Dt.store.get("reward:lines", []);
                            Dt.store.get("reward:wildReel").forEach((function(i, s) {
                                "WILDREEL" == i.type || "WILDREEL2" == i.type ? e.children.forEach((function(e, i) {
                                    if (1 === e.active) {
                                        var s = !1;
                                        t.forEach((t => {
                                            -1 !== t.pos[i] && (s = !0)
                                        })), s ? e.play("static", !1) : e.alpha = .3
                                    }
                                })) : "WRRESPIN" != i.type && "WRRESPIN2" != i.type || (t.forEach((function(t) {
                                    t.pos.forEach((function(s, o) {
                                        -1 !== t.pos[o] && (e.children[i.pos[0]].win = 1)
                                    }))
                                })), e.children.forEach((function(e, i) {
                                    if (1 === e.active) {
                                        var s = !1;
                        ...
                        animatePlusFree: t => (0, o.Z)((function*() {
                            var t = Dt.store.get("reward:wildReel"),
                                e = Dt.store.get("reward:lines", []),
                                s = !1;
                            t.forEach((function(t, e) {
                                "FREE" == t.type && (s = !0)
                            })), e.length > 0 || s && (t.forEach((function(t, e) {
                                "FREE" == t.type && i.children.forEach((function(t) {
                                    t.play("win", !0)
                                }))
                            })), yield Dt.delay(1e3))
                        }))(),
                        stopAnimation() {
                            Dt.store.get("reward:wildReel").forEach((function(t, s) {
                                "WILDREEL" == t.type || "WILDREEL2" == t.type ? e.children.forEach((function(t) {
                                    1 === t.active && t.play("static", !1)
                                })) : "WRRESPIN" == t.type || "WRRESPIN2" == t.type ? e.children.forEach((function(t) {
                                    1 === t.active && (t.play("static", !1), t.alpha = 1)
                                })) : "MULTIPLIER2" != t.type && "FREE" != t.type || i.children.forEach((function(t) {
                                    t.play("static", !1)
                                }))
                            }))
                        },
                        hide(t) {
                            ...
                            if (s.forEach(function() {
                                    var s = (0, o.Z)((function*(s) {
                                        if ("WRRESPIN" != s.type && "WRRESPIN2" != s.type || 1 != s.new)
                                            if ("WILDREEL" != s.type && "WILDREEL2" != s.type || 1 != e.children[s.pos[0]].active) {
                                                if ("MULTIPLIER2" == s.type || "FREE" == s.type) {
                                                    var o = t[s.pos[0]].children[s.pos[1] + 1];
                                                    i.removeChildren(), o.visible = !0
                                                }
                                            } else e.children[s.pos[0]].alpha = 0, e.children[s.pos[0]].win = 0, e.children[s.pos[0]].active = 0, t[s.pos[0]].children.forEach((function(t) {
                                                t.visible = !0
                                            }));
                                        else n = !0
                                    }));
                                ...
                                s.forEach(function() {
                                    var i = (0, o.Z)((function*(i, s) {
                                        "WRRESPIN" != i.type && "WRRESPIN2" != i.type || 1 != e.children[i.pos[0]].active || (e.children[i.pos[0]].alpha = 0, e.children[i.pos[0]].win = 0, e.children[i.pos[0]].active = 0, t[i.pos[0]].children.forEach((function(t) {
                                            t.visible = !0
                                        })), a = !0)
                                    }));
                                    return function(t, e) {
                                ...
                                }()), !0 === a && (Dt.action.emit("wild:respinEnd"), a = !1)
                            }
                        },
                        hideFree(t) {
                            Dt.store.get("reward:wildReel").forEach((function(s, o) {
                                if ("WRRESPIN" == s.type || "WRRESPIN2" == s.type) e.children[s.pos[0]].alpha = 0, e.children[s.pos[0]].win = 0, t[s.pos[0]].children.forEach((function(t) {
                                    t.visible = !0
                                }));
                                else if ("WILDREEL" == s.type || "WILDREEL2" == s.type) e.children[s.pos[0]].alpha = 0, e.children[s.pos[0]].win = 0, t[s.pos[0]].children.forEach((function(t) {
                                    t.visible = !0
                                }));
                                else if ("MULTIPLIER2" == s.type || "FREE" == s.type) {
                                    var n = t[s.pos[0]].children[s.pos[1] + 1];
                                    i.removeChildren(), n.visible = !0
                                }
                            }))
                        },
                        isRespin() {
                            ...
                            return t.forEach((function(t) {
                                "WRRESPIN" != t.type && "WRRESPIN2" != t.type || 1 != t.new || (e = !0)
                            })), e || Dt.action.emit("respin:end"), e
                        },
                        isRespinFeature() {
                            var t = Dt.store.get("reward:wildReel"),
                                e = !1;
                        ...
                        willShow() {
                            var t = Dt.store.get("reward:wildReel"),
                                e = !1;
                            return t.forEach((function(t) {
                                1 == t.new && "MULTIPLIER2" !== t.type && "FREE" !== t.type && (e = !0)
                            })), e
                        },
                        restoreAlpha() {
                            var t = Dt.store.get("reward:wildReel"),
                            ...
                            t.forEach((function(t) {
                                "WRRESPIN" != t.type && "WRRESPIN2" != t.type || 1 != t.new || (i = !0)
                            })), i && e.children.forEach((function(t, e) {
                                1 === t.active && (t.alpha = 1)
                            }))
                        },
                        clearTransform() {
                            s.removeChildren()
                ...
                class wn extends sn {
                    constructor() {
                        super(), (0, n.Z)(this, "animation", void 0), (0, n.Z)(this, "lines", void 0), (0, n.Z)(this, "reels", void 0), (0, n.Z)(this, "reelsBgContainer", void 0), (0, n.Z)(this, "reelsContainer", void 0), (0, n.Z)(this, "respinsText", void 0), (0, n.Z)(this, "scatterWaiting", void 0), (0, n.Z)(this, "slotData", void 0), (0, n.Z)(this, "stopReelCounter", void 0), (0, n.Z)(this, "symbolsPositions", void 0), (0, n.Z)(this, "textExtraFree", void 0), (0, n.Z)(this, "textFreeLeft", void 0), (0, n.Z)(this, "textLineWin", void 0), (0, n.Z)(this, "textTotalWin", void 0), (0, n.Z)(this, "wildReels", void 0), this.pivot.set(710, 40), this.reels = [], this.symbolsPositions = this.game.config.get("slot.symbolsPositions", []), this.animation = new rn(this), this.stopReelCounter = 0, this.init(), this.setupEvents()
                    }
                    createGradientMask(t, e) {
                        var i = document.createElement("canvas"),
                            s = i.getContext("2d"),
                            o = s.createLinearGradient(0, 0, 0, e - 55);
                        return i.width = t, i.height = e, o.addColorStop(0, "rgba(255, 255, 255, 0.0)"), o.addColorStop(.05, "rgba(255, 255, 255, 1.0)"), o.addColorStop(.95, "rgba(255, 255, 255, 1.0)"), o.addColorStop(1, "rgba(255, 255, 255, 0.0)"), s.fillStyle = o, s.fillRect(0, 0, t, e - 55), new c.xE(c.VL.from(i))
                    }
                    createMask() {
                        if (this.game.device.desktop && it.isWebGLSupported()) {
                            var t = this.createGradientMask(this.game.config.get("slot.width"), this.game.config.get("slot.height") + 60),
                                e = new $.j(t);
                            return e.position.y = 0, e
                        }
                        var i = new u.TC;
                        return i.beginFill(16711680, .8), i.drawRect(0, 0, this.game.config.get("slot.width"), this.game.config.get("slot.height")), i.endFill(), i
                    }
                    init() {
                        var t, e, i = this.createMask();
                        this.reelsContainer = new Q.W2, this.reelsContainer.mask = i, this.reelsContainer.addChild(i), this.reelsBgContainer = new Q.W2;
                        for (var s, n, a, r = this.game.config.get("slot.size[0]"), h = 0; h < r; h++) {
                            var l = this.symbolsPositions[h],
                                c = new vn(h, l);
                            this.reels.push(c), this.reelsContainer.addChild(c);
                            var d = new $.j(this.game.loader.getAsset("wheelBg"));
                            d.x = l[0][0], this.reelsBgContainer.addChild(d)
                        }
                        this.slotData = {
                            reels: this.reels.map((t => t.visibleSymbols)),
                            lines: null !== (t = null === (e = this.game.server) || void 0 === e ? void 0 : e.response.lines) && void 0 !== t ? t : []
                        }, this.scatterWaiting = (s = this.slotData, n = [], (a = new Q.W2).name = "scatterWaitingContainer", s.reels.forEach(((t, e) => {
                            n.push([]), t.forEach((t => {
                                var i = new ms(Dt.loader.getAsset("scatterWinEffect"));
                            ...
                            play: (t, e, i) => (0, o.Z)((function*() {
                                ...
                                s.forEach((function(e, i) {
                                    "MULTIPLIER2" !== e.type && "FREE" !== e.type && "WRRESPIN" !== e.type && "WRRESPIN2" !== e.type || t !== e.pos[0] || e.new || (o = !1)
                                }));
                                try {
                                    if (o) {
                                        var a = n[t][e],
                                            r = i[t].children[e + 1];
                                        r.renderable = !1, a.renderable = !0, yield a.play("waiting", !1), a.renderable = !1, r.renderable = !0
                                    }
                                } catch (t) {
                                    return console.error(t), t
                                }
                            }))()
                        }), this.lines = new en(this.slotData.lines.map((t => ({
                            color: 15444736,
                            width: 4,
                            padding: 100,
                            points: t.map(((t, e) => {
                        ...
                        })))), this.wildReels = fn(), this.textFreeLeft = new nn, this.textFreeLeft.container.position.set(712.5, 650), this.textTotalWin = new on(.8), this.textTotalWin.position.set(712.5, 650), this.respinsText = new cn, this.respinsText.container.position.set(712.5, 640), this.textLineWin = new ln, this.textExtraFree = new Jo, this.textExtraFree.value.scale.set(.6), this.textExtraFree.description.y = 80, this.textExtraFree.position.set(712.5, 640), this.addChild(this.reelsBgContainer), this.addChild(this.reelsContainer), this.addChild(this.lines), this.addChild(hn()), this.addChild(this.wildReels.container), this.addChild(this.textLineWin.container), this.addChild(this.scatterWaiting.getContainer()), this.addChild(this.textTotalWin), this.addChild(this.respinsText.container), this.addChild(this.textExtraFree), this.addChild(this.textFreeLeft.container)
                    }
                    setupEvents() {
                        this.game.action.on("state:ready_enter", this._onReadyEnter, this), this.game.action.on("state:spin_enter", this._onSpinEnter, this), this.game.action.on("state:stop_enter", this._onStopEnter, this), this.game.action.on("free:start", (() => {
                            this.animation.stop(), this.wildReels.enterFree(), this.reels.forEach(((t, e) => {
                                var i = this.game.store.get("reward:fsReels", []);
                                t.update(i[e])
                            }))
                        })), this.game.action.on("free:stop", (() => {
                            this.animation.stop()
                        })), this.game.action.on("state:finish_enter", this._onFinishEnter, this), this.game.action.on("wheel:stop", this._onStopWheel, this), this.game.action.on("reward:reset", this._onResetReward, this), this.game.action.on("free:stop", this._onFreeStop, this), this.game.action.on("free:start", this._onFreeStart, this), this.game.action.on("free:select_start", (() => {
                            k.fromTo(this, .5, {
                                pixi: {
                                    alpha: 0
                                }
                    ...
                    restoreFreeSpins() {
                        this.alpha = 0, this.showWildReels()
                    }
                    showWildReels() {
                        this.wildReels.initShow(this.reels)
                    }
                    _onFreeStart() {
                        var t = this;
                        return (0, o.Z)((function*() {
                            t.wildReels.hideFree(t.reels)
                        }))()
                    }
                    _onFreeStop() {
                        this.wildReels.hideFree(this.reels), this.wildReels.hide(this.reels), this.wildReels.showAfterFree(this.reels), this.lines.enable(), this.game.store.set("reward:wildReel", this.game.store.get("reward:preWilds"))
                    }
                    _onReadyEnter() {
                        var t = this.game.autoPlay.enabled,
                            e = this.game.store.get("reward:lines", []);
                        if (Vi.isFreespin()) {
                            var i = Ni.get("before_spin_free");
                            this.game.store.get("free:spin_start") && (i = Ni.get("after_free_start")), setTimeout((() => {
                                this.game.action.emit("spin:start")
                            }), i)
                        } else t ? setTimeout((() => {
                            "respin" === this.game.store.get("reward:feature") && this.game.action.emit("respin:start"), this.game.action.emit("spin:start")
                        }), Ni.get("before_spin_auto")) : "respin" === this.game.store.get("reward:feature") && setTimeout((() => {
                            this.game.action.emit("spin:start"), this.game.action.emit("respin:start")
                        }), Ni.get("before_spin_auto"));
                        !t && e <= 0 && this.lines.enable()
                    }
                    updateFreeLeft() {
                        var t = this;
                        return (0, o.Z)((function*() {
                            if (Vi.isFreespin() && !t.wildReels.isFreeRespin()) {
                    ...
                    _onSpinEnter() {
                        var t = this;
                        return (0, o.Z)((function*() {
                            t.game.store.set("free:spin_start", !1), t.wildReels.hide(t.reels), t.wildReels.clearTransform(), t.animation.stop(), t.lines.disable();
                            try {
                                yield t.game.beforeSpin(), (Vi.isFreespin() && t.wildReels.isRespin() && 0 !== t.game.store.get("free:played") || !Vi.isFreespin() && "respin" === t.game.store.get("reward:feature")) && (t.game.action.emit("sound:wildRespin"), t.game.store.set("respin", !0), t.wildReels.restoreAlpha(), yield t.respinsText.show()), t.reels.forEach((t => t.start())), yield t.updateFreeLeft(), yield t.requestSpin(), t.game.state.goTo("stop")
                            } catch (e) {
                    ...
                    _onFinishEnter() {
                        var t = this;
                        return (0, o.Z)((function*() {
                            Vi.set(t.game.store.get("reward:feature")), t.stopReelCounter = 0, t.game.store.get("free:isFree", !1) || Vi.isRespin() || (yield t.game.freeRound.finish()), t.game.autoPlay.enabled ? t.game.checkBalance().then((() => {
                        ...
                        return (0, o.Z)((function*() {
                            try {
                                if (!e.game.store.get("spin:isFast", !1)) {
                                    ...
                                    i > -1 && e.reels[t].children[i + 1].visible && (e.game.action.emit("sound:scatterWheel"), yield e.scatterWaiting.play(t, i, e.reels))
                                }
                    ...
                    resize() {
                        this.game.device.desktop || this.game.device.landscape ? (this.scale.set(1), this.position.set(960, 90), this.game.device.desktop || (this.pivot.x = 655)) : (this.scale.set(1.2 * .5625), this.position.set(540, 292.5), this.pivot.x = 705)
                    }
                }
                class yn extends(Vt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "timeline", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "value", void 0), (0, n.Z)(this, "light", void 0), (0, n.Z)(this, "coins", void 0), (0, n.Z)(this, "onPress", void 0), this.visible = !1, this.interactive = !0, this.onPress = new(x()), this.game.interaction.click(this, (() => this.onPress.dispatch())), this.timeline = new C, this.content = new Q.W2, this.overlay = new u.TC, this.overlay.beginFill(0, .75), this.overlay.drawRect(0, 0, 1920, 1080), this.overlay.endFill(), this.title = new $.j, this.title.anchor.set(.5), this.value = new v.Xz("", {
                            fontName: "WinFont"
                        }), this.value.anchor = .5, this.light = new ms(this.game.loader.getAsset("effectBigWin")), this.light.pivot.set(910, 300), this.light.position.set(0, 0), this.light.alpha = 0, this.coins = new ms(this.game.loader.getAsset("effectBigWin")), this.coins.position.set(-1110, -320), this.coins.alpha = 0, this.content.addChild(this.light), this.content.addChild(this.coins), this.content.addChild(this.title), this.content.addChild(this.value), this.addChild(this.overlay), this.addChild(this.content)
                    }
                    show(t, e) {
                        var i = this;
                        return (0, o.Z)((function*() {
                            ...
                            return new Promise((a => {
                                i.value.alpha = 0, i.content.alpha = 0, i.overlay.alpha = 0, i.timeline.eventCallback("onComplete", (() => {
                                    i.hide(), a()
                                }));
                                var r = {
                                    coins: 0
                                ...
                                i.timeline.to(i.overlay, .35, {
                                    ...
                                    onUpdate: () => {
                                        !o && t === ye && r.coins > e / 2 && (i.title.texture = i.game.loader.getAsset("textGiantWin"), o = !0, i.coins.play("win_giant", !0), i.coins.alpha = 1, k.to(i.value, s / 2, {
                                            pixi: {
                                                scale: n + .2
                                            }
                    ...
                    break () {
                        var t = this.timeline.getLabelTime("break") / this.timeline.totalDuration();
                        t > 0 && this.timeline.progress(t)
                    }
                    resize() {
                        this.game.device.desktop || this.game.device.landscape ? (this.overlay.height = this.game.viewport.height, this.overlay.width = this.game.viewport.width, this.overlay.position.set(0, 0), this.content.scale.set(1), this.content.position.set(this.game.viewport.width / 2, 300), this.light.scale.set(1), this.light.position.set(0, 0), this.coins.scale.set(1), this.coins.position.set(-1110, -320), this.title.scale.set(1), this.value.scale.set(.8), this.value.position.set(0, this.title.height + 50)) : (this.overlay.height = 2 * this.game.viewport.paddingY + this.game.viewport.height, this.overlay.width = 2 * this.game.viewport.paddingX + this.game.viewport.width, this.overlay.position.set(-this.game.viewport.paddingX, 0), this.content.scale.set(.5625), this.content.position.set(this.game.viewport.width / 2, (this.game.viewport.height - 500) / 2), this.light.scale.set(2), this.light.position.set(0, -430), this.coins.scale.set(2), this.coins.position.set(-1400, -1e3), this.title.scale.set(2), this.value.scale.set(.8), this.value.position.set(0, this.title.height + 50))
                    }
                }
                new class extends class extends class extends class {
                    constructor(t) {
                        ...
                        })), Dt = this, et.vB.shared.autoStart = !1, et.vB.shared.stop(), this.config = new rt(_t), this.logger = new Ct, this.rootNode = this.createRootNode(), this.renderer = new Pt, this.i18n = new bt(e), this.helpers = new vt(this.config), this.keyboard = new yt, this.device = new mt(this.renderer), this.viewport = new Ot, this.leftHand = new ut, this.fullscreen = this.device.ios || this.device.iPadPro ? new ct : new dt(this.device), this.visibility = new zt, this.preferences = new Ut, this.sound = new O(this.device, this.visibility, this.preferences), this.state = new Ft, this.store = new rt, this.action = new gt, this.loader = new kt(this.device), this.error = new At, this.interaction = new ft(this.device), this.externalApi = new Wt(this), this.popupManager = new Lt(this.rootNode), this.create(), this.initAnalytics()
                    }
                    initAnalytics() {
                        return (0, o.Z)((function*() {
                            try {
                    ...
                    initPopups() {
                        this.popupManager.add([new Ti, new Pi, new Bi, new Si, new Zi, new Ci, new Ri, new Fi, new Ei, new ki, new Oi])
                    }
                    loadAssets(t) {
                    ...
                    constructor() {
                        super({}), (0, n.Z)(this, "autoPlaySettings", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "betSettings", void 0), (0, n.Z)(this, "bigWinAnimation", void 0), (0, n.Z)(this, "fastStopLayout", void 0), (0, n.Z)(this, "freeOverlay", void 0), (0, n.Z)(this, "gameRules", void 0), (0, n.Z)(this, "menu", void 0), (0, n.Z)(this, "paytable", void 0), (0, n.Z)(this, "slot", void 0), Xi.init(), this.init(Li, Di)
                    }
                    loadTranslations() {
                    ...
                    initViews() {
                        ...
                        super.initViews(), this.background = this.rootNode.addChild(new As), this.slot = this.rootNode.addChild(new wn), this.riskFeature = this.rootNode.addChild(new qo), this.paytable = new Fo(null !== (t = null === (e = this.server) || void 0 === e ? void 0 : e.response.lines) && void 0 !== t ? t : []), this.gameSettings = new Ue, this.config.get("quickSpin.available", !0) && this.gameSettings.addItem(this.createQuickSpinCheckbox()), this.gameSettings.addItem(this.createFullscreenCheckbox()), this.gameSettings.addItem(this.createLeftHandCheckbox()), this.gameSettings.addItem(this.createGameSoundsCheckbox()), this.gameSettings.addItem(this.createBackgroundSoundsCheckbox()), this.gameSettings.addItem(this.createRiskFeatureCheckbox()), this.bigWinAnimation = new yn, this.fastStopLayout = new Te, this.controls = this.device.desktop ? new to : new uo, this.betSettings = this.rootNode.addChild(new Ee), this.betSettings.setBets(this.betLevel.bets, this.betLevel.betCoins), this.betSettings.setPayLines(25), this.betSettings.setBet(this.betLevel.bet), this.autoPlaySettings = this.rootNode.addChild(new ce), this.autoPlaySettings.setAutoPlayCounts(this.autoPlay.counts), this.autoPlaySettings.stopSection.addItem(new Se), this.autoPlaySettings.stopSection.addItem(new be), this.autoPlaySettings.stopSection.addItem(new Ae), this.autoPlaySettings.stopSection.addItem(new ve), this.gameRules = new Ne, this.menu = new Ge, this.menu.addItem(this.loader.getAsset("iconPaytable"), this.paytable), this.menu.addItem(this.loader.getAsset("iconSettings"), this.gameSettings), this.menu.addItem(this.loader.getAsset("iconRules"), this.gameRules), this.rootNode.addChild(this.fastStopLayout), this.rootNode.addChild(this.menu), this.rootNode.addChild(this.controls), this.rootNode.addChild(this.bigWinAnimation), this.freeOverlay = this.rootNode.addChild(new po), this.paytable.updateBet(this.betLevel), this.controls.updateBet(this.betLevel), this.betSettings.on("open", (() => {
                            ...
                            this.riskFeature.hide(), this.riskFeature.updateCurrentBet(this.betLevel.bet), this.autoPlay.enabled && !this.store.get("free:isFree", !1) && "respin" !== this.store.get("reward:feature") && (this.autoPlay.setCount(this.autoPlay.count - 1), this.controls.setAutoPlayCount(this.autoPlay.count)), this.controls.onSpinEnter()
                    ...
                    start() {
                        ...
                        return (0, o.Z)((function*() {
                            var i;
                            t().call(e), Vi.set(e.store.get("reward:feature", zi.Basic));
                            var s = e.store.get("reward:wildReel");
                            if (yield e.freeRound.start(), "respin" === e.store.get("reward:feature") && (yield e.popupManager.show("PopupRestore")), null === (i = e.sound.get("backgroundNormal")) || void 0 === i || i.fade(2), e.state.goTo("setup"), Vi.isFreespin()) {
                                e.slot.restoreFreeSpins();
                                var o = e.store.get("free:left", 0);
                                e.action.emit("free:updateLeft", o), yield e.freeOverlay.show(ao.RESTORE), yield e.delay(200)
                            } else s.length > 0 && (s.map((t => t.new = !0)), e.store.set("reward:wildReel", s), e.slot.showWildReels());
                            e.state.goTo("ready")
                        }))()
                    }
                    reward() {
                        ...
                        return (0, o.Z)((function*() {
                            ...
                            var n = t.store.get("reward:lines", []),
                                ...
                                r = t.store.get("reward:wildReel");
                            if ("respin" !== t.store.get("reward:feature") && t.action.emit("respin:end"), null !== (o = t.bigWin) && void 0 !== o && o.available(t.wallet.coins) && (t.bigWinAnimation.press(i), t.controls.pressButtonSpin(i), yield t.bigWinAnimation.show(t.bigWin.type(t.wallet.coins), t.wallet.coins), t.sound.stopBigWin(), e()), 0 !== t.store.get("reward:wildReel").length && (t.controls.pressButtonSpin(i), yield t.slot.wildReels.changeStart(t.slot.reels), t.slot.wildReels.willShow() && (yield t.slot.wildReels.show(t.slot.reels))), n.length > 0 || t.wallet.scatterCoins ? (t.controls.disableButtonSpin(), a && (t.store.set("scatter:lineWin", 1), n.unshift(a)), t.slot.textTotalWin.once("show", (() => {
                                    t.fastStopLayout.press(s, !1), t.controls.pressButtonSpin(s)
                                })), yield t.slot.animation.allPayment(n), e()) : r.length > 0 && (t.controls.disableButtonSpin(), yield t.slot.wildReels.animatePlusFree()), a.n > 2 && (t.controls.disableButtonSpin(), yield t.slot.animation.scatterPayment(a)), t.store.get("free:isStart", !1) && !t.slot.wildReels.showFreePopup()) {
                                var h = t.store.get("free:left", 0);
                                t.action.emit("free:updateLeft", h), t.beforeFreeSpinsPopup(), yield t.freeOverlay.show(ao.START)
                            } else t.store.get("free:isEnd", !1) && !t.slot.wildReels.isRespin() && (yield t.delay(Ni.get("free_end")), t.beforeFreeSpinsPopup(), yield t.freeOverlay.show(ao.END), yield t.delay(200), t.store.set("free:end", 1));
                    ...
                    checkBalance() {
                        var t = this;
                        return (0, o.Z)((function*() {
                            if (!(t.freeRound.enabled || t.store.get("free:isFree", !1) || Vi.isRespin()) && t.wallet.balance < t.betLevel.toCoins()) {
                                try {
                                    yield t.server.request({
                                        action: "balance"
                    ...
                    beforeSpin() {
                        var t = this;
                        return (0, o.Z)((function*() {
                            t.autoPlay.enabled || Vi.isFreespin() || Vi.isRespin() || (yield t.quickSpin.tryEnable())
                        }))()
                    }
                    afterReelsStop() {
                        !this.store.get("spin:isFast", !1) || this.autoPlay.enabled || Vi.isRespin() || Vi.isFreespin() || this.quickSpin.update()
                    }
                }
            },
            6331: () => {},
    ...
    n.m = s, t = [], n.O = (e, i, s, o) => {
        if (!i) {
            ...
            for (c = 0; c < t.length; c++) {
                for (var [i, s, o] = t[c], r = !0, h = 0; h < i.length; h++)(!1 & o || a >= o) && Object.keys(n.O).every((t => n.O[t](i[h]))) ? i.splice(h--, 1) : (r = !1, o < a && (a = o));
                if (r) {
                    t.splice(c--, 1);
                    var l = s();
                    void 0 !== l && (e = l)
    ...
    }), t), n.o = (t, e) => Object.prototype.hasOwnProperty.call(t, e), e = {}, i = "legioner:", n.l = (t, s, o, a) => {
        if (e[t]) e[t].push(s);
        else {
            var r, h;
            if (void 0 !== o)
        ...
        var e = (e, i) => {
            ...
            i = self.webpackChunklegioner = self.webpackChunklegioner || [];
        i.forEach(e.bind(null, 0)), i.push = e.bind(null, i.push.bind(i))
    })();
    var a = n.O(void 0, [216], (() => n(1469)));
    a = n.O(a)
})();