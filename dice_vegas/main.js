...
(() => {
    var t, e, i, s = {
            2262: (t, e, i) => {
                ...
                class Ve extends(Vt(Q.W2)) {
                    ...
                    addItem(t, e) {
                        var i = this.items.addChild(new _e(t));
                ...
                const Vi = {
                        init() {
                            function t(t) {
                                var e = ot()(t, "win", 0);
                                jt.store.set("reward:win", e), jt.store.set("reward:lines", ot()(t, "lines", [])), jt.store.set("reward:reels", ot()(t, "reels", t.error ? zi : [])), jt.store.set("reward:nReels", ot()(t, "nReels", t.error ? _i : [])), jt.store.set("reward:preReels", ot()(t, "preSpin.reels", [])), jt.store.set("reward:isWin", e > 0), jt.store.set("reward:numberWinSymbol", ot()(t, "winSyms", 0)), jt.store.set("reward:wildReels", ot()(t, "wildReels", []));
                ...
                class Ao extends(Vt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "sectionTitle", void 0), (0, n.Z)(this, "dice_luck", void 0), (0, n.Z)(this, "dice1", void 0), (0, n.Z)(this, "dice2", void 0), (0, n.Z)(this, "dice3", void 0), (0, n.Z)(this, "dice4", void 0), (0, n.Z)(this, "dice5", void 0), (0, n.Z)(this, "dice6", void 0), (0, n.Z)(this, "symbols", void 0), this.sectionTitle = new lo(this.game.i18n.t("PaytableSectionPayoutTitle").toUpperCase()), this.dice_luck = new go("hpLuck"), this.dice_luck.position.set(0, this.sectionTitle.y + this.sectionTitle.height + 30), this.dice6 = new go("lp6"), this.dice6.position.set(600, this.sectionTitle.y + this.sectionTitle.height + 30), this.dice5 = new go("lp5"), this.dice5.position.set(0, this.dice_luck.y + this.dice_luck.height + 30), this.dice4 = new go("lp4"), this.dice4.position.set(600, this.dice6.y + this.dice6.height + 30), this.dice3 = new go("lp3"), this.dice3.position.set(0, this.dice5.y + this.dice5.height + 30), this.dice2 = new go("lp2"), this.dice2.position.set(600, this.dice4.y + this.dice4.height + 30), this.dice1 = new go("lp1"), this.dice1.position.set(0, this.dice3.y + this.dice3.height + 30), this.symbols = [this.dice_luck, this.dice6, this.dice5, this.dice4, this.dice3, this.dice2, this.dice1], this.addChild(this.sectionTitle, ...this.symbols)
                    }
                    updateBet(t) {
                        this.symbols.forEach((e => e.updateBet(t)))
                    }
                    resize() {
                        this.game.device.desktop || (this.game.device.landscape ? (this.dice_luck.position.set(0, this.sectionTitle.y + this.sectionTitle.height + 30), this.dice6.position.set(820, this.sectionTitle.y + this.sectionTitle.height + 30), this.dice5.position.set(0, this.dice_luck.y + this.dice_luck.height + 30), this.dice4.position.set(820, this.dice6.y + this.dice6.height + 30), this.dice3.position.set(0, this.dice5.y + this.dice5.height + 30), this.dice2.position.set(820, this.dice4.y + this.dice4.height + 30), this.dice1.position.set(0, this.dice3.y + this.dice3.height + 30)) : (this.dice_luck.position.set(0, this.sectionTitle.y + this.sectionTitle.height + 30), this.dice6.position.set(0, this.dice_luck.y + this.dice_luck.height + 30), this.dice5.position.set(0, this.dice6.y + this.dice6.height + 30), this.dice4.position.set(0, this.dice5.y + this.dice5.height + 30), this.dice3.position.set(0, this.dice4.y + this.dice4.height + 30), this.dice2.position.set(0, this.dice3.y + this.dice3.height + 30), this.dice1.position.set(0, this.dice2.y + this.dice2.height + 30)))
                    }
                }
                class mo extends(Vt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "_sectionParagraph1", void 0), (0, n.Z)(this, "_sectionParagraph2", void 0), (0, n.Z)(this, "_sectionTitle", void 0), (0, n.Z)(this, "_symbol1", void 0), (0, n.Z)(this, "_symbol2", void 0), this._sectionTitle = new lo(jt.i18n.t("PaytableSectionWildTitle").toUpperCase()), this._sectionTitle.position.set(0, 0), this._symbol1 = new go("hpJ"), this._symbol1.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this._symbol1.withoutPayout(), this._sectionParagraph1 = new ro(jt.i18n.t("PaytableSectionWildContent1")), this._sectionParagraph1.position.set(this._symbol1.x + this._symbol1.width, this._sectionTitle.height + this._sectionTitle.y + 30), this._sectionParagraph1.setTagStyle("default", {
                            wordWrapWidth: 690
                ...
                class Do extends fo {
                    ...
                    createMask() {
                        if (this.game.device.desktop && it.isWebGLSupported()) {
                            var t = this.createGradientMask(this.game.config.get("slot.width"), this.game.config.get("slot.height") + 12),
                                e = new $.j(t);
                            return e.position.y = -27, e
                        }
                        var i = new u.TC;
                        return i.beginFill(16711680, .8), i.drawRect(0, 0, this.game.config.get("slot.width"), this.game.config.get("slot.height") - 15), i.endFill(), i.position.y = -10, i
                    }
                    init() {
                        ...
                        }))), this.game.config.get("lines", {}).points), this.textTotalWin = new xo(.9), this.textTotalWin.position.set(730, 700), this.respinsText = new To, this.respinsText.container.position.set(730, 700), this.textLineWin = new Eo, this.stickyWild = function(t) {
                            var e = new Q.W2;
                            e.name = "stickyWilds";
                            var i = t,
                                s = !1;
                                    ...
                                    "respin" === jt.store.get("reward:feature") && (jt.action.emit("sound:joker"), s = !0, a(), h.forEach((s => {
                                        i.reels[s].visibleSymbols.forEach(((i, o) => {
                                            if (i.visible) {
                                                ...
                                                n.changeSkin(i._texture.textureCacheIds[0]), "game" === t ? n.play("wildTransform") : (n.changeSkin("hpJ"), n.play("wildSticky", !0)), n.wheel = s, n.index = o, n.position.set(i.x, i.y), e.addChild(n)
                                            }
                                        ...
                                        t.changeSkin("hpJ"), t.play("wildSticky", !0)
                                    })), n()))
                    ...
                    resize() {
                        this.game.device.desktop || this.game.device.landscape ? (this.scale.set(1), this.position.set(1024, 72)) : (this.scale.set(1.2 * .5625), this.position.set(576, 281.25))
                    }
                }
    ...
    n.m = s, t = [], n.O = (e, i, s, o) => {
    ...
    }), t), n.o = (t, e) => Object.prototype.hasOwnProperty.call(t, e), e = {}, i = "dice_vegas:", n.l = (t, s, o, a) => {
        if (e[t]) e[t].push(s);
        else {
            var h, r;
            if (void 0 !== o)
        ...
        var e = (e, i) => {
            ...
            i = self.webpackChunkdice_vegas = self.webpackChunkdice_vegas || [];
