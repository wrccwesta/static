...
(() => {
    var t, e, i, s = {
            9952: (t, e, i) => {
                ...
                class U {
                    ...
                    readSkeletonData(t, e) {
                        ...
                        var s = i.readString(),
                            o = N(s),
                            n = null;
                        if (o === W.VER38 && (n = new _.SkeletonBinary(new _.AtlasAttachmentLoader(t))), (i = new M.BinaryInput(e)).readInt32(), i.readInt32(), (o = N(s = i.readString())) !== W.VER40 && o !== W.VER41 || (n = new L.SkeletonBinary(new L.AtlasAttachmentLoader(t))), !n) {
                ...
                class z {
                    ...
                    readSkeletonData(t, e) {
                        var i = e.skeleton.spine,
                            s = N(i),
                            o = null;
                        if (s === W.VER37 && (o = new D.SkeletonJson(new D.AtlasAttachmentLoader(t))), s === W.VER38 && (o = new _.SkeletonJson(new _.AtlasAttachmentLoader(t))), s !== W.VER40 && s !== W.VER41 || (o = new L.SkeletonJson(new L.AtlasAttachmentLoader(t))), !o) {
                ...
                class Ne extends(Vt(H.W2)) {
                    ...
                    addSections() {
                        this.content.addChild(new Ie), this.content.addChild(new _e), this.content.addChild(new Le), this.addAutoPlaySection(), this.content.addChild(new Me), this.content.addChild(new We), this.content.addChild(new je)
                    }
                    addAutoPlaySection() {
                ...
                const _i = [...[{
                    ...
                    metadata: {
                        ...
                        audioMetadata: {
                            type: "effects",
                            volume: Di.get("expand_wild_reel"),
                            loop: !1
                        }
                    }
                }, {
                    ...
                    url: "assets/images/slotBackground.png",
                    name: "slotBackground",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                    ...
                    url: "assets/images/effects/spineffect/skeleton.json",
                    ...
                    url: "assets/images/effects/symbols/bear/skeleton.json",
                    name: "effectBear",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/effects/symbols/seal/skeleton.json",
                    name: "effectSeal",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/effects/symbols/walrus/skeleton.json",
                    name: "effectWalrus",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/effects/symbols/fox/skeleton.json",
                    name: "effectFox",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/effects/symbols/common/skeleton.json",
                    name: "effectCommon",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                        ...
                        layout: {
                            default: [{
                                ...
                                animation: {
                                    ...
                                    effectName: {
                                        normal: "win",
                                        freeStart: "win_freespins",
                                        freeStop: "win_freestop"
                                    }
                                }
                            }, {
                                textureAtlas: "symbols_static",
                ...
                class gs extends(Vt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "backgroundLTextureFree", void 0), (0, n.Z)(this, "backgroundLTextureNormal", void 0), (0, n.Z)(this, "backgroundPTextureFree", void 0), (0, n.Z)(this, "backgroundPTextureNormal", void 0), (0, n.Z)(this, "backgroundTextureLandscape", void 0), (0, n.Z)(this, "backgroundTexturePortrait", void 0), (0, n.Z)(this, "featureBackground", void 0), (0, n.Z)(this, "logoFreeSpin", void 0), (0, n.Z)(this, "logoNormal", void 0), this.backgroundLTextureNormal = this.game.loader.getAsset("bgln"), this.backgroundLTextureFree = this.game.loader.getAsset("bglf"), this.backgroundPTextureNormal = this.game.loader.getAsset("bgpn"), this.backgroundPTextureFree = this.game.loader.getAsset("bgpf"), this.backgroundTextureLandscape = this.backgroundLTextureNormal, this.backgroundTexturePortrait = this.backgroundPTextureNormal, this.background = new $.j(this.backgroundTextureLandscape), this.background.name = "background", this.featureBackground = new $.j(this.backgroundLTextureFree), this.featureBackground.name = "featureBackground", this.featureBackground.alpha = 0, this.logoNormal = new $.j(this.game.loader.getAsset("logo")), this.logoNormal.name = "logo", this.logoNormal.anchor.x = .5, this.logoNormal.x = this.background.width / 2, this.logoFreeSpin = new $.j(this.game.loader.getAsset("logo_fs")), this.logoFreeSpin.name = "logo", this.logoFreeSpin.anchor.x = .5, this.logoFreeSpin.x = this.background.width / 2, this.logoFreeSpin.visible = !1, this.addChild(this.background), this.addChild(this.featureBackground), this.addChild(this.logoNormal), this.addChild(this.logoFreeSpin), this.setupEvents()
                    }
                    setupEvents() {
                        this.game.action.on("state:setup_enter", (() => {
                            ...
                            this.logoNormal.visible = !1, this.logoFreeSpin.visible = !0
                        })), this.game.action.on("free:select_start", (() => {
                            this.featureBackground.texture = this.game.device.portrait && !this.game.device.desktop ? this.backgroundPTextureFree : this.backgroundLTextureFree, 0 === this.featureBackground.alpha && (this.logoNormal.visible = !1, this.logoFreeSpin.visible = !0, k.fromTo(this.featureBackground, .5, {
                                pixi: {
                                    alpha: 0
                                }
                            }, {
                ...
                class Ps extends(Vt(H.W2)) {
                    constructor() {
                        ...
                        var e = new ks(c.xE.from(ys), 0);
                        e.width = 12, e.height = 151;
                        var i = new ks(c.xE.from(ys), 4914792);
                ...
                class _s extends Fs {
                    constructor(t) {
                        ...
                        })), this.betLevel = t, this.betLevelText = this.addChild(new Pe("", Ds(Ds({}, Ms.Common), {}, {
                ...
                class to extends Ts {
                    constructor() {
                        ...
                        this.background = $.j.from("data:image/png;base64,"), this.background.alpha = .4, this.background.anchor.set(0, 1), this.background.position.set(0, this.game.viewport.height), this.buttonMenu = new bs, this.buttonMenu.position.set(77, 1013), this.buttonMaxBet = new _s(this.game.betLevel), this.buttonMaxBet.position.set(213, 1013), this.buttonAutoPlay = new ms, this.buttonAutoPlay.position.set(833, 1013), this.buttonQuickSpin = new fs, this.buttonQuickSpin.position.set(1084, 1014), this.buttonSound = new Es, this.buttonSound.position.set(1840, 1012), this.buttonSpin = function() {
                            ...
                            e.name = "buttonSpin", e.hitArea = new X.Rectangle(10, 5, 120, 130);
                            var i = new js(Lt.loader.getAsset("effectSpin")),
                                s = new js(Lt.loader.getAsset("spinButtonEffect"));
                            s.alpha = 0, e.addChild(i), e.addChild(s), i.play("normal", !1), e.onClick.add(n), e.onHover.add((() => {
                                i.play("mouse-in", !1)
                            })), e.onLeave.add((() => {
                                i.play("mouse-out", !1)
                            }));
                            ...
                            function n() {
                                t.handlers(!0) ? t.dispatch() : (Lt.store.get("spin:isSpin", !1) || (i.play("press", !1), s.alpha = 1, s.play("animation")), Lt.action.emit("clickSpin"))
                            }

                            function a() {
                                i.play("inactive", !1), e.disable(), o.disable()
                            }

                            function h() {
                                Vi.isFreespin() || (e.enable(), o.enable(), s.alpha = 0)
                            }
                            ...
                            function c() {
                                o.enable(), Vi.isFreespin() || (e.visible = !0)
                            }
                            return o.onPress.add(n), o.disable(), Lt.action.on("spin:fast", a), Lt.action.on("state:ready_enter", c), Lt.action.on("state:finish_exit", h), Lt.action.on("free:start", r), Lt.action.on("free:restore", r), Lt.action.on("free:stop", (() => {
                                e.visible = !0, e.disable(), o.disable()
                            })), Lt.action.on("free:select_start", l), {
                                container: e,
                                hide() {
                                    e.visible = !1
                                },
                ...
                class uo extends Ts {
                    constructor() {
                        super(), (0, n.Z)(this, "autoPlayButton", void 0), (0, n.Z)(this, "betButton", void 0), (0, n.Z)(this, "buttonAccept", void 0), (0, n.Z)(this, "buttonMenu", void 0), (0, n.Z)(this, "buttonQuickSpin", void 0), (0, n.Z)(this, "buttonSound", void 0), (0, n.Z)(this, "buttonSpin", void 0), (0, n.Z)(this, "onPressButtonSpin", void 0), (0, n.Z)(this, "state", void 0), (0, n.Z)(this, "statusBar", void 0), this.state = no.Normal, this.onPressButtonSpin = new(x()), this.statusBar = new lo, this.statusBar.changeState(this.state), this.game.freeRound.enabled ? (this.statusBar.update({
                        ...
                        })), this.buttonAccept = new vs, this.buttonQuickSpin = new fs, this.autoPlayButton = new ms, this.autoPlayButton.scale.set(1.6), this.betButton = new Fs, this.betButton.disable(), this.betButton.onClick.add((() => this.game.action.emit("clickMaxBet"))), this.game.action.on("update:win", (() => {
                            ...
                            this.game.freeRound.enabled || this.game.store.get("free:isStart", !1) ? (this.statusBar.update({
                                type: oo.Win,
                                value: Vi.isFreespin() ? this.game.wallet.coins : this.game.wallet.totalCoins
                            }), this.statusBar.update({
                                type: oo.TotalWin,
                ...
                class So extends(Vt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "_sectionParagraph", void 0), (0, n.Z)(this, "_sectionTitle", void 0), this._sectionTitle = new fo(this.game.i18n.t("PaytableSectionFreeTitle").toUpperCase()), this._sectionTitle.position.set(0, 0), this._sectionParagraph = new bo(this.game.i18n.t("PaytableSectionFreeContent1") + "\n\n" + this.game.i18n.t("PaytableSectionFreeContent2") + "\n\n" + this.game.i18n.t("PaytableSectionFreeContent3")), this._sectionParagraph.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this.addChild(this._sectionTitle), this.addChild(this._sectionParagraph)
                    }
                    resize() {
                ...
                class Co extends(Vt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "sectionTitle", void 0), (0, n.Z)(this, "symbol10", void 0), (0, n.Z)(this, "symbol9", void 0), (0, n.Z)(this, "symbolA", void 0), (0, n.Z)(this, "symbolBear", void 0), (0, n.Z)(this, "symbolFox", void 0), (0, n.Z)(this, "symbolJ", void 0), (0, n.Z)(this, "symbolK", void 0), (0, n.Z)(this, "symbolQ", void 0), (0, n.Z)(this, "symbolSeal", void 0), (0, n.Z)(this, "symbolWalrus", void 0), (0, n.Z)(this, "symbols", void 0), this.sectionTitle = new fo(this.game.i18n.t("PaytableSectionPayoutTitle").toUpperCase()), this.symbolFox = new ko("fox"), this.symbolFox.position.set(0, this.sectionTitle.y + this.sectionTitle.height + 30), this.symbolBear = new ko("bear"), this.symbolBear.position.set(600, this.sectionTitle.y + this.sectionTitle.height + 30), this.symbolSeal = new ko("seal"), this.symbolSeal.position.set(0, this.symbolFox.y + this.symbolFox.height + 30), this.symbolWalrus = new ko("walrus"), this.symbolWalrus.position.set(600, this.symbolBear.y + this.symbolBear.height + 30), this.symbolA = new ko("a"), this.symbolA.position.set(0, this.symbolSeal.y + this.symbolSeal.height + 30), this.symbolK = new ko("k"), this.symbolK.position.set(600, this.symbolWalrus.y + this.symbolWalrus.height + 30), this.symbolQ = new ko("q"), this.symbolQ.position.set(0, this.symbolA.y + this.symbolA.height + 30), this.symbolJ = new ko("j"), this.symbolJ.position.set(600, this.symbolK.y + this.symbolK.height + 30), this.symbol10 = new ko("10"), this.symbol10.position.set(0, this.symbolQ.y + this.symbolQ.height + 30), this.symbol9 = new ko("9"), this.symbol9.position.set(600, this.symbolJ.y + this.symbolJ.height + 30), this.symbols = [this.symbolFox, this.symbolBear, this.symbolSeal, this.symbolWalrus, this.symbolA, this.symbolK, this.symbolQ, this.symbolJ, this.symbol10, this.symbol9], this.addChild(this.sectionTitle, ...this.symbols)
                    }
                    updateBet(t) {
                ...
                class Po extends(Vt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "_sectionParagraph1", void 0), (0, n.Z)(this, "_sectionParagraph2", void 0), (0, n.Z)(this, "_sectionTitle", void 0), (0, n.Z)(this, "_symbol1", void 0), this._sectionTitle = new fo(this.game.i18n.t("PaytableSectionWildTitle").toUpperCase()), this._sectionTitle.position.set(0, 0), this._symbol1 = new ko("wild"), this._symbol1.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this._symbol1.withoutPayout(), this._sectionParagraph1 = new bo(this.game.i18n.t("PaytableSectionWildContent1")), this._sectionParagraph1.position.set(this._symbol1.x + this._symbol1.width, this._sectionTitle.y + this._sectionTitle.height + 30), this._sectionParagraph1.setTagStyle("default", {
                            wordWrapWidth: 690
                    ...
                    resize() {
                        this.game.device.desktop || (this.game.device.landscape ? (this._symbol1.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this._sectionParagraph1.position.set(this._symbol1.x + this._symbol1.width, this._sectionTitle.y + this._sectionTitle.height + 30), this._sectionParagraph1.setTagStyle("default", {
                            wordWrapWidth: 490
                        }), this._sectionParagraph2.position.set(this._symbol1.x + this._symbol1.width, this._sectionParagraph1.y + this._sectionParagraph1.height + 30), this._sectionParagraph2.setTagStyle("default", {
                            wordWrapWidth: 490
                ...
                class Wo {
                    ...
                    show(t) {
                        ...
                        return new Promise((i => {
                            ...
                            }, this.textDescription.position.set(0, 0), this.textValue.text = "".concat(t), this.textValue.position.set(30 + this.textDescription.x + this.textDescription.width + this.textValue.width / 2, 0), this.container.pivot.set(this.container.width / 2, 0), this.timeline.set(this.container, {
                                pixi: {
                                    alpha: 0
                                }
                            }).to(this.container, .5, {
                ...
                const Io = class extends Mo {
                    ...
                    wildReelPayment(t) {
                        ...
                        return (0, o.Z)((function*() {
                            if (Vi.isFreespin()) {
                                ...
                                var s = t.reduce(((t, i) => (t.push(...e.slot.reels[i].children.slice(1, 5)), t)), []);
                                Lt.action.emit("sound:expandWildReel"), t.forEach((function(t, e) {
                                    i[t].visible = !0, i[t].play("wild", !1)
                                })), yield Promise.all(s.map((t => 1 === t.getCurrentTextureIndex() ? (t.alpha = 1, Promise.resolve()) : new Promise((e => {
                                    setTimeout((() => {
                                        t.replaceTexture(1), t.alpha = 1, e()
                                    }), 400)
                                }))))), yield Lt.delay(1e3)
                            }
                        }))()
                    ...
                    allPayment(t) {
                        ...
                        return (0, o.Z)((function*() {
                            ...
                            for (var i = 0, s = t.length; i < s; i++) {
                                var o = t[i];
                                e._wins.push(o), e._showFrame(o), e._runSymbolAnimation(o, !1)
                            }
                    ...
                    scatterPayment(t) {
                        var e = this;
                        return (0, o.Z)((function*() {
                            Lt.action.emit("sound:scatterWin"), e.slot.reels.forEach((t => t.overlay())), e.slot.lines.hide(), Lt.store.get("free:isStart", !1) ? e._runSymbolAnimation(t, !0, "freeStart") : Lt.store.get("free:isEnd", !1) && e._runSymbolAnimation(t, !0, "freeStop"), e._showFrame(t), yield Lt.delay(Ni.get("reward_scatter"))
                        }))()
                    }
                    complete() {
                ...
                function Do() {
                    ...
                    return Lt.action.on("symbol:playAnimation", ((i, s, o) => {
                        if (! function(t, i) {
                            ...
                            var r = new js(Lt.loader.getAsset("effectCommon"));
                            r.name = o.assetName, r.alpha = 1, r.position.set(i, s), t.addChild(r), r.play("win", !1)
                        }
                ...
                class Qo extends Ro {
                    ...
                    init() {
                        ...
                        for (var s, n, a, h, r = this.game.config.get("slot.size[0]"), l = 0; l < r; l++) {
                            var c = this.symbolsPositions[l],
                                d = new Go(l, c);
                            this.reels.push(d), this.reelsContainer.addChild(d);
                            var u = new js(this.game.loader.getAsset("fsWildEffect"));
                            u.x = d.children[0].x, u.visible = !1, this.wildReels.push(u), this.reelsContainer.addChild(u)
                        }
                        this.slotData = {
                            ...
                            t.play("win", !1)
                        })), this.frames.render("effectFrame"), this.backgroundSlot = ((s = new $.j(Lt.loader.getAsset("slotBackground"))).name = "slotBackgound", s.anchor.set(.5), s.position.set(680, 430), s), this.scatterWaiting = (n = this.slotData, a = [], (h = new H.W2).name = "scatterWaitingContainer", n.reels.forEach(((t, e) => {
                            a.push([]), t.forEach((t => {
                                var i = new js(Lt.loader.getAsset("effectScatter"));
                                i.position.set(t.x, t.y), i.renderable = !1, h.addChild(i), a[e].push(i)
                            }))
                        })), {
                            getContainer: () => h,
                        ...
                        }), this.textFreeLeft = new Wo, this.textFreeLeft.container.position.set(685, 680), this.textTotalWin = new Zo(.8), this.textTotalWin.position.set(685, 680), this.textLineWin = new _o, this.addChild(this.reelsContainer), this.addChild(this.lines), this.addChild(this.scatterWaiting.getContainer()), this.addChild(this.backgroundSlot), this.addChild(Do()), this.addChild(this.frames.container), this.addChild(this.textLineWin.container), this.addChild(this.textTotalWin), this.addChild(this.textFreeLeft.container)
                    }
                    setupEvents() {
                        ...
                        })), this.game.action.on("state:finish_enter", this._onFinishEnter, this), this.game.action.on("wheel:stop", this._onStopWheel, this), this.game.action.on("reward:reset", this._onResetReward, this), this.game.action.on("free:select_start", this._onFreeStart, this)
                    }
                    _onFreeStart() {
                    ...
                    resize() {
                        this.game.device.desktop || this.game.device.landscape ? (this.scale.set(1, 1), this.position.set(960, 80)) : (this.scale.set(.759375, 1.3 * .5625), this.position.set(540, 202.5))
                    }
                }
                class Ho extends(Vt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "timeline", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "value", void 0), (0, n.Z)(this, "light", void 0), (0, n.Z)(this, "coins", void 0), (0, n.Z)(this, "onPress", void 0), this.visible = !1, this.interactive = !0, this.onPress = new(x()), this.game.interaction.click(this, (() => this.onPress.dispatch())), this.timeline = new C, this.content = new H.W2, this.overlay = new u.TC, this.overlay.beginFill(0, .75), this.overlay.drawRect(0, 0, 1920, 1080), this.overlay.endFill(), this.title = new $.j, this.title.anchor.set(.5), this.value = new v.Xz("", {
                            fontName: "WinFont"
                        }), this.value.anchor = .5, this.light = new js(this.game.loader.getAsset("effectBigWinLight")), this.light.alpha = 0, this.coins = new js(this.game.loader.getAsset("effectBigWinCoins")), this.coins.alpha = 0, this.content.addChild(this.title), this.content.addChild(this.value), this.addChild(this.overlay), this.addChild(this.light), this.addChild(this.coins), this.addChild(this.content)
                    }
                    show(t, e) {
                        var i = 0;
                        ...
                        return new Promise((n => {
                            ...
                            this.timeline.to(this.overlay, .35, {
                                ...
                                roundProps: ["coins"],
                                onStart: () => {
                                    this.light.play("lights", !0), this.light.alpha = 1
                                },
                                onUpdate: () => {
                ...
                new class extends class extends class extends class {
                    ...
                    constructor() {
                        super({}), (0, n.Z)(this, "autoPlaySettings", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "betSettings", void 0), (0, n.Z)(this, "bigWinAnimation", void 0), (0, n.Z)(this, "fastStopLayout", void 0), (0, n.Z)(this, "freeOverlay", void 0), (0, n.Z)(this, "gameRules", void 0), (0, n.Z)(this, "menu", void 0), (0, n.Z)(this, "paytable", void 0), (0, n.Z)(this, "slot", void 0), Xi.init(), this.init(_i, Li)
                    }
                    loadTranslations() {
                    ...
                    initViews() {
                        var t, e, i = this;
                        super.initViews(), this.background = this.rootNode.addChild(new gs), this.slot = this.rootNode.addChild(new Qo), this.controls = this.device.desktop ? new to : new uo, this.paytable = new Eo(null !== (t = null === (e = this.server) || void 0 === e ? void 0 : e.response.lines) && void 0 !== t ? t : []), this.gameSettings = new Ue, this.config.get("quickSpin.available", !0) && this.gameSettings.addItem(this.createQuickSpinCheckbox()), this.gameSettings.addItem(this.createFullscreenCheckbox()), this.gameSettings.addItem(this.createLeftHandCheckbox()), this.gameSettings.addItem(this.createGameSoundsCheckbox()), this.gameSettings.addItem(this.createBackgroundSoundsCheckbox()), this.bigWinAnimation = new Ho, this.fastStopLayout = new Te, this.betSettings = this.rootNode.addChild(new Ee), this.betSettings.setBets(this.betLevel.bets, this.betLevel.betCoins), this.betSettings.setPayLines(40), this.betSettings.setBet(this.betLevel.bet), this.autoPlaySettings = this.rootNode.addChild(new ce), this.autoPlaySettings.setAutoPlayCounts(this.autoPlay.counts), this.autoPlaySettings.stopSection.addItem(new Se), this.autoPlaySettings.stopSection.addItem(new be), this.autoPlaySettings.stopSection.addItem(new me), this.autoPlaySettings.stopSection.addItem(new ve), this.gameRules = new Ne, this.menu = new Ge, this.menu.addItem(this.loader.getAsset("iconPaytable"), this.paytable), this.menu.addItem(this.loader.getAsset("iconSettings"), this.gameSettings), this.menu.addItem(this.loader.getAsset("iconRules"), this.gameRules), this.rootNode.addChild(this.fastStopLayout), this.rootNode.addChild(this.menu), this.rootNode.addChild(this.controls), this.rootNode.addChild(this.bigWinAnimation), this.freeOverlay = this.rootNode.addChild(new po), this.paytable.updateBet(this.betLevel), this.controls.updateBet(this.betLevel), this.betSettings.on("open", (() => {
                    ...
                    reward() {
                        ...
                        return (0, o.Z)((function*() {
                            ...
                            var n = t.store.get("reward:wildReels", []),
                                a = t.store.get("reward:lines", []),
                                h = t.store.get("reward:scatters", !1);
                            if (n.length > 0 && (yield t.slot.animation.wildReelPayment(n)), (a.length > 0 || t.wallet.scatterCoins) && (t.controls.disableButtonSpin(), h && a.unshift(h), t.slot.textTotalWin.once("show", (() => {
                                    t.fastStopLayout.press(s, !1), t.controls.pressButtonSpin(s)
                                })), yield t.slot.animation.allPayment(a), e()), h && (t.controls.disableButtonSpin(), yield t.slot.animation.scatterPayment(h)), t.store.get("free:isStart", !1)) {
                                t.beforeFreeSpinsPopup(), yield t.freeOverlay.show(ao.START);
                                var r = t.store.get("free:played", 0) + 1;
                                t.action.emit("free:updateLeft", r)
    ...
    n.m = s, t = [], n.O = (e, i, s, o) => {
    ...
    }), t), n.o = (t, e) => Object.prototype.hasOwnProperty.call(t, e), e = {}, i = "northern_heat:", n.l = (t, s, o, a) => {
        if (e[t]) e[t].push(s);
        else {
            var h, r;
            if (void 0 !== o)
        ...
        var e = (e, i) => {
            ...
            i = self.webpackChunknorthern_heat = self.webpackChunknorthern_heat || [];
