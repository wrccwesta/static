...
(() => {
    var t, e, i, s = {
            9592: (t, e, i) => {
                ...
                class U {
                    ...
                    readSkeletonData(t, e) {
                        ...
                        var s = i.readString(),
                            o = N(s),
                            n = null;
                        if (o === W.VER38 && (n = new j.SkeletonBinary(new j.AtlasAttachmentLoader(t))), (i = new M.BinaryInput(e)).readInt32(), i.readInt32(), (o = N(s = i.readString())) !== W.VER40 && o !== W.VER41 || (n = new L.SkeletonBinary(new L.AtlasAttachmentLoader(t))), !n) {
                ...
                var G = i(512),
                    ...
                    et = i(798),
                    it = i(5277);
                u.TC.nextRoundedRectBehavior = !0, A.xv.nextLineHeightBehavior = !0, c.R.add(p.bx, g.B9, d.Bv, a.c, r.Q, h.T, l.O, v.vl, m.o, V, f, Z), window.PIXI = s;
                var st = i(3233),
                    ot = i.n(st);
                ...
                class Re extends(Vt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "content", void 0), this.title = this.addChild(new Fe(this.game.i18n.t("GameRulesAdvancedAutoPlayTitle"))), this.content = this.addChild(new Oe(this.game.i18n.t("GameRulesAdvancedAutoPlayContent")))
                    }
                    resize() {
                ...
                class Ze extends(Vt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "content", void 0), this.title = this.addChild(new Fe(this.game.i18n.t("GameRulesAutoPlayTitle"))), this.content = this.addChild(new Oe(this.game.i18n.t("GameRulesAutoPlayContent")))
                    }
                    resize() {
                        this.content.position.set(0, this.title.y + this.title.height + 30)
                    }
                ...
                class Ie extends(Vt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "gameName", void 0), (0, n.Z)(this, "gameTRTP", void 0), this.title = this.addChild(new Fe(this.game.i18n.t("GameRulesGeneralTitle"))), this.gameName = this.addChild(new Oe(this.game.config.get("gameName")));
                ...
                class je extends(Vt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "content", void 0), this.title = this.addChild(new Fe(this.game.i18n.t("GameRulesInterfaceTitle"))), this.content = this.addChild(new Oe(this.game.i18n.t("GameRulesInterfaceContent"))), this.addItems()
                    }
                    addItems() {
                ...
                class Ne extends(Vt(Q.W2)) {
                    ...
                    addSections() {
                        this.content.addChild(new Ie), this.content.addChild(new je), this.content.addChild(new Le), this.addAutoPlaySection(), this.content.addChild(new Me), this.content.addChild(new We), this.content.addChild(new _e)
                    }
                    addAutoPlaySection() {
                ...
                const Qi = {
                        init() {
                            ...
                            function e(e) {
                                var i = ot()(e, "win", 0);
                                Lt.store.set("reward:win", i), Lt.store.set("reward:lines", ot()(e, "lines", [])), Lt.store.set("reward:reels", ot()(e, "reels", e.error ? Gi : [])), Lt.store.set("reward:nReels", ot()(e, "nReels", e.error ? Hi : [])), Lt.store.set("reward:fsReels", ot()(e, "fsReels", [])), Lt.store.set("reward:ways", ot()(e, "ways", ""));
                            ...
                            Lt.store.set("reward:win", 0), Lt.store.set("reward:isWin", !1), Lt.store.set("reward:lines", []), Lt.store.set("reward:reels", []), Lt.store.set("reward:nReels", []), Lt.store.set("reward:fsReels", []), Lt.store.set("reward:preReels", []), Lt.store.set("reward:preSpin", []), Lt.store.set("reward:scatters", !1), Lt.store.set("reward:numberWinSymbol", 0), Lt.store.set("reward:wildReels", []), Lt.store.set("reward:multiplier", 1), Lt.store.set("reward:nextMultiplier", 1), Lt.store.set("reward:ways", ""), Lt.store.set("reward:wildReelsWays", ""), Lt.store.set("reward:feature", ""), Lt.server.on("response", (function(e) {
                                ...
                                Lt.store.set("reward:feature", n), Lt.store.set("reward:multiplier", ot()(e, "multiplier", Lt.store.get("free:isFree") ? 2 : 1)), Lt.store.set("reward:nextMultiplier", ot()(e, "nextMultiplier", Lt.store.get("free:isFree") ? 2 : 1)), Lt.store.set("reward:ways", ot()(e, "ways", "")), Lt.store.set("reward:wildReelsWays", ot()(e, "wildReelsWays", "")), t(e)
                ...
                class Ki extends R {
                    ...
                    _setupEvents() {
                        ...
                        Lt.action.on("sound:win", (function(e) {
                            ...
                            this.extraFree.play()
                        })), Lt.action.on("state:spin_enter", this._onSpinEnter, this), Lt.action.on("state:finish_enter", this._onFinishEnter, this), Lt.action.on("sound:wheelStop", this._onWheelStop, this), Lt.action.on("state:finish_enter", this._onFinishEnter, this), Lt.action.on("sound:click", this.click, this), Lt.action.on("sound:free_start", this._onFreeStart, this), Lt.action.on("sound:free_stop", this._onFreeStop, this), Lt.action.on("free:select_start", this._onSelectFreeStart, this), Lt.action.on("free:select_stop", this._onSelectFreeStop, this), Lt.action.on("sound:wild-appear", (() => {
                            this.wildReel.play()
                        })), Lt.action.on("sound:symbolDrop", (() => {
                ...
                var ps = us(us({}, ls), ds),
                    gs = Symbol("Multiplier");
                class ms extends(Vt(Q.W2)) {
                    constructor(t) {
                        super(), (0, n.Z)(this, "id", gs), (0, n.Z)(this, "currentMultiplier", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "value", void 0), this.currentMultiplier = t, this.background = this.addChild(new $.j(this.game.loader.getAsset("multiplier", "stone"))), this.value = this.addChild(new $.j(this.game.loader.getAsset("multiplier", "X".concat(t)))), this.value.position.set(65)
                    }
                    updateValue(t) {
                        var e = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1];
                        if (t !== this.currentMultiplier) {
                            this.currentMultiplier = t, this.value.texture = this.game.loader.getAsset("multiplier", "X".concat(t));
                            ...
                            e && k.fromTo(this.value, .2, {
                                ...
                                yoyo: !0,
                                repeat: 1
                            }), this.game.device.portrait || (this.value.x = this.background.width / 2 - this.value.width / 2 + 10)
                        }
                    }
                    hide() {
                        this.alpha = 0
                    ...
                    resize() {
                        this.background.visible = this.game.device.desktop || this.game.device.landscape, this.game.device.desktop || this.game.device.landscape ? (this.value.scale.set(1), this.position.set(this.game.device.desktop || this.game.leftHand.enabled ? 280 : 1430, 720)) : (this.value.scale.set(1.3), this.position.set(720, 1260))
                    }
                }
                var As = Symbol("WaysBadge");
                class vs extends(Vt(Q.W2)) {
                    constructor(t) {
                        super(), (0, n.Z)(this, "id", As), (0, n.Z)(this, "currentWays", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "value", void 0), this.currentWays = t, this.background = this.addChild(new $.j(this.game.loader.getAsset("assets/images/rockWays.png"))), this.value = this.background.addChild(new Pe("", {
                            default: {
                                fill: "white",
                                fontSize: 60,
                                fontFamily: "Avenir-Bold",
                        ...
                        })), this.value.text = t, this.value.anchor.set(.5), this.value.position.set(this.background.width / 2, 80)
                    }
                    updateValue(t) {
                        var e = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1];
                    ...
                    resize() {
                        this.game.device.desktop || this.game.device.landscape ? (this.value.scale.set(1), this.position.set(this.game.device.desktop || this.game.leftHand.enabled ? 1540 : 140, 780)) : (this.value.scale.set(1.3), this.position.set(750, 1180))
                    }
                }
                class bs extends Je {
                    get dropCoins() {
                                ...
                                if (l) {
                                    ...
                                    switch (l.type) {
                                        case M.AttachmentType.Region:
                                            ...
                                            d.transform.setFromMatrix(h.bone.matrix), h.currentSprite.color ? c = h.currentSprite.color : (fs[0] = o[0] * h.color.r * u.r, fs[1] = o[1] * h.color.g * u.g, fs[2] = o[2] * h.color.b * u.b, h.currentSprite.tint = it.rgb2hex(fs)), h.currentSprite.blendMode = h.blendMode;
                                            break;
                                        case M.AttachmentType.Mesh:
                                            ...
                                            l.computeWorldVerticesOld(h, h.currentMesh.vertices), h.currentMesh.color ? c = h.currentMesh.color : (fs[0] = o[0] * h.color.r * u.r, fs[1] = o[1] * h.color.g * u.g, fs[2] = o[2] * h.color.b * u.b, h.currentMesh.tint = it.rgb2hex(fs)), h.currentMesh.blendMode = h.blendMode;
                                            break;
                ...
                class ys extends(Vt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "backgroundLTextureFree", void 0), (0, n.Z)(this, "backgroundLTextureNormal", void 0), (0, n.Z)(this, "backgroundPTextureFree", void 0), (0, n.Z)(this, "backgroundPTextureNormal", void 0), (0, n.Z)(this, "backgroundTextureLandscape", void 0), (0, n.Z)(this, "backgroundTexturePortrait", void 0), (0, n.Z)(this, "featureBackground", void 0), (0, n.Z)(this, "freeAnimation", void 0), (0, n.Z)(this, "logo", void 0), this.backgroundLTextureNormal = this.game.loader.getAsset("bgln"), this.backgroundLTextureFree = this.game.loader.getAsset("bglf"), this.backgroundPTextureNormal = this.game.loader.getAsset("bgpn"), this.backgroundPTextureFree = this.game.loader.getAsset("bgpf"), this.backgroundTextureLandscape = this.backgroundLTextureNormal, this.backgroundTexturePortrait = this.backgroundPTextureNormal, this.background = new $.j(this.backgroundTextureLandscape), this.featureBackground = new $.j(this.backgroundLTextureFree), this.featureBackground.alpha = 0, this.freeAnimation = new ws(this.game.loader.getAsset("assets/images/effects/bg-fs/skeleton.json")), this.freeAnimation.play("animation", !0), this.freeAnimation.alpha = 0, this.logo = new $.j(this.game.loader.getAsset("logo")), this.logo.anchor.x = .5, this.logo.alpha = 0, this.addChild(this.background), this.addChild(this.featureBackground), this.addChild(this.freeAnimation), this.addChild(this.logo), this.setupEvents()
                    }
                    setupEvents() {
                        this.game.action.on("state:setup_enter", (() => {
                            this.game.store.get("free:isFree", !1) && (this.featureBackground.alpha = 1, this.freeAnimation.alpha = 1, this.logo.alpha = 0)
                            ...
                            }), this.freeAnimation.alpha = 1, this.logo.alpha = 1
                            ...
                            }), this.freeAnimation.alpha = 0, this.logo.alpha = 1
                        }))
                    }
                ...
                class Ws extends(Vt(Q.W2)) {
                    constructor() {
                        ...
                        var e = new Fs(d.xE.from(Es), 0);
                        e.width = 12, e.height = 151;
                        var i = new Fs(d.xE.from(Es), 4914792);
                ...
                class Gs extends Ds {
                    constructor(t) {
                        ...
                        })), this.betLevel = t, this.betLevelText = this.addChild(new Pe("", Vs(Vs({}, Us.Common), {}, {
                            default: Vs(Vs({}, Us.Common.default), {}, {
                                align: "left"
                            })
                ...
                class no extends Is {
                    constructor() {
                        ...
                        this.background = $.j.from("data:image/png;base64,"), this.background.alpha = .4, this.background.anchor.set(0, 1), this.background.position.set(0, this.game.viewport.height), this.buttonMenu = new Cs, this.buttonMenu.position.set(77, 1013), this.buttonMaxBet = new Gs(this.game.betLevel), this.buttonMaxBet.position.set(213, 1013), this.buttonAutoPlay = new Ss, this.buttonAutoPlay.position.set(833, 1013), this.buttonQuickSpin = new Bs, this.buttonQuickSpin.position.set(1084, 1014), this.buttonSound = new Ms, this.buttonSound.position.set(1840, 1012), this.buttonSpin = function() {
                            ...
                            var i = new ws(Lt.loader.getAsset("effectSpinStatic"));
                            ...
                            return s.onPress.add(o), s.disable(), Lt.action.on("spin:fast", (function() {
                                ...
                                "drop" !== Lt.store.get("server:nextAction") && (s.enable(), Vi.isFreespin() || (e.visible = !0, e.enable(), i.play("active", !1)))
                            ...
                            Vi.isFreespin() && (this.y = this.y + this.height + 100), "drop" === this.game.store.get("server:nextAction") && (this.buttonMenu.disable(), this.buttonSpin.disable(), this.buttonAutoPlay.disable())
                        })), this.game.action.on("state:finish_exit", (() => {
                            Vi.isBasic() && "drop" !== this.game.store.get("server:nextAction") && (this.game.autoPlay.enabled || this.buttonMenu.enable(), this.buttonAutoPlay.enable())
                            ...
                            !Vi.isBasic() || this.game.autoPlay.enabled || this.game.freeRound.enabled || "drop" === this.game.store.get("server:nextAction") || this.buttonMaxBet.enable()
                            ...
                            Vi.isFreespin() || "drop" === this.game.store.get("server:nextAction") || this.textBalance.update(this.game.wallet.balance)
                        }))
                    }
                    lock() {
                ...
                class vo extends Is {
                    constructor() {
                        ...
                        super(), t = this, (0, n.Z)(this, "autoPlayButton", void 0), (0, n.Z)(this, "betButton", void 0), (0, n.Z)(this, "buttonAccept", void 0), (0, n.Z)(this, "buttonMenu", void 0), (0, n.Z)(this, "buttonQuickSpin", void 0), (0, n.Z)(this, "buttonSound", void 0), (0, n.Z)(this, "buttonSpin", void 0), (0, n.Z)(this, "onPressButtonSpin", void 0), (0, n.Z)(this, "state", void 0), (0, n.Z)(this, "statusBar", void 0), this.state = co.Normal, this.onPressButtonSpin = new(x()), this.statusBar = new mo, this.statusBar.changeState(this.state), this.game.freeRound.enabled ? (this.statusBar.update({
                        ...
                        })), this.buttonMenu = new Cs, this.buttonSound = new Ms, this.buttonSpin = new Ao, this.game.interaction.hover(this.buttonSpin, (() => {
                            ...
                            !Vi.isBasic() || this.game.autoPlay.enabled || this.game.freeRound.enabled || "drop" === this.game.store.get("server:nextAction") || (this.betButton.show(), this.betButton.enable())
                        })), this.game.action.on("state:spin_enter", (() => {
                            ...
                            var t = this.game.autoPlay.enabled;
                            Vi.isFreespin() || t || "drop" === this.game.store.get("server:nextAction") || (this.buttonSpin.visible = !0, this.buttonSpin.interactive = !0, this.buttonQuickSpin.show(), this.autoPlayButton.show(), this.autoPlayButton.enable(), this.buttonMenu.show(), this.buttonMenu.enable())
                        })), this.game.freeRound.onFinish.once((() => {
                            this.statusBar.update({
                                type: lo.Balance,
                                value: this.game.wallet.balance
                ...
                class Po extends Bo {
                    resize() {
                        this.game.device.desktop ? (this.position.set(150, 806), this.button.scale.set(1), this.buttonText.position.set(31, 17)) : (this.position.set(this.game.device.landscape ? 150 : 500, this.game.device.landscape ? 792 : 1384), this.button.scale.set(1.6), this.buttonText.scale.set(1.5), this.buttonText.position.set(50, 29))
                    }
                }
                ...
                class To extends Eo {
                    constructor(t) {
                        super(t, arguments.length > 1 && void 0 !== arguments[1] && arguments[1]), this.featurePreview.anchor.x = .5, this.featurePreview.position.set(0, 0), this.description.anchor.x = .5, this.description.position.set(0, this.featurePreview.y + this.featurePreview.height - 150)
                    }
                    resize() {
                        this.description.setTagStyle("default", {
                            wordWrapWidth: this.game.viewport.width / 2.4
                        }), this.game.device.desktop ? (this.scale.set(.9), this.position.set(980, 100)) : this.game.device.landscape ? (this.description.setTagStyle("default", {
                            wordWrapWidth: this.game.viewport.width / 2.4
                        }), this.scale.set(.9), this.position.set(980, 100)) : (this.description.setTagStyle("default", {
                            wordWrapWidth: this.game.viewport.width / 1.5
                        }), this.scale.set(1.3), this.position.set(550, 300))
                    }
                }
                class Oo extends wo {
                    constructor() {
                        super(), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "logo", void 0), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "playButtonBg", void 0), (0, n.Z)(this, "bottomLine", void 0), (0, n.Z)(this, "topLine", void 0), (0, n.Z)(this, "trex", void 0), this.background = this.addChild(new $.j(this.game.loader.getAsset("bgln"))), this.overlay = this.addChild(new Jt(.75)), this.content = this.addChild(new Q.W2), this.topLine = this.content.addChild(this.createDelimeter(6780011, 1200)), this.logo = this.content.addChild(new $.j(this.game.loader.getAsset("logo"))), this.bottomLine = this.content.addChild(this.createDelimeter(6780011, this.game.viewport.width)), this.logo.anchor.x = .5, this.trex = this.content.addChild(new $.j(this.game.loader.getAsset("assets/images/introScreen/texture.json", "trex"))), this.slides.push(this.content.addChild(new To(0))), this.slides.push(this.content.addChild(new To(1))), this.slides.push(this.content.addChild(new To(2))), this.slides.push(this.content.addChild(new To(3, !0))), this.pagination = this.content.addChild(new ko(this.visibleViewsCount, 40)), this.hideButton = this.content.addChild(new Po("#4cb26b")), this.arrows = this.content.addChild(new xo(this.visibleViewsCount)), this.arrows.right.position.set(790, 0), this.arrows.position.set(580, 400), this.playButton = this.content.addChild(new Co), this.playButton.anchor.set(.5), this.setupArrows(), this.setupPagination(), this.setupHideButton(), this.setupSlides()
                    }
                    resize() {
                        this.topLine.position.set(410, 122), this.logo.position.set(250, 40), this.bottomLine.position.set(0, 820), this.trex.position.set(this.game.viewport.width - this.trex.width, 148), this.content.scale.set(1), this.content.position.set(0, this.game.device.portrait && !this.game.device.desktop ? 40 : 0), this.game.device.desktop ? (this.pagination.scale.set(1), this.pagination.position.set(940, 806)) : (this.pagination.scale.set(1.6), this.pagination.position.set(this.game.device.landscape ? 900 : 150, this.game.device.landscape ? 792 : 1384)), this.game.device.portrait && !this.game.device.desktop ? (this.background.texture = this.game.loader.getAsset("bgpn"), this.background.height = 2 * this.game.viewport.paddingY + this.game.viewport.height, this.background.width = 2 * this.game.viewport.paddingX + .5625 * this.background.height, this.topLine.position.set(-this.game.viewport.paddingX / 2, 390), this.bottomLine.position.set(0, 1410), this.bottomLine.width = this.game.viewport.width, this.playButton.scale.set(1.4), this.playButton.position.set(540, 1600), this.logo.scale.set(1.5), this.logo.position.set(this.game.viewport.width / 2 - this.logo.width / 2, 0), this.trex.visible = !1) : (this.background.texture = this.game.loader.getAsset("bgln"), this.background.width = this.game.viewport.width, this.background.height = this.game.viewport.height, this.topLine.position.set(410, 122), this.bottomLine.position.set(0, 820), this.bottomLine.width = this.game.viewport.width, this.logo.scale.set(1), this.logo.position.set(250, 40), this.playButton.scale.set(1), this.playButton.position.set(1e3, 890), this.trex.visible = !0)
                    }
                }
                ...
                class Do extends(Vt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "_sectionParagraph1", void 0), (0, n.Z)(this, "_sectionTitle", void 0), this.visible = this.game.config.get("rnb", !0), this._sectionTitle = new Io(this.game.i18n.t("PaytableSectionRiskTitle").toUpperCase()), this._sectionTitle.position.set(0, 0), this._sectionParagraph1 = new Mo(this.game.i18n.t("PaytableSectionRiskContent1")), this._sectionParagraph1.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this.addChild(this._sectionTitle), this.addChild(this._sectionParagraph1)
                    }
                    resize() {
                ...
                class jo extends(Vt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "_betWays", void 0), (0, n.Z)(this, "_payTableParagraph", void 0), (0, n.Z)(this, "_payTableTitle", void 0), (0, n.Z)(this, "_textureAtlas", void 0), this._payTableTitle = new Io(this.game.i18n.t("PaytableSectionBetLinesTitle").toUpperCase()), this._payTableParagraph = new Mo(this.game.i18n.t("PaytableSectionBetLinesContent")), this._payTableParagraph.y = 190, this._textureAtlas = this.game.loader.getAsset("paytable"), this._betWays = new $.j(this._textureAtlas.payways_scheme), this._betWays.scale.set(2), this._betWays.y = 60, this.addChild(this._payTableTitle, this._betWays, this._payTableParagraph)
                    }
                    resize() {
                ...
                class _o extends(Vt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "_sectionParagraph", void 0), (0, n.Z)(this, "_sectionTitle", void 0), this._sectionTitle = new Io(this.game.i18n.t("PaytableSectionFreeTitle").toUpperCase()), this._sectionParagraph = new Mo(this.game.i18n.t("PaytableSectionFreeContent")), this._sectionParagraph.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this.addChild(this._sectionTitle), this.addChild(this._sectionParagraph)
                    }
                    resize() {
                ...
                class zo extends(Vt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "_sectionParagraph", void 0), (0, n.Z)(this, "_sectionTitle", void 0), this._sectionTitle = new Io(this.game.i18n.t("PaytableSectionRockfallTitle").toUpperCase()), this._sectionParagraph = new Mo(this.game.i18n.t("PaytableSectionRockfallContent")), this._sectionParagraph.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this.addChild(this._sectionTitle), this.addChild(this._sectionParagraph)
                    }
                    resize() {
                        this.game.device.desktop || this._sectionParagraph.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30)
                    }
                ...
                class Go extends(Vt(Q.W2)) {
                    constructor() {
                        ...
                        this._sectionTitle = new Io(t.toUpperCase()), this._sectionTitle.position.set(0, 0), this._symbolWild = new No("wild"), this._symbolWild.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this._symbolWild.withoutPayout(), this._sectionParagraph = new Mo(this.game.i18n.t("PaytableSectionWildContent")), this._sectionParagraph.position.set(400, this._sectionTitle.y + this._sectionTitle.height + 30), this._sectionParagraph.setTagStyle("default", {
                            wordWrapWidth: 620
                ...
                class pn extends $o {
                    constructor() {
                        super(), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "backgroundContent", void 0), (0, n.Z)(this, "buyFor", void 0), (0, n.Z)(this, "buyValue", void 0), (0, n.Z)(this, "divider1", void 0), (0, n.Z)(this, "divider2", void 0), (0, n.Z)(this, "featureButton", void 0), (0, n.Z)(this, "header", void 0), (0, n.Z)(this, "labelDescription", void 0), (0, n.Z)(this, "labelHeader", void 0), (0, n.Z)(this, "onBet", void 0), (0, n.Z)(this, "onBetValue", void 0), (0, n.Z)(this, "onPress", void 0), this.onPress = new(x()), this.background = this.addChild(new $.j(this.game.loader.getAsset("risk", "buy_bg"))), this.backgroundContent = this.addChild(new Q.W2), this.header = this.backgroundContent.addChild(new an({
                            default: {
                                fontSize: 23,
                                wordWrapWidth: 200,
                                fill: "#ffffff"
                            ...
                            fontName: "WinFont"
                        })), this.labelHeader.letterSpacing = -40, this.labelHeader.scale.set(.5), this.labelHeader.anchor.x = .5, this.labelDescription = this.backgroundContent.addChild(new sn({
                            default: {
                                fontSize: 35,
                                fill: "#ffffff"
                            }
                        })), this.divider1 = this.backgroundContent.addChild(new u.TC), this.divider1.lineStyle(2, 7953976, 1), this.divider1.moveTo(0, 0), this.divider1.lineTo(120, 0), this.divider2 = this.backgroundContent.addChild(new u.TC), this.divider2.lineStyle(2, 3897656, 1), this.divider2.moveTo(0, 0), this.divider2.lineTo(120, 0), this.buyFor = this.backgroundContent.addChild(new Xo({
                            default: {
                                fill: "#ffffff",
                                fontSize: 21,
                                wordWrapWidth: 220
                        ...
                        })), this.featureButton = this.addChild(new $.j(this.game.loader.getAsset("assets/images/risk/Buy.png"))), this.featureButton.cursor = "pointer", this.featureButton.interactive = !1, this.featureButton.position.set(36, 420), this.game.interaction.click(this.featureButton, (() => {
                    ...
                    show(t) {
                        if (this.game.store.get("isRiskNBuy") && (super.show(t), this.visible)) {
                            ...
                            this.featureButton.interactive = !0, this.featureButton.texture = this.game.loader.getAsset("assets/images/risk/".concat(e ? "Risk" : "Buy", ".png")), this.background.texture = this.game.loader.getAsset("risk", e ? "risk_bg" : "buy_bg"), e ? (this.header.show(), this.buyFor.hide(), this.buyValue.hide(), this.divider1.alpha = 1, this.divider2.alpha = 0, this.labelHeader.text = e.freespins, this.onBetValue.text = "".concat(Lt.helpers.toMoneySS(this.game.betLevel.toCoins())), this.header.position.set(0, 0), this.labelHeader.position.set(0, 30), this.labelDescription.position.set(0, 210), this.divider1.position.set(-62, 280), this.onBet.position.set(0, 310), this.onBetValue.position.set(0, this.onBet.y + this.onBet.height), this.backgroundContent.position.set(113, 50), this.featureButton.position.set(0, 474)) : (this.header.hide(), this.buyFor.show(), this.buyValue.show(), this.divider1.alpha = 0, this.divider2.alpha = 1, this.labelHeader.text = i.freespins, this.buyValue.text = "".concat(Lt.helpers.toMoneySS(i.bet)), this.onBetValue.text = "".concat(Lt.helpers.toMoneySS(this.game.betLevel.toCoins())), this.labelHeader.position.set(0, -160), this.labelDescription.position.set(0, 20), this.buyFor.position.set(0, 85), this.buyValue.position.set(0, this.buyFor.height + this.buyFor.y), this.divider2.position.set(-60, this.buyValue.height + this.buyValue.y + 15), this.onBet.position.set(0, this.divider2.height + this.divider2.y + 15), this.onBetValue.position.set(0, this.onBet.height + this.onBet.y), this.backgroundContent.position.set(113, 140), this.featureButton.position.set(10, 480))
                        }
                    }
                    hide() {
                    ...
                    resize() {
                        this.game.device.desktop ? this.position.set(1550, 80) : this.game.device.landscape ? (this.scale.set(1.15), this.game.leftHand.enabled ? this.position.set(1550, 80) : this.position.set(130, 80)) : (this.scale.set(1.2), this.position.set(760, 194))
                    }
                }
                ...
                class vn extends(Vt(Q.W2)) {
                    ...
                    show(t) {
                        ...
                        return new Promise((i => {
                            ...
                            }, t < 1 ? (this.textValue.text = "", this.textDescription.texture = Lt.loader.getAsset("textLastFreeSpin"), this.textDescription.pivot.set(this.textDescription.width / 2, 0), this.timeline.set(this, {
                                pixi: {
                                    y: e,
                                    alpha: 0,
                                    scale: 1
                ...
                const bn = class {
                    ...
                    scatterPayment(t) {
                        ...
                        return (0, o.Z)((function*() {
                            ...
                            "freespin" === Lt.store.get("server:nextAction", "spin") || Vi.isFreespin() || e.slot.reels.forEach((t => t.stopAnimation()))
                        }))()
                    }
                    mixPayment(t, e) {
                        var i = arguments,
                        ...
                        return (0, o.Z)((function*() {
                            ...
                            if ("free" !== o && Lt.action.emit("sound:win", a), n && t.length > 0 && (Lt.action.emit("sound:win", a, "light"), yield s.slot.textTotalWin.show(Lt.wallet.coins, (() => {
                                ...
                                if (Lt.action.emit("free:updateLeft", d), t.length > 0) {
                                    ...
                                    for (yield Lt.delay(700), r = 0; r < h; r++) {
                                        var u = t[r];
                    ...
                    _runSymbolAnimation(t) {
                        ...
                        for (var o of (i && this.slot.reels.forEach((t => t.clearAnimation())), e)) {
                            ...
                            if (n.isWildReel && "normal" === s) n.playWildWin();
                            else {
                                var a = this._findSymbol(o[0], o[1]),
                ...
                function wn() {
                    ...
                    return Lt.action.on("symbol:playAnimation", ((i, o, a) => {
                        ...
                        if (function(t, i) {
                            ...
                            (h = t.addChildAt(new ws(Lt.loader.getAsset(a.assetName)), l)).zIndex = o, h.name = "".concat(i).concat(o), h.alpha = 1, h.position.set(i, o)
                        }
                        if (!h.visible || !h.playing || h.skinName !== a.skin || h.animationName !== a.effectName) {
                            ...
                            "win" === d && (t.zIndex = 3), h.play(d, "idle" === d, null !== (r = a.trackIndex) && void 0 !== r ? r : 0, a.onComplete).then((() => {
                                t.zIndex = 1
                            })), h.visible = !0
                        }
                        ...
                        var e = (0, o.Z)((function*(e, s, o) {
                            ...
                            var a = i.sort(n).indexOf(o.symbolPosition),
                                r = new ws(Lt.loader.getAsset(o.assetName));
                            r.visible = !0, r.changeSkin(o.skin), r.play("idle"), r.position.set(e, s), t.addChildAt(r, a), r.zIndex = o.symbolPosition, k.fromTo(r, .2, {
                                pixi: {
                                    y: s
                                }
                            }, {
                ...
                class Cn extends(Vt(Q.W2)) {
                    constructor(t, e) {
                        super(), (0, n.Z)(this, "_dropCount", void 0), (0, n.Z)(this, "_reel", void 0), (0, n.Z)(this, "_reelIndex", void 0), (0, n.Z)(this, "_stopTimeout", void 0), (0, n.Z)(this, "_stopTimeoutDuration", void 0), (0, n.Z)(this, "isStop", void 0), (0, n.Z)(this, "symbols", void 0), (0, n.Z)(this, "symbolsPositions", void 0), (0, n.Z)(this, "visibleSymbols", void 0), (0, n.Z)(this, "wildReel", void 0), (0, n.Z)(this, "wildSoundPlayed", void 0), this.interactiveChildren = !1, this.visibleSymbols = [], this.symbolsPositions = e, this.wildSoundPlayed = !1, this._reel = [], this._reelIndex = t, this._dropCount = 0, this.isStop = !1, this._stopTimeout = null, this._stopTimeoutDuration = 0, this.symbols = this.addChild(new Q.W2), this.symbols.sortableChildren = !0, this.wildReel = new ws(this.game.loader.getAsset("assets/images/effects/wild-appear/skeleton.json")), this.wildReel.visible = !1, this._setup()
                    }
                    get isWildReel() {
                        return this.wildReel.visible
                    }
                    get dropCount() {
                    ...
                    start() {
                        ...
                        return (0, o.Z)((function*() {
                            if ("drop" !== t.game.store.get("server:nextAction")) {
                                t.hideWildReel(), t.stopAnimation(), t.isStop = !1, t._stopTimeoutDuration = t.game.quickSpin.enabled ? t.game.config.get("wheel.durationQuickStop") : t.game.config.get("wheel.durationStop"), yield t.game.delay(t._stopTimeoutDuration * t._reelIndex);
                                var e = t.height;
                    ...
                    stopRockfall() {
                        ...
                        return (0, o.Z)((function*() {
                            ...
                            else if (t.isWildReel)
                                for (var s = t.symbols.children.length - 1; s >= 0; s--) {
                                    var n = t._reel[s],
                                        a = t.symbols.children[s];
                                    a.replaceTexture(n), a.hide()
                                } else
                                    for (var r = function(e) {
                                            ...
                                            a.replaceTexture(n), a.position.set(r, -500), a.alpha = 1, k.to(a, .06, {
                                                ...
                                                delay: .06 * (i - e),
                                                onCompleteParams: [e],
                                                onComplete: (s = (0, o.Z)((function*(i) {
                                                    a.playAnimation({
                                                        animationName: "drop",
                                                        symbolPosition: e
                                                    }), "drop" === t.game.store.get("server:action") && t.game.action.emit("sound:symbolDrop"), yield t.game.delay(500), 0 === i && (t.setDropCount(0), t.game.action.emit("wheel:stop", t._reelIndex))
                                                })), function(t) {
                    ...
                    showWildReel() {
                        var t = this;
                        return (0, o.Z)((function*() {
                            t.game.store.get("reward:wildReels", []).indexOf(t._reelIndex) > -1 && (t.update(t._reel), t.visibleSymbols.forEach(((e, i) => e.playAnimation({
                                animationName: "normal",
                                reelPosition: t._reelIndex,
                                symbolPosition: i
                            }))), t.wildReel.visible = !0, t.zIndex = 3, t.wildReel.zIndex = 2, t.wildReel.position.set(150 * t._reelIndex, 0), t.wildReel.changeSkin("wild"), t.wildSoundPlayed || (t.game.action.emit("sound:wild-appear"), t.wildSoundPlayed = !0), yield t.wildReel.play("wild-appear"), t.visibleSymbols.forEach((t => t.visible = !1)))
                        }))()
                    }
                    hideWildReel() {
                        this.wildSoundPlayed = !1, this.wildReel.visible = !1, this.zIndex = 1
                    }
                    restore() {
                    ...
                    playWildWin() {
                        var t = this;
                        return (0, o.Z)((function*() {
                            yield t.wildReel.play("wild-win"), t.hideWildReel(), t.setDropCount(6)
                        }))()
                    }
                    overlay() {
                    ...
                    stopAnimation() {
                        this.isWildReel || this.visibleSymbols.forEach((t => {
                            t.stopAnimation()
                        }))
                    }
                    clearAnimation() {}
                ...
                class Bn extends mn {
                    constructor() {
                        super(), (0, n.Z)(this, "animation", void 0), (0, n.Z)(this, "reels", void 0), (0, n.Z)(this, "reelsContainer", void 0), (0, n.Z)(this, "slotData", void 0), (0, n.Z)(this, "stopReelCounter", void 0), (0, n.Z)(this, "stopRockfallCounter", void 0), (0, n.Z)(this, "symbolsPositions", void 0), (0, n.Z)(this, "textExtraFree", void 0), (0, n.Z)(this, "textFreeLeft", void 0), (0, n.Z)(this, "textTotalWin", void 0), (0, n.Z)(this, "symbolsAnimation", void 0), this.sortableChildren = !0, this.pivot.set(500, 0), this.reels = [], this.stopReelCounter = 0, this.stopRockfallCounter = 0, this.symbolsPositions = this.game.config.get("slot.symbolsPositions", []), this.animation = new bn(this), this.symbolsAnimation = wn(), this.symbolsAnimation.zIndex = 1, this.init(), this.setupEvents()
                    }
                    createMask() {
                        var t = new u.TC;
                        return t.beginFill(16711680, .8), t.drawRect(0, 0, this.game.config.get("slot.width"), this.game.config.get("slot.height") - 26), t.endFill(), t
                    }
                    init() {
                        var t, e, i = this.createMask();
                        this.reelsContainer = new Q.W2, this.reelsContainer.mask = i, this.reelsContainer.zIndex = 2, this.reelsContainer.addChild(i);
                        ...
                        }, this.textFreeLeft = new vn, this.textFreeLeft.position.set(1010, 500), this.textFreeLeft.zIndex = 5, this.textTotalWin = new An(.8, "1"), this.textTotalWin.textScaleEnabled = !0, this.textTotalWin.textScaleMultiplier = .1, this.textTotalWin.winText.rotation = .15, this.textTotalWin.position.set(1040, 550), this.textTotalWin.zIndex = 5, this.textExtraFree = new gn, this.textExtraFree.value.rotation = .15, this.textExtraFree.position.set(1010, 530), this.textExtraFree.zIndex = 5, this.addChild(this.reelsContainer), this.addChild(this.symbolsAnimation), this.addChild(...this.reels.map((t => t.wildReel))), this.addChild(this.textTotalWin), this.addChild(this.textFreeLeft), this.addChild(this.textExtraFree)
                    }
                    setupEvents() {
                        this.game.action.on("state:ready_enter", this._onReadyEnter, this), this.game.action.on("state:spin_enter", this._onSpinEnter, this), this.game.action.on("state:stop_enter", this._onStopEnter, this), this.game.action.on("state:finish_enter", this._onFinishEnter, this), this.game.action.on("free:start", (() => {
                            ...
                            this.reels.forEach(((e, i) => {
                                e.hideWildReel(), e.update(t[i])
                            })), this.game.get(gs).updateValue("drop" === this.game.store.get("server:nextAction") ? this.game.store.get("reward:preSpin").multiplier : 1)
                        })), this.game.action.on("free:restore", (() => {
                            this.game.get(As).hide()
                        })), this.game.action.on("free:select_stop", (() => {
                            k.fromTo(this, .5, {
                                pixi: {
                                    alpha: 0
                            ...
                            }), this.game.get(As).updateValue(this.game.store.get("reward:preSpin").ways), this.game.get(gs).show()
                        })), this.game.action.on("free:select_start", (() => {
                            k.fromTo(this, .5, {
                                pixi: {
                                    alpha: 0
                            ...
                            }), this.game.store.get("free:isStart") && this.game.get(gs).updateValue(this.game.store.get("reward:nextMultiplier", 2), !1), this.game.get(As).updateValue(this.game.store.get(this.game.store.get("free:ways") ? "free:ways" : "reward:ways"))
                        })), this.game.action.on("sound:wild-appear", (() => {
                            this.game.get(As).updateValue(this.game.store.get("reward:wildReelWays"))
                    ...
                    _onReadyEnter() {
                        this.game.get(gs).updateValue(this.game.store.get("reward:nextMultiplier"));
                        var t = this.game.autoPlay.enabled,
                    ...
                    updateFreeLeft() {
                        if (Vi.isFreespin() && "drop" !== this.game.store.get("server:nextAction")) {
                    ...
                    _onFinishEnter() {
                        var t = this;
                        return (0, o.Z)((function*() {
                            t.stopReelCounter = 0, t.stopRockfallCounter = 0, Vi.set(t.game.store.get("reward:feature")), t.game.store.get("free:isFree", !1) || "drop" === t.game.store.get("server:nextAction") || (yield t.game.freeRound.finish()), t.game.autoPlay.enabled ? t.game.checkBalance().then((() => {
                    ...
                    onStopWheel() {
                        var t = this;
                        return (0, o.Z)((function*() {
                            t.stopReelCounter++, t.game.get(As).updateValue(t.game.store.get("reward:ways")), t.stopReelCounter >= t.reels.length && (yield Promise.all(t.reels.map((t => t.showWildReel()))), t.game.afterReelsStop(), yield t.animation.stop(), t.game.get(As).updateValue(t.game.store.get("reward:wildReelsWays", t.game.store.get("reward:ways"))), t.game.state.goTo("reward"))
                        }))()
                    }
                    _onResetReward() {}
                    beforeFreeSpinsPopup() {
                    ...
                    resize() {
                        this.game.device.desktop || this.game.device.landscape ? (this.scale.set(1), this.position.set(980, 30), this.textTotalWin.position.set(950, 550), this.textExtraFree.position.set(950, 530), this.textFreeLeft.position.set(950, 500)) : (this.scale.set(1.1), this.position.set(551.25, 150), this.textTotalWin.position.set(470, 550), this.textExtraFree.position.set(470, 530), this.textFreeLeft.position.set(470, 530))
                    }
                }
                class Pn extends(Vt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "timeline", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "value", void 0), (0, n.Z)(this, "light", void 0), (0, n.Z)(this, "coins", void 0), (0, n.Z)(this, "onPress", void 0), this.visible = !1, this.interactive = !0, this.onPress = new(x()), this.game.interaction.click(this, (() => this.onPress.dispatch())), this.timeline = new C, this.content = new Q.W2, this.overlay = new u.TC, this.overlay.beginFill(0, .75), this.overlay.drawRect(0, 0, this.game.config.get("application.width"), this.game.config.get("application.height")), this.overlay.endFill(), this.title = new $.j, this.title.anchor.set(.5), this.value = new v.Xz("", {
                            fontName: "WinFont"
                        }), this.value.anchor = .5, this.light = new ws(this.game.loader.getAsset("effectBigWin")), this.light.pivot.set(this.light.width / 2, this.light.height / 2), this.light.position.set(-70, 0), this.light.alpha = 0, this.coins = new ws(this.game.loader.getAsset("effectGiantWin")), this.coins.pivot.set(this.coins.width / 2, this.coins.height / 2), this.coins.alpha = 0, this.content.addChild(this.light), this.content.addChild(this.coins), this.content.addChild(this.title), this.content.addChild(this.value), this.addChild(this.overlay), this.addChild(this.content)
                    }
                    show(t, e) {
                        var i = 0;
                        ...
                        return new Promise((n => {
                            ...
                            this.timeline.to(this.overlay, .35, {
                                ...
                                onUpdate: () => {
                                    !s && t === ye && a.coins > e / 2 && (this.title.texture = this.game.loader.getAsset("textGiantWin"), s = !0, this.coins.play("animation", !0), this.coins.alpha = 1, k.to(this.value, i / 2, {
                                        pixi: {
                                            scale: o + .2
                                        }
                ...
                new class extends class extends class extends class {
                    ...
                    initPopups() {
                        this.popupManager.add([new Ti, new Bi, new Pi, new Si, new Zi, new Ci, new Oi, new Fi, new Ei, new ki, new Ri])
                    }
                    loadAssets(t) {
                            ...
                            if (t.action.emit("sound:click"), t.onPopupShow(), t.riskFeature.hide(), t.wallet.balance - t.store.get("buy").bet < 0) yield t.popupManager.show("PopupZeroBalance"), t.onPopupHide();
                                ...
                                try {
                                    if (s) {
                                        ...
                                        }), Vi.set(t.store.get("reward:feature", zi.Basic)), t.onRNBStart();
                    ...
                    beforeFreeSpinsPopup() {
                        this.waysBadge.hide(), this.slot.beforeFreeSpinsPopup(), this.background.beforeFreeSpinsPopup(), this.controls.beforeFreeSpinsPopup(), this.multiplier.hide(), this.multiplier.updateValue(this.store.get("reward:nextMultiplier", 2)), this.device.portrait && (this.multiplier.hide(), this.background.logo.alpha = 0)
                    }
                    afterFreeSpinsPopup() {
                    ...
                    start() {
                        ...
                        return (0, o.Z)((function*() {
                            ...
                            if (yield e.freeRound.start(), e.state.goTo("setup"), i || s) {
                                if (i || o) {
                                    e.slot.beforeFreeSpinsPopup(!0), e.device.portrait && (e.multiplier.hide(), e.background.logo.alpha = 0), e.multiplier.hide();
                    ...
                    reward() {
                        ...
                        return (0, o.Z)((function*() {
                            ...
                            if (Vi.isFreespin() && n.length > 0 && a ? (t.controls.disableButtonSpin(), t.slot.textTotalWin.once("show", (() => {
                                ...
                                var h, l;
                                yield t.delay(Ni.get("afterFreeSpins")), t.beforeFreeSpinsPopup(), yield t.freeOverlay.show(uo.END), yield t.delay(200);
                    ...
                    beforeSpin() {
                        ...
                        return (0, o.Z)((function*() {
                            ...
                            t.autoPlay.enabled || Vi.isFreespin() || e || (yield t.quickSpin.tryEnable())
                        }))()
                    }
                    afterReelsStop() {
                        var t = this.store.get("spin:isFast", !1),
                            e = "drop" === this.store.get("server:action") || "drop" === this.store.get("server:nextAction");
                        !t || e || this.autoPlay.enabled || Vi.isFreespin() || this.quickSpin.update()
                    }
                }
            },
            3020: () => {},
    ...
    n.m = s, t = [], n.O = (e, i, s, o) => {
    ...
    }), t), n.o = (t, e) => Object.prototype.hasOwnProperty.call(t, e), e = {}, i = "primal_bet_rockways:", n.l = (t, s, o, a) => {
        if (e[t]) e[t].push(s);
        else {
            var r, h;
            if (void 0 !== o)
        ...
        var e = (e, i) => {
            ...
            i = self.webpackChunkprimal_bet_rockways = self.webpackChunkprimal_bet_rockways || [];
