...
(() => {
    var t, e, i, s = {
            1621: (t, e, i) => {
                ...
                const Di = [...[{
                    ...
                    url: "assets/images/logo_mobile.png",
                    name: "logoMobile",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                ...
                class js extends Zs {
                    constructor(t) {
                        ...
                        })), this.betLevel = t, this.betLevelText = this.addChild(new Pe("", Ls(Ls({}, Is.Common), {}, {
                            default: Ls(Ls({}, Is.Common.default), {}, {
                                align: "left"
                            })
                ...
                class Ys extends Pe {
                    constructor() {
                        super("", Hs(Hs({}, Is.Common), {}, {
                            default: Hs(Hs({}, Is.Common.default), {}, {
                                align: "right"
                            })
                        }))
                    }
                ...
                class to extends Os {
                    constructor() {
                        ...
                        this.background = $.j.from("data:image/png;base64,"), this.background.alpha = .4, this.background.anchor.set(0, 1), this.background.position.set(0, this.game.viewport.height), this.buttonMenu = new fs, this.buttonMenu.position.set(77, 1013), this.buttonMaxBet = new js(this.game.betLevel), this.buttonMaxBet.position.set(213, 1013), this.buttonAutoPlay = new bs, this.buttonAutoPlay.position.set(833, 1013), this.buttonQuickSpin = new ws, this.buttonQuickSpin.position.set(1084, 1014), this.buttonSound = new Fs, this.buttonSound.position.set(1840, 1012), this.buttonSpin = function() {
                            ...
                            i.play("normal", !1), e.addChild(i), e.onClick.add(o), e.onHover.add((() => {
                                i.play("hover", !1)
                            })), e.onLeave.add((() => {
                                i.play("normal", !1)
                            }));
                            ...
                            function a() {
                                Gi.isFreespin() || (i.play("normal", !1), e.enable(), s.enable())
                            }
                ...
                class uo extends Os {
                    constructor() {
                        ...
                        })), this.buttonAccept = new ys, this.buttonQuickSpin = new ws, this.autoPlayButton = new bs, this.autoPlayButton.scale.set(1.6), this.betButton = new Zs, this.betButton.disable(), this.betButton.onClick.add((() => this.game.action.emit("clickMaxBet"))), this.game.action.on("update:win", (() => {
                ...
                class ko extends(Gt(H.W2)) {
                    constructor() {
                        ...
                        var t = this.game.loader.getAsset("symbols_static", "girl");
                        this._payTableSymbol1 = new $.j(t), this._payTableSymbol1.position.set(240, this._sectionTitle.y + this._sectionTitle.height + 30), this._payTableSymbol2 = new $.j(t), this._payTableSymbol2.position.set(240, this._payTableSymbol1.y + this._payTableSymbol1.height + 30), this._payTableParagraph1 = new bo(this.game.i18n.t("PaytableSectionMassivePayDesc1")), this._payTableParagraph1.position.set(0, this._payTableSymbol1.y + (this._payTableSymbol1.height - this._payTableParagraph1.height) / 2), this._payTableParagraph2 = new bo(this.game.i18n.t("PaytableSectionMassivePayDesc2")), this._payTableParagraph2.position.set(0, this._payTableSymbol2.y + (this._payTableSymbol2.height - this._payTableParagraph2.height) / 2), this._payTableParagraph3 = new bo(this.game.i18n.t("PaytableSectionMassivePayContent1")), this._payTableParagraph3.position.set(0, this._payTableSymbol2.y + this._payTableSymbol2.height + 30);
                        var e = {
                            default: {
                                fill: "white",
                                fontSize: 36,
                        ...
                        this._payOutText1 = new Pe(this.game.i18n.t("PaytableSectionMassivePayPayout1"), e), this._payOutText1.position.set(500, this._payTableSymbol1.y + (this._payTableSymbol1.height - this._payOutText1.height) / 2), this._payOutText2 = new Pe(this.game.i18n.t("PaytableSectionMassivePayPayout2"), e), this._payOutText2.position.set(500, this._payTableSymbol2.y + (this._payTableSymbol2.height - this._payOutText2.height) / 2), this.addChild(this._sectionTitle), this.addChild(this._payTableParagraph1), this.addChild(this._payTableParagraph2), this.addChild(this._payTableParagraph3), this.addChild(this._payTableSymbol1), this.addChild(this._payTableSymbol2), this.addChild(this._payOutText1), this.addChild(this._payOutText2)
                    }
                    resize() {
                        this.game.device.desktop || (this.game.device.landscape ? (this._payTableSymbol1.scale.set(1.3), this._payTableSymbol1.position.set(460, this._sectionTitle.y + this._sectionTitle.height + 30), this._payTableSymbol2.scale.set(1.3), this._payTableSymbol2.position.set(460, this._payTableSymbol1.y + this._payTableSymbol1.height + 30), this._payTableParagraph1.position.set(0, this._payTableSymbol1.y + (this._payTableSymbol1.height - this._payTableParagraph1.height) / 2), this._payTableParagraph2.position.set(0, this._payTableSymbol2.y + (this._payTableSymbol2.height - this._payTableParagraph2.height) / 2), this._payTableParagraph3.position.set(0, this._payTableSymbol2.y + this._payTableSymbol2.height + 30), this._payOutText1.scale.set(1.3), this._payOutText1.position.set(800, this._payTableSymbol1.y + (this._payTableSymbol1.height - this._payTableParagraph1.height) / 2), this._payOutText2.scale.set(1.3), this._payOutText2.position.set(800, this._payTableSymbol2.y + (this._payTableSymbol2.height - this._payTableParagraph2.height) / 2)) : (this._payTableSymbol1.scale.set(1.2), this._payTableSymbol1.position.set(430, this._sectionTitle.y + this._sectionTitle.height + 30), this._payTableSymbol2.scale.set(1.2), this._payTableSymbol2.position.set(430, this._payTableSymbol1.y + this._payTableSymbol1.height + 30), this._payTableParagraph1.position.set(0, this._payTableSymbol1.y + (this._payTableSymbol1.height - this._payTableParagraph1.height) / 2), this._payTableParagraph2.position.set(0, this._payTableSymbol2.y + (this._payTableSymbol2.height - this._payTableParagraph2.height) / 2), this._payTableParagraph3.position.set(0, this._payTableSymbol2.y + this._payTableSymbol2.height + 30), this._payOutText1.scale.set(1.2), this._payOutText1.position.set(720, this._payTableSymbol1.y + (this._payTableSymbol1.height - this._payTableParagraph1.height) / 2), this._payOutText2.scale.set(1.2), this._payOutText2.position.set(720, this._payTableSymbol2.y + (this._payTableSymbol2.height - this._payTableParagraph2.height) / 2)))
                    }
                }
                class Co extends(Gt(H.W2)) {
                    constructor(t) {
                        ...
                        if (! function(t, i) {
                            ...
                            if (e.push({
                                ...
                                var n = new As(Lt.loader.getAsset(o.assetName)),
                                    a = n.width / 2,
                                    h = n.height / 2;
                                if (n.name = o.assetName, n.pivot.set(a, h), n.position.set(i + a, s + h), n.alpha = 1, o.skin && n.changeSkin(o.skin), t.addChild(n), "string" == typeof o.effectName) n.play(o.effectName, !1);
                                else {
                ...
                class Ho extends Ro {
                    ...
                    init() {
                        ...
                        this.slotData = {
                            ...
                            n.push([]), t.forEach((t => {
                                ...
                                i.changeSkin("scatter"), i.position.set(t.x, t.y), i.renderable = !1, a.addChild(i), n[e].push(i)
                            }))
                        })), {
                            getContainer: () => a,
                        ...
                        }), this.textFreeLeft = new _o, this.textFreeLeft.container.position.set(652, 660), this.textTotalWin = new Mo(.8), this.textTotalWin.position.set(652, 660), this.textLineWin = new Lo, this.addChild(this.reelsContainer), this.addChild(this.frames.container), this.addChild(this.lines), this.addChild(Do()), this.addChild(this.textLineWin.container), this.addChild(this.scatterWaiting.getContainer()), this.addChild(this.textTotalWin), this.addChild(this.textFreeLeft.container)
                    }
                    setupEvents() {
                    ...
                    resize() {
                        this.game.device.desktop || this.game.device.landscape ? (this.scale.set(1), this.position.set(960, 70)) : (this.scale.set(.759375), this.position.set(540, 303.75))
                    }
                }
                class Yo extends(Gt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "onPress", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "value", void 0), (0, n.Z)(this, "timeline", void 0), (0, n.Z)(this, "light", void 0), (0, n.Z)(this, "coins", void 0), this.visible = !1, this.interactive = !0, this.onPress = new(x()), this.game.interaction.click(this, (() => this.onPress.dispatch())), this.timeline = new C, this.content = new H.W2, this.overlay = new u.TC, this.overlay.beginFill(0, .75), this.overlay.drawRect(0, 0, 1920, 1080), this.overlay.endFill(), this.title = new $.j, this.title.anchor.set(.5), this.value = new v.Xz("", {
                            fontName: "WinFont"
                        }), this.value.anchor = .5, this.light = new As(this.game.loader.getAsset("backgroundAnimation")), this.light.pivot.set(0, this.game.config.get("application.height")), this.light.alpha = 0, this.coins = new As(this.game.loader.getAsset("backgroundAnimation")), this.coins.pivot.set(0, this.game.config.get("application.height")), this.coins.alpha = 0, this.content.addChild(this.title), this.content.addChild(this.value), this.addChild(this.overlay), this.addChild(this.light), this.addChild(this.coins), this.addChild(this.content)
                    }
                    show(t, e) {
                        var i = this;
                        return (0, o.Z)((function*() {
                            ...
                            return i.value.scale.set(n), new Promise((a => {
                                ...
                                i.timeline.to(i, .35, {
                                    ...
                                    onUpdate: () => {
                                        !o && t === we && h.coins > e / 2 && (i.title.texture = i.game.loader.getAsset("textGiantWin"), o = !0, i.coins.play("win_giant", !0), i.coins.alpha = 1, k.to(i.value, s / 2, {
                                            pixi: {
                                                scale: n + .1
                                            }
                ...
                new class extends class extends class extends class {
                    ...
                    reward() {
                        ...
                        return (0, o.Z)((function*() {
                            ...
                            } else t.store.get("free:isEnd", !1) && (yield t.delay(Ni.get("free_end")), t.beforeFreeSpinsPopup(), yield t.freeOverlay.show(ao.END), yield t.delay(200));
    ...
    n.m = s, t = [], n.O = (e, i, s, o) => {
    ...
    }), t), n.o = (t, e) => Object.prototype.hasOwnProperty.call(t, e), e = {}, i = "wild_spirit:", n.l = (t, s, o, a) => {
        if (e[t]) e[t].push(s);
        else {
            var h, r;
            if (void 0 !== o)
        ...
        var e = (e, i) => {
            ...
            i = self.webpackChunkwild_spirit = self.webpackChunkwild_spirit || [];
