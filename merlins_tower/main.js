...
(() => {
            ...
            9952: (t, e, i) => {
                ...
                class w {
                    ...
                    static loadFromBuffer(t) {
                        var e, i, s, o, n, a, h, r, l, d, c, u, p, g, A, m, v, b, f, y = null !== (e = null === (i = t.metadata) || void 0 === i || null === (s = i.font) || void 0 === s ? void 0 : s.family) && void 0 !== e ? e : t.name;
                ...
                class U {
                    ...
                    readSkeletonData(t, e) {
                        ...
                        var s = i.readString(),
                            o = N(s),
                            n = null;
                        if (o === M.VER38 && (n = new D.SkeletonBinary(new D.AtlasAttachmentLoader(t))), (i = new W.BinaryInput(e)).readInt32(), i.readInt32(), (o = N(s = i.readString())) !== M.VER40 && o !== M.VER41 || (n = new L.SkeletonBinary(new L.AtlasAttachmentLoader(t))), !n) {
                ...
                class z {
                    ...
                    readSkeletonData(t, e) {
                        var i = e.skeleton.spine,
                            s = N(i),
                            o = null;
                        if (s === M.VER37 && (o = new _.SkeletonJson(new _.AtlasAttachmentLoader(t))), s === M.VER38 && (o = new D.SkeletonJson(new D.AtlasAttachmentLoader(t))), s !== M.VER40 && s !== M.VER41 || (o = new L.SkeletonJson(new L.AtlasAttachmentLoader(t))), !o) {
                ...
                var G = i(512),
                    ...
                    et = i(798),
                    it = i(5277);
                u.TC.nextRoundedRectBehavior = !0, m.xv.nextLineHeightBehavior = !0, c.R.add(p.bx, g.B9, d.Bv, a.c, h.Q, r.T, l.O, v.vl, A.o, V, w, Z), window.PIXI = s;
                var st = i(3233),
                    ot = i.n(st);
                ...
                class Ne extends(Vt(H.W2)) {
                    ...
                    addSections() {
                        this.content.addChild(new Ie), this.content.addChild(new De), this.content.addChild(new Le), this.addAutoPlaySection(), this.content.addChild(new We), this.content.addChild(new Me), this.content.addChild(new je)
                    }
                    addAutoPlaySection() {
                ...
                const Di = [...[{
                    ...
                    metadata: {
                        ...
                        audioMetadata: {
                            type: "background",
                            volume: _i.get("background_free"),
                            loop: !0
                        }
                    }
                }, {
                    url: "assets/audio/expandWildReel.mp3",
                    name: "expandWildReel",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"],
                        audioMetadata: {
                            type: "effects",
                            volume: _i.get("expand_wild_reel"),
                            loop: !1
                        }
                    }
                }, {
                    ...
                    url: "assets/images/table.png",
                    name: "slotBackground",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/table_shelf.png",
                    name: "tableShelf",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                    ...
                    url: "assets/images/branch1.png",
                    name: "branch1",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/branch2.png",
                    name: "branch2",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/effects/fs_wild/skeleton.json",
                    name: "fsWildEffect",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                    ...
                    url: "assets/images/effects/bg_fs/skeleton.json",
                    name: "freeSpinsEffect",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/effects/background/skeleton.json",
                    name: "effectAnimateBackground",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/effects/autoplay/skeleton.json",
                    name: "effectAutoPlay",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                    ...
                    url: "assets/images/effects/wild_big/skeleton.json",
                    name: "effectWild",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                        ...
                        layout: {
                            default: [{
                                ...
                                animation: {
                                    ...
                                    effectName: {
                                        normal: "win",
                                        free: "scatter_fs_start",
                                        endFree: "scatter_fs_end"
                                    }
                                }
                            }, {
                                textureAtlas: "symbols_static",
                        ...
                        init() {
                            function t(t) {
                                var e = ot()(t, "win", 0),
                                    i = ot()(t, "scatters", !1),
                                    s = ot()(t, "wildReels", []);
                                Lt.store.set("reward:win", e), Lt.store.set("reward:lines", ot()(t, "lines", [])), Lt.store.set("reward:reels", ot()(t, "reels", t.error ? Gi : [])), Lt.store.set("reward:nReels", ot()(t, "nReels", t.error ? Qi : [])), Lt.store.set("reward:fsReels", ot()(t, "fsReels", [])), Lt.store.set("reward:preReels", ot()(t, "preSpin.reels", [])), Lt.store.set("reward:scatters", i), Lt.store.set("reward:wildReels", s), Lt.store.set("reward:isWin", e > 0 || i), Lt.store.set("reward:numberWinSymbol", ot()(t, "winSyms", 0));
                                var o = ot()(t, "feature", zi.Basic);
                                Lt.store.set("reward:feature", o)
                            }
                            Lt.store.set("reward:win", 0), Lt.store.set("reward:isWin", !1), Lt.store.set("reward:lines", []), Lt.store.set("reward:reels", []), Lt.store.set("reward:nReels", []), Lt.store.set("reward:fsReels", []), Lt.store.set("reward:preReels", []), Lt.store.set("reward:scatters", !1), Lt.store.set("reward:wildReels", []), Lt.store.set("reward:numberWinSymbol", 0), Lt.store.set("reward:feature", ""), Lt.server.on("response:init", t), Lt.server.on("response:spin", t)
                        }
                    },
                    Yi = {
                        init() {
                ...
                class Ki extends R {
                    ...
                    _setupEvents() {
                        Lt.action.on("sound:win", (t => {
                            ...
                            this.scatterWheel.play()
                        })), Lt.action.on("sound:expandWildReel", (() => {
                            this.expandWildReel.play()
                ...
                const ls = JSON.parse('{"AutoPlaySettingsStopCondButtonReset":"Reset","AutoPlaySettingsStopCondCheckboxBalance":"If Balance Increases By","AutoPlaySettingsStopCondCheckboxBalanceDrop":"If Balance Decreases By","AutoPlaySettingsStopCondCheckboxFeatureBonus":"If Bonus Game Won","AutoPlaySettingsStopCondCheckboxFeatureFreeSpin":"If Free Spins Won","AutoPlaySettingsStopCondCheckboxWin":"If Win","AutoPlaySettingsStopCondCheckboxWinAny":"Any","AutoPlaySettingsStopCondCheckboxWinBig":"Big","AutoPlaySettingsStopCondCheckboxWinGiant":"Giant","AutoPlaySettingsStopCondTitle":"STOP AUTOPLAY","AutoPlaySettingsSubTitle":"Setup your best autoplay conditions","AutoPlaySettingsTitle":"AUTOPLAY","BetSettingsLines":"LINES\\n<value>%s</value>","BetSettingsTitle":"BET SETTINGS","BetSettingsWays":"WAYS\\n<value>%s</value>","ControlsDesktopAutoPlayStart":"AUTOPLAY","ControlsDesktopAutoPlayStop":"STOP AUTO","ControlsDesktopBalance":"BALANCE%s\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopBet":"BET %s\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopFreeRoundLeft":"FREE ROUND\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopFreeRoundWin":"TOTAL WIN %s\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopFreeRoundWinEmpty":"TOTAL WIN","ControlsDesktopFreeSpinsLast":"FREE SPINS LEFT\\n<delimiter> \\n</delimiter><value>LAST</value>","ControlsDesktopFreeSpinsLeft":"FREE SPINS LEFT\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopLines":"LINES\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopMaxBet":"MAX BET","ControlsDesktopTotalWin":"TOTAL WIN %s\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopWays":"WAYS\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopWin":"WIN %s\\n<delimiter> \\n</delimiter><value>%s</value>","Currency":"CURRENCY\\n<value>%s</value>","GameRulesAdvancedAutoPlayContent":"Advanced autoplay settings are available in the section with standard autoplay settings. You can set the conditions for stopping the game in automatic mode:\\n\\n<bold>if win any/big/giant</bold> - autoplay will be stopped after any/big/giant win\\n\\n<bold>if balance increased by 10%-100%</bold> - autoplay will stop when your balance increases by the selected %\\n\\n<bold>if balance decreased by 10%-100%</bold> - autoplay will be interrupted when your balance decreases by the selected %\\n\\nClick <bold>Reset</bold> to reset all autoplay settings","GameRulesAdvancedAutoPlayTitle":"Advanced Autoplay Settings","GameRulesAutoPlayContent":"Select the number of game rounds to play in automatic mode by pressing the button with the corresponding number, or press the button with the infinity sign to play in automatic mode until the autoplay is manually canceled or until the balance runs out. Your choice must be confirmed with the Start button.","GameRulesAutoPlayTitle":"Autoplay Options","GameRulesBestExperience":"Please note that you can only play one game at a time on each account. Therefore, you cannot play a game on more than one device, or multiple games on the same device simultaneously. Doing so may lead to various errors.\\n\\nFor the best gaming experience, we recommend using the latest version of the relevant software.","GameRulesGeneralRTP":"Theoretical RTP: %s %","GameRulesGeneralTitle":"General Info","GameRulesInterfaceAutoPlay":"Click to go to autoplay menu","GameRulesInterfaceBalance":"Here is your current balance","GameRulesInterfaceBetLevel":"Your current bet and a button to go to the bet size selection menu","GameRulesInterfaceContent":"All buttons of the game interface are listed below. Please note that the appearance and location of the buttons may differ slightly depending on the format in which the game is launched and what feature it is currently in.","GameRulesInterfaceMenu":"Click to access the game menu","GameRulesInterfaceQuickSpin":"Click to enable/disable quick spin","GameRulesInterfaceSound":"Turn game sound on/off and adjust sound volume","GameRulesInterfaceSpin":"Click to start the game round at the current bet. In the desktop version of the game, the button may have an alternative design","GameRulesInterfaceTitle":"Game Interface","GameRulesInterfaceWin":"Here is the win in the current game round","GameRulesSettingsContent":"To go to the settings menu, click the cogwheel icon in the game menu","GameRulesSettingsContentItemBackgroundSound":"<bold>Background music</bold> - turns on/off background music in the game","GameRulesSettingsContentItemFullscreen":"<bold>Full Screen</bold> - enables/disables full screen mode","GameRulesSettingsContentItemGameSound":"<bold>Game sound</bold> - turns on/off the sound effects of the game","GameRulesSettingsContentItemQuickSpin":"<bold>Quick Spin</bold> - turns on/off the function of the accelerated mode of rotation and stop of the reels","GameRulesSettingsTitle":"Game Settings","GameSettingsBackgroundSounds":"Background Music","GameSettingsFullscreen":"Full Screen","GameSettingsGameSounds":"Game Sounds","GameSettingsIntroScreen":"Intro Screen","GameSettingsLeftHand":"Left Hand Mode","GameSettingsQuickSpin":"Quick Spin","GameSettingsRiskFeatureCheckbox":"Risk&Buy","GameSettingsTitle":"GAME SETTINGS","IntroScreenHideButtonText":"Don\'t show next time","IntroScreenLoaderText":"LOADING","MenuDesktopButtonFullscreen":"FULLSCREEN","MenuDesktopButtonHome":"HOME","MenuDesktopButtonPaytable":"PAYTABLE","MenuDesktopButtonQuickspin":"QUICKSPIN","MenuDesktopButtonSound":"SOUND","MenuGameRules":"GAME INFORMATION","MenuMobileBetSettingsTitle":"BET SETTINGS","MenuMobileGameSettingsLeftHand":"Left Hand Mode","MenuMobileGameSettingsQuickspin":"Quick Spin","MenuMobileGameSettingsSounds":"Game Sounds","MenuMobileGameSettingsTitle":"GAME SETTINGS","MenuMobilePaytableTitle":"PAYTABLE","MenuPaytable":"PAYTABLE","MenuSettings":"SETTINGS","NetPositionTitle":"Net Position: %s","PopupActionClose":"Close","PopupActionContinue":"Continue","PopupActionEnable":"Enable","PopupActionNo":"No","PopupActionReload":"Reload","PopupActionYes":"Yes","PopupFreeRoundEndMessage":"The next spins will use your bonus amount","PopupFreeRoundEndTitle":"Free Rounds Finished","PopupFreeRoundLastMessage":"Congratulations, you have\\n last free round","PopupFreeRoundStartMessage":"Congratulations, you have\\n%s free rounds","PopupFreeRoundStartTitle":"Free Rounds Bonus","PopupFreeSpinsButton":"CLICK ANYWHERE TO CONTINUE","PopupFreeSpinsStopDescription":"<value>%s FREE SPINS</value> PLAYED","PopupFreeSpinsStopDescriptionNew":"%s Free Spins played","PopupFreeSpinsTitle":"CONGRATULATIONS","PopupFreeSpinsTitleNew":"CONGRATULATIONS! YOU WON","PopupFreeSpinsTitleRestore":"IN-GAME FEATURE RESTORED!","PopupFreeSpinsWinRestore":"<value>%s FREE SPINS</value> LEFT","PopupFreeSpinsWinRestoreLast":"<value>LAST FREE SPIN</value> LEFT","PopupFreeSpinsWinStart":"YOU WON <value>%s FREE SPINS</value>","PopupFreeSpinsWinStartNew":"%s FREE SPINS","PopupFreeSpinsWinStop":"YOU WON <value>%s</value>","PopupFreeSpinsWinStopNew":"<value>%s</value>","PopupMaxLimitMessage":"Bet exceeded max bet limit.","PopupMaxLimitTitle":"Max limit","PopupNetworkErrorMessage":"Please reload the game.","PopupNetworkErrorTitle":"Connection Lost","PopupQuickSpinMessage":"It seems you prefer to play a bit faster.\\nWould you like to enable Quick Spin?","PopupQuickSpinTitle":"Quick Spin","PopupRestoreMessage":"In-game feature restored!","PopupRiskNBuyContentBuy":"Buy in a feature for %s\\nthat will play at the bet %s","PopupRiskNBuyContentRisk":"Take the risk of winning %s\\nto get a feature at the bet %s","PopupRiskNBuyTitleBuy":"BUY IN FEATURE","PopupRiskNBuyTitleRisk":"RISK FEATURE","PopupSoundMessage":"Play with sound?","PopupSpendingBudgetMessage":"You have reached your play limit.\\nWelcome back later.","PopupSpendingBudgetTitle":"Play limit","PopupUnexpectedErrorMessage":"An unexpected situation.\\nReload the page.","PopupUnexpectedErrorTitle":"Unexpected situation","PopupZeroBalanceMessage":"Please change your BET LEVEL or top up your balance","PopupZeroBalanceTitle":"Insufficient funds","RiskNBuyBuyFor":"BUY FOR %s","RiskNBuyFreeSpinsText":"FREE SPINS","RiskNBuyOnBet":"ON BET %s","RiskNBuySubHeader":"RISK YOUR WIN\\nTO PLAY","StatusBarMobileBalance":"BALANCE %s\\n","StatusBarMobileBet":"BET %s\\n","StatusBarMobileFreeLast":"FREE SPINS LEFT\\n<value>LAST</value>","StatusBarMobileFreeLeft":"FREE SPINS LEFT\\n<value>%s</value>","StatusBarMobileFreePlayed":"FREE SPINS PLAYED\\n","StatusBarMobileFreeRoundLeft":"FREE ROUND\\n","StatusBarMobileTotalWin":"TOTAL WIN %s\\n","StatusBarMobileWin":"WIN %s\\n","TimeElapsedTitle":"Time Elapsed: %s"}'),
                    ds = JSON.parse('{"ControlsDesktopFreeSpinsPlayed":"FREE SPINS PLAYED\\n<delimiter> \\n</delimiter><value>%s</value>","PaytableSectionBetLinesContent1":"Only the highest win per bet line is paid. All prizes are for combinations left to right, beginning from the leftmost reel. The payout values are based on the currently selected bet and change proportionally with its changes. The game is played with fixed bet lines. Malfunction voids all pays and plays.","PaytableSectionBetLinesTitle":"Bet lines","PaytableSectionFreeContent1":"The feature will continue as long as 2 Scatter symbols will appear on the screen.","PaytableSectionFreeContent2":"Free spins play automatically at the bet at which they were won. All payments are made in accordance with the paytable.","PaytableSectionFreeContent3":"Wild symbols will be transformed into a Wild Reels when they appear on the screen during the Infinite Free Spins feature. Wild reels are a stack of Wilds, height in all of the whole reel. Wild reels substitutes all symbols except for Scatter symbols.","PaytableSectionFreeTitle":"Infinite Free Spins feature","PaytableSectionPayoutTitle":"Symbol payout values","PaytableSectionScatterContent1":"Scatter symbols can appear in both main game and Free Spins feature on 1st and 5th reels only. 2 Scatter symbols in base game start Infinite Free Spins feature.","PaytableSectionScatterTitle":"Scatter symbol","PaytableSectionWildContent1":"Wild symbols substitute all symbols except for Scatter symbols.","PaytableSectionWildContent2":"Wild symbols can appear in both main game and Free Spins on 2, 3 and 4th reels only.","PaytableSectionWildTitle":"Wild symbols","PopupFreeSpinsDescription":"2 SCATTERS WILL FINISH FEATURE","PopupFreeSpinsWinStart":"YOU WON\\n<value>INFINITE FREE SPINS</value>"}');
                ...
                class ms extends(Vt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "backgroundLTextureFree", void 0), (0, n.Z)(this, "backgroundLTextureNormal", void 0), (0, n.Z)(this, "backgroundPTextureFree", void 0), (0, n.Z)(this, "backgroundPTextureNormal", void 0), (0, n.Z)(this, "backgroundTextureLandscape", void 0), (0, n.Z)(this, "backgroundTexturePortrait", void 0), (0, n.Z)(this, "bgStatic", void 0), (0, n.Z)(this, "featureBackground", void 0), (0, n.Z)(this, "logoFreeSpin", void 0), (0, n.Z)(this, "logoNormal", void 0), (0, n.Z)(this, "stand", void 0), this.backgroundLTextureNormal = this.game.loader.getAsset("bgln"), this.backgroundLTextureFree = this.game.loader.getAsset("bglf"), this.backgroundPTextureNormal = this.game.loader.getAsset("bgpn"), this.backgroundPTextureFree = this.game.loader.getAsset("bgpf"), this.backgroundTextureLandscape = this.backgroundLTextureNormal, this.backgroundTexturePortrait = this.backgroundPTextureNormal, this.background = new $.j(this.backgroundTextureLandscape), this.background.name = "background", this.featureBackground = new $.j(this.backgroundLTextureFree), this.featureBackground.name = "featureBackground", this.featureBackground.alpha = 0, this.logoNormal = new $.j(this.game.loader.getAsset("logo")), this.logoNormal.scale.set(.6), this.logoNormal.name = "logo", this.logoNormal.anchor.x = .5, this.logoNormal.x = this.background.width / 2, this.logoFreeSpin = new $.j(this.game.loader.getAsset("logo_fs")), this.logoFreeSpin.scale.set(.5), this.logoFreeSpin.name = "logo", this.logoFreeSpin.anchor.x = .5, this.logoFreeSpin.x = this.background.width / 2, this.logoFreeSpin.alpha = 0, this.stand = new $.j(this.game.loader.getAsset("stand")), this.stand.y = this.background.height - this.stand.height, this.bgStatic = new As(this.game.loader.getAsset("bgStatic")), this.addChild(this.background), this.addChild(this.featureBackground), this.addChild(this.logoNormal), this.addChild(this.logoFreeSpin), this.addChild(this.stand), this.setupEvents()
                    }
                    setupEvents() {
                        this.game.action.on("state:setup_enter", (() => {
                            this.featureBackground.texture = this.game.device.portrait && !this.game.device.desktop ? this.backgroundPTextureFree : this.backgroundLTextureFree, this.game.store.get("free:isFree", !1) && (this.featureBackground.alpha = 1, this.logoNormal.alpha = 0, this.logoFreeSpin.alpha = 1)
                ...
                class js extends Rs {
                    constructor(t) {
                        ...
                        })), this.betLevel = t, this.betLevelText = this.addChild(new Pe("", Ls(Ls({}, _s.Common), {}, {
                            default: Ls(Ls({}, _s.Common.default), {}, {
                                align: "left"
                            })
                ...
                class Xs extends Pe {
                    ...
                    change(t) {
                        this.text = Lt.i18n.t("ControlsDesktopFreeSpinsPlayed", t)
                    }
                }
                ...
                class to extends Os {
                    constructor() {
                        ...
                        this.background = $.j.from("data:image/png;base64,"), this.background.alpha = .4, this.background.anchor.set(0, 1), this.background.position.set(0, this.game.viewport.height), this.buttonMenu = new fs, this.buttonMenu.position.set(77, 1013), this.buttonMaxBet = new js(this.game.betLevel), this.buttonMaxBet.position.set(213, 1013), this.buttonAutoPlay = new bs, this.buttonAutoPlay.position.set(833, 1013), this.buttonQuickSpin = new ys, this.buttonQuickSpin.position.set(1084, 1014), this.buttonSound = new Fs, this.buttonSound.position.set(1840, 1012), this.buttonSpin = function() {
                            ...
                            e.addChild(i), i.play("normal", !1), e.onClick.add(o), e.onHover.add((() => {
                                i.play("hover", !1)
                            })), e.onLeave.add((() => {
                                i.play("normal", !1)
                            }));
                        ...
                        }(t.btn_spin_active, t.btn_spin_active, t.btn_spin_active, t.btn_spin_active), this.buttonSpin.container.position.set(894, 950), this.buttonAccept = new ws, this.buttonAccept.position.set(958, 1013), this.textWin = new $s, this.textWin.anchor.x = .5, this.textWin.position.set(1400, 980), this.textBalance = new Ys, this.textBalance.anchor.x = 1, this.textBalance.position.set(1760, 980), this.freeRoundLeft = Vs(_s.Common), this.freeRoundLeft.container.position.set(1700, 1054), this.freeRoundTotalWin = Gs(_s.Common), this.freeRoundTotalWin.container.position.set(1400, 980), this.textFreeSpinPlayed = new Xs, this.textFreeSpinPlayed.visible = !1, this.textFreeSpinPlayed.anchor.x = .5, this.textFreeSpinPlayed.position.set(600, 980), this.textFreeSpinTotalWin = new Js, this.textFreeSpinTotalWin.visible = !1, this.textFreeSpinTotalWin.anchor.x = .5, this.textFreeSpinTotalWin.position.set(960, 955), this.addChild(this.background), this.addChild(this.textFreeSpinPlayed), this.addChild(this.textFreeSpinTotalWin), this.addChild(this.buttonMenu), this.addChild(this.buttonMaxBet), this.game.config.get("autoPlay.available", !0) && this.addChild(this.buttonAutoPlay), this.game.config.get("quickSpin.available", !0) && this.addChild(this.buttonQuickSpin), this.addChild(this.buttonSound), this.addChild(this.buttonSpin.container), this.addChild(this.buttonAccept), this.addChild(this.textWin), this.game.config.get("balanceHide", !1) || this.addChild(this.textBalance), this.addChild(this.freeRoundTotalWin.container), this.addChild(this.freeRoundLeft.container), this.textWin.update(this.game.wallet.coins), this.textBalance.update(this.game.wallet.balance), this.game.freeRound.onStart.once((t => {
                ...
                class uo extends Os {
                    constructor() {
                        super(), (0, n.Z)(this, "autoPlayButton", void 0), (0, n.Z)(this, "betButton", void 0), (0, n.Z)(this, "buttonAccept", void 0), (0, n.Z)(this, "buttonMenu", void 0), (0, n.Z)(this, "buttonQuickSpin", void 0), (0, n.Z)(this, "buttonSound", void 0), (0, n.Z)(this, "buttonSpin", void 0), (0, n.Z)(this, "onPressButtonSpin", void 0), (0, n.Z)(this, "state", void 0), (0, n.Z)(this, "statusBar", void 0), this.state = no.Normal, this.onPressButtonSpin = new(x()), this.statusBar = new lo, this.statusBar.changeState(this.state), this.game.freeRound.enabled ? (this.statusBar.update({
                        ...
                        })), this.buttonMenu = new fs, this.buttonSound = new Fs, this.buttonSpin = new co, this.game.interaction.hover(this.buttonSpin, (() => {
                        ...
                        })), this.buttonAccept = new ws, this.buttonQuickSpin = new ys, this.autoPlayButton = new bs, this.autoPlayButton.scale.set(1.6), this.betButton = new Rs, this.betButton.disable(), this.betButton.onClick.add((() => this.game.action.emit("clickMaxBet"))), this.game.action.on("update:win", (() => {
                            ...
                            this.state = no.Free, this.buttonMenu.hide(), this.buttonSpin.visible = !1, this.betButton.hide(), this.autoPlayButton.hide(), this.buttonSound.show(), this.statusBar.changeState(this.state), this.statusBar.update({
                                type: oo.Win,
                                value: 0
                            }), this.statusBar.update({
                                type: oo.TotalWin,
                                ...
                                type: oo.FreePlayed,
                                value: this.game.store.get("free:played", 0) + 1
                            }), this.resize()
                        })), this.game.action.on("free:start", (() => {
                            this.state = no.Free, this.buttonMenu.hide(), this.buttonSpin.visible = !1, this.betButton.hide(), this.autoPlayButton.hide(), this.buttonSound.show(), this.statusBar.changeState(this.state), this.statusBar.update({
                                type: oo.Win,
                    ...
                    show(t) {
                        ...
                        return new Promise((i => {
                            ...
                            if (t === ao.START) s = "free:start", this.game.action.emit("sound:free_start"), this._title.text = this.game.i18n.t("PopupFreeSpinsTitle"), this._win.text = this.game.i18n.t("PopupFreeSpinsWinStart"), this._description.text = this.game.i18n.t("PopupFreeSpinsDescription"), this._buttonText.text = this.game.i18n.t("PopupFreeSpinsButton"), e && (this.tweenAutoTimeout = k.to(this._buttonText, 1, {
                                ...
                                var o = this.game.helpers.toMoney(this.game.wallet.freespinCoins),
                                    n = this.game.store.get("free:count", 0);
                                this._title.text = this.game.i18n.t("PopupFreeSpinsTitle"), this._win.text = this.game.i18n.t("PopupFreeSpinsWinStop", "".concat(o, "\t").concat(this.game.i18n.currency())), this._description.text = this.game.i18n.t("PopupFreeSpinsStopDescription", n), this._buttonText.text = this.game.i18n.t("PopupFreeSpinsButton"), e && (this.tweenAutoTimeout = k.to(this._buttonText, 1, {
                                    pixi: {
                                        scale: 1.1
                                    },
                                    repeat: 5,
                            ...
                            } else t === ao.RESTORE && (s = "free:restore", this.game.action.emit("sound:free_start"), this._title.text = this.game.i18n.t("PopupFreeSpinsTitleRestore"), this._win.text = this.game.i18n.t("PopupFreeSpinsWinStart"), this._description.text = this.game.i18n.t("PopupFreeSpinsDescription"), this._buttonText.text = this.game.i18n.t("PopupFreeSpinsButton"));
                ...
                class fo extends(Vt(H.W2)) {
                    constructor(t) {
                        var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [];
                        super(), (0, n.Z)(this, "_payTableBetLineBoxs", void 0), (0, n.Z)(this, "_payTableParagraph", void 0), (0, n.Z)(this, "_payTableTitle", void 0), this._payTableBetLineBoxs = new H.W2, this._payTableTitle = new wo(this.game.i18n.t("PaytableSectionBetLinesTitle").toUpperCase()), this._payTableParagraph = new bo(this.game.i18n.t("PaytableSectionBetLinesContent1")), t.forEach(((t, i) => {
                ...
                class So extends(Vt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "_sectionParagraph", void 0), (0, n.Z)(this, "_sectionTitle", void 0), this._sectionTitle = new wo(this.game.i18n.t("PaytableSectionFreeTitle").toUpperCase()), this._sectionTitle.position.set(0, 0), this._sectionParagraph = new bo(this.game.i18n.t("PaytableSectionFreeContent1") + "\n\n" + this.game.i18n.t("PaytableSectionFreeContent2") + "\n\n" + this.game.i18n.t("PaytableSectionFreeContent3")), this._sectionParagraph.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this.addChild(this._sectionTitle), this.addChild(this._sectionParagraph)
                    }
                    resize() {
                ...
                class Co extends(Vt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "sectionTitle", void 0), (0, n.Z)(this, "symbol10", void 0), (0, n.Z)(this, "symbol9", void 0), (0, n.Z)(this, "symbolA", void 0), (0, n.Z)(this, "symbolBear", void 0), (0, n.Z)(this, "symbolFox", void 0), (0, n.Z)(this, "symbolJ", void 0), (0, n.Z)(this, "symbolK", void 0), (0, n.Z)(this, "symbolQ", void 0), (0, n.Z)(this, "symbolSeal", void 0), (0, n.Z)(this, "symbolWalrus", void 0), (0, n.Z)(this, "symbols", void 0), this.sectionTitle = new wo(this.game.i18n.t("PaytableSectionPayoutTitle").toUpperCase()), this.symbolFox = new ko("P1"), this.symbolFox.position.set(0, this.sectionTitle.y + this.sectionTitle.height + 30), this.symbolBear = new ko("P2"), this.symbolBear.position.set(600, this.sectionTitle.y + this.sectionTitle.height + 30), this.symbolSeal = new ko("P3"), this.symbolSeal.position.set(0, this.symbolFox.y + this.symbolFox.height + 30), this.symbolWalrus = new ko("P4"), this.symbolWalrus.position.set(600, this.symbolBear.y + this.symbolBear.height + 30), this.symbolA = new ko("a"), this.symbolA.position.set(0, this.symbolSeal.y + this.symbolSeal.height + 30), this.symbolK = new ko("k"), this.symbolK.position.set(600, this.symbolWalrus.y + this.symbolWalrus.height + 30), this.symbolQ = new ko("q"), this.symbolQ.position.set(0, this.symbolA.y + this.symbolA.height + 30), this.symbolJ = new ko("j"), this.symbolJ.position.set(600, this.symbolK.y + this.symbolK.height + 30), this.symbol10 = new ko("10"), this.symbol10.position.set(0, this.symbolQ.y + this.symbolQ.height + 30), this.symbol9 = new ko("9"), this.symbol9.position.set(600, this.symbolJ.y + this.symbolJ.height + 30), this.symbols = [this.symbolFox, this.symbolBear, this.symbolSeal, this.symbolWalrus, this.symbolA, this.symbolK, this.symbolQ, this.symbolJ, this.symbol10, this.symbol9], this.addChild(this.sectionTitle, ...this.symbols)
                    }
                    updateBet(t) {
                        this.symbols.forEach((e => e.updateBet(t)))
                    }
                    resize() {
                        this.game.device.desktop || (this.game.device.landscape ? (this.symbolFox.position.set(0, this.sectionTitle.y + this.sectionTitle.height + 30), this.symbolBear.position.set(820, this.sectionTitle.y + this.sectionTitle.height + 30), this.symbolSeal.position.set(0, this.symbolFox.y + this.symbolFox.height + 30), this.symbolWalrus.position.set(820, this.symbolBear.y + this.symbolBear.height + 30), this.symbolA.position.set(0, this.symbolSeal.y + this.symbolSeal.height + 30), this.symbolK.position.set(820, this.symbolWalrus.y + this.symbolWalrus.height + 30), this.symbolQ.position.set(0, this.symbolA.y + this.symbolA.height + 30), this.symbolJ.position.set(820, this.symbolK.y + this.symbolK.height + 30), this.symbol10.position.set(0, this.symbolQ.y + this.symbolQ.height + 30), this.symbol9.position.set(820, this.symbolJ.y + this.symbolJ.height + 30)) : (this.symbolFox.position.set(0, this.sectionTitle.y + this.sectionTitle.height + 30), this.symbolBear.position.set(0, this.symbolFox.y + this.symbolFox.height + 30), this.symbolSeal.position.set(0, this.symbolBear.y + this.symbolBear.height + 30), this.symbolWalrus.position.set(0, this.symbolSeal.y + this.symbolSeal.height + 30), this.symbolA.position.set(0, this.symbolWalrus.y + this.symbolWalrus.height + 30), this.symbolK.position.set(0, this.symbolA.y + this.symbolA.height + 30), this.symbolQ.position.set(0, this.symbolK.y + this.symbolK.height + 30), this.symbolJ.position.set(0, this.symbolQ.y + this.symbolQ.height + 30), this.symbol10.position.set(0, this.symbolJ.y + this.symbolJ.height + 30), this.symbol9.position.set(0, this.symbol10.y + this.symbol10.height + 30)))
                    }
                }
                class Bo extends(Vt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "_sectionParagraph", void 0), (0, n.Z)(this, "_sectionTitle", void 0), (0, n.Z)(this, "_symbolScatter", void 0), this._sectionTitle = new wo(this.game.i18n.t("PaytableSectionScatterTitle").toUpperCase()), this._sectionTitle.position.set(0, 0), this._symbolScatter = new ko("scatter"), this._symbolScatter.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this._symbolScatter.withoutPayout(), this._sectionParagraph = new bo(this.game.i18n.t("PaytableSectionScatterContent1")), this._sectionParagraph.position.set(this._symbolScatter.x + this._symbolScatter.width, this._sectionTitle.y + this._sectionTitle.height + 30), this._sectionParagraph.setTagStyle("default", {
                            wordWrapWidth: 690
                ...
                class Po extends(Vt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "_sectionParagraph1", void 0), (0, n.Z)(this, "_sectionParagraph2", void 0), (0, n.Z)(this, "_sectionTitle", void 0), (0, n.Z)(this, "_symbol1", void 0), this._sectionTitle = new wo(this.game.i18n.t("PaytableSectionWildTitle").toUpperCase()), this._sectionTitle.position.set(0, 0), this._symbol1 = new ko("wild"), this._symbol1.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this._symbol1.withoutPayout(), this._sectionParagraph1 = new bo(this.game.i18n.t("PaytableSectionWildContent1")), this._sectionParagraph1.position.set(this._symbol1.x + this._symbol1.width, this._sectionTitle.y + this._sectionTitle.height + 30), this._sectionParagraph1.setTagStyle("default", {
                            wordWrapWidth: 690
                        }), this._sectionParagraph2 = new bo(this.game.i18n.t("PaytableSectionWildContent2")), this._sectionParagraph2.position.set(this._symbol1.x + this._symbol1.width, this._sectionParagraph1.y + this._sectionParagraph1.height + 30), this._sectionParagraph2.setTagStyle("default", {
                            wordWrapWidth: 690
                        }), this.addChild(this._sectionTitle, this._symbol1, this._sectionParagraph1, this._sectionParagraph2)
                    }
                    updateBet(t) {
                    ...
                    resize() {
                        this.game.device.desktop || (this.game.device.landscape ? (this._symbol1.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this._sectionParagraph1.position.set(this._symbol1.x + this._symbol1.width, this._sectionTitle.y + this._sectionTitle.height + 30), this._sectionParagraph1.setTagStyle("default", {
                            wordWrapWidth: 490
                        }), this._sectionParagraph2.position.set(0, this._sectionParagraph1.y + this._sectionParagraph1.height + 30), this._sectionParagraph2.position.set(this._symbol1.x + this._symbol1.width, this._sectionParagraph1.y + this._sectionParagraph1.height + 30), this._sectionParagraph2.setTagStyle("default", {
                            wordWrapWidth: 490
                            ...
                            wordWrapWidth: 390
                        }), this._sectionParagraph2.position.set(0, this._sectionParagraph1.y + this._sectionParagraph1.height + 30), this._sectionParagraph2.setTagStyle("default", {
                            wordWrapWidth: 390
                        })))
                    }
                }
                ...
                class Oo extends(Vt(H.W2)) {
                    constructor(t) {
                        var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [];
                        super(), (0, n.Z)(this, "lines", void 0), (0, n.Z)(this, "points", new Map), this.lines = t.map((t => this.addChild(new To(t)))), this.game.device.desktop && e.map((t => this.points.set(t.line, t.position.map((e => {
                            var i = this.addChild(new Fo(t.line));
                ...
                class Mo {
                    constructor() {
                        (0, n.Z)(this, "container", void 0), (0, n.Z)(this, "timeline", void 0), (0, n.Z)(this, "textValue", void 0), (0, n.Z)(this, "textDescription", void 0), this.timeline = new C, this.container = new H.W2, this.container.name = "TextFreeLeft", this.container.alpha = 0, this.textValue = new v.Xz("", {
                            fontName: "WinFont"
                        }), this.textValue.scale.set(.6), this.textValue.anchor = .5, this.textDescription = new $.j(Lt.loader.getAsset("textFreeSpinLeft")), this.container.addChild(this.textDescription), this.container.addChild(this.textValue)
                    }
                    show(t) {
                        ...
                        return new Promise((i => {
                            ...
                            }, this.textDescription.position.set(0, 0), this.textValue.text = "".concat(t), this.textValue.position.set(this.textDescription.x + this.textDescription.width / 2, 50 - this.textDescription.height), this.container.pivot.set(this.container.width / 2, 40), this.timeline.set(this.container, {
                                pixi: {
                                    alpha: 0
                                }
                            }).to(this.container, .5, {
                ...
                const Io = class extends Wo {
                    ...
                    wildReelPayment(t) {
                        ...
                        return (0, o.Z)((function*() {
                            if (Vi.isFreespin()) {
                                var i = e.slot.wildReels;
                                e.slot.reels.forEach((t => t.overlay())), Lt.action.emit("sound:expandWildReel"), t.forEach((t => {
                                    e.slot.reels[t].visibleSymbols.forEach(((i, s) => {
                                        var o = e.slot.wildTransform.children[t].children[s];
                                        i.visible = !1, o.visible = !0, o.changeSkin(i._texture.textureCacheIds[0]), o.play("transform", !1)
                                    }))
                                })), yield Lt.delay(500), t.forEach((t => {
                                    i[t].visible = !0, i[t].play("transform", !1), e.slot.reels[t].children.forEach((t => t.visible = !1))
                                })), yield Lt.delay(1e3)
                            }
                        }))()
                    }
                    ...
                    allPayment(t) {
                        ...
                        return (0, o.Z)((function*() {
                            ...
                            for (var i = 0, s = t.length; i < s; i++) {
                                var o = t[i];
                                e._wins.push(o), e._runSymbolAnimation(o, !1), e.slot.wildReels.forEach((t => {
                                    t.visible && t.play("win", !1)
                                }))
                            }
                    ...
                    scatterPayment(t) {
                        var e = this;
                        return (0, o.Z)((function*() {
                            Lt.action.emit("sound:scatterWin"), e.slot.reels.forEach((t => t.overlay())), e.slot.lines.hide(), Lt.store.get("free:isStart", !1) ? e._runSymbolAnimation(t, !0, "free") : Lt.store.get("free:isEnd", !1) && e._runSymbolAnimation(t, !0, "endFree"), yield Lt.delay(Ni.get("reward_scatter"))
                        }))()
                    }
                    complete() {
                        var t = this;
                        return (0, o.Z)((function*() {
                            (t.isStop ? t.stop() : t._wins.length > 0 ? t._flush() : t.slot.lines.enable(), Vi.isFreespin()) && (Lt.store.get("reward:wildReels", []).forEach((e => {
                                t.slot.reels[e].children.forEach((t => {
                                    t.visible = !0
                                })), t.slot.wildReels[e].play("fade", !1)
                            })), yield Lt.delay(200), t.slot.wildReels.forEach((t => {
                                t.visible = !1
                            })))
                        }))()
                    }
                ...
                function _o() {
                    ...
                    return Lt.action.on("symbol:playAnimation", ((i, s, o) => {
                        if (! function(t, i) {
                            ...
                            if (o.assetName) {
                                var n = new As(Lt.loader.getAsset(o.assetName));
                ...
                function Vo(t, e, i) {
                    ...
                    function r() {
                        a.animation && (Lt.action.emit("symbol:stopAnimation", a.animation), s && (h.alpha = No))
                    }
                    return h.position.set(t, e), Object.assign(h, {
                        clearAnimation: r,
                        getCurrentTextureIndex: () => o,
                        overlay() {
                            h.alpha = zo
                        },
                        getData: () => a,
                        playAnimation(t) {
                            s = !0, h.alpha = Uo, Lt.action.emit("symbol:playAnimation", h.x, h.y, jo(jo({}, a.animation), {}, {
                                type: t,
                                texture: h.texture,
                                visible: h.visible
                            }))
                ...
                class Qo extends Ro {
                    constructor() {
                        super(), (0, n.Z)(this, "animation", void 0), (0, n.Z)(this, "backgroundSlot", void 0), (0, n.Z)(this, "frames", void 0), (0, n.Z)(this, "lines", void 0), (0, n.Z)(this, "reels", void 0), (0, n.Z)(this, "reelsContainer", void 0), (0, n.Z)(this, "scatterWaiting", void 0), (0, n.Z)(this, "slotData", void 0), (0, n.Z)(this, "stopReelCounter", void 0), (0, n.Z)(this, "symbolsPositions", void 0), (0, n.Z)(this, "tableShelf", void 0), (0, n.Z)(this, "textFreeLeft", void 0), (0, n.Z)(this, "textLineWin", void 0), (0, n.Z)(this, "textTotalWin", void 0), (0, n.Z)(this, "wildContainer", void 0), (0, n.Z)(this, "wildReels", void 0), (0, n.Z)(this, "wildTransform", void 0), (0, n.Z)(this, "wildTransformReel", void 0), this.pivot.set(680, 20), this.reels = [], this.wildReels = [], this.symbolsPositions = this.game.config.get("slot.symbolsPositions", []), this.animation = new Io(this), this.stopReelCounter = 0, this.init(), this.setupEvents()
                    }
                    createGradientMask(t, e) {
                        var i = document.createElement("canvas"),
                            s = i.getContext("2d"),
                            o = s.createLinearGradient(0, 0, 0, e + 15);
                        return i.width = t, i.height = e, o.addColorStop(0, "rgba(255, 255, 255, 0.0)"), o.addColorStop(.05, "rgba(255, 255, 255, 1.0)"), o.addColorStop(.95, "rgba(255, 255, 255, 1.0)"), o.addColorStop(1, "rgba(255, 255, 255, 1.0)"), s.fillStyle = o, s.fillRect(0, 0, t, e + 15), new d.xE(d.VL.from(i))
                    }
                    createMask() {
                        ...
                        var i = new u.TC;
                        return i.beginFill(16711680, .8), i.drawRect(0, 12, this.game.config.get("slot.width"), this.game.config.get("slot.height") - 22), i.endFill(), i
                    }
                    init() {
                        var t, e, i = this.createMask();
                        this.reelsContainer = new H.W2, this.reelsContainer.mask = i, this.reelsContainer.addChild(i), this.wildContainer = new H.W2, this.wildTransform = new H.W2;
                        for (var s, n, a, h, r = this.game.config.get("slot.size[0]"), l = 0; l < r; l++) {
                            var d = this.symbolsPositions[l],
                                c = new Go(l, d);
                            this.reels.push(c), this.reelsContainer.addChild(c);
                            var u = new As(this.game.loader.getAsset("effectWild"));
                            u.x = c.children[0].x, u.y = -10, u.visible = !1, this.wildReels.push(u), this.wildContainer.addChild(u), this.wildTransformReel = new H.W2, this.wildTransform.addChild(this.wildTransformReel), c.visibleSymbols.forEach((t => {
                                var e = new As(this.game.loader.getAsset("effectSymbols"));
                                e.visible = !1, e.position.set(t.x, t.y), this.wildTransformReel.addChild(e)
                            }))
                        }
                        this.slotData = {
                            reels: this.reels.map((t => t.visibleSymbols)),
                            lines: null !== (t = null === (e = this.game.server) || void 0 === e ? void 0 : e.response.lines) && void 0 !== t ? t : []
                        }, this.lines = new Oo(this.slotData.lines.map((t => ({
                            color: 10648005,
                            width: 4,
                            padding: 2,
                            points: t.map(((t, e) => {
                            ...
                            return {
                                ...
                                render: function(s) {
                                    t.reels.forEach(((t, o) => {
                                        i.push([]), t.forEach((t => {
                                            var n = new As(Lt.loader.getAsset(s));
                        ...
                        }(this.slotData), this.frames.render("effectFrame"), this.backgroundSlot = ((s = new $.j(Lt.loader.getAsset("slotBackground"))).name = "slotBackgound", s.anchor.set(.5), s.position.set(680, 445), s), this.scatterWaiting = (n = this.slotData, a = [], (h = new H.W2).name = "scatterWaitingContainer", n.reels.forEach(((t, e) => {
                            a.push([]), t.forEach((t => {
                                var i = new As(Lt.loader.getAsset("effectSymbols"));
                                i.changeSkin("scatter"), i.position.set(t.x, t.y), i.renderable = !1, h.addChild(i), a[e].push(i)
                            }))
                        })), {
                            getContainer: () => h,
                            play: (t, e) => (0, o.Z)((function*() {
                                try {
                                    var i = a[t][e];
                                    i.renderable = !0, yield i.play("scatter_waiting", !1), i.renderable = !1
                                } catch (t) {
                                    return console.error(t), t
                                }
                            }))()
                        }), this.textFreeLeft = new Mo, this.textFreeLeft.container.position.set(685, 680), this.textTotalWin = new Zo(.8), this.textTotalWin.position.set(685, 680), this.textLineWin = new Do, this.tableShelf = new $.j(this.game.loader.getAsset("tableShelf")), this.tableShelf.position.set(-108, 848), this.addChild(this.backgroundSlot), this.addChild(this.reelsContainer), this.addChild(this.lines), this.addChild(this.wildTransform), this.addChild(this.wildContainer), this.addChild(_o()), this.addChild(this.tableShelf), this.addChild(this.scatterWaiting.getContainer()), this.addChild(this.frames.container), this.addChild(this.textLineWin.container), this.addChild(this.textTotalWin), this.addChild(this.textFreeLeft.container)
                    }
                    setupEvents() {
                        this.game.action.on("state:ready_enter", this._onReadyEnter, this), this.game.action.on("state:spin_enter", this._onSpinEnter, this), this.game.action.on("state:stop_enter", this._onStopEnter, this), this.game.action.on("free:start", (() => {
                            ...
                            this.animation.stop(), this.lines.enable(), this.wildReels.forEach((t => {
                                t.visible = !1
                        ...
                        })), this.game.action.on("state:finish_enter", this._onFinishEnter, this), this.game.action.on("wheel:stop", this._onStopWheel, this), this.game.action.on("reward:reset", this._onResetReward, this), this.game.action.on("free:start", this._onFreeStart, this), this.game.action.on("free:select_start", (() => {
                            k.fromTo(this, .5, {
                                pixi: {
                                    alpha: 0
                                }
                    ...
                    updateFreeLeft() {
                        ...
                        return (0, o.Z)((function*() {
                            if (Vi.isFreespin()) {
                                var e = t.game.store.get("free:played", 0) + 1;
                    ...
                    _onSpinEnter() {
                        ...
                        return (0, o.Z)((function*() {
                            ...
                            try {
                                yield t.game.beforeSpin(), Vi.isFreespin() && t.wildContainer.children.forEach((t => {
                                    t.play("fade", !1)
                                })), t.reels.forEach((t => t.start())), yield t.updateFreeLeft(), yield t.requestSpin(), t.game.state.goTo("stop")
                            } catch (e) {
                    ...
                    resize() {
                        this.game.device.desktop || this.game.device.landscape ? (this.scale.set(1), this.position.set(960, 80)) : (this.scale.set(1.2 * .5625), this.position.set(540, 315))
                    }
                }
                class Ho extends(Vt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "timeline", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "value", void 0), (0, n.Z)(this, "light", void 0), (0, n.Z)(this, "coins", void 0), (0, n.Z)(this, "onPress", void 0), this.visible = !1, this.interactive = !0, this.onPress = new(x()), this.game.interaction.click(this, (() => this.onPress.dispatch())), this.timeline = new C, this.content = new H.W2, this.overlay = new u.TC, this.overlay.beginFill(0, .75), this.overlay.drawRect(0, 0, 1920, 1080), this.overlay.endFill(), this.title = new $.j, this.title.anchor.set(.5), this.value = new v.Xz("", {
                            fontName: "WinFont"
                        }), this.value.anchor = .5, this.light = new As(this.game.loader.getAsset("bgEffect")), this.light.alpha = 0, this.coins = new As(this.game.loader.getAsset("bgEffect")), this.coins.alpha = 0, this.content.addChild(this.title), this.content.addChild(this.value), this.addChild(this.overlay), this.addChild(this.light), this.addChild(this.coins), this.addChild(this.content)
                    }
                    show(t, e) {
                        var i = 0;
                        t === fe ? (i = 9, this.game.action.emit("sound:bigWin")) : t === ye && (i = 18, this.game.action.emit("sound:giantWin")), this.title.texture = this.game.loader.getAsset("textBigWin");
                        var s = !1;
                        ...
                        return new Promise((n => {
                            ...
                            this.timeline.to(this.overlay, .35, {
                                ...
                                onUpdate: () => {
                                    !s && t === ye && a.coins > e / 2 && (this.title.texture = this.game.loader.getAsset("textGiantWin"), s = !0, this.coins.play("win_gigant", !0), this.coins.alpha = 1, k.to(this.value, i / 2, {
                                        pixi: {
                                            scale: o + .2
                                        }
                ...
                new class extends class extends class extends class {
                    constructor(t) {
                        ...
                        })), Lt = this, et.vB.shared.autoStart = !1, et.vB.shared.stop(), this.config = new ht(Wt), this.logger = new Ct, this.rootNode = this.createRootNode(), this.renderer = new Bt, this.i18n = new bt(e), this.helpers = new vt(this.config), this.keyboard = new yt, this.device = new At(this.renderer), this.viewport = new Rt, this.leftHand = new ut, this.fullscreen = this.device.ios || this.device.iPadPro ? new dt : new ct(this.device), this.visibility = new zt, this.preferences = new Ut, this.sound = new R(this.device, this.visibility, this.preferences), this.state = new Ot, this.store = new ht, this.action = new gt, this.loader = new kt(this.device), this.error = new mt, this.interaction = new wt(this.device), this.externalApi = new Mt(this), this.popupManager = new Dt(this.rootNode), this.create(), this.initAnalytics()
                    }
                    initAnalytics() {
                        return (0, o.Z)((function*() {
                            try {
                    ...
                    initModules(t) {
                        ...
                        this.wallet = new Je(this.server), this.betLevel = new It(null == o ? void 0 : o.bet, null == o ? void 0 : o.bets, null !== (e = null == o ? void 0 : o.betCoins) && void 0 !== e ? e : 1), this.autoPlay = new He({
                    ...
                    initViews() {
                        var t, e, i = this;
                        super.initViews(), this.background = this.rootNode.addChild(new ms), this.slot = this.rootNode.addChild(new Qo), this.rootNode.addChild(this.background.bgStatic), this.background.bgStatic.play("static", !0), this.paytable = new Eo(null !== (t = null === (e = this.server) || void 0 === e ? void 0 : e.response.lines) && void 0 !== t ? t : []), this.gameSettings = new Ue, this.config.get("quickSpin.available", !0) && this.gameSettings.addItem(this.createQuickSpinCheckbox()), this.gameSettings.addItem(this.createFullscreenCheckbox()), this.gameSettings.addItem(this.createLeftHandCheckbox()), this.gameSettings.addItem(this.createGameSoundsCheckbox()), this.gameSettings.addItem(this.createBackgroundSoundsCheckbox()), this.bigWinAnimation = new Ho, this.fastStopLayout = new Te, this.controls = this.device.desktop ? new to : new uo, this.betSettings = this.rootNode.addChild(new Ee), this.betSettings.setBets(this.betLevel.bets, this.betLevel.betCoins), this.betSettings.setPayLines(40), this.betSettings.setBet(this.betLevel.bet), this.autoPlaySettings = this.rootNode.addChild(new de), this.autoPlaySettings.setAutoPlayCounts(this.autoPlay.counts), this.autoPlaySettings.stopSection.addItem(new Se), this.autoPlaySettings.stopSection.addItem(new be), this.autoPlaySettings.stopSection.addItem(new me), this.autoPlaySettings.stopSection.addItem(new ve), this.gameRules = new Ne, this.menu = new Ge, this.menu.addItem(this.loader.getAsset("iconPaytable"), this.paytable), this.menu.addItem(this.loader.getAsset("iconSettings"), this.gameSettings), this.menu.addItem(this.loader.getAsset("iconRules"), this.gameRules), this.rootNode.addChild(this.fastStopLayout), this.rootNode.addChild(this.menu), this.rootNode.addChild(this.controls), this.rootNode.addChild(this.bigWinAnimation), this.freeOverlay = this.rootNode.addChild(new po), this.paytable.updateBet(this.betLevel), this.controls.updateBet(this.betLevel), this.betSettings.on("open", (() => {
                    ...
                    reward() {
                        ...
                        return (0, o.Z)((function*() {
                            ...
                            var n = t.store.get("reward:lines", []).concat(),
                                ...
                                h = t.store.get("reward:wildReels", []).concat();
                            if (h.length > 0 && (yield t.slot.animation.wildReelPayment(h)), (n.length > 0 || t.wallet.scatterCoins) && (t.controls.disableButtonSpin(), a && n.unshift(a), t.slot.textTotalWin.once("show", (() => {
                            ...
                            } else t.store.get("free:isEnd", !1) && (yield t.delay(Ni.get("free_end")), t.beforeFreeSpinsPopup(), yield t.freeOverlay.show(ao.END), t.store.get("reward:wildReel", []).length > 0 && t.store.get("reward:wildReel", []).forEach((e => {
                                t.slot.reels[e].children.forEach((t => {
                                    t.visible = !1
                                }))
                            })), yield t.delay(200));
    ...
    n.m = s, t = [], n.O = (e, i, s, o) => {
    ...
    }), t), n.o = (t, e) => Object.prototype.hasOwnProperty.call(t, e), e = {}, i = "merlins_tower:", n.l = (t, s, o, a) => {
        if (e[t]) e[t].push(s);
        else {
            var h, r;
            if (void 0 !== o)
        ...
        var e = (e, i) => {
            ...
            i = self.webpackChunkmerlins_tower = self.webpackChunkmerlins_tower || [];
        i.forEach(e.bind(null, 0)), i.push = e.bind(null, i.push.bind(i))
    })();
    var a = n.O(void 0, [216], (() => n(9952)));
    a = n.O(a)
})();