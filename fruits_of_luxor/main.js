...
(() => {
            ...
            8522: (t, e, i) => {
                ...
                class y {
                    ...
                    static loadFromBuffer(t) {
                        var e, i, s, o, n, a, h, r, l, d, c, u, p, g, A, m, v, b, w, f = null !== (e = null === (i = t.metadata) || void 0 === i || null === (s = i.font) || void 0 === s ? void 0 : s.family) && void 0 !== e ? e : t.name;
                ...
                class G {
                    ...
                    readSkeletonData(t, e) {
                        ...
                        var s = i.readString(),
                            o = j(s),
                            n = null;
                        if (o === M.VER38 && (n = new L.SkeletonBinary(new L.AtlasAttachmentLoader(t))), (i = new I.BinaryInput(e)).readInt32(), i.readInt32(), (o = j(s = i.readString())) !== M.VER40 && o !== M.VER41 || (n = new U.SkeletonBinary(new U.AtlasAttachmentLoader(t))), !n) {
                ...
                var _ = i(512),
                    ...
                    et = i(798),
                    it = i(5277);
                u.TC.nextRoundedRectBehavior = !0, m.xv.nextLineHeightBehavior = !0, c.R.add(p.bx, g.B9, d.Bv, a.c, h.Q, r.T, l.O, v.vl, A.o, V, y, F), window.PIXI = s;
                var st = i(3233),
                    ot = i.n(st);
                ...
                class Be extends m.xv {
                    ...
                    updateText() {
                        if (this.withPrivateMembers().dirty) {
                            ...
                            for (var y = A + g, w = [], f = 0; f < s.length; f++) {
                                var x = s[f],
                                    S = void 0;
                ...
                const Bi = class extends Dt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupRestore"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "icon", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContinue", void 0), (0, n.Z)(this, "resolver", null), this.overlay = this.addChild(new Jt), this.content = this.addChild(new Q.W2), this.icon = new vi(ci), this.icon.anchor.x = .5, this.message = new yi(this.game.i18n.t("PopupRestoreMessage"), {
                            wordWrap: !0,
                            wordWrapWidth: 320
                        }), this.message.anchor.x = .5, this.actionContinue = new mi(this.game.i18n.t("PopupActionContinue"), {
                            fill: 16777215
                ...
                const Ei = class extends Dt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupSound"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "icon", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContainer", void 0), (0, n.Z)(this, "actionYes", void 0), (0, n.Z)(this, "actionNo", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt, this.content = new Q.W2, this.icon = new vi(pi), this.icon.anchor.x = .5, this.message = new yi(this.game.i18n.t("PopupSoundMessage"), {
                            wordWrap: !0
                ...
                const Gi = {
                        init() {
                            function t(t) {
                                var e = ot()(t, "win", 0);
                                Ut.store.set("reward:win", e), Ut.store.set("reward:lines", ot()(t, "lines", [])), Ut.store.set("reward:reels", ot()(t, "reels", t.error ? Ni : [])), Ut.store.set("reward:nReels", ot()(t, "nReels", t.error ? ji : [])), Ut.store.set("reward:preReels", ot()(t, "preSpin.reels", [])), Ut.store.set("reward:isWin", e > 0), Ut.store.set("reward:numberWinSymbol", ot()(t, "winSyms", 0)), Ut.store.set("reward:overlayWilds", ot()(t, "overlayWilds", []))
                            }
                ...
                class Bs extends(Vt(Q.W2)) {
                    constructor() {
                        ...
                        var e = new Ss(d.xE.from(ws), 0);
                        e.width = 12, e.height = 151;
                        var i = new Ss(d.xE.from(ws), 4914792);
                ...
                class Ao extends(Vt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "sectionTitle", void 0), (0, n.Z)(this, "symbolApple", void 0), (0, n.Z)(this, "symbolBanana", void 0), (0, n.Z)(this, "symbolBell", void 0), (0, n.Z)(this, "symbolCleo", void 0), (0, n.Z)(this, "symbolGrapes", void 0), (0, n.Z)(this, "symbolOrange", void 0), (0, n.Z)(this, "symbolPharaoh", void 0), (0, n.Z)(this, "symbolScatStar", void 0), (0, n.Z)(this, "symbolSeven", void 0), (0, n.Z)(this, "symbolWmelon", void 0), (0, n.Z)(this, "symbols", void 0), this.sectionTitle = new lo(this.game.i18n.t("PaytableSectionPayoutTitle").toUpperCase()), this.symbolPharaoh = new go("pharaoh"), this.symbolPharaoh.position.set(0, this.sectionTitle.y + this.sectionTitle.height + 30), this.symbolCleo = new go("cleo"), this.symbolCleo.position.set(600, this.sectionTitle.y + this.sectionTitle.height + 30), this.symbolSeven = new go("seven"), this.symbolSeven.position.set(0, this.symbolPharaoh.y + this.symbolPharaoh.height + 30), this.symbolScatStar = new go("star"), this.symbolScatStar.position.set(600, this.symbolCleo.y + this.symbolCleo.height + 30), this.symbolBell = new go("bell"), this.symbolBell.position.set(0, this.symbolSeven.y + this.symbolSeven.height + 30), this.symbolOrange = new go("orange"), this.symbolOrange.position.set(600, this.symbolScatStar.y + this.symbolScatStar.height + 30), this.symbolGrapes = new go("grapes"), this.symbolGrapes.position.set(0, this.symbolBell.y + this.symbolBell.height + 30), this.symbolWmelon = new go("wmelon_p"), this.symbolWmelon.position.set(600, this.symbolOrange.y + this.symbolOrange.height + 30), this.symbolApple = new go("apple"), this.symbolApple.position.set(0, this.symbolGrapes.y + this.symbolGrapes.height + 30), this.symbolBanana = new go("banana"), this.symbolBanana.position.set(600, this.symbolWmelon.y + this.symbolWmelon.height + 30), this.symbols = [this.symbolPharaoh, this.symbolCleo, this.symbolSeven, this.symbolScatStar, this.symbolBell, this.symbolOrange, this.symbolGrapes, this.symbolWmelon, this.symbolApple, this.symbolBanana], this.addChild(this.sectionTitle, ...this.symbols)
                    }
                    updateBet(t) {
                        this.symbols.forEach((e => e.updateBet(t)))
                    }
                    resize() {
                        this.game.device.desktop || (this.game.device.landscape ? (this.symbolPharaoh.position.set(0, this.sectionTitle.y + this.sectionTitle.height + 30), this.symbolCleo.position.set(820, this.sectionTitle.y + this.sectionTitle.height + 30), this.symbolSeven.position.set(0, this.symbolPharaoh.y + this.symbolPharaoh.height + 30), this.symbolScatStar.position.set(820, this.symbolCleo.y + this.symbolCleo.height + 30), this.symbolBell.position.set(0, this.symbolSeven.y + this.symbolSeven.height + 30), this.symbolOrange.position.set(820, this.symbolScatStar.y + this.symbolScatStar.height + 30), this.symbolGrapes.position.set(0, this.symbolBell.y + this.symbolBell.height + 30), this.symbolWmelon.position.set(820, this.symbolOrange.y + this.symbolOrange.height + 30), this.symbolApple.position.set(0, this.symbolGrapes.y + this.symbolGrapes.height + 30), this.symbolBanana.position.set(820, this.symbolWmelon.y + this.symbolWmelon.height + 30)) : (this.symbolPharaoh.position.set(0, this.sectionTitle.y + this.sectionTitle.height + 30), this.symbolCleo.position.set(0, this.symbolPharaoh.y + this.symbolPharaoh.height + 30), this.symbolSeven.position.set(0, this.symbolCleo.y + this.symbolCleo.height + 30), this.symbolScatStar.position.set(0, this.symbolSeven.y + this.symbolSeven.height + 30), this.symbolBell.position.set(0, this.symbolScatStar.y + this.symbolScatStar.height + 30), this.symbolOrange.position.set(0, this.symbolBell.y + this.symbolBell.height + 30), this.symbolGrapes.position.set(0, this.symbolOrange.y + this.symbolOrange.height + 30), this.symbolWmelon.position.set(0, this.symbolGrapes.y + this.symbolGrapes.height + 30), this.symbolApple.position.set(0, this.symbolWmelon.y + this.symbolWmelon.height + 30), this.symbolBanana.position.set(0, this.symbolApple.y + this.symbolApple.height + 30)))
                    }
                }
                class mo extends(Vt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "_sectionParagraph1", void 0), (0, n.Z)(this, "_sectionParagraph2", void 0), (0, n.Z)(this, "_sectionParagraph3", void 0), (0, n.Z)(this, "_sectionTitle", void 0), (0, n.Z)(this, "_symbol1", void 0), this._sectionTitle = new lo(Ut.i18n.t("PaytableSectionWildTitle").toUpperCase()), this._sectionTitle.position.set(0, 0), this._symbol1 = new go("wild(crown)_luxor"), this._symbol1.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this._symbol1.withoutPayout(), this._sectionParagraph1 = new ro(Ut.i18n.t("PaytableSectionWildContent1")), this._sectionParagraph1.position.set(this._symbol1.x + this._symbol1.width, this._sectionTitle.height + this._sectionTitle.y + 30), this._sectionParagraph1.setTagStyle("default", {
                            wordWrapWidth: 690
                ...
                class Oo extends Bo {
                    ...
                    playAnimation(t) {
                        ...
                        if (this.visible && this.renderable && (!this.symbolAnimation.renderable || !this.symbolAnimation.playing || this.symbolAnimation.skinName !== i.skin || this.symbolAnimation.animationName !== i.effectName)) {
                            ...
                            var s, o = "string" == typeof i.effectName[t] ? i.effectName[t] : i.effectName[i.animationName] || i.effectName.normal;
                            if ("win" === o) this.symbolAnimation.play("static"), this.timeoutId = setTimeout((() => {
                                var t;
                                this.symbolAnimation.play(o, "idle" === o, null !== (t = i.trackIndex) && void 0 !== t ? t : 0)
                            }), e);
                            else this.symbolAnimation.play(o, "idle" === o, null !== (s = i.trackIndex) && void 0 !== s ? s : 0)
                        }
                    }
                    ...
                    spawn() {
                        this.wildPositions.forEach(((t, e) => {
                            ...
                            if (this.children[e]) {
                                ...
                                a.position.set(n.x, n.y), a.changeSkin("wild(crown)_luxor"), a.play("wild_stick").then((() => {
                                    a.play("wild_sticky", !0)
                ...
                class Do extends fo {
                    ...
                    _onStopEnter() {
                        var t, e, i;
                        Hi.set(null !== (t = null === (e = this.game.server) || void 0 === e || null === (i = e.response) || void 0 === i ? void 0 : i.feature) && void 0 !== t ? t : _i.Basic), this.reels.forEach((t => t.stop()))
                    }
                    _onFinishEnter() {
                        var t = this;
                        return (0, o.Z)((function*() {
                    ...
                    _onStopWheel(t) {
                        ...
                        return (0, o.Z)((function*() {
                            try {
                                e.stopReelCounter++, e.stickyWilds.onWheelStop(t), e.runSymbolAnimation({
                                    animationName: "spin"
                                }, t), e.stopReelCounter >= e.reels.length && (yield e.game.helpers.delay(500), e.animation.stop(), e.game.afterReelsStop(), e.stickyWilds.onWin(), e.game.state.goTo("reward"))
                            } catch (t) {
                    ...
                    _onResetReward() {
                        this.animation.stop(), this.lines.enable(), this.runSymbolAnimation({
                            animationName: "idle"
                        })
                    }
                    tryRespin() {
                    ...
                    resize() {
                        this.game.device.desktop || this.game.device.landscape ? (this.scale.set(1), this.position.set(960, 10)) : (this.scale.set(.7), this.position.set(520, 370))
                    }
                }
                        ...
                        return (0, o.Z)((function*() {
                            ...
                            return new Promise((a => {
                                ...
                                i.timeline.to(i.overlay, .35, {
                                    ...
                                    onUpdate: () => {
                                        !o && t === we && h.coins > e / 2 && (i.title.texture = i.game.loader.getAsset("textGiantWin"), o = !0, i.coins.play("giant", !0), i.coins.alpha = 1, k.to(i.value, s / 2, {
                                            pixi: {
                                                scale: n + .2
                                            }
                ...
                new class extends class extends class extends class {
                    ...
                    start() {
                        ...
                        return (0, o.Z)((function*() {
                            var i, s, o;
                            t().call(e), Hi.set(null !== (i = null === (s = e.server.response) || void 0 === s ? void 0 : s.feature) && void 0 !== i ? i : _i.Basic), yield e.freeRound.start(), null === (o = e.sound.get("backgroundNormal")) || void 0 === o || o.fade(2), e.state.goTo("setup"), Hi.isRespin() && (yield e.popupManager.show("PopupRestore"), yield e.slot.tryRespin()), e.state.goTo("ready")
                        }))()
                    }
                    reward() {
                        var t = this,
    ...
    n.m = s, t = [], n.O = (e, i, s, o) => {
    ...
    }), t), n.o = (t, e) => Object.prototype.hasOwnProperty.call(t, e), e = {}, i = "fruits_of_luxor:", n.l = (t, s, o, a) => {
        if (e[t]) e[t].push(s);
        else {
            var h, r;
            if (void 0 !== o)
        ...
        var e = (e, i) => {
            ...
            i = self.webpackChunkfruits_of_luxor = self.webpackChunkfruits_of_luxor || [];
