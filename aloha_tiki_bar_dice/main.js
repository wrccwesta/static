...
(() => {
    var t, e, i, s = {
            4363: (t, e, i) => {
                ...
                class G {
                    ...
                    readSkeletonData(t, e) {
                        ...
                        var s = i.readString(),
                            o = N(s),
                            n = null;
                        if (o === F.VER38 && (n = new L.SkeletonBinary(new L.AtlasAttachmentLoader(t))), (i = new I.BinaryInput(e)).readInt32(), i.readInt32(), (o = N(s = i.readString())) !== F.VER40 && o !== F.VER41 || (n = new j.SkeletonBinary(new j.AtlasAttachmentLoader(t))), !n) {
                ...
                class V {
                    ...
                    readSkeletonData(t, e) {
                        var i = e.skeleton.spine,
                            s = N(i),
                            o = null;
                        if (s === F.VER37 && (o = new D.SkeletonJson(new D.AtlasAttachmentLoader(t))), s === F.VER38 && (o = new L.SkeletonJson(new L.AtlasAttachmentLoader(t))), s !== F.VER40 && s !== F.VER41 || (o = new j.SkeletonJson(new j.AtlasAttachmentLoader(t))), !o) {
                ...
                var _ = i(512),
                    ...
                    et = i(798),
                    it = i(5277);
                u.TC.nextRoundedRectBehavior = !0, m.xv.nextLineHeightBehavior = !0, d.R.add(p.bx, g.B9, c.Bv, a.c, h.Q, r.T, l.O, v.vl, A.o, z, w, M), window.PIXI = s;
                var st = i(3233),
                    ot = i.n(st);
                ...
                class Be extends m.xv {
                    ...
                    getTagRegex(t, e) {
                        ...
                        var o = s === xe ? "\\".concat(Ce.bbcode[0]).concat(i, "(?:\\=(?:[A-Za-z0-9_\\-\\#]+|'(?:[^']+|\\\\')*'))*\\s*\\").concat(Ce.bbcode[1], "|\\").concat(Ce.bbcode[0], "\\/").concat(i, "\\s*\\").concat(Ce.bbcode[1]) : "\\".concat(Ce.xml[0]).concat(i, "(?:\\s+[A-Za-z0-9_\\-]+=(?:\"(?:[^\"]+|\\\\\")*\"|'(?:[^']+|\\\\')*'))*\\s*\\").concat(Ce.xml[1], "|\\").concat(Ce.xml[0], "\\/").concat(i, "\\s*\\").concat(Ce.xml[1]);
                    ...
                    _getTextDataPerLine(t) {
                            ...
                            if (0 === r.length) h.push(this.createTextData(t[a], o[o.length - 1], n[n.length - 1]));
                                ...
                                for (var c = 0, d = 0; d < r.length; d++) {
                                    if (r[d].index > c && h.push(this.createTextData(t[a].substring(c, r[d].index), o[o.length - 1], n[n.length - 1])), "/" === r[d][0][1]) o.length > 1 && (o.pop(), n.pop());
                                        ...
                                        if (A === xe && r[d][0].includes("=") && this.textStyles[r[d][1]]) ! function() {
                        ...
                        return i[i.length - 1].map((t => {
                            t.text.includes(Ce[b][0]) && (t.text = t.text.match(b === xe ? /^(.*)\[/ : /^(.*)\</)[1])
                        })), i
                    }
                    getFontString(t) {
                                ...
                                for (var x = 0; x < k.length; x++) {
                                    ...
                                    if (0 === C.letterSpacing) y.push({
                                        ...
                                        for (var Z = 0; Z < B.length; Z++) {
                                            (Z > 0 || x > 0) && (S += C.letterSpacing / 2);
                                            var M = this.context.measureText(B.charAt(Z)).width;
                                            y.push({
                                                text: B.charAt(Z),
                                                style: C,
                                                x: S,
                                                ...
                                                descent: P.descent,
                                                tag: O
                                            }), S += M, (Z < B.length - 1 || x < k.length - 1) && (S += C.letterSpacing / 2)
                                        }
                                    }
                                }
                                w += a[f] - n[f]
                ...
                class Ue extends(zt(H.W2)) {
                    ...
                    addSections() {
                        this.content.addChild(new Ie), this.content.addChild(new De), this.content.addChild(new Le), this.addAutoPlaySection(), this.content.addChild(new Fe), this.content.addChild(new Me), this.content.addChild(new je)
                    }
                    addAutoPlaySection() {
                ...
                class ze extends(zt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "Menu"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "contentItems", void 0), (0, n.Z)(this, "bottom", void 0), (0, n.Z)(this, "items", void 0), (0, n.Z)(this, "homeButton", void 0), (0, n.Z)(this, "closeButton", void 0), (0, n.Z)(this, "bottomBackgroundTexture", void 0), (0, n.Z)(this, "bottomBackgroundMobileTexture", void 0), (0, n.Z)(this, "spaceKey", void 0), (0, n.Z)(this, "currentIndex", 0), (0, n.Z)(this, "onClickHome", void 0), (0, n.Z)(this, "onClickClose", void 0), this.visible = !1, this.interactive = !0, this.bottomBackgroundTexture = c.xE.from(Qt), this.bottomBackgroundMobileTexture = c.xE.from(Ht), this.overlay = this.addChild(new Jt), this.contentItems = this.addChild(new H.W2), this.bottom = this.addChild(new $.j(this.bottomBackgroundMobileTexture)), this.items = this.addChild(new H.W2), this.homeButton = this.addChild(new Ge), this.closeButton = this.addChild(new Kt), this.closeButton.onClick.add((() => this.close())), this.spaceKey = this.game.keyboard.register(this.game.keyboard.KEY_CODE.Escape), this.spaceKey.onPress.add(this.close, this), this.spaceKey.disable()
                    }
                    get opened() {
                        return this.visible
                    }
                ...
                class Ke {
                    constructor(t) {
                        (0, n.Z)(this, "watcher", void 0), (0, n.Z)(this, "enabled", !1), (0, n.Z)(this, "onToggle", new(k())), (0, n.Z)(this, "onTryEnable", new(k())), this.config = t, this.watcher = new Xe(t)
                    }
                    get available() {
                ...
                const ki = class extends Dt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupFreeRound"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "icon", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContinue", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt, this.content = new H.W2, this.icon = new vi(di), this.icon.anchor.x = .5, this.title = new fi(this.game.i18n.t("PopupFreeRoundStartTitle")), this.title.anchor.x = .5, this.message = new wi("", {
                            wordWrap: !0,
                            wordWrapWidth: 600
                ...
                const Si = class extends Dt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupMaxLimit"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContinue", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt(.7), this.content = new H.W2, this.background = new $.j(this.game.loader.getAsset(gi)), this.background.anchor.set(.5), this.background.interactive = !0, this.background.name = "PopupBackground", this.title = new fi(this.game.i18n.t("PopupMaxLimitTitle")), this.title.anchor.x = .5, this.message = new wi(this.game.i18n.t("PopupMaxLimitMessage"), {
                            wordWrap: !0
                ...
                const xi = class extends Dt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupNetworkError"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "icon", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionReload", void 0), (0, n.Z)(this, "_resolver", null), this.overlay = this.addChild(new Jt), this.content = this.addChild(new H.W2), this.icon = new vi(ui), this.icon.anchor.x = .5, this.title = new fi(this.game.i18n.t("PopupNetworkErrorTitle"), {
                            align: "center"
                ...
                class Ci extends Dt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupQuickSpin"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionEnable", void 0), (0, n.Z)(this, "actionClose", void 0), (0, n.Z)(this, "escKey", void 0), (0, n.Z)(this, "enterKey", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt(.7), this.content = new H.W2, this.background = new $.j(this.game.loader.getAsset(gi)), this.background.anchor.set(.5), this.background.interactive = !0, this.background.name = "PopupBackground", this.title = new fi(this.game.i18n.t("PopupQuickSpinTitle")), this.title.anchor.x = .5, this.message = new wi(this.game.i18n.t("PopupQuickSpinMessage"), {
                            fontSize: 35,
                            wordWrap: !0,
                            wordWrapWidth: 600
                ...
                const Bi = class extends Dt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupRestore"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "icon", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContinue", void 0), (0, n.Z)(this, "resolver", null), this.overlay = this.addChild(new Jt), this.content = this.addChild(new H.W2), this.icon = new vi(di), this.icon.anchor.x = .5, this.message = new wi(this.game.i18n.t("PopupRestoreMessage"), {
                            wordWrap: !0,
                            wordWrapWidth: 320
                        }), this.message.anchor.x = .5, this.actionContinue = new mi(this.game.i18n.t("PopupActionContinue"), {
                            fill: 16777215
                ...
                const Pi = class extends Dt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupRiskNBuy"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionYes", void 0), (0, n.Z)(this, "actionNo", void 0), (0, n.Z)(this, "escKey", void 0), (0, n.Z)(this, "enterKey", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt(.7), this.content = new H.W2, this.background = new $.j(this.game.loader.getAsset(gi)), this.background.anchor.set(.5), this.background.interactive = !0, this.background.name = "PopupBackground", this.title = new fi("RISK FEATURE"), this.title.anchor.x = .5, this.message = new wi("", {
                            wordWrap: !0,
                            whiteSpace: "normal",
                            breakWords: !0
                ...
                const Ei = class extends Dt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupSound"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "icon", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContainer", void 0), (0, n.Z)(this, "actionYes", void 0), (0, n.Z)(this, "actionNo", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt, this.content = new H.W2, this.icon = new vi(pi), this.icon.anchor.x = .5, this.message = new wi(this.game.i18n.t("PopupSoundMessage"), {
                            wordWrap: !0
                ...
                const Ti = class extends Dt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupSpendingBudget"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContinue", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt(.7), this.content = new H.W2, this.background = new $.j(this.game.loader.getAsset(gi)), this.background.anchor.set(.5), this.background.interactive = !0, this.background.name = "PopupBackground", this.title = new fi(this.game.i18n.t("PopupSpendingBudgetTitle")), this.title.anchor.x = .5, this.message = new wi(this.game.i18n.t("PopupSpendingBudgetMessage"), {
                            wordWrap: !0
                        }), this.message.anchor.x = .5, this.actionContinue = new mi(this.game.i18n.t("PopupActionContinue"), {
                            fill: 10066329
                        }), this.actionContinue.anchor.x = .5, this.game.interaction.out(this.actionContinue, (() => this.actionContinue.style.fill = 10066329)), this.game.interaction.hover(this.actionContinue, (() => this.actionContinue.style.fill = 16777215)), this.game.interaction.click(this.actionContinue, (() => this.hide())), this.content.addChild(this.title), this.content.addChild(this.message), this.content.addChild(this.actionContinue), this.addChild(this.overlay), this.addChild(this.background), this.addChild(this.content)
                ...
                const Oi = class extends Dt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupUnexpectedError"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContinue", void 0), (0, n.Z)(this, "_resolver", null), this.overlay = new Jt(.7), this.content = new H.W2, this.background = new $.j(this.game.loader.getAsset(gi)), this.background.anchor.set(.5), this.background.interactive = !0, this.background.name = "PopupBackground", this.title = new fi(this.game.i18n.t("PopupUnexpectedErrorTitle")), this.title.anchor.x = .5, this.message = new wi(this.game.i18n.t("PopupUnexpectedErrorMessage")), this.message.anchor.x = .5, this.actionContinue = new mi(this.game.i18n.t("PopupActionReload"), {
                            fill: 10066329
                        }), this.actionContinue.anchor.x = .5, this.game.interaction.out(this.actionContinue, (() => this.actionContinue.style.fill = 10066329)), this.game.interaction.hover(this.actionContinue, (() => this.actionContinue.style.fill = 16777215)), this.game.interaction.click(this.actionContinue, (() => this.hide())), this.content.addChild(this.title), this.content.addChild(this.message), this.content.addChild(this.actionContinue), this.addChild(this.overlay), this.addChild(this.background), this.addChild(this.content)
                    }
                    resize() {
                ...
                class Ri extends Dt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupWilds"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionEnable", void 0), (0, n.Z)(this, "actionClose", void 0), (0, n.Z)(this, "escKey", void 0), (0, n.Z)(this, "spaceKey", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt(.7), this.content = new H.W2, this.background = new $.j(this.game.loader.getAsset(gi)), this.background.anchor.set(.5), this.background.interactive = !0, this.background.name = "PopupBackground", this.title = new fi(this.game.i18n.t("PopupWildsTitle"), {
                            fontSize: 40,
                            wordWrap: !0,
                            wordWrapWidth: 600,
                ...
                const Zi = class extends Dt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupZeroBalance"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContinue", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt(.7), this.content = new H.W2, this.background = new $.j(this.game.loader.getAsset(gi)), this.background.anchor.set(.5), this.background.interactive = !0, this.background.name = "PopupBackground", this.title = new fi(this.game.i18n.t("PopupZeroBalanceTitle")), this.title.anchor.x = .5, this.message = new wi(this.game.i18n.t("PopupZeroBalanceMessage"), {
                            wordWrap: !0
                        }), this.message.anchor.x = .5, this.actionContinue = new mi(this.game.i18n.t("PopupActionContinue"), {
                            fill: 10066329
                        }), this.actionContinue.anchor.x = .5, this.game.interaction.out(this.actionContinue, (() => this.actionContinue.style.fill = 10066329)), this.game.interaction.hover(this.actionContinue, (() => this.actionContinue.style.fill = 16777215)), this.game.interaction.click(this.actionContinue, (() => this.hide())), this.content.addChild(this.title), this.content.addChild(this.message), this.content.addChild(this.actionContinue), this.addChild(this.overlay), this.addChild(this.background), this.addChild(this.content)
                ...
                const Di = [...[{
                    ...
                    url: "assets/audio/transform_wild.mp3",
                    name: "joker",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"],
                        audioMetadata: {
                    ...
                    url: "assets/images/effects/buttons/button/skeleton.json",
                    name: "bttonsEffect",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                    ...
                    url: "assets/images/effects/wild-appear/skeleton.json",
                    name: "wildReelEffect",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                    ...
                    url: "assets/images/controls/desktop/btn_spin_active.png",
                    metadata: {
                        platform: ["desktop"]
                    }
                }, {
                ...
                const zi = {
                        init() {
                            function t(t) {
                                var e = ot()(t, "win", 0);
                                "init" !== t.action && jt.store.set("reward:lines", ot()(t, "lines", [])), jt.store.set("reward:win", e), jt.store.set("reward:reels", ot()(t, "reels", t.error ? Gi : [])), jt.store.set("reward:nReels", ot()(t, "nReels", t.error ? Vi : [])), jt.store.set("reward:preReels", ot()(t, "preSpin.reels", [])), jt.store.set("reward:isWin", e > 0), jt.store.set("reward:numberWinSymbol", ot()(t, "winSyms", 0)), jt.store.set("reward:wildReels", ot()(t, "wildReels", []));
                                var i = ot()(t, "feature", Ui.Basic);
                                jt.store.set("reward:feature", i)
                            }
                            jt.store.set("reward:win", 0), jt.store.set("reward:isWin", !1), jt.store.set("reward:lines", []), jt.store.set("reward:reels", []), jt.store.set("reward:nReels", []), jt.store.set("reward:preReels", []), jt.store.set("reward:numberWinSymbol", 0), jt.store.set("reward:wildReels", []), jt.store.set("reward:feature", ""), jt.store.set("respin", !1), jt.server.on("response:init", t), jt.server.on("response:spin", t)
                        }
                    },
                    _i = {
                        init() {
                ...
                class Hi extends Z {
                    constructor(t, e, i) {
                        super(t, e, i), (0, n.Z)(this, "backgroundNormal", void 0), (0, n.Z)(this, "bigWin", void 0), (0, n.Z)(this, "clickNormal", void 0), (0, n.Z)(this, "currentWinSound", void 0), (0, n.Z)(this, "giantWin", void 0), (0, n.Z)(this, "joker", void 0), (0, n.Z)(this, "respin", void 0), (0, n.Z)(this, "spinFast", void 0), (0, n.Z)(this, "spinStart", void 0), (0, n.Z)(this, "wheelStop", void 0), (0, n.Z)(this, "wildWheel", void 0), (0, n.Z)(this, "winNormal1", void 0), (0, n.Z)(this, "winNormal2", void 0), (0, n.Z)(this, "winNormal3", void 0), this.backgroundNormal = this.get("backgroundNormal"), this.winNormal1 = this.get("win_normal_1"), this.winNormal2 = this.get("win_normal_2"), this.winNormal3 = this.get("win_normal_3"), this.bigWin = this.get("bigWin"), this.giantWin = this.get("giantWin"), this.spinStart = this.get("spinStart"), this.spinFast = this.get("spinFast"), this.clickNormal = this.get("clickNormal"), this.wheelStop = this.get("wheelStop"), this.joker = this.get("joker"), this.respin = this.get("respin"), this.wildWheel = this.get("wildWheel"), this.currentWinSound = null, this._setupEvents()
                    }
                    _setupEvents() {
                        ...
                        })), jt.action.on("state:spin_enter", this._onSpinEnter, this), jt.action.on("state:finish_enter", this._onFinishEnter, this), jt.action.on("sound:spinFast", this._onFastSpin, this), jt.action.on("wheel:stop_down", this._onWheelStop, this), jt.action.on("sound:click", this.click, this), jt.action.on("sound:joker", (() => {
                            this.joker.play()
                        })), jt.action.on("sound:respin", (() => {
                            this.respin.play()
                        })), jt.action.on("sound:WildsWheel", (() => {
                            this.wildWheel.play()
                        }))
                    }
                    stopBigWin() {
                                ...
                                if (l) {
                                    ...
                                    if (c.visible = !0, d) {
                                        var f = r.color.r * u.r,
                                            k = r.color.g * u.g,
                                            S = r.color.b * u.b;
                                        d.setLight(o[0] * f + n[0] * (1 - f), o[1] * k + n[1] * (1 - k), o[2] * S + n[2] * (1 - S)), r.darkColor ? (f = r.darkColor.r, k = r.darkColor.g, S = r.darkColor.b) : (f = 0, k = 0, S = 0), d.setDark(o[0] * f + n[0] * (1 - f), o[1] * k + n[1] * (1 - k), o[2] * S + n[2] * (1 - S))
                                    }
                                    c.alpha = r.color.a
                                } else c.visible = !1
                            }
                            for (var x = this.skeleton.drawOrder, C = null, B = null, P = 0, E = x.length; P < E; P++) {
                                var T = i[x[P].data.index],
                                    O = this.slotContainers[x[P].data.index];
                ...
                class ps extends(zt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "backgroundAnimation", void 0), (0, n.Z)(this, "backgroundLTextureNormal", void 0), (0, n.Z)(this, "backgroundPTextureNormal", void 0), (0, n.Z)(this, "backgroundTextureLandscape", void 0), (0, n.Z)(this, "backgroundTexturePortrait", void 0), (0, n.Z)(this, "logo", void 0), this.backgroundLTextureNormal = this.game.loader.getAsset("bgln"), this.backgroundPTextureNormal = this.game.loader.getAsset("bgpn"), this.backgroundTextureLandscape = this.backgroundLTextureNormal, this.backgroundTexturePortrait = this.backgroundPTextureNormal, this.background = new $.j(this.backgroundTextureLandscape), this.background.name = "background", this.backgroundAnimation = new us(this.game.loader.getAsset("bgEffect")), this.backgroundAnimation.play("animation", !0), this.logo = new $.j(this.game.loader.getAsset("logo")), this.logo.name = "logo", this.logo.position.set(44, 20), this.addChild(this.background), this.addChild(this.backgroundAnimation), this.addChild(this.logo), this.setupEvents()
                    }
                    setupEvents() {}
                    resize() {
                        this.game.device.portrait && !this.game.device.desktop ? (this.background.texture = this.backgroundTexturePortrait, this.background.width = 2 * this.game.viewport.paddingX + this.game.viewport.width, this.background.height = 2 * this.game.viewport.paddingY + this.game.viewport.height, this.background.position.set(-this.game.viewport.paddingX, 0), this.backgroundAnimation.visible = !1, this.logo.scale.set(1.5), this.logo.position.set(310, 20)) : (this.background.texture = this.backgroundTextureLandscape, this.background.width = this.game.viewport.width, this.background.height = this.game.viewport.height, this.background.position.set(0, 0), this.backgroundAnimation.visible = !0, this.logo.scale.set(1), this.logo.position.set(44, 20))
                    }
                }
                ...
                class Cs extends(zt(H.W2)) {
                    constructor(t, e, i) {
                        super(), (0, n.Z)(this, "progress", void 0), (0, n.Z)(this, "minPosition", void 0), (0, n.Z)(this, "maxPosition", void 0), (0, n.Z)(this, "onChange", void 0), this.track = t, this.background = e, this.foreground = i, this.progress = new ks, this.progress.mask = this.progress.addChild(new xs(0, 15, this.background.width, this.background.height - 25)), this.minPosition = new X.Point(0, this.track.padding), this.maxPosition = new X.Point(0, this.background.height - this.track.padding), this.onChange = new(k()), this.progress.addChild(this.background), this.progress.addChild(this.foreground), this.addChild(this.progress), this.addChild(this.track), this.track.x = this.progress.width / 2, this.handleProgress(), this.handleTrack()
                    }
                    handleProgress() {
                ...
                class Bs extends(zt(H.W2)) {
                    constructor() {
                        ...
                        i.width = 12, i.height = 151, this.onChangeVolume = new(k()), this.slider = new Cs(t, e, i), this.slider.position.set(33, 30), this.slider.onChange.add((t => this.onChangeVolume.dispatch(this.convertToVolume(t)))), this.interactive = !0, this.hitArea = new X.Rectangle(0, 0, 78, 200), this.game.interaction.up(this, (() => {
                ...
                class Ds extends Ts {
                    constructor(t) {
                        super(), (0, n.Z)(this, "betLevel", void 0), (0, n.Z)(this, "betLevelText", void 0), (0, n.Z)(this, "updateAll", (() => {
                        ...
                        })), this.betLevel = t, this.betLevelText = this.addChild(new Be("", Ws(Ws({}, Fs.Common), {}, {
                            default: Ws(Ws({}, Fs.Common.default), {}, {
                                align: "left"
                            })
                            ...
                            !Ni.isBasic() || this.game.autoPlay.enabled || this.game.freeRound.enabled || this.enable()
                ...
                class _s extends Be {
                    constructor() {
                        super("", zs(zs({}, Fs.Common), {}, {
                            default: zs(zs({}, Fs.Common.default), {}, {
                                align: "right"
                            })
                        }))
                    }
                ...
                class Qs extends Be {
                    constructor() {
                        super("", Fs.Common), this.anchor.x = .5
                    }
                    update(t) {
                        var e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
                ...
                class Hs extends Es {
                    constructor() {
                        super(), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "buttonAccept", void 0), (0, n.Z)(this, "buttonAutoPlay", void 0), (0, n.Z)(this, "buttonMaxBet", void 0), (0, n.Z)(this, "buttonMenu", void 0), (0, n.Z)(this, "buttonQuickSpin", void 0), (0, n.Z)(this, "buttonSound", void 0), (0, n.Z)(this, "buttonSpin", void 0), (0, n.Z)(this, "freeRoundLeft", void 0), (0, n.Z)(this, "freeRoundTotalWin", void 0), (0, n.Z)(this, "textBalance", void 0), (0, n.Z)(this, "textWin", void 0), this.background = $.j.from("data:image/png;base64,"), this.background.alpha = .4, this.background.anchor.set(0, 1), this.background.position.set(0, this.game.viewport.height), this.buttonMenu = new vs, this.buttonMenu.position.set(77, 1013), this.buttonMaxBet = new Ds(this.game.betLevel), this.buttonMaxBet.position.set(213, 1013), this.buttonAutoPlay = new As, this.buttonAutoPlay.position.set(833, 1013), this.buttonQuickSpin = new bs, this.buttonQuickSpin.position.set(1084, 1014), this.buttonSound = new Ps, this.buttonSound.position.set(1840, 1012), this.buttonSpin = function() {
                            ...
                            e.name = "buttonSpin", e.hitArea = new X.Circle(70, 70, 80);
                            ...
                            function a() {
                                i.enable(), e.enable(), s.play("active")
                            }

                            function h() {
                                "respin" !== jt.store.get("reward:feature") && i.enable(), jt.autoPlay.enabled || s.play("active"), e.visible = !0
                            }
                            return e.addChild(s), s.play("active"), e.onClick.add(o), e.onHover.add((() => {
                                ...
                                e.enable(), s.play("active"), i.enable()
                            })), {
                                container: e,
                                hide() {
                                    e.visible = !1
                                ...
                                press(o) {
                                    e.enable(), s.play("active"), i.enable(), t.once(o)
                                },
                                enable() {
                                    e.enable(), s.play("active"), i.enable()
                                },
                        ...
                        }(this.game.loader.getAsset("assets/images/controls/desktop/btn_spin_active.png")), this.buttonSpin.container.scale.set(.94), this.buttonSpin.container.position.set(892, 940), this.buttonAccept = new ms, this.buttonAccept.position.set(958, 1013), this.textWin = new Qs, this.textWin.anchor.x = .5, this.textWin.position.set(1400, 980), this.textBalance = new _s, this.textBalance.anchor.x = 1, this.textBalance.position.set(1760, 980), this.freeRoundLeft = Ns(Fs.Common), this.freeRoundLeft.container.position.set(1700, 1054), this.freeRoundTotalWin = Gs(Fs.Common), this.freeRoundTotalWin.container.position.set(1400, 980), this.addChild(this.background), this.addChild(this.buttonMenu), this.addChild(this.buttonMaxBet), this.game.config.get("autoPlay.available", !0) && this.addChild(this.buttonAutoPlay), this.game.config.get("quickSpin.available", !0) && this.addChild(this.buttonQuickSpin), this.addChild(this.buttonSound), this.addChild(this.buttonSpin.container), this.addChild(this.buttonAccept), this.addChild(this.textWin), this.game.config.get("balanceHide", !1) || this.addChild(this.textBalance), this.addChild(this.freeRoundTotalWin.container), this.addChild(this.freeRoundLeft.container), this.textWin.update(this.game.wallet.coins), this.textBalance.update(this.game.wallet.balance), this.game.freeRound.onStart.once((t => {
                            ...
                            this.game.autoPlay.enabled || this.buttonAutoPlay.disable(), "respin" !== this.game.store.get("reward:feature") && (this.freeRoundLeft.updateLeft(this.game.freeRound.left - 1), this.textBalance.update(this.game.wallet.balance - this.game.betLevel.toCoins()))
                        })), this.game.action.on("state:finish_exit", (() => {
                            Ni.isBasic() && (this.game.autoPlay.enabled || this.buttonMenu.enable(), this.buttonAutoPlay.enable())
                            ...
                            Ni.isRespin() && (this.buttonMenu.disable(), this.buttonAutoPlay.disable())
                        }))
                    }
                    lock() {
                ...
                class so extends Es {
                    constructor() {
                        super(), (0, n.Z)(this, "autoPlayButton", void 0), (0, n.Z)(this, "betButton", void 0), (0, n.Z)(this, "buttonAccept", void 0), (0, n.Z)(this, "buttonMenu", void 0), (0, n.Z)(this, "buttonQuickSpin", void 0), (0, n.Z)(this, "buttonSound", void 0), (0, n.Z)(this, "buttonSpin", void 0), (0, n.Z)(this, "onPressButtonSpin", void 0), (0, n.Z)(this, "state", void 0), (0, n.Z)(this, "statusBar", void 0), this.state = Js.Normal, this.onPressButtonSpin = new(k()), this.statusBar = new eo, this.statusBar.changeState(this.state), this.game.freeRound.enabled ? (this.statusBar.update({
                            ...
                            this.buttonSpin.scale.set(1), x.to(this.buttonSpin, .2, {
                                pixi: {
                                    scale: 1.04
                                },
                                yoyo: !0,
                            ...
                            this.game.freeRound.enabled || Ni.isFreespin() || this.statusBar.update({
                                type: qs.Balance,
                                value: this.game.wallet.balance
                            })
                        })), this.game.action.on("reward:reset", (() => {
                            ...
                            !Ni.isBasic() || this.game.autoPlay.enabled || this.game.freeRound.enabled || (this.betButton.show(), this.betButton.enable())
                        })), this.game.action.on("state:spin_enter", (() => {
                            ...
                            }), this.game.freeRound.enabled ? i || this.statusBar.update({
                                type: qs.FreeRoundLeft,
                            ...
                            var t = this.game.autoPlay.enabled,
                                e = this.game.store.get("reward:feature");
                            t && "respin" !== e && (this.buttonSpin.visible = !0, this.buttonSpin.interactive = !0)
                        })), this.game.action.on("state:finish_exit", (() => {
                            var t = this.game.autoPlay.enabled,
                                e = "respin" === this.game.store.get("reward:feature");
                            this.buttonSpin.visible = !0, this.buttonSpin.interactive = !0, e || t || (this.buttonQuickSpin.show(), this.autoPlayButton.show(), this.autoPlayButton.enable(), this.buttonMenu.show(), this.buttonMenu.enable())
                        })), this.game.action.on("state:setup_enter", (() => {
                            Ni.isRespin() && (this.buttonMenu.disable(), this.autoPlayButton.disable())
                        })), this.game.freeRound.onFinish.once((() => {
                            this.statusBar.update({
                                type: qs.Balance,
                                value: this.game.wallet.balance
                    ...
                    disableButtonSpin() {
                        this.buttonSpin.interactive = !1, this.onPressButtonSpin.handlers(!0) && this.onPressButtonSpin.detachAll()
                    }
                    pressButtonSpin(t) {
                        this.buttonSpin.interactive = !0, this.onPressButtonSpin.once(t)
                    }
                }
                class oo extends(zt(H.W2)) {
                    constructor() {
                ...
                class co extends(zt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "_betWays", void 0), (0, n.Z)(this, "_payTableParagraph", void 0), (0, n.Z)(this, "_payTableTitle", void 0), (0, n.Z)(this, "_textureAtlas", void 0), this._payTableTitle = new lo(this.game.i18n.t("PaytableSectionBetLinesTitle").toUpperCase()), this._textureAtlas = this.game.loader.getAsset("paytable"), this._betWays = new $.j(this._textureAtlas.payways_scheme), this._betWays.scale.set(2), this._betWays.position.set(0, this._payTableTitle.y + this._payTableTitle.height + 30), this._payTableParagraph = new ro(this.game.i18n.t("PaytableSectionBetLinesContent1")), this._payTableParagraph.position.set(0, this._betWays.y + this._betWays.height + 30), this.addChild(this._payTableTitle, this._betWays, this._payTableParagraph)
                    }
                    resize() {
                        this.game.device.desktop || (this._betWays.scale.set(3), this._betWays.y = this._payTableTitle.y + this._payTableTitle.height + 30, this._payTableParagraph.y = this._betWays.y + this._betWays.height + 30)
                    }
                }
                class uo extends(zt(H.W2)) {
                    constructor(t) {
                ...
                class po extends(zt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "sectionTitle", void 0), (0, n.Z)(this, "symbolBMask", void 0), (0, n.Z)(this, "symbolGMask", void 0), (0, n.Z)(this, "symbolRMask", void 0), (0, n.Z)(this, "lp5", void 0), (0, n.Z)(this, "lp3", void 0), (0, n.Z)(this, "lp6", void 0), (0, n.Z)(this, "lp1", void 0), (0, n.Z)(this, "symbols", void 0), this.sectionTitle = new lo(this.game.i18n.t("PaytableSectionPayoutTitle").toUpperCase()), this.symbolBMask = new uo("hpBrown"), this.symbolBMask.position.set(0, this.sectionTitle.y + this.sectionTitle.height + 30), this.symbolGMask = new uo("hpGreen"), this.symbolGMask.position.set(600, this.sectionTitle.y + this.sectionTitle.height + 30), this.symbolRMask = new uo("hpRed"), this.symbolRMask.position.set(0, this.symbolBMask.y + this.symbolBMask.height + 30), this.lp1 = new uo("lp1"), this.lp1.position.set(600, this.symbolGMask.y + this.symbolGMask.height + 30), this.lp3 = new uo("lp3"), this.lp3.position.set(0, this.symbolRMask.y + this.symbolRMask.height + 30), this.lp5 = new uo("lp5"), this.lp5.position.set(600, this.lp1.y + this.lp1.height + 30), this.lp6 = new uo("lp6"), this.lp6.position.set(0, this.lp3.y + this.lp3.height + 30), this.symbols = [this.symbolBMask, this.symbolGMask, this.symbolRMask, this.lp1, this.lp3, this.lp5, this.lp6], this.addChild(this.sectionTitle, ...this.symbols)
                    }
                    updateBet(t) {
                        this.symbols.forEach((e => e.updateBet(t)))
                    }
                    resize() {
                        this.game.device.desktop || (this.game.device.landscape ? (this.symbolBMask.position.set(0, this.sectionTitle.y + this.sectionTitle.height + 30), this.symbolGMask.position.set(820, this.sectionTitle.y + this.sectionTitle.height + 30), this.symbolRMask.position.set(0, this.symbolBMask.y + this.symbolBMask.height + 30), this.lp1.position.set(820, this.symbolGMask.y + this.symbolGMask.height + 30), this.lp3.position.set(0, this.symbolRMask.y + this.symbolRMask.height + 30), this.lp5.position.set(820, this.lp1.y + this.lp1.height + 30), this.lp6.position.set(0, this.lp3.y + this.lp3.height + 30)) : (this.symbolBMask.position.set(0, this.sectionTitle.y + this.sectionTitle.height + 30), this.symbolGMask.position.set(0, this.symbolBMask.y + this.symbolBMask.height + 30), this.symbolRMask.position.set(0, this.symbolGMask.y + this.symbolGMask.height + 30), this.lp1.position.set(0, this.symbolRMask.y + this.symbolRMask.height + 30), this.lp3.position.set(0, this.lp1.y + this.lp1.height + 30), this.lp5.position.set(0, this.lp3.y + this.lp3.height + 30), this.lp6.position.set(0, this.lp5.y + this.lp5.height + 30)))
                    }
                }
                class go extends(zt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "_sectionParagraph1", void 0), (0, n.Z)(this, "_sectionParagraph2", void 0), (0, n.Z)(this, "_sectionTitle", void 0), (0, n.Z)(this, "_symbol1", void 0), (0, n.Z)(this, "_symbol2", void 0), this._sectionTitle = new lo(jt.i18n.t("PaytableSectionWildTitle").toUpperCase()), this._sectionTitle.position.set(0, 0), this._symbol1 = new uo("wild"), this._symbol1.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this._symbol1.withoutPayout(), this._sectionParagraph1 = new ro(jt.i18n.t("PaytableSectionWildContent1")), this._sectionParagraph1.position.set(this._symbol1.x + this._symbol1.width, this._sectionTitle.height + this._sectionTitle.y + 30), this._sectionParagraph1.setTagStyle("default", {
                            wordWrapWidth: 690
                        }), this._symbol2 = new $.j(jt.loader.getAsset("respinsImage")), this._symbol2.position.set(0, this._symbol1.height + this._symbol1.y + 30), this._sectionParagraph2 = new ro(jt.i18n.t("PaytableSectionWildContent2")), this._sectionParagraph2.position.set(0, this._symbol2.height + this._symbol2.y + 30), this.addChild(this._sectionTitle, this._symbol1, this._sectionParagraph1, this._symbol2, this._sectionParagraph2)
                    }
                    updateBet(t) {
                    ...
                    resize() {
                        this.game.device.desktop || (this.game.device.landscape ? (this._symbol1.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this._sectionParagraph1.position.set(this._symbol1.x + this._symbol1.width, this._sectionTitle.height + this._sectionTitle.y + 30), this._sectionParagraph1.setTagStyle("default", {
                            wordWrapWidth: 490
                        }), this._symbol2.position.set(0, this._symbol1.height + this._symbol1.y + 30), this._sectionParagraph2.position.set(0, this._symbol2.height + this._symbol2.y + 30)) : (this._symbol1.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this._sectionParagraph1.position.set(0, this._symbol1.height + this._symbol1.y + 30), this._sectionParagraph1.setTagStyle("default", {
                            wordWrapWidth: 390
                        }), this._symbol2.position.set(0, this._sectionParagraph1.height + this._sectionParagraph1.y + 30), this._sectionParagraph2.position.set(0, this._symbol2.height + this._symbol2.y + 30)))
                    }
                }
                class Ao extends oo {
                    constructor() {
                        super(), (0, n.Z)(this, "_paytableSectionBetLines", void 0), (0, n.Z)(this, "_paytableSectionPayout", void 0), (0, n.Z)(this, "_paytableSectionWild", void 0), (0, n.Z)(this, "payTableDelimiter", void 0), this._paytableSectionPayout = new po, this._paytableSectionWild = new go, this.payTableDelimiter = new no, this._paytableSectionBetLines = new co, this.content.addChild(this._paytableSectionPayout, this._paytableSectionWild, this.payTableDelimiter, this._paytableSectionBetLines)
                    }
                    updateBet(t) {
                ...
                class yo extends(zt(H.W2)) {
                    constructor(t) {
                        super(), (0, n.Z)(this, "bottomPositions", void 0), (0, n.Z)(this, "containerPositions", void 0), (0, n.Z)(this, "slot", void 0), (0, n.Z)(this, "wildReelIndexs", void 0), this.slot = t, this.containerPositions = [80, -10, -100, -100, -10, 80], this.bottomPositions = [600, 780, 960, 960, 780, 600]
                    }
                    createAnimations(t, e) {
                        var i = new H.W2;
                        i.x = t, i.y = this.containerPositions[e];
                        var s = new us(this.game.loader.getAsset("wildReelEffect"));
                        s.alpha = 0, s.position.set(0, 0);
                        var o = new us(this.game.loader.getAsset("wildReelEffect"));
                        o.alpha = 0, s.position.set(0, this.bottomPositions[e]), i.addChild(s, o), this.addChild(i)
                    }
                    show(t) {
                        var e = this;
                        return (0, o.Z)((function*() {
                            e.wildReelIndexs = jt.store.get("reward:wildReels", []), e.wildReelIndexs.forEach((i => {
                                e.children[i].children.forEach((e => {
                                    e.alpha = 1, e.play("game" === t ? "wild-appear" : "wild-indicator").then((() => {
                                        e.play("wild-indicator", !0)
                                    }))
                                }))
                            }))
                        }))()
                ...
                class ko extends(zt(fo)) {
                    constructor(t) {
                        super(), (0, n.Z)(this, "isExist", void 0), (0, n.Z)(this, "slot", void 0), (0, n.Z)(this, "wildReelIndexs", void 0), this.slot = t, this.isExist = !1, this.wildReelIndexs = []
                    }
                    overlay() {
                        this.children.forEach((t => {
                            t.tint = 6316128
                    ...
                    checkWin() {
                        var t = jt.store.get("reward:lines", []);
                        !this.isExist || t.length <= 0 || (this.overlay(), t.forEach((t => {
                            t.pos.forEach((t => {
                                var [e, i] = t;
                                this.children.forEach((t => {
                                    -1 !== e && t.index === i && t.wheel === e && (t.win = !0, t.tint = 16777215)
                                }))
                            }))
                        })))
                    }
                    show() {
                        var t = arguments,
                            e = this;
                        return (0, o.Z)((function*() {
                            var i = t.length > 0 && void 0 !== t[0] ? t[0] : "game";
                            if ("respin" === jt.store.get("reward:feature")) {
                                var s = "game" === i ? 800 : 100;
                                e.wildReelIndexs = jt.store.get("reward:wildReels", []), jt.action.emit("sound:joker"), e.slot.wildEffects.show(i), e.isExist = !0, e.slot.reels.forEach((t => t.visibleSymbols.forEach((t => t.alpha = 1)))), e.wildReelIndexs.forEach((t => {
                                    e.slot.reels[t].visibleSymbols.forEach(((s, o) => {
                                        if (s.visible) {
                                            var n = new us(jt.loader.getAsset("symbolAnimation")),
                                                a = s.getData();
                                            n.changeSkin(a.animation.skin), "game" === i ? n.play("stickyTransform") : (n.changeSkin("wild"), n.play("stickyIdle", !0)), n.wheel = t, n.index = o, n.position.set(s.x, s.y), e.addChild(n)
                                        }
                                    })), e.slot.reels[t].children.forEach((t => {
                                        t.visible = !1, t.stopAnimation()
                                    })), e.slot.reels[t].wild = !0
                                })), yield jt.delay(s), "game" === i && (e.children.forEach((t => {
                                    t.changeSkin("wild"), t.play("stickyIdle", !0)
                                })), e.checkWin())
                            }
                        }))()
                    }
                    hide() {
                        this.isExist && (this.wildReelIndexs.forEach((t => {
                            var e = this.slot.reels[t];
                            e.wild = !1, e.children.forEach((t => {
                                t.visible = !0, t.replaceTexture(1)
                            }))
                        })), this.removeChildren()), this.isExist = !1, this.wildReelIndexs.length = 0, this.slot.wildEffects.hide()
                    }
                }
                class So extends(zt(H.W2)) {
                    constructor() {
                        super()
                    }
                    get isStop() {
                ...
                const xo = class extends So {
                    ...
                    get isStop() {
                        return super.isStop || "respin" === jt.store.get("reward:feature")
                    }
                    stop() {
                        this._wins.length = 0, clearInterval(this._flushInterval), jt.action.emit("stopAnimation")
                    }
                    _getWinSoundNumber() {
                    ...
                    _runSymbolAnimation(t) {
                        ...
                        for (var o of (i && this.slot.reels.forEach((t => t.clearAnimation())), e)) {
                            this._findSymbol(o[0], o[1]).playAnimation({
                                type: s
                            })
                        }
                    }
                ...
                function Co() {
                    ...
                    return jt.action.on("symbol:playAnimation", ((i, s, o) => {
                        ...
                        if (! function(t, i) {
                                ...
                                x: i,
                                y: s
                            }), (a = t.addChild(new us(jt.loader.getAsset(o.assetName)))).name = "".concat(i).concat(s), a.alpha = 1, a.position.set(i, s)) : a = t.getChildByName("".concat(i).concat(s)), !a.visible || !a.playing || a.skinName !== o.skin || a.animationName !== o.effectName) {
                            o.skin && a.changeSkin(o.skin);
                            var h = "string" == typeof o.effectName ? o.effectName : o.effectName[o.type] || o.effectName.normal;
                            a.play(h, o.loop, null !== (n = o.trackIndex) && void 0 !== n ? n : 0, o.onComplete), a.visible = !0
                        }
                ...
                class Bo extends H.W2 {
                    constructor() {
                        super(), (0, n.Z)(this, "description", void 0), (0, n.Z)(this, "timeline", void 0), (0, n.Z)(this, "resolveTimeline", void 0), this.alpha = 0, this.description = new $.j(jt.loader.getAsset("respinsText")), this.addChild(this.description), this.timeline = new C({
                            onComplete: () => {
                    ...
                    show() {
                        return new Promise((t => {
                            this.resolveTimeline = t, this.pivot.set(this.width / 2, this.height / 2), this.timeline.set(this, {
                                pixi: {
                                    alpha: 0
                                }
                            }).to(this, .5, {
                ...
                function To(t, e, i) {
                    var s = !1,
                        o = "default",
                        n = jt.config.get("slot.layout.".concat(o, "[").concat(i, "]"), null);
                    if (!n) throw new Error("Symbol data not found");
                    var a = new $.j(jt.loader.getAsset(n.textureAtlas, n.assetName));

                    function h() {
                        n.animation && (jt.action.emit("symbol:stopAnimation", n.animation), s && (a.alpha = 1, a.tint = 16777215))
                    }
                    return a.position.set(t, e), Object.assign(a, {
                        clearAnimation: h,
                        overlay() {
                            a.alpha = 1, a.tint = 6316128
                        },
                        getData: () => n,
                        playAnimation(t) {
                            if (s = !0, a.alpha = 0, a.tint = 16777215, a.visible) return new Promise((e => {
                                jt.action.emit("symbol:playAnimation", a.x, a.y, Eo(Eo(Eo({}, n.animation), t), {}, {
                                    texture: a.texture,
                                    onComplete: e
                                }))
                            }))
                        ...
                        stopAnimation() {
                            s = !1, a.alpha = 1, a.tint = 16777215, h()
                        },
                        replaceTexture(t) {
                            n = jt.config.get("slot.layout.".concat(o, "[").concat(t, "]"), null), a.texture = jt.loader.getAsset(n.textureAtlas, n.assetName)
                        }
                    })
                }
                class Oo extends H.W2 {
                    constructor(t, e) {
                        super(), (0, n.Z)(this, "_endTween", void 0), (0, n.Z)(this, "_nReel", void 0), (0, n.Z)(this, "_numberSpinToComplete", void 0), (0, n.Z)(this, "_reel", void 0), (0, n.Z)(this, "_reelIndex", void 0), (0, n.Z)(this, "_spinTween", void 0), (0, n.Z)(this, "_startTween", void 0), (0, n.Z)(this, "_stopTimeout", void 0), (0, n.Z)(this, "_stopTimeoutDuration", void 0), (0, n.Z)(this, "isStop", void 0), (0, n.Z)(this, "symbolsPositions", void 0), (0, n.Z)(this, "visibleSymbols", void 0), (0, n.Z)(this, "wild", void 0), this.interactiveChildren = !1, this.visibleSymbols = [], this.symbolsPositions = e, this.wild = !1, this._reel = [], this._nReel = [], this._reelIndex = t, this._numberSpinToComplete = 0, this.isStop = !1, this._stopTimeout = null, this._stopTimeoutDuration = 0, this._startTween = new x(this, jt.config.get("wheel.durationSpin"), {
                            paused: !0,
                            roundProps: ["y"],
                            pixi: {
                        ...
                        }), this._spinTween = new x(this, jt.config.get("wheel.durationSpin"), {
                            paused: !0,
                            roundProps: ["y"],
                            pixi: {
                    ...
                    start() {
                        this.stopAnimation(), this.isStop = !1, this._numberSpinToComplete = this.visibleSymbols.length, this.children.forEach(((t, e) => {
                            ...
                            !this.wild && (t.y < this.visibleSymbols[0].y || t.y > this.visibleSymbols[this.visibleSymbols.length - 1].y) && (t.replaceTexture(i[e]), t.visible = !0)
                        }));
                        var t = jt.quickSpin.enabled ? jt.config.get("wheel.durationQuickDelta") : jt.config.get("wheel.durationDelta");
                        this._endTween.duration(t), this._stopTimeoutDuration = jt.quickSpin.enabled ? jt.config.get("wheel.durationQuickStop") : jt.config.get("wheel.durationStop"), this._startTween.restart()
                    }
                    stop(t) {
                        if (!this.isStop) {
                            var e = this.visible ? this._stopTimeoutDuration * t : 0,
                                i = jt.store.get("reward:nReels", []);
                            this._nReel = i[this._reelIndex].concat();
                            var s = jt.store.get("reward:reels", []);
                            this._reel = s[this._reelIndex].concat(), jt.store.get("spin:isFast", !1) ? (jt.action.emit("sound:spinFast"), clearTimeout(this._stopTimeout), this.isStop = !0) : this._stopTimeout = setTimeout((() => this.isStop = !0), e)
                        }
                    }
                    overlay() {
                    ...
                    _setup() {
                        ...
                        for (var i = 0, s = this._nReel.length; i < s; i++) {
                            var [o, n] = this.symbolsPositions[i], a = To(o, n, 0 === i || i === s - 1 ? this._nReel[i] : this._reel[i - 1]);
                            this.addChild(a), i > 0 && i < s - 1 ? this.visibleSymbols.push(a) : a.visible = !1
                        }
                    }
                    _spin() {
                        if (this._flip(), this.isStop)
                            ...
                            } else this.y = 0, this.children[0].y = this.symbolsPositions[0][1], this.children[this.children.length - 1].visible = !1, this._updateVisibleSymbols(), jt.store.get("respin") && this.wild || jt.action.emit("wheel:stop_down"), this._spinTween.pause(), this._endTween.restart()
                    }
                    _flip() {
                        var t = this.children.pop();
                        t.y = this.symbolsPositions[0][1], !this.isStop && this._nReel.length > 0 && t.replaceTexture(this._nReel.pop());
                        for (var e = 0, i = this.children.length; e < i; e++) this.children[e].y = this.symbolsPositions[e + 1][1];
                        this.children.unshift(t)
                    }
                    _complete() {
                        this.y = 0, this._reel.length = 0, this.children[0].visible = !1, this._endTween.pause(), clearTimeout(this._stopTimeout), jt.action.emit("wheel:stop", this._reelIndex)
                    }
                    update(t) {
                ...
                class Ro extends mo {
                    constructor() {
                        super(), (0, n.Z)(this, "animation", void 0), (0, n.Z)(this, "reels", void 0), (0, n.Z)(this, "reelsContainer", void 0), (0, n.Z)(this, "respinsText", void 0), (0, n.Z)(this, "stickyWild", void 0), (0, n.Z)(this, "stopReelCounter", void 0), (0, n.Z)(this, "textTotalWin", void 0), (0, n.Z)(this, "wildEffects", void 0), this.pivot.set(646, 0), this.reels = [], this.animation = new xo(this), this.stopReelCounter = 0, this.init(), this.setupEvents()
                    }
                    ...
                    init() {
                        this.reelsContainer = new H.W2, this.wildEffects = new yo;
                        for (var t = this.game.store.get("reward:reels", []).length, e = this.game.config.get("slot.symbolsPositions", []), i = 0; i < t; i++) {
                            var s = this.reelsContainer.addChild(new H.W2),
                                o = e[i],
                                n = s.addChild(new Oo(i, o));
                            this.reels.push(n);
                            var a = s.addChild(this.createMask(233, 200 * n.visibleSymbols.length + 40));
                            a.y = o[1][1] - 20, a.x = o[0][0], s.mask = a, this.wildEffects.createAnimations(o[0][0], i)
                        }
                        this.textTotalWin = new vo, this.textTotalWin.rotation = .15, this.textTotalWin.winText.letterSpacing = -40, this.textTotalWin.winText.anchor.set(1), this.respinsText = new Bo, this.stickyWild = new ko(this), this.addChild(this.reelsContainer), this.addChild(this.wildEffects), this.addChild(Co()), this.addChild(this.stickyWild), this.addChild(this.textTotalWin), this.addChild(this.respinsText)
                    }
                    setupEvents() {
                    ...
                    _onSetupEnter() {
                        var t = this;
                        return (0, o.Z)((function*() {
                            "respin" === t.game.store.get("reward:feature") && t.stickyWild.show("init"), t.game.state.goTo("ready")
                        }))()
                    }
                    _onReadyEnter() {
                        var t = this;
                        return (0, o.Z)((function*() {
                            var e = t.game.autoPlay.enabled,
                                i = t.game.store.get("reward:feature"),
                                s = t.game.store.get("reward:lines", []);
                            e ? setTimeout((() => {
                                t.game.action.emit("spin:start")
                            }), wo.get("before_spin_auto")) : "respin" === i ? (t.stickyWild.clear(), setTimeout((() => {
                    ...
                    _onSpinEnter() {
                        var t = this;
                        return (0, o.Z)((function*() {
                            var e = t.game.store.get("reward:feature");
                            t.animation.stop();
                            try {
                                yield t.game.beforeSpin(), "respin" !== e ? (t.stickyWild.hide(), t.game.store.set("respin", !1)) : (t.game.action.emit("sound:respin"), t.game.store.set("respin", !0), t.stickyWild.clear(), yield t.respinsText.show()), t.reels.forEach((t => t.start())), yield t.requestSpin(), t.game.state.goTo("stop")
                            } catch (e) {
                    ...
                    _onFinishEnter() {
                        var t = this;
                        return (0, o.Z)((function*() {
                            Ni.set(t.game.store.get("reward:feature")), t.stopReelCounter = 0, Ni.isRespin() || (yield t.game.freeRound.finish()), t.game.autoPlay.enabled ? t.game.checkBalance().then((() => {
                    ...
                    _onResetReward() {
                        this.animation.stop(), this.stickyWild.clear()
                    }
                    runSymbolAnimation(t) {
                        var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : -1;
                        e > -1 ? this.reels[e].visibleSymbols.forEach((e => e.playAnimation(t))) : this.reels.forEach((e => {
                            e.visibleSymbols.forEach((e => e.playAnimation(t)))
                        }))
                    }
                    resize() {
                        this.game.device.desktop || this.game.device.landscape ? (this.textTotalWin.position.set(this.game.device.landscape ? 1350 : 1500, 900), this.respinsText.position.set(this.game.device.landscape ? 1150 : 1250, 760), this.scale.set(.95), this.position.set(960, 0)) : (this.textTotalWin.position.set(1300, 900), this.respinsText.position.set(1150, 760), this.scale.set(1.2 * .5625), this.position.set(540, 292.5))
                    }
                }
                class Zo extends(zt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "timeline", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "value", void 0), (0, n.Z)(this, "light", void 0), (0, n.Z)(this, "coins", void 0), (0, n.Z)(this, "onPress", void 0), this.visible = !1, this.interactive = !0, this.onPress = new(k()), this.game.interaction.click(this, (() => this.onPress.dispatch())), this.timeline = new C, this.content = new H.W2, this.overlay = new Jt(.75), this.title = new $.j, this.title.anchor.set(.5), this.value = new v.Xz("", {
                            fontName: "WinFont"
                        }), this.value.anchor = .5, this.light = new us(this.game.loader.getAsset("effectBigWinLight")), this.light.alpha = 0, this.coins = new us(this.game.loader.getAsset("effectBigWinCoins")), this.coins.alpha = 0, this.content.addChild(this.title), this.content.addChild(this.value), this.addChild(this.overlay), this.addChild(this.light), this.addChild(this.coins), this.addChild(this.content)
                    }
                    show(t, e) {
                        var i = this;
                        return (0, o.Z)((function*() {
                            ...
                            return i.value.scale.set(n), new Promise((a => {
                                i.content.alpha = 0, i.value.alpha = 0, i.timeline.eventCallback("onComplete", (() => {
                                    i.hide(), a()
                                }));
                                var h = {
                                    coins: 0
                    ...
                    resize() {
                        this.game.device.desktop || this.game.device.landscape ? (this.scale.set(1), this.content.position.set(this.game.viewport.width / 2, 300), this.light.scale.set(1), this.light.position.set(0, 0), this.coins.scale.set(1), this.coins.position.set(0, 0), this.title.scale.set(1), this.value.scale.set(.8), this.value.position.set(0, this.title.height + 50)) : (this.content.position.set(this.game.viewport.width / 2, (this.game.viewport.height - 500) / 2), this.light.scale.set(1), this.light.position.set(-400, 0), this.coins.scale.set(1), this.coins.position.set(-420, 400), this.title.scale.set(1), this.value.position.set(0, this.title.height + 100))
                    }
                }
                new class extends class extends class extends class {
                    ...
                    initPopups() {
                        this.popupManager.add([new Ei, new Ci, new Bi, new ki, new Zi, new xi, new Ti, new Oi, new Pi, new Si, new Ri])
                    }
                    loadAssets(t) {
                    ...
                    initModules(t) {
                        ...
                        this.wallet = new qe(this.server), this.betLevel = new Wt(null == o ? void 0 : o.bet, null == o ? void 0 : o.bets, null !== (e = null == o ? void 0 : o.betCoins) && void 0 !== e ? e : 1), this.autoPlay = new Qe({
                            counts: this.config.get("autoPlay.counts", [10, 25, 50, 100, 150, 300, -1]).map((t => {
                                var e = Number(t);
                                return -1 === e ? 1 / 0 : e
                            })).filter((t => t > 0))
                        }), this.freeRound = new Ye, this.quickSpin = new Ke(this.config), this.bigWin = new He(this.config.get("bigWin.bigMultiplier"), this.config.get("bigWin.giantMultiplier"), this.betLevel), this.config.set("autoPlay.available", this.autoPlay.available), this.config.set("quickSpin.available", this.quickSpin.available), this.netPosition.setEnabled(null !== (i = null == o || null === (s = o.gameConfig) || void 0 === s ? void 0 : s.netPosition) && void 0 !== i && i)
                    }
                    initViews() {
                    ...
                    constructor() {
                        super({}), (0, n.Z)(this, "autoPlaySettings", void 0), (0, n.Z)(this, "betSettings", void 0), (0, n.Z)(this, "bigWinAnimation", void 0), (0, n.Z)(this, "fastStopLayout", void 0), (0, n.Z)(this, "gameRules", void 0), (0, n.Z)(this, "menu", void 0), (0, n.Z)(this, "paytable", void 0), (0, n.Z)(this, "slot", void 0), Qi.init(), this.init(Di, ji)
                    }
                    loadTranslations() {
                    ...
                    initViews() {
                        var t = this;
                        super.initViews(), this.rootNode.addChild(new ps), this.slot = this.rootNode.addChild(new Ro), this.paytable = new Ao, this.gameSettings = new Ne, this.config.get("quickSpin.available", !0) && this.gameSettings.addItem(this.createQuickSpinCheckbox()), this.gameSettings.addItem(this.createFullscreenCheckbox()), this.gameSettings.addItem(this.createLeftHandCheckbox()), this.gameSettings.addItem(this.createGameSoundsCheckbox()), this.gameSettings.addItem(this.createBackgroundSoundsCheckbox()), this.bigWinAnimation = new Zo, this.fastStopLayout = new Ee, this.controls = this.device.desktop ? new Hs : new so, this.betSettings = this.rootNode.addChild(new Pe), this.betSettings.setBets(this.betLevel.bets, this.betLevel.betCoins), this.betSettings.setPayLines("3600", "ways"), this.betSettings.setBet(this.betLevel.bet), this.autoPlaySettings = this.rootNode.addChild(new ce), this.autoPlaySettings.setAutoPlayCounts(this.autoPlay.counts), this.autoPlaySettings.stopSection.addItem(new ke), this.autoPlaySettings.stopSection.addItem(new me), this.autoPlaySettings.stopSection.addItem(new ve), this.gameRules = new Ue, this.menu = new ze, this.menu.addItem(this.loader.getAsset("iconPaytable"), this.paytable), this.menu.addItem(this.loader.getAsset("iconSettings"), this.gameSettings), this.menu.addItem(this.loader.getAsset("iconRules"), this.gameRules), this.rootNode.addChild(this.fastStopLayout), this.rootNode.addChild(this.menu), this.rootNode.addChild(this.controls), this.rootNode.addChild(this.bigWinAnimation), this.paytable.updateBet(this.betLevel), this.controls.updateBet(this.betLevel), this.betSettings.on("open", (() => {
                            ...
                            this.autoPlay.enabled && !this.store.get("free:isFree", !1) && "respin" !== this.store.get("reward:feature") && (this.autoPlay.setCount(this.autoPlay.count - 1), this.controls.setAutoPlayCount(this.autoPlay.count)), this.controls.onSpinEnter()
                    ...
                    start() {
                        var t = () => super.start,
                            e = this;
                        return (0, o.Z)((function*() {
                            t().call(e), Ni.set(e.store.get("reward:feature", Ui.Basic)), yield e.freeRound.start(), "respin" === e.store.get("reward:feature") && (yield e.popupManager.show("PopupRestore")), e.sound.get("backgroundNormal").fade(2), e.state.goTo("setup")
                        }))()
                    }
                    reward() {
                        var t = this,
                        ...
                        return (0, o.Z)((function*() {
                            var o;
                            e(), yield t.slot.stickyWild.show(), t.slot.stickyWild.checkWin(), null !== (o = t.bigWin) && void 0 !== o && o.available(t.wallet.coins) && (t.bigWinAnimation.press(i), t.controls.pressButtonSpin(i), yield t.bigWinAnimation.show(t.bigWin.type(t.wallet.coins), t.wallet.coins), t.sound.stopBigWin(), e());
                            var n = t.store.get("reward:lines", []);
                            n.length > 0 && (t.slot.reels.forEach((t => t.stopAnimation())), t.controls.disableButtonSpin(), t.slot.textTotalWin.once("show", (() => {
                    ...
                    checkBalance() {
                        var t = this;
                        return (0, o.Z)((function*() {
                            if (!(t.freeRound.enabled || t.store.get("free:isFree", !1) || Ni.isRespin()) && t.wallet.balance < t.betLevel.toCoins()) {
                                try {
                                    yield t.server.request({
                                        action: "balance"
                    ...
                    beforeSpin() {
                        var t = this;
                        return (0, o.Z)((function*() {
                            Ni.isRespin() || t.autoPlay.enabled || Ni.isFreespin() || (yield t.quickSpin.tryEnable())
                        }))()
                    }
                    afterReelsStop() {
                        !this.store.get("spin:isFast", !1) || this.autoPlay.enabled || Ni.isRespin() || Ni.isFreespin() || this.quickSpin.update()
                    }
                }
            },
            3113: () => {}
    ...
    n.m = s, t = [], n.O = (e, i, s, o) => {
    ...
    }), t), n.o = (t, e) => Object.prototype.hasOwnProperty.call(t, e), e = {}, i = "aloha_tiki_bar_dice:", n.l = (t, s, o, a) => {
        if (e[t]) e[t].push(s);
        else {
            var h, r;
            if (void 0 !== o)
        ...
        var e = (e, i) => {
            ...
            i = self.webpackChunkaloha_tiki_bar_dice = self.webpackChunkaloha_tiki_bar_dice || [];
        i.forEach(e.bind(null, 0)), i.push = e.bind(null, i.push.bind(i))
    })();
    var a = n.O(void 0, [216], (() => n(4363)));
    a = n.O(a)
})();