...
(() => {
    var t, e, i, s = {
            7258: (t, e, i) => {
                ...
                class O {
                    ...
                    set volume(t) {
                        t <= 0 && !this.mutedAll ? _.forEach((t => this.setMuteBySound(t, !0))) : t > 0 && this.mutedAll && _.forEach((t => this.setMuteBySound(t, !1))), this.savedVolume = t, this.setGlobalVolume(t), this.onChangeVolume.dispatch(t)
                    }
                    get volume() {
                    ...
                    filterByType(t) {
                        return Array.from(_.values()).filter((e => {
                            var {
                                type: i
                            } = e;
                            return "all" === t || t === i
                    ...
                    get(t) {
                        var e;
                        return null === (e = _.get(t)) || void 0 === e ? void 0 : e.sound
                    }
                    play(t) {
                ...
                class R {
                    static pre(t, e) {
                        t && R.supportedSoundExtensions.includes(t.extension) ? (t.load = function(t) {
                            ...
                            _.set(e, E(E({}, this.metadata.audioMetadata), {}, {
                                id: e,
                                sound: this.sound,
                                muted: !1
                ...
                class U {
                    ...
                    readSkeletonData(t, e) {
                        ...
                        var s = i.readString(),
                            o = N(s),
                            n = null;
                        if (o === Z.VER38 && (n = new I.SkeletonBinary(new I.AtlasAttachmentLoader(t))), (i = new W.BinaryInput(e)).readInt32(), i.readInt32(), (o = N(s = i.readString())) !== Z.VER40 && o !== Z.VER41 || (n = new L.SkeletonBinary(new L.AtlasAttachmentLoader(t))), !n) {
                ...
                class z {
                    ...
                    readSkeletonData(t, e) {
                        var i = e.skeleton.spine,
                            s = N(i),
                            o = null;
                        if (s === Z.VER37 && (o = new D.SkeletonJson(new D.AtlasAttachmentLoader(t))), s === Z.VER38 && (o = new I.SkeletonJson(new I.AtlasAttachmentLoader(t))), s !== Z.VER40 && s !== Z.VER41 || (o = new L.SkeletonJson(new L.AtlasAttachmentLoader(t))), !o) {
                ...
                var G = i(512),
                    ...
                    et = i(798),
                    it = i(5277);
                u.TC.nextRoundedRectBehavior = !0, A.xv.nextLineHeightBehavior = !0, c.R.add(p.bx, g.B9, d.Bv, a.c, h.Q, r.T, l.O, b.vl, m.o, V, y, R), window.PIXI = s;
                var st = i(3233),
                    ot = i.n(st);
                ...
                class Et extends it.EventEmitter {
                    constructor() {
                ...
                class Ft {
                    constructor() {
                        (0, n.Z)(this, "transitions", Object.create(null)), (0, n.Z)(this, "transition", _t)
                    }
                    is(t) {
                        var e;
                ...
                class Pe extends A.xv {
                    ...
                    _getTextDataPerLine(t) {
                        ...
                        return i[i.length - 1].map((t => {
                            t.text.includes(Be[v][0]) && (t.text = t.text.match(v === Ce ? /^(.*)\[/ : /^(.*)\</)[1])
                        })), i
                    }
                    getFontString(t) {
                    ...
                    updateText() {
                        if (this.withPrivateMembers().dirty) {
                                ...
                                for (var k = 0; k < S.length; k++) {
                                    ...
                                    switch (C.valign) {
                                        ...
                                        case "baseline":
                                            ...
                                            break;
                                        case "middle":
                                            F += (a[w] - n[w] - P.ascent - P.descent) / 2;
                                            break;
                                        case "bottom":
                                            F += a[w] - n[w] - P.ascent - P.descent;
                                            break;
                                        default:
                                            F += a[w] - P.ascent - C.valign
                                    }
                                    if (0 === C.letterSpacing) f.push({
                                        ...
                                        for (var O = 0; O < B.length; O++) {
                                            ...
                                            f.push({
                                                ...
                                                descent: P.descent,
                                                tag: _
                                            }), x += R, (O < B.length - 1 || k < S.length - 1) && (x += C.letterSpacing / 2)
                                        }
                                    }
                                }
                                y += a[w] - n[w]
                            ...
                            })), Pe.debugOptions.objects.enabled && (Pe.debugOptions.objects.bounding && (this.context.fillStyle = Pe.debugOptions.objects.bounding, this.context.beginPath(), this.context.rect(0, 0, b, v), this.context.fill()), Pe.debugOptions.objects.text && (this.context.fillStyle = "#ffffff", this.context.strokeStyle = "#000000", this.context.lineWidth = 2, this.context.font = "8px monospace", this.context.strokeText("".concat(b.toFixed(2), "x").concat(v.toFixed(2)), 0, 8, b), this.context.fillText("".concat(b.toFixed(2), "x").concat(v.toFixed(2)), 0, 8, b))), this.updateTexture()
                        }
                    }
                    wordWrap(t) {
                        var e = "",
                ...
                class Oe extends(Vt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "content", void 0), this.title = this.addChild(new Fe(this.game.i18n.t("GameRulesAdvancedAutoPlayTitle"))), this.content = this.addChild(new _e(this.game.i18n.t("GameRulesAdvancedAutoPlayContent")))
                    }
                    resize() {
                ...
                class Re extends(Vt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "content", void 0), this.title = this.addChild(new Fe(this.game.i18n.t("GameRulesAutoPlayTitle"))), this.content = this.addChild(new _e(this.game.i18n.t("GameRulesAutoPlayContent")))
                    }
                    resize() {
                        this.content.position.set(0, this.title.y + this.title.height + 30)
                    }
                ...
                class Ze extends(Vt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "content", void 0), this.content = this.addChild(new _e(this.game.i18n.t("GameRulesBestExperience")))
                    }
                    resize() {
                        this.content.position.set(0, 0)
                    }
                }
                class We extends(Vt($.j)) {
                    constructor() {
                ...
                class Me extends(Vt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "gameName", void 0), (0, n.Z)(this, "gameTRTP", void 0), this.title = this.addChild(new Fe(this.game.i18n.t("GameRulesGeneralTitle"))), this.gameName = this.addChild(new _e(this.game.config.get("gameName")));
                        var t = this.game.config.get("trtp");
                        this.gameTRTP = this.addChild(new _e(this.game.i18n.t("GameRulesGeneralRTP", t))), this.gameTRTP.visible = !!t
                    }
                    resize() {
                ...
                class De extends(Vt(H.W2, {
                    ...
                    constructor(t, e, i) {
                        super(), (0, n.Z)(this, "icon", void 0), (0, n.Z)(this, "text", void 0), this.name = i, this.icon = this.addChild(new $.j(e)), this.text = this.addChild(new _e(t))
                    }
                    resize() {
                ...
                class Ie extends(Vt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "content", void 0), this.title = this.addChild(new Fe(this.game.i18n.t("GameRulesInterfaceTitle"))), this.content = this.addChild(new _e(this.game.i18n.t("GameRulesInterfaceContent"))), this.addItems()
                    }
                    addItems() {
                ...
                class Le extends(Vt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "itemQuickSpin", void 0), (0, n.Z)(this, "itemFullscreen", void 0), (0, n.Z)(this, "itemGameSound", void 0), (0, n.Z)(this, "itemBackgroundSound", void 0), this.title = this.addChild(new Fe(this.game.i18n.t("GameRulesSettingsTitle"))), this.content = this.addChild(new _e(this.game.i18n.t("GameRulesSettingsContent"))), this.game.config.get("quickSpin.available", !0) && (this.itemQuickSpin = this.addChild(new _e(this.game.i18n.t("GameRulesSettingsContentItemQuickSpin")))), this.itemFullscreen = this.addChild(new _e(this.game.i18n.t("GameRulesSettingsContentItemFullscreen"))), this.itemGameSound = this.addChild(new _e(this.game.i18n.t("GameRulesSettingsContentItemGameSound"))), this.itemBackgroundSound = this.addChild(new _e(this.game.i18n.t("GameRulesSettingsContentItemBackgroundSound")))
                    }
                    resize() {
                        var t;
                ...
                class je extends(Vt(H.W2)) {
                    constructor() {
                        var t, e;
                        super(), (0, n.Z)(this, "content", void 0), this.content = this.addChild(new _e("".concat(null !== (t = window.RELEASE_VERSION) && void 0 !== t ? t : "", "\n").concat(null !== (e = window.RELEASE_DATE) && void 0 !== e ? e : "")))
                    }
                    resize() {
                        var t;
                ...
                class Ne extends(Vt(H.W2)) {
                    ...
                    addSections() {
                        this.content.addChild(new Me), this.content.addChild(new Ie), this.content.addChild(new Le), this.addAutoPlaySection(), this.content.addChild(new We), this.content.addChild(new Ze), this.content.addChild(new je)
                    }
                    addAutoPlaySection() {
                ...
                class Ge extends(Vt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "Menu"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "contentItems", void 0), (0, n.Z)(this, "bottom", void 0), (0, n.Z)(this, "items", void 0), (0, n.Z)(this, "homeButton", void 0), (0, n.Z)(this, "closeButton", void 0), (0, n.Z)(this, "bottomBackgroundTexture", void 0), (0, n.Z)(this, "bottomBackgroundMobileTexture", void 0), (0, n.Z)(this, "spaceKey", void 0), (0, n.Z)(this, "currentIndex", 0), (0, n.Z)(this, "onClickHome", void 0), (0, n.Z)(this, "onClickClose", void 0), this.visible = !1, this.interactive = !0, this.bottomBackgroundTexture = d.xE.from(Qt), this.bottomBackgroundMobileTexture = d.xE.from(Ht), this.overlay = this.addChild(new Jt), this.contentItems = this.addChild(new H.W2), this.bottom = this.addChild(new $.j(this.bottomBackgroundMobileTexture)), this.items = this.addChild(new H.W2), this.homeButton = this.addChild(new ze), this.closeButton = this.addChild(new Kt), this.closeButton.onClick.add((() => this.close())), this.spaceKey = this.game.keyboard.register(this.game.keyboard.KEY_CODE.Escape), this.spaceKey.onPress.add(this.close, this), this.spaceKey.disable()
                    }
                    get opened() {
                        return this.visible
                    }
                ...
                class Ye {
                    ...
                    type(t) {
                        return t >= this.giantMul * this.betLevel.toCoins() ? we : fe
                    }
                }
                ...
                const xi = class extends Dt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupFreeRound"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "icon", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContinue", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt, this.content = new H.W2, this.icon = new vi(ui), this.icon.anchor.x = .5, this.title = new Si(this.game.i18n.t("PopupFreeRoundStartTitle")), this.title.anchor.x = .5, this.message = new fi("", {
                            wordWrap: !0,
                            wordWrapWidth: 600
                ...
                const ki = class extends Dt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupMaxLimit"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContinue", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt(.7), this.content = new H.W2, this.background = new $.j(this.game.loader.getAsset(mi)), this.background.anchor.set(.5), this.background.interactive = !0, this.background.name = "PopupBackground", this.title = new Si(this.game.i18n.t("PopupMaxLimitTitle")), this.title.anchor.x = .5, this.message = new fi(this.game.i18n.t("PopupMaxLimitMessage"), {
                            wordWrap: !0
                ...
                const Ci = class extends Dt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupNetworkError"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "icon", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionReload", void 0), (0, n.Z)(this, "_resolver", null), this.overlay = this.addChild(new Jt), this.content = this.addChild(new H.W2), this.icon = new vi(pi), this.icon.anchor.x = .5, this.title = new Si(this.game.i18n.t("PopupNetworkErrorTitle"), {
                            align: "center"
                ...
                class Bi extends Dt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupQuickSpin"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionEnable", void 0), (0, n.Z)(this, "actionClose", void 0), (0, n.Z)(this, "escKey", void 0), (0, n.Z)(this, "enterKey", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt(.7), this.content = new H.W2, this.background = new $.j(this.game.loader.getAsset(mi)), this.background.anchor.set(.5), this.background.interactive = !0, this.background.name = "PopupBackground", this.title = new Si(this.game.i18n.t("PopupQuickSpinTitle")), this.title.anchor.x = .5, this.message = new fi(this.game.i18n.t("PopupQuickSpinMessage"), {
                            fontSize: 35,
                            wordWrap: !0,
                            wordWrapWidth: 600
                ...
                const Pi = class extends Dt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupRestore"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "icon", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContinue", void 0), (0, n.Z)(this, "resolver", null), this.overlay = this.addChild(new Jt), this.content = this.addChild(new H.W2), this.icon = new vi(ui), this.icon.anchor.x = .5, this.message = new fi(this.game.i18n.t("PopupRestoreMessage"), {
                            wordWrap: !0,
                            wordWrapWidth: 320
                        }), this.message.anchor.x = .5, this.actionContinue = new bi(this.game.i18n.t("PopupActionContinue"), {
                            fill: 16777215
                ...
                const Ti = class extends Dt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupRiskNBuy"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionYes", void 0), (0, n.Z)(this, "actionNo", void 0), (0, n.Z)(this, "escKey", void 0), (0, n.Z)(this, "enterKey", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt(.7), this.content = new H.W2, this.background = new $.j(this.game.loader.getAsset(mi)), this.background.anchor.set(.5), this.background.interactive = !0, this.background.name = "PopupBackground", this.title = new Si("RISK FEATURE"), this.title.anchor.x = .5, this.message = new fi("", {
                            wordWrap: !0,
                            whiteSpace: "normal",
                            breakWords: !0
                ...
                const Ei = class extends Dt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupSound"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "icon", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContainer", void 0), (0, n.Z)(this, "actionYes", void 0), (0, n.Z)(this, "actionNo", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt, this.content = new H.W2, this.icon = new vi(gi), this.icon.anchor.x = .5, this.message = new fi(this.game.i18n.t("PopupSoundMessage"), {
                            wordWrap: !0
                ...
                const _i = class extends Dt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupSpendingBudget"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContinue", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt(.7), this.content = new H.W2, this.background = new $.j(this.game.loader.getAsset(mi)), this.background.anchor.set(.5), this.background.interactive = !0, this.background.name = "PopupBackground", this.title = new Si(this.game.i18n.t("PopupSpendingBudgetTitle")), this.title.anchor.x = .5, this.message = new fi(this.game.i18n.t("PopupSpendingBudgetMessage"), {
                            wordWrap: !0
                        }), this.message.anchor.x = .5, this.actionContinue = new bi(this.game.i18n.t("PopupActionContinue"), {
                            fill: 10066329
                        }), this.actionContinue.anchor.x = .5, this.game.interaction.out(this.actionContinue, (() => this.actionContinue.style.fill = 10066329)), this.game.interaction.hover(this.actionContinue, (() => this.actionContinue.style.fill = 16777215)), this.game.interaction.click(this.actionContinue, (() => this.hide())), this.content.addChild(this.title), this.content.addChild(this.message), this.content.addChild(this.actionContinue), this.addChild(this.overlay), this.addChild(this.background), this.addChild(this.content)
                ...
                const Fi = class extends Dt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupUnexpectedError"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContinue", void 0), (0, n.Z)(this, "_resolver", null), this.overlay = new Jt(.7), this.content = new H.W2, this.background = new $.j(this.game.loader.getAsset(mi)), this.background.anchor.set(.5), this.background.interactive = !0, this.background.name = "PopupBackground", this.title = new Si(this.game.i18n.t("PopupUnexpectedErrorTitle")), this.title.anchor.x = .5, this.message = new fi(this.game.i18n.t("PopupUnexpectedErrorMessage")), this.message.anchor.x = .5, this.actionContinue = new bi(this.game.i18n.t("PopupActionReload"), {
                            fill: 10066329
                        }), this.actionContinue.anchor.x = .5, this.game.interaction.out(this.actionContinue, (() => this.actionContinue.style.fill = 10066329)), this.game.interaction.hover(this.actionContinue, (() => this.actionContinue.style.fill = 16777215)), this.game.interaction.click(this.actionContinue, (() => this.hide())), this.content.addChild(this.title), this.content.addChild(this.message), this.content.addChild(this.actionContinue), this.addChild(this.overlay), this.addChild(this.background), this.addChild(this.content)
                    }
                    resize() {
                ...
                class Oi extends Dt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupWilds"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionEnable", void 0), (0, n.Z)(this, "actionClose", void 0), (0, n.Z)(this, "escKey", void 0), (0, n.Z)(this, "spaceKey", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt(.7), this.content = new H.W2, this.background = new $.j(this.game.loader.getAsset(mi)), this.background.anchor.set(.5), this.background.interactive = !0, this.background.name = "PopupBackground", this.title = new Si(this.game.i18n.t("PopupWildsTitle"), {
                            fontSize: 40,
                            wordWrap: !0,
                            wordWrapWidth: 600,
                ...
                const Ri = class extends Dt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupZeroBalance"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContinue", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt(.7), this.content = new H.W2, this.background = new $.j(this.game.loader.getAsset(mi)), this.background.anchor.set(.5), this.background.interactive = !0, this.background.name = "PopupBackground", this.title = new Si(this.game.i18n.t("PopupZeroBalanceTitle")), this.title.anchor.x = .5, this.message = new fi(this.game.i18n.t("PopupZeroBalanceMessage"), {
                            wordWrap: !0
                        }), this.message.anchor.x = .5, this.actionContinue = new bi(this.game.i18n.t("PopupActionContinue"), {
                            fill: 10066329
                        }), this.actionContinue.anchor.x = .5, this.game.interaction.out(this.actionContinue, (() => this.actionContinue.style.fill = 10066329)), this.game.interaction.hover(this.actionContinue, (() => this.actionContinue.style.fill = 16777215)), this.game.interaction.click(this.actionContinue, (() => this.hide())), this.content.addChild(this.title), this.content.addChild(this.message), this.content.addChild(this.actionContinue), this.addChild(this.overlay), this.addChild(this.background), this.addChild(this.content)
                ...
                const Ii = [...[{
                        ...
                        url: "assets/audio/backgroundFree1.mp3",
                        name: "backgroundFree1",
                        metadata: {
                            platform: ["phone", "tablet", "desktop"],
                            audioMetadata: {
                                type: "background",
                        ...
                        url: "assets/audio/backgroundFree2.mp3",
                        name: "backgroundFree2",
                        metadata: {
                            platform: ["phone", "tablet", "desktop"],
                            audioMetadata: {
                                type: "background",
                        ...
                        url: "assets/audio/backgroundFree3.mp3",
                        name: "backgroundFree3",
                        metadata: {
                            platform: ["phone", "tablet", "desktop"],
                            audioMetadata: {
                                type: "background",
                        ...
                        url: "assets/audio/win_swat1.mp3",
                        name: "win_free_1_1",
                        metadata: {
                            platform: ["phone", "tablet", "desktop"],
                            audioMetadata: {
                        ...
                        url: "assets/audio/win_swat2.mp3",
                        name: "win_free_1_2",
                        metadata: {
                            platform: ["phone", "tablet", "desktop"],
                            audioMetadata: {
                        ...
                        url: "assets/audio/win_swat3.mp3",
                        name: "win_free_1_3",
                        metadata: {
                            platform: ["phone", "tablet", "desktop"],
                            audioMetadata: {
                        ...
                        url: "assets/audio/win_punx1.mp3",
                        name: "win_free_2_1",
                        metadata: {
                            platform: ["phone", "tablet", "desktop"],
                            audioMetadata: {
                        ...
                        url: "assets/audio/win_punx2.mp3",
                        name: "win_free_2_2",
                        metadata: {
                            platform: ["phone", "tablet", "desktop"],
                            audioMetadata: {
                        ...
                        url: "assets/audio/win_punx3.mp3",
                        name: "win_free_2_3",
                        metadata: {
                            platform: ["phone", "tablet", "desktop"],
                            audioMetadata: {
                        ...
                        url: "assets/audio/win_surv1.mp3",
                        name: "win_free_3_1",
                        metadata: {
                            platform: ["phone", "tablet", "desktop"],
                            audioMetadata: {
                        ...
                        url: "assets/audio/win_surv2.mp3",
                        name: "win_free_3_2",
                        metadata: {
                            platform: ["phone", "tablet", "desktop"],
                            audioMetadata: {
                        ...
                        url: "assets/audio/win_surv3.mp3",
                        name: "win_free_3_3",
                        metadata: {
                            platform: ["phone", "tablet", "desktop"],
                            audioMetadata: {
                        ...
                        url: "assets/audio/sticky_wild_chain.mp3",
                        name: "stickyChain",
                        metadata: {
                            platform: ["phone", "tablet", "desktop"],
                            audioMetadata: {
                        ...
                        url: "assets/audio/respin_start.mp3",
                        name: "respinStart",
                        metadata: {
                            platform: ["phone", "tablet", "desktop"],
                            audioMetadata: {
                        ...
                        url: "assets/audio/expand_wild_swat.mp3",
                        name: "stickySwat",
                        metadata: {
                            platform: ["phone", "tablet", "desktop"],
                            audioMetadata: {
                        ...
                        url: "assets/images/background/bglf1.jpg",
                        name: "bglf1",
                        metadata: {
                            platform: ["phone", "tablet", "desktop"]
                        }
                    }, {
                        url: "assets/images/background/bglf2.jpg",
                        name: "bglf2",
                        metadata: {
                            platform: ["phone", "tablet", "desktop"]
                        }
                    }, {
                        url: "assets/images/background/bglf3.jpg",
                        name: "bglf3",
                        metadata: {
                            platform: ["phone", "tablet", "desktop"]
                        }
                        ...
                        url: "assets/images/background/bgpf1.jpg",
                        name: "bgpf1",
                        metadata: {
                            platform: ["desktop", "phone", "tablet"]
                        }
                    }, {
                        url: "assets/images/background/bgpf2.jpg",
                        name: "bgpf2",
                        metadata: {
                            platform: ["desktop", "phone", "tablet"]
                        }
                    }, {
                        url: "assets/images/background/bgpf3.jpg",
                        name: "bgpf3",
                        metadata: {
                            platform: ["desktop", "phone", "tablet"]
                        }
                        ...
                        url: "assets/images/freespin/textRespin.png",
                        name: "textRespin",
                        metadata: {
                            platform: ["phone", "tablet", "desktop"]
                        }
                    }, {
                        url: "assets/images/freespin/labelbox.png",
                        name: "labelBox",
                        metadata: {
                            platform: ["phone", "tablet", "desktop"]
                        }
                        ...
                        url: "assets/bitmapFont/riskFont.xml",
                        name: "RiskFont",
                        metadata: {
                            platform: ["phone", "tablet", "desktop"]
                        }
                        ...
                        url: "assets/images/winbox.png",
                        name: "winBg",
                        metadata: {
                            platform: ["phone", "tablet", "desktop"]
                        }
                    }, {
                        url: "assets/images/label-youwon.png",
                        name: "winText",
                        metadata: {
                            platform: ["phone", "tablet", "desktop"]
                        }
                        ...
                        url: "assets/images/effects/buttons/spin/skeleton.json",
                        name: "effectSpin",
                        metadata: {
                            platform: ["phone", "tablet", "desktop"]
                        }
                    }, {
                        url: "assets/images/effects/buttons/btn/skeleton.json",
                        name: "effectButton",
                        metadata: {
                            platform: ["phone", "tablet", "desktop"]
                        }
                    }, {
                        url: "assets/images/effects/symbols/f_pink/skeleton.json",
                        name: "f_pinkEffect",
                        metadata: {
                            platform: ["phone", "tablet", "desktop"]
                        }
                    }, {
                        url: "assets/images/effects/symbols/s_boy/skeleton.json",
                        name: "s_boyEffect",
                        metadata: {
                            platform: ["phone", "tablet", "desktop"]
                        }
                    }, {
                        url: "assets/images/effects/symbols/s_glass/skeleton.json",
                        name: "s_glassEffect",
                        metadata: {
                            platform: ["phone", "tablet", "desktop"]
                        }
                    }, {
                        url: "assets/images/effects/symbols/f_yellow/skeleton.json",
                        name: "f_yellowEffect",
                        metadata: {
                            platform: ["phone", "tablet", "desktop"]
                        }
                    }, {
                        url: "assets/images/effects/symbols/f_black/skeleton.json",
                        name: "f_blackEffect",
                        metadata: {
                            platform: ["phone", "tablet", "desktop"]
                        }
                    }, {
                        url: "assets/images/effects/symbols/s_girl/skeleton.json",
                        name: "s_girlEffect",
                        metadata: {
                            platform: ["phone", "tablet", "desktop"]
                        }
                    }, {
                        url: "assets/images/effects/symbols/soldier/skeleton.json",
                        name: "soldierEffect",
                        metadata: {
                            platform: ["phone", "tablet", "desktop"]
                        }
                    }, {
                        url: "assets/images/effects/symbols/letters/skeleton.json",
                        name: "lettersEffect",
                        metadata: {
                            platform: ["phone", "tablet", "desktop"]
                        }
                    }, {
                        url: "assets/images/effects/symbols/special/skeleton.json",
                        name: "specialEffect",
                        metadata: {
                            platform: ["phone", "tablet", "desktop"]
                        }
                    }, {
                        url: "assets/images/effects/symbols/sticky/skeleton.json",
                        ...
                        url: "assets/images/effects/risk/risk_buy/skeleton.json",
                        name: "riskButton",
                        metadata: {
                            platform: ["phone", "tablet", "desktop"]
                        }
                    }, {
                        url: "assets/images/effects/symbols/revolt-fs/skeleton.json",
                        name: "freeSymbolText",
                        metadata: {
                            platform: ["phone", "tablet", "desktop"]
                        }
                        ...
                        url: "assets/images/risk/risk.json",
                        name: "risk",
                        metadata: {
                            platform: ["phone", "tablet", "desktop"]
                        }
                        ...
                        slot: {
                            ...
                            layout: {
                                default: [{
                                    ...
                                    assetName: "scat_1(bird)",
                                    hasFrame: !1,
                                    animation: {
                                        skin: "scat_1(bird)",
                                        assetName: "specialEffect",
                                        effectName: {
                                            normal: "win",
                                            free: "win_special"
                                        },
                ...
                var zi = new class {
                    ...
                    isBasic() {
                        return this.currentFeature.includes(ji.Basic)
                    }
                    isAuto() {
                        return this.currentFeature === ji.Auto
                    }
                    isRespin() {
                        return this.currentFeature === ji.Respin
                    }
                    isFreespin() {
                        return this.currentFeature === ji.Freespin
                    }
                };
                const Vi = {
                    init() {
                        function t(t) {
                            var e = ot()(t, "freespins.win", 0),
                                i = ot()(t, "feature", ji.Basic).includes("freespins") ? ji.Freespin : ji.Basic,
                                s = 0 === ot()(t, "freespins", []).length ? 0 : ot()(t, "freespins.extra", 0),
                                o = ot()(t, "freespins.left", -1),
                                n = ot()(t, "freespins.played", -1);
                            Lt.store.set("free:win", e), Lt.store.set("free:coins", ot()(t, "freespins.coins", 0)), Lt.store.set("free:left", o), Lt.store.set("free:played", n), Lt.store.set("free:count", o + n), Lt.store.set("free:isStart", 0 === n), Lt.store.set("free:isEnd", 0 === o), Lt.store.set("free:isFree", "freespin" === i), Lt.store.set("free:freespins", ot()(t, "freespins", [])), 0 !== n && (Lt.store.set("free:winAdditional", s > 0), Lt.store.set("free:winAdditionalCount", s))
                        }
                        Lt.store.set("free:win", 0), Lt.store.set("free:coins", 0), Lt.store.set("free:count", 0), Lt.store.set("free:left", -1), Lt.store.set("free:played", -1), Lt.store.set("free:isStart", !1), Lt.store.set("free:isEnd", !1), Lt.store.set("free:isFree", !1), Lt.store.set("free:freespins", !1), Lt.store.set("free:winAdditional", !1), Lt.server.on("response:init", t), Lt.server.on("response:spin", t), Lt.server.on("response:buyin", t), Lt.server.on("response:risk", t)
                    }
                };
                var Gi = [
                        [8, 9, 11],
                ...
                const Hi = {
                        init() {
                            function t(t) {
                                var e = ot()(t, "win", 0),
                                    ...
                                    s = ot()(t, "buyin", !1),
                                    o = ot()(t, "risk", !1);
                                Lt.store.set("reward:win", e), Lt.store.set("reward:lines", ot()(t, "lines", [])), Lt.store.set("reward:reels", ot()(t, "reels", t.error ? Gi : [])), Lt.store.set("reward:nReels", ot()(t, "nReels", t.error ? Qi : [])), Lt.store.set("reward:fsReels", ot()(t, "fsReels", [])), Lt.store.set("reward:preReels", ot()(t, "preSpin.reels", [])), Lt.store.set("reward:scatters", i), Lt.store.set("reward:isWin", e > 0 || i), Lt.store.set("isRiskNBuy", !(!s && !o)), Lt.store.get("isRiskNBuy") && (Lt.store.set("risk", o), Lt.store.set("buy", s));
                                var n = ot()(t, "feature", ji.Basic),
                                    a = n.includes("freespins") ? ji.Freespin : ji.Basic;
                                "freespin" === a && Lt.store.set("freeNumber", ot()(t, "feature").slice(n.length - 1)), Lt.store.set("isRespin", 1 === ot()(t, "respin")), Lt.store.set("wildReels", ot()(t, "wildReels"), []), Lt.store.set("reward:feature", a), Lt.store.set("reward:currentFeature", n), Lt.store.set("overlayWilds", ot()(t, "overlayWilds"))
                            }
                            ...
                            function e(t) {
                                var e = ot()(t, "win", 0),
                                    i = ot()(t, "buyin", !1),
                                    s = ot()(t, "risk", !1);
                                Lt.store.set("reward:win", e), Lt.store.set("reward:lines", ot()(t, "lines", [])), Lt.store.set("reward:fsReels", ot()(t, "fsReels", [])), Lt.store.set("isRiskNBuy", !(!i && !s)), Lt.store.set("reward:reels", ot()(t, "reels", t.error ? Gi : [])), Lt.store.set("reward:nReels", ot()(t, "nReels", t.error ? Qi : [])), Lt.store.get("isRiskNBuy") && (Lt.store.set("risk", s), Lt.store.set("buy", i));
                                var o = ot()(t, "feature", ji.Basic),
                                    n = o.includes("freespins") ? ji.Freespin : ji.Basic;
                                Lt.store.set("reward:currentFeature", o), Lt.store.set("reward:feature", n)
                            }
                            Lt.store.set("reward:win", 0), Lt.store.set("reward:isWin", !1), Lt.store.set("reward:lines", []), Lt.store.set("reward:reels", []), Lt.store.set("reward:nReels", []), Lt.store.set("reward:fsReels", []), Lt.store.set("reward:preReels", []), Lt.store.set("reward:scatters", !1), Lt.store.set("isRespin", !1), Lt.store.set("overlayWilds", []), Lt.store.set("wildReels", []), Lt.store.set("isRiskNBuy", !1), Lt.store.set("risk", !1), Lt.store.set("buy", !1), Lt.store.set("reward:feature", ""), Lt.store.set("freeNumber", 0), Lt.server.on("response:init", t), Lt.server.on("response:spin", t), Lt.server.on("response:buyin", e), Lt.server.on("response:risk", e)
                        }
                    },
                    Yi = {
                        init() {
                    ...
                    Xi = {
                        init() {
                            Vi.init(), Yi.init(), Hi.init()
                        }
                    };
                class Ki extends O {
                    constructor(t, e, i) {
                        super(t, e, i), (0, n.Z)(this, "backgroundFree1", void 0), (0, n.Z)(this, "backgroundFree2", void 0), (0, n.Z)(this, "backgroundFree3", void 0), (0, n.Z)(this, "backgroundNormal", void 0), (0, n.Z)(this, "bigWin", void 0), (0, n.Z)(this, "bonusEnd", void 0), (0, n.Z)(this, "bonusStart", void 0), (0, n.Z)(this, "clickNormal", void 0), (0, n.Z)(this, "currentWinSound", void 0), (0, n.Z)(this, "giantWin", void 0), (0, n.Z)(this, "respin", void 0), (0, n.Z)(this, "scatterReel", void 0), (0, n.Z)(this, "scatterWin", void 0), (0, n.Z)(this, "spinFast", void 0), (0, n.Z)(this, "spinStart", void 0), (0, n.Z)(this, "stickyChain", void 0), (0, n.Z)(this, "stickySwat", void 0), (0, n.Z)(this, "wheelStop", void 0), (0, n.Z)(this, "winFree11", void 0), (0, n.Z)(this, "winFree12", void 0), (0, n.Z)(this, "winFree13", void 0), (0, n.Z)(this, "winFree21", void 0), (0, n.Z)(this, "winFree22", void 0), (0, n.Z)(this, "winFree23", void 0), (0, n.Z)(this, "winFree31", void 0), (0, n.Z)(this, "winFree32", void 0), (0, n.Z)(this, "winFree33", void 0), (0, n.Z)(this, "winNormal1", void 0), (0, n.Z)(this, "winNormal2", void 0), (0, n.Z)(this, "winNormal3", void 0), this.backgroundNormal = this.get("backgroundNormal"), this.backgroundFree1 = this.get("backgroundFree1"), this.backgroundFree2 = this.get("backgroundFree2"), this.backgroundFree3 = this.get("backgroundFree3"), this.bonusStart = this.get("bonusStart"), this.bonusEnd = this.get("bonusEnd"), this.winNormal1 = this.get("win_normal_1"), this.winNormal2 = this.get("win_normal_2"), this.winNormal3 = this.get("win_normal_3"), this.winFree11 = this.get("win_free_1_1"), this.winFree12 = this.get("win_free_1_2"), this.winFree13 = this.get("win_free_1_3"), this.winFree21 = this.get("win_free_2_1"), this.winFree22 = this.get("win_free_2_2"), this.winFree23 = this.get("win_free_2_3"), this.winFree31 = this.get("win_free_3_1"), this.winFree32 = this.get("win_free_3_2"), this.winFree33 = this.get("win_free_3_3"), this.bigWin = this.get("bigWin"), this.giantWin = this.get("giantWin"), this.spinStart = this.get("spinStart"), this.spinFast = this.get("spinFast"), this.clickNormal = this.get("clickNormal"), this.wheelStop = this.get("wheelStop"), this.scatterWin = this.get("scatterWin"), this.scatterReel = this.get("scatterReel"), this.stickyChain = this.get("stickyChain"), this.respin = this.get("respinStart"), this.stickySwat = this.get("stickySwat"), this.currentWinSound = null, this._setupEvents()
                    }
                    _setupEvents() {
                        Lt.action.on("sound:win", (t => {
                            var e = zi.isFreespin() ? "winFree" + Lt.store.get("freeNumber") : "winFree" + Lt.store.get("reward:currentFeature").slice(Lt.store.get("reward:currentFeature").length - 1);
                            this.currentWinSound = this["".concat(zi.isFreespin() ? e : "winNormal").concat(t)], this.currentWinSound.play()
                        ...
                        })), Lt.action.on("stickyChain", (() => {
                            this.stickyChain.play()
                        })), Lt.action.on("respin:start", (() => {
                            this.respin.play()
                        })), Lt.action.on("stickySwat", (() => {
                            this.stickySwat.play()
                        })), Lt.action.on("state:spin_enter", this._onSpinEnter, this), Lt.action.on("state:finish_enter", this._onFinishEnter, this), Lt.action.on("sound:spinFast", this._onFastSpin, this), Lt.action.on("wheel:stop_down", this._onWheelStop, this), Lt.action.on("sound:click", this.click, this), Lt.action.on("sound:free_start", this._onFreeStart, this), Lt.action.on("sound:free_stop", this._onFreeStop, this), Lt.action.on("free:select_start", this._onSelectFreeStart, this), Lt.action.on("free:select_stop", this._onSelectFreeStop, this)
                    }
                    stopBigWin() {
                    ...
                    _onFreeStart() {
                        var t = Lt.store.get("reward:currentFeature").slice(Lt.store.get("reward:currentFeature").length - 1, Lt.store.get("reward:currentFeature").length);
                        this.currentWinSound && (this.currentWinSound.stop(), this.currentWinSound = null), this.backgroundNormal.stop(), this.bonusStart.once("end", (() => {
                            this["backgroundFree".concat(t)].fade(1)
                        })), this.bonusStart.play()
                    }
                    _onFreeStop() {
                        this.currentWinSound && (this.currentWinSound.stop(), this.currentWinSound = null), this.backgroundFree1.stop(), this.backgroundFree2.stop(), this.backgroundFree3.stop(), this.bonusEnd.once("end", (() => {
                            this.backgroundNormal.fade(1)
                        })), this.bonusEnd.play()
                    }
                    _onSelectFreeStart() {
                        var t = Lt.store.get("reward:currentFeature").slice(Lt.store.get("reward:currentFeature").length - 1, Lt.store.get("reward:currentFeature").length);
                        this.bonusStart.stop(), this["backgroundFree".concat(t)].playing() || this["backgroundFree".concat(t)].fade(2)
                    }
                    _onSelectFreeStop() {
                ...
                const ls = JSON.parse('{"AutoPlaySettingsStopCondButtonReset":"Reset","AutoPlaySettingsStopCondCheckboxBalance":"If Balance Increases By","AutoPlaySettingsStopCondCheckboxBalanceDrop":"If Balance Decreases By","AutoPlaySettingsStopCondCheckboxFeatureBonus":"If Bonus Game Won","AutoPlaySettingsStopCondCheckboxFeatureFreeSpin":"If Free Spins Won","AutoPlaySettingsStopCondCheckboxWin":"If Win","AutoPlaySettingsStopCondCheckboxWinAny":"Any","AutoPlaySettingsStopCondCheckboxWinBig":"Big","AutoPlaySettingsStopCondCheckboxWinGiant":"Giant","AutoPlaySettingsStopCondTitle":"STOP AUTOPLAY","AutoPlaySettingsSubTitle":"Setup your best autoplay conditions","AutoPlaySettingsTitle":"AUTOPLAY","BetSettingsLines":"LINES\\n<value>%s</value>","BetSettingsTitle":"BET SETTINGS","BetSettingsWays":"WAYS\\n<value>%s</value>","ControlsDesktopAutoPlayStart":"AUTOPLAY","ControlsDesktopAutoPlayStop":"STOP AUTO","ControlsDesktopBalance":"BALANCE%s\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopBet":"BET %s\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopFreeRoundLeft":"FREE ROUND\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopFreeRoundWin":"TOTAL WIN %s\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopFreeRoundWinEmpty":"TOTAL WIN","ControlsDesktopFreeSpinsLast":"FREE SPINS LEFT\\n<delimiter> \\n</delimiter><value>LAST</value>","ControlsDesktopFreeSpinsLeft":"FREE SPINS LEFT\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopLines":"LINES\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopMaxBet":"MAX BET","ControlsDesktopTotalWin":"TOTAL WIN %s\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopWays":"WAYS\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopWin":"WIN %s\\n<delimiter> \\n</delimiter><value>%s</value>","Currency":"CURRENCY\\n<value>%s</value>","GameRulesAdvancedAutoPlayContent":"Advanced autoplay settings are available in the section with standard autoplay settings. You can set the conditions for stopping the game in automatic mode:\\n\\n<bold>if win any/big/giant</bold> - autoplay will be stopped after any/big/giant win\\n\\n<bold>if balance increased by 10%-100%</bold> - autoplay will stop when your balance increases by the selected %\\n\\n<bold>if balance decreased by 10%-100%</bold> - autoplay will be interrupted when your balance decreases by the selected %\\n\\nClick <bold>Reset</bold> to reset all autoplay settings","GameRulesAdvancedAutoPlayTitle":"Advanced Autoplay Settings","GameRulesAutoPlayContent":"Select the number of game rounds to play in automatic mode by pressing the button with the corresponding number, or press the button with the infinity sign to play in automatic mode until the autoplay is manually canceled or until the balance runs out. Your choice must be confirmed with the Start button.","GameRulesAutoPlayTitle":"Autoplay Options","GameRulesBestExperience":"Please note that you can only play one game at a time on each account. Therefore, you cannot play a game on more than one device, or multiple games on the same device simultaneously. Doing so may lead to various errors.\\n\\nFor the best gaming experience, we recommend using the latest version of the relevant software.","GameRulesGeneralRTP":"Theoretical RTP: %s %","GameRulesGeneralTitle":"General Info","GameRulesInterfaceAutoPlay":"Click to go to autoplay menu","GameRulesInterfaceBalance":"Here is your current balance","GameRulesInterfaceBetLevel":"Your current bet and a button to go to the bet size selection menu","GameRulesInterfaceContent":"All buttons of the game interface are listed below. Please note that the appearance and location of the buttons may differ slightly depending on the format in which the game is launched and what feature it is currently in.","GameRulesInterfaceMenu":"Click to access the game menu","GameRulesInterfaceQuickSpin":"Click to enable/disable quick spin","GameRulesInterfaceSound":"Turn game sound on/off and adjust sound volume","GameRulesInterfaceSpin":"Click to start the game round at the current bet. In the desktop version of the game, the button may have an alternative design","GameRulesInterfaceTitle":"Game Interface","GameRulesInterfaceWin":"Here is the win in the current game round","GameRulesSettingsContent":"To go to the settings menu, click the cogwheel icon in the game menu","GameRulesSettingsContentItemBackgroundSound":"<bold>Background music</bold> - turns on/off background music in the game","GameRulesSettingsContentItemFullscreen":"<bold>Full Screen</bold> - enables/disables full screen mode","GameRulesSettingsContentItemGameSound":"<bold>Game sound</bold> - turns on/off the sound effects of the game","GameRulesSettingsContentItemQuickSpin":"<bold>Quick Spin</bold> - turns on/off the function of the accelerated mode of rotation and stop of the reels","GameRulesSettingsTitle":"Game Settings","GameSettingsBackgroundSounds":"Background Music","GameSettingsFullscreen":"Full Screen","GameSettingsGameSounds":"Game Sounds","GameSettingsIntroScreen":"Intro Screen","GameSettingsLeftHand":"Left Hand Mode","GameSettingsQuickSpin":"Quick Spin","GameSettingsRiskFeatureCheckbox":"Risk&Buy","GameSettingsTitle":"GAME SETTINGS","IntroScreenHideButtonText":"Don\'t show next time","IntroScreenLoaderText":"LOADING","MenuDesktopButtonFullscreen":"FULLSCREEN","MenuDesktopButtonHome":"HOME","MenuDesktopButtonPaytable":"PAYTABLE","MenuDesktopButtonQuickspin":"QUICKSPIN","MenuDesktopButtonSound":"SOUND","MenuGameRules":"GAME INFORMATION","MenuMobileBetSettingsTitle":"BET SETTINGS","MenuMobileGameSettingsLeftHand":"Left Hand Mode","MenuMobileGameSettingsQuickspin":"Quick Spin","MenuMobileGameSettingsSounds":"Game Sounds","MenuMobileGameSettingsTitle":"GAME SETTINGS","MenuMobilePaytableTitle":"PAYTABLE","MenuPaytable":"PAYTABLE","MenuSettings":"SETTINGS","NetPositionTitle":"Net Position: %s","PopupActionClose":"Close","PopupActionContinue":"Continue","PopupActionEnable":"Enable","PopupActionNo":"No","PopupActionReload":"Reload","PopupActionYes":"Yes","PopupFreeRoundEndMessage":"The next spins will use your bonus amount","PopupFreeRoundEndTitle":"Free Rounds Finished","PopupFreeRoundLastMessage":"Congratulations, you have\\n last free round","PopupFreeRoundStartMessage":"Congratulations, you have\\n%s free rounds","PopupFreeRoundStartTitle":"Free Rounds Bonus","PopupFreeSpinsButton":"CLICK ANYWHERE TO CONTINUE","PopupFreeSpinsStopDescription":"<value>%s FREE SPINS</value> PLAYED","PopupFreeSpinsStopDescriptionNew":"%s Free Spins played","PopupFreeSpinsTitle":"CONGRATULATIONS","PopupFreeSpinsTitleNew":"CONGRATULATIONS! YOU WON","PopupFreeSpinsTitleRestore":"IN-GAME FEATURE RESTORED!","PopupFreeSpinsWinRestore":"<value>%s FREE SPINS</value> LEFT","PopupFreeSpinsWinRestoreLast":"<value>LAST FREE SPIN</value> LEFT","PopupFreeSpinsWinStart":"YOU WON <value>%s FREE SPINS</value>","PopupFreeSpinsWinStartNew":"%s FREE SPINS","PopupFreeSpinsWinStop":"YOU WON <value>%s</value>","PopupFreeSpinsWinStopNew":"<value>%s</value>","PopupMaxLimitMessage":"Bet exceeded max bet limit.","PopupMaxLimitTitle":"Max limit","PopupNetworkErrorMessage":"Please reload the game.","PopupNetworkErrorTitle":"Connection Lost","PopupQuickSpinMessage":"It seems you prefer to play a bit faster.\\nWould you like to enable Quick Spin?","PopupQuickSpinTitle":"Quick Spin","PopupRestoreMessage":"In-game feature restored!","PopupRiskNBuyContentBuy":"Buy in a feature for %s\\nthat will play at the bet %s","PopupRiskNBuyContentRisk":"Take the risk of winning %s\\nto get a feature at the bet %s","PopupRiskNBuyTitleBuy":"BUY IN FEATURE","PopupRiskNBuyTitleRisk":"RISK FEATURE","PopupSoundMessage":"Play with sound?","PopupSpendingBudgetMessage":"You have reached your play limit.\\nWelcome back later.","PopupSpendingBudgetTitle":"Play limit","PopupUnexpectedErrorMessage":"An unexpected situation.\\nReload the page.","PopupUnexpectedErrorTitle":"Unexpected situation","PopupZeroBalanceMessage":"Please change your BET LEVEL or top up your balance","PopupZeroBalanceTitle":"Insufficient funds","RiskNBuyBuyFor":"BUY FOR %s","RiskNBuyFreeSpinsText":"FREE SPINS","RiskNBuyOnBet":"ON BET %s","RiskNBuySubHeader":"RISK YOUR WIN\\nTO PLAY","StatusBarMobileBalance":"BALANCE %s\\n","StatusBarMobileBet":"BET %s\\n","StatusBarMobileFreeLast":"FREE SPINS LEFT\\n<value>LAST</value>","StatusBarMobileFreeLeft":"FREE SPINS LEFT\\n<value>%s</value>","StatusBarMobileFreePlayed":"FREE SPINS PLAYED\\n","StatusBarMobileFreeRoundLeft":"FREE ROUND\\n","StatusBarMobileTotalWin":"TOTAL WIN %s\\n","StatusBarMobileWin":"WIN %s\\n","TimeElapsedTitle":"Time Elapsed: %s"}'),
                    ds = JSON.parse('{"PaytableSectionBaseCampContent1":"\\"Base camp\\" feature is a series of 10 free spins, that play automatically at the bet at which they were won. All payments are made in accordance with the paytable. Additional \\"Base Camp\\" free spins cannot be won in the current feature.","PaytableSectionBaseCampContent2":"The Soldier of \\"The Law\\" gang in the \\"Base camp\\" feature turns into a Wild Reel when it appears anywhere on the screen.\\n\\nWild Reel substitutes for all symbols. Wild Reel symbols, in any quantity on a screen award with 1 free Respin when appear and become sticky. Every new Wild Reel symbol, appeared after Respin becomes sticky and awards with one more free respin. \\n\\nWild Reels can only appear in the \\"Base camp\\" feature and only on reels 2, 3 and 4.","PaytableSectionBaseCampTitle":"Base camp feature","PaytableSectionBetLinesContent1":"Only the highest win per bet line is paid. All prizes are for combinations left to right, beginning from the leftmost reel. The payout values are based on the currently selected bet and change proportionally with its changes. The game is played with fixed bet lines. Malfunction voids all pays and plays.","PaytableSectionBetLinesTitle":"Bet Lines","PaytableSectionFreeContent1":"The winning combination of 4 and more \\"the Survivors\\" gang character symbols award \\"The Survivors free spins\\" feature with amount of free spins according to paytable.\\n\\n\\"The Survivors free spins\\" feature plays automatically at the bet at which it was won. All payments are tripled to paytable values. Additional free spins of \\"The Survivors free spins\\" feature can be won in the current free spins series, according to general rules.","PaytableSectionFreeTitle":"The Survivors free spins","PaytableSectionPayoutTitle":"Symbol payout values","PaytableSectionRazeContent1":"\\"Raze! Rave!\\" feature - is a series of 10 free spins, that play automatically at the bet at which they were won. All payments are made in accordance with the paytable. Additional \\"Raze! Rave!\\" free spins can not be won in the current feature.","PaytableSectionRazeContent2":"Each \\"Raze\\" gang character during \\"Raze! Rave!\\" feature becomes Sticky Wild symbol when appear. Sticky Wild symbols remain on the screen till the end of the entire \\"Raze! Rave!\\" feature and substitute all symbols.\\n\\nSticky Wild symbol can appear in \\"Raze! Rave!\\" feature only. Combination of 3 and more Sticky Wild symbols on a payline pays as the highest symbol payline win combination.","PaytableSectionRazeTitle":"Raze! Rave! feature","PaytableSectionRiskContent1":"The Risk\'n\'Buy feature will be offered in the main game to the player after each spin, regardless of whether or not there is a win. The Risk\'n\'Buy feature will offer to either risk the current win and immediately go to the Base camp game or Raze! Rave! game, or buy a random number of The Survivors free spins at the specified cost and immediately go to them.\\n\\nThe player makes his own decision to agree to the proposed version of the Risk\'n\'Buy feature or continue to the main game. The current winnings, in case of risk, or the indicated value, in case of a purchase, will be deducted from the player’s balance in the form of a bet. Free spins received in the Risk\'n\'Buy feature will occur at the bet at which it was accepted by the player. Risk\'n\'Buy feature is not available in autoplay.","PaytableSectionRiskTitle":"Risk\'n\'Buy feature","PaytableSectionScatterContent1":"\\"The Law\\" and \\"Raze\\" gangs badges symbols are Scatter symbols. \\"The Law\\" and \\"Raze\\" gangs badges symbols can appear on 2, 3 and 4th reel in the main game only.\\n\\n3 scattered \\"The Law\\" gang badge symbols award 10 free games of \\"Base camp\\" feature.\\n\\n3 scattered \\"Raze\\" gang badge symbols award 10 free games of \\"Raze! Rave!\\" feature.","PaytableSectionScatterDesc1":"\\"The Law\\"\\ngang badge","PaytableSectionScatterDesc2":"\\"Raze\\"\\ngang badge","PaytableSectionScatterTitle":"Scatter symbol","PaytableSectionWildContent1":"Wild symbols substitute for all symbols except Scatter symbols. Combination of 5 Wild symbols pays as the highest symbol payline win combination.","PaytableSectionWildTitle":"Wild symbol","PopupFreeSpinsDescription1":"WITH WILD REELS & RESPIN","PopupFreeSpinsDescription2":"WITH STICKY WILDS","PopupFreeSpinsDescription3":"WITH <value>X3</value> MULTIPLIER"}');
                ...
                class gs extends(Vt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "backgroundLTextureFree", void 0), (0, n.Z)(this, "backgroundLTextureNormal", void 0), (0, n.Z)(this, "backgroundPTextureFree", void 0), (0, n.Z)(this, "backgroundPTextureNormal", void 0), (0, n.Z)(this, "backgroundTextureLandscape", void 0), (0, n.Z)(this, "backgroundTexturePortrait", void 0), (0, n.Z)(this, "featureBackground", void 0), (0, n.Z)(this, "logo", void 0), this.backgroundLTextureNormal = this.game.loader.getAsset("bgln"), this.backgroundLTextureFree = this.game.loader.getAsset("bglf1"), this.backgroundPTextureNormal = this.game.loader.getAsset("bgpn"), this.backgroundPTextureFree = this.game.loader.getAsset("bgpf1"), this.backgroundTextureLandscape = this.backgroundLTextureNormal, this.backgroundTexturePortrait = this.backgroundPTextureNormal, this.background = new $.j(this.backgroundTextureLandscape), this.background.name = "background", this.featureBackground = new $.j(this.backgroundLTextureFree), this.featureBackground.name = "featureBackground", this.featureBackground.alpha = 0, this.logo = new $.j(this.game.loader.getAsset("logo")), this.logo.anchor.set(.5), this.logo.x = 190, this.logo.y = 120, this.addChild(this.background), this.addChild(this.featureBackground), this.addChild(this.logo), this.setupEvents()
                    }
                    setupEvents() {
                        this.game.action.on("state:setup_enter", (() => {
                            this.backgroundLTextureFree = "freespins1" === this.game.store.get("reward:currentFeature") ? this.game.loader.getAsset("bglf1") : "freespins2" === this.game.store.get("reward:currentFeature") ? this.game.loader.getAsset("bglf2") : this.game.loader.getAsset("bglf3"), this.backgroundPTextureFree = "freespins1" === this.game.store.get("reward:currentFeature") ? this.game.loader.getAsset("bgpf1") : "freespins2" === this.game.store.get("reward:currentFeature") ? this.game.loader.getAsset("bgpf2") : this.game.loader.getAsset("bgpf3"), this.featureBackground.texture = this.game.device.portrait && !this.game.device.desktop ? this.backgroundPTextureFree : this.backgroundLTextureFree, this.game.store.get("free:isFree", !1) && (this.featureBackground.alpha = 1)
                            ...
                            this.backgroundLTextureFree = "freespins1" === this.game.store.get("reward:currentFeature") ? this.game.loader.getAsset("bglf1") : "freespins2" === this.game.store.get("reward:currentFeature") ? this.game.loader.getAsset("bglf2") : this.game.loader.getAsset("bglf3"), this.backgroundPTextureFree = "freespins1" === this.game.store.get("reward:currentFeature") ? this.game.loader.getAsset("bgpf1") : "freespins2" === this.game.store.get("reward:currentFeature") ? this.game.loader.getAsset("bgpf2") : this.game.loader.getAsset("bgpf3"), this.featureBackground.texture = this.game.device.portrait && !this.game.device.desktop ? this.backgroundPTextureFree : this.backgroundLTextureFree, 0 === this.featureBackground.alpha && k.fromTo(this.featureBackground, .5, {
                                pixi: {
                                    alpha: 0
                                }
                            }, {
                ...
                class Ps extends(Vt(H.W2)) {
                    constructor() {
                        ...
                        var e = new ks(d.xE.from(ws), 0);
                        e.width = 12, e.height = 151;
                        var i = new ks(d.xE.from(ws), 4914792);
                        i.width = 12, i.height = 151, this.onChangeVolume = new(S()), this.slider = new Bs(t, e, i), this.slider.position.set(33, 30), this.slider.onChange.add((t => this.onChangeVolume.dispatch(this.convertToVolume(t)))), this.interactive = !0, this.hitArea = new X.Rectangle(0, 0, 78, 200), this.game.interaction.up(this, (() => {
                ...
                class Is extends _s {
                    constructor(t) {
                        ...
                        })), this.betLevel = t, this.betLevelText = this.addChild(new Pe("", Ds(Ds({}, Ws.Common), {}, {
                            default: Ds(Ds({}, Ws.Common.default), {}, {
                                align: "left"
                            })
                                ...
                                if (l) {
                                    ...
                                    switch (l.type) {
                                        case W.AttachmentType.Region:
                                            ...
                                            d.transform.setFromMatrix(r.bone.matrix), r.currentSprite.color ? c = r.currentSprite.color : (Ls[0] = o[0] * r.color.r * u.r, Ls[1] = o[1] * r.color.g * u.g, Ls[2] = o[2] * r.color.b * u.b, r.currentSprite.tint = it.rgb2hex(Ls)), r.currentSprite.blendMode = r.blendMode;
                                            break;
                                        case W.AttachmentType.Mesh:
                                            if (r.currentSprite) {
                                                r.currentSprite.visible = !1, r.currentSprite = null, r.currentSpriteName = void 0;
                                                var b = new X.Transform;
                                            ...
                                            l.computeWorldVerticesOld(r, r.currentMesh.vertices), r.currentMesh.color ? c = r.currentMesh.color : (Ls[0] = o[0] * r.color.r * u.r, Ls[1] = o[1] * r.color.g * u.g, Ls[2] = o[2] * r.color.b * u.b, r.currentMesh.tint = it.rgb2hex(Ls)), r.currentMesh.blendMode = r.blendMode;
                                            break;
                                    ...
                                    if (d.visible = !0, c) {
                                        var w = r.color.r * u.r,
                                            S = r.color.g * u.g,
                                            x = r.color.b * u.b;
                                        c.setLight(o[0] * w + n[0] * (1 - w), o[1] * S + n[1] * (1 - S), o[2] * x + n[2] * (1 - x)), r.darkColor ? (w = r.darkColor.r, S = r.darkColor.g, x = r.darkColor.b) : (w = 0, S = 0, x = 0), c.setDark(o[0] * w + n[0] * (1 - w), o[1] * S + n[1] * (1 - S), o[2] * x + n[2] * (1 - x))
                                    }
                                    d.alpha = r.color.a
                                } else d.visible = !1
                            }
                            for (var k = this.skeleton.drawOrder, C = null, B = null, P = 0, T = k.length; P < T; P++) {
                                var E = i[k[P].data.index],
                                    _ = this.slotContainers[k[P].data.index];
                                if (B || null !== _.parent && _.parent !== this && (_.parent.removeChild(_), _.parent = this), E.currentGraphics && E.getAttachment()) B = E.clippingContainer, C = E.getAttachment(), B.children.length = 0, this.children[P] = _, C.endSlot === E.data && (C.endSlot = null);
                                else if (B) {
                                    var F = this.tempClipContainers[P];
                                    F || ((F = this.tempClipContainers[P] = this.newContainer()).visible = !1), this.children[P] = F, _.parent = null, B.addChild(_), C.endSlot == E.data && (B.renderable = !0, B = null, C = null)
                                } else this.children[P] = _
                            }
                        }
                    }
                    createGraphics(t, e) {
                ...
                class Ys extends Pe {
                    constructor() {
                        super("", Hs(Hs({}, Ws.Common), {}, {
                            default: Hs(Hs({}, Ws.Common.default), {}, {
                                align: "right"
                            })
                        }))
                    }
                ...
                class Xs extends Pe {
                    constructor() {
                        super("", Ws.FreeSpins), this.visible = !1
                    }
                    change(t) {
                ...
                class Js extends Pe {
                    constructor() {
                        super("", qs(qs({}, Ws.Common), {}, {
                            default: qs(qs({}, Ws.Common.default), {}, {
                                fill: Lt.config.get("colors.primary"),
                                fontFamily: "Avenir-Bold"
                            }),
                            value: qs(qs({}, Ws.Common.value), {}, {
                                fontSize: 66
                            })
                        })), this.visible = !1
                    }
                ...
                class $s extends Pe {
                    constructor() {
                        super("", Ws.Common), this.anchor.x = .5
                    }
                    update(t) {
                        var e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
                ...
                class to extends Es {
                    constructor() {
                        super(), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "buttonAccept", void 0), (0, n.Z)(this, "buttonAutoPlay", void 0), (0, n.Z)(this, "buttonMaxBet", void 0), (0, n.Z)(this, "buttonMenu", void 0), (0, n.Z)(this, "buttonQuickSpin", void 0), (0, n.Z)(this, "buttonSound", void 0), (0, n.Z)(this, "buttonSpin", void 0), (0, n.Z)(this, "freeRoundLeft", void 0), (0, n.Z)(this, "freeRoundTotalWin", void 0), (0, n.Z)(this, "textBalance", void 0), (0, n.Z)(this, "textFreeSpinLeft", void 0), (0, n.Z)(this, "textFreeSpinTotalWin", void 0), (0, n.Z)(this, "textWin", void 0), this.background = $.j.from("data:image/png;base64,"), this.background.alpha = .4, this.background.anchor.set(0, 1), this.background.position.set(0, this.game.viewport.height), this.buttonMenu = new vs, this.buttonMenu.position.set(77, 1013), this.buttonMaxBet = new Is(this.game.betLevel), this.buttonMaxBet.position.set(213, 1013), this.buttonAutoPlay = new As, this.buttonAutoPlay.position.set(833, 1013), this.buttonQuickSpin = new ys, this.buttonQuickSpin.position.set(1084, 1014), this.buttonSound = new Ts, this.buttonSound.position.set(1840, 1012), this.buttonSpin = function() {
                            ...
                            e.name = "buttonSpin", e.hitArea = new X.Rectangle(0, 0, 150, 130);
                            var i = new js(Lt.loader.getAsset("effectSpin"));
                            i.play("static", !1), e.addChild(i), e.onClick.add(o), e.onHover.add((() => {
                                i.play("hover", !1)
                            })), e.onLeave.add((() => {
                                i.play("static", !1)
                            }));
                            ...
                            return s.onPress.add(o), s.disable(), Lt.action.on("spin:fast", (function() {
                                ...
                                zi.isFreespin() || (i.play("static", !1), e.enable(), s.enable())
                        ...
                        }(), this.buttonSpin.container.position.set(880, 928), this.buttonAccept = new bs, this.buttonAccept.position.set(958, 1013), this.textWin = new $s, this.textWin.anchor.x = .5, this.textWin.position.set(1400, 980), this.textBalance = new Ys, this.textBalance.anchor.x = 1, this.textBalance.position.set(1760, 980), this.freeRoundLeft = Vs(Ws.Common), this.freeRoundLeft.container.position.set(1700, 1054), this.freeRoundTotalWin = Gs(Ws.Common), this.freeRoundTotalWin.container.position.set(1400, 980), this.textFreeSpinLeft = new Xs, this.textFreeSpinLeft.visible = !1, this.textFreeSpinLeft.anchor.x = .5, this.textFreeSpinLeft.position.set(640, 980), this.textFreeSpinTotalWin = new Js, this.textFreeSpinTotalWin.visible = !1, this.textFreeSpinTotalWin.anchor.x = .5, this.textFreeSpinTotalWin.position.set(960, 955), this.addChild(this.background), this.addChild(this.textFreeSpinLeft), this.addChild(this.textFreeSpinTotalWin), this.addChild(this.buttonMenu), this.addChild(this.buttonMaxBet), this.game.config.get("autoPlay.available", !0) && this.addChild(this.buttonAutoPlay), this.game.config.get("quickSpin.available", !0) && this.addChild(this.buttonQuickSpin), this.addChild(this.buttonSound), this.addChild(this.buttonSpin.container), this.addChild(this.buttonAccept), this.addChild(this.textWin), this.game.config.get("balanceHide", !1) || this.addChild(this.textBalance), this.addChild(this.freeRoundTotalWin.container), this.addChild(this.freeRoundLeft.container), this.textWin.update(this.game.wallet.coins), this.textBalance.update(this.game.wallet.balance), this.game.freeRound.onStart.once((t => {
                            ...
                            zi.isFreespin() || this.textBalance.update(this.game.wallet.balance)
                        }))
                    }
                    lock() {
                ...
                class uo extends Es {
                    constructor() {
                        ...
                        })), this.buttonMenu = new vs, this.buttonSound = new Ts, this.buttonSpin = new co, this.game.interaction.hover(this.buttonSpin, (() => {
                        ...
                        })), this.buttonAccept = new bs, this.buttonQuickSpin = new ys, this.autoPlayButton = new As, this.autoPlayButton.scale.set(1.6), this.betButton = new _s, this.betButton.disable(), this.betButton.onClick.add((() => this.game.action.emit("clickMaxBet"))), this.game.action.on("update:win", (() => {
                ...
                class po extends(Vt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "_timeline", void 0), (0, n.Z)(this, "_keyboardSpace", void 0), (0, n.Z)(this, "_overlay", void 0), (0, n.Z)(this, "_content", void 0), (0, n.Z)(this, "_title", void 0), (0, n.Z)(this, "_win", void 0), (0, n.Z)(this, "_description", void 0), (0, n.Z)(this, "_buttonText", void 0), (0, n.Z)(this, "tweenAutoTimeout", void 0), (0, n.Z)(this, "completeResolve", void 0), this.visible = !1, this.completeResolve = !1, this.cursor = "pointer", this.interactive = !1, this._overlay = this.addChild(new Jt(.4)), this._content = this.addChild(new H.W2), this._content.interactive = !1, this._content.interactiveChildren = !1, this._title = this._content.addChild(new Pe("", {
                            default: {
                                fill: "#ffffff",
                                fontFamily: "PT Sans Narrow Bold",
                                fontSize: 78,
                    ...
                    show(t) {
                        ...
                        return new Promise((i => {
                            ...
                            if (t === ao.START) {
                                ...
                                this._title.text = this.game.i18n.t("PopupFreeSpinsTitle"), this._win.text = this.game.i18n.t("PopupFreeSpinsWinStart", o), this._description.text = "freespins1" === this.game.store.get("reward:currentFeature") ? this.game.i18n.t("PopupFreeSpinsDescription1") : "freespins2" === this.game.store.get("reward:currentFeature") ? this.game.i18n.t("PopupFreeSpinsDescription2") : this.game.i18n.t("PopupFreeSpinsDescription3"), this._buttonText.text = this.game.i18n.t("PopupFreeSpinsButton"), e && (this.tweenAutoTimeout = k.to(this._buttonText, 1, {
                                    pixi: {
                                        scale: 1.1
                                    },
                                    repeat: 5,
                                ...
                                this._title.text = this.game.i18n.t("PopupFreeSpinsTitleRestore"), this._win.text = this.game.i18n.t("PopupFreeSpinsWinRestore", h), this._description.text = "freespins1" === this.game.store.get("reward:currentFeature") ? this.game.i18n.t("PopupFreeSpinsDescription1") : "freespins2" === this.game.store.get("reward:currentFeature") ? this.game.i18n.t("PopupFreeSpinsDescription2") : this.game.i18n.t("PopupFreeSpinsDescription3"), this._buttonText.text = this.game.i18n.t("PopupFreeSpinsButton")
                            }
                    ...
                    resize() {
                        this.hitArea = new X.Rectangle(-this.game.viewport.paddingX, 0, this.game.viewport.width + 2 * this.game.viewport.paddingX, this.game.viewport.height), this._overlay.width = this.game.viewport.width + 2 * this.game.viewport.paddingX, this._overlay.height = this.game.viewport.height + 2 * this.game.viewport.paddingY, this._overlay.position.set(-this.game.viewport.paddingX, 0), this._title.setTagStyle("default", {
                ...
                class fo extends(Vt(H.W2)) {
                    constructor(t) {
                        var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [];
                        super(), (0, n.Z)(this, "_payTableBetLineBoxs", void 0), (0, n.Z)(this, "_payTableParagraph", void 0), (0, n.Z)(this, "_payTableTitle", void 0), this._payTableBetLineBoxs = new H.W2, this._payTableTitle = new yo(this.game.i18n.t("PaytableSectionBetLinesTitle").toUpperCase()), this._payTableParagraph = new vo(this.game.i18n.t("PaytableSectionBetLinesContent1")), t.forEach(((t, i) => {
                ...
                class xo extends(Vt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "_sectionParagraph1", void 0), (0, n.Z)(this, "_sectionTitle", void 0), this.visible = this.game.config.get("rnb", !0), this._sectionTitle = new yo(this.game.i18n.t("PaytableSectionRiskTitle").toUpperCase()), this._sectionTitle.position.set(0, 0), this._sectionParagraph1 = new vo(this.game.i18n.t("PaytableSectionRiskContent1")), this._sectionParagraph1.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this.addChild(this._sectionTitle), this.addChild(this._sectionParagraph1)
                    }
                    resize() {
                        this.game.device.desktop || this._sectionParagraph1.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30)
                    }
                }
                class ko extends(Vt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "_payTableParagraph1", void 0), (0, n.Z)(this, "_payTableParagraph2", void 0), (0, n.Z)(this, "_payTableSymbol", void 0), (0, n.Z)(this, "_sectionTitle", void 0), this._sectionTitle = new yo(this.game.i18n.t("PaytableSectionBaseCampTitle").toUpperCase()), this._payTableSymbol = new $.j(this.game.loader.getAsset("paytable", "soldier-wild-x3")), this._payTableSymbol.position.set(0, this._sectionTitle.height + this._sectionTitle.y - 30), this._payTableParagraph1 = new vo(this.game.i18n.t("PaytableSectionBaseCampContent1")), this._payTableParagraph1.position.set(this._payTableSymbol.x + this._payTableSymbol.width + 20, this._sectionTitle.height + this._sectionTitle.y + 30), this._payTableParagraph1.setTagStyle("default", {
                            wordWrapWidth: 600
                        }), this._payTableParagraph2 = new vo(this.game.i18n.t("PaytableSectionBaseCampContent2")), this._payTableParagraph2.position.set(this._payTableSymbol.x + this._payTableSymbol.width + 20, this._payTableParagraph1.y + this._payTableParagraph1.height + 30), this._payTableParagraph2.setTagStyle("default", {
                            wordWrapWidth: 600
                        }), this.addChild(this._sectionTitle), this.addChild(this._payTableSymbol), this.addChild(this._payTableParagraph1), this.addChild(this._payTableParagraph2)
                    }
                    resize() {
                        this.game.device.desktop || (this.game.device.landscape ? (this._payTableSymbol.scale.set(1), this._payTableSymbol.position.set(0, this._sectionTitle.height + this._sectionTitle.y - 30), this._payTableParagraph1.position.set(this._payTableSymbol.x + this._payTableSymbol.width + 10, this._sectionTitle.y + this._sectionTitle.height + 30), this._payTableParagraph1.setTagStyle("default", {
                            wordWrapWidth: 600
                        }), this._payTableParagraph2.position.set(this._payTableSymbol.x + this._payTableSymbol.width + 10, this._payTableParagraph1.y + this._payTableParagraph1.height + 30), this._payTableParagraph2.setTagStyle("default", {
                            wordWrapWidth: 600
                        })) : (this._payTableSymbol.scale.set(1), this._payTableSymbol.position.set(0, this._sectionTitle.height + this._sectionTitle.y), this._payTableParagraph1.position.set(0, this._payTableSymbol.y + this._payTableSymbol.height + 30), this._payTableParagraph1.scale.set(2), this._payTableParagraph1.setTagStyle("default", {
                            wordWrapWidth: 450
                        }), this._payTableParagraph2.position.set(0, this._payTableParagraph1.y + this._payTableParagraph1.height + 30), this._payTableParagraph2.scale.set(2), this._payTableParagraph2.setTagStyle("default", {
                            wordWrapWidth: 450
                        })))
                    }
                }
                class Co extends(Vt(H.W2)) {
                    ...
                    updateBet(t) {
                        this.payoutText.text = "\n", this.payouts.filter((t => t.sym === this.findIndex)).forEach((e => {
                            var i;
                            e.n > 0 && e.mul > 0 && (i = "scatter" === e.type ? t.toCoins() * e.mul : t.bet * e.mul, "fs" === this.showType && e.n > 3 ? this.payoutText.text += "<mul>".concat(e.n, "\t\t").concat(this.game.helpers.toMoney(i, t.bet), "*\n</mul>") : "description" === this.showType && e.n > 3 ? this.payoutText.text += "<mul>".concat(e.n, "\t\t+").concat(e.freespins, " FS\n</mul>\n") : "description" !== this.showType && (this.payoutText.text += "<mul>".concat(e.n, "</mul>\t\t").concat(this.game.helpers.toMoney(i, t.bet), "\n")))
                        }))
                    }
                    resize() {
                ...
                class Bo extends(Vt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "_sectionParagraph", void 0), (0, n.Z)(this, "_sectionTitle", void 0), (0, n.Z)(this, "_symbol1", void 0), (0, n.Z)(this, "_symbol2", void 0), (0, n.Z)(this, "_symbol3", void 0), this._sectionTitle = new yo(this.game.i18n.t("PaytableSectionFreeTitle").toUpperCase()), this._sectionTitle.position.set(0, 0), this._symbol1 = new Co("s_glass", "default", "description"), this._symbol1.position.set(0, this._sectionTitle.height + this._sectionTitle.y + 30), this._symbol2 = new Co("s_girl", "default", "description"), this._symbol2.position.set(600, this._sectionTitle.height + this._sectionTitle.y + 30), this._symbol3 = new Co("s_boy", "default", "description"), this._symbol3.position.set(0, this._symbol1.height + this._symbol1.y + 30), this._sectionParagraph = new vo(this.game.i18n.t("PaytableSectionFreeContent1")), this._sectionParagraph.position.set(0, this._symbol3.height + this._symbol3.y + 30), this.addChild(this._sectionTitle, this._symbol1, this._symbol2, this._symbol3, this._sectionParagraph)
                    }
                    updateBet(t) {
                        this._symbol1.updateBet(t), this._symbol2.updateBet(t), this._symbol3.updateBet(t)
                    }
                    resize() {
                        this.game.device.desktop || (this.game.device.landscape ? (this._symbol1.position.set(0, this._sectionTitle.height + this._sectionTitle.y + 30), this._symbol2.position.set(820, this._sectionTitle.height + this._sectionTitle.y + 30), this._symbol3.position.set(0, this._symbol1.height + this._symbol1.y + 30), this._sectionParagraph.position.set(0, this._symbol3.height + this._symbol3.y + 30)) : (this._symbol1.position.set(0, this._sectionTitle.height + this._sectionTitle.y + 30), this._symbol2.position.set(0, this._symbol1.height + this._symbol1.y + 30), this._symbol3.position.set(0, this._symbol2.height + this._symbol2.y + 30), this._sectionParagraph.position.set(0, this._symbol3.height + this._symbol3.y + 30)))
                    }
                }
                class Po extends(Vt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "fBlack", void 0), (0, n.Z)(this, "fPink", void 0), (0, n.Z)(this, "fYellow", void 0), (0, n.Z)(this, "sBoy", void 0), (0, n.Z)(this, "sGirl", void 0), (0, n.Z)(this, "sGlass", void 0), (0, n.Z)(this, "sectionTitle", void 0), (0, n.Z)(this, "symbolA", void 0), (0, n.Z)(this, "symbolJ", void 0), (0, n.Z)(this, "symbolK", void 0), (0, n.Z)(this, "symbolQ", void 0), (0, n.Z)(this, "symbolSoldier", void 0), (0, n.Z)(this, "symbolTen", void 0), (0, n.Z)(this, "symbols", void 0), this.sectionTitle = new yo(this.game.i18n.t("PaytableSectionPayoutTitle").toUpperCase()), this.symbolSoldier = new Co("soldier"), this.symbolSoldier.position.set(0, this.sectionTitle.y + this.sectionTitle.height + 30), this.fYellow = new Co("f_yellow"), this.fYellow.position.set(600, this.sectionTitle.y + this.sectionTitle.height + 30), this.fPink = new Co("f_pink"), this.fPink.position.set(0, this.symbolSoldier.y + this.symbolSoldier.height + 30), this.fBlack = new Co("f_black"), this.fBlack.position.set(600, this.fYellow.y + this.fYellow.height + 30), this.sGlass = new Co("s_glass", "default", "fs"), this.sGlass.position.set(0, this.fPink.y + this.fPink.height + 30), this.sGirl = new Co("s_girl", "default", "fs"), this.sGirl.position.set(600, this.fBlack.y + this.fBlack.height + 30), this.sBoy = new Co("s_boy", "default", "fs"), this.sBoy.position.set(0, this.sGlass.y + this.sGlass.height + 30), this.symbolA = new Co("a"), this.symbolA.position.set(600, this.sGirl.y + this.sGirl.height + 30), this.symbolK = new Co("k"), this.symbolK.position.set(0, this.sBoy.y + this.sBoy.height + 30), this.symbolQ = new Co("q"), this.symbolQ.position.set(600, this.symbolA.y + this.symbolA.height + 30), this.symbolJ = new Co("j"), this.symbolJ.position.set(0, this.symbolK.y + this.symbolK.height + 30), this.symbolTen = new Co("10"), this.symbolTen.position.set(600, this.symbolQ.y + this.symbolQ.height + 30), this.symbols = [this.symbolSoldier, this.fYellow, this.fPink, this.fBlack, this.sGlass, this.sGirl, this.sBoy, this.symbolA, this.symbolK, this.symbolQ, this.symbolJ, this.symbolTen], this.addChild(this.sectionTitle, ...this.symbols)
                    }
                    updateBet(t) {
                        this.symbols.forEach((e => e.updateBet(t)))
                    }
                    resize() {
                        this.game.device.desktop || (this.game.device.landscape ? (this.symbolSoldier.position.set(0, this.sectionTitle.y + this.sectionTitle.height + 30), this.fYellow.position.set(820, this.sectionTitle.y + this.sectionTitle.height + 30), this.fPink.position.set(0, this.symbolSoldier.y + this.symbolSoldier.height + 30), this.fBlack.position.set(820, this.fYellow.y + this.fYellow.height + 30), this.sGlass.position.set(0, this.fPink.y + this.fPink.height + 30), this.sGirl.position.set(820, this.fBlack.y + this.fBlack.height + 30), this.sBoy.position.set(0, this.sGlass.y + this.sGlass.height + 30), this.symbolA.position.set(820, this.sGirl.y + this.sGirl.height + 30), this.symbolK.position.set(0, this.sBoy.y + this.sBoy.height + 30), this.symbolQ.position.set(820, this.symbolA.y + this.symbolA.height + 30), this.symbolJ.position.set(0, this.symbolK.y + this.symbolK.height + 30), this.symbolTen.position.set(820, this.symbolQ.y + this.symbolQ.height + 30)) : (this.symbolSoldier.position.set(0, this.sectionTitle.y + this.sectionTitle.height + 30), this.fYellow.position.set(0, this.symbolSoldier.y + this.symbolSoldier.height + 30), this.fPink.position.set(0, this.fYellow.y + this.fYellow.height + 30), this.fBlack.position.set(0, this.fPink.y + this.fPink.height + 30), this.sGlass.position.set(0, this.fBlack.y + this.fBlack.height + 30), this.sGirl.position.set(0, this.sGlass.y + this.sGlass.height + 30), this.sBoy.position.set(0, this.sGirl.y + this.sGirl.height + 30), this.symbolA.position.set(0, this.sBoy.y + this.sBoy.height + 30), this.symbolK.position.set(0, this.symbolA.y + this.symbolA.height + 30), this.symbolQ.position.set(0, this.symbolK.y + this.symbolK.height + 30), this.symbolJ.position.set(0, this.symbolQ.y + this.symbolQ.height + 30), this.symbolTen.position.set(0, this.symbolJ.y + this.symbolJ.height + 30)))
                    }
                }
                class To extends(Vt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "_payoutText1", void 0), (0, n.Z)(this, "_payoutText2", void 0), (0, n.Z)(this, "_sectionParagraph", void 0), (0, n.Z)(this, "_sectionTitle", void 0), (0, n.Z)(this, "_symbolScatter1", void 0), (0, n.Z)(this, "_symbolScatter2", void 0);
                        var t = {
                            default: {
                                fill: "white",
                                fontSize: 36,
                        ...
                        this._sectionTitle = new yo(this.game.i18n.t("PaytableSectionScatterTitle").toUpperCase()), this._sectionTitle.position.set(0, 0), this._symbolScatter1 = new Co("scat_1(bird)"), this._symbolScatter1.position.set(130, this._sectionTitle.y + this._sectionTitle.height + 30), this._symbolScatter1.withoutPayout(), this._payoutText1 = new Pe(this.game.i18n.t("PaytableSectionScatterDesc1"), t), this._payoutText1.anchor.x = .5, this._payoutText1.position.set(this._symbolScatter1.x + this._symbolScatter1.width / 2 - 12, this._symbolScatter1.y + this._symbolScatter1.height + 30), this._symbolScatter2 = new Co("scat_2(skull)"), this._symbolScatter2.position.set(720, this._sectionTitle.y + this._sectionTitle.height + 30), this._symbolScatter2.withoutPayout(), this._payoutText2 = new Pe(this.game.i18n.t("PaytableSectionScatterDesc2"), t), this._payoutText2.anchor.x = .5, this._payoutText2.position.set(this._symbolScatter2.x + this._symbolScatter2.width / 2 - 12, this._symbolScatter2.y + this._symbolScatter2.height + 30), this._sectionParagraph = new vo(this.game.i18n.t("PaytableSectionScatterContent1")), this._sectionParagraph.position.set(0, this._payoutText2.y + this._payoutText2.height + 30), this.addChild(this._sectionTitle, this._symbolScatter1, this._symbolScatter2, this._payoutText1, this._payoutText2, this._sectionParagraph)
                    }
                    updateBet(t) {
                        this._symbolScatter1.updateBet(t), this._symbolScatter2.updateBet(t)
                    }
                    resize() {
                        this.game.device.desktop || (this.game.device.landscape ? (this._payoutText1.anchor.y = 0, this._payoutText2.anchor.y = 0, this._payoutText1.scale.set(1.5), this._payoutText2.scale.set(1.5), this._symbolScatter1.position.x = 200, this._payoutText1.position.set(this._symbolScatter1.x + this._symbolScatter1.width / 2, this._sectionTitle.y + this._sectionTitle.height + 30), this._symbolScatter1.position.y = this._payoutText1.y + this._payoutText1.height + 30, this._symbolScatter2.position.x = 960, this._payoutText2.position.set(this._symbolScatter2.x + this._symbolScatter2.width / 2, this._sectionTitle.y + this._sectionTitle.height + 30), this._symbolScatter2.position.y = this._payoutText2.y + this._payoutText2.height + 30, this._sectionParagraph.position.set(0, this._symbolScatter1.y + this._symbolScatter1.height + 30)) : (this._payoutText1.anchor.y = 0, this._payoutText2.anchor.y = 0, this._payoutText1.scale.set(2), this._payoutText2.scale.set(2), this._payoutText1.position.set(this._symbolScatter1.width / 2, this._sectionTitle.y + this._sectionTitle.height + 30), this._symbolScatter1.position.set(0, this._payoutText1.y + this._payoutText1.height + 30), this._payoutText2.position.set(this._symbolScatter2.width / 2, this._symbolScatter1.y + this._symbolScatter1.height + 30), this._symbolScatter2.position.set(0, this._payoutText2.y + this._payoutText2.height + 30), this._sectionParagraph.position.set(0, this._symbolScatter2.y + this._symbolScatter2.height + 30)))
                    }
                }
                class Eo extends(Vt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "_sectionParagraph1", void 0), (0, n.Z)(this, "_sectionTitle", void 0), (0, n.Z)(this, "_symbol1", void 0), this._sectionTitle = new yo(this.game.i18n.t("PaytableSectionWildTitle").toUpperCase()), this._sectionTitle.position.set(0, 0), this._symbol1 = new Co("wild(fist)"), this._symbol1.position.set(0, this._sectionTitle.height + this._sectionTitle.y + 30), this._symbol1.withoutPayout(), this._sectionParagraph1 = new vo(this.game.i18n.t("PaytableSectionWildContent1")), this._sectionParagraph1.position.set(this._symbol1.x + this._symbol1.width, this._sectionTitle.height + this._sectionTitle.y + 30), this._sectionParagraph1.setTagStyle("default", {
                            wordWrapWidth: 690
                    ...
                    resize() {
                        this.game.device.desktop || (this.game.device.landscape ? (this._symbol1.position.set(0, this._sectionTitle.height + this._sectionTitle.y + 30), this._sectionParagraph1.position.set(this._symbol1.x + this._symbol1.width, this._sectionTitle.height + this._sectionTitle.y + 30), this._sectionParagraph1.setTagStyle("default", {
                            wordWrapWidth: 490
                        })) : (this._symbol1.position.set(0, this._sectionTitle.height + this._sectionTitle.y + 30), this._sectionParagraph1.position.set(0, this._symbol1.height + this._symbol1.y + 30), this._sectionParagraph1.setTagStyle("default", {
                            wordWrapWidth: 390
                        })))
                    }
                }
                class _o extends(Vt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "_payTableParagraph1", void 0), (0, n.Z)(this, "_payTableParagraph2", void 0), (0, n.Z)(this, "_payTableSymbol1", void 0), (0, n.Z)(this, "_payTableSymbol2", void 0), (0, n.Z)(this, "_payTableSymbol3", void 0), (0, n.Z)(this, "_sectionTitle", void 0), this._sectionTitle = new yo(this.game.i18n.t("PaytableSectionRazeTitle").toUpperCase()), this._payTableParagraph1 = new vo(this.game.i18n.t("PaytableSectionRazeContent1")), this._payTableParagraph1.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this._payTableSymbol1 = new $.j(this.game.loader.getAsset("paytable", "f_yellow_wild")), this._payTableSymbol1.scale.set(.8), this._payTableSymbol1.position.set(0, this._payTableParagraph1.y + this._payTableParagraph1.height + 30), this._payTableSymbol2 = new $.j(this.game.loader.getAsset("paytable", "f_pink_wild")), this._payTableSymbol2.scale.set(.8), this._payTableSymbol2.position.set(this._payTableSymbol1.x + 2 * this._payTableSymbol1.width, this._payTableParagraph1.y + this._payTableParagraph1.height + 30), this._payTableSymbol3 = new $.j(this.game.loader.getAsset("paytable", "f_black_wild")), this._payTableSymbol3.scale.set(.8), this._payTableSymbol3.position.set(this._payTableSymbol2.x + 2 * this._payTableSymbol2.width, this._payTableParagraph1.y + this._payTableParagraph1.height + 30), this._payTableParagraph2 = new vo(this.game.i18n.t("PaytableSectionRazeContent2")), this._payTableParagraph2.position.set(0, this._payTableSymbol1.height + this._payTableSymbol1.y + 30), this.addChild(this._sectionTitle), this.addChild(this._payTableParagraph1), this.addChild(this._payTableSymbol1), this.addChild(this._payTableSymbol2), this.addChild(this._payTableSymbol3), this.addChild(this._payTableParagraph2)
                    }
                    resize() {
                        this.game.device.desktop || (this.game.device.landscape ? (this._payTableSymbol1.scale.set(.8), this._payTableSymbol2.scale.set(.8), this._payTableSymbol3.scale.set(.8), this._payTableParagraph1.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this._payTableSymbol1.position.set(0, this._payTableParagraph1.y + this._payTableParagraph1.height + 30), this._payTableSymbol2.position.set(this._payTableSymbol1.x + 2 * this._payTableSymbol1.width, this._payTableParagraph1.y + this._payTableParagraph1.height + 30), this._payTableSymbol3.position.set(this._payTableSymbol2.x + 2 * this._payTableSymbol2.width, this._payTableParagraph1.y + this._payTableParagraph1.height + 30), this._payTableParagraph2.position.set(0, this._payTableSymbol1.height + this._payTableSymbol1.y + 30)) : (this._payTableSymbol1.scale.set(1), this._payTableSymbol2.scale.set(1), this._payTableSymbol3.scale.set(1), this._payTableParagraph1.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this._payTableSymbol1.position.set(0, this._payTableParagraph1.y + this._payTableParagraph1.height + 30), this._payTableSymbol2.position.set(this._payTableSymbol1.x + this._payTableSymbol1.width + 40, this._payTableParagraph1.y + this._payTableParagraph1.height + 30), this._payTableSymbol3.position.set(this._payTableSymbol2.x + this._payTableSymbol2.width + 40, this._payTableParagraph1.y + this._payTableParagraph1.height + 30), this._payTableParagraph2.position.set(0, this._payTableSymbol1.height + this._payTableSymbol1.y + 30)))
                    }
                }
                class Fo extends go {
                    constructor(t) {
                        super(), (0, n.Z)(this, "_paytableSectionBaseCamp", void 0), (0, n.Z)(this, "_paytableSectionBetLines", void 0), (0, n.Z)(this, "_paytableSectionFree", void 0), (0, n.Z)(this, "_paytableSectionPayout", void 0), (0, n.Z)(this, "_paytableSectionRaze", void 0), (0, n.Z)(this, "_paytableSectionRisk", void 0), (0, n.Z)(this, "_paytableSectionScatter", void 0), (0, n.Z)(this, "_paytableSectionWild", void 0), (0, n.Z)(this, "payTableDelimiter", void 0), this.payTableDelimiter = new So, this._paytableSectionRisk = new xo, this._paytableSectionPayout = new Po, this._paytableSectionWild = new Eo, this._paytableSectionScatter = new To, this._paytableSectionBaseCamp = new ko, this._paytableSectionRaze = new _o, this._paytableSectionFree = new Bo, this._paytableSectionBetLines = new wo(t), this.content.addChild(this._paytableSectionRisk, this._paytableSectionPayout, this._paytableSectionWild, this._paytableSectionScatter, this._paytableSectionBaseCamp, this._paytableSectionRaze, this._paytableSectionFree, this.payTableDelimiter, this._paytableSectionBetLines)
                    }
                    updateBet(t) {
                        this._paytableSectionPayout.updateBet(t), this._paytableSectionWild.updateBet(t), this._paytableSectionScatter.updateBet(t), this._paytableSectionFree.updateBet(t)
                    }
                }
                ...
                function Qo(t) {
                    for (var e = 1; e < arguments.length; e++) {
                        var i = null != arguments[e] ? arguments[e] : {};
                        e % 2 ? Go(Object(i), !0).forEach((function(e) {
                            (0, n.Z)(t, e, i[e])
                        })) : Object.getOwnPropertyDescriptors ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(i)) : Go(Object(i)).forEach((function(e) {
                            Object.defineProperty(t, e, Object.getOwnPropertyDescriptor(i, e))
                        }))
                    }
                    return t
                }
                class Ho extends(Vt(Pe)) {
                    constructor() {
                        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                        super("", Qo(Qo({}, t), {}, {
                            default: Qo({
                ...
                class Yo extends Io {
                    constructor() {
                        super(), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "backgroundContent", void 0), (0, n.Z)(this, "betValue", void 0), (0, n.Z)(this, "featureButton", void 0), (0, n.Z)(this, "label", void 0), (0, n.Z)(this, "labelCount", void 0), (0, n.Z)(this, "onPress", void 0), (0, n.Z)(this, "subHeader", void 0), (0, n.Z)(this, "textBuy", void 0), (0, n.Z)(this, "textDelimeter", void 0), (0, n.Z)(this, "value", void 0), this.onPress = new(S()), this.background = this.addChild(new $.j(this.game.loader.getAsset("risk", "bg"))), this.background.x = 1641, this.backgroundContent = this.background.addChild(new H.W2), this.backgroundContent.renderable = !1, this.label = this.backgroundContent.addChild(new $.j(this.game.loader.getAsset("risk", "logo-raze"))), this.label.position.set(-10, 120), this.labelCount = this.label.addChild(new b.Xz("", {
                            fontName: "RiskFont"
                        })), this.subHeader = this.backgroundContent.addChild(new No({
                            default: {
                                fontSize: 28,
                                wordWrapWidth: 220
                            }
                        })), this.textBuy = this.backgroundContent.addChild(new Zo({
                            default: {
                                fill: "#d7d7d7",
                                fontSize: 20,
                                wordWrapWidth: 200
                            }
                        })), this.value = this.backgroundContent.addChild(new Do({
                            default: {
                                fontSize: 36
                            }
                        })), this.textDelimeter = this.backgroundContent.addChild(new Vo({
                            default: {
                                fill: "#d7d7d7",
                                fontSize: 20,
                                wordWrapWidth: 210
                            }
                        })), this.betValue = this.backgroundContent.addChild(new Ho({
                            default: {
                                fontSize: 36
                            }
                        })), this.featureButton = this.backgroundContent.addChild(new js(this.game.loader.getAsset("riskButton"))), this.featureButton.cursor = "pointer", this.game.interaction.click(this.featureButton, (() => {
                    ...
                    show(t) {
                        if (this.game.store.get("isRiskNBuy") && (super.show(t), this.visible)) {
                            ...
                            k.to(this.background, .5, {
                                pixi: {
                                    alpha: 1
                                }
                            }), this.backgroundContent.renderable = !0, setTimeout((() => {
                                this.featureButton.interactive = !0
                            }), 150), this.label.texture = e ? "freespins1" === e.feature ? this.game.loader.getAsset("risk", "logo-thelaw") : this.game.loader.getAsset("risk", "logo-raze") : this.game.loader.getAsset("risk", "logo-survivors"), this.label.anchor.x = .5, this.label.position.set(this.background.width / 2, e ? 190 : 80), this.textBuy.text = e ? "" : this.game.i18n.t("RiskNBuyBuyFor", this.game.i18n.currency({
                                withBrace: !0
                            })), this.textBuy.anchor.x = .5, this.textBuy.position.set(this.background.width / 2, this.label.height + this.label.y + this.textBuy.height / 2 - 10), this.value.text = e ? "" : "".concat(Lt.helpers.toMoneySS(i.bet)), this.value.anchor.x = .5, this.value.position.set(this.background.width / 2, this.textBuy.y + this.textBuy.height), this.textDelimeter.anchor.x = .5, this.textDelimeter.position.set(this.background.width / 2, 580), this.betValue.text = "".concat(Lt.helpers.toMoneySS(this.game.betLevel.toCoins())), this.betValue.anchor.x = .5, this.betValue.position.set(this.background.width / 2, this.textDelimeter.height + this.textDelimeter.y), e ? (this.subHeader.show(), this.subHeader.position.set(this.background.width / 2, 120), this.labelCount.text = "", this.featureButton.changeSkin("risk")) : (this.subHeader.hide(), this.labelCount.text = i.freespins, this.labelCount.scale.set(.5), this.labelCount.anchor.x = .5, this.labelCount.position.set(0, 130), this.featureButton.changeSkin("buy")), this.featureButton.play("idle", !0), this.featureButton.pivot.x = -25, this.featureButton.position.set(0, 780), this.resize()
                        }
                    }
                    hide() {
                        super.hide(), this.backgroundContent.renderable = !1, this.background.scale.set(1), this.backgroundContent.position.set(0), this.backgroundContent.scale.set(1), this.featureButton.interactive = !1
                    }
                    resize() {
                        this.renderable && (this.game.device.desktop || this.game.device.landscape ? (this.scale.set(1), this.x = 0, this.background.x = this.game.device.desktop ? 1641 : 1131, this.background.scale.set(1), this.backgroundContent.position.set(0), this.backgroundContent.scale.set(1)) : (this.scale.set(1.125), this.x = -129.375, this.background.x = 760, this.background.scale.set(1.3, 2), this.backgroundContent.position.set(-5, 60), this.backgroundContent.scale.set(1.1, .7)))
                    }
                    playFeatureButton() {
                        return this.featureButton.play("action")
                    }
                }
                class Xo extends(Vt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "value", void 0), (0, n.Z)(this, "description", void 0), (0, n.Z)(this, "timeline", void 0), this.alpha = 0, this.value = this.addChild(new b.Xz("0", {
                            fontName: "WinFont"
                ...
                class en {
                    constructor() {
                        (0, n.Z)(this, "container", void 0), (0, n.Z)(this, "timeline", void 0), (0, n.Z)(this, "textValue", void 0), (0, n.Z)(this, "textDescription", void 0), (0, n.Z)(this, "containerBg", void 0), this.timeline = new C, this.container = new H.W2, this.container.name = "TextFreeLeft", this.container.alpha = 0, this.containerBg = new $.j(Lt.loader.getAsset("labelBox")), this.containerBg.anchor.set(.5), this.textValue = new b.Xz("", {
                            fontName: "WinFont"
                        }), this.textValue.scale.set(.6), this.textValue.anchor = .5, this.textDescription = new $.j(Lt.loader.getAsset("textLastFreeSpin")), this.container.addChild(this.containerBg), this.container.addChild(this.textValue), this.container.addChild(this.textDescription)
                    }
                    show(t) {
                        var e = Lt.store.get("isRespin"),
                            i = this.container.y;
                        return new Promise((s => {
                            ...
                            }, e ? (this.textValue.text = "", this.textDescription.texture = Lt.loader.getAsset("textRespin"), this.textDescription.pivot.set(this.textDescription.width / 2, this.textDescription.height / 2), this.timeline.set(this.container, {
                                pixi: {
                                    y: i,
                                    alpha: 0,
                                    scale: 1
                            ...
                            }, "+=0.75"), Lt.action.emit("respin:start")) : t < 1 ? (this.textValue.text = "", this.textDescription.texture = Lt.loader.getAsset("textLastFreeSpin"), this.textDescription.pivot.set(this.textDescription.width / 2, this.textDescription.height / 2), this.timeline.set(this.container, {
                                pixi: {
                                    y: i,
                                    alpha: 0,
                                    scale: 1
                            ...
                            }, "+=0.75")) : (this.textValue.text = "".concat(t), this.textDescription.texture = Lt.loader.getAsset("textFreeSpinLeft"), this.textValue.position.set(0, -80), this.textDescription.pivot.set(this.textDescription.width / 2, 0), this.timeline.set(this.container, {
                                pixi: {
                                    y: i,
                                    alpha: 0,
                                    scale: 1
                ...
                const on = class extends sn {
                    ...
                    get isStop() {
                        return super.isStop || Lt.store.get("free:isFree", !1) || Lt.store.get("free:isEnd", !1)
                    }
                    beforeStart() {
                        var t = this;
                        return (0, o.Z)((function*() {
                            t._isFree = Lt.store.get("free:isFree", !1), t._isFreeEnd = Lt.store.get("isRespin") ? Lt.store.set("free:isEnd", !1) : Lt.store.get("free:isEnd", !1)
                        }))()
                    }
                    stop() {
                        this._wins.length = 0, clearInterval(this._flushInterval), this.slot.reels.forEach((t => t.stopAnimation())), this.slot.lines.hide(), this.slot.textLineWin.clear(), this.slot.stickyWild.hideLayoutSymbols()
                    }
                    _getWinSoundNumber() {
                    ...
                    allPayment(t) {
                        var e = this;
                        return (0, o.Z)((function*() {
                            e.slot.staticAnimation.hide(e.slot.reels), e.slot.reels.forEach((t => t.overlay())), e.slot.lines.show(t);
                            for (var i = 0, s = t.length; i < s; i++) {
                                var o = t[i];
                                e._wins.push(o), e._runSymbolAnimation(o, !1), e.slot.stickyWild.checkWin(o)
                            }
                    ...
                    scatterPayment(t) {
                        var e = this;
                        return (0, o.Z)((function*() {
                            e.slot.stickyWild.hideLayoutSymbols(), e.slot.staticAnimation.hide(e.slot.reels), Lt.action.emit("sound:scatterWin"), e.slot.reels.forEach((t => t.overlay())), e.slot.lines.hide(), Lt.action.emit("textLineWin:hide"), e._runSymbolAnimation(t, !0, "free"), yield Lt.delay(Ui.get("reward_scatter"))
                        }))()
                    }
                    freeSymbolsReward(t) {
                        var e = this;
                        return (0, o.Z)((function*() {
                            if (Lt.action.emit("sound:scatterWin"), e.slot.reels.forEach((t => t.overlay())), e.slot.lines.hide(), Lt.action.emit("textLineWin:hide"), e._runSymbolsAsScatters(t), Lt.store.get("free:winAdditional", !1)) {
                                yield Lt.delay(1e3);
                            ...
                            } else yield Lt.delay(Ui.get("reward_scatter"))
                        }))()
                    }
                    complete() {
                    ...
                    _flush() {
                        var t = !0,
                            e = e => {
                                ...
                                var i = this._wins[e];
                                this._runSymbolAnimation(i), t && this._showLineText(i), this.slot.lines.show([i])
                            },
                            i = 0;
                        ...
                        for (var s = 0; s < e.length; s++)
                            if (-1 !== e[s]) {
                                var o = e[s],
                                    ...
                                    a = Lt.config.get("slot.size[0]") * o + s;
                                n.playAnimation(i, a, s)
                            }
                    }
                    _runSymbolsAsScatters(t) {
                        this.slot.reels.forEach((t => t.clearAnimation())), t.forEach((t => {
                            for (var e = 0; e < t.length; e++)
                                if (-1 !== t[e]) {
                                    var i = t[e],
                                        s = this._findSymbol(e, i),
                                        o = Lt.config.get("slot.size[0]") * i + e;
                                    s.playAnimation("wild(fist)" === s._texture.textureCacheIds[0] ? "free" : "freeSymbol", o, e)
                                }
                        }))
                    }
                    _showLineText(t) {
                ...
                function an() {
                    ...
                    return Lt.action.on("symbol:playAnimation", ((o, n, a, h) => {
                        if (h.renderable)
                            if (function(t, i) {
                                    return e.some((e => e.x === t && e.y === i))
                                }(o, n)) {
                                if (a.assetName) {
                                    var r = t.children.find((t => t.x === o && t.y === n));
                                    if (r)
                                        if ("string" == typeof a.effectName) r.play(a.effectName);
                                        else {
                                            var l = a.effectName[a.type] || a.effectName.normal;
                                            r.play(l, !1)
                                        }
                                }
                            } else {
                                ...
                                var d = i.sort(s).indexOf(a.pos);
                                if (a.assetName) {
                                    var c = new js(Lt.loader.getAsset(a.assetName));
                                    if (c.name = a.assetName, c.alpha = 1, c.position.set(o, n), a.skin && c.changeSkin(a.skin), "freeSymbol" === a.type) {
                                        var u = new js(Lt.loader.getAsset("freeSymbolText"));
                                        u.play("win-fs"), c.addChild(u)
                                    }
                                    if (t.addChildAt(c, d), "string" == typeof a.effectName) c.play(a.effectName);
                                    else {
                                        var p = a.effectName[a.type] || a.effectName.normal;
                                        c.play(p, !1)
                                    }
                                } else {
                                    var g = new $.j(a.texture);
                                    g.alpha = 1, g.position.set(o, n), t.addChildAt(g, d)
                                }
                            }
                    })), Lt.action.on("symbol:stopAnimation", (() => {
                        e.length = 0, i.length = 0, t.removeChildren(0, t.children.length)
                    })), t
                }
                class hn {
                    constructor() {
                        (0, n.Z)(this, "container", void 0), (0, n.Z)(this, "containerText", void 0), (0, n.Z)(this, "tween", void 0), this.container = new $.j(Lt.loader.getAsset("flushBg")), this.container.anchor.set(.5), this.container.alpha = 0, this.containerText = new b.Xz("", {
                            fontName: "WinFont"
                        }), this.containerText.anchor = .5, this.containerText.scale.set(.3), this.container.addChild(this.containerText)
                    }
                    show(t, e, i) {
                        this.container.x = t, this.container.y = e, this.containerText.text = "".concat(Lt.i18n.currency({
                            bitmap: !0
                    ...
                    clear() {
                        this.tween && this.tween.kill(), this.containerText.text = "", this.container.alpha = 0
                    }
                }
                ...
                function pn(t, e, i) {
                    ...
                    function h() {
                        Lt.action.emit("symbol:stopAnimation", n.animation), s && (a.alpha = dn)
                    }
                    return a.position.set(t, e), Object.assign(a, {
                        replaceTexture: function(t) {
                            t,
                            n = Lt.config.get("slot.layout.".concat(o, "[").concat(t, "]"), null),
                            a.texture = Lt.loader.getAsset(n.textureAtlas, n.assetName)
                        },
                        clearAnimation: h,
                        overlay() {
                            a.alpha = un
                        ...
                        playAnimation(t, e, i) {
                            s = !0, a.alpha = cn, Lt.action.emit("symbol:playAnimation", a.x, a.y, ln(ln({}, n.animation), {}, {
                                type: t,
                                texture: a.texture,
                                pos: e,
                                index: i
                ...
                class gn extends H.W2 {
                    constructor(t, e) {
                        ...
                        })), Lt.action.on("free:stop", (() => {
                            this._restoreWheelAfterFree(), this.visibleSymbols.forEach((t => {
                                t.renderable = !0, t.isSticky = !1
                            }))
                        })), Lt.action.on("free:start", (() => {
                    ...
                    start() {
                        ...
                        var t = Lt.store.get("stickyArr", [0, 0, 0, 0, 0]);
                        this.children.forEach(((e, i) => {
                            e.renderable = 1 !== t[this._reelIndex], this._nReel = Lt.store.get("reward:nReels", [])[this._reelIndex].concat(), (e.y < this.visibleSymbols[0].y || e.y > this.visibleSymbols[this.visibleSymbols.length - 1].y) && e.replaceTexture(this._nReel[i])
                        }));
                    ...
                    stop() {
                        if (!this.isStop) {
                            ...
                            for (var s = 0; s < this._reelIndex; s++) 1 === e[s] && 1 === t[s] && (i -= 1);
                            var o = this.renderable ? this._stopTimeoutDuration * i : 0,
                                n = Lt.store.get("reward:reels", []);
                            this._reel = n[this._reelIndex].concat(), Lt.store.get("spin:isFast", !1) ? (Lt.action.emit("sound:spinFast"), clearTimeout(this._stopTimeout), this.isStop = !0) : this._stopTimeout = setTimeout((() => {
                                this.isStop = !0
                            }), o)
                        }
                    }
                    ...
                    _setup() {
                        ...
                        for (var i = 0, s = this._nReel.length; i < s; i++) {
                            var [o, n] = this.symbolsPositions[i], a = pn(o, n, 0 === i || i === s - 1 ? this._nReel[i] : this._reel[i - 1]);
                    ...
                    _spin() {
                        if (this._flip(), this.isStop)
                            ...
                            } else this.y = 0, this.children[0].y = this._startY, this._updateVisibleSymbols(), this.renderable && Lt.action.emit("wheel:stop_down"), this._spinTween.pause(), this._endTween.restart(), this.children[this.children.length - 1].alpha = 0, this.children[0].alpha = 0
                    }
                    _flip() {
                        this.children[0].alpha = 1, this.children[this.children.length - 1].alpha = 1;
                ...
                class mn extends $o {
                    constructor() {
                        super(), (0, n.Z)(this, "animation", void 0), (0, n.Z)(this, "lines", void 0), (0, n.Z)(this, "reels", void 0), (0, n.Z)(this, "reelsContainer", void 0), (0, n.Z)(this, "slotData", void 0), (0, n.Z)(this, "staticAnimation", void 0), (0, n.Z)(this, "stickyWild", void 0), (0, n.Z)(this, "stickyWildLayout", void 0), (0, n.Z)(this, "stickyWildReelLayout", void 0), (0, n.Z)(this, "stopReelCounter", void 0), (0, n.Z)(this, "symbolsPositions", void 0), (0, n.Z)(this, "textExtraFree", void 0), (0, n.Z)(this, "textFreeLeft", void 0), (0, n.Z)(this, "textLineWin", void 0), (0, n.Z)(this, "textTotalWin", void 0), this.pivot.set(582, 68), this.reels = [], this.symbolsPositions = this.game.config.get("slot.symbolsPositions", []), this.animation = new on(this), this.stopReelCounter = 0, this.init(), this.setupEvents()
                    }
                    createMask() {
                        var t = new u.TC;
                        return t.beginFill(16711680, .8), t.drawRect(0, 0, this.game.config.get("slot.width"), this.game.config.get("slot.height") - 37), t.endFill(), t
                    }
                    init() {
                        var t, e, i = this.createMask();
                        this.reelsContainer = new H.W2, this.reelsContainer.mask = i, this.reelsContainer.addChild(i);
                        for (var s = this.game.config.get("slot.size[0]"), n = 0; n < s; n++) {
                            var a = this.symbolsPositions[n],
                                h = new gn(n, a);
                        ...
                        this.slotData = {
                        ...
                        })))), this.stickyWildLayout = new H.W2, this.stickyWildLayout.alpha = .3, this.stickyWildReelLayout = new H.W2, this.stickyWildReelLayout.alpha = .3, this.textFreeLeft = new en, this.textFreeLeft.container.position.set(622, 810), this.textExtraFree = new Xo, this.textExtraFree.setBackground("labelBox"), this.textExtraFree.background.position.set(-320, -30), this.textExtraFree.value.scale.set(.6), this.textExtraFree.description.y = 80, this.textExtraFree.position.set(622, 810), this.textTotalWin = new tn(.9), this.textTotalWin.setBackground("winBg"), this.textTotalWin.background.position.set(-130, -420), this.textTotalWin.textScaleEnabled = !0, this.textTotalWin.winText.rotation = -.2, this.textTotalWin.position.set(-180, 430), this.textLineWin = new hn, this.staticAnimation = function() {
                            var t = new nn;

                            function e() {
                                return 0 === Math.round(2 * Math.random() - .5) ? "idle" : "idle2"
                            }
                            return t.name = "animationStatic", {
                                container: t,
                                onStop: (i, s) => (0, o.Z)((function*() {
                                    Lt.store.get("reward:feature");
                                    var o = Lt.config.get("slot.layout.default");
                                    i.isWild || i.visibleSymbols.forEach((i => {
                                        if (i.renderable) {
                                            var n = "wild" === i._texture.textureCacheIds[0].slice(i._texture.textureCacheIds[0].length - 4, i._texture.textureCacheIds[0].length) ? i._texture.textureCacheIds[0].slice(0, i._texture.textureCacheIds[0].length - 5) : i._texture.textureCacheIds[0],
                                                a = o.find((t => t.animation && t.animation.spin && t.assetName === n));
                                            if (a) {
                                                var h = new js(Lt.loader.getAsset(a.animation.assetName));
                                                h.changeSkin(n), h.position.set(i.x, i.y), h.reelIndex = s, t.addChild(h), i.renderable = !1, h.play("wild" === i._texture.textureCacheIds[0].slice(i._texture.textureCacheIds[0].length - 4, i._texture.textureCacheIds[0].length) ? "spin-wild" : "spin").then((() => {
                                                    Lt.autoPlay.enabled || zi.isFreespin() || !a.animation.idle || h.play(e(), !0)
                                                }))
                                            }
                                        }
                                    }))
                                ...
                                runStatic(i) {
                                    var s = Lt.config.get("slot.layout.default");
                                    t.children.length < 1 && i.forEach((i => {
                                        i.visibleSymbols.forEach((i => {
                                            var o = i._texture.textureCacheIds[0],
                                                n = s.find((t => t.animation && t.animation.idle && t.assetName === o));
                                            if (n) {
                                                i.renderable = !1;
                                                var a = new js(Lt.loader.getAsset(n.animation.assetName));
                                                a.changeSkin(o), a.position.set(i.x, i.y), a.play(e(), !0), t.addChild(a)
                                            }
                                        }))
                                    }))
                                },
                                hide(e) {
                                    e.forEach((e => {
                                        e.visibleSymbols.forEach((e => {
                                            e.renderable = !e.isSticky, t.removeChildren()
                                        }))
                                    }))
                                }
                            }
                        }(), this.stickyWild = function(t, e) {
                            var i = [],
                                s = new H.W2,
                                n = new H.W2,
                                a = new H.W2,
                            ...
                            function l() {
                                return 0 === Math.round(2 * Math.random() - .5) ? "idle-wild" : "idle-wild2"
                            }
                            return s.addChild(n, a, h), Lt.store.set("initResipn", !1), Lt.store.set("stickyArr", [0, 0, 0, 0, 0]), {
                                container: s,
                                hideSymbols(e) {
                                    var i = Lt.store.get("overlayWilds");
                                    i && i.length && i.forEach((i => {
                                        var s = Lt.config.get("slot.size[0]") * i[1] + i[0],
                                            o = n.children.find((t => t.index === s));
                                        i[0] === e && o && (t[i[0]].visibleSymbols[i[1]].renderable = !1, t[i[0]].visibleSymbols[i[1]].isSticky = !0)
                                    }))
                                },
                                show() {
                                    var s = arguments;
                                    return (0, o.Z)((function*() {
                                        var o = s.length > 0 && void 0 !== s[0] ? s[0] : "normal",
                                            h = Lt.store.get("overlayWilds"),
                                            d = Lt.config.get("slot.layout.default"),
                                            c = 0;
                                        h && h.length > 0 && h.forEach((s => {
                                            var h = Lt.config.get("slot.size[0]") * s[1] + s[0],
                                                u = t[s[0]].visibleSymbols[s[1]];
                                            u.renderable = !1, u.isSticky = !0;
                                            var p = d[s[2]].assetName.slice(0, d[s[2]].assetName.length - 5);
                                            if (!(i.indexOf(h) >= 0)) {
                                                var g = d.find((t => t.animation && t.animation.idle && t.assetName === p));
                                                if (g) {
                                                    c = 1e3, i.push(h);
                                                    var m = i.sort(r).indexOf(h),
                                                        A = new js(Lt.loader.getAsset(g.animation.assetName));
                                                    A.reelIndex = s[0], A.index = h, A.changeSkin(p), A.position.set(u.x, u.y), A.play(l(), !0);
                                                    var b = new $.j(Lt.loader.getAsset("paytable", d[s[2]].assetName));
                                                    b.position.set(u.x, u.y), b.index = h, b.visible = !1, e.stickyWildLayout.addChild(b);
                                                    var v = new js(Lt.loader.getAsset("stickyTransform"));
                                                    v.index = h, v.position.set(u.x, u.y), "normal" === o && Lt.action.emit("stickyChain"), v.play("transform").then((() => {
                                                        v.play("idle", !0)
                                                    })), n.addChildAt(A, m), a.addChild(v)
                                                }
                                            }
                                        })), yield Lt.delay(c)
                                    }))()
                                ...
                                checkReel() {
                                    if ("freespins2" === Lt.store.get("reward:currentFeature")) {
                                        var t = [0, 0, 0, 0, 0];
                                        n.children.forEach((e => {
                                            ++t[e.reelIndex]
                                        }));
                                        var e = t.map((t => 3 === t ? 1 : 0));
                                        Lt.store.set("stickyArr", e)
                                    }
                                },
                                showRespin: (t, i, s) => (0, o.Z)((function*() {
                                    var o = Lt.store.get("wildReels"),
                                        n = Lt.store.get("isRespin"),
                                        a = 0;
                                    n && o.forEach((o => {
                                        if (void 0 === h.children.find((t => t.index === o)) && o === i) {
                                            var n = new js(Lt.loader.getAsset("soldierEffect")),
                                                r = new $.j(Lt.loader.getAsset("paytable", "soldier-wild-x3"));
                                            s.forEach((t => {
                                                t.renderable = t.reelIndex !== i
                                            })), Lt.action.emit("stickySwat"), t.visibleSymbols.forEach((i => {
                                                if ("soldier" === i._texture.textureCacheIds[0]) {
                                                    var s = i;
                                                    h.addChild(n), n.position.set(s.x, 626), n.changeSkin("soldier"), n.play("expand-x3").then((() => {
                                                        n.play("idle-x3-2")
                                                    })), n.index = o, n.isNew = !0, a = 800, r.position.set(s.x, -30), e.stickyWildReelLayout.addChild(r), t.renderable = !1, t.isWild = !0, t.children.forEach((t => {
                                                        t.renderable = !1, t.isSticky = !0
                                                    })), setTimeout((() => {
                                                        var t = Lt.store.get("stickyArr");
                                                        t[o] = 1, Lt.store.set("stickyArr", t)
                                                    }), 100)
                                                }
                                            }))
                                        }
                                    })), yield Lt.delay(a), Lt.store.set("initResipn", !0)
                                }))(),
                                respinInit(t) {
                                    var i = Lt.store.get("wildReels", []);
                                    i.length < 1 || (i.forEach((i => {
                                        var s = new js(Lt.loader.getAsset("soldierEffect")),
                                            o = new $.j(Lt.loader.getAsset("paytable", "soldier-wild-x3")),
                                            n = t[i],
                                            a = t[i].visibleSymbols[0];
                                        h.addChild(s), s.position.set(a.x, 626), s.changeSkin("soldier"), s.play("expand-x3").then((() => {
                                            s.play("idle-x3-2")
                                        })), s.index = i, o.position.set(a.x, -30), e.stickyWildReelLayout.addChild(o);
                                        var r = Lt.store.get("stickyArr");
                                        r[i] = 1, Lt.store.set("stickyArr", r), n.renderable = !1, n.isWild = !0, n.children.forEach((t => {
                                            t.renderable = !1, t.isSticky = !0
                                        }))
                                    })), Lt.store.set("initResipn", !0))
                                },
                                onStart() {
                                    h.length < 1 || h.children.forEach((t => {
                                        t.isNew || (t.isNew = !0, t.play("spin-x3").then((() => {
                                            t.play("idle-x3-2")
                                        })))
                                    }))
                                },
                                hideRespin(t) {
                                    var i = Lt.store.get("isRespin");
                                    h.children.forEach((t => {
                                        t.isNew = !1
                                    })), i || (Lt.store.set("initResipn", !1), Lt.store.set("stickyArr", [0, 0, 0, 0, 0]), t.forEach((t => {
                                        t.renderable = !0, t.isWild = !1, t.children.forEach((t => {
                                            t.renderable = !0, t.isSticky = !1
                                        }))
                                    })), h.removeChildren(), e.stickyWildReelLayout.removeChildren())
                                },
                                hide() {
                                    n.removeChildren(), a.removeChildren(), e.stickyWildLayout.removeChildren(), e.stickyWildReelLayout.removeChildren(), i = []
                                },
                                checkWin(t) {
                                    h.children.forEach((t => {
                                        t.win = !1
                                        ...
                                        t.win = !1
                                    })), Lt.store.get("reward:lines", []).forEach((t => {
                                        t.pos.forEach(((t, e) => {
                                            if (-1 !== t) {
                                                var i = Lt.config.get("slot.size[0]") * t + e,
                                                    s = h.children.find((t => t.index === e)),
                                                    o = n.children.find((t => t.index === i)),
                                                    r = a.children.find((t => t.index === i));
                                                s && (s.win = !0), o && (o.win = !0, r.win = !0)
                                            }
                                        }))
                                    })), h.children.forEach((t => {
                                        t.win ? (t.play("win-wild").then((() => {
                                            t.play("idle-x3-2", !0)
                                        })), t.win = !1) : t.renderable = !1
                                    })), n.children.forEach((t => {
                                        t.win ? t.play("win-wild").then((() => {
                                            t.play(l(), !0)
                                        })) : t.renderable = !1
                                    })), a.children.forEach((t => {
                                        t.win || (t.renderable = !1)
                                    }));
                                    for (var e = 0; e < t.pos.length; e++)
                                        if (-1 !== t.pos[e]) {
                                            var i = t.pos[e],
                                                s = Lt.config.get("slot.size[0]") * i + e;
                                            this.hideWinLayoutSymbols(s)
                                        }
                                },
                                stopAnimation() {
                                    h.children.forEach((t => {
                                ...
                                hideWinLayoutSymbols() {
                                    n.children.forEach((t => {
                                        e.stickyWildLayout.children.forEach((e => {
                                            t.renderable || t.index !== e.index || (e.visible = !0)
                                        }))
                                    }))
                                },
                                hideLayoutSymbols() {
                                    e.stickyWildLayout.children.forEach((t => {
                                        t.visible = !1
                                    }))
                                }
                            }
                        }(this.reels, this), this.addChild(this.reelsContainer), this.addChild(this.stickyWildLayout), this.addChild(this.stickyWildReelLayout), this.addChild(this.lines), this.addChild(an()), this.addChild(this.staticAnimation.container), this.addChild(this.stickyWild.container), this.addChild(this.textLineWin.container), this.addChild(this.textTotalWin), this.addChild(this.textFreeLeft.container), this.addChild(this.textExtraFree)
                    }
                    setupEvents() {
                        this.game.action.on("state:ready_enter", this._onReadyEnter, this), this.game.action.on("state:spin_enter", this._onSpinEnter, this), this.game.action.on("state:stop_enter", this._onStopEnter, this), this.game.action.on("free:start", (() => {
                            this.animation.stop(), this.staticAnimation.hide(this.reels), this.reels.forEach(((t, e) => {
                            ...
                            }), this.animation.stop(), this.stickyWild.hide(), this.stickyWild.hideRespin(this.reels), this.staticAnimation.hide(this.reels), this.staticAnimation.runStatic(this.reels)
                        })), this.game.action.on("free:select_start", (() => {
                            k.fromTo(this, .5, {
                                pixi: {
                                    alpha: 0
                    ...
                    restoreFreeSpins() {
                        this.alpha = 0, this.stickyWild.respinInit(this.reels), this.stickyWild.show("init")
                    }
                    runStaticAnimation() {
                    ...
                    _onReadyEnter() {
                        var t = this.game.autoPlay.enabled;
                        if (zi.isFreespin()) {
                            var e = this.game.store.get("free:isStart", !1) ? Ui.get("beforeFreeSpins") : Ui.get("inFreeSpins");
                            setTimeout((() => {
                                this.game.action.emit("spin:start")
                            }), e)
                        } else t && setTimeout((() => {
                            this.game.action.emit("spin:start")
                        }), Ui.get("before_spin_auto"))
                    }
                    updateFreeLeft() {
                        var t = this;
                        return (0, o.Z)((function*() {
                            var e = t.game.store.get("isRespin");
                            if ("freespin" === t.game.store.get("reward:feature")) {
                                var i = e ? t.game.store.get("free:left", 0) : t.game.store.get("free:left", 0) - 1;
                                t.game.action.emit("free:updateLeft", i), yield t.textFreeLeft.show(i)
                            }
                        }))()
                    }
                    _onSpinEnter() {
                        var t = this;
                        return (0, o.Z)((function*() {
                            t.stickyWild.hideRespin(t.reels), t.animation.stop(), t.staticAnimation.hide(t.reels), t.stickyWild.onStart(), t.stickyWild.checkReel();
                            try {
                    ...
                    _onFinishEnter() {
                        ...
                        return (0, o.Z)((function*() {
                            ...
                            t.stopReelCounter = 0, zi.set(t.game.store.get("reward:feature")), t.game.store.get("free:isFree", !1) || (yield t.game.freeRound.finish()), e ? t.game.checkBalance().then((() => {
                        ...
                        return (0, o.Z)((function*() {
                            try {
                                if (!e.game.store.get("spin:isFast", !1)) {
                                    var i = e.game.store.get("reward:reels", [])[t],
                                        s = i.indexOf(0),
                                        o = i.indexOf(14);
                                    (s > -1 || o > -1) && e.game.action.emit("sound:scatterReel")
                                }
                                e.stickyWild.hideSymbols(t), yield e.stickyWild.showRespin(e.reels[t], t, e.staticAnimation.container.children), e.staticAnimation.onStop(e.reels[t], t), e.stopReelCounter++, e.stopReelCounter >= e.reels.length && (e.game.afterReelsStop(), e.game.state.goTo("reward"))
                            } catch (t) {
                    ...
                    _onResetReward() {
                        this.animation.stop(), this.staticAnimation.runStatic(this.reels)
                    }
                    beforeFreeSpinsPopup() {
                        k.fromTo(this, .5, {
                            pixi: {
                    ...
                    resize() {
                        var t;
                        this.game.device.desktop || this.game.device.landscape ? (this.scale.set(.98), this.position.set(940, 70), this.textTotalWin.scale.set(1), this.textTotalWin.x = null !== (t = this.game.leftHand) && void 0 !== t && t.enabled ? 1380 : -180) : (this.scale.set(1.45 * .5625), this.position.set(520.3125, 303.75), this.textTotalWin.scale.set(1.5), this.textTotalWin.x = 620)
                    }
                }
                class An extends(Vt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "timeline", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "value", void 0), (0, n.Z)(this, "light", void 0), (0, n.Z)(this, "coins", void 0), (0, n.Z)(this, "onPress", void 0), this.visible = !1, this.interactive = !0, this.onPress = new(S()), this.game.interaction.click(this, (() => this.onPress.dispatch())), this.timeline = new C, this.content = new H.W2, this.overlay = new u.TC, this.overlay.beginFill(0, .75), this.overlay.drawRect(0, 0, 1920, 1080), this.overlay.endFill(), this.title = new $.j, this.title.anchor.set(.5), this.value = new b.Xz("", {
                            fontName: "WinFont"
                        }), this.value.anchor = .5, this.light = new js(this.game.loader.getAsset("backgroundAnimation")), this.light.pivot.set(100, this.game.config.get("application.height")), this.light.alpha = 0, this.coins = new js(this.game.loader.getAsset("backgroundAnimation")), this.coins.pivot.set(0, this.game.config.get("application.height")), this.coins.alpha = 0, this.content.addChild(this.title), this.content.addChild(this.value), this.addChild(this.overlay), this.addChild(this.light), this.addChild(this.coins), this.addChild(this.content)
                    }
                    show(t, e) {
                        var i = this;
                        return (0, o.Z)((function*() {
                            var s = 0;
                            t === fe ? (s = 8, i.game.action.emit("sound:bigWin")) : t === we && (s = 16, i.game.action.emit("sound:giantWin")), i.title.texture = i.game.loader.getAsset("textBigWin");
                            var o = !1;
                            ...
                            return new Promise((a => {
                                ...
                                i.timeline.to(i, .35, {
                                    ...
                                    roundProps: ["coins"],
                                    onStart: () => {
                                        i.light.play("win-big", !0), i.light.alpha = 1
                                    },
                                    onUpdate: () => {
                                        !o && t === we && h.coins > e / 2 && (i.title.texture = i.game.loader.getAsset("textGiantWin"), o = !0, i.coins.play("win-giant", !0), i.coins.alpha = 1, k.to(i.value, s / 2, {
                                            pixi: {
                                                scale: n + .2
                                            }
                ...
                new class extends class extends class extends class {
                    ...
                    initPopups() {
                        this.popupManager.add([new Ei, new Bi, new Pi, new xi, new Ri, new Ci, new _i, new Fi, new Ti, new ki, new Oi])
                    }
                    loadAssets(t) {
                    ...
                    initModules(t) {
                        ...
                        this.wallet = new Je(this.server), this.betLevel = new Mt(null == o ? void 0 : o.bet, null == o ? void 0 : o.bets, null !== (e = null == o ? void 0 : o.betCoins) && void 0 !== e ? e : 1), this.autoPlay = new He({
                    ...
                    constructor() {
                        super({}), (0, n.Z)(this, "_isFreeEnd", void 0), (0, n.Z)(this, "autoPlaySettings", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "betSettings", void 0), (0, n.Z)(this, "bigWinAnimation", void 0), (0, n.Z)(this, "fastStopLayout", void 0), (0, n.Z)(this, "freeOverlay", void 0), (0, n.Z)(this, "gameRules", void 0), (0, n.Z)(this, "menu", void 0), (0, n.Z)(this, "paytable", void 0), (0, n.Z)(this, "slot", void 0), Xi.init(), this.init(Ii, Li)
                    }
                    loadTranslations() {
                    ...
                    initViews() {
                        var t, e, i = this;
                        super.initViews(), this.background = this.rootNode.addChild(new gs), this.slot = this.rootNode.addChild(new mn), this.riskFeature = this.rootNode.addChild(new Yo), this.paytable = new Fo(null !== (t = null === (e = this.server) || void 0 === e ? void 0 : e.response.lines) && void 0 !== t ? t : []), this.gameSettings = new Ue, this.config.get("quickSpin.available", !0) && this.gameSettings.addItem(this.createQuickSpinCheckbox()), this.gameSettings.addItem(this.createFullscreenCheckbox()), this.gameSettings.addItem(this.createLeftHandCheckbox()), this.gameSettings.addItem(this.createGameSoundsCheckbox()), this.gameSettings.addItem(this.createBackgroundSoundsCheckbox()), this.gameSettings.addItem(this.createRiskFeatureCheckbox()), this.bigWinAnimation = new An, this.fastStopLayout = new Ee, this.controls = this.device.desktop ? new to : new uo, this.betSettings = this.rootNode.addChild(new Te), this.betSettings.setBets(this.betLevel.bets, this.betLevel.betCoins), this.betSettings.setPayLines(15), this.betSettings.setBet(this.betLevel.bet), this.autoPlaySettings = this.rootNode.addChild(new de), this.autoPlaySettings.setAutoPlayCounts(this.autoPlay.counts), this.autoPlaySettings.stopSection.addItem(new xe), this.autoPlaySettings.stopSection.addItem(new ve), this.autoPlaySettings.stopSection.addItem(new Ae), this.autoPlaySettings.stopSection.addItem(new be), this.gameRules = new Ne, this.menu = new Ge, this.menu.addItem(this.loader.getAsset("iconPaytable"), this.paytable), this.menu.addItem(this.loader.getAsset("iconSettings"), this.gameSettings), this.menu.addItem(this.loader.getAsset("iconRules"), this.gameRules), this.rootNode.addChild(this.fastStopLayout), this.rootNode.addChild(this.menu), this.rootNode.addChild(this.controls), this.rootNode.addChild(this.bigWinAnimation), this.freeOverlay = this.rootNode.addChild(new po), this.paytable.updateBet(this.betLevel), this.controls.updateBet(this.betLevel), this.betSettings.on("open", (() => {
                            ...
                            if (i.action.emit("sound:click"), i.onPopupShow(), yield i.riskFeature.playFeatureButton(), i.riskFeature.hide(), i.wallet.balance - i.store.get("buy").bet < 0) yield i.popupManager.show("PopupZeroBalance"), i.onPopupHide();
                            else {
                                ...
                                try {
                                    if (s) {
                                        ...
                                        }), zi.set(i.store.get("reward:feature", ji.Basic)), i.onRNBStart();
                    ...
                    start() {
                        ...
                        return (0, o.Z)((function*() {
                            var i;
                            if (t().call(e), zi.set(e.store.get("reward:feature", ji.Basic)), yield e.freeRound.start(), null === (i = e.sound.get("backgroundNormal")) || void 0 === i || i.fade(2), e.state.goTo("setup"), zi.isFreespin()) {
                    ...
                    reward() {
                        ...
                        return (0, o.Z)((function*() {
                            var o;
                            e(), yield t.slot.stickyWild.show(), t.slot.animation.beforeStart(), null !== (o = t.bigWin) && void 0 !== o && o.available(t.wallet.coins) && (t.bigWinAnimation.press(i), t.controls.pressButtonSpin(i), yield t.bigWinAnimation.show(t.bigWin.type(t.wallet.coins), t.wallet.coins), t.sound.stopBigWin(), e());
                            var n = t.store.get("reward:lines", []),
                                a = t.store.get("reward:scatters", !1),
                                h = t.store.get("free:freespins", []);
                            if ((n.length > 0 || t.wallet.scatterCoins) && (t.controls.disableButtonSpin(), a && n.unshift(a), t.slot.textTotalWin.once("show", (() => {
                                ...
                                })), yield t.slot.animation.allPayment(n), e()), a && a.n > 2 && (t.controls.disableButtonSpin(), yield t.slot.animation.scatterPayment(a)), h.pos && h.pos.length > 0 && (t.controls.disableButtonSpin(), yield t.slot.animation.freeSymbolsReward(h.pos)), t._isFreeEnd = t.store.get("isRespin") ? t.store.set("free:isEnd", !1) : t.store.get("free:isEnd", !1), t.store.get("free:isStart", !1)) {
                                var r = t.store.get("free:left", 0);
                                t.action.emit("free:updateLeft", r), t.beforeFreeSpinsPopup(), yield t.freeOverlay.show(ao.START)
                            } else t._isFreeEnd && (yield t.delay(Ui.get("free_end")), t.beforeFreeSpinsPopup(), yield t.freeOverlay.show(ao.END), yield t.delay(200), t.store.set("free:end", 1));
                            t.slot.animation.complete(), t.slot.stickyWild.stopAnimation(), t.action.emit("update:balance"), t.state.goTo("finish")
                        }))
                    }
                    checkBalance() {
                        var t = this;
    ...
    n.m = s, t = [], n.O = (e, i, s, o) => {
    ...
    }), t), n.o = (t, e) => Object.prototype.hasOwnProperty.call(t, e), e = {}, i = "riot:", n.l = (t, s, o, a) => {
        if (e[t]) e[t].push(s);
        else {
            var h, r;
            if (void 0 !== o)
        ...
        var e = (e, i) => {
            ...
            i = self.webpackChunkriot = self.webpackChunkriot || [];
        i.forEach(e.bind(null, 0)), i.push = e.bind(null, i.push.bind(i))
    })();
    var a = n.O(void 0, [216], (() => n(7258)));
    a = n.O(a)
})();