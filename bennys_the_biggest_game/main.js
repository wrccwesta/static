...
(() => {
            ...
            1045: (t, e, i) => {
                ...
                class y {
                    ...
                    static loadFromBuffer(t) {
                        var e, i, s, o, n, a, h, r, l, c, d, u, p, g, m, A, v, b, f, w = null !== (e = null === (i = t.metadata) || void 0 === i || null === (s = i.font) || void 0 === s ? void 0 : s.family) && void 0 !== e ? e : t.name;
                        ...
                        }, null === (m = t.metadata) || void 0 === m || null === (A = m.font) || void 0 === A ? void 0 : A.testString, null !== (v = null === (b = t.metadata) || void 0 === b || null === (f = b.font) || void 0 === f ? void 0 : f.timeout) && void 0 !== v ? v : t.timeout)
                    }
                }(0, n.Z)(y, "extension", d.n.Loader), (0, n.Z)(y, "supportedFontExtensions", ["ttf", "otf", "woff", "woff2"]), (0, n.Z)(y, "waitFont", function() {
                ...
                }(0, n.Z)(_, "extension", d.n.Loader), (0, n.Z)(_, "supportedSoundExtensions", ["mp3"]);
                i(1293);
                var R, M = i(9534),
                    W = i(1162),
                    I = i(4022),
                ...
                class z {
                    ...
                    readSkeletonData(t, e) {
                        var i = e.skeleton.spine,
                            s = N(i),
                            o = null;
                        if (s === R.VER37 && (o = new I.SkeletonJson(new I.AtlasAttachmentLoader(t))), s === R.VER38 && (o = new D.SkeletonJson(new D.AtlasAttachmentLoader(t))), s !== R.VER40 && s !== R.VER41 || (o = new L.SkeletonJson(new L.AtlasAttachmentLoader(t))), !o) {
                ...
                var G = i(512),
                    ...
                    et = i(798),
                    it = i(5277);
                u.TC.nextRoundedRectBehavior = !0, A.xv.nextLineHeightBehavior = !0, d.R.add(p.bx, g.B9, c.Bv, a.c, h.Q, r.T, l.O, v.vl, m.o, V, y, _), window.PIXI = s;
                var st = i(3233),
                    ot = i.n(st);
                ...
                class Te extends A.xv {
                    ...
                    deleteTagStyle(t) {
                        "default" === t ? this.textStyles.default = this.assign({}, Te.DEFAULT_TAG_STYLE) : delete this.textStyles[t], this.withPrivateMembers()._style = new A.pn(this.textStyles.default), this.withPrivateMembers().dirty = !0
                    }
                    getTagRegex(t, e) {
                            ...
                            if (0 === r.length) h.push(this.createTextData(t[a], o[o.length - 1], n[n.length - 1]));
                                ...
                                for (var c = 0, d = 0; d < r.length; d++) {
                                    if (r[d].index > c && h.push(this.createTextData(t[a].substring(c, r[d].index), o[o.length - 1], n[n.length - 1])), "/" === r[d][0][1]) o.length > 1 && (o.pop(), n.pop());
                                        ...
                                        if (m === Be && r[d][0].includes("=") && this.textStyles[r[d][1]]) ! function() {
                        ...
                        if (this.withPrivateMembers().dirty) {
                            ...
                            for (var i = e.split(/(?:\r\n|\r|\n)/), s = this._getTextDataPerLine(i), o = [], n = [], a = [], h = 0, r = 0; r < i.length; r++) {
                                for (var l = 0, c = 0, d = 0, u = 0; u < s[r].length; u++) {
                                    var p = s[r][u].style;
                                    this.context.font = this.getFontString(p), s[r][u].width = this.context.measureText(s[r][u].text).width, 0 !== s[r][u].text.length && (s[r][u].width += (s[r][u].text.length - 1) * p.letterSpacing, u > 0 && (l += p.letterSpacing / 2), u < s[r].length - 1 && (l += p.letterSpacing / 2)), l += s[r][u].width, s[r][u].fontProperties = A._A.measureFont(this.context.font), s[r][u].height = s[r][u].fontProperties.fontSize, "number" == typeof p.valign ? (c = Math.min(c, p.valign - s[r][u].fontProperties.descent), d = Math.max(d, p.valign + s[r][u].fontProperties.ascent)) : (c = Math.min(c, -s[r][u].fontProperties.descent), d = Math.max(d, s[r][u].fontProperties.ascent))
                                }
                                    ...
                                    if (0 === C.letterSpacing) f.push({
                                        ...
                                        for (var Z = 0; Z < B.length; Z++) {
                                            ...
                                            f.push({
                                                ...
                                                descent: P.descent,
                                                tag: F
                                            }), S += _, (Z < B.length - 1 || k < x.length - 1) && (S += C.letterSpacing / 2)
                                        }
                                    }
                                }
                                y += a[w] - n[w]
                            ...
                            })), Te.debugOptions.objects.enabled && (Te.debugOptions.objects.bounding && (this.context.fillStyle = Te.debugOptions.objects.bounding, this.context.beginPath(), this.context.rect(0, 0, v, b), this.context.fill()), Te.debugOptions.objects.text && (this.context.fillStyle = "#ffffff", this.context.strokeStyle = "#000000", this.context.lineWidth = 2, this.context.font = "8px monospace", this.context.strokeText("".concat(v.toFixed(2), "x").concat(b.toFixed(2)), 0, 8, v), this.context.fillText("".concat(v.toFixed(2), "x").concat(b.toFixed(2)), 0, 8, v))), this.updateTexture()
                        }
                    }
                    wordWrap(t) {
                        var e = "",
                ...
                class Ue extends(Vt(Q.W2)) {
                    ...
                    addSections() {
                        this.content.addChild(new Ie), this.content.addChild(new Le), this.content.addChild(new je), this.addAutoPlaySection(), this.content.addChild(new We), this.content.addChild(new Me), this.content.addChild(new Ne)
                    }
                    addAutoPlaySection() {
                        this.game.config.get("autoPlay.available", !0) && (this.content.addChild(new Re), this.content.addChild(new _e))
                    }
                    open() {
                ...
                class He extends(Vt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "Menu"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "contentItems", void 0), (0, n.Z)(this, "bottom", void 0), (0, n.Z)(this, "items", void 0), (0, n.Z)(this, "homeButton", void 0), (0, n.Z)(this, "closeButton", void 0), (0, n.Z)(this, "bottomBackgroundTexture", void 0), (0, n.Z)(this, "bottomBackgroundMobileTexture", void 0), (0, n.Z)(this, "spaceKey", void 0), (0, n.Z)(this, "currentIndex", 0), (0, n.Z)(this, "onClickHome", void 0), (0, n.Z)(this, "onClickClose", void 0), this.visible = !1, this.interactive = !0, this.bottomBackgroundTexture = c.xE.from(Ht), this.bottomBackgroundMobileTexture = c.xE.from(Qt), this.overlay = this.addChild(new Jt), this.contentItems = this.addChild(new Q.W2), this.bottom = this.addChild(new $.j(this.bottomBackgroundMobileTexture)), this.items = this.addChild(new Q.W2), this.homeButton = this.addChild(new Ve), this.closeButton = this.addChild(new Kt), this.closeButton.onClick.add((() => this.close())), this.spaceKey = this.game.keyboard.register(this.game.keyboard.KEY_CODE.Escape), this.spaceKey.onPress.add(this.close, this), this.spaceKey.disable()
                    }
                    get opened() {
                        return this.visible
                    }
                ...
                const ki = class extends It {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupFreeRound"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "icon", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContinue", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt, this.content = new Q.W2, this.icon = new yi(pi), this.icon.anchor.x = .5, this.title = new Si(this.game.i18n.t("PopupFreeRoundStartTitle")), this.title.anchor.x = .5, this.message = new wi("", {
                            wordWrap: !0,
                            wordWrapWidth: 600
                ...
                const Ci = class extends It {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupMaxLimit"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContinue", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt(.7), this.content = new Q.W2, this.background = new $.j(this.game.loader.getAsset(Ai)), this.background.anchor.set(.5), this.background.interactive = !0, this.background.name = "PopupBackground", this.title = new Si(this.game.i18n.t("PopupMaxLimitTitle")), this.title.anchor.x = .5, this.message = new wi(this.game.i18n.t("PopupMaxLimitMessage"), {
                            wordWrap: !0
                ...
                const Bi = class extends It {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupNetworkError"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "icon", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionReload", void 0), (0, n.Z)(this, "_resolver", null), this.overlay = this.addChild(new Jt), this.content = this.addChild(new Q.W2), this.icon = new yi(gi), this.icon.anchor.x = .5, this.title = new Si(this.game.i18n.t("PopupNetworkErrorTitle"), {
                            align: "center"
                ...
                class Pi extends It {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupQuickSpin"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionEnable", void 0), (0, n.Z)(this, "actionClose", void 0), (0, n.Z)(this, "escKey", void 0), (0, n.Z)(this, "enterKey", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt(.7), this.content = new Q.W2, this.background = new $.j(this.game.loader.getAsset(Ai)), this.background.anchor.set(.5), this.background.interactive = !0, this.background.name = "PopupBackground", this.title = new Si(this.game.i18n.t("PopupQuickSpinTitle")), this.title.anchor.x = .5, this.message = new wi(this.game.i18n.t("PopupQuickSpinMessage"), {
                            fontSize: 35,
                            wordWrap: !0,
                            wordWrapWidth: 600
                ...
                const Ti = class extends It {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupRestore"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "icon", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContinue", void 0), (0, n.Z)(this, "resolver", null), this.overlay = this.addChild(new Jt), this.content = this.addChild(new Q.W2), this.icon = new yi(pi), this.icon.anchor.x = .5, this.message = new wi(this.game.i18n.t("PopupRestoreMessage"), {
                            wordWrap: !0,
                            wordWrapWidth: 320
                        }), this.message.anchor.x = .5, this.actionContinue = new bi(this.game.i18n.t("PopupActionContinue"), {
                            fill: 16777215
                ...
                const Ei = class extends It {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupRiskNBuy"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionYes", void 0), (0, n.Z)(this, "actionNo", void 0), (0, n.Z)(this, "escKey", void 0), (0, n.Z)(this, "enterKey", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt(.7), this.content = new Q.W2, this.background = new $.j(this.game.loader.getAsset(Ai)), this.background.anchor.set(.5), this.background.interactive = !0, this.background.name = "PopupBackground", this.title = new Si("RISK FEATURE"), this.title.anchor.x = .5, this.message = new wi("", {
                            wordWrap: !0,
                            whiteSpace: "normal",
                            breakWords: !0
                ...
                const Fi = class extends It {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupSound"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "icon", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContainer", void 0), (0, n.Z)(this, "actionYes", void 0), (0, n.Z)(this, "actionNo", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt, this.content = new Q.W2, this.icon = new yi(mi), this.icon.anchor.x = .5, this.message = new wi(this.game.i18n.t("PopupSoundMessage"), {
                            wordWrap: !0
                ...
                const Oi = class extends It {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupSpendingBudget"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContinue", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt(.7), this.content = new Q.W2, this.background = new $.j(this.game.loader.getAsset(Ai)), this.background.anchor.set(.5), this.background.interactive = !0, this.background.name = "PopupBackground", this.title = new Si(this.game.i18n.t("PopupSpendingBudgetTitle")), this.title.anchor.x = .5, this.message = new wi(this.game.i18n.t("PopupSpendingBudgetMessage"), {
                            wordWrap: !0
                        }), this.message.anchor.x = .5, this.actionContinue = new bi(this.game.i18n.t("PopupActionContinue"), {
                            fill: 10066329
                        }), this.actionContinue.anchor.x = .5, this.game.interaction.out(this.actionContinue, (() => this.actionContinue.style.fill = 10066329)), this.game.interaction.hover(this.actionContinue, (() => this.actionContinue.style.fill = 16777215)), this.game.interaction.click(this.actionContinue, (() => this.hide())), this.content.addChild(this.title), this.content.addChild(this.message), this.content.addChild(this.actionContinue), this.addChild(this.overlay), this.addChild(this.background), this.addChild(this.content)
                ...
                class _i extends It {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupWilds"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionEnable", void 0), (0, n.Z)(this, "actionClose", void 0), (0, n.Z)(this, "escKey", void 0), (0, n.Z)(this, "spaceKey", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt(.7), this.content = new Q.W2, this.background = new $.j(this.game.loader.getAsset(Ai)), this.background.anchor.set(.5), this.background.interactive = !0, this.background.name = "PopupBackground", this.title = new Si(this.game.i18n.t("PopupWildsTitle"), {
                            fontSize: 40,
                            wordWrap: !0,
                            wordWrapWidth: 600,
                ...
                const Ri = class extends It {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupZeroBalance"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContinue", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt(.7), this.content = new Q.W2, this.background = new $.j(this.game.loader.getAsset(Ai)), this.background.anchor.set(.5), this.background.interactive = !0, this.background.name = "PopupBackground", this.title = new Si(this.game.i18n.t("PopupZeroBalanceTitle")), this.title.anchor.x = .5, this.message = new wi(this.game.i18n.t("PopupZeroBalanceMessage"), {
                            wordWrap: !0
                        }), this.message.anchor.x = .5, this.actionContinue = new bi(this.game.i18n.t("PopupActionContinue"), {
                            fill: 10066329
                        }), this.actionContinue.anchor.x = .5, this.game.interaction.out(this.actionContinue, (() => this.actionContinue.style.fill = 10066329)), this.game.interaction.hover(this.actionContinue, (() => this.actionContinue.style.fill = 16777215)), this.game.interaction.click(this.actionContinue, (() => this.hide())), this.content.addChild(this.title), this.content.addChild(this.message), this.content.addChild(this.actionContinue), this.addChild(this.overlay), this.addChild(this.background), this.addChild(this.content)
                ...
                const Li = [...[{
                    ...
                    url: "assets/audio/winFree.mp3",
                    name: "winFree",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"],
                        audioMetadata: {
                            type: "effects",
                            volume: Di.get("win_free"),
                            loop: !1
                        }
                    }
                }, {
                    ...
                    url: "assets/audio/grave_scatter_win2.mp3",
                    name: "scatterWinGrave",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"],
                        audioMetadata: {
                            type: "effects",
                    ...
                    url: "assets/audio/grave_scatter_on_wheel.mp3",
                    name: "scatterReelGrave",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"],
                        audioMetadata: {
                            type: "effects",
                    ...
                    url: "assets/audio/harp_scatter_win.mp3",
                    name: "scatterWinHarp",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"],
                        audioMetadata: {
                    ...
                    url: "assets/audio/harp_scatter_on_wheel.mp3",
                    name: "scatterReelHarp",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"],
                        audioMetadata: {
                            type: "effects",
                    ...
                    url: "assets/audio/hunter_scatter_win.mp3",
                    name: "scatterWinHunter",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"],
                        audioMetadata: {
                            type: "effects",
                    ...
                    url: "assets/audio/hunter_scatter_on_wheel.mp3",
                    name: "scatterReelHunter",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"],
                        audioMetadata: {
                            type: "effects",
                    ...
                    metadata: {
                        ...
                        audioMetadata: {
                            type: "effects",
                            volume: Di.get("wild_freespin"),
                            loop: !1
                        }
                    }
                }, {
                    url: "assets/audio/hunter_bonus_loss.mp3",
                    name: "bonusLoss",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"],
                        audioMetadata: {
                    ...
                    url: "assets/audio/hunter_bonus_pick.mp3",
                    name: "bonusPick",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"],
                        audioMetadata: {
                    ...
                    url: "assets/audio/hunter_bonus_score.mp3",
                    name: "bonusScore",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"],
                        audioMetadata: {
                    ...
                    url: "assets/audio/hunter_bonus_win.mp3",
                    name: "bonusWin",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"],
                        audioMetadata: {
                    ...
                    url: "assets/images/bonusMultiplierText.png",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/bonusTotalWInText.png",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    ...
                    url: "assets/bitmapFont/smallFont.xml",
                    name: "SmallFont",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                    ...
                    url: "assets/images/win_bg.png",
                    name: "winBg",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/win_box_fs.png",
                    name: "winBgFree",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/win_shot.png",
                    name: "lineWinBg",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/winbox_multiplier.png",
                    name: "multiplierBg",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/textBonusWin.png",
                    name: "textBonusWin",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                    ...
                    url: "assets/images/effects/bg-grass/skeleton.json",
                    name: "bgEffect",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/effects/symbols/sym-circled-normal/skeleton.json",
                    name: "circledSymEffect",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/effects/symbols/sym-fs/skeleton.json",
                    name: "fsEffect",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/effects/bonus-shoot/skeleton.json",
                    name: "bonusEffect",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                    ...
                    url: "assets/images/paytable/bonus.jpg",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                ...
                const Ni = {
                    ...
                    slot: {
                        ...
                        layout: {
                            default: [{}, {
                                textureAtlas: "symbols_static",
                                assetName: "wild_normal_mask",
                                hasFrame: !1,
                                animation: {
                                    assetName: "circledSymEffect",
                                    effectName: "win",
                                    skin: "wild_normal_mask"
                                }
                            }, {
                                textureAtlas: "symbols_static",
                                assetName: "lion",
                                ...
                                textureAtlas: "symbols_static",
                                assetName: "scatter_pay_drum",
                                hasFrame: !1,
                                animation: {
                                    assetName: "circledSymEffect",
                                    effectName: "win",
                                    skin: "scatter_pay_drum"
                                }
                            }, {
                                textureAtlas: "symbols_static",
                                assetName: "scatter_normal_free",
                                hasFrame: !1,
                                animation: {
                                    assetName: "circledSymEffect",
                                    skin: "scatter_free_grave",
                                    effectName: {
                                        normal: "win",
                                        free: "win-special"
                                    }
                                ...
                                animation: {
                                    ...
                                    skin: "scatter_fs_harp"
                                }
                            }, {
                                textureAtlas: "symbols_static",
                                assetName: "devil_mouse",
                                hasFrame: !1,
                                animation: {
                                    assetName: "fsEffect",
                                    effectName: "win",
                ...
                const Vi = {
                    init() {
                        function t(t) {
                            ...
                            if (Lt.store.set("free:win", e), Lt.store.set("free:coins", ot()(t, "freespins.coins", 0)), Lt.store.set("free:left", o), Lt.store.set("free:played", n), Lt.store.set("free:count", o + n), Lt.store.set("free:isStart", 0 === n), Lt.store.set("free:isEnd", 0 === o), Lt.store.set("free:isFree", "freespin" === i), Lt.store.set("free:multiplier", ot()(t, "freespins.mul", 1)), 0 !== n) {
                                var a = o > s || o === s;
                                Lt.store.set("free:winAdditional", a), Lt.store.set("free:winAdditionalCount", ot()(t, "scatters.freespins", 0))
                            }
                        }
                        Lt.store.set("free:win", 0), Lt.store.set("free:coins", 0), Lt.store.set("free:count", 0), Lt.store.set("free:left", -1), Lt.store.set("free:played", -1), Lt.store.set("free:isStart", !1), Lt.store.set("free:isEnd", !1), Lt.store.set("free:isFree", !1), Lt.store.set("free:multiplier", 1), Lt.store.set("free:winAdditional", !1), Lt.server.on("response:init", t), Lt.server.on("response:spin", t), Lt.server.on("response:buyin", t), Lt.server.on("response:risk", t)
                    }
                };
                var Gi;
                ! function(t) {
                        ...
                        init() {
                            ...
                            function e(e) {
                                var i = ot()(e, "win", 0),
                                    s = ot()(e, "scatters", !1),
                                    o = ot()(e, "bonus", !1);
                                Lt.store.set("reward:win", i), Lt.store.set("reward:lines", ot()(e, "lines", [])), Lt.store.set("reward:reels", ot()(e, "reels", e.error ? Qi : [])), Lt.store.set("reward:nReels", ot()(e, "nReels", e.error ? Yi : [])), Lt.store.set("reward:fsReels", ot()(e, "fsReels", [])), Lt.store.set("reward:preReels", ot()(e, "preSpin.reels", [])), Lt.store.set("reward:preSpin", ot()(e, "preSpin", [])), Lt.store.set("reward:wilds", ot()(e, "wilds", [])), Lt.store.set("reward:scatters", s), Lt.store.set("reward:bonus", o), Lt.store.set("reward:isWin", i > 0 || s), Lt.store.set("reward:numberWinSymbol", ot()(e, "winSyms", 0));
                                var n = ot()(e, "feature", Gi.Basic);
                                Lt.store.set("reward:feature", n), t(e)
                            }

                            function i(e) {
                                var i = ot()(e, "win", 0);
                                Lt.store.set("reward:win", i), Lt.store.set("reward:lines", ot()(e, "lines", [])), Lt.store.set("reward:fsReels", ot()(e, "fsReels", [])), Lt.store.set("reward:reels", ot()(e, "reels", e.error ? Qi : [])), Lt.store.set("reward:nReels", ot()(e, "nReels", e.error ? Yi : []));
                                var s = ot()(e, "feature", Gi.Basic);
                                Lt.store.set("reward:feature", "basic" === s ? s : "freespin"), "freespin" === Lt.store.get("reward:feature") && Hi.set("freespin"), t(e)
                            }
                            Lt.store.set("reward:win", 0), Lt.store.set("reward:isWin", !1), Lt.store.set("reward:lines", []), Lt.store.set("reward:reels", []), Lt.store.set("reward:nReels", []), Lt.store.set("reward:fsReels", []), Lt.store.set("reward:preReels", []), Lt.store.set("reward:preSpin", []), Lt.store.set("reward:wilds", []), Lt.store.set("reward:scatters", !1), Lt.store.set("reward:bonus", !1), Lt.store.set("reward:numberWinSymbol", 0), Lt.store.set("reward:feature", ""), Lt.store.set("bonusGame:bonus", !1), Lt.store.set("isRiskNBuy", !1), Lt.store.set("risk", !1), Lt.store.set("buy", !1), Lt.server.on("response:init", e), Lt.server.on("response:spin", e), Lt.server.on("response:bonus", (t => {
                                Lt.store.set("bonusGame:bonus", t), Lt.store.set("bonusGame:balance", t.balance), Lt.store.set("bonusGame:win", t.totalWin), Lt.store.set("reward:feature", t.feature)
                            })), Lt.server.on("response:buyin", i), Lt.server.on("response:risk", i)
                        }
                    },
                    Ki = {
                        init() {
                ...
                class Ji extends Z {
                    constructor(t, e, i) {
                        super(t, e, i), (0, n.Z)(this, "backgroundFree", void 0), (0, n.Z)(this, "backgroundNormal", void 0), (0, n.Z)(this, "bigWin", void 0), (0, n.Z)(this, "bonusEnd", void 0), (0, n.Z)(this, "bonusLoss", void 0), (0, n.Z)(this, "bonusPick", void 0), (0, n.Z)(this, "bonusScore", void 0), (0, n.Z)(this, "bonusStart", void 0), (0, n.Z)(this, "bonusWin", void 0), (0, n.Z)(this, "clickNormal", void 0), (0, n.Z)(this, "currentWinSound", void 0), (0, n.Z)(this, "giantWin", void 0), (0, n.Z)(this, "scatterReelGrave", void 0), (0, n.Z)(this, "scatterReelHarp", void 0), (0, n.Z)(this, "scatterReelHunter", void 0), (0, n.Z)(this, "scatterWinGrave", void 0), (0, n.Z)(this, "scatterWinHarp", void 0), (0, n.Z)(this, "scatterWinHunter", void 0), (0, n.Z)(this, "spinFast", void 0), (0, n.Z)(this, "spinStart", void 0), (0, n.Z)(this, "wheelStop", void 0), (0, n.Z)(this, "wildFreespin", void 0), (0, n.Z)(this, "winFree1", void 0), (0, n.Z)(this, "winFree2", void 0), (0, n.Z)(this, "winFree3", void 0), (0, n.Z)(this, "winNormal1", void 0), (0, n.Z)(this, "winNormal2", void 0), (0, n.Z)(this, "winNormal3", void 0), this.backgroundNormal = this.get("backgroundNormal"), this.backgroundFree = this.get("backgroundFree"), this.bonusStart = this.get("bonusStart"), this.bonusEnd = this.get("bonusEnd"), this.winNormal1 = this.get("win_normal_1"), this.winNormal2 = this.get("win_normal_2"), this.winNormal3 = this.get("win_normal_3"), this.winFree1 = this.get("win_free_1"), this.winFree2 = this.get("win_free_2"), this.winFree3 = this.get("win_free_3"), this.bigWin = this.get("bigWin"), this.giantWin = this.get("giantWin"), this.spinStart = this.get("spinStart"), this.spinFast = this.get("spinFast"), this.clickNormal = this.get("clickNormal"), this.wheelStop = this.get("wheelStop"), this.scatterWinGrave = this.get("scatterWinGrave"), this.scatterReelGrave = this.get("scatterReelGrave"), this.scatterWinHarp = this.get("scatterWinHarp"), this.scatterReelHarp = this.get("scatterReelHarp"), this.scatterWinHunter = this.get("scatterWinHunter"), this.scatterReelHunter = this.get("scatterReelHunter"), this.wildFreespin = this.get("wildFreespin"), this.bonusLoss = this.get("bonusLoss"), this.bonusPick = this.get("bonusPick"), this.bonusScore = this.get("bonusScore"), this.bonusWin = this.get("bonusWin"), this.currentWinSound = null, this._setupEvents()
                    }
                    _setupEvents() {
                        var t = this;
                        ...
                        })), Lt.action.on("sound:scatterWin", (function() {
                            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "Grave",
                                i = t["scatterWin".concat(e)];
                            i.play()
                        })), Lt.action.on("sound:scatterWheel", (function() {
                            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "Grave",
                                i = t["scatterReel".concat(e)];
                            i.play()
                        })), Lt.action.on("state:spin_enter", this._onSpinEnter, this), Lt.action.on("sound:spinFast", this._onFastSpin, this), Lt.action.on("wheel:stop_down", this._onWheelStop, this), Lt.action.on("sound:click", this.click, this), Lt.action.on("sound:free_start", this._onFreeStart, this), Lt.action.on("sound:free_stop", this._onFreeStop, this), Lt.action.on("free:select_start", this._onSelectFreeStart, this), Lt.action.on("free:select_stop", this._onSelectFreeStop, this), Lt.action.on("bonus:hover", (() => {
                            this.bonusPick.play()
                        })), Lt.action.on("bonus:win", (() => {
                            this.bonusWin.play()
                        })), Lt.action.on("bonus:loss", (() => {
                            this.bonusLoss.play()
                        })), Lt.action.on("bonus:score", (() => {
                            this.bonusScore.play()
                        })), Lt.action.on("BackgroundMultiplier.Update", (() => {
                            this.scatterWinHarp.play()
                        }))
                    }
                    stopBigWin() {
                                ...
                                if (l) {
                                    ...
                                    if (c.visible = !0, d) {
                                        var w = r.color.r * u.r,
                                            x = r.color.g * u.g,
                                            S = r.color.b * u.b;
                                        d.setLight(o[0] * w + n[0] * (1 - w), o[1] * x + n[1] * (1 - x), o[2] * S + n[2] * (1 - S)), r.darkColor ? (w = r.darkColor.r, x = r.darkColor.g, S = r.darkColor.b) : (w = 0, x = 0, S = 0), d.setDark(o[0] * w + n[0] * (1 - w), o[1] * x + n[1] * (1 - x), o[2] * S + n[2] * (1 - S))
                                    }
                                    c.alpha = r.color.a
                                } else c.visible = !1
                            }
                ...
                class bs extends(Vt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "value", void 0), this.visible = !1, this.title = this.addChild(new Te(this.game.i18n.t("BonusTextMultiplier", this.game.i18n.currency({
                            withBrace: !0
                        })), {
                            default: {
                                align: "center",
                        ...
                        })), this.value = this.addChild(new v.Xz("x".concat(this.game.store.get("free:multiplier")), {
                            fontName: "SmallFont"
                        })), this.value.letterSpacing = -10, this.value.scale.set(1), this.value.anchor.set(.5), this.value.position.set(this.title.width / 2, this.title.y + this.title.height - 15)
                    }
                    updateMultiplier(t) {
                        this.value.text !== "x".concat(t) && (this.value.text = "x".concat(t), k.fromTo(this.value, .2, {
                            pixi: {
                                scale: 1
                            }
                        }, {
                    ...
                    hide() {
                        super.hide(), this.value.text = "x1"
                    }
                    resize() {
                        this.game.device.desktop || this.game.device.landscape ? (this.title.setTagStyle("default", {
                            wordWrapWidth: 200
                        }), this.position.set((210 - this.width) / 2, 440)) : (this.title.setTagStyle("default", {
                            wordWrapWidth: 500
                        }), this.position.set((this.game.viewport.width - this.width) / 2, 860)), this.value.position.set(this.title.width / 2, this.title.y + this.title.height - 15)
                    }
                }
                class ys extends(Vt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "backgroundLTextureFree", void 0), (0, n.Z)(this, "backgroundLTextureNormal", void 0), (0, n.Z)(this, "backgroundPTextureFree", void 0), (0, n.Z)(this, "backgroundPTextureNormal", void 0), (0, n.Z)(this, "backgroundTextureLandscape", void 0), (0, n.Z)(this, "backgroundTexturePortrait", void 0), (0, n.Z)(this, "bgAnimation", void 0), (0, n.Z)(this, "bonusTitle", void 0), (0, n.Z)(this, "featureBackground", void 0), (0, n.Z)(this, "logo", void 0), (0, n.Z)(this, "logoFs", void 0), (0, n.Z)(this, "multiplier", void 0), this.backgroundLTextureNormal = this.game.loader.getAsset("bgln"), this.backgroundLTextureFree = this.game.loader.getAsset("bglf"), this.backgroundPTextureNormal = this.game.loader.getAsset("bgpn"), this.backgroundPTextureFree = this.game.loader.getAsset("bgpf"), this.backgroundTextureLandscape = this.backgroundLTextureNormal, this.backgroundTexturePortrait = this.backgroundPTextureNormal, this.background = new $.j(this.backgroundTextureLandscape), this.background.name = "background", this.featureBackground = new $.j(this.backgroundLTextureFree), this.featureBackground.name = "featureBackground", this.featureBackground.alpha = 0, this.logo = new $.j(this.game.loader.getAsset("logo")), this.logo.name = "logo", this.logo.anchor.x = .5, this.logo.position.set(this.logo.width / 1.5, this.logo.height / 2), this.logoFs = new $.j(this.game.loader.getAsset("logo_fs")), this.logoFs.name = "logoFs", this.logoFs.anchor.x = .5, this.logoFs.position.set(this.logo.width / 1.5, this.logo.height / 2), this.logoFs.alpha = 0, this.bgAnimation = new vs(this.game.loader.getAsset("bgEffect")), this.bgAnimation.play("static_normal", !0), this.bonusTitle = new A.xv("", {
                            fill: 16771720,
                            fontSize: 34,
                            fontFamily: "Avenir-Bold",
                            aling: "center"
                        }), this.bonusTitle.text = this.game.i18n.t("BonusActionText"), this.bonusTitle.anchor.x = .5, this.bonusTitle.visible = !1, this.multiplier = new bs, this.addChild(this.background), this.addChild(this.featureBackground), this.addChild(this.bgAnimation), this.addChild(this.bonusTitle), this.addChild(this.logo), this.addChild(this.logoFs), this.addChild(this.multiplier), this.setupEvents()
                    }
                    setupEvents() {
                        this.game.action.on("state:setup_enter", (() => {
                            this.game.store.get("free:isFree", !1) && (this.bgAnimation.play("static_fs", !0), this.featureBackground.alpha = 1, this.logo.alpha = 0, this.logoFs.alpha = 1)
                        })), this.game.action.on("free:select_start", (() => {
                            this.multiplier.show(), 0 === this.featureBackground.alpha && (this.bgAnimation.play("static_fs", !0), k.fromTo(this.featureBackground, .5, {
                                pixi: {
                                    alpha: 0
                                }
                            }, {
                            ...
                            this.bgAnimation.play("static_normal", !0), k.fromTo(this.featureBackground, .5, {
                                pixi: {
                                    alpha: 1
                                }
                            }, {
                            ...
                            "bonus" === this.game.store.get("reward:feature") && (this.bonusTitle.visible = !0)
                        })), this.game.action.on("bonus:start", (() => {
                            this.bonusTitle.visible = !0
                        })), this.game.action.on("bonus:end", (() => {
                            this.bonusTitle.visible = !1
                        }))
                    }
                    updateMultiplier(t) {
                        this.multiplier.updateMultiplier(t)
                    }
                    reset() {
                        this.multiplier.hide()
                    }
                    resize() {
                        this.game.device.portrait && !this.game.device.desktop ? (this.bonusTitle.position.set(540, 1500), this.bgAnimation.visible = !1, this.featureBackground.texture = this.backgroundPTextureFree, this.featureBackground.width = 2 * this.game.viewport.paddingX + this.game.viewport.width, this.featureBackground.height = 2 * this.game.viewport.paddingY + this.game.viewport.height, this.featureBackground.position.set(-this.game.viewport.paddingX, 0), this.background.texture = this.backgroundTexturePortrait, this.background.width = 2 * this.game.viewport.paddingX + this.game.viewport.width, this.background.height = 2 * this.game.viewport.paddingY + this.game.viewport.height, this.background.position.set(-this.game.viewport.paddingX, 0), this.logo.position.set(540, 140), this.logoFs.position.set(540, 140)) : (this.bonusTitle.position.set(960, 930), this.bgAnimation.visible = !0, this.featureBackground.texture = this.backgroundLTextureFree, this.featureBackground.width = this.game.viewport.width, this.featureBackground.height = this.game.viewport.height, this.featureBackground.position.set(0, 0), this.background.texture = this.backgroundTextureLandscape, this.background.width = this.game.viewport.width, this.background.height = this.game.viewport.height, this.background.position.set(0, 0), this.logo.position.set(this.logo.width / 1.5, this.logo.height / 2), this.logoFs.position.set(this.logo.width / 1.5, this.logo.height / 2))
                    }
                }
                class fs extends(Vt(A.xv)) {
                    constructor() {
                        super(Lt.i18n.t("BonusEndClickText").toUpperCase(), {
                            fontFamily: "PT Sans Narrow Bold",
                            align: "center",
                            fill: "#ffffff",
                            fontSize: 38,
                    ...
                    resize() {
                        this.game.device.desktop || this.game.device.landscape ? (this.scale.set(1), this.position.set(795, 965)) : (this.scale.set(2), this.position.set(800, 2100))
                    }
                }
                class ws extends $.j {
                    constructor() {
                        super(Lt.loader.getAsset("lineWinBg")), this.position.set(30, 120), this.alpha = 0
                    }
                    show() {
                        k.fromTo(this, .2, {
                            pixi: {
                ...
                class xs extends v.Xz {
                    constructor() {
                        super("", {
                            fontName: "SmallFont"
                        }), this.anchor.set(.5), this.scale.set(.6), this.alpha = 0
                    }
                    show(t) {
                        this.alpha = 1, "COIN" === t.type ? this.text = "".concat(Lt.i18n.currency({
                            bitmap: !0
                        })).concat(Lt.helpers.toMoney(t.value)) : "MUL" === t.type && (this.text = "x".concat(t.value))
                    }
                    hide() {
                        var t = this;
                        return (0, o.Z)((function*() {
                ...
                class Ss extends(Vt(Q.W2)) {
                    constructor(t) {
                        super(), (0, n.Z)(this, "animation", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "index", void 0), (0, n.Z)(this, "onPress", void 0), (0, n.Z)(this, "opened", void 0), (0, n.Z)(this, "text", void 0), this.onPress = new(x()), this.game.interaction.click(this, (() => this.onPress.dispatch(t))), this.index = t, this.opened = !0, this.cursor = "pointer", this.interactive = !1, this.alpha = 0, this.animation = this.addChild(new vs(this.game.loader.getAsset("bonusEffect"))), this.background = new ws, this.text = new xs, this.text.position.set(this.background.width / 2 + this.background.x, 170), this.addChild(this.background, this.text)
                    }
                    show(t, e) {
                        var i = this;
                        return (0, o.Z)((function*() {
                            i.opened = !1, i.alpha = 1, yield i.animation.play(t ? "start_shootme_fixed" : "start_shootme"), i.interactive = !e
                        }))()
                    }
                    open(t) {
                        var e = this;
                        return (0, o.Z)((function*() {
                            ...
                            e.opened = !0, e.interactive = !1, e.alpha = o ? .5 : 1, "LOSS" === n ? (e.animation.changeSkin("result_miss"), yield e.animation.play(o ? "result_fixed" : "play_shoot")) : (e.animation.changeSkin("result_win"), yield e.animation.play(s || o ? "result_fixed" : "play_shoot"), e.text.show(i), e.background.show())
                        }))()
                    }
                    hide() {
                        var t = this;
                        return (0, o.Z)((function*() {
                            t.animation.play("fade"), t.background.hide(), yield t.text.hide(), t.opened = !0, t.interactive = !1, t.alpha = 0
                        }))()
                    }
                }
                class ks extends(Vt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "mulDescription", void 0), (0, n.Z)(this, "mulText", void 0), (0, n.Z)(this, "winDescription", void 0), (0, n.Z)(this, "winText", void 0), this.position.set(-100, 430), this.alpha = 0, this.mulDescription = this.addChild(new Te("", {
                            default: {
                                fontSize: 30,
                                fontFamily: "Avenir-Bold",
                                fill: "#ffdf08",
                        ...
                        })), this.mulDescription.text = Lt.i18n.t("BonusTextMultiplier", Lt.i18n.currency({
                            withBrace: !0
                        })), this.mulDescription.y = 330, this.winDescription = this.addChild(new Te("", {
                            default: {
                                fontSize: 30,
                                fontFamily: "Avenir-Bold",
                                fill: "#ffdf08",
                        ...
                        })), this.winDescription.text = Lt.i18n.t("BonusTextTotalWin", Lt.i18n.currency({
                            withBrace: !0
                        })), this.winDescription.y = 500, this.mulText = this.addChild(new v.Xz("", {
                            fontName: "SmallFont"
                        })), this.mulText.letterSpacing = -10, this.mulText.scale.set(1.5), this.mulText.text = "x1", this.mulText.y = 60, this.winText = this.addChild(new v.Xz("", {
                            fontName: "SmallFont"
                        })), this.winText.letterSpacing = -10, this.winText.scale.set(1.5), this.winText.y = 230
                    }
                    show() {
                        this.alpha = 1, this.mulText.text = "x1", this.winText.text = Lt.helpers.toMoney(0)
                    }
                    hide() {
                        this.alpha = 0
                    }
                    update(t) {
                        var e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                            i = 1;
                        for (var [s, o] of Object.entries(t.items)) "MUL" === o.type && (i += o.value);
                        this.mulText.text = "x".concat(i), this.winText.text = Lt.helpers.toMoney(t.win), e || "LOSS" === t.type || ("MUL" === t.type && this.animateMul(this.mulText), t.win)
                    }
                    animateWin(t) {
                        var e = t.y;
                        k.fromTo(t, .2, {
                    ...
                    resize() {
                        this.game.device.desktop || (this.game.device.landscape ? (this.position.set(-100, 430), this.scale.set(1)) : (this.position.set(100, 730), this.scale.set(2)))
                    }
                }
                ...
                class Bs extends(Vt(Q.W2)) {
                    constructor(t) {
                        var e;
                        super(), e = this, (0, n.Z)(this, "bonuWinText", void 0), (0, n.Z)(this, "endText", void 0), (0, n.Z)(this, "isRequested", void 0), (0, n.Z)(this, "items", void 0), (0, n.Z)(this, "onBonusEnd", void 0), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "slot", void 0), (0, n.Z)(this, "spaceKey", void 0), (0, n.Z)(this, "handleItemHover", (t => () => {
                            this.isRequested || (this.game.action.emit("bonus:hover"), t.animation.play("shootme_hover"))
                        })), (0, n.Z)(this, "open", function() {
                            var t = (0, o.Z)((function*(t) {
                                if (!e.isRequested) {
                                    e.game.autoPlay.enabled || e.spaceKey.disable();
                                    try {
                                        e.isRequested = !0, e.items.forEach((t => t.interactive = !1));
                                        var i = yield e.game.server.request({
                                            action: "bonus",
                                            bonusItem: t
                                        });
                                        e.bonuWinText.update(i.bonus);
                                        var s = e.items.find((e => e.index == t));
                                        yield s.open({
                                            bonusItem: i.bonus
                                        }), "LOSS" === i.bonus.type ? (e.game.action.emit("bonus:loss"), yield e.loss(i.lostItems), e.tryEnd(), e.spaceKey.enable()) : (e.isRequested = !1, e.items.forEach((t => !t.opened && (t.interactive = !0))), e.game.action.emit("bonus:win"), e.game.action.emit("update:win"), e.items.some((t => !t.opened)) ? e.spaceKey.enable() : (yield e.game.delay(500), e.tryEnd()))
                                    } catch (t) {
                                        yield e.game.catchError(t)
                                    }
                                }
                            }));
                            return function(e) {
                        ...
                        }()), this.slot = t, this.items = [], this.isRequested = !1, this.onBonusEnd = new(x()), this.slot.reels.forEach(((t, e) => {
                            t.visibleSymbols.forEach(((t, i) => {
                                var s = this.game.config.get("slot.size[0]") * i + e,
                                    o = this.addChild(new Ss(s));
                                o.position.set(t.x, t.y), o.onPress.add(this.open), this.game.device.desktop && o.on("mouseover", this.handleItemHover(o)), this.items.push(o)
                            }))
                        })), this.items.sort(Cs), this.bonuWinText = this.addChild(new ks), this.endText = this.addChild(new fs), this.endText.visible = !1, this.spaceKey = this.game.keyboard.register(this.game.keyboard.KEY_CODE.Space), this.spaceKey.onPress.add((0, o.Z)((function*() {
                            if (e.game.autoPlay.enabled) e.game.autoPlay.toggle(), e.overlay.interactive = !1, e.spaceKey.disable();
                            else if (e.overlay.interactive) e.end();
                            else {
                                var t = e.items.find((t => !t.opened));
                                t && (e.items.forEach((t => t.interactive = !1)), yield e.open(t.index))
                            }
                        }))), this.spaceKey.disable(), this.overlay = new Jt(0), this.game.interaction.click(this.overlay, (() => {
                            this.game.autoPlay.enabled ? (this.game.autoPlay.toggle(), this.overlay.interactive = !1) : this.end()
                        }))
                    }
                    tryEnd() {
                        this.game.autoPlay.enabled ? this.end() : (this.endText.visible = !0, this.overlay.interactive = !0)
                    }
                    show() {
                        var t = this,
                            e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
                        return new Promise((i => {
                            this.onBonusEnd.once(i), this.game.autoPlay.enabled && (this.overlay.interactive = !0);
                            var s = this.game.store.get("reward:bonus");
                            if (this.bonuWinText.show(), this.slot.reels.forEach((t => {
                                    t.overlay(), t.visibleSymbols.forEach((t => {
                                        t.alpha = 0
                                    }))
                                })), this.items.forEach(((t, i) => {
                                    var o = !!e && void 0 !== s.items[i];
                                    t.show(e, o)
                                })), e) {
                                var o = function(e, i) {
                                    var s = t.items.find((t => t.index == e));
                                    s.open({
                                        bonusItem: i,
                                        restore: !0
                                    })
                                };
                                for (var [n, a] of Object.entries(s.items)) o(n, a);
                                this.bonuWinText.update(this.game.store.get("reward:bonus"), !0)
                            }
                            this.game.action.emit("bonus:start", e), this.spaceKey.enable(), this.game.autoPlay.enabled && this.autoPlay()
                        }))
                    }
                    autoPlay() {
                        var t = this;
                        return (0, o.Z)((function*() {
                            yield t.game.delay(1200);
                    ...
                    loss(t) {
                        ...
                        var t = this;
                        return (0, o.Z)((function*() {
                            t.isRequested = !1, t.spaceKey.disable(), t.endText.visible = !1, t.overlay.interactive = !1, t.game.action.emit("bonus:score"), t.items.forEach((t => t.hide())), t.bonuWinText.hide(), (t.game.store.get("reward:bonus").pos ? t.game.store.get("reward:bonus").pos : t.game.store.get("reward:preSpin").bonus.pos).forEach(((e, i) => {
                                -1 !== e && k.fromTo(t.slot.reels[i].visibleSymbols[e], .4, {
                                    pixi: {
                                        alpha: 0
                                    }
                                }, {
                ...
                class Ks extends Us {
                    constructor(t) {
                        ...
                        })), this.betLevel = t, this.betLevelText = this.addChild(new Te("", Xs(Xs({}, Qs.Common), {}, {
                ...
                class oo extends Te {
                    constructor() {
                        super("", so(so({}, Qs.Common), {}, {
                            default: so(so({}, Qs.Common.default), {}, {
                                align: "right"
                            })
                        }))
                    }
                ...
                class ro extends Te {
                    constructor() {
                        super("", ho(ho({}, Qs.Common), {}, {
                            default: ho(ho({}, Qs.Common.default), {}, {
                                fill: Lt.config.get("colors.primary"),
                                fontFamily: "Avenir-Bold"
                            }),
                            value: ho(ho({}, Qs.Common.value), {}, {
                                fontSize: 66
                            })
                        })), this.visible = !1
                    }
                ...
                class co extends Ns {
                    constructor() {
                        ...
                        this.background = $.j.from("data:image/png;base64,"), this.background.alpha = 0, this.background.anchor.set(0, 1), this.background.position.set(0, this.game.viewport.height), this.buttonMenu = new Fs, this.buttonMenu.position.set(77, 1013), this.buttonMaxBet = new Ks(this.game.betLevel), this.buttonMaxBet.position.set(213, 1013), this.buttonAutoPlay = new Ts, this.buttonAutoPlay.position.set(833, 1013), this.buttonQuickSpin = new Os, this.buttonQuickSpin.position.set(1084, 1014), this.buttonSound = new js, this.buttonSound.position.set(1840, 1012), this.buttonSpin = function() {
                            ...
                            e.hitArea = new X.Rectangle(20, 10, e.width - 40, e.height - 30), e.name = "buttonSpin", e.onClick.add(o);
                            var i = Lt.keyboard.register(Lt.keyboard.KEY_CODE.Space);
                            i.onPress.add(o), i.disable();
                            var s = new vs(Lt.loader.getAsset("effectSpin"));
                            ...
                            function a() {
                                Hi.isFreespin() || (e.enable(), i.enable())
                            }
                            ...
                            function l() {
                                "bonus" === Lt.store.get("reward:feature") || i.enable(), Hi.isFreespin() || (e.visible = !0), Lt.autoPlay.enabled || s.play("normal")
                            }
                            return e.addChild(s), s.play("normal"), e.onHover.add((() => {
                                s.play("hover")
                            })), Lt.action.on("state:setup_enter", (() => {
                                "bonus" === Lt.store.get("reward:feature") && (e.disable(), i.disable())
                            ...
                            })), Lt.action.on("free:select_start", r), Lt.action.on("bonus:end", (() => {
                                e.enable(), i.enable()
                            })), {
                                container: e,
                                hide() {
                                ...
                                enable() {
                                    s.play("normal"), e.enable(), i.enable()
                                },
                                disable() {
                                    s.play("inactive"), e.disable(), i.disable(), t.handlers(!0) && t.detachAll()
                                }
                            }
                        }(e.btn_spin_active, e.btn_spin_hover, e.btn_spin_press, e.btn_spin_inactive), this.buttonSpin.container.position.set(886, 940), this.buttonAccept = new Es, this.buttonAccept.position.set(958, 1013), this.textWin = new lo, this.textWin.anchor.x = .5, this.textWin.position.set(1400, 980), this.textBalance = new oo, this.textBalance.anchor.x = 1, this.textBalance.position.set(1760, 980), this.freeRoundLeft = to(Qs.Common), this.freeRoundLeft.container.position.set(1700, 1054), this.freeRoundTotalWin = eo(Qs.Common), this.freeRoundTotalWin.container.position.set(1400, 980), this.textFreeSpinLeft = new no, this.textFreeSpinLeft.visible = !1, this.textFreeSpinLeft.anchor.x = .5, this.textFreeSpinLeft.position.set(640, 980), this.textFreeSpinTotalWin = new ro, this.textFreeSpinTotalWin.visible = !1, this.textFreeSpinTotalWin.anchor.x = .5, this.textFreeSpinTotalWin.position.set(960, 955), this.addChild(this.background), this.addChild(this.textFreeSpinLeft), this.addChild(this.textFreeSpinTotalWin), this.addChild(this.buttonMenu), this.addChild(this.buttonMaxBet), this.game.config.get("autoPlay.available", !0) && this.addChild(this.buttonAutoPlay), this.game.config.get("quickSpin.available", !0) && this.addChild(this.buttonQuickSpin), this.addChild(this.buttonSound), this.addChild(this.buttonSpin.container), this.addChild(this.buttonAccept), this.addChild(this.textWin), this.game.config.get("balanceHide", !1) || this.addChild(this.textBalance), this.addChild(this.freeRoundTotalWin.container), this.addChild(this.freeRoundLeft.container), this.textWin.update(this.game.wallet.coins), this.textBalance.update(this.game.wallet.balance), this.game.freeRound.onStart.once((t => {
                            ...
                            t.textWin.update(t.game.wallet.coins, e), (t.game.store.get("free:isFree", !1) || t.game.store.get("free:isEnd", !1)) && t.textFreeSpinTotalWin.update(t.game.wallet.totalCoins)
                        })), this.game.action.on("update:balance", (() => {
                            Hi.isFreespin() || this.textBalance.update(this.game.wallet.balance)
                        })), this.game.action.on("state:setup_enter", (() => {
                            var t = "bonus" === this.game.store.get("reward:feature");
                            (Hi.isFreespin() || t) && (this.y = this.y + this.height + 100)
                            ...
                            this.buttonAutoPlay.disable(), k.fromTo(this, .5, {
                                pixi: {
                                    y: this.y
                                }
                            }, {
                            ...
                            this.buttonAutoPlay.enable(), this.textWin.update(this.game.wallet.bonusCoins), k.fromTo(this, .5, {
                                pixi: {
                ...
                var vo, bo = {
                    ...
                    yo = go(go({}, bo), {}, {
                        value: go(go({}, bo.value), {}, {
                            fill: 16777215
                        })
                    });
                class fo extends(Vt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "state", void 0), (0, n.Z)(this, "textBet", void 0), (0, n.Z)(this, "textWin", void 0), (0, n.Z)(this, "textBalance", void 0), (0, n.Z)(this, "textFreeRound", void 0), (0, n.Z)(this, "textFree", void 0), (0, n.Z)(this, "textTotalWin", void 0), (0, n.Z)(this, "textBonus", void 0), (0, n.Z)(this, "delimiter", void 0), this.state = Ao.Normal, this.textBet = new Te("", go(go({}, bo), {}, {
                            default: go(go({}, bo.default), {}, {
                                align: "left"
                            })
                        })), this.textBet.anchor.set(0, 0), this.textWin = new Te("", bo), this.textWin.anchor.set(.5, 0), this.textBalance = new Te("", go(go({}, bo), {}, {
                            default: go(go({}, bo.default), {}, {
                                align: "right"
                            })
                        })), this.textBalance.anchor.set(1, 0), this.textFreeRound = new Te("", go(go({}, bo), {}, {
                            default: go(go({}, bo.default), {}, {
                                align: "center",
                                wordWrap: !0,
                                wordWrapWidth: 300
                            })
                        })), this.textFreeRound.anchor.set(1, 1), this.textFree = new Te("", go(go({}, yo), {}, {
                            default: go(go({}, yo.default), {}, {
                                fontSize: 30,
                                wordWrapWidth: 340
                            })
                        })), this.textFree.anchor.set(0, 1), this.textTotalWin = new Te("", go(go({}, yo), {}, {
                            default: go(go({}, yo.default), {}, {
                                fontFamily: "Avenir-Bold",
                                fill: this.game.config.get("colors.primary"),
                                fontSize: 30,
                            ...
                            value: go(go({}, yo.value), {}, {
                                fill: this.game.config.get("colors.primary")
                            })
                        })), this.textTotalWin.anchor.set(.5, 1), this.textBonus = new Te("", go(go({}, yo), {}, {
                            default: go(go({}, yo.default), {}, {
                                fontSize: 27,
                                wordWrapWidth: 340
                            })
                        })), this.textBonus.anchor.set(0, 1), this.delimiter = new uo(16777215, .5), this.addChild(...[this.textBet, this.textWin, !this.game.config.get("balanceHide", !1) && this.textBalance, this.textFreeRound, this.textFree, this.textTotalWin, this.textBonus, this.delimiter].filter(Boolean)), this.game.freeRound.onStart.once((() => {
                    ...
                    resize() {
                        var t = this.state === Ao.Free,
                            e = this.state === Ao.Bonus;
                    ...
                    changeState(t) {
                        this.state = t, t === Ao.Free ? (this.textFree.visible = !0, this.textTotalWin.visible = !0, this.textWin.visible = !0, this.textBonus.visible = !1, this.visible = !0) : t === Ao.Normal ? (this.textFree.visible = !1, this.textTotalWin.visible = !1, this.textWin.visible = !0, this.textBonus.visible = !1, this.visible = !0) : t === Ao.Bonus && (this.textBonus.visible = !0, this.textTotalWin.visible = !0, this.textWin.visible = !1, this.visible = !0), this.resize()
                    }
                }
                class wo extends(Vt(Q.W2)) {
                    constructor() {
                ...
                class xo extends Ns {
                    constructor() {
                        super(), (0, n.Z)(this, "autoPlayButton", void 0), (0, n.Z)(this, "betButton", void 0), (0, n.Z)(this, "buttonAccept", void 0), (0, n.Z)(this, "buttonMenu", void 0), (0, n.Z)(this, "buttonQuickSpin", void 0), (0, n.Z)(this, "buttonSound", void 0), (0, n.Z)(this, "buttonSpin", void 0), (0, n.Z)(this, "onPressButtonSpin", void 0), (0, n.Z)(this, "state", void 0), (0, n.Z)(this, "statusBar", void 0), this.state = Ao.Normal, this.onPressButtonSpin = new(x()), this.statusBar = new fo, this.statusBar.changeState(this.state), this.game.freeRound.enabled ? (this.statusBar.update({
                        ...
                        })), this.buttonMenu = new Fs, this.buttonSound = new js, this.buttonSpin = new wo, this.game.interaction.hover(this.buttonSpin, (() => {
                        ...
                        })), this.buttonAccept = new Es, this.buttonQuickSpin = new Os, this.autoPlayButton = new Ts, this.autoPlayButton.scale.set(1.6), this.betButton = new Us, this.betButton.disable(), this.betButton.onClick.add((() => this.game.action.emit("clickMaxBet"))), this.game.action.on("update:win", (() => {
                            ...
                            this.state = Ao.Free, this.buttonMenu.hide(), this.betButton.hide(), this.autoPlayButton.hide(), this.buttonSpin.visible = !1, this.buttonSound.show(), this.statusBar.changeState(this.state), this.statusBar.update({
                                type: mo.Win,
                                value: 0
                            }), this.statusBar.update({
                                type: mo.TotalWin,
                            ...
                            this.state = Ao.Normal, this.buttonMenu.show(), this.buttonSpin.visible = !0, this.betButton.show(), this.buttonQuickSpin.show(), this.autoPlayButton.show(), this.buttonSound.hide(), this.statusBar.changeState(this.state), this.game.freeRound.enabled || this.statusBar.update({
                                type: mo.Balance,
                                value: this.game.wallet.balance
                            }), this.statusBar.update({
                                type: mo.Win,
                            ...
                            "bonus" === this.game.store.get("reward:feature") && (this.buttonSpin.visible = !1, this.buttonSpin.interactive = !1, this.alpha = 0)
                        })), this.game.action.on("bonus:start", (t => {
                            this.buttonSpin.visible = !1, this.buttonSpin.interactive = !1, this.interactiveChildren = !1, this.statusBar.update({
                                type: mo.Win,
                                value: 0
                            }), t ? this.alpha = 0 : k.fromTo(this, .5, {
                                pixi: {
                                    alpha: 1
                                }
                            }, {
                            ...
                            this.buttonSpin.visible = !0, this.buttonSpin.interactive = !0, this.interactiveChildren = !0, this.statusBar.update({
                                type: mo.Balance,
                                value: this.game.wallet.balance
                            }), k.fromTo(this, .5, {
                                pixi: {
                    ...
                    resize() {
                        ...
                        if (this.game.device.landscape) this.betButton.position.set(120, 980), e && this.betButton.show(), i ? (this.buttonSound.position.set(120, this.state === Ao.Free ? 300 : 780), this.buttonMenu.position.set(120, 120), this.buttonQuickSpin.position.set(120, 780), this.autoPlayButton.position.set(120, 300), this.buttonSpin.position.set(160, this.game.viewport.height / 2), this.buttonAccept.position.set(160, this.game.viewport.height / 2)) : (this.buttonSound.position.set(1780, this.state === Ao.Free ? 300 : 780), this.buttonMenu.position.set(1780, 120), this.buttonQuickSpin.position.set(1780, 780), this.autoPlayButton.position.set(1780, 300), this.buttonSpin.position.set(1760, this.game.viewport.height / 2), this.buttonAccept.position.set(1760, this.game.viewport.height / 2));
                        else {
                            var s = 2 * this.game.viewport.paddingY + this.game.viewport.height;
                            this.buttonSound.position.set(110, this.state === Ao.Free ? 100 : s - 318), this.autoPlayButton.position.set(540, s - 318), this.buttonQuickSpin.position.set(this.state === Ao.Normal ? 748 : 955, s - 318), this.buttonMenu.position.set(955, s - 318), this.betButton.position.set(332, s - 318), e && this.betButton.hide(), this.buttonSpin.scale.set(1), this.buttonSpin.position.set(this.game.viewport.width / 2, s - 590), this.buttonAccept.position.set(this.game.viewport.width / 2, s - 590)
                        }
                    }
                    lock() {
                ...
                class So extends(Vt(Q.W2)) {
                    constructor() {
                        ...
                        })), this._description.anchor.set(.5), this._description.position.set(0, 480), this._buttonText = this._content.addChild(new Te("", {
                            default: {
                                fontFamily: "PT Sans Narrow Bold",
                                fill: "#ffffff",
                                fontSize: 65,
                        ...
                        })), this._buttonText.anchor.set(.5, 0), this._buttonText.position.set(0, 620), this._timeline = new C({
                            paused: !0
                    ...
                    showContent(t) {
                        return t === vo.RESTORE ? Promise.resolve() : new Promise((t => {
                ...
                class Fo extends(Vt(Q.W2)) {
                    constructor(t) {
                        var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [];
                        super(), (0, n.Z)(this, "_payTableBetLineBoxs", void 0), (0, n.Z)(this, "_payTableParagraph", void 0), (0, n.Z)(this, "_payTableTitle", void 0), this._payTableBetLineBoxs = new Q.W2, this._payTableTitle = new Eo(this.game.i18n.t("PaytableSectionBetLinesTitle").toUpperCase()), this._payTableParagraph = new To(this.game.i18n.t("PaytableSectionBetLinesContent1")), t.forEach(((t, i) => {
                            var s = new Co(i + 1, t, e);
                ...
                class _o extends(Vt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "_sectionParagraph1", void 0), (0, n.Z)(this, "_sectionTitle", void 0), this.visible = this.game.config.get("rnb", !0), this._sectionTitle = new Eo(this.game.i18n.t("PaytableSectionRiskTitle").toUpperCase()), this._sectionTitle.position.set(0, 0), this._sectionParagraph1 = new To(this.game.i18n.t("PaytableSectionRiskContent1")), this._sectionParagraph1.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this.addChild(this._sectionTitle), this.addChild(this._sectionParagraph1)
                    }
                    resize() {
                ...
                class Ro extends(Vt(Q.W2)) {
                    ...
                    updateBet(t) {
                        this.payoutText.text = "\n", this.payouts.filter((t => t.sym === this.findIndex)).forEach((e => {
                            var i;
                            e.n > 0 && e.mul > 0 && (i = "scatter" === e.type || 11 === e.sym ? t.toCoins() * e.mul : t.bet * e.mul, this.payoutText.text += "<mul>".concat(e.n, "</mul>\t\t").concat(this.game.helpers.toMoney(i, t.bet), "\n"))
                        }))
                    }
                    resize() {
                ...
                class Mo extends(Vt(Q.W2)) {
                    constructor() {
                        ...
                        this._sectionTitle = new Eo(t.toUpperCase()), this._sectionTitle.position.set(0, 0), this._symbol = new Ro("bonus_hunter"), this._symbol.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this._symbol.withoutPayout(), this._sectionParagraph = new To(this.game.i18n.t("PaytableSectionBonusContent1")), this._sectionParagraph.position.set(this._symbol.x + this._symbol.width + 30, this._sectionTitle.y + this._sectionTitle.height + 30), this._sectionParagraph.setTagStyle("default", {
                            wordWrapWidth: 620
                        }), this.addChild(this._sectionTitle, this._symbol, this._sectionParagraph)
                    }
                    updateBet(t) {
                        this._symbol.updateBet(t)
                    }
                    resize() {
                        this.game.device.desktop || (this.game.device.landscape ? (this._symbol.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this._sectionParagraph.position.set(this._symbol.x + this._symbol.width + 30, this._sectionTitle.y + this._sectionTitle.height + 30), this._sectionParagraph.setTagStyle("default", {
                            wordWrapWidth: 420
                        })) : (this._symbol.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this._sectionParagraph.position.set(0, this._symbol.y + this._symbol.height + 30), this._sectionParagraph.setTagStyle("default", {
                            wordWrapWidth: 420
                        })))
                    }
                }
                class Wo extends(Vt(Q.W2)) {
                    constructor() {
                        ...
                        this._sectionTitle = new Eo(t.toUpperCase()), this._sectionTitle.position.set(0, 0), this._sectionParagraph = new To(this.game.i18n.t("PaytableSectionFreeContent1")), this._sectionParagraph.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this.addChild(this._sectionTitle), this.addChild(this._sectionParagraph)
                    }
                    resize() {
                ...
                class Io extends(Vt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "_sectionTitle", void 0), (0, n.Z)(this, "symbolBlue", void 0), (0, n.Z)(this, "symbolHanno", void 0), (0, n.Z)(this, "symbolMouse", void 0), (0, n.Z)(this, "symbolPink", void 0), (0, n.Z)(this, "symbolShango", void 0), (0, n.Z)(this, "symbolVodoo", void 0), (0, n.Z)(this, "symbols", void 0);
                        var t = this.game.i18n.t("PaytableSectionFreePayout1Title");
                        this._sectionTitle = new Eo(t.toUpperCase()), this._sectionTitle.position.set(0, 0), this.symbolMouse = new Ro("devil_mouse"), this.symbolMouse.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this.symbolPink = new Ro("pink_elephant"), this.symbolPink.position.set(600, this._sectionTitle.y + this._sectionTitle.height + 30), this.symbolBlue = new Ro("blue_elephant"), this.symbolBlue.position.set(0, this.symbolMouse.y + this.symbolMouse.height + 30), this.symbolShango = new Ro("shango_grave"), this.symbolShango.position.set(600, this.symbolPink.y + this.symbolPink.height + 30), this.symbolHanno = new Ro("hanno_grave"), this.symbolHanno.position.set(0, this.symbolBlue.y + this.symbolBlue.height + 30), this.symbolVodoo = new Ro("voodoo_skull"), this.symbolVodoo.position.set(600, this.symbolShango.y + this.symbolShango.height + 30), this.symbols = [this.symbolMouse, this.symbolPink, this.symbolBlue, this.symbolShango, this.symbolHanno, this.symbolVodoo], this.addChild(this._sectionTitle, ...this.symbols)
                    }
                    updateBet(t) {
                        this.symbols.forEach((e => e.updateBet(t)))
                    }
                    resize() {
                        this.game.device.desktop || (this.game.device.landscape ? (this.symbolMouse.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this.symbolPink.position.set(820, this._sectionTitle.y + this._sectionTitle.height + 30), this.symbolBlue.position.set(0, this.symbolMouse.y + this.symbolMouse.height + 30), this.symbolShango.position.set(820, this.symbolPink.y + this.symbolPink.height + 30), this.symbolHanno.position.set(0, this.symbolBlue.y + this.symbolBlue.height + 30), this.symbolVodoo.position.set(820, this.symbolShango.y + this.symbolShango.height + 30)) : (this.symbolMouse.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this.symbolPink.position.set(0, this.symbolMouse.y + this.symbolMouse.height + 30), this.symbolBlue.position.set(0, this.symbolPink.y + this.symbolPink.height + 30), this.symbolShango.position.set(0, this.symbolBlue.y + this.symbolBlue.height + 30), this.symbolHanno.position.set(0, this.symbolShango.y + this.symbolShango.height + 30), this.symbolVodoo.position.set(0, this.symbolHanno.y + this.symbolHanno.height + 30)))
                    }
                }
                class Do extends(Vt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "_sectionParagraph", void 0), (0, n.Z)(this, "_sectionTitle", void 0), (0, n.Z)(this, "symbolHarp", void 0), (0, n.Z)(this, "symbolNut", void 0), (0, n.Z)(this, "symbols", void 0);
                        var t = this.game.i18n.t("PaytableSectionFreePayout2Title");
                        this._sectionTitle = new Eo(t.toUpperCase()), this._sectionTitle.position.set(0, 0), this.symbolNut = new Ro("wild_fs_nut"), this.symbolNut.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this.symbolNut.withoutPayout(), this.symbolHarp = new Ro("scatter_fs_harp"), this.symbolHarp.position.set(this.symbolNut.x + this.symbolNut.width + 30, this._sectionTitle.y + this._sectionTitle.height + 30), this.symbolHarp.withoutPayout(), this._sectionParagraph = new To(this.game.i18n.t("PaytableSectionFreePayout2Content1")), this._sectionParagraph.position.set(0, this.symbolNut.height + this.symbolNut.y + 30), this.symbols = [this.symbolNut, this.symbolHarp], this.addChild(this._sectionTitle, ...this.symbols, this._sectionParagraph)
                    }
                    updateBet(t) {
                        this.symbols.forEach((e => e.updateBet(t)))
                    }
                    resize() {
                        this.game.device.desktop || (this.game.device.landscape ? (this.symbolNut.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this.symbolHarp.position.set(this.symbolNut.x + this.symbolNut.width + 30, this._sectionTitle.y + this._sectionTitle.height + 30), this._sectionParagraph.position.set(0, this.symbolNut.height + this.symbolNut.y + 30), this._sectionParagraph.setTagStyle("default", {
                            wordWrapWidth: 690
                        })) : (this.symbolNut.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this.symbolHarp.position.set(0, this.symbolNut.y + this.symbolNut.height + 30), this._sectionParagraph.position.set(0, this.symbolHarp.height + this.symbolHarp.y + 30), this._sectionParagraph.setTagStyle("default", {
                            wordWrapWidth: 390
                        })))
                    }
                }
                class Lo extends(Vt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "_sectionTitle", void 0), (0, n.Z)(this, "symbolBanana", void 0), (0, n.Z)(this, "symbolCoconut", void 0), (0, n.Z)(this, "symbolKiwi", void 0), (0, n.Z)(this, "symbolLion", void 0), (0, n.Z)(this, "symbolMango", void 0), (0, n.Z)(this, "symbolMonkey", void 0), (0, n.Z)(this, "symbolOrange", void 0), (0, n.Z)(this, "symbolPlum", void 0), (0, n.Z)(this, "symbolZirafa", void 0), (0, n.Z)(this, "symbols", void 0);
                        var t = this.game.i18n.t("PaytableSectionPayoutTitle");
                        this._sectionTitle = new Eo(t.toUpperCase()), this.symbolLion = new Ro("lion"), this.symbolLion.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this.symbolMonkey = new Ro("monkey"), this.symbolMonkey.position.set(600, this._sectionTitle.y + this._sectionTitle.height + 30), this.symbolZirafa = new Ro("zirafa"), this.symbolZirafa.position.set(0, this.symbolLion.y + this.symbolLion.height + 30), this.symbolOrange = new Ro("orange"), this.symbolOrange.position.set(600, this.symbolMonkey.y + this.symbolMonkey.height + 30), this.symbolKiwi = new Ro("kiwi"), this.symbolKiwi.position.set(0, this.symbolZirafa.y + this.symbolZirafa.height + 30), this.symbolCoconut = new Ro("coconut"), this.symbolCoconut.position.set(600, this.symbolOrange.y + this.symbolOrange.height + 30), this.symbolBanana = new Ro("banana"), this.symbolBanana.position.set(0, this.symbolKiwi.y + this.symbolKiwi.height + 30), this.symbolPlum = new Ro("plum"), this.symbolPlum.position.set(600, this.symbolCoconut.y + this.symbolCoconut.height + 30), this.symbolMango = new Ro("mango"), this.symbolMango.position.set(0, this.symbolPlum.y + this.symbolPlum.height + 30), this.symbols = [this.symbolLion, this.symbolMonkey, this.symbolZirafa, this.symbolOrange, this.symbolKiwi, this.symbolCoconut, this.symbolBanana, this.symbolPlum, this.symbolMango], this.addChild(this._sectionTitle, ...this.symbols)
                    }
                    updateBet(t) {
                        this.symbols.forEach((e => e.updateBet(t)))
                    }
                    resize() {
                        this.game.device.desktop || (this.game.device.landscape ? (this.symbolLion.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this.symbolMonkey.position.set(820, this._sectionTitle.y + this._sectionTitle.height + 30), this.symbolZirafa.position.set(0, this.symbolLion.y + this.symbolLion.height + 30), this.symbolOrange.position.set(820, this.symbolMonkey.y + this.symbolMonkey.height + 30), this.symbolKiwi.position.set(0, this.symbolZirafa.y + this.symbolZirafa.height + 30), this.symbolCoconut.position.set(820, this.symbolOrange.y + this.symbolOrange.height + 30), this.symbolBanana.position.set(0, this.symbolKiwi.y + this.symbolKiwi.height + 30), this.symbolPlum.position.set(820, this.symbolCoconut.y + this.symbolCoconut.height + 30), this.symbolMango.position.set(0, this.symbolPlum.y + this.symbolPlum.height + 30)) : (this.symbolLion.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this.symbolMonkey.position.set(0, this.symbolLion.y + this.symbolLion.height + 30), this.symbolZirafa.position.set(0, this.symbolMonkey.y + this.symbolMonkey.height + 30), this.symbolOrange.position.set(0, this.symbolZirafa.y + this.symbolZirafa.height + 30), this.symbolKiwi.position.set(0, this.symbolOrange.y + this.symbolOrange.height + 30), this.symbolCoconut.position.set(0, this.symbolKiwi.y + this.symbolKiwi.height + 30), this.symbolBanana.position.set(0, this.symbolCoconut.y + this.symbolCoconut.height + 30), this.symbolPlum.position.set(0, this.symbolBanana.y + this.symbolBanana.height + 30), this.symbolMango.position.set(0, this.symbolPlum.y + this.symbolPlum.height + 30)))
                    }
                }
                class jo extends(Vt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "_sectionParagraph", void 0), (0, n.Z)(this, "_sectionTitle", void 0), (0, n.Z)(this, "_symbolScatter1", void 0), (0, n.Z)(this, "_symbolScatter2", void 0);
                        var t = this.game.i18n.t("PaytableSectionScatterTitle");
                        this._sectionTitle = new Eo(t.toUpperCase()), this._sectionTitle.position.set(0, 0), this._symbolScatter1 = new Ro("scatter_pay_drum"), this._symbolScatter1.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this._symbolScatter2 = new Ro("scatter_normal_free"), this._symbolScatter2.position.set(600, this._sectionTitle.y + this._sectionTitle.height + 30), this._symbolScatter2.withoutPayout(), this._sectionParagraph = new To(this.game.i18n.t("PaytableSectionScatterContent1")), this._sectionParagraph.position.set(0, this._symbolScatter1.y + this._symbolScatter1.height + 30), this.addChild(this._sectionTitle), this.addChild(this._symbolScatter1), this.addChild(this._symbolScatter2), this.addChild(this._sectionParagraph)
                    }
                    updateBet(t) {
                        this._symbolScatter1.updateBet(t), this._symbolScatter2.updateBet(t)
                    }
                    resize() {
                        this.game.device.desktop || (this.game.device.landscape ? (this._symbolScatter1.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this._symbolScatter2.position.set(820, this._sectionTitle.y + this._sectionTitle.height + 30), this._sectionParagraph.position.set(0, this._symbolScatter1.y + this._symbolScatter1.height + 30)) : (this._symbolScatter1.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this._symbolScatter2.position.set(0, this._symbolScatter1.y + this._symbolScatter1.height + 30), this._sectionParagraph.position.set(0, this._symbolScatter2.y + this._symbolScatter2.height + 30)))
                    }
                }
                class No extends(Vt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "_sectionParagraph", void 0), (0, n.Z)(this, "_sectionTitle", void 0), (0, n.Z)(this, "symbol", void 0);
                        var t = this.game.i18n.t("PaytableSectionShootTitle");
                        this._sectionTitle = new Eo(t.toUpperCase()), this._sectionTitle.position.set(0, 0), this.symbol = new $.j(this.game.loader.getAsset("assets/images/paytable/bonus.jpg")), this.symbol.scale.set(.4), this.symbol.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this._sectionParagraph = new To(this.game.i18n.t("PaytableSectionShootContent1")), this._sectionParagraph.position.set(0, this.symbol.y + this.symbol.height + 30), this.addChild(this._sectionTitle, this.symbol, this._sectionParagraph)
                    }
                    resize() {
                        this.game.device.desktop || (this.symbol.scale.set(.4), this.symbol.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this._sectionParagraph.position.set(0, this.symbol.y + this.symbol.height + 30))
                    }
                }
                class Uo extends(Vt(Q.W2)) {
                    constructor() {
                        ...
                        this._sectionTitle = new Eo(t.toUpperCase()), this._sectionTitle.position.set(0, 0), this._symbol = new Ro("wild_normal_mask"), this._symbol.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this._symbol.withoutPayout(), this._sectionParagraph = new To(this.game.i18n.t("PaytableSectionWildContent1")), this._sectionParagraph.position.set(this._symbol.x + this._symbol.width + 30, this._sectionTitle.y + this._sectionTitle.height + 30), this._sectionParagraph.setTagStyle("default", {
                            wordWrapWidth: 620
                        }), this.addChild(this._sectionTitle, this._symbol, this._sectionParagraph)
                    }
                    updateBet(t) {
                ...
                class zo extends ko {
                    constructor(t) {
                        super(), (0, n.Z)(this, "_payTableSectionRisk", void 0), (0, n.Z)(this, "_paytableSectionBetLines", void 0), (0, n.Z)(this, "_paytableSectionBonus", void 0), (0, n.Z)(this, "_paytableSectionFree", void 0), (0, n.Z)(this, "_paytableSectionFreePayout1", void 0), (0, n.Z)(this, "_paytableSectionFreePayout2", void 0), (0, n.Z)(this, "_paytableSectionPayout", void 0), (0, n.Z)(this, "_paytableSectionScatter", void 0), (0, n.Z)(this, "_paytableSectionShoot", void 0), (0, n.Z)(this, "_paytableSectionWild", void 0), (0, n.Z)(this, "payTableDelimiter", void 0), this.payTableDelimiter = new Zo, this._payTableSectionRisk = new _o, this._paytableSectionPayout = new Lo, this._paytableSectionWild = new Uo, this._paytableSectionScatter = new jo, this._paytableSectionBonus = new Mo, this._paytableSectionShoot = new No, this._paytableSectionFree = new Wo, this._paytableSectionFreePayout1 = new Io, this._paytableSectionFreePayout2 = new Do, this._paytableSectionBetLines = new Oo(t), this.content.addChild(this._payTableSectionRisk, this._paytableSectionPayout, this._paytableSectionWild, this._paytableSectionScatter, this._paytableSectionBonus, this._paytableSectionShoot, this._paytableSectionFree, this._paytableSectionFreePayout1, this._paytableSectionFreePayout2, this.payTableDelimiter, this._paytableSectionBetLines)
                    }
                    updateBet(t) {
                        this._paytableSectionPayout.updateBet(t), this._paytableSectionWild.updateBet(t), this._paytableSectionBonus.updateBet(t), this._paytableSectionScatter.updateBet(t), this._paytableSectionFreePayout1.updateBet(t), this._paytableSectionFreePayout2.updateBet(t)
                    }
                }
                ...
                class cn extends Ko {
                    constructor() {
                        super(), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "backgroundContent", void 0), (0, n.Z)(this, "betValue", void 0), (0, n.Z)(this, "buyFor", void 0), (0, n.Z)(this, "buyValue", void 0), (0, n.Z)(this, "featureButton", void 0), (0, n.Z)(this, "freespinsText", void 0), (0, n.Z)(this, "header", void 0), (0, n.Z)(this, "labelCount", void 0), (0, n.Z)(this, "onBet", void 0), (0, n.Z)(this, "onPress", void 0), this.position.set(1650, 180), this.onPress = new(x()), this.backgroundContent = this.addChild(new Q.W2), this.backgroundContent.renderable = !1, this.background = this.backgroundContent.addChild(new $.j(this.game.loader.getAsset("riskTexture", "bg"))), this.header = this.backgroundContent.addChild(new sn({
                            default: {
                                fill: "#ffffff",
                                fontSize: 20
                            }
                        })), this.labelCount = this.backgroundContent.addChild(new v.Xz("", {
                            fontName: "WinFont"
                        })), this.labelCount.anchor.x = .5, this.labelCount.scale.set(.7), this.labelCount.text = "10", this.labelCount.letterSpacing = -10, this.freespinsText = this.backgroundContent.addChild(new $o({
                            default: {
                                fontSize: 30
                            }
                        ...
                        })), this.buyValue = this.backgroundContent.addChild(new Xo({
                            default: {
                                fontSize: 30
                            }
                        })), this.onBet = this.backgroundContent.addChild(new an({
                            default: {
                                fill: "#ffce46",
                                fontSize: 21,
                                wordWrapWidth: 220
                            }
                        })), this.betValue = this.backgroundContent.addChild(new ln({
                            default: {
                                fontSize: 30
                            }
                        })), this.featureButton = this.backgroundContent.addChild(new $.j(this.game.loader.getAsset("riskTexture", "ex" === this.game.i18n.language ? "btn-get" : "btn_buy"))), this.featureButton.position.set(6, 370), this.featureButton.cursor = "pointer", this.featureButton.interactive = !1, this.game.interaction.click(this.featureButton, (() => {
                    ...
                    show(t) {
                        if (this.game.store.get("isRiskNBuy") && (super.show(t), this.visible)) {
                            ...
                            }), 150), e ? (this.buyFor.hide(), this.buyValue.hide(), this.header.show(), this.featureButton.texture = this.game.loader.getAsset("riskTexture", "ex" === this.game.i18n.language ? "btn-play" : "btn_risk"), this.betValue.text = "".concat(Lt.helpers.toMoneySS(this.game.betLevel.toCoins())), this.labelCount.text = e.freespins, this.header.position.set(145, 176), this.labelCount.position.set(143, 190), this.freespinsText.position.set(144, 332), this.buyFor.position.set(144), this.buyValue.position.set(144, 340), this.onBet.position.set(144, 410), this.betValue.position.set(144, this.onBet.y + this.onBet.height), this.featureButton.position.set(38, 540)) : (this.buyFor.show(), this.buyValue.show(), this.header.hide(), this.featureButton.texture = this.game.loader.getAsset("riskTexture", "ex" === this.game.i18n.language ? "btn-get" : "btn_buy"), this.buyValue.text = "".concat(Lt.helpers.toMoneySS(i.bet)), this.betValue.text = "".concat(Lt.helpers.toMoneySS(this.game.betLevel.toCoins())), this.labelCount.text = i.freespins, this.labelCount.position.set(143, 80), this.freespinsText.position.set(144, 230), this.buyFor.position.set(144, 295), this.buyValue.position.set(144, this.buyFor.y + this.buyFor.height), this.onBet.position.set(144, 410), this.betValue.position.set(144, this.onBet.y + this.onBet.height), this.featureButton.position.set(38, 540)), this.resize()
                        }
                    }
                    hide() {
                        super.hide(), this.backgroundContent.renderable = !1, this.background.scale.set(1), this.backgroundContent.scale.set(1), this.featureButton.interactive = !1
                    }
                    resize() {
                        this.game.device.desktop || this.game.device.landscape ? (this.scale.set(1), this.position.set(1650, 180), this.game.device.desktop || (this.scale.set(1.3), this.game.leftHand.enabled ? this.position.set(1550, 80) : this.position.set(0, 80))) : (this.scale.set(1.5), this.position.set(650, 160))
                    }
                }
                class dn extends Y.K3 {
                    constructor(t) {
                ...
                class pn extends(Vt(Q.W2)) {
                    constructor(t) {
                        var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [];
                        super(), (0, n.Z)(this, "lines", void 0), (0, n.Z)(this, "points", new Map), this.lines = t.map((t => this.addChild(new dn(t)))), this.game.device.desktop && e.map((t => this.points.set(t.line, t.position.map((e => {
                            var i = this.addChild(new un(t.line));
                ...
                class An {
                    constructor() {
                        (0, n.Z)(this, "container", void 0), (0, n.Z)(this, "timeline", void 0), (0, n.Z)(this, "textValue", void 0), (0, n.Z)(this, "textDescription", void 0), this.timeline = new C, this.container = new $.j(Lt.loader.getAsset("winBg")), this.container.name = "TextFreeLeft", this.container.anchor.set(.5), this.container.alpha = 0, this.textValue = new v.Xz("", {
                            fontName: "WinFont"
                        }), this.textValue.anchor = .5, this.textDescription = new $.j(Lt.loader.getAsset("textFreeSpinLeft")), this.textDescription.anchor.set(.5), this.container.addChild(this.textValue), this.container.addChild(this.textDescription)
                    }
                    show(t) {
                        ...
                        return new Promise((i => {
                            ...
                            }, t < 1 ? (this.textValue.text = "", this.textDescription.texture = Lt.loader.getAsset("textLastFreeSpin"), this.textDescription.pivot.y = -15, this.timeline.set(this.container, {
                                pixi: {
                                    y: e,
                                    alpha: 0,
                                    scale: 1
                            ...
                            }, "+=0.75")) : (this.textValue.text = "".concat(t), this.textDescription.texture = Lt.loader.getAsset("textFreeSpinLeft"), this.textValue.position.set(0, -120), this.textDescription.pivot.y = -30, this.timeline.set(this.container, {
                                pixi: {
                                    y: e,
                                    alpha: 0,
                                    scale: 1
                ...
                const bn = class extends vn {
                    ...
                    wildPayment(t) {
                        var e = this;
                        return (0, o.Z)((function*() {
                            e.slot.lines.hide(), e.slot.reels.forEach((t => {
                                t.overlay(), t.clearAnimation()
                            })), t.forEach((t => {
                                var [i, s] = t;
                                e._findSymbol(i, s).playAnimation("free")
                            })), yield Lt.delay(300)
                        }))()
                    }
                    scatterPayment(t) {
                        var e = this;
                        return (0, o.Z)((function*() {
                            var i = 13 === t.sym ? "Grave" : "Harp";
                            if (Lt.action.emit("sound:scatterWin", i), e.slot.reels.forEach((t => t.overlay())), e.slot.lines.hide(), Lt.action.emit("textLineWin:hide"), e._runSymbolAnimation(t, !0, "free"), Lt.store.get("free:winAdditional", !1)) {
                                var s = Lt.store.get("free:left", 0);
                                Lt.action.emit("free:updateLeft", s)
                            }
                            yield Lt.delay(zi.get("reward_scatter"))
                        }))()
                    }
                    bonusPayment(t) {
                        var e = this;
                        return (0, o.Z)((function*() {
                            Lt.action.emit("sound:scatterWin", "Hunter"), e.slot.reels.forEach((t => t.overlay())), e.slot.lines.hide(), Lt.action.emit("textLineWin:hide"), e._runSymbolAnimation(t, !0, "bonus"), yield Lt.delay(2e3), e.stop(), e.slot.reels.forEach((t => t.overlay()))
                        }))()
                    }
                    complete() {
                    ...
                    return Lt.action.on("symbol:playAnimation", ((i, s, o) => {
                        if (! function(t, i) {
                            ...
                            if (e.push({
                                ...
                                var n = new vs(Lt.loader.getAsset(o.assetName));
                                if (n.name = o.assetName, n.alpha = 1, n.position.set(i, s), o.skin && n.changeSkin(o.skin), t.addChild(n), "string" == typeof o.effectName) n.play(o.effectName, !1);
                                else {
                ...
                class fn {
                    constructor() {
                        (0, n.Z)(this, "container", void 0), (0, n.Z)(this, "containerText", void 0), (0, n.Z)(this, "tween", void 0), this.container = new $.j(Lt.loader.getAsset("lineWinBg")), this.container.anchor.set(.5), this.container.alpha = 0, this.containerText = new v.Xz("", {
                            fontName: "SmallFont"
                        }), this.containerText.anchor = .5, this.containerText.y = -60, this.container.addChild(this.containerText)
                    }
                    show(t, e, i) {
                        this.container.scale.set(1), this.container.x = t, this.container.y = e, this.containerText.text = "".concat(Lt.i18n.currency({
                            bitmap: !0
                ...
                function xn(t) {
                    for (var e = 1; e < arguments.length; e++) {
                        ...
                        e % 2 ? wn(Object(i), !0).forEach((function(e) {
                            (0, n.Z)(t, e, i[e])
                        })) : Object.getOwnPropertyDescriptors ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(i)) : wn(Object(i)).forEach((function(e) {
                            Object.defineProperty(t, e, Object.getOwnPropertyDescriptor(i, e))
                        }))
                    }
                    return t
                ...
                function Bn(t, e, i) {
                    ...
                    function h() {
                        n.animation && (Lt.action.emit("symbol:stopAnimation", n.animation), s && (a.alpha = Sn))
                    }
                    return a.position.set(t, e), Object.assign(a, {
                        ...
                        getData: () => n,
                        playAnimation(t) {
                            s = !0, a.alpha = kn, Lt.action.emit("symbol:playAnimation", a.x, a.y, xn(xn({}, n.animation), {}, {
                                type: t,
                                texture: a.texture
                            }))
                        },
                ...
                class Pn extends Q.W2 {
                    ...
                    start() {
                        ...
                        this._endTween.duration(t), this._stopTimeoutDuration = Lt.quickSpin.enabled ? Lt.config.get("wheel.durationQuickStop") : Lt.config.get("wheel.durationStop"), this._startTween.restart(), this.children[0].visible = !0, this.children[this.children.length - 1].visible = !0
                    }
                    stop() {
                        if (!this.isStop) {
                    ...
                    _setup() {
                        ...
                        for (var i = 0, s = this._nReel.length; i < s; i++) {
                            var [o, n] = this.symbolsPositions[i], a = Bn(o, n, 0 === i || i === s - 1 ? this._nReel[i] : this._reel[i - 1]);
                            this.addChild(a), i > 0 && i < s - 1 && this.visibleSymbols.push(a)
                        }
                        this._startY = this.children[0].y, this.children[0].visible = !1, this.children[this.children.length - 1].visible = !1
                    }
                    _spin() {
                    ...
                    _complete() {
                        var t = Lt.store.get("reward:nReels", []);
                        this._nReel = t[this._reelIndex].concat(), this.y = 0, this._reel.length = 0, this._endTween.pause(), clearTimeout(this._stopTimeout), Lt.action.emit("wheel:stop", this._reelIndex), this.children[0].visible = !1, this.children[this.children.length - 1].visible = !1
                    }
                    _restoreWheelAfterFree() {
                        ...
                        this.children[0].replaceTexture(this._nReel[0]), this.children[4].replaceTexture(this._nReel[4])
                    }
                    update(t) {
                ...
                class Tn extends gn {
                    constructor() {
                        super(), (0, n.Z)(this, "animation", void 0), (0, n.Z)(this, "autoplayText", void 0), (0, n.Z)(this, "lines", void 0), (0, n.Z)(this, "reels", void 0), (0, n.Z)(this, "reelsContainer", void 0), (0, n.Z)(this, "scatterWaiting", void 0), (0, n.Z)(this, "slotData", void 0), (0, n.Z)(this, "stopReelCounter", void 0), (0, n.Z)(this, "symbolsPositions", void 0), (0, n.Z)(this, "textFreeLeft", void 0), (0, n.Z)(this, "textLineWin", void 0), (0, n.Z)(this, "textTotalWin", void 0), this.pivot.set(800, 0), this.reels = [], this.symbolsPositions = this.game.config.get("slot.symbolsPositions", []), this.animation = new bn(this), this.stopReelCounter = 0, this.init(), this.setupEvents()
                    }
                    ...
                    createMask() {
                        if (this.game.device.desktop && it.isWebGLSupported()) {
                            var t = this.createGradientMask(this.game.config.get("slot.width"), this.game.config.get("slot.height") + 70),
                                e = new $.j(t);
                            return e.position.y = -25, e
                        }
                        var i = new u.TC;
                        return i.beginFill(16711680, .8), i.drawRect(0, 12, this.game.config.get("slot.width"), this.game.config.get("slot.height") + 20), i.endFill(), i
                    }
                    init() {
                        var t, e, i = this.createMask();
                        this.reelsContainer = new Q.W2, this.reelsContainer.mask = i, this.reelsContainer.addChild(i);
                        for (var s, n, a, h, r, l = this.game.config.get("slot.size[0]"), c = 0; c < l; c++) {
                            var d = this.symbolsPositions[c],
                                u = new Pn(c, d);
                            this.reels.push(u), this.reelsContainer.addChild(u)
                        }
                        this.slotData = {
                            reels: this.reels.map((t => t.visibleSymbols)),
                            lines: null !== (t = null === (e = this.game.server) || void 0 === e ? void 0 : e.response.lines) && void 0 !== t ? t : []
                        }, this.lines = new pn(this.slotData.lines.map((t => ({
                            color: 16768776,
                            width: 4,
                            padding: 100,
                            points: t.map(((t, e) => {
                        ...
                        })))), this.scatterWaiting = (s = this.slotData, n = this.reels, a = [], h = [], (r = new Q.W2).name = "scatterWaitingContainer", s.reels.forEach(((t, e) => {
                            a.push([]), h.push([]), t.forEach((t => {
                                var i = new vs(Lt.loader.getAsset("circledSymEffect"));
                                i.position.set(t.x, t.y), i.renderable = !1, r.addChild(i), a[e].push(i);
                                var s = new vs(Lt.loader.getAsset("fsEffect"));
                                s.position.set(t.x, t.y), s.renderable = !1, r.addChild(s), h[e].push(s)
                            }))
                        })), {
                            getContainer: () => r,
                            play: (t, e, i) => (0, o.Z)((function*() {
                                var s = n[t].visibleSymbols[e];
                                try {
                                    var o;
                                    13 === i ? ((o = a[t][e]).renderable = !0, o.changeSkin("scatter_free_grave")) : 11 === i ? ((o = a[t][e]).renderable = !0, o.changeSkin("bonus_hunter")) : 14 === i && ((o = h[t][e]).renderable = !0, o.changeSkin("scatter_fs_harp")), s.visible = !1, yield o.play("waiting", !1), o.renderable = !1, s.visible = !0
                                } catch (t) {
                                    return console.error(t), t
                                }
                            }))()
                        }), this.textFreeLeft = new An, this.textFreeLeft.container.position.set(795, 660), this.textTotalWin = new mn(1), this.textTotalWin.setBackground("winBg"), this.textTotalWin.background.position.set(-540, -108), this.textTotalWin.position.set(795, 660), this.textLineWin = new fn;
                        var p = {
                            default: {
                                fontFamily: "Avenir-Medium",
                                fill: 16777215,
                        ...
                        this.autoplayText = new Te("", p), this.autoplayText.text = this.game.i18n.t("BonusAutoPlayText"), this.autoplayText.anchor.x = .5, this.autoplayText.position.set(786, 960), this.autoplayText.visible = !1, this.addChild(this.reelsContainer), this.addChild(this.lines), this.addChild(yn()), this.addChild(this.textLineWin.container), this.addChild(this.scatterWaiting.getContainer()), this.addChild(this.textTotalWin), this.addChild(this.textFreeLeft.container), this.addChild(this.autoplayText)
                    }
                    setupEvents() {
                        var t = this;
                        this.game.action.on("reward:reset", this._onResetReward, this), this.game.action.on("state:ready_enter", this._onReadyEnter, this), this.game.action.on("state:spin_enter", this._onSpinEnter, this), this.game.action.on("state:stop_enter", this._onStopEnter, this), this.game.action.on("free:start", (() => {
                            this.animation.stop(), this.reels.forEach(((t, e) => {
                                var i = this.game.store.get("reward:fsReels", []);
                                t.update(i[e]), t.updateNReels()
                            }))
                        })), this.game.action.on("free:stop", (() => {
                            this.animation.stop(), this.lines.enable()
                        })), this.game.action.on("free:select_start", (() => {
                            this.textTotalWin.setBackground("winBgFree"), k.fromTo(this, .5, {
                                pixi: {
                                    alpha: 0
                                }
                            }, {
                            ...
                            this.textTotalWin.setBackground("winBg"), k.fromTo(this, .5, {
                                pixi: {
                                    alpha: 0
                                }
                            }, {
                        ...
                        })), this.game.action.on("state:finish_enter", this._onFinishEnter, this), this.game.action.on("wheel:stop", this._onStopWheel, this), this.game.autoPlay.on("disable", (() => {
                            this.autoplayText.visible = !1
                        })), this.game.action.on("bonus:start", (() => {
                            this.autoplayText.visible = this.game.autoPlay.enabled
                        })), this.game.action.on("bonus:end", (0, o.Z)((function*() {
                            t.autoplayText.visible = !1
                        })))
                    }
                    restoreFreeSpins() {
                        this.alpha = 0
                    ...
                    _onFinishEnter() {
                        var t = this;
                        return (0, o.Z)((function*() {
                            t.stopReelCounter = 0, Hi.set(t.game.store.get("reward:feature")), t.game.store.get("free:isFree", !1) || (yield t.game.freeRound.finish()), t.game.autoPlay.enabled ? t.game.checkBalance().then((() => {
                        ...
                        return (0, o.Z)((function*() {
                            try {
                                if (!e.game.store.get("spin:isFast", !1)) {
                                    ...
                                    i.indexOf(13) > -1 ? (e.game.action.emit("sound:scatterWheel", "Grave"), yield e.scatterWaiting.play(t, i.indexOf(13), 13)) : i.indexOf(11) > -1 ? (e.game.action.emit("sound:scatterWheel", "Hunter"), yield e.scatterWaiting.play(t, i.indexOf(11), 11)) : i.indexOf(14) > -1 && (e.game.action.emit("sound:scatterWheel", "Harp"), yield e.scatterWaiting.play(t, i.indexOf(14), 14))
                                }
                    ...
                    resize() {
                        this.game.device.desktop || this.game.device.landscape ? (this.scale.set(1), this.position.set(960, 55), this.autoplayText.scale.set(1), this.autoplayText.position.set(786, 960)) : (this.scale.set(.646875), this.position.set(540, 247.5), this.autoplayText.scale.set(2), this.autoplayText.position.set(760, 1140))
                    }
                }
                class En extends(Vt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "timeline", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "value", void 0), (0, n.Z)(this, "light", void 0), (0, n.Z)(this, "coins", void 0), (0, n.Z)(this, "onPress", void 0), this.visible = !1, this.interactive = !0, this.onPress = new(x()), this.game.interaction.click(this, (() => this.onPress.dispatch())), this.timeline = new C, this.content = new Q.W2, this.overlay = new u.TC, this.overlay.beginFill(0, .75), this.overlay.drawRect(0, 0, this.game.config.get("application.width"), this.game.config.get("application.height")), this.overlay.endFill(), this.title = new $.j, this.title.anchor.set(.5), this.value = new v.Xz("", {
                            fontName: "WinFont"
                        }), this.value.anchor = .5, this.light = new vs(this.game.loader.getAsset("bigWinEffect")), this.light.alpha = 0, this.coins = new vs(this.game.loader.getAsset("bigWinEffect")), this.coins.alpha = 0, this.content.addChild(this.light), this.content.addChild(this.coins), this.content.addChild(this.title), this.content.addChild(this.value), this.addChild(this.overlay), this.addChild(this.content)
                    }
                    show(t, e) {
                        var i = 0;
                        ...
                        return new Promise((n => {
                            ...
                            this.timeline.to(this.overlay, .35, {
                                ...
                                roundProps: ["coins"],
                                onStart: () => {
                                    this.light.play("win_big", !0), this.light.alpha = 1
                                },
                                onUpdate: () => {
                                    !s && t === xe && a.coins > e / 2 && (this.title.texture = this.game.loader.getAsset("textGiantWin"), s = !0, this.coins.play("win_giant", !0), this.coins.alpha = 1, k.to(this.value, i / 2, {
                                        pixi: {
                                            scale: o + .2
                                        }
                    ...
                    break () {
                        var t = this.timeline.totalDuration(),
                            e = this.timeline.getLabelTime("break");
                        e / t > 0 && this.timeline.progress(e / t)
                    }
                    resize() {
                        this.game.device.desktop || this.game.device.landscape ? (this.scale.set(1), this.overlay.width = this.game.viewport.width, this.overlay.height = this.game.viewport.height, this.overlay.position.set(0, 0), this.content.position.set(this.game.viewport.width / 2, 300), this.light.scale.set(1), this.light.position.set(-940, -280), this.coins.scale.set(1), this.coins.position.set(-930, -350), this.title.scale.set(1), this.value.scale.set(.8), this.value.position.set(0, this.title.height + 50)) : (this.scale.set(.5625), this.overlay.height = (2 * this.game.viewport.paddingY + this.game.viewport.height) / .5625, this.overlay.width = (2 * this.game.viewport.paddingX + this.game.viewport.width) / .5625, this.overlay.position.set(-this.game.viewport.paddingX / .5625, 0), this.content.position.set(this.game.viewport.width / .5625 / 2, (this.game.viewport.height / .5625 - 500) / 2), this.light.scale.set(1.5), this.light.position.set(-1970, -800), this.coins.scale.set(2), this.coins.position.set(-1970, -1080), this.title.scale.set(2), this.value.scale.set(.8), this.value.position.set(0, this.title.height + 50))
                    }
                }
                new class extends class extends class extends class {
                    constructor(t) {
                        ...
                        })), Lt = this, et.vB.shared.autoStart = !1, et.vB.shared.stop(), this.config = new ht(Mt), this.logger = new Ct, this.rootNode = this.createRootNode(), this.renderer = new Bt, this.i18n = new bt(e), this.helpers = new vt(this.config), this.keyboard = new wt, this.device = new mt(this.renderer), this.viewport = new Zt, this.leftHand = new ut, this.fullscreen = this.device.ios || this.device.iPadPro ? new ct : new dt(this.device), this.visibility = new zt, this.preferences = new Ut, this.sound = new Z(this.device, this.visibility, this.preferences), this.state = new Ot, this.store = new ht, this.action = new gt, this.loader = new kt(this.device), this.error = new At, this.interaction = new yt(this.device), this.externalApi = new Rt(this), this.popupManager = new Dt(this.rootNode), this.create(), this.initAnalytics()
                    }
                    initAnalytics() {
                        return (0, o.Z)((function*() {
                            try {
                    ...
                    initPopups() {
                        this.popupManager.add([new Fi, new Pi, new Ti, new ki, new Ri, new Bi, new Oi, new Zi, new Ei, new Ci, new _i])
                    }
                    loadAssets(t) {
                    ...
                    createQuickSpinCheckbox() {
                        return this.checkboxQuickSpin = new ci, this.checkboxQuickSpin.onClick.add((() => {
                    ...
                    constructor() {
                        super({}), (0, n.Z)(this, "autoPlaySettings", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "betSettings", void 0), (0, n.Z)(this, "bigWinAnimation", void 0), (0, n.Z)(this, "bonus", void 0), (0, n.Z)(this, "fastStopLayout", void 0), (0, n.Z)(this, "freeOverlay", void 0), (0, n.Z)(this, "gameRules", void 0), (0, n.Z)(this, "menu", void 0), (0, n.Z)(this, "paytable", void 0), (0, n.Z)(this, "slot", void 0), qi.init(), this.init(Li, Ni)
                    }
                    loadTranslations() {
                    ...
                    initViews() {
                        var t, e, i = this;
                        super.initViews(), this.background = this.rootNode.addChild(new ys), this.slot = this.rootNode.addChild(new Tn), this.bonus = this.rootNode.addChild(new Bs(this.slot)), this.rootNode.addChild(this.bonus.overlay), this.riskFeature = this.rootNode.addChild(new cn), this.paytable = new zo(null !== (t = null === (e = this.server) || void 0 === e ? void 0 : e.response.lines) && void 0 !== t ? t : []), this.gameSettings = new ze, this.config.get("quickSpin.available", !0) && this.gameSettings.addItem(this.createQuickSpinCheckbox()), this.gameSettings.addItem(this.createFullscreenCheckbox()), this.gameSettings.addItem(this.createLeftHandCheckbox()), this.gameSettings.addItem(this.createGameSoundsCheckbox()), this.gameSettings.addItem(this.createBackgroundSoundsCheckbox()), this.gameSettings.addItem(this.createRiskFeatureCheckbox()), this.fastStopLayout = new Fe, this.bigWinAnimation = new En, this.controls = this.device.desktop ? new co : new xo, this.betSettings = this.rootNode.addChild(new Ee), this.betSettings.setBets(this.betLevel.bets, this.betLevel.betCoins), this.betSettings.setPayLines(20), this.betSettings.setBet(this.betLevel.bet), this.autoPlaySettings = this.rootNode.addChild(new ce), this.autoPlaySettings.setAutoPlayCounts(this.autoPlay.counts), this.autoPlaySettings.stopSection.addItem(new ke), this.autoPlaySettings.stopSection.addItem(new ye), this.autoPlaySettings.stopSection.addItem(new be), this.autoPlaySettings.stopSection.addItem(new Ae), this.autoPlaySettings.stopSection.addItem(new ve), this.gameRules = new Ue, this.menu = new He, this.menu.addItem(this.loader.getAsset("iconPaytable"), this.paytable), this.menu.addItem(this.loader.getAsset("iconSettings"), this.gameSettings), this.menu.addItem(this.loader.getAsset("iconRules"), this.gameRules), this.rootNode.addChild(this.fastStopLayout), this.rootNode.addChild(this.menu), this.rootNode.addChild(this.controls), this.rootNode.addChild(this.bigWinAnimation), this.freeOverlay = this.rootNode.addChild(new So), this.paytable.updateBet(this.betLevel), this.controls.updateBet(this.betLevel), this.betSettings.on("open", (() => {
                            ...
                            if (i.action.emit("sound:click"), i.onPopupShow(), i.riskFeature.hide(), i.wallet.balance - i.store.get("buy").bet < 0) yield i.popupManager.show("PopupZeroBalance"), i.onPopupHide();
                                ...
                                try {
                                    if (s) {
                                        ...
                                        }), Hi.set(i.store.get("reward:feature", Gi.Basic)), i.onRNBStart();
                                        var o = i.store.get("free:left", 0);
                                        i.action.emit("free:updateLeft", o), i.beforeFreeSpinsPopup(), yield i.freeOverlay.show(vo.START), setTimeout((() => {
                    ...
                    initStates() {
                        super.initStates(), this.state.add("setup", new as(this), ["ready"]), this.state.add("ready", new is(this), ["spin"]), this.state.add("spin", new rs(this), ["stop"]), this.state.add("stop", new cs(this), ["reward"]), this.state.add("reward", new os(this), ["finish"]), this.state.add("finish", new ts(this), ["ready"])
                    }
                    start() {
                        var t = () => super.start,
                            e = this;
                        return (0, o.Z)((function*() {
                            var i;
                            t().call(e), yield e.freeRound.start();
                            var s = e.store.get("reward:feature", Gi.Basic);
                            if ("bonus" === s && (yield e.popupManager.show("PopupRestore")), Hi.set(s), null === (i = e.sound.get("backgroundNormal")) || void 0 === i || i.fade(2), e.state.goTo("setup"), Hi.isFreespin()) {
                                e.slot.restoreFreeSpins();
                                var o = e.store.get("free:left", 0);
                                e.action.emit("free:updateLeft", o), yield e.freeOverlay.show(vo.RESTORE)
                            } else "bonus" === s && (yield e.bonus.show(!0), yield e.freeRound.finish());
                            e.state.goTo("ready")
                        }))()
                    }
                    beforeFreeSpinsPopup() {
                        this.background.reset(), this.slot.beforeFreeSpinsPopup(), this.controls.beforeFreeSpinsPopup()
                    }
                    reward() {
                        var t = this,
                            e = () => {
                        ...
                        return (0, o.Z)((function*() {
                            ...
                            var n = t.store.get("reward:lines", []).concat(),
                                ...
                                h = t.store.get("reward:wilds", []),
                                r = t.store.get("reward:bonus", !1);
                            if ((n.length > 0 || t.wallet.scatterCoins || t.wallet.bonusCoins) && (t.controls.disableButtonSpin(), a && n.unshift(a), r && n.unshift(r), t.slot.textTotalWin.once("show", (() => {
                                    t.fastStopLayout.press(s, !1), t.controls.pressButtonSpin(s)
                                })), yield t.slot.animation.allPayment(n), e()), h && h.length && (yield t.slot.animation.wildPayment(h), t.action.emit("sound:scatterWin", "Harp"), t.background.updateMultiplier(t.store.get("free:multiplier")), yield t.delay(zi.get("reward_scatter"))), a && 12 !== a.sym && (t.controls.disableButtonSpin(), yield t.slot.animation.scatterPayment(a)), r && (t.controls.disableButtonSpin(), yield t.slot.animation.bonusPayment(r), yield t.bonus.show(), e()), t.store.get("free:isStart", !1)) {
                                var l = t.store.get("free:left", 0);
                                t.action.emit("free:updateLeft", l), t.beforeFreeSpinsPopup(), yield t.freeOverlay.show(vo.START)
                            } else t.store.get("free:isEnd", !1) && (yield t.delay(zi.get("free_end")), t.beforeFreeSpinsPopup(), yield t.freeOverlay.show(vo.END), yield t.delay(200));
    ...
    n.m = s, t = [], n.O = (e, i, s, o) => {
    ...
    }), t), n.o = (t, e) => Object.prototype.hasOwnProperty.call(t, e), e = {}, i = "bennys_the_biggest_game:", n.l = (t, s, o, a) => {
        if (e[t]) e[t].push(s);
        else {
            var h, r;
            if (void 0 !== o)
        ...
        var e = (e, i) => {
            ...
            i = self.webpackChunkbennys_the_biggest_game = self.webpackChunkbennys_the_biggest_game || [];
        i.forEach(e.bind(null, 0)), i.push = e.bind(null, i.push.bind(i))
    })();
    var a = n.O(void 0, [216], (() => n(1045)));
    a = n.O(a)
})();