...
(() => {
    var t, e, i, s = {
            7778: (t, e, i) => {
                ...
                class U {
                    ...
                    readSkeletonData(t, e) {
                        ...
                        var s = i.readString(),
                            o = N(s),
                            n = null;
                        if (o === _.VER38 && (n = new D.SkeletonBinary(new D.AtlasAttachmentLoader(t))), (i = new R.BinaryInput(e)).readInt32(), i.readInt32(), (o = N(s = i.readString())) !== _.VER40 && o !== _.VER41 || (n = new L.SkeletonBinary(new L.AtlasAttachmentLoader(t))), !n) {
                ...
                var G = i(512),
                    ...
                    et = i(798),
                    it = i(5277);
                u.TC.nextRoundedRectBehavior = !0, A.xv.nextLineHeightBehavior = !0, c.R.add(p.bx, g.B9, d.Bv, a.c, h.Q, r.T, l.O, v.vl, m.o, V, f, Z), window.PIXI = s;
                var st = i(3233),
                    ot = i.n(st);
                                ...
                                for (var k = 0; k < x.length; k++) {
                                    ...
                                    if (0 === C.letterSpacing) w.push({
                                        ...
                                        for (var M = 0; M < B.length; M++) {
                                            (M > 0 || k > 0) && (S += C.letterSpacing / 2);
                                            var Z = this.context.measureText(B.charAt(M)).width;
                                            w.push({
                                                text: B.charAt(M),
                                                style: C,
                                                x: S,
                                                ...
                                                descent: P.descent,
                                                tag: F
                                            }), S += Z, (M < B.length - 1 || k < x.length - 1) && (S += C.letterSpacing / 2)
                                        }
                                    }
                                }
                                f += a[y] - n[y]
                ...
                class Ne extends(Vt(H.W2)) {
                    ...
                    addSections() {
                        this.content.addChild(new We), this.content.addChild(new De), this.content.addChild(new Le), this.addAutoPlaySection(), this.content.addChild(new Re), this.content.addChild(new _e), this.content.addChild(new je)
                    }
                    addAutoPlaySection() {
                        this.game.config.get("autoPlay.available", !0) && (this.content.addChild(new Ze), this.content.addChild(new Me))
                    }
                    open() {
                ...
                const Si = class extends It {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupFreeRound"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "icon", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContinue", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt, this.content = new H.W2, this.icon = new bi(ui), this.icon.anchor.x = .5, this.title = new xi(this.game.i18n.t("PopupFreeRoundStartTitle")), this.title.anchor.x = .5, this.message = new wi("", {
                            wordWrap: !0,
                            wordWrapWidth: 600
                ...
                const ki = class extends It {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupMaxLimit"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContinue", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt(.7), this.content = new H.W2, this.background = new $.j(this.game.loader.getAsset(mi)), this.background.anchor.set(.5), this.background.interactive = !0, this.background.name = "PopupBackground", this.title = new xi(this.game.i18n.t("PopupMaxLimitTitle")), this.title.anchor.x = .5, this.message = new wi(this.game.i18n.t("PopupMaxLimitMessage"), {
                            wordWrap: !0
                ...
                const Ci = class extends It {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupNetworkError"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "icon", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionReload", void 0), (0, n.Z)(this, "_resolver", null), this.overlay = this.addChild(new Jt), this.content = this.addChild(new H.W2), this.icon = new bi(pi), this.icon.anchor.x = .5, this.title = new xi(this.game.i18n.t("PopupNetworkErrorTitle"), {
                            align: "center"
                ...
                class Bi extends It {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupQuickSpin"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionEnable", void 0), (0, n.Z)(this, "actionClose", void 0), (0, n.Z)(this, "escKey", void 0), (0, n.Z)(this, "enterKey", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt(.7), this.content = new H.W2, this.background = new $.j(this.game.loader.getAsset(mi)), this.background.anchor.set(.5), this.background.interactive = !0, this.background.name = "PopupBackground", this.title = new xi(this.game.i18n.t("PopupQuickSpinTitle")), this.title.anchor.x = .5, this.message = new wi(this.game.i18n.t("PopupQuickSpinMessage"), {
                            fontSize: 35,
                            wordWrap: !0,
                            wordWrapWidth: 600
                ...
                const Ei = class extends It {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupRiskNBuy"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionYes", void 0), (0, n.Z)(this, "actionNo", void 0), (0, n.Z)(this, "escKey", void 0), (0, n.Z)(this, "enterKey", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt(.7), this.content = new H.W2, this.background = new $.j(this.game.loader.getAsset(mi)), this.background.anchor.set(.5), this.background.interactive = !0, this.background.name = "PopupBackground", this.title = new xi("RISK FEATURE"), this.title.anchor.x = .5, this.message = new wi("", {
                            wordWrap: !0,
                            whiteSpace: "normal",
                            breakWords: !0
                ...
                const Fi = class extends It {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupSpendingBudget"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContinue", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt(.7), this.content = new H.W2, this.background = new $.j(this.game.loader.getAsset(mi)), this.background.anchor.set(.5), this.background.interactive = !0, this.background.name = "PopupBackground", this.title = new xi(this.game.i18n.t("PopupSpendingBudgetTitle")), this.title.anchor.x = .5, this.message = new wi(this.game.i18n.t("PopupSpendingBudgetMessage"), {
                            wordWrap: !0
                        }), this.message.anchor.x = .5, this.actionContinue = new vi(this.game.i18n.t("PopupActionContinue"), {
                            fill: 10066329
                        }), this.actionContinue.anchor.x = .5, this.game.interaction.out(this.actionContinue, (() => this.actionContinue.style.fill = 10066329)), this.game.interaction.hover(this.actionContinue, (() => this.actionContinue.style.fill = 16777215)), this.game.interaction.click(this.actionContinue, (() => this.hide())), this.content.addChild(this.title), this.content.addChild(this.message), this.content.addChild(this.actionContinue), this.addChild(this.overlay), this.addChild(this.background), this.addChild(this.content)
                ...
                const Oi = class extends It {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupUnexpectedError"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContinue", void 0), (0, n.Z)(this, "_resolver", null), this.overlay = new Jt(.7), this.content = new H.W2, this.background = new $.j(this.game.loader.getAsset(mi)), this.background.anchor.set(.5), this.background.interactive = !0, this.background.name = "PopupBackground", this.title = new xi(this.game.i18n.t("PopupUnexpectedErrorTitle")), this.title.anchor.x = .5, this.message = new wi(this.game.i18n.t("PopupUnexpectedErrorMessage")), this.message.anchor.x = .5, this.actionContinue = new vi(this.game.i18n.t("PopupActionReload"), {
                            fill: 10066329
                        }), this.actionContinue.anchor.x = .5, this.game.interaction.out(this.actionContinue, (() => this.actionContinue.style.fill = 10066329)), this.game.interaction.hover(this.actionContinue, (() => this.actionContinue.style.fill = 16777215)), this.game.interaction.click(this.actionContinue, (() => this.hide())), this.content.addChild(this.title), this.content.addChild(this.message), this.content.addChild(this.actionContinue), this.addChild(this.overlay), this.addChild(this.background), this.addChild(this.content)
                    }
                    resize() {
                ...
                class Mi extends It {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupWilds"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionEnable", void 0), (0, n.Z)(this, "actionClose", void 0), (0, n.Z)(this, "escKey", void 0), (0, n.Z)(this, "spaceKey", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt(.7), this.content = new H.W2, this.background = new $.j(this.game.loader.getAsset(mi)), this.background.anchor.set(.5), this.background.interactive = !0, this.background.name = "PopupBackground", this.title = new xi(this.game.i18n.t("PopupWildsTitle"), {
                            fontSize: 40,
                            wordWrap: !0,
                            wordWrapWidth: 600,
                ...
                const Zi = class extends It {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupZeroBalance"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContinue", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt(.7), this.content = new H.W2, this.background = new $.j(this.game.loader.getAsset(mi)), this.background.anchor.set(.5), this.background.interactive = !0, this.background.name = "PopupBackground", this.title = new xi(this.game.i18n.t("PopupZeroBalanceTitle")), this.title.anchor.x = .5, this.message = new wi(this.game.i18n.t("PopupZeroBalanceMessage"), {
                            wordWrap: !0
                        }), this.message.anchor.x = .5, this.actionContinue = new vi(this.game.i18n.t("PopupActionContinue"), {
                            fill: 10066329
                        }), this.actionContinue.anchor.x = .5, this.game.interaction.out(this.actionContinue, (() => this.actionContinue.style.fill = 10066329)), this.game.interaction.hover(this.actionContinue, (() => this.actionContinue.style.fill = 16777215)), this.game.interaction.click(this.actionContinue, (() => this.hide())), this.content.addChild(this.title), this.content.addChild(this.message), this.content.addChild(this.actionContinue), this.addChild(this.overlay), this.addChild(this.background), this.addChild(this.content)
                ...
                const Di = [...[{
                    ...
                    url: "assets/audio/box_open_1.mp3",
                    name: "box_open_1",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"],
                        audioMetadata: {
                    ...
                    url: "assets/audio/box_open_2.mp3",
                    name: "box_open_2",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"],
                        audioMetadata: {
                    ...
                    url: "assets/audio/box_open_3.mp3",
                    name: "box_open_3",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"],
                        audioMetadata: {
                    ...
                    url: "assets/audio/box_open_4.mp3",
                    name: "box_open_4",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"],
                        audioMetadata: {
                    ...
                    url: "assets/audio/box_closed.mp3",
                    name: "boxClose",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"],
                        audioMetadata: {
                    ...
                    url: "assets/audio/expanding_wild.mp3",
                    name: "expandingWild",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"],
                        audioMetadata: {
                    ...
                    url: "assets/images/rightFeature/badge-inactive.png",
                    name: "badge-inactive",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                    ...
                    url: "assets/images/effects/man/skeleton.json",
                    name: "wildReelEffect",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                }, {
                    url: "assets/images/effects/box/skeleton.json",
                    name: "boxEffect",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                    ...
                    url: "assets/images/rightFeature/texture.json",
                    name: "feature",
                    metadata: {
                        platform: ["phone", "tablet", "desktop"]
                    }
                ...
                var zi = new class {
                    ...
                    isFreespin() {
                        return this.currentFeature.includes(ji.Freespin)
                    }
                };
                const Vi = {
                    init() {
                        function t(t) {
                            var e = ot()(t, "freespins.win", 0),
                                i = ot()(t, "feature", ji.Basic).includes("basic_") ? "mod" : ot()(t, "feature", ji.Basic).includes("freespin") ? "freespin" : "basic",
                        ...
                        init() {
                            ...
                            function e(e) {
                                var i = ot()(e, "win", 0),
                                    s = ot()(e, "scatters", !1),
                                    o = ot()(e, "bonus", !1);
                                Lt.store.set("reward:win", i), Lt.store.set("reward:lines", ot()(e, "lines", [])), Lt.store.set("reward:reels", ot()(e, "reels", e.error ? Gi : [])), Lt.store.set("reward:nReels", ot()(e, "nReels", e.error ? Qi : [])), Lt.store.set("reward:fsReels", ot()(e, "fsReels", [])), Lt.store.set("reward:preReels", ot()(e, "preSpin.reels", [])), Lt.store.set("reward:preSpin", ot()(e, "preSpin", [])), Lt.store.set("reward:scatters", s), Lt.store.set("reward:bonus", o), Lt.store.set("reward:isWin", i > 0 || s), Lt.store.set("reward:numberWinSymbol", ot()(e, "winSyms", 0)), Lt.store.set("isCurrenSpin", !1), Lt.store.set("reward:collection", ot()(e, "collection", []));
                                var n = ot()(e, "feature", ji.Basic);
                                Lt.store.set("reward:featureType", n);
                                var a = n.includes("freespin") ? "freespin" : "basic";
                                Lt.store.set("reward:feature", a), Lt.store.set("reward:modType", ""), t(e)
                            }

                            function i(e) {
                                var i = ot()(e, "win", 0);
                                Lt.store.set("reward:win", i), Lt.store.set("reward:lines", ot()(e, "lines", [])), Lt.store.set("reward:fsReels", ot()(e, "fsReels", [])), Lt.store.set("reward:reels", ot()(e, "reels", e.error ? Gi : [])), Lt.store.set("reward:nReels", ot()(e, "nReels", e.error ? Qi : []));
                                var s = ot()(e, "feature", ji.Basic);
                                Lt.store.set("reward:featureType", s);
                                var o = s.includes("freespin") ? "freespin" : "basic";
                                Lt.store.set("reward:feature", o), t(e)
                            }
                            Lt.store.set("reward:win", 0), Lt.store.set("reward:isWin", !1), Lt.store.set("reward:lines", []), Lt.store.set("reward:reels", []), Lt.store.set("reward:nReels", []), Lt.store.set("reward:fsReels", []), Lt.store.set("reward:preReels", []), Lt.store.set("reward:preSpin", []), Lt.store.set("reward:scatters", !1), Lt.store.set("reward:bonus", !1), Lt.store.set("reward:numberWinSymbol", 0), Lt.store.set("reward:feature", ""), Lt.store.set("reward:featureType", ""), Lt.store.set("reward:modType", !1), Lt.store.set("bonusGame:bonus", !1), Lt.store.set("reward:collection", []), Lt.server.on("response:init", e), Lt.server.on("response:spin", e), Lt.server.on("response:buyin", i), Lt.server.on("response:risk", i), Lt.server.on("response:bonus", (t => {
                                Lt.store.set("bonusGame:bonus", t), Lt.store.set("bonusGame:balance", t.balance), Lt.store.set("bonusGame:win", t.totalWin)
                            }))
                        }
                    },
                    Yi = {
                ...
                class Ki extends M {
                    constructor(t, e, i) {
                        super(t, e, i), (0, n.Z)(this, "backgroundFree", void 0), (0, n.Z)(this, "backgroundNormal", void 0), (0, n.Z)(this, "bigWin", void 0), (0, n.Z)(this, "bonusEnd", void 0), (0, n.Z)(this, "bonusStart", void 0), (0, n.Z)(this, "boxClose", void 0), (0, n.Z)(this, "boxOpen", void 0), (0, n.Z)(this, "boxOpen1", void 0), (0, n.Z)(this, "boxOpen2", void 0), (0, n.Z)(this, "boxOpen3", void 0), (0, n.Z)(this, "boxOpen4", void 0), (0, n.Z)(this, "clickNormal", void 0), (0, n.Z)(this, "currentWinSound", void 0), (0, n.Z)(this, "expandingWild", void 0), (0, n.Z)(this, "giantWin", void 0), (0, n.Z)(this, "scatterReel", void 0), (0, n.Z)(this, "scatterWin", void 0), (0, n.Z)(this, "spinFast", void 0), (0, n.Z)(this, "spinStart", void 0), (0, n.Z)(this, "wheelStop", void 0), (0, n.Z)(this, "winFree1", void 0), (0, n.Z)(this, "winFree2", void 0), (0, n.Z)(this, "winFree3", void 0), (0, n.Z)(this, "winNormal1", void 0), (0, n.Z)(this, "winNormal2", void 0), (0, n.Z)(this, "winNormal3", void 0), this.backgroundNormal = this.get("backgroundNormal"), this.backgroundFree = this.get("backgroundFree"), this.bonusStart = this.get("bonusStart"), this.bonusEnd = this.get("bonusEnd"), this.winNormal1 = this.get("win_normal_1"), this.winNormal2 = this.get("win_normal_2"), this.winNormal3 = this.get("win_normal_3"), this.winFree1 = this.get("win_free_1"), this.winFree2 = this.get("win_free_2"), this.winFree3 = this.get("win_free_3"), this.bigWin = this.get("bigWin"), this.giantWin = this.get("giantWin"), this.spinStart = this.get("spinStart"), this.spinFast = this.get("spinFast"), this.clickNormal = this.get("clickNormal"), this.wheelStop = this.get("wheelStop"), this.scatterWin = this.get("scatterWin"), this.scatterReel = this.get("scatterReel"), this.boxOpen1 = this.get("box_open_1"), this.boxOpen2 = this.get("box_open_2"), this.boxOpen3 = this.get("box_open_3"), this.boxOpen4 = this.get("box_open_4"), this.boxClose = this.get("boxClose"), this.boxOpen = this.get("boxOpen"), this.expandingWild = this.get("expandingWild"), this.currentWinSound = null, this._setupEvents()
                    }
                    _setupEvents() {
                        ...
                        })), Lt.action.on("state:spin_enter", this._onSpinEnter, this), Lt.action.on("state:finish_enter", this._onFinishEnter, this), Lt.action.on("sound:spinFast", this._onFastSpin, this), Lt.action.on("wheel:stop_down", this._onWheelStop, this), Lt.action.on("sound:click", this.click, this), Lt.action.on("sound:free_start", this._onFreeStart, this), Lt.action.on("sound:free_stop", this._onFreeStop, this), Lt.action.on("free:select_start", this._onSelectFreeStart, this), Lt.action.on("free:select_stop", this._onSelectFreeStop, this), Lt.action.on("box:open", (t => {
                            t > 4 && (t = 4), this["boxOpen".concat(t)].play()
                        })), Lt.action.on("box:close", (() => {
                            this.boxClose.play()
                        })), Lt.action.on("closeBoxes", (() => {
                            this.boxOpen.stop(), this.boxClose.play()
                        }))
                    }
                    stopBigWin() {
                ...
                const ls = JSON.parse('{"AutoPlaySettingsStopCondButtonReset":"Reset","AutoPlaySettingsStopCondCheckboxBalance":"If Balance Increases By","AutoPlaySettingsStopCondCheckboxBalanceDrop":"If Balance Decreases By","AutoPlaySettingsStopCondCheckboxFeatureBonus":"If Bonus Game Won","AutoPlaySettingsStopCondCheckboxFeatureFreeSpin":"If Free Spins Won","AutoPlaySettingsStopCondCheckboxWin":"If Win","AutoPlaySettingsStopCondCheckboxWinAny":"Any","AutoPlaySettingsStopCondCheckboxWinBig":"Big","AutoPlaySettingsStopCondCheckboxWinGiant":"Giant","AutoPlaySettingsStopCondTitle":"STOP AUTOPLAY","AutoPlaySettingsSubTitle":"Setup your best autoplay conditions","AutoPlaySettingsTitle":"AUTOPLAY","BetSettingsLines":"LINES\\n<value>%s</value>","BetSettingsTitle":"BET SETTINGS","BetSettingsWays":"WAYS\\n<value>%s</value>","ControlsDesktopAutoPlayStart":"AUTOPLAY","ControlsDesktopAutoPlayStop":"STOP AUTO","ControlsDesktopBalance":"BALANCE%s\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopBet":"BET %s\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopFreeRoundLeft":"FREE ROUND\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopFreeRoundWin":"TOTAL WIN %s\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopFreeRoundWinEmpty":"TOTAL WIN","ControlsDesktopFreeSpinsLast":"FREE SPINS LEFT\\n<delimiter> \\n</delimiter><value>LAST</value>","ControlsDesktopFreeSpinsLeft":"FREE SPINS LEFT\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopLines":"LINES\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopMaxBet":"MAX BET","ControlsDesktopTotalWin":"TOTAL WIN %s\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopWays":"WAYS\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopWin":"WIN %s\\n<delimiter> \\n</delimiter><value>%s</value>","Currency":"CURRENCY\\n<value>%s</value>","GameRulesAdvancedAutoPlayContent":"Advanced autoplay settings are available in the section with standard autoplay settings. You can set the conditions for stopping the game in automatic mode:\\n\\n<bold>if win any/big/giant</bold> - autoplay will be stopped after any/big/giant win\\n\\n<bold>if balance increased by 10%-100%</bold> - autoplay will stop when your balance increases by the selected %\\n\\n<bold>if balance decreased by 10%-100%</bold> - autoplay will be interrupted when your balance decreases by the selected %\\n\\nClick <bold>Reset</bold> to reset all autoplay settings","GameRulesAdvancedAutoPlayTitle":"Advanced Autoplay Settings","GameRulesAutoPlayContent":"Select the number of game rounds to play in automatic mode by pressing the button with the corresponding number, or press the button with the infinity sign to play in automatic mode until the autoplay is manually canceled or until the balance runs out. Your choice must be confirmed with the Start button.","GameRulesAutoPlayTitle":"Autoplay Options","GameRulesBestExperience":"Please note that you can only play one game at a time on each account. Therefore, you cannot play a game on more than one device, or multiple games on the same device simultaneously. Doing so may lead to various errors.\\n\\nFor the best gaming experience, we recommend using the latest version of the relevant software.","GameRulesGeneralRTP":"Theoretical RTP: %s %","GameRulesGeneralTitle":"General Info","GameRulesInterfaceAutoPlay":"Click to go to autoplay menu","GameRulesInterfaceBalance":"Here is your current balance","GameRulesInterfaceBetLevel":"Your current bet and a button to go to the bet size selection menu","GameRulesInterfaceContent":"All buttons of the game interface are listed below. Please note that the appearance and location of the buttons may differ slightly depending on the format in which the game is launched and what feature it is currently in.","GameRulesInterfaceMenu":"Click to access the game menu","GameRulesInterfaceQuickSpin":"Click to enable/disable quick spin","GameRulesInterfaceSound":"Turn game sound on/off and adjust sound volume","GameRulesInterfaceSpin":"Click to start the game round at the current bet. In the desktop version of the game, the button may have an alternative design","GameRulesInterfaceTitle":"Game Interface","GameRulesInterfaceWin":"Here is the win in the current game round","GameRulesSettingsContent":"To go to the settings menu, click the cogwheel icon in the game menu","GameRulesSettingsContentItemBackgroundSound":"<bold>Background music</bold> - turns on/off background music in the game","GameRulesSettingsContentItemFullscreen":"<bold>Full Screen</bold> - enables/disables full screen mode","GameRulesSettingsContentItemGameSound":"<bold>Game sound</bold> - turns on/off the sound effects of the game","GameRulesSettingsContentItemQuickSpin":"<bold>Quick Spin</bold> - turns on/off the function of the accelerated mode of rotation and stop of the reels","GameRulesSettingsTitle":"Game Settings","GameSettingsBackgroundSounds":"Background Music","GameSettingsFullscreen":"Full Screen","GameSettingsGameSounds":"Game Sounds","GameSettingsIntroScreen":"Intro Screen","GameSettingsLeftHand":"Left Hand Mode","GameSettingsQuickSpin":"Quick Spin","GameSettingsRiskFeatureCheckbox":"Risk&Buy","GameSettingsTitle":"GAME SETTINGS","IntroScreenHideButtonText":"Don\'t show next time","IntroScreenLoaderText":"LOADING","MenuDesktopButtonFullscreen":"FULLSCREEN","MenuDesktopButtonHome":"HOME","MenuDesktopButtonPaytable":"PAYTABLE","MenuDesktopButtonQuickspin":"QUICKSPIN","MenuDesktopButtonSound":"SOUND","MenuGameRules":"GAME INFORMATION","MenuMobileBetSettingsTitle":"BET SETTINGS","MenuMobileGameSettingsLeftHand":"Left Hand Mode","MenuMobileGameSettingsQuickspin":"Quick Spin","MenuMobileGameSettingsSounds":"Game Sounds","MenuMobileGameSettingsTitle":"GAME SETTINGS","MenuMobilePaytableTitle":"PAYTABLE","MenuPaytable":"PAYTABLE","MenuSettings":"SETTINGS","NetPositionTitle":"Net Position: %s","PopupActionClose":"Close","PopupActionContinue":"Continue","PopupActionEnable":"Enable","PopupActionNo":"No","PopupActionReload":"Reload","PopupActionYes":"Yes","PopupFreeRoundEndMessage":"The next spins will use your bonus amount","PopupFreeRoundEndTitle":"Free Rounds Finished","PopupFreeRoundLastMessage":"Congratulations, you have\\n last free round","PopupFreeRoundStartMessage":"Congratulations, you have\\n%s free rounds","PopupFreeRoundStartTitle":"Free Rounds Bonus","PopupFreeSpinsButton":"CLICK ANYWHERE TO CONTINUE","PopupFreeSpinsStopDescription":"<value>%s FREE SPINS</value> PLAYED","PopupFreeSpinsStopDescriptionNew":"%s Free Spins played","PopupFreeSpinsTitle":"CONGRATULATIONS","PopupFreeSpinsTitleNew":"CONGRATULATIONS! YOU WON","PopupFreeSpinsTitleRestore":"IN-GAME FEATURE RESTORED!","PopupFreeSpinsWinRestore":"<value>%s FREE SPINS</value> LEFT","PopupFreeSpinsWinRestoreLast":"<value>LAST FREE SPIN</value> LEFT","PopupFreeSpinsWinStart":"YOU WON <value>%s FREE SPINS</value>","PopupFreeSpinsWinStartNew":"%s FREE SPINS","PopupFreeSpinsWinStop":"YOU WON <value>%s</value>","PopupFreeSpinsWinStopNew":"<value>%s</value>","PopupMaxLimitMessage":"Bet exceeded max bet limit.","PopupMaxLimitTitle":"Max limit","PopupNetworkErrorMessage":"Please reload the game.","PopupNetworkErrorTitle":"Connection Lost","PopupQuickSpinMessage":"It seems you prefer to play a bit faster.\\nWould you like to enable Quick Spin?","PopupQuickSpinTitle":"Quick Spin","PopupRestoreMessage":"In-game feature restored!","PopupRiskNBuyContentBuy":"Buy in a feature for %s\\nthat will play at the bet %s","PopupRiskNBuyContentRisk":"Take the risk of winning %s\\nto get a feature at the bet %s","PopupRiskNBuyTitleBuy":"BUY IN FEATURE","PopupRiskNBuyTitleRisk":"RISK FEATURE","PopupSoundMessage":"Play with sound?","PopupSpendingBudgetMessage":"You have reached your play limit.\\nWelcome back later.","PopupSpendingBudgetTitle":"Play limit","PopupUnexpectedErrorMessage":"An unexpected situation.\\nReload the page.","PopupUnexpectedErrorTitle":"Unexpected situation","PopupZeroBalanceMessage":"Please change your BET LEVEL or top up your balance","PopupZeroBalanceTitle":"Insufficient funds","RiskNBuyBuyFor":"BUY FOR %s","RiskNBuyFreeSpinsText":"FREE SPINS","RiskNBuyOnBet":"ON BET %s","RiskNBuySubHeader":"RISK YOUR WIN\\nTO PLAY","StatusBarMobileBalance":"BALANCE %s\\n","StatusBarMobileBet":"BET %s\\n","StatusBarMobileFreeLast":"FREE SPINS LEFT\\n<value>LAST</value>","StatusBarMobileFreeLeft":"FREE SPINS LEFT\\n<value>%s</value>","StatusBarMobileFreePlayed":"FREE SPINS PLAYED\\n","StatusBarMobileFreeRoundLeft":"FREE ROUND\\n","StatusBarMobileTotalWin":"TOTAL WIN %s\\n","StatusBarMobileWin":"WIN %s\\n","TimeElapsedTitle":"Time Elapsed: %s"}'),
                    ds = JSON.parse('{"IntroScreenDescription0":"Win modifiers: up to 3 different wilds, multipliers up to x5","IntroScreenDescription1":"Win Free Spins with the current modifier","IntroScreenDescription2":"Buy Free Spins or risk your winnings for them","PaytableSectionBetLinesContent1":"Only the highest win per bet line is paid. All prizes are for combinations left to right, beginning from the leftmost reel. The payout values are based on the currently selected bet and change proportionally with its changes. The game is played with fixed bet lines. Malfunction voids all pays and plays.","PaytableSectionBetLinesTitle":"Bet Lines","PaytableSectionFreeContent1":"Free Spins play automatically at the bet and with the modifier at which they were won. All payments are made in accordance with the paytable, considering active modifiers.\\n\\nAdditional Free Spins can be won in the current Free Spins series, preserving active modifiers.","PaytableSectionFreeTitle":"Free Spins feature","PaytableSectionModifierContent1":"Each non-winning spin activates a new win modifier. All active win modifiers will be applied together with the next spin winnings calculation. The actual modifiers at the time of the Free Spins activation will be active throughout the Free Spins series without any change.\\n\\nActivation and deactivation of the modifiers occur in the base game only. Any winnings deactivate all modifiers. Modifiers are valid only at the bet at which they were revealed.\\n\\nOnly 4 modifiers can be active at a time. Modifiers are activated strictly in the indicated sequence.","PaytableSectionModifierContent2":"The Witch symbol becomes wild and substitutes all symbols except for Scatter symbol.","PaytableSectionModifierContent3":"The Monster symbol becomes wild and substitutes all symbols except for Scatter symbol.","PaytableSectionModifierContent4":"The Man symbol becomes wild and substitutes all symbols except for Scatter symbol.","PaytableSectionModifierContent5":"All winning combinations pay with x2 multiplier.","PaytableSectionModifierContent6":"All winning combinations pay with x3 multiplier. Deactivates previous modifier.","PaytableSectionModifierContent7":"All winning combinations pay with x5 multiplier. Deactivates previous modifier.","PaytableSectionModifierTitle":"Growing modifiers feature","PaytableSectionPayoutTitle":"Symbol payout values","PaytableSectionRiskContent1":"The Risk\'n\'Buy feature will be offered in the main game to the player after each spin, regardless of whether or not there is a win. The Risk\'n\'Buy feature will offer to either risk the current win and immediately go to the Free Spins feature, or buy the Free Spins feature at the specified cost and immediately go to them.\\n\\nFree Spins launched using the Risk\'n\'Buy feature play with the win modifiers active at the time of the Risk\'n\'Buy offer. The dots on the Risk\'n\'Buy badge indicate the current set of win modifiers.\\n\\nThe player makes his own decision to agree to the proposed version of the Risk\'n\'Buy feature or continue to the main game. The current winnings, in case of risk, or the indicated value, in case of a purchase, will be deducted from the player’s balance in the form of a bet. Free spins received in the Risk\'n\'Buy feature will occur at the bet at which it was accepted by the player. The Risk\'n\'Buy feature is not available in autoplay.","PaytableSectionRiskTitle":"Risk\'n\'Buy Feature","PaytableSectionScatterContent1":"Scatter symbols can appear in both the main game and Free Spins. 3, 4 or 5 Scatter symbols award 10 Free Spins that play with the actual modifier.","PaytableSectionScatterTitle":"Scatter symbols","PopupWarningContent":"If your current bet will be changed, your earned modifiers will be reset and no longer apply.\\n\\nWould you like to change your bet?"}');
                ...
                class gs extends(Vt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "backgroundLTextureFree", void 0), (0, n.Z)(this, "backgroundLTextureNormal", void 0), (0, n.Z)(this, "backgroundPTextureFree", void 0), (0, n.Z)(this, "backgroundPTextureNormal", void 0), (0, n.Z)(this, "backgroundTextureLandscape", void 0), (0, n.Z)(this, "backgroundTexturePortrait", void 0), (0, n.Z)(this, "bonusTitle", void 0), (0, n.Z)(this, "featureBackground", void 0), (0, n.Z)(this, "logo", void 0), this.backgroundLTextureNormal = this.game.loader.getAsset("bgln"), this.backgroundLTextureFree = this.game.loader.getAsset("bglf"), this.backgroundPTextureNormal = this.game.loader.getAsset("bgpn"), this.backgroundPTextureFree = this.game.loader.getAsset("bgpf"), this.backgroundTextureLandscape = this.backgroundLTextureNormal, this.backgroundTexturePortrait = this.backgroundPTextureNormal, this.background = new $.j(this.backgroundTextureLandscape), this.background.name = "background", this.featureBackground = new $.j(this.backgroundLTextureFree), this.featureBackground.name = "featureBackground", this.featureBackground.alpha = 0, this.logo = new $.j(this.game.loader.getAsset("logo")), this.logo.anchor.x = .5, this.logo.position.set(110, 14), this.bonusTitle = new A.xv("", {
                            fill: 16771720,
                            fontSize: 40,
                            fontFamily: "Avenir-Bold",
                            aling: "center"
                        }), this.bonusTitle.text = "SHOOT THE TARGET!", this.bonusTitle.anchor.x = .5, this.bonusTitle.visible = !1, this.bonusTitle.position.set(this.background.width / 2, this.background.height - 2 * this.bonusTitle.height), this.addChild(this.background), this.addChild(this.featureBackground), this.addChild(this.logo), this.addChild(this.bonusTitle), this.setupEvents()
                    }
                    setupEvents() {
                ...
                class Ps extends(Vt(H.W2)) {
                    constructor() {
                        ...
                        var e = new ks(d.xE.from(ys), 0);
                        e.width = 12, e.height = 151;
                        var i = new ks(d.xE.from(ys), 4914792);
                ...
                class Ds extends Fs {
                    constructor(t) {
                        ...
                        })), this.betLevel = t, this.betLevelText = this.addChild(new Pe("", Is(Is({}, Rs.Common), {}, {
                            default: Is(Is({}, Rs.Common.default), {}, {
                                align: "left"
                            })
                                ...
                                if (l) {
                                    ...
                                    switch (l.type) {
                                        ...
                                        case R.AttachmentType.Mesh:
                                            ...
                                            break;
                                        case R.AttachmentType.Clipping:
                ...
                class Ys extends Pe {
                    constructor() {
                        super("", Hs(Hs({}, Rs.Common), {}, {
                            default: Hs(Hs({}, Rs.Common.default), {}, {
                                align: "right"
                            })
                        }))
                    }
                ...
                class Xs extends Pe {
                    constructor() {
                        super("", Rs.FreeSpins), this.visible = !1
                    }
                    change(t) {
                ...
                class Js extends Pe {
                    constructor() {
                        super("", qs(qs({}, Rs.Common), {}, {
                            default: qs(qs({}, Rs.Common.default), {}, {
                                fill: Lt.config.get("colors.primary"),
                                fontFamily: "Avenir-Bold"
                            }),
                            value: qs(qs({}, Rs.Common.value), {}, {
                                fontSize: 66
                            })
                        })), this.visible = !1
                    }
                ...
                class $s extends Pe {
                    constructor() {
                        super("", Rs.Common), this.anchor.x = .5
                    }
                    update(t) {
                        var e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
                ...
                class to extends Ts {
                    constructor() {
                        ...
                        this.background = $.j.from("data:image/png;base64,"), this.background.alpha = .4, this.background.anchor.set(0, 1), this.background.position.set(0, this.game.viewport.height), this.buttonMenu = new bs, this.buttonMenu.position.set(77, 1013), this.buttonMaxBet = new Ds(this.game.betLevel), this.buttonMaxBet.position.set(213, 1013), this.buttonAutoPlay = new As, this.buttonAutoPlay.position.set(833, 1013), this.buttonQuickSpin = new fs, this.buttonQuickSpin.position.set(1084, 1014), this.buttonSound = new Es, this.buttonSound.position.set(1840, 1012), this.buttonSpin = function() {
                            ...
                            e.hitArea = new X.Circle(89, 93, e.height / 2), e.name = "buttonSpin", e.onClick.add(o);
                            var i = Lt.keyboard.register(Lt.keyboard.KEY_CODE.Space);
                            i.onPress.add(o), i.disable();
                            var s = new js(Lt.loader.getAsset("effectSpin"));

                            function o() {
                                t.handlers(!0) ? t.dispatch() : (Lt.store.get("spin:isSpin", !1) || s.play("press"), Lt.action.emit("clickSpin"))
                            }
                            ...
                            function a() {
                                zi.isFreespin() || (s.play("active", !1), e.enable(), i.enable())
                            }
                            ...
                            function l() {
                                i.enable(), zi.isFreespin() || (e.visible = !0), Lt.autoPlay.enabled || s.play("active")
                            }
                            return s.position.set(0, 0), e.addChild(s), s.play("active"), e.onHover.add((() => {
                                s.play("hover")
                            ...
                            })), Lt.action.on("free:select_start", r), {
                                container: e,
                                hide() {
                                    e.visible = !1
                                },
                ...
                class uo extends Ts {
                    constructor() {
                        ...
                        })), this.buttonMenu = new bs, this.buttonSound = new Es, this.buttonSpin = new co, this.game.interaction.hover(this.buttonSpin, (() => {
                        ...
                        })), this.buttonAccept = new vs, this.buttonQuickSpin = new fs, this.autoPlayButton = new As, this.autoPlayButton.scale.set(1.6), this.betButton = new Fs, this.betButton.disable(), this.betButton.onClick.add((() => this.game.action.emit("clickMaxBet"))), this.game.action.on("update:win", (() => {
                        ...
                        })), this.game.action.on("warning:show", (() => {
                            this.interactiveChildren = !1
                        })), this.game.action.on("warning:hide", (() => {
                ...
                class po extends(Vt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "featureType", void 0), (0, n.Z)(this, "modifiers", void 0), (0, n.Z)(this, "textures", void 0), (0, n.Z)(this, "types", void 0), this.modifiers = [], this.textures = ["paytable_witch", "paytable_monster", "paytable_man", "box-x2", "box-x3", "box-x5"], this.types = ["freespin_1w", "freespin_2w", "freespin_3w", "freespin_x2", "freespin_x3", "freespin_x5"], this.textures.forEach((t => {
                            this.modifiers.push(new $.j(this.game.loader.getAsset("symbols_static", t)))
                        }))
                    }
                    show() {
                        if (this.featureType = this.types.indexOf(this.game.store.get("reward:featureType")), -1 !== this.featureType)
                            for (var t = 0; t <= this.featureType; t++) {
                                var e = this.modifiers[t];
                                t < 4 ? (e.x = (e.width - 30) * t, this.addChild(e)) : (e.x = 3 * (e.width - 30), this.removeChildAt(3), this.addChild(e))
                            }
                    }
                    hide() {
                        this.removeChildren()
                ...
                class go extends(Vt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "_timeline", void 0), (0, n.Z)(this, "_keyboardSpace", void 0), (0, n.Z)(this, "_content", void 0), (0, n.Z)(this, "_title", void 0), (0, n.Z)(this, "_win", void 0), (0, n.Z)(this, "_description", void 0), (0, n.Z)(this, "_buttonText", void 0), (0, n.Z)(this, "tweenAutoTimeout", void 0), (0, n.Z)(this, "completeResolve", void 0), (0, n.Z)(this, "_modifiers", void 0), this.visible = !1, this.completeResolve = !1, this.cursor = "pointer", this.interactive = !1, this._content = this.addChild(new H.W2), this._content.interactive = !1, this._content.interactiveChildren = !1, this._title = this._content.addChild(new Pe("", {
                            default: {
                                fill: "#ffffff",
                                fontFamily: "PT Sans Narrow Bold",
                                fontSize: 78,
                        ...
                        })), this._win.anchor.set(.5), this._win.position.set(0, 300), this._modifiers = this._content.addChild(new po), this._description = this._content.addChild(new Pe("", {
                            default: {
                                fontFamily: "PT Sans Narrow Bold",
                                fill: "#ffffff",
                                align: "center",
                    ...
                    hide() {
                        this._modifiers.hide(), this.interactive = !1, this._keyboardSpace.disable(), this._buttonText.scale.set(1), this.tweenAutoTimeout && (this.tweenAutoTimeout.kill(), this.tweenAutoTimeout = null);
                    ...
                    show(t) {
                        ...
                        return new Promise((i => {
                            ...
                            if (t === ao.START) {
                                ...
                                this._title.text = this.game.i18n.t("PopupFreeSpinsTitle"), this._win.text = this.game.i18n.t("PopupFreeSpinsWinStart", o), this._description.text = "", this._buttonText.text = this.game.i18n.t("PopupFreeSpinsButton"), this._modifiers.show(), this._modifiers.position.set(-this._modifiers.width / 2, this._win.height > 200 ? 400 : 375), e && (this.tweenAutoTimeout = k.to(this._buttonText, 1, {
                                    pixi: {
                                        scale: 1.1
                                    },
                                    repeat: 5,
                                ...
                                0 === h ? (this._title.text = this.game.i18n.t("PopupFreeSpinsTitleRestore"), this._win.text = this.game.i18n.t("PopupFreeSpinsWinRestoreLast"), this._description.text = "", this._buttonText.text = this.game.i18n.t("PopupFreeSpinsButton")) : (this._title.text = this.game.i18n.t("PopupFreeSpinsTitleRestore"), this._win.text = this.game.i18n.t("PopupFreeSpinsWinRestore", h), this._description.text = "", this._buttonText.text = this.game.i18n.t("PopupFreeSpinsButton")), this._modifiers.show(), this._modifiers.position.set(-this._modifiers.width / 2, this._win.height > 200 ? 400 : 375)
                            }
                    ...
                    resize() {
                        this.hitArea = new X.Rectangle(-this.game.viewport.paddingX, 0, this.game.viewport.width + 2 * this.game.viewport.paddingX, this.game.viewport.height), this._title.setTagStyle("default", {
                            wordWrapWidth: this.game.device.portrait && !this.game.device.desktop ? this.game.viewport.width / 1.2 : this.game.viewport.width / 2,
                ...
                class bo extends(Vt(H.W2)) {
                    constructor(t) {
                        super(), (0, n.Z)(this, "left", void 0), (0, n.Z)(this, "right", void 0), this.renderable = t > 1, this.left = this.addChild(new vo("left")), this.left.position.set(0, 0), this.right = this.addChild(new vo("right")), this.right.position.set(910, 0)
                    }
                    get allArrows() {
                ...
                class wo extends(Vt(H.W2)) {
                    constructor(t, e) {
                        super(), (0, n.Z)(this, "buttonsContainer", void 0), this.buttonsContainer = this.addChild(new H.W2);
                        for (var i = 0; i < t; i++) {
                            var s = this.buttonsContainer.addChild(new fo);
                ...
                class xo extends(Vt(H.W2)) {
                    constructor(t) {
                        super(), (0, n.Z)(this, "button", void 0), (0, n.Z)(this, "buttonText", void 0), (0, n.Z)(this, "checked", void 0), (0, n.Z)(this, "onClick", void 0), this.interactive = !0, this.cursor = "pointer", this.checked = !1, this.onClick = new(x()), this.button = this.addChild(new fo), this.buttonText = this.addChild(new Pe("", {
                            default: {
                                fill: t,
                                fontFamily: "Avenir-Bold",
                                fontSize: 20,
                ...
                class So extends xo {
                    resize() {
                        this.game.device.desktop ? (this.position.set(280, 800), this.button.scale.set(1), this.buttonText.position.set(45, 26)) : (this.position.set(this.game.device.landscape ? 210 : 460, this.game.device.landscape ? 786 : 788), this.button.scale.set(1.6), this.buttonText.scale.set(1.4), this.buttonText.position.set(70, 37))
                    }
                }
                ...
                class Co extends ko {
                    constructor(t) {
                        super(t, arguments.length > 1 && void 0 !== arguments[1] && arguments[1]), this.featurePreview.anchor.x = .5, this.featurePreview.position.set(0, 0), this.description.anchor.x = .5, this.description.position.set(0, this.featurePreview.y + this.featurePreview.height - 15)
                    }
                    resize() {
                        this.description.setTagStyle("default", {
                            wordWrapWidth: this.game.viewport.width / 2.6
                        }), this.game.device.desktop ? (this.scale.set(1.1), this.position.set(960, 200)) : this.game.device.landscape ? (this.description.setTagStyle("default", {
                            wordWrapWidth: this.game.viewport.width / 2.6
                        }), this.scale.set(1.2), this.position.set(960, 130)) : (this.description.setTagStyle("default", {
                            wordWrapWidth: this.game.viewport.width / 1.7
                        }), this.scale.set(1.2), this.position.set(550, 140))
                    }
                }
                class Bo extends Ao {
                    constructor() {
                        super(), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "logo", void 0), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "playButtonBg", void 0), (0, n.Z)(this, "topLine1", void 0), (0, n.Z)(this, "topLine2", void 0), (0, n.Z)(this, "bottomLine", void 0), this.background = this.addChild(new $.j(this.game.loader.getAsset("bgln"))), this.overlay = this.addChild(new Jt(.75)), this.content = this.addChild(new H.W2), this.logo = this.content.addChild(new $.j(this.game.loader.getAsset("logo"))), this.topLine1 = this.content.addChild(this.createDelimeter(16762880, this.logo.width)), this.topLine2 = this.content.addChild(this.createDelimeter(16762880, 1700 - 2 * this.logo.width - 50)), this.bottomLine = this.content.addChild(this.createDelimeter(16762880, 1700)), this.topLine1.position.set(110, 122), this.topLine2.position.set(470, 122), this.logo.anchor.x = .5, this.logo.position.set(this.game.viewport.width / 2, 60), this.bottomLine.position.set(this.game.viewport.width / 2, 820), this.slides.push(this.content.addChild(new Co(0))), this.slides.push(this.content.addChild(new Co(1))), this.slides.push(this.content.addChild(new Co(2, !0))), this.pagination = this.content.addChild(new wo(this.visibleViewsCount, 50)), this.hideButton = this.content.addChild(new So("#ffeb3b")), this.arrows = this.content.addChild(new bo(this.visibleViewsCount)), this.arrows.right.position.set(910, 0), this.arrows.position.set(500, 420), this.playButton = this.content.addChild(new yo), this.playButton.anchor.set(.5), this.setupArrows(), this.setupPagination(), this.setupHideButton(), this.setupSlides()
                    }
                    resize() {
                        this.topLine1.position.set(110, 122), this.topLine2.position.set(470, 122), this.logo.position.set(380, 30), this.bottomLine.position.set(this.game.viewport.width / 2 - this.bottomLine.width / 2, 822), this.game.device.desktop ? (this.pagination.scale.set(1), this.pagination.position.set(910, 800)) : (this.pagination.scale.set(1.6), this.pagination.position.set(this.game.device.landscape ? 870 : 180, this.game.device.landscape ? 786 : 788)), this.game.device.tablet && this.game.device.portrait ? (this.content.scale.set(1.2), this.content.position.set(-100, 240)) : (this.content.scale.set(1), this.content.position.set(0, this.game.device.portrait && !this.game.device.desktop ? 400 : 0)), this.game.device.portrait && !this.game.device.desktop ? (this.background.texture = this.game.loader.getAsset("bgpn"), this.background.height = 2 * this.game.viewport.paddingY + this.game.viewport.height, this.background.width = 2 * this.game.viewport.paddingX + .5625 * this.background.height, this.background.position.set(-this.game.viewport.paddingX, 0), this.playButton.scale.set(1.4), this.playButton.position.set(520, 1040), this.logo.scale.set(1.2), this.logo.position.set(this.game.viewport.width / 2, -180), this.topLine2.position.set(-110, 122)) : (this.background.texture = this.game.loader.getAsset("bgln"), this.background.width = this.game.viewport.width, this.background.height = this.game.viewport.height, this.background.position.set(0, 0), this.logo.scale.set(1), this.logo.position.set(380, 30), this.playButton.scale.set(1), this.playButton.position.set(1480, 820), this.topLine2.position.set(470, 122))
                    }
                }
                class Po extends(Vt(H.W2)) {
                    constructor() {
                ...
                class Zo extends(Vt(H.W2)) {
                    constructor(t) {
                        var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [];
                        super(), (0, n.Z)(this, "_payTableBetLineBoxs", void 0), (0, n.Z)(this, "_payTableParagraph", void 0), (0, n.Z)(this, "_payTableTitle", void 0), this._payTableBetLineBoxs = new H.W2, this._payTableTitle = new Mo(this.game.i18n.t("PaytableSectionBetLinesTitle").toUpperCase()), this._payTableParagraph = new Oo(this.game.i18n.t("PaytableSectionBetLinesContent1")), t.forEach(((t, i) => {
                            var s = new Eo(i + 1, t, e);
                ...
                class Wo extends(Vt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "_sectionParagraph1", void 0), (0, n.Z)(this, "_sectionTitle", void 0), this.visible = this.game.config.get("rnb", !0), this._sectionTitle = new Mo(this.game.i18n.t("PaytableSectionRiskTitle").toUpperCase()), this._sectionTitle.position.set(0, 0), this._sectionParagraph1 = new Oo(this.game.i18n.t("PaytableSectionRiskContent1")), this._sectionParagraph1.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this.addChild(this._sectionTitle), this.addChild(this._sectionParagraph1)
                    }
                    resize() {
                ...
                class Io extends(Vt(H.W2)) {
                    constructor() {
                        ...
                        this._sectionTitle = new Mo(t.toUpperCase()), this._sectionTitle.position.set(0, 0), this._sectionParagraph = new Oo(this.game.i18n.t("PaytableSectionFreeContent1")), this._sectionParagraph.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this.addChild(this._sectionTitle), this.addChild(this._sectionParagraph)
                    }
                    resize() {
                ...
                class Lo extends(Vt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "_sectionParagraph1", void 0), (0, n.Z)(this, "_sectionParagraph2", void 0), (0, n.Z)(this, "_sectionParagraph3", void 0), (0, n.Z)(this, "_sectionParagraph4", void 0), (0, n.Z)(this, "_sectionParagraph5", void 0), (0, n.Z)(this, "_sectionParagraph6", void 0), (0, n.Z)(this, "_sectionParagraph7", void 0), (0, n.Z)(this, "_sectionTitle", void 0), (0, n.Z)(this, "_symbolModifier1", void 0), (0, n.Z)(this, "_symbolModifier2", void 0), (0, n.Z)(this, "_symbolModifier3", void 0), (0, n.Z)(this, "_symbolModifier4", void 0), (0, n.Z)(this, "_symbolModifier5", void 0), (0, n.Z)(this, "_symbolModifier6", void 0);
                        var t = this.game.i18n.t("PaytableSectionModifierTitle");
                        this._sectionTitle = new Mo(t.toUpperCase()), this._sectionTitle.position.set(0, 0), this._sectionParagraph1 = new Oo(this.game.i18n.t("PaytableSectionModifierContent1")), this._sectionParagraph1.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this._symbolModifier1 = new Do("wild-witch"), this._symbolModifier1.position.set(0, this._sectionParagraph1.y + this._sectionParagraph1.height + 30), this._symbolModifier1.withoutPayout(), this._sectionParagraph2 = new Oo(this.game.i18n.t("PaytableSectionModifierContent2")), this._sectionParagraph2.position.set(this._symbolModifier1.x + this._symbolModifier1.width, this._sectionParagraph1.y + this._sectionParagraph1.height + 30), this._sectionParagraph2.setTagStyle("default", {
                            wordWrapWidth: 690
                        }), this._symbolModifier2 = new Do("wild-monster"), this._symbolModifier2.position.set(0, this._symbolModifier1.height + this._symbolModifier1.y + 30), this._symbolModifier2.withoutPayout(), this._sectionParagraph3 = new Oo(this.game.i18n.t("PaytableSectionModifierContent3")), this._sectionParagraph3.position.set(this._symbolModifier2.x + this._symbolModifier2.width, this._symbolModifier1.height + this._symbolModifier1.y + 30), this._sectionParagraph3.setTagStyle("default", {
                            wordWrapWidth: 690
                        }), this._symbolModifier3 = new Do("man-wild"), this._symbolModifier3.position.set(0, this._symbolModifier2.height + this._symbolModifier2.y + 30), this._symbolModifier3.withoutPayout(), this._sectionParagraph4 = new Oo(this.game.i18n.t("PaytableSectionModifierContent4")), this._sectionParagraph4.position.set(this._symbolModifier3.x + this._symbolModifier3.width, this._symbolModifier2.height + this._symbolModifier2.y + 30), this._sectionParagraph4.setTagStyle("default", {
                            wordWrapWidth: 690
                        }), this._symbolModifier4 = new Do("box-x2"), this._symbolModifier4.position.set(0, this._symbolModifier3.height + this._symbolModifier3.y + 30), this._symbolModifier4.withoutPayout(), this._sectionParagraph5 = new Oo(this.game.i18n.t("PaytableSectionModifierContent5")), this._sectionParagraph5.position.set(this._symbolModifier4.x + this._symbolModifier4.width, this._symbolModifier3.height + this._symbolModifier3.y + 30), this._sectionParagraph5.setTagStyle("default", {
                            wordWrapWidth: 690
                        }), this._symbolModifier5 = new Do("box-x3"), this._symbolModifier5.position.set(0, this._symbolModifier4.height + this._symbolModifier4.y + 30), this._symbolModifier5.withoutPayout(), this._sectionParagraph6 = new Oo(this.game.i18n.t("PaytableSectionModifierContent6")), this._sectionParagraph6.position.set(this._symbolModifier5.x + this._symbolModifier5.width, this._symbolModifier4.height + this._symbolModifier4.y + 30), this._sectionParagraph6.setTagStyle("default", {
                            wordWrapWidth: 690
                        }), this._symbolModifier6 = new Do("box-x5"), this._symbolModifier6.position.set(0, this._symbolModifier5.height + this._symbolModifier5.y + 30), this._symbolModifier6.withoutPayout(), this._sectionParagraph7 = new Oo(this.game.i18n.t("PaytableSectionModifierContent7")), this._sectionParagraph7.position.set(this._symbolModifier6.x + this._symbolModifier6.width, this._symbolModifier5.height + this._symbolModifier5.y + 30), this._sectionParagraph7.setTagStyle("default", {
                            wordWrapWidth: 690
                        }), this.addChild(this._sectionTitle), this.addChild(this._sectionParagraph1), this.addChild(this._symbolModifier1), this.addChild(this._sectionParagraph2), this.addChild(this._symbolModifier2), this.addChild(this._sectionParagraph3), this.addChild(this._symbolModifier3), this.addChild(this._sectionParagraph4), this.addChild(this._symbolModifier4), this.addChild(this._sectionParagraph5), this.addChild(this._symbolModifier5), this.addChild(this._sectionParagraph6), this.addChild(this._symbolModifier6), this.addChild(this._sectionParagraph7)
                    }
                    updateBet(t) {
                        this._symbolModifier1.updateBet(t), this._symbolModifier2.updateBet(t), this._symbolModifier3.updateBet(t), this._symbolModifier4.updateBet(t), this._symbolModifier5.updateBet(t), this._symbolModifier6.updateBet(t)
                    }
                    resize() {
                        this.game.device.desktop || (this.game.device.landscape ? (this._sectionParagraph1.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this._symbolModifier1.position.set(0, this._sectionParagraph1.y + this._sectionParagraph1.height + 30), this._symbolModifier2.position.set(0, this._symbolModifier1.height + this._symbolModifier1.y + 30), this._symbolModifier3.position.set(0, this._symbolModifier2.height + this._symbolModifier2.y + 30), this._symbolModifier4.position.set(0, this._symbolModifier3.height + this._symbolModifier3.y + 30), this._symbolModifier5.position.set(0, this._symbolModifier4.height + this._symbolModifier4.y + 30), this._symbolModifier6.position.set(0, this._symbolModifier5.height + this._symbolModifier5.y + 30), this._sectionParagraph2.position.set(this._symbolModifier1.x + this._symbolModifier1.width, this._sectionParagraph1.y + this._sectionParagraph1.height + 30), this._sectionParagraph2.setTagStyle("default", {
                            wordWrapWidth: 490
                        }), this._sectionParagraph3.position.set(this._symbolModifier2.x + this._symbolModifier2.width, this._symbolModifier1.height + this._symbolModifier1.y + 30), this._sectionParagraph3.setTagStyle("default", {
                            wordWrapWidth: 490
                        }), this._sectionParagraph4.position.set(this._symbolModifier3.x + this._symbolModifier3.width, this._symbolModifier2.height + this._symbolModifier2.y + 30), this._sectionParagraph4.setTagStyle("default", {
                            wordWrapWidth: 490
                        }), this._sectionParagraph5.position.set(this._symbolModifier4.x + this._symbolModifier4.width, this._symbolModifier3.height + this._symbolModifier3.y + 30), this._sectionParagraph5.setTagStyle("default", {
                            wordWrapWidth: 490
                        }), this._sectionParagraph6.position.set(this._symbolModifier5.x + this._symbolModifier5.width, this._symbolModifier4.height + this._symbolModifier4.y + 30), this._sectionParagraph6.setTagStyle("default", {
                            wordWrapWidth: 490
                        }), this._sectionParagraph7.position.set(this._symbolModifier6.x + this._symbolModifier6.width, this._symbolModifier5.height + this._symbolModifier5.y + 30), this._sectionParagraph7.setTagStyle("default", {
                            wordWrapWidth: 490
                        })) : (this._sectionParagraph1.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this._symbolModifier1.position.set(0, this._sectionParagraph1.y + this._sectionParagraph1.height + 30), this._sectionParagraph2.position.set(0, this._symbolModifier1.height + this._symbolModifier1.y + 30), this._symbolModifier2.position.set(0, this._sectionParagraph2.height + this._sectionParagraph2.y + 30), this._sectionParagraph3.position.set(0, this._symbolModifier2.height + this._symbolModifier2.y + 30), this._symbolModifier3.position.set(0, this._sectionParagraph3.height + this._sectionParagraph3.y + 30), this._sectionParagraph4.position.set(0, this._symbolModifier3.height + this._symbolModifier3.y + 30), this._symbolModifier4.position.set(0, this._sectionParagraph4.height + this._sectionParagraph4.y + 30), this._sectionParagraph5.position.set(0, this._symbolModifier4.height + this._symbolModifier4.y + 30), this._symbolModifier5.position.set(0, this._sectionParagraph5.height + this._sectionParagraph5.y + 30), this._sectionParagraph6.position.set(0, this._symbolModifier5.height + this._symbolModifier5.y + 30), this._symbolModifier6.position.set(0, this._sectionParagraph6.height + this._sectionParagraph6.y + 30), this._sectionParagraph7.position.set(0, this._symbolModifier6.height + this._symbolModifier6.y + 30)))
                    }
                }
                class jo extends(Vt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "_sectionTitle", void 0), (0, n.Z)(this, "symbolA", void 0), (0, n.Z)(this, "symbolButcher", void 0), (0, n.Z)(this, "symbolGhost", void 0), (0, n.Z)(this, "symbolGuns", void 0), (0, n.Z)(this, "symbolJ", void 0), (0, n.Z)(this, "symbolK", void 0), (0, n.Z)(this, "symbolMan", void 0), (0, n.Z)(this, "symbolMonster", void 0), (0, n.Z)(this, "symbolQ", void 0), (0, n.Z)(this, "symbolSaw", void 0), (0, n.Z)(this, "symbolTen", void 0), (0, n.Z)(this, "symbolWitch", void 0), (0, n.Z)(this, "symbolZombie", void 0), (0, n.Z)(this, "symbols", void 0);
                        var t = this.game.i18n.t("PaytableSectionPayoutTitle");
                        this._sectionTitle = new Mo(t.toUpperCase()), this.symbolSaw = new Do("saw"), this.symbolSaw.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this.symbolGuns = new Do("guns"), this.symbolGuns.position.set(600, this._sectionTitle.y + this._sectionTitle.height + 30), this.symbolMan = new Do("man"), this.symbolMan.position.set(0, this.symbolSaw.y + this.symbolSaw.height + 30), this.symbolButcher = new Do("butcher"), this.symbolButcher.position.set(600, this.symbolGuns.y + this.symbolGuns.height + 30), this.symbolGhost = new Do("ghost"), this.symbolGhost.position.set(0, this.symbolButcher.y + this.symbolButcher.height + 30), this.symbolZombie = new Do("zombie"), this.symbolZombie.position.set(600, this.symbolMan.y + this.symbolMan.height + 30), this.symbolMonster = new Do("monster"), this.symbolMonster.position.set(0, this.symbolGhost.y + this.symbolGhost.height + 30), this.symbolWitch = new Do("witch"), this.symbolWitch.position.set(600, this.symbolZombie.y + this.symbolZombie.height + 30), this.symbolA = new Do("A"), this.symbolA.position.set(0, this.symbolMonster.y + this.symbolMonster.height + 30), this.symbolK = new Do("K"), this.symbolK.position.set(600, this.symbolWitch.y + this.symbolWitch.height + 30), this.symbolQ = new Do("Q"), this.symbolQ.position.set(0, this.symbolA.y + this.symbolA.height + 30), this.symbolJ = new Do("J"), this.symbolJ.position.set(600, this.symbolK.y + this.symbolK.height + 30), this.symbolTen = new Do("10"), this.symbolTen.position.set(0, this.symbolQ.y + this.symbolQ.height + 30), this.symbols = [this.symbolSaw, this.symbolGuns, this.symbolButcher, this.symbolGhost, this.symbolZombie, this.symbolMan, this.symbolMonster, this.symbolWitch, this.symbolA, this.symbolK, this.symbolQ, this.symbolJ, this.symbolTen], this.addChild(this._sectionTitle, ...this.symbols)
                    }
                    updateBet(t) {
                        this.symbols.forEach((e => e.updateBet(t)))
                    }
                    resize() {
                        this.game.device.desktop || (this.game.device.landscape ? (this.symbolSaw.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this.symbolGuns.position.set(820, this._sectionTitle.y + this._sectionTitle.height + 30), this.symbolMan.position.set(0, this.symbolSaw.y + this.symbolSaw.height + 30), this.symbolButcher.position.set(820, this.symbolGuns.y + this.symbolGuns.height + 30), this.symbolGhost.position.set(0, this.symbolMan.y + this.symbolMan.height + 30), this.symbolZombie.position.set(820, this.symbolButcher.y + this.symbolButcher.height + 30), this.symbolMonster.position.set(0, this.symbolGhost.y + this.symbolGhost.height + 30), this.symbolWitch.position.set(820, this.symbolZombie.y + this.symbolZombie.height + 30), this.symbolA.position.set(0, this.symbolMonster.y + this.symbolMonster.height + 30), this.symbolK.position.set(820, this.symbolWitch.y + this.symbolWitch.height + 30), this.symbolQ.position.set(0, this.symbolA.y + this.symbolA.height + 30), this.symbolJ.position.set(820, this.symbolK.y + this.symbolK.height + 30), this.symbolTen.position.set(0, this.symbolQ.y + this.symbolQ.height + 30)) : (this.symbolSaw.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this.symbolGuns.position.set(0, this.symbolSaw.y + this.symbolSaw.height + 30), this.symbolMan.position.set(0, this.symbolGuns.y + this.symbolGuns.height + 30), this.symbolButcher.position.set(0, this.symbolMan.y + this.symbolMan.height + 30), this.symbolGhost.position.set(0, this.symbolButcher.y + this.symbolButcher.height + 30), this.symbolZombie.position.set(0, this.symbolGhost.y + this.symbolGhost.height + 30), this.symbolMonster.position.set(0, this.symbolZombie.y + this.symbolZombie.height + 30), this.symbolWitch.position.set(0, this.symbolMonster.y + this.symbolMonster.height + 30), this.symbolA.position.set(0, this.symbolWitch.y + this.symbolWitch.height + 30), this.symbolK.position.set(0, this.symbolA.y + this.symbolA.height + 30), this.symbolQ.position.set(0, this.symbolK.y + this.symbolK.height + 30), this.symbolJ.position.set(0, this.symbolQ.y + this.symbolQ.height + 30), this.symbolTen.position.set(0, this.symbolJ.y + this.symbolJ.height + 30)))
                    }
                }
                class No extends(Vt(H.W2)) {
                    constructor() {
                        ...
                        this._sectionTitle = new Mo(t.toUpperCase()), this._sectionTitle.position.set(0, 0), this._symbolScatter = new Do("necronomicon"), this._symbolScatter.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this._symbolScatter.withoutPayout(), this._sectionParagraph = new Oo(this.game.i18n.t("PaytableSectionScatterContent1")), this._sectionParagraph.position.set(this._symbolScatter.x + this._symbolScatter.width, this._sectionTitle.y + this._sectionTitle.height + 30), this._sectionParagraph.setTagStyle("default", {
                            wordWrapWidth: 690
                        }), this.addChild(this._sectionTitle), this.addChild(this._symbolScatter), this.addChild(this._sectionParagraph)
                    }
                    updateBet(t) {
                        this._symbolScatter.updateBet(t)
                    }
                    resize() {
                        this.game.device.desktop || (this.game.device.landscape ? (this._symbolScatter.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this._sectionParagraph.position.set(this._symbolScatter.x + this._symbolScatter.width, this._sectionTitle.y + this._sectionTitle.height + 30), this._sectionParagraph.setTagStyle("default", {
                            wordWrapWidth: 490
                        })) : (this._symbolScatter.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this._sectionParagraph.position.set(0, this._symbolScatter.y + this._symbolScatter.height + 30), this._sectionParagraph.setTagStyle("default", {
                            wordWrapWidth: 390
                        })))
                    }
                }
                class Uo extends Po {
                    constructor(t) {
                        super(), (0, n.Z)(this, "_payTableSectionRisk", void 0), (0, n.Z)(this, "_paytableSectionBetLines", void 0), (0, n.Z)(this, "_paytableSectionFree", void 0), (0, n.Z)(this, "_paytableSectionModiier", void 0), (0, n.Z)(this, "_paytableSectionPayout", void 0), (0, n.Z)(this, "_paytableSectionScatter", void 0), (0, n.Z)(this, "payTableDelimiter", void 0), this.payTableDelimiter = new Ro, this._payTableSectionRisk = new Wo, this._paytableSectionPayout = new jo, this._paytableSectionScatter = new No, this._paytableSectionModiier = new Lo, this._paytableSectionFree = new Io, this._paytableSectionBetLines = new _o(t), this.content.addChild(this._payTableSectionRisk, this._paytableSectionPayout, this._paytableSectionScatter, this._paytableSectionModiier, this._paytableSectionFree, this.payTableDelimiter, this._paytableSectionBetLines)
                    }
                    updateBet(t) {
                        this._paytableSectionPayout.updateBet(t), this._paytableSectionScatter.updateBet(t), this._paytableSectionModiier.updateBet(t)
                    }
                }
                ...
                class an extends u.TC {
                    constructor(t) {
                        super(), this.name = t, this.alpha = 0, this.beginFill(16777215), this.drawCircle(0, 0, 10), this.endFill()
                    }
                }
                class hn extends H.W2 {
                    constructor() {
                        super(), this.addChild(new an("1w")), this.addChild(new an("2w")), this.addChild(new an("3w")), this.addChild(new an("x2")), this.addChild(new an("x3")), this.addChild(new an("x5")), this.children.forEach(((t, e) => t.position.set(30 * e, 0)))
                    }
                    show(t) {
                        var e = this.getChildByName(t);
                        if (e)
                            for (var i = 0, s = this.getChildIndex(e); i <= s; i++) this.children[i].alpha = 1
                    }
                    hide() {
                        for (var t = 0; t < this.children.length; t++) this.children[t].alpha = 0
                    }
                }
                class rn extends Xo {
                    createDelimeter(t, e) {
                    ...
                    constructor() {
                        super(), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "backgroundContent", void 0), (0, n.Z)(this, "betValue", void 0), (0, n.Z)(this, "buyFor", void 0), (0, n.Z)(this, "buyValue", void 0), (0, n.Z)(this, "featureButton", void 0), (0, n.Z)(this, "freespinsText", void 0), (0, n.Z)(this, "header", void 0), (0, n.Z)(this, "labelCount", void 0), (0, n.Z)(this, "modifiers", void 0), (0, n.Z)(this, "onBet", void 0), (0, n.Z)(this, "onPress", void 0), this.alpha = 0, this.position.set(1440, 90), this.onPress = new(x()), this.backgroundContent = this.addChild(new H.W2), this.backgroundContent.renderable = !1, this.background = this.backgroundContent.addChild(new $.j(this.game.loader.getAsset("risk", "buy_bg"))), this.header = this.background.addChild(new Jo({
                            default: {
                                wordWrapWidth: 250,
                                fontSize: 23
                            },
                        ...
                        })), this.labelCount = this.background.addChild(new v.Xz("", {
                            fontName: "WinFont"
                        })), this.labelCount.anchor.x = .5, this.labelCount.scale.set(.7), this.labelCount.letterSpacing = -10, this.freespinsText = this.background.addChild(new Pe("", {
                            default: {
                                fill: "#ffffff",
                                fontFamily: "Avenir-Bold",
                                fontSize: 37,
                        ...
                        })), this.freespinsText.anchor.x = .5, this.freespinsText.text = "FREE SPINS", this.buyFor = this.backgroundContent.addChild(new Go({
                            default: {
                                fill: "#ffffff",
                                fontSize: 20,
                                wordWrapWidth: 210
                            }
                        })), this.buyValue = this.backgroundContent.addChild(new Yo({
                            default: {
                                fill: "#ffffff",
                                fontSize: 50,
                                lineJoin: "round",
                        ...
                        })), this.onBet = this.backgroundContent.addChild(new en({
                            default: {
                                fontSize: 20,
                                wordWrapWidth: 210
                            }
                        })), this.betValue = this.backgroundContent.addChild(new nn({
                            default: {
                                fontSize: 50,
                                lineJoin: "round",
                                strokeThickness: 5
                            }
                        })), this.featureButton = this.background.addChild(new $.j(this.game.loader.getAsset("risk", "buy_btn"))), this.featureButton.cursor = "pointer", this.featureButton.interactive = !1, this.game.interaction.click(this.featureButton, (() => {
                            this.featureButton.interactive = !1, this.onPress.dispatch()
                        })), this.backgroundContent.renderable = !1, this.modifiers = this.addChild(new hn)
                    }
                    show(t) {
                        if (this.game.store.get("isRiskNBuy") && (super.show(t), this.visible)) {
                            var e = this.game.store.get("risk", !1),
                                ...
                                s = e ? e.type : i.type;
                            this.modifiers.show(s.substring(9, s.length)), this.backgroundContent.renderable = !0, k.to(this, .3, {
                                pixi: {
                                    alpha: 1
                                }
                            }), setTimeout((() => {
                                this.featureButton.interactive = !0
                            }), 150), e ? (this.buyFor.hide(), this.buyValue.hide(), this.header.show(), this.background.texture = this.game.loader.getAsset("risk", "risk_bg"), this.featureButton.texture = this.game.loader.getAsset("risk", "risk_btn"), this.betValue.text = "".concat(Lt.helpers.toMoneySS(this.game.betLevel.toCoins())), this.labelCount.text = e.freespins, this.header.position.set(137, 54), this.labelCount.position.set(134, 20), this.freespinsText.position.set(136, 317), this.onBet.position.set(136, 436), this.betValue.position.set(136, this.onBet.height + this.onBet.y), this.featureButton.position.set(0, 556)) : (this.buyFor.show(), this.buyValue.show(), this.header.hide(), this.background.texture = this.game.loader.getAsset("risk", "buy_bg"), this.featureButton.texture = this.game.loader.getAsset("risk", "buy_btn"), this.buyValue.text = "".concat(Lt.helpers.toMoneySS(i.bet)), this.betValue.text = "".concat(Lt.helpers.toMoneySS(this.game.betLevel.toCoins())), this.labelCount.text = i.freespins, this.labelCount.position.set(134, -150), this.freespinsText.position.set(140, 150), this.buyFor.position.set(140, 240), this.buyValue.position.set(140, this.buyFor.height + this.buyFor.y), this.onBet.position.set(140, 380), this.betValue.position.set(140, this.onBet.height + this.onBet.y), this.featureButton.position.set(0, 480)), this.modifiers.position.set(35, this.background.y + this.background.height + 20), this.resize()
                        }
                    }
                    hide() {
                        super.hide(), this.modifiers.hide(), this.alpha = 0, this.backgroundContent.renderable = !1, this.background.scale.set(1), this.backgroundContent.scale.set(1), this.featureButton.interactive = !1
                    }
                    resize() {
                        this.game.device.desktop || this.game.device.landscape ? (this.scale.set(1), this.position.set(1630, 100), this.game.device.desktop || (this.scale.set(1.1), this.position.set(1320, 100))) : (this.scale.set(1.3), this.position.set(580, 150))
                    }
                }
                class ln extends(Vt(H.W2)) {
                    constructor() {
                ...
                class un extends(Vt(H.W2)) {
                    constructor(t) {
                        ...
                        super(), (0, n.Z)(this, "lines", void 0), (0, n.Z)(this, "points", new Map), this.lines = t.map((t => this.addChild(new dn(t)))), this.game.device.desktop && e.map((t => this.points.set(t.line, t.position.map((e => {
                            var i = this.addChild(new cn(t.line));
                ...
                class mn {
                    constructor() {
                        (0, n.Z)(this, "container", void 0), (0, n.Z)(this, "timeline", void 0), (0, n.Z)(this, "textValue", void 0), (0, n.Z)(this, "textDescription", void 0), this.timeline = new C, this.container = new H.W2, this.container.name = "TextFreeLeft", this.container.alpha = 0, this.textDescription = new $.j(Lt.loader.getAsset("textFreeSpinLeft")), this.textDescription.anchor.set(.5), this.textValue = new v.Xz("", {
                            fontName: "WinFont"
                        }), this.textValue.anchor = .5, this.textValue.scale.set(.6), this.container.addChild(this.textDescription), this.container.addChild(this.textValue)
                    }
                    show(t) {
                        ...
                        return new Promise((i => {
                            ...
                            }, "+=0.75")) : (this.textValue.text = "".concat(t), this.textDescription.texture = Lt.loader.getAsset("textFreeSpinLeft"), this.textValue.position.set(0, -200), this.textDescription.pivot.y = -30, this.timeline.set(this.container, {
                                pixi: {
                                    y: e,
                                    alpha: 0,
                                    scale: 1
                ...
                const vn = class extends An {
                    constructor(t) {
                        super(), (0, n.Z)(this, "_flushInterval", void 0), (0, n.Z)(this, "_isFlush", void 0), (0, n.Z)(this, "_isFree", void 0), (0, n.Z)(this, "_isFreeEnd", void 0), (0, n.Z)(this, "_isFreeStart", void 0), (0, n.Z)(this, "_wins", void 0), (0, n.Z)(this, "slot", void 0), this.slot = t, this._wins = [], this._flushInterval = null, this._isFlush = !1, this._isFree = !1, this._isFreeEnd = !1, this._isFreeStart = !1
                    }
                    get isStop() {
                    ...
                    beforeStart() {
                        var t = this;
                        return (0, o.Z)((function*() {
                            t._isFree = Lt.store.get("free:isFree", !1), t._isFreeEnd = Lt.store.get("free:isEnd", !1), t._isFreeStart = Lt.store.get("free:isStart", !1)
                        }))()
                    }
                    stop() {
                        this._wins.length = 0, this._isFlush = !1, clearInterval(this._flushInterval), this.slot.staticAnimation.runStatic(this.slot.reels, "reset"), this.slot.wildReels.runStatic(this.slot.reels, "reset"), this.slot.reels.forEach((t => t.stopAnimation())), this.slot.lines.hide(), this.slot.textLineWin.clear()
                    }
                    _getWinSoundNumber() {
                    ...
                    allPayment(t) {
                        var e = this;
                        return (0, o.Z)((function*() {
                            e.slot.staticAnimation.hide(e.slot.reels), e.slot.reels.forEach((t => t.overlay())), e.slot.lines.show(t), e.slot.wildReels.container.children.forEach((t => {
                            ...
                            e.slot.feature.playWin(e.slot.reels);
                            var n = e._getWinSoundNumber();
                            Lt.action.emit("sound:win", n), Lt.store.set("isFeature", !1), yield e.slot.textTotalWin.show(Lt.wallet.coins, (() => {
                    ...
                    scatterPayment(t) {
                        var e = this;
                        return (0, o.Z)((function*() {
                            if (e.slot.staticAnimation.hide(e.slot.reels), Lt.action.emit("sound:scatterWin"), e.slot.reels.forEach((t => t.overlay())), e.slot.lines.hide(), Lt.action.emit("textLineWin:hide"), e._runSymbolAnimation(t, !0, "free"), Lt.store.get("free:winAdditional", !1)) {
                    ...
                    complete() {
                        this.isStop ? this.stop() : this._wins.length > 0 ? (this._isFlush = !0, this._flush()) : this.slot.lines.enable()
                    }
                    _flush() {
                        var t = !0,
                            e = e => {
                                ...
                                var i = this._wins[e];
                                this._runSymbolAnimation(i, !1), this.slot.feature.playWin(this.slot.reels, i.pos), t && this._showLineText(i), this.slot.lines.show([i])
                            },
                            i = 0;
                    ...
                    _runSymbolAnimation(t) {
                        ...
                        for (var s = 0; s < e.length; s++)
                            if (-1 !== e[s]) {
                                var o = this.slot.wildReels.container.children[s].children[2],
                                    n = e[s],
                                    a = this._findSymbol(s, n),
                                    h = a._texture.textureCacheIds[0];
                                !o.win || "man" !== h && "man-wild" !== h || o.play("win-x" + o.winType);
                                var r = Lt.config.get("slot.size[0]") * n + s;
                                a.playAnimation(i, r, s, 60 * s)
                            }
                    }
                    _runGeneralAnimation(t) {
                        for (var e = 0; e < 3; e++) t.forEach((t => {
                            t.pos.forEach(((i, s) => {
                                var o = this.slot.wildReels.container.children[s].children[2];
                                (!o.win || 6 !== t.comb[s] && 16 !== t.comb[s] || o.play("win-x" + o.winType), i === e) && this._findSymbol(s, i).playAnimation("normal")
                            }))
                        }))
                    }
                    _showLineText(t) {
                ...
                class fn extends bn {
                    constructor() {
                        super(...arguments), (0, n.Z)(this, "sortableChildren", !0)
                    }
                    onStop(t) {
                        var e = Lt.config.get("slot.layout.default");
                        t.visibleSymbols.forEach((t => {
                            if (t.renderable && t.visible) {
                                var i = t.getTextureName(),
                                    s = "man" === i || "man-wild" === i,
                                    o = e.find((t => t.assetName === i));
                                if (o) {
                                    t.renderable = !1;
                                    var n = new js(Lt.loader.getAsset(s ? "wildReelEffect" : "symEffect"));
                                    n.changeSkin(o.animation.skin), n.position.set(t.x, t.y), n.zIndex = o.animation.drawOrder, n.play(s ? "spin-x1" : "spin").then((() => {
                                        Lt.autoPlay.enabled || zi.isFreespin() || n.play(s ? "idle-x1" : "idle", !0)
                                    })), this.addChild(n)
                                }
                            }
                        }))
                    ...
                    runStatic(t) {
                        var e = Lt.config.get("slot.layout.default");
                        0 === this.children.length && t.forEach((t => {
                            t.visibleSymbols.forEach((t => {
                                var i = t.getTextureName(),
                                    s = "man" === i || "man-wild" === i,
                                    o = e.find((t => t.assetName === i));
                                if (o) {
                                    t.renderable = !1;
                                    var n = new js(Lt.loader.getAsset(s ? "wildReelEffect" : "symEffect"));
                                    n.changeSkin(o.animation.skin), n.position.set(t.x, t.y), n.visible = !0, n.zIndex = o.animation.drawOrder, n.play(s ? "idle-x1" : "idle", !0), this.addChild(n)
                                }
                            }))
                        }))
                    }
                    hide(t) {
                        this.removeChildren(), t.forEach((t => {
                            t.visibleSymbols.forEach((t => {
                                t.renderable = !0
                            }))
                        }))
                ...
                function wn() {
                    ...
                    return Lt.action.on("symbol:playAnimation", ((o, n, a, h) => {
                        ...
                        i.length = 0, e.length = 0, t.removeChildren(0, t.children.length)
                    })), t
                }
                class yn {
                    constructor() {
                        (0, n.Z)(this, "container", void 0), (0, n.Z)(this, "containerText", void 0), (0, n.Z)(this, "tween", void 0), this.container = new H.W2, this.container.alpha = 0, this.containerText = new v.Xz("", {
                            fontName: "WinFont"
                        }), this.containerText.scale.set(.5), this.containerText.anchor = .5, this.containerText.y = -15, this.container.addChild(this.containerText)
                    }
                    show(t, e, i) {
                ...
                function kn(t, e, i) {
                    var s = !1,
                        ...
                        n = i,
                        a = "default",
                        h = Lt.config.get("slot.layout.".concat(a, "[").concat(i, "]"), null);
                    if (!h) throw new Error("Symbol data not found");
                    var r = new $.j(Lt.loader.getAsset(h.textureAtlas, h.assetName));
                    r.position.set(t, e);
                    var l = r.addChild(new u.TC);

                    function d() {
                        Lt.action.emit("symbol:stopAnimation", h.animation), r.mask = null, s && (r.alpha = 1, r.tint = 16777215)
                    }
                    return l.beginFill(), l.drawRect(39, 29, 280, 302), l.endFill(), l.alpha = 0, r.mask = null, Object.assign(r, {
                        replaceTexture: function(t) {
                            n = t, h = Lt.config.get("slot.layout.".concat(a, "[").concat(t, "]"), null), r.texture = Lt.loader.getAsset(h.textureAtlas, h.assetName)
                        },
                        clearAnimation: d,
                        overlay() {
                            r.tint = 6316128, r.mask = l
                        },
                        getData: () => h,
                        getTextureName: () => r.texture.textureCacheIds[0],
                        unblur() {
                            a = "default", this.replaceTexture(n)
                        },
                        blur() {
                            a = "blur", this.replaceTexture(n)
                        },
                        playAnimation(t, e, i) {
                            o = setTimeout((() => {
                                s = !0, r.alpha = 0, r.tint = 16777215, Lt.action.emit("symbol:playAnimation", r.x, r.y, Sn(Sn({}, h.animation), {}, {
                                    type: t,
                                    texture: r.texture,
                                    pos: e,
                                    index: i
                        ...
                        stopAnimation() {
                            o && clearTimeout(o), s = !1, r.alpha = 1, r.tint = 16777215, d()
                        }
                    })
                }
                class Cn extends H.W2 {
                    ...
                    _setup() {
                        ...
                        for (var i = 0, s = this._nReel.length; i < s; i++) {
                            var [o, n] = this.symbolsPositions[i], a = kn(o, n, 0 === i || i === s - 1 ? this._nReel[i] : this._reel[i - 1]);
                    ...
                    _spin() {
                        if (this._flip(), this.isStop)
                            if (this._numberSpinToComplete > 0) {
                                ...
                                var e = Lt.store.get("reward:wildReels", [0, 0, 0, 0, 0]);
                                this.y = 0, this.children[0].y = this._startY, this._updateVisibleSymbols(), 3 !== e[this._reelIndex] && Lt.action.emit("wheel:stop_down"), this._spinTween.pause(), this._endTween.restart(), this.children[this.children.length - 1].visible = !1
                            }
                    }
                    _flip() {
                    ...
                    _complete() {
                        this.y = 0, this._reel.length = 0, this._endTween.pause(), clearTimeout(this._stopTimeout), Lt.action.emit("wheel:stop", this._reelIndex), this.children[0].visible = !1
                    }
                ...
                class Bn extends pn {
                    constructor() {
                        super(), (0, n.Z)(this, "animation", void 0), (0, n.Z)(this, "feature", void 0), (0, n.Z)(this, "lines", void 0), (0, n.Z)(this, "reels", void 0), (0, n.Z)(this, "reelsContainer", void 0), (0, n.Z)(this, "reelsMask", void 0), (0, n.Z)(this, "slotData", void 0), (0, n.Z)(this, "staticAnimation", void 0), (0, n.Z)(this, "stopReelCounter", void 0), (0, n.Z)(this, "symbolsPositions", void 0), (0, n.Z)(this, "textExtraFree", void 0), (0, n.Z)(this, "textFreeLeft", void 0), (0, n.Z)(this, "textLineWin", void 0), (0, n.Z)(this, "textTotalWin", void 0), (0, n.Z)(this, "wheelBg", void 0), (0, n.Z)(this, "wildReels", void 0), this.pivot.set(815, 0), this.reels = [], this.symbolsPositions = this.game.config.get("slot.symbolsPositions", []), this.animation = new vn(this), this.stopReelCounter = 0, this.init(), this.setupEvents()
                    }
                    createMask() {
                        var t = new u.TC;
                        return t.beginFill(), t.drawRect(40, 21, this.game.config.get("slot.width"), this.game.config.get("slot.height") + 9), t.endFill(), t
                    }
                    init() {
                        var t, e;
                        this.reelsMask = this.createMask(), this.reelsContainer = new H.W2, this.reelsContainer.addChild(this.reelsMask), this.reelsContainer.mask = this.reelsMask;
                        for (var i = this.game.config.get("slot.size[0]"), s = 0; s < i; s++) {
                            var n = this.symbolsPositions[s],
                                a = new Cn(s, n);
                        ...
                        this.slotData = {
                        ...
                        }, this.lines = new un(this.slotData.lines.map((t => ({
                            color: 16768776,
                            width: 4,
                            padding: 125,
                            points: t.map(((t, e) => {
                        ...
                        })))), this.textFreeLeft = new mn, this.textFreeLeft.container.position.set(1262, 622), this.textExtraFree = new ln, this.textExtraFree.pivot.set(0), this.textExtraFree.setBackground("winBg"), this.textExtraFree.background.position.set(-12, -64), this.textExtraFree.value.scale.set(.6), this.textExtraFree.position.set(1042, 482), this.textTotalWin = new gn(.9), this.textTotalWin.textScaleEnabled = !0, this.textTotalWin.setBackground("winBg"), this.textTotalWin.background.position.set(-226, -133), this.textTotalWin.winText.letterSpacing = -20, this.textTotalWin.winText.rotation = .1, this.textTotalWin.position.set(1252, 552), this.textLineWin = new yn, this.feature = function(t) {
                            var e = new H.W2;
                            e.name = "featureContainer", e.position.set(-230, 310);
                            for (var i = 0; i < 4; i++) {
                                var s = new js(Lt.loader.getAsset("boxEffect"));
                                s.play("box-idle", !0), s.active = !1, s.y = 150 * i, e.addChild(s)
                            }
                            return {
                                container: e,
                                initFeature() {
                                    var i = Lt.store.get("reward:collection", []),
                                        s = Lt.store.get("reward:featureType"),
                                        o = zi.isFreespin() ? s.substring(9, s.length) : i[t.betLevel.bet],
                                        n = (Lt.store.get("reward:feature"), ["1w", "2w", "3w", "x2", "x3", "x5"]),
                                        a = ["box-witch", "box-monster", "box-man", "x2", "x3", "x5"],
                                        h = !1;
                                    if (zi.isFreespin() && n.forEach((t => {
                                            t === s.slice(9) && (h = !0)
                                        })), o || h) {
                                        var r;
                                        Lt.store.set("isFeature", !0);
                                        for (var l = 0; l <= n.indexOf(o); l++)(r = l > 3 ? e.children[3] : e.children[l]).active = !0, r.type = o, r.changeSkin(a[l]), r.play("badge-idle", !0)
                                    }
                                },
                                showFeature: i => (0, o.Z)((function*() {
                                    var i = Lt.store.get("reward:collection", [])[t.betLevel.bet],
                                        s = !1,
                                        o = ["1w", "2w", "3w", "x2", "x3", "x5"],
                                        n = ["box-witch", "box-monster", "box-man", "x2", "x3", "x5"];
                                    if (i) {
                                        var a;
                                        Lt.store.set("isFeature", !0);
                                        for (var h = 0; h <= o.indexOf(i); h++)(!(a = h > 3 ? e.children[3] : e.children[h]).active || a === e.children[3] && a.type !== i && ("x3" === i && 4 === h || "x5" === i && 5 === h)) && (a.type = i, s = !0, a.active = !0, a.changeSkin(n[h]), Lt.action.emit("box:open", h + 1), a.play("box-open").then((() => {
                                            a.play("badge-idle", !0)
                                        })));
                                        s && (yield Lt.delay(800))
                                    }
                                }))(),
                                hideFeature: () => (0, o.Z)((function*() {
                                    Lt.store.get("reward:feature");
                                    var i = Lt.store.get("reward:collection", [])[t.betLevel.bet],
                                        s = Lt.store.get("reward:win"),
                                        o = !1;
                                    i || e.children.forEach((t => {
                                        t.active && (o = !0)
                                    })), zi.isFreespin() ? e.children.forEach((t => {
                                        t.active && t.play("badge-idle", !0)
                                    })) : !s && !o || s && !o || (e.children.forEach((t => {
                                        t.active && (Lt.store.get("free:isStart") ? t.play("box-idle", !0) : t.play("box-close").then((() => {
                                            t.play("box-idle", !0)
                                        })), t.active = !1, t.type = "")
                                    })), Lt.store.set("isFeature", !1), Lt.store.get("free:isStart") || Lt.action.emit("box:close"), o && (yield Lt.delay(800)))
                                }))(),
                                hideAfterFree() {
                                    e.children.forEach((t => {
                                        t.active && (t.stop(), t.play("box-idle", !0), t.active = !1, t.type = ""), Lt.store.set("isFeature", !1)
                                    }))
                                },
                                freeEnter() {
                                    var t = Lt.store.get("reward:featureType");
                                    e.children.forEach((e => {
                                        "freespin" === t ? (e.play("box-idle", !0), e.active = !1, e.type = "") : e.active && e.play("badge-idle", !0)
                                    }))
                                },
                                playWin(t, i) {
                                    var s = Lt.store.get("reward:lines", []);
                                    if (0 !== s.length) {
                                        var o = ["wild-witch", "wild-monster", "man-wild"];
                                        i ? i.forEach(((i, s) => {
                                            var n = t[s].visibleSymbols[i],
                                                a = -1 === i ? 0 : n.texture.textureCacheIds[0],
                                                h = o.indexOf(a); - 1 !== h && e.children[h].active && 0 === n.alpha && (e.children[h].play("win-badge"), e.children[3].active && e.children[3].play("win-badge"))
                                        })) : s.forEach((t => {
                                            var {
                                                comb: i
                                            } = t;
                                            i.forEach((t => {
                                                var i = "x" === t ? 0 : Lt.config.get("slot.layout.default[".concat(t, "]")).assetName,
                                                    s = o.indexOf(i); - 1 !== s && e.children[s].active && (e.children[s].play("win-badge"), e.children[3].active && e.children[3].play("win-badge"))
                                            }))
                                        }))
                                    }
                                },
                                restoreFeature: () => (0, o.Z)((function*() {
                                    var i, s = Lt.store.get("reward:collection", [])[t.betLevel.bet],
                                        o = ["1w", "2w", "3w", "x2", "x3", "x5"],
                                        n = ["box-witch", "box-monster", "box-man", "x2", "x3", "x5"];
                                    Lt.store.set("isFeature", !0);
                                    for (var a = 0; a <= o.indexOf(s); a++)(i = a > 3 ? e.children[3] : e.children[a]).type = s, i.active = !0, i.changeSkin(n[a]), i.play("badge-idle", !0)
                                }))(),
                                hideAfterBet() {
                                    e.children.forEach((t => {
                                        t.active && (t.stop(), t.play("box-idle", !0), t.active = !1, t.type = "", Lt.action.emit("closeBoxes")), Lt.store.set("isFeature", !1)
                                    }))
                                },
                                onBetChange: () => (0, o.Z)((function*() {
                                    var i = Lt.store.get("reward:collection", [])[t.betLevel.bet],
                                        s = ["1w", "2w", "3w", "x2", "x3", "x5"],
                                        o = ["box-witch", "box-monster", "box-man", "x2", "x3", "x5"];
                                    if (e.children.forEach((t => {
                                            t.play("box-idle", !0), t.active = !1, t.type = ""
                                        })), i)
                                        for (var n, a = 0; a <= s.indexOf(i); a++)(n = a > 3 ? e.children[3] : e.children[a]).type = i, n.active = !0, n.changeSkin(o[a]), n.play("badge-idle", !0)
                                }))()
                            }
                        }(this.game), this.wildReels = function(t) {
                            var e, i = new H.W2;
                            ...
                            function a() {
                                var t = Lt.store.get("reward:lines", []),
                                    e = [0, 0, 0, 0, 0];
                                return t.forEach((t => {
                                    t.comb.forEach(((t, i) => {
                                        16 !== t && 6 !== t || (e[i] = 1)
                            ...
                            function h() {
                                ...
                                return t.forEach((t => {
                                    t.visibleSymbols.forEach((t => {
                                        "man" === t._texture.textureCacheIds[0] ? e = "man" : "man-wild" === t._texture.textureCacheIds[0] && (e = "man-wild")
                                    }))
                                })), e
                            }
                            return i.name = "wildContainer", t.forEach((t => {
                                var e = new H.W2;
                                e.x = t.x, t.visibleSymbols.forEach((t => {
                                    var i = new js(Lt.loader.getAsset("wildReelEffect"));
                                    i.renderable = !1, i.position.set(t.x, t.y), i.win = 0, i.type = 1, e.addChild(i)
                                })), i.addChild(e)
                            })), {
                                container: i,
                                show: (e = (0, o.Z)((function*() {
                                    var e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
                                        o = s(),
                                        r = e ? ["static-x2", "static-x3"] : ["expand-x1-x2", "expand-x1-x3"],
                                        l = Lt.store.get("reward:lines", []),
                                        d = Lt.store.get("reward:scatters", !1),
                                        c = 0;
                                    if (a().forEach((t => {
                                            c += t
                                        })), 0 !== o.length && 0 !== l.length && 0 !== c) {
                                        var u = n(o);
                                        o.forEach(((s, o) => {
                                            var n = i.children[o].children[2];
                                            n.changeSkin(h());
                                            var c = t[o].visibleSymbols[u[o]].y,
                                                p = 0 === l.length || e ? [] : a();
                                            s > 1 && ((0 !== p.length || d) && 0 !== p.length && 1 === p[o] && (n.win = !0, n.winType = s), n.renderable = n.win, n.y = c, n.play([r[s - 2]]), n.type = s, Lt.action.emit("wild:show"), setTimeout((() => {
                                                t[o].visibleSymbols.forEach((t => {
                                                    !n.win || "man" !== t._texture.textureCacheIds[0] && "man-wild" !== t._texture.textureCacheIds[0] || (t.visible = !1, t.isWild = !0)
                                                }))
                                            }), 400))
                                        })), yield Lt.delay(500)
                                    }
                                ...
                                hide() {
                                    i.children.forEach(((e, i) => {
                                        e.children.forEach((t => {
                                            t.renderable = !1, t.win = 0, t.type = 1
                                        })), t[i].visibleSymbols.forEach((t => {
                                            t.visible = !0, t.isWild = !1
                                        }))
                                    }))
                                },
                                restoreAfterFree() {
                                    var e = Lt.store.get("reward:preSpin", []).reels,
                                        s = [0, 0, 0, 0, 0],
                                        o = 0,
                                        n = !1,
                                        a = ["static-x2", "static-x3"],
                                        r = Lt.store.get("reward:preSpin", []).lines,
                                        l = 0,
                                        d = [0, 0, 0, 0, 0];
                                    ...
                                    })), n || (s = []), 0 !== s.length && 0 !== l && s.forEach(((s, o) => {
                                        var n = i.children[o].children[0];
                                        n.changeSkin(h()), s > 1 && 0 !== d[o] && (e[o].forEach(((e, i) => {
                                            6 !== e && 16 !== e || (n.y = t[o].visibleSymbols[i].y)
                                        })), n.renderable = !0, n.play([a[s - 2]]), t[o].visibleSymbols.forEach((t => {
                                            "man" !== t._texture.textureCacheIds[0] && "man-wild" !== t._texture.textureCacheIds[0] || (t.visible = !1)
                                        })))
                                    }))
                                },
                                runStatic(t) {
                                    var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "normal",
                                        ...
                                        n = Lt.store.get("reward:feature"),
                                        a = Lt.store.get("reward:preSpin", []);
                                    if ("reset" === e);
                                    else if (!s && ("freespin" === n || 0 !== a.length && "afterFree" !== e) || Lt.autoPlay.enabled) return;
                                    o || (t.forEach(((t, e) => {
                                        t.visibleSymbols.forEach(((t, s) => {
                                            if (("man" === t._texture.textureCacheIds[0] || "man-wild" === t._texture.textureCacheIds[0]) && t.visible) {
                                                var o = i.children[e].children[s];
                                                o.renderable = !0, o.changeSkin(h()), o.y = t.y, o.play("idle-x1", !0)
                                            }
                                        }))
                                    })), i.children.forEach((t => {
                                        t.children.forEach((t => {
                                            t.renderable && t.type > 1 && t.win && t.play("idle-x".concat(t.type), !0)
                                        }))
                                    })))
                                }
                            }
                        }(this.reels), this.staticAnimation = new fn, this.wheelBg = new $.j(this.game.loader.getAsset("wheelBg")), this.wheelBg.position.set(28, 18), this.addChild(this.wheelBg), this.addChild(this.reelsContainer), this.addChild(this.lines), this.addChild(wn()), this.addChild(this.staticAnimation), this.addChild(this.wildReels.container), this.addChild(this.feature.container), this.addChild(this.textLineWin.container), this.addChild(this.textTotalWin), this.addChild(this.textFreeLeft.container), this.addChild(this.textExtraFree)
                    }
                    setupEvents() {
                        this.game.action.on("state:ready_enter", this._onReadyEnter, this), this.game.action.on("state:spin_enter", this._onSpinEnter, this), this.game.action.on("state:stop_enter", this._onStopEnter, this), this.game.action.on("free:start", (() => {
                            this.animation.stop(), this.staticAnimation.hide(this.reels), this.wildReels.hide(), this.feature.freeEnter(), this.reels.forEach(((t, e) => {
                            ...
                            }), this.animation.stop(), this.lines.enable(), this.wildReels.restoreAfterFree(), this.staticAnimation.hide(this.reels), this.wildReels.hide(), this.staticAnimation.runStatic(this.reels, "afterFree"), this.feature.hideAfterFree()
                        })), this.game.action.on("free:select_start", (() => {
                            k.fromTo(this, .5, {
                                pixi: {
                                    alpha: 0
                        ...
                        })), this.game.action.on("wheel:stop", this._onStopWheel, this), this.game.action.on("state:finish_enter", this._onFinishEnter, this), this.game.action.on("reward:reset", this._onResetReward, this)
                    }
                    restoreFreeSpins() {
                        this.alpha = 0
                    }
                    setup() {
                        this.staticAnimation.runStatic(this.reels, "normal"), this.feature.initFeature()
                    }
                    _onReadyEnter() {
                        this.game.store.set("currentBetLevel", this.game.betLevel.bet);
                        var t = this.game.autoPlay.enabled;
                        if (zi.isFreespin()) {
                    ...
                    _onSpinEnter() {
                        var t = this;
                        return (0, o.Z)((function*() {
                            t.game.store.set("isCurrenSpin", !1), t.animation.stop(), t.lines.disable(), t.wildReels.hide(), t.staticAnimation.hide(t.reels);
                            try {
                                yield t.game.beforeSpin(), t.reels.forEach((t => t.start())), yield t.updateFreeLeft(), yield Promise.all([t.requestSpin(), t.feature.hideFeature()]), t.game.state.goTo("stop")
                            } catch (e) {
                    ...
                    _onStopWheel(t) {
                        ...
                        return (0, o.Z)((function*() {
                            var i = e.reels[t];
                            e.game.store.get("spin:isFast", !1) || e.game.store.get("reward:reels", [])[t].indexOf(0) > -1 && e.game.action.emit("sound:scatterReel");
                            e.staticAnimation.onStop(i), e.stopReelCounter++, e.stopReelCounter >= e.reels.length && (yield e.wildReels.show(), yield e.feature.showFeature(), e.game.afterReelsStop(), e.game.state.goTo("reward"))
                        }))()
                    }
                    _onFinishEnter() {
                        var t = this;
                        return (0, o.Z)((function*() {
                            zi.set(t.game.store.get("reward:feature")), t.game.store.get("free:isFree", !1) || (yield t.game.freeRound.finish()), t.stopReelCounter = 0, t.game.autoPlay.enabled ? t.game.checkBalance().then((() => {
                    ...
                    beforeFreeSpinsPopup() {
                        ...
                        return (0, o.Z)((function*() {
                            ...
                            }), yield t.game.delay(500), t.wildReels.hide(!0)
                        }))()
                    }
                    resize() {
                        this.game.device.desktop || this.game.device.landscape ? (this.scale.set(.9), this.feature.container.scale.set(1), this.position.set(this.game.device.landscape ? 1010 : 1e3, this.game.device.landscape ? 30 : 10), this.game.leftHand.enabled ? this.feature.container.position.set(1590, 260) : this.feature.container.position.set(-230, 310)) : (this.scale.set(.61875), this.feature.container.scale.set(1.2), this.position.set(511.875, 348), this.feature.container.position.set(1518, 180))
                    }
                }
                class Pn extends(Vt(H.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "timeline", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "value", void 0), (0, n.Z)(this, "light", void 0), (0, n.Z)(this, "coins", void 0), (0, n.Z)(this, "onPress", void 0), this.visible = !1, this.interactive = !0, this.onPress = new(x()), this.game.interaction.click(this, (() => this.onPress.dispatch())), this.timeline = new C, this.content = new H.W2, this.overlay = new u.TC, this.overlay.beginFill(0, .75), this.overlay.drawRect(0, 0, this.game.config.get("application.width"), this.game.config.get("application.height")), this.overlay.endFill(), this.title = new $.j, this.title.anchor.set(.5), this.value = new v.Xz("", {
                            fontName: "WinFont"
                        ...
                        return (0, o.Z)((function*() {
                            ...
                            return new Promise((a => {
                                ...
                                i.timeline.to(i.overlay, .35, {
                                    ...
                                    roundProps: ["coins"],
                                    onStart: () => {
                                        i.light.play("big-win", !0), i.light.alpha = 1
                                    },
                                    onUpdate: () => {
                                        !o && t === ye && h.coins > e / 2 && (i.title.texture = i.game.loader.getAsset("textGiantWin"), o = !0, i.coins.play("giant-win", !0), i.coins.alpha = 1, k.to(i.value, s / 2, {
                                            pixi: {
                                                scale: n + .2
                                            }
                ...
                new class extends class extends class extends class {
                    constructor(t) {
                        ...
                        })), Lt = this, et.vB.shared.autoStart = !1, et.vB.shared.stop(), this.config = new ht(Rt), this.logger = new Ct, this.rootNode = this.createRootNode(), this.renderer = new Bt, this.i18n = new bt(e), this.helpers = new vt(this.config), this.keyboard = new yt, this.device = new mt(this.renderer), this.viewport = new Mt, this.leftHand = new ut, this.fullscreen = this.device.ios || this.device.iPadPro ? new dt : new ct(this.device), this.visibility = new zt, this.preferences = new Ut, this.sound = new M(this.device, this.visibility, this.preferences), this.state = new Ot, this.store = new ht, this.action = new gt, this.loader = new kt(this.device), this.error = new At, this.interaction = new ft(this.device), this.externalApi = new _t(this), this.popupManager = new Dt(this.rootNode), this.create(), this.initAnalytics()
                    }
                    initAnalytics() {
                        return (0, o.Z)((function*() {
                            try {
                    ...
                    initPopups() {
                        this.popupManager.add([new Ti, new Bi, new Pi, new Si, new Zi, new Ci, new Fi, new Oi, new Ei, new ki, new Mi])
                    }
                    loadAssets(t) {
                    ...
                    initModules(t) {
                        ...
                        this.wallet = new Je(this.server), this.betLevel = new Wt(null == o ? void 0 : o.bet, null == o ? void 0 : o.bets, null !== (e = null == o ? void 0 : o.betCoins) && void 0 !== e ? e : 1), this.autoPlay = new He({
                    ...
                    showIntroScreen() {
                        ...
                        return (0, o.Z)((function*() {
                            var e;
                            if (t.background = t.rootNode.addChild(new gs), null === (e = t.sound.get("backgroundNormal")) || void 0 === e || e.fade(2), t.preferences.get("showIntroScreen", !0) && "basic" === t.server.response.feature) return t.introScreen = t.rootNode.addChild(new Bo), t.introScreen.play()
                        }))()
                    }
                    initModules(t) {
                    ...
                    initViews() {
                        ...
                        super.initViews(), this.slot = this.rootNode.addChild(new Bn), this.riskFeature = this.rootNode.addChild(new rn), this.paytable = new Uo(null !== (t = null === (e = this.server) || void 0 === e ? void 0 : e.response.lines) && void 0 !== t ? t : []), this.gameSettings = new Ue, this.config.get("quickSpin.available", !0) && this.gameSettings.addItem(this.createQuickSpinCheckbox()), this.gameSettings.addItem(this.createFullscreenCheckbox()), this.gameSettings.addItem(this.createLeftHandCheckbox()), this.gameSettings.addItem(this.createGameSoundsCheckbox()), this.gameSettings.addItem(this.createBackgroundSoundsCheckbox()), this.gameSettings.addItem(this.createIntroScreenCheckbox()), this.gameSettings.addItem(this.createRiskFeatureCheckbox()), this.bigWinAnimation = new Pn, this.fastStopLayout = new Te, this.controls = this.device.desktop ? new to : new uo, this.betSettings = this.rootNode.addChild(new Ee), this.betSettings.setBets(this.betLevel.bets, this.betLevel.betCoins), this.betSettings.setPayLines(15), this.betSettings.setBet(this.betLevel.bet), this.autoPlaySettings = this.rootNode.addChild(new de), this.autoPlaySettings.setAutoPlayCounts(this.autoPlay.counts), this.autoPlaySettings.stopSection.addItem(new Se), this.autoPlaySettings.stopSection.addItem(new be), this.autoPlaySettings.stopSection.addItem(new Ae), this.autoPlaySettings.stopSection.addItem(new ve), this.gameRules = new Ne, this.menu = new Ge, this.menu.addItem(this.loader.getAsset("iconPaytable"), this.paytable), this.menu.addItem(this.loader.getAsset("iconSettings"), this.gameSettings), this.menu.addItem(this.loader.getAsset("iconRules"), this.gameRules), this.rootNode.addChild(this.fastStopLayout), this.rootNode.addChild(this.menu), this.rootNode.addChild(this.controls), this.rootNode.addChild(this.bigWinAnimation), this.freeOverlay = this.rootNode.addChild(new go), this.paytable.updateBet(this.betLevel), this.controls.updateBet(this.betLevel), this.betSettings.on("open", (() => {
                            ...
                            this.paytable.updateBet(this.betLevel), this.controls.updateBet(this.betLevel), this.betSettings.setBet(this.betLevel.bet), this.slot.feature.onBetChange()
                    ...
                    start() {
                        var t = () => super.start,
                            e = this;
                        return (0, o.Z)((function*() {
                            if (t().call(e), zi.set(e.store.get("reward:feature", ji.Basic)), yield e.freeRound.start(), "mod" === e.store.get("reward:feature") && (yield e.popupManager.show("PopupRestore")), e.state.goTo("setup"), e.slot.setup(), zi.isFreespin()) {
                    ...
                    reward() {
                        ...
                        return (0, o.Z)((function*() {
                            var o;
                            e(), t.slot.animation.beforeStart(), null !== (o = t.bigWin) && void 0 !== o && o.available(t.wallet.coins) && (t.bigWinAnimation.press(i), t.controls.pressButtonSpin(i), yield t.bigWinAnimation.show(t.bigWin.type(t.wallet.coins), t.wallet.coins), t.sound.stopBigWin(), e());
                            ...
                            if ((n.length > 0 || t.wallet.scatterCoins) && (t.controls.disableButtonSpin(), a && n.unshift(a), t.slot.textTotalWin.once("show", (() => {
                                ...
                                })), yield t.slot.animation.allPayment(n), e()), a && (t.controls.disableButtonSpin(), yield t.slot.animation.scatterPayment(a)), t.store.get("free:isStart", !1)) {
                                var h = t.store.get("free:left", 0);
                                t.action.emit("free:updateLeft", h), t.beforeFreeSpinsPopup(), yield t.freeOverlay.show(ao.START)
                            } else t.store.get("free:isEnd", !1) && (yield t.delay(Ui.get("free_end")), t.beforeFreeSpinsPopup(), yield t.freeOverlay.show(ao.END), yield t.delay(200), t.store.set("free:end", 1));
                    ...
                    beforeSpin() {
                        var t = this;
                        return (0, o.Z)((function*() {
                            t.autoPlay.enabled || zi.isFreespin() || t.store.get("free:isStart") || (yield t.quickSpin.tryEnable())
                        }))()
                    }
                    afterReelsStop() {
    ...
    n.m = s, t = [], n.O = (e, i, s, o) => {
    ...
    }), t), n.o = (t, e) => Object.prototype.hasOwnProperty.call(t, e), e = {}, i = "the_evil_bet:", n.l = (t, s, o, a) => {
        if (e[t]) e[t].push(s);
        else {
            var h, r;
            if (void 0 !== o)
        ...
        var e = (e, i) => {
            ...
            i = self.webpackChunkthe_evil_bet = self.webpackChunkthe_evil_bet || [];
        i.forEach(e.bind(null, 0)), i.push = e.bind(null, i.push.bind(i))
    })();
    var a = n.O(void 0, [216], (() => n(7778)));
    a = n.O(a)
})();