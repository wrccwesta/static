...
(() => {
            ...
            1982: (t, e, i) => {
                ...
                class f {
                    ...
                    static loadFromBuffer(t) {
                        var e, i, s, o, n, a, h, r, l, c, d, u, p, g, m, A, v, b, w, y = null !== (e = null === (i = t.metadata) || void 0 === i || null === (s = i.font) || void 0 === s ? void 0 : s.family) && void 0 !== e ? e : t.name;
                ...
                }(0, n.Z)(R, "extension", d.n.Loader), (0, n.Z)(R, "supportedSoundExtensions", ["mp3"]);
                i(1293);
                var M, I = i(9534),
                    W = i(1162),
                    D = i(1368),
                ...
                class U {
                    ...
                    readSkeletonData(t, e) {
                        ...
                        var s = i.readString(),
                            o = N(s),
                            n = null;
                        if (o === M.VER38 && (n = new L.SkeletonBinary(new L.AtlasAttachmentLoader(t))), (i = new I.BinaryInput(e)).readInt32(), i.readInt32(), (o = N(s = i.readString())) !== M.VER40 && o !== M.VER41 || (n = new j.SkeletonBinary(new j.AtlasAttachmentLoader(t))), !n) {
                ...
                class V {
                    ...
                    readSkeletonData(t, e) {
                        var i = e.skeleton.spine,
                            s = N(i),
                            o = null;
                        if (s === M.VER37 && (o = new D.SkeletonJson(new D.AtlasAttachmentLoader(t))), s === M.VER38 && (o = new L.SkeletonJson(new L.AtlasAttachmentLoader(t))), s !== M.VER40 && s !== M.VER41 || (o = new j.SkeletonJson(new j.AtlasAttachmentLoader(t))), !o) {
                ...
                }(0, n.Z)(z, "extension", d.n.Loader), (0, n.Z)(z, "use", (new z).genMiddleware().use);
                var G = i(512),
                    H = i(600),
                    Q = i(9360),
                    Y = i(3361),
                    ...
                    et = i(798),
                    it = i(5277);
                u.TC.nextRoundedRectBehavior = !0, A.xv.nextLineHeightBehavior = !0, d.R.add(p.bx, g.B9, c.Bv, a.c, h.Q, r.T, l.O, v.vl, m.o, z, f, R), window.PIXI = s;
                var st = i(3233),
                    ot = i.n(st);
                            ...
                            if (0 === r.length) h.push(this.createTextData(t[a], o[o.length - 1], n[n.length - 1]));
                                ...
                                for (var c = 0, d = 0; d < r.length; d++) {
                                    if (r[d].index > c && h.push(this.createTextData(t[a].substring(c, r[d].index), o[o.length - 1], n[n.length - 1])), "/" === r[d][0][1]) o.length > 1 && (o.pop(), n.pop());
                                        ...
                                        if (m === Ce && r[d][0].includes("=") && this.textStyles[r[d][1]]) ! function() {
                                    ...
                                    if (0 === C.letterSpacing) w.push({
                                        ...
                                        for (var Z = 0; Z < B.length; Z++) {
                                            ...
                                            w.push({
                                                ...
                                                descent: P.descent,
                                                tag: F
                                            }), x += R, (Z < B.length - 1 || k < S.length - 1) && (x += C.letterSpacing / 2)
                                        }
                                    }
                                }
                                f += a[y] - n[y]
                ...
                class Ne extends(zt(Q.W2)) {
                    ...
                    addSections() {
                        this.content.addChild(new We), this.content.addChild(new Le), this.content.addChild(new je), this.addAutoPlaySection(), this.content.addChild(new Ie), this.content.addChild(new Me), this.content.addChild(new _e)
                    }
                    addAutoPlaySection() {
                ...
                const xi = class extends Dt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupFreeRound"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "icon", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContinue", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt, this.content = new Q.W2, this.icon = new bi(ui), this.icon.anchor.x = .5, this.title = new Si(this.game.i18n.t("PopupFreeRoundStartTitle")), this.title.anchor.x = .5, this.message = new wi("", {
                            wordWrap: !0,
                            wordWrapWidth: 600
                ...
                const ki = class extends Dt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupMaxLimit"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContinue", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt(.7), this.content = new Q.W2, this.background = new $.j(this.game.loader.getAsset(mi)), this.background.anchor.set(.5), this.background.interactive = !0, this.background.name = "PopupBackground", this.title = new Si(this.game.i18n.t("PopupMaxLimitTitle")), this.title.anchor.x = .5, this.message = new wi(this.game.i18n.t("PopupMaxLimitMessage"), {
                            wordWrap: !0
                ...
                const Ci = class extends Dt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupNetworkError"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "icon", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionReload", void 0), (0, n.Z)(this, "_resolver", null), this.overlay = this.addChild(new Jt), this.content = this.addChild(new Q.W2), this.icon = new bi(pi), this.icon.anchor.x = .5, this.title = new Si(this.game.i18n.t("PopupNetworkErrorTitle"), {
                            align: "center"
                ...
                class Bi extends Dt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupQuickSpin"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionEnable", void 0), (0, n.Z)(this, "actionClose", void 0), (0, n.Z)(this, "escKey", void 0), (0, n.Z)(this, "enterKey", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt(.7), this.content = new Q.W2, this.background = new $.j(this.game.loader.getAsset(mi)), this.background.anchor.set(.5), this.background.interactive = !0, this.background.name = "PopupBackground", this.title = new Si(this.game.i18n.t("PopupQuickSpinTitle")), this.title.anchor.x = .5, this.message = new wi(this.game.i18n.t("PopupQuickSpinMessage"), {
                            fontSize: 35,
                            wordWrap: !0,
                            wordWrapWidth: 600
                ...
                const Ei = class extends Dt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupRiskNBuy"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionYes", void 0), (0, n.Z)(this, "actionNo", void 0), (0, n.Z)(this, "escKey", void 0), (0, n.Z)(this, "enterKey", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt(.7), this.content = new Q.W2, this.background = new $.j(this.game.loader.getAsset(mi)), this.background.anchor.set(.5), this.background.interactive = !0, this.background.name = "PopupBackground", this.title = new Si("RISK FEATURE"), this.title.anchor.x = .5, this.message = new wi("", {
                            wordWrap: !0,
                            whiteSpace: "normal",
                            breakWords: !0
                ...
                const Fi = class extends Dt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupSpendingBudget"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContinue", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt(.7), this.content = new Q.W2, this.background = new $.j(this.game.loader.getAsset(mi)), this.background.anchor.set(.5), this.background.interactive = !0, this.background.name = "PopupBackground", this.title = new Si(this.game.i18n.t("PopupSpendingBudgetTitle")), this.title.anchor.x = .5, this.message = new wi(this.game.i18n.t("PopupSpendingBudgetMessage"), {
                            wordWrap: !0
                        }), this.message.anchor.x = .5, this.actionContinue = new vi(this.game.i18n.t("PopupActionContinue"), {
                            fill: 10066329
                        }), this.actionContinue.anchor.x = .5, this.game.interaction.out(this.actionContinue, (() => this.actionContinue.style.fill = 10066329)), this.game.interaction.hover(this.actionContinue, (() => this.actionContinue.style.fill = 16777215)), this.game.interaction.click(this.actionContinue, (() => this.hide())), this.content.addChild(this.title), this.content.addChild(this.message), this.content.addChild(this.actionContinue), this.addChild(this.overlay), this.addChild(this.background), this.addChild(this.content)
                ...
                const Oi = class extends Dt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupUnexpectedError"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContinue", void 0), (0, n.Z)(this, "_resolver", null), this.overlay = new Jt(.7), this.content = new Q.W2, this.background = new $.j(this.game.loader.getAsset(mi)), this.background.anchor.set(.5), this.background.interactive = !0, this.background.name = "PopupBackground", this.title = new Si(this.game.i18n.t("PopupUnexpectedErrorTitle")), this.title.anchor.x = .5, this.message = new wi(this.game.i18n.t("PopupUnexpectedErrorMessage")), this.message.anchor.x = .5, this.actionContinue = new vi(this.game.i18n.t("PopupActionReload"), {
                            fill: 10066329
                        }), this.actionContinue.anchor.x = .5, this.game.interaction.out(this.actionContinue, (() => this.actionContinue.style.fill = 10066329)), this.game.interaction.hover(this.actionContinue, (() => this.actionContinue.style.fill = 16777215)), this.game.interaction.click(this.actionContinue, (() => this.hide())), this.content.addChild(this.title), this.content.addChild(this.message), this.content.addChild(this.actionContinue), this.addChild(this.overlay), this.addChild(this.background), this.addChild(this.content)
                    }
                    resize() {
                ...
                class Zi extends Dt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupWilds"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionEnable", void 0), (0, n.Z)(this, "actionClose", void 0), (0, n.Z)(this, "escKey", void 0), (0, n.Z)(this, "spaceKey", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt(.7), this.content = new Q.W2, this.background = new $.j(this.game.loader.getAsset(mi)), this.background.anchor.set(.5), this.background.interactive = !0, this.background.name = "PopupBackground", this.title = new Si(this.game.i18n.t("PopupWildsTitle"), {
                            fontSize: 40,
                            wordWrap: !0,
                            wordWrapWidth: 600,
                ...
                const Ri = class extends Dt {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "PopupZeroBalance"), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "message", void 0), (0, n.Z)(this, "actionContinue", void 0), (0, n.Z)(this, "resolver", null), this.overlay = new Jt(.7), this.content = new Q.W2, this.background = new $.j(this.game.loader.getAsset(mi)), this.background.anchor.set(.5), this.background.interactive = !0, this.background.name = "PopupBackground", this.title = new Si(this.game.i18n.t("PopupZeroBalanceTitle")), this.title.anchor.x = .5, this.message = new wi(this.game.i18n.t("PopupZeroBalanceMessage"), {
                            wordWrap: !0
                        }), this.message.anchor.x = .5, this.actionContinue = new vi(this.game.i18n.t("PopupActionContinue"), {
                            fill: 10066329
                        }), this.actionContinue.anchor.x = .5, this.game.interaction.out(this.actionContinue, (() => this.actionContinue.style.fill = 10066329)), this.game.interaction.hover(this.actionContinue, (() => this.actionContinue.style.fill = 16777215)), this.game.interaction.click(this.actionContinue, (() => this.hide())), this.content.addChild(this.title), this.content.addChild(this.message), this.content.addChild(this.actionContinue), this.addChild(this.overlay), this.addChild(this.background), this.addChild(this.content)
                ...
                const Li = [...[{
                        ...
                        url: "assets/audio/progressFill.mp3",
                        name: "progressFill",
                        metadata: {
                            platform: ["phone", "tablet", "desktop"],
                            audioMetadata: {
                        ...
                        url: "assets/audio/progressFillEnd.mp3",
                        name: "progressFillEnd",
                        metadata: {
                            platform: ["phone", "tablet", "desktop"],
                            audioMetadata: {
                                type: "effects",
                        ...
                        url: "assets/audio/progressSymbols.mp3",
                        name: "progressSymbols",
                        metadata: {
                            platform: ["phone", "tablet", "desktop"],
                            audioMetadata: {
                                type: "effects",
                        ...
                        url: "assets/images/label_bg.png",
                        name: "fsTextBg",
                        metadata: {
                            platform: ["phone", "tablet", "desktop"]
                        }
                    }, {
                        url: "assets/images/freespin/popup-image.png",
                        metadata: {
                            platform: ["phone", "tablet", "desktop"]
                        }
                    }, {
                        ...
                        url: "assets/images/effects/counter/skeleton.json",
                        metadata: {
                            platform: ["phone", "tablet", "desktop"]
                        }
                    }, {
                        ...
                        url: "assets/images/scaleFeature/texture.json",
                        metadata: {
                            platform: ["phone", "tablet", "desktop"]
                        }
                    }, {
                        url: "assets/fonts/font-valorant.ttf",
                        name: "Valorant",
                        metadata: {
                            platform: ["phone", "tablet", "desktop"]
                        }
                        ...
                        slot: {
                            ...
                            layout: {
                                default: [{
                                    ...
                                    assetName: "scat",
                                    animation: {
                                        assetName: "symbolEffect",
                                        skin: "scat",
                                        effectName: {
                                            normal: "win",
                                            scale: "win-move",
                                            scaleLeft: "win-move-lefthand"
                                        }
                                    }
                                }, {
                                    textureAtlas: "symbols_static",
                    ...
                    init() {
                        function t(t) {
                            var e = ot()(t, "freespins.win", 0),
                                i = ot()(t, "feature", "");
                            jt.store.set("free:type", ot()(t, "freespins.type", 2));
                            var s = jt.store.get("free:left", 0),
                        ...
                        jt.store.set("free:win", 0), jt.store.set("free:coins", 0), jt.store.set("free:count", 0), jt.store.set("free:left", -1), jt.store.set("free:played", -1), jt.store.set("free:isStart", !1), jt.store.set("free:isEnd", !1), jt.store.set("free:isFree", !1), jt.store.set("free:winAdditional", !1), jt.store.set("free:type", 2), jt.server.on("response:init", t), jt.server.on("response:spin", t), jt.server.on("response:buyin", t), jt.server.on("response:risk", t)
                    }
                };
                var Vi;
                ! function(t) {
                        ...
                        init() {
                            ...
                            function e(e) {
                                var i = ot()(e, "win", 0),
                                    ...
                                    o = ot()(e, "overlayWilds", []),
                                    n = ot()(e, "preSpin", []);
                                jt.store.set("reward:win", i), jt.store.set("reward:lines", ot()(e, "lines", [])), jt.store.set("reward:reels", ot()(e, "reels", e.error ? Gi : [])), jt.store.set("reward:nReels", ot()(e, "nReels", e.error ? Hi : [])), jt.store.set("reward:fsReels", ot()(e, "fsReels", [])), jt.store.set("reward:preReels", ot()(e, "preSpin.reels", [])), jt.store.set("reward:scatters", s), jt.store.set("reward:isWin", i > 0 || s || o.length > 0), jt.store.set("reward:numberWinSymbol", ot()(e, "winSyms", 0)), jt.store.set("reward:overlaySyms", ot()(e, "overlaySyms", [])), jt.store.set("reward:newOverlaySyms", ot()(e, "newOverlaySyms", []));
                                var a = ot()(e, "feature", Vi.Basic);
                                jt.store.set("reward:feature", a), jt.store.set("reward:collection", ot()(e, 0 === n.length ? "collection" : "preSpin.collection", {})), jt.store.set("reward:potential", ot()(e, 0 === n.length ? "potential" : "preSpin.potential", {})), t(e)
                            }

                            function i(e) {
                                var i = ot()(e, "win", 0);
                                jt.store.set("reward:win", i), jt.store.set("reward:lines", ot()(e, "lines", [])), jt.store.set("reward:fsReels", ot()(e, "fsReels", [])), jt.store.set("reward:reels", ot()(e, "reels", e.error ? Gi : [])), jt.store.set("reward:nReels", ot()(e, "nReels", e.error ? Hi : []));
                                var s = ot()(e, "feature", Vi.Basic);
                                "freespin" === s && zi.set("freespin"), jt.store.set("reward:feature", s), t(e)
                            }
                            jt.store.set("reward:win", 0), jt.store.set("reward:isWin", !1), jt.store.set("reward:lines", []), jt.store.set("reward:reels", []), jt.store.set("reward:nReels", []), jt.store.set("reward:fsReels", []), jt.store.set("reward:preReels", []), jt.store.set("reward:scatters", !1), jt.store.set("reward:stickyWilds", [!1, !1, !1, !1, !1]), jt.store.set("reward:numberWinSymbol", 0), jt.store.set("reward:overlaySyms", []), jt.store.set("reward:newOverlaySyms", []), jt.store.set("isRiskNBuy", !1), jt.store.set("risk", !1), jt.store.set("buy", !1), jt.store.set("reward:feature", ""), jt.store.set("reward:collection", {}), jt.store.set("reward:potential", {}), jt.server.on("response:init", e), jt.server.on("response:spin", e), jt.server.on("response:buyin", i), jt.server.on("response:risk", i)
                        }
                    },
                    Yi = {
                        init() {
                ...
                class Ki extends Z {
                    constructor(t, e, i) {
                        super(t, e, i), (0, n.Z)(this, "backgroundFree", void 0), (0, n.Z)(this, "backgroundNormal", void 0), (0, n.Z)(this, "bigWin", void 0), (0, n.Z)(this, "clickNormal", void 0), (0, n.Z)(this, "currentWinSound", void 0), (0, n.Z)(this, "freeEnd", void 0), (0, n.Z)(this, "freeStart", void 0), (0, n.Z)(this, "giantWin", void 0), (0, n.Z)(this, "progressFill", void 0), (0, n.Z)(this, "progressFillEnd", void 0), (0, n.Z)(this, "progressSymbols", void 0), (0, n.Z)(this, "scatterReel", void 0), (0, n.Z)(this, "scatterWin", void 0), (0, n.Z)(this, "spinFast", void 0), (0, n.Z)(this, "spinStart", void 0), (0, n.Z)(this, "wheelStop", void 0), (0, n.Z)(this, "winFree1", void 0), (0, n.Z)(this, "winFree2", void 0), (0, n.Z)(this, "winFree3", void 0), (0, n.Z)(this, "winNormal1", void 0), (0, n.Z)(this, "winNormal2", void 0), (0, n.Z)(this, "winNormal3", void 0), this.backgroundNormal = this.get("backgroundNormal"), this.backgroundFree = this.get("backgroundFree"), this.freeStart = this.get("freeStart"), this.freeEnd = this.get("freeEnd"), this.winNormal1 = this.get("win_normal_1"), this.winNormal2 = this.get("win_normal_2"), this.winNormal3 = this.get("win_normal_3"), this.winFree1 = this.get("win_free_1"), this.winFree2 = this.get("win_free_2"), this.winFree3 = this.get("win_free_3"), this.bigWin = this.get("bigWin"), this.giantWin = this.get("giantWin"), this.spinStart = this.get("spinStart"), this.spinFast = this.get("spinFast"), this.clickNormal = this.get("clickNormal"), this.wheelStop = this.get("wheelStop"), this.scatterWin = this.get("scatterWin"), this.scatterReel = this.get("scatterReel"), this.progressFill = this.get("progressFill"), this.progressFillEnd = this.get("progressFillEnd"), this.progressSymbols = this.get("progressSymbols"), this.currentWinSound = null, this._setupEvents()
                    }
                    _setupEvents() {
                        ...
                        })), jt.action.on("state:spin_enter", this._onSpinEnter, this), jt.action.on("state:finish_enter", this._onFinishEnter, this), jt.action.on("sound:spinFast", this._onFastSpin, this), jt.action.on("sound:wheel_stop_down", this._onWheelStop, this), jt.action.on("sound:click", this.click, this), jt.action.on("sound:free_start", this._onFreeStart, this), jt.action.on("sound:free_stop", this._onFreeStop, this), jt.action.on("free:select_start", this._onSelectFreeStart, this), jt.action.on("free:select_stop", this._onSelectFreeStop, this), jt.action.on("sound:scale", (t => {
                            "fill-end" === t ? this.progressFillEnd.play() : this.progressFill.play()
                        })), jt.action.on("sound:progressSymbols", (() => {
                            this.progressSymbols.play()
                        }))
                    }
                    stopBigWin() {
                ...
                class is extends es {
                    get stopIfWin() {
                        var t, e, i, s = (null === (t = this.game.store.get("reward:collection", {})[this.game.betLevel.bet]) || void 0 === t ? void 0 : t.coin) >= this.game.config.get("coinScale", 0);
                        return super.stopIfWin || s && (null === (e = this.stopItemWin) || void 0 === e ? void 0 : e.checked) && (null === (i = this.stopItemWin) || void 0 === i ? void 0 : i.type) === fe
                    }
                }
                class ss extends Gt {
                    constructor() {
                ...
                const ls = JSON.parse('{"AutoPlaySettingsStopCondButtonReset":"Reset","AutoPlaySettingsStopCondCheckboxBalance":"If Balance Increases By","AutoPlaySettingsStopCondCheckboxBalanceDrop":"If Balance Decreases By","AutoPlaySettingsStopCondCheckboxFeatureBonus":"If Bonus Game Won","AutoPlaySettingsStopCondCheckboxFeatureFreeSpin":"If Free Spins Won","AutoPlaySettingsStopCondCheckboxWin":"If Win","AutoPlaySettingsStopCondCheckboxWinAny":"Any","AutoPlaySettingsStopCondCheckboxWinBig":"Big","AutoPlaySettingsStopCondCheckboxWinGiant":"Giant","AutoPlaySettingsStopCondTitle":"STOP AUTOPLAY","AutoPlaySettingsSubTitle":"Setup your best autoplay conditions","AutoPlaySettingsTitle":"AUTOPLAY","BetSettingsLines":"LINES\\n<value>%s</value>","BetSettingsTitle":"BET SETTINGS","BetSettingsWays":"WAYS\\n<value>%s</value>","ControlsDesktopAutoPlayStart":"AUTOPLAY","ControlsDesktopAutoPlayStop":"STOP AUTO","ControlsDesktopBalance":"BALANCE%s\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopBet":"BET %s\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopFreeRoundLeft":"FREE ROUND\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopFreeRoundWin":"TOTAL WIN %s\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopFreeRoundWinEmpty":"TOTAL WIN","ControlsDesktopFreeSpinsLast":"FREE SPINS LEFT\\n<delimiter> \\n</delimiter><value>LAST</value>","ControlsDesktopFreeSpinsLeft":"FREE SPINS LEFT\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopLines":"LINES\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopMaxBet":"MAX BET","ControlsDesktopTotalWin":"TOTAL WIN %s\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopWays":"WAYS\\n<delimiter> \\n</delimiter><value>%s</value>","ControlsDesktopWin":"WIN %s\\n<delimiter> \\n</delimiter><value>%s</value>","Currency":"CURRENCY\\n<value>%s</value>","GameRulesAdvancedAutoPlayContent":"Advanced autoplay settings are available in the section with standard autoplay settings. You can set the conditions for stopping the game in automatic mode:\\n\\n<bold>if win any/big/giant</bold> - autoplay will be stopped after any/big/giant win\\n\\n<bold>if balance increased by 10%-100%</bold> - autoplay will stop when your balance increases by the selected %\\n\\n<bold>if balance decreased by 10%-100%</bold> - autoplay will be interrupted when your balance decreases by the selected %\\n\\nClick <bold>Reset</bold> to reset all autoplay settings","GameRulesAdvancedAutoPlayTitle":"Advanced Autoplay Settings","GameRulesAutoPlayContent":"Select the number of game rounds to play in automatic mode by pressing the button with the corresponding number, or press the button with the infinity sign to play in automatic mode until the autoplay is manually canceled or until the balance runs out. Your choice must be confirmed with the Start button.","GameRulesAutoPlayTitle":"Autoplay Options","GameRulesBestExperience":"Please note that you can only play one game at a time on each account. Therefore, you cannot play a game on more than one device, or multiple games on the same device simultaneously. Doing so may lead to various errors.\\n\\nFor the best gaming experience, we recommend using the latest version of the relevant software.","GameRulesGeneralRTP":"Theoretical RTP: %s %","GameRulesGeneralTitle":"General Info","GameRulesInterfaceAutoPlay":"Click to go to autoplay menu","GameRulesInterfaceBalance":"Here is your current balance","GameRulesInterfaceBetLevel":"Your current bet and a button to go to the bet size selection menu","GameRulesInterfaceContent":"All buttons of the game interface are listed below. Please note that the appearance and location of the buttons may differ slightly depending on the format in which the game is launched and what feature it is currently in.","GameRulesInterfaceMenu":"Click to access the game menu","GameRulesInterfaceQuickSpin":"Click to enable/disable quick spin","GameRulesInterfaceSound":"Turn game sound on/off and adjust sound volume","GameRulesInterfaceSpin":"Click to start the game round at the current bet. In the desktop version of the game, the button may have an alternative design","GameRulesInterfaceTitle":"Game Interface","GameRulesInterfaceWin":"Here is the win in the current game round","GameRulesSettingsContent":"To go to the settings menu, click the cogwheel icon in the game menu","GameRulesSettingsContentItemBackgroundSound":"<bold>Background music</bold> - turns on/off background music in the game","GameRulesSettingsContentItemFullscreen":"<bold>Full Screen</bold> - enables/disables full screen mode","GameRulesSettingsContentItemGameSound":"<bold>Game sound</bold> - turns on/off the sound effects of the game","GameRulesSettingsContentItemQuickSpin":"<bold>Quick Spin</bold> - turns on/off the function of the accelerated mode of rotation and stop of the reels","GameRulesSettingsTitle":"Game Settings","GameSettingsBackgroundSounds":"Background Music","GameSettingsFullscreen":"Full Screen","GameSettingsGameSounds":"Game Sounds","GameSettingsIntroScreen":"Intro Screen","GameSettingsLeftHand":"Left Hand Mode","GameSettingsQuickSpin":"Quick Spin","GameSettingsRiskFeatureCheckbox":"Risk&Buy","GameSettingsTitle":"GAME SETTINGS","IntroScreenHideButtonText":"Don\'t show next time","IntroScreenLoaderText":"LOADING","MenuDesktopButtonFullscreen":"FULLSCREEN","MenuDesktopButtonHome":"HOME","MenuDesktopButtonPaytable":"PAYTABLE","MenuDesktopButtonQuickspin":"QUICKSPIN","MenuDesktopButtonSound":"SOUND","MenuGameRules":"GAME INFORMATION","MenuMobileBetSettingsTitle":"BET SETTINGS","MenuMobileGameSettingsLeftHand":"Left Hand Mode","MenuMobileGameSettingsQuickspin":"Quick Spin","MenuMobileGameSettingsSounds":"Game Sounds","MenuMobileGameSettingsTitle":"GAME SETTINGS","MenuMobilePaytableTitle":"PAYTABLE","MenuPaytable":"PAYTABLE","MenuSettings":"SETTINGS","NetPositionTitle":"Net Position: %s","PopupActionClose":"Close","PopupActionContinue":"Continue","PopupActionEnable":"Enable","PopupActionNo":"No","PopupActionReload":"Reload","PopupActionYes":"Yes","PopupFreeRoundEndMessage":"The next spins will use your bonus amount","PopupFreeRoundEndTitle":"Free Rounds Finished","PopupFreeRoundLastMessage":"Congratulations, you have\\n last free round","PopupFreeRoundStartMessage":"Congratulations, you have\\n%s free rounds","PopupFreeRoundStartTitle":"Free Rounds Bonus","PopupFreeSpinsButton":"CLICK ANYWHERE TO CONTINUE","PopupFreeSpinsStopDescription":"<value>%s FREE SPINS</value> PLAYED","PopupFreeSpinsStopDescriptionNew":"%s Free Spins played","PopupFreeSpinsTitle":"CONGRATULATIONS","PopupFreeSpinsTitleNew":"CONGRATULATIONS! YOU WON","PopupFreeSpinsTitleRestore":"IN-GAME FEATURE RESTORED!","PopupFreeSpinsWinRestore":"<value>%s FREE SPINS</value> LEFT","PopupFreeSpinsWinRestoreLast":"<value>LAST FREE SPIN</value> LEFT","PopupFreeSpinsWinStart":"YOU WON <value>%s FREE SPINS</value>","PopupFreeSpinsWinStartNew":"%s FREE SPINS","PopupFreeSpinsWinStop":"YOU WON <value>%s</value>","PopupFreeSpinsWinStopNew":"<value>%s</value>","PopupMaxLimitMessage":"Bet exceeded max bet limit.","PopupMaxLimitTitle":"Max limit","PopupNetworkErrorMessage":"Please reload the game.","PopupNetworkErrorTitle":"Connection Lost","PopupQuickSpinMessage":"It seems you prefer to play a bit faster.\\nWould you like to enable Quick Spin?","PopupQuickSpinTitle":"Quick Spin","PopupRestoreMessage":"In-game feature restored!","PopupRiskNBuyContentBuy":"Buy in a feature for %s\\nthat will play at the bet %s","PopupRiskNBuyContentRisk":"Take the risk of winning %s\\nto get a feature at the bet %s","PopupRiskNBuyTitleBuy":"BUY IN FEATURE","PopupRiskNBuyTitleRisk":"RISK FEATURE","PopupSoundMessage":"Play with sound?","PopupSpendingBudgetMessage":"You have reached your play limit.\\nWelcome back later.","PopupSpendingBudgetTitle":"Play limit","PopupUnexpectedErrorMessage":"An unexpected situation.\\nReload the page.","PopupUnexpectedErrorTitle":"Unexpected situation","PopupZeroBalanceMessage":"Please change your BET LEVEL or top up your balance","PopupZeroBalanceTitle":"Insufficient funds","RiskNBuyBuyFor":"BUY FOR %s","RiskNBuyFreeSpinsText":"FREE SPINS","RiskNBuyOnBet":"ON BET %s","RiskNBuySubHeader":"RISK YOUR WIN\\nTO PLAY","StatusBarMobileBalance":"BALANCE %s\\n","StatusBarMobileBet":"BET %s\\n","StatusBarMobileFreeLast":"FREE SPINS LEFT\\n<value>LAST</value>","StatusBarMobileFreeLeft":"FREE SPINS LEFT\\n<value>%s</value>","StatusBarMobileFreePlayed":"FREE SPINS PLAYED\\n","StatusBarMobileFreeRoundLeft":"FREE ROUND\\n","StatusBarMobileTotalWin":"TOTAL WIN %s\\n","StatusBarMobileWin":"WIN %s\\n","TimeElapsedTitle":"Time Elapsed: %s"}'),
                    cs = JSON.parse('{"IntroScreenDescription0":"Accumulate symbols to get a guaranteed coin win or Free Spins","IntroScreenDescription1":"Buy Free Spins or risk your winnings for them","PaytableSectionBetLinesContent1":"Only the highest win per bet line is paid. All prizes are for combinations left to right, beginning from the leftmost reel. The payout values are based on the currently selected bet and change proportionally with its changes. The game is played with fixed bet lines. Malfunction voids all pays and plays.","PaytableSectionBetLinesTitle":"Bet Lines","PaytableSectionBonusContent1":"Each Bonus symbol, dropped out in the game round, fills the Bonus symbol accumulation scale. 25 accumulated Bonus symbols give coin win.","PaytableSectionBonusTitle":"Bonus symbol","PaytableSectionFreeContent1":"2 scales for accumulating Bonus and Scatter symbols are located on the side of the game reels in the main game only. With each new spin, the denominations of the prizes that can be won when the scale is filled change. When accumulating the required number of Scatter or Bonus symbols, the player receives the prize indicated on the screen in the current game round. Each bet level has its own accumulation of Scatter and Bonus symbols.","PaytableSectionFreeTitle":"Free Spins and Instant win scales","PaytableSectionPayoutTitle":"Symbol payout values","PaytableSectionRiskContent1":"The Risk\'n\'Buy feature will be offered in the main game to the player after each spin, regardless of whether or not there is a win. The Risk\'n\'Buy feature will offer to either risk the current win and immediately go to the Free Spins feature, or buy the Free Spins feature at the specified cost and immediately go to them.\\n\\nThe player makes his own decision to agree to the proposed version of the Risk\'n\'Buy feature or continue to the main game. The current winnings, in case of risk, or the indicated value, in case of a purchase, will be deducted from the player’s balance in the form of a bet. Free spins received in the Risk\'n\'Buy feature will occur at the bet at which it was accepted by the player. Risk\'n\'Buy feature is not available in autoplay.","PaytableSectionRiskTitle":"Risk\'n\'Buy feature","PaytableSectionScatterContent1":"Each Scatter symbol, dropped out in the game round, fills the accumulation scale of Scatter symbols. 40 accumulated Scatter symbols trigger the Free Spins feature.\\n\\nFree Spins play automatically at the bet at which they were won. All wins during Free Spins are multiplied by X3. Additional Free Spins cannot be won in the current Free Spins series.","PaytableSectionScatterTitle":"Scatter symbol and Free Spins feature","PaytableSectionWildContent1":"Wild symbols substitute for all symbols exсept Scatter and Bonus symbols.","PaytableSectionWildTitle":"Wild symbol","PopupFreeSpinsDescription":"with x3 multiplier","PopupFreeSpinsFreeCount":"FREE SPINS: %s","PopupFreeSpinsFreeCountEnd":"FREE SPINS PLAYED: %s","PopupFreeSpinsFreeCountRestore":"FREE SPINS LEFT: %s","PopupFreeSpinsWin":"You won"}');
                                ...
                                if (l) {
                                    ...
                                    switch (l.type) {
                                        case I.AttachmentType.Region:
                                            ...
                                            c.transform.setFromMatrix(r.bone.matrix), r.currentSprite.color ? d = r.currentSprite.color : (gs[0] = o[0] * r.color.r * u.r, gs[1] = o[1] * r.color.g * u.g, gs[2] = o[2] * r.color.b * u.b, r.currentSprite.tint = it.rgb2hex(gs)), r.currentSprite.blendMode = r.blendMode;
                                            break;
                                        case I.AttachmentType.Mesh:
                                            ...
                                            l.computeWorldVerticesOld(r, r.currentMesh.vertices), r.currentMesh.color ? d = r.currentMesh.color : (gs[0] = o[0] * r.color.r * u.r, gs[1] = o[1] * r.color.g * u.g, gs[2] = o[2] * r.color.b * u.b, r.currentMesh.tint = it.rgb2hex(gs)), r.currentMesh.blendMode = r.blendMode;
                                            break;
                ...
                class As extends(zt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "backgroundLTextureFree", void 0), (0, n.Z)(this, "backgroundLTextureNormal", void 0), (0, n.Z)(this, "backgroundPTextureFree", void 0), (0, n.Z)(this, "backgroundPTextureNormal", void 0), (0, n.Z)(this, "backgroundTextureLandscape", void 0), (0, n.Z)(this, "backgroundTexturePortrait", void 0), (0, n.Z)(this, "bgAnimation", void 0), (0, n.Z)(this, "featureBackground", void 0), (0, n.Z)(this, "logo", void 0), (0, n.Z)(this, "multiplier", void 0), this.backgroundLTextureNormal = this.game.loader.getAsset("bgln"), this.backgroundLTextureFree = this.game.loader.getAsset("bglf"), this.backgroundPTextureNormal = this.game.loader.getAsset("bgpn"), this.backgroundPTextureFree = this.game.loader.getAsset("bgpf"), this.backgroundTextureLandscape = this.backgroundLTextureNormal, this.backgroundTexturePortrait = this.backgroundPTextureNormal, this.background = new $.j(this.backgroundTextureLandscape), this.background.name = "background", this.featureBackground = new $.j(this.backgroundLTextureFree), this.featureBackground.name = "featureBackground", this.featureBackground.alpha = 0, this.bgAnimation = new ms(this.game.loader.getAsset("assets/images/effects/bg/skeleton.json")), this.bgAnimation.changeSkin("bg"), this.bgAnimation.play("animation", !0), this.logo = new $.j(this.game.loader.getAsset("logo")), this.logo.position.set(960, 8), this.logo.alpha = 0, this.multiplier = this.addChild(new Pe("", {
                            default: {
                                fontSize: 90,
                                fontFamily: "Valorant",
                                fill: "#40fa21",
                        ...
                        })), this.multiplier.text = "x3", this.multiplier.alpha = 0, this.addChild(this.background), this.addChild(this.featureBackground), this.addChild(this.bgAnimation), this.addChild(this.logo), this.addChild(this.multiplier), this.setupEvents()
                    }
                    setupEvents() {
                        this.game.action.on("state:setup_enter", (() => {
                            ...
                            this.multiplier.alpha = 0, this.background.texture = this.game.device.portrait && !this.game.device.desktop ? this.backgroundTexturePortrait : this.backgroundTextureLandscape
                        })), this.game.action.on("free:select_start", (() => {
                            this.logo.alpha = 1, this.multiplier.alpha = 1
                            ...
                            }), this.logo.alpha = 1, this.multiplier.alpha = 0
                        }))
                    }
                    beforeFreeSpinsPopup() {
                        this.logo.alpha = 0, this.multiplier.alpha = 0, this.featureBackground.texture = this.game.device.portrait && !this.game.device.desktop ? this.backgroundPTextureFree : this.backgroundLTextureFree, 0 === this.featureBackground.alpha && k.fromTo(this.featureBackground, .5, {
                            pixi: {
                                alpha: 0
                            }
                        }, {
                    ...
                    gameStart() {
                        this.game.store.get("free:isFree", !1) || (this.logo.alpha = 1)
                    }
                    resize() {
                        this.game.device.portrait && !this.game.device.desktop ? (this.background.texture = this.backgroundTexturePortrait, this.background.position.set(-this.game.viewport.paddingX, 0), this.featureBackground.texture = this.backgroundPTextureFree, this.featureBackground.position.set(-this.game.viewport.paddingX, 0), this.logo.scale.set(1.5), this.logo.position.set(210, 320), this.game.device.tablet ? (this.background.width = 2 * this.game.viewport.paddingX + this.game.viewport.width, this.background.height = this.background.width / .5625, this.featureBackground.width = 2 * this.game.viewport.paddingX + this.game.viewport.width, this.featureBackground.height = this.background.width / .5625) : (this.background.height = 2 * this.game.viewport.paddingY + this.game.viewport.height, this.background.width = 2 * this.game.viewport.paddingX + .5625 * this.background.height, this.featureBackground.height = 2 * this.game.viewport.paddingY + this.game.viewport.height, this.featureBackground.width = 2 * this.game.viewport.paddingX + .5625 * this.background.height), this.bgAnimation.pivot.set(400, -200), this.multiplier.position.set(40, 750)) : (this.logo.scale.set(1), this.logo.position.set(0, 8), this.background.texture = this.backgroundTextureLandscape, this.background.width = this.game.viewport.width, this.background.height = this.game.viewport.height, this.background.position.set(0, 0), this.featureBackground.texture = this.backgroundLTextureFree, this.featureBackground.width = this.game.viewport.width, this.featureBackground.height = this.game.viewport.height, this.featureBackground.position.set(0, 0), this.bgAnimation.pivot.set(0), this.multiplier.position.set(140, 430))
                    }
                }
                ...
                class bs extends Xt {
                    constructor() {
                        super(vs), (0, n.Z)(this, "name", "ButtonAutoPlay"), (0, n.Z)(this, "startTexture", void 0), (0, n.Z)(this, "stopTexture", void 0), (0, n.Z)(this, "counts", void 0), (0, n.Z)(this, "countsInfinity", void 0), (0, n.Z)(this, "enterKey", void 0), (0, n.Z)(this, "onEnterClick", void 0), this.startTexture = c.xE.from(vs), this.stopTexture = c.xE.from("data:image/png;base64,"), this.onEnterClick = new(S()), this.counts = this.addChild(new A.xv("", {
                            fontFamily: "Avenir-Bold",
                            fontSize: 28,
                            fill: this.game.config.get("colors.primary")
                ...
                class _s extends Zs {
                    constructor(t) {
                        ...
                        })), this.betLevel = t, this.betLevelText = this.addChild(new Pe("", js(js({}, Ds.Common), {}, {
                            default: js(js({}, Ds.Common.default), {}, {
                                align: "left"
                            })
                ...
                const zs = function(t) {
                    var e = new Pe("", Vs(Vs({}, t), {}, {
                        default: Vs(Vs({}, t.default), {}, {
                            wordWrap: !0,
                            wordWrapWidth: 200
                        })
                    }));
                ...
                const Gs = function(t) {
                    ...
                    return e.visible = !1, e.anchor.x = .5, jt.action.on("update:win", (function(t) {
                        var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "regular";
                        i("regular" === e ? jt.wallet.totalCoins - jt.wallet.progressCoinsWin : jt.wallet.totalCoins)
                    })), {
                        container: e,
                        hide: function() {
                            e.visible = !1
                ...
                class Ys extends Pe {
                    constructor() {
                        super("", Qs(Qs({}, Ds.Common), {}, {
                            default: Qs(Qs({}, Ds.Common.default), {}, {
                                align: "right"
                            })
                        }))
                    }
                    update(t) {
                        t >= 0 && (this.text = jt.i18n.t("ControlsDesktopBalance", jt.i18n.currency({
                            withBrace: !0,
                            withSpace: !0
                        }), jt.helpers.toMoney(t)), jt.action.emit("balance_updated", t))
                    }
                }
                class Xs extends Pe {
                    constructor() {
                        super("", Ds.FreeSpins), this.visible = !1
                    }
                    change(t) {
                ...
                class to extends Os {
                    constructor() {
                        ...
                        this.background = $.j.from("data:image/png;base64,"), this.background.alpha = .4, this.background.anchor.set(0, 1), this.background.position.set(0, this.game.viewport.height), this.buttonMenu = new ws, this.buttonMenu.position.set(77, 1013), this.buttonMaxBet = new _s(this.game.betLevel), this.buttonMaxBet.position.set(213, 1013), this.buttonAutoPlay = new bs, this.buttonAutoPlay.position.set(833, 1013), this.buttonQuickSpin = new ys, this.buttonQuickSpin.position.set(1084, 1014), this.buttonSound = new Fs, this.buttonSound.position.set(1840, 1012), this.buttonSpin = function() {
                            ...
                            e.name = "buttonSpin", e.hitArea = new X.Circle(125, 112, 74);
                            var i = new ms(jt.loader.getAsset("effectSpin"));
                            i.position.set(50, 40), i.play("active", !0), e.addChild(i), e.onClick.add(o), e.onHover.add((() => {
                                i.play("hover", !1)
                            })), e.onLeave.add((() => {
                                i.play("active", !0)
                            }));
                            ...
                            function o() {
                                t.handlers(!0) ? t.dispatch() : (jt.store.get("spin:isSpin", !1) || i.play("press", !1).then((() => {
                                    jt.store.get("spin:isFast", !1) || i.play("active", !0)
                                })), jt.action.emit("clickSpin"))
                            }
                            ...
                            return s.onPress.add(o), s.disable(), jt.action.on("spin:fast", (function() {
                                ...
                                zi.isFreespin() || (i.play("active", !0), e.enable(), s.enable())
                        ...
                        }(e.btn_spin_active, e.btn_spin_hover, e.btn_spin_press, e.btn_spin_inactive), this.buttonSpin.container.position.set(850, 905), this.buttonSpin.container.scale.set(.9), this.buttonAccept = new fs, this.buttonAccept.position.set(958, 1013), this.textWin = new $s, this.textWin.anchor.x = .5, this.textWin.position.set(1400, 980), this.textBalance = new Ys, this.textBalance.anchor.x = 1, this.textBalance.position.set(1760, 980), this.freeRoundLeft = zs(Ds.Common), this.freeRoundLeft.container.position.set(1700, 1054), this.freeRoundTotalWin = Gs(Ds.Common), this.freeRoundTotalWin.container.position.set(1400, 980), this.textFreeSpinLeft = new Xs, this.textFreeSpinLeft.visible = !1, this.textFreeSpinLeft.anchor.x = .5, this.textFreeSpinLeft.position.set(640, 980), this.textFreeSpinTotalWin = new Js, this.textFreeSpinTotalWin.visible = !1, this.textFreeSpinTotalWin.anchor.x = .5, this.textFreeSpinTotalWin.position.set(960, 965), this.addChild(this.background), this.addChild(this.textFreeSpinLeft), this.addChild(this.textFreeSpinTotalWin), this.addChild(this.buttonMenu), this.addChild(this.buttonMaxBet), this.game.config.get("autoPlay.available", !0) && this.addChild(this.buttonAutoPlay), this.game.config.get("quickSpin.available", !0) && this.addChild(this.buttonQuickSpin), this.addChild(this.buttonSound), this.addChild(this.buttonSpin.container), this.addChild(this.buttonAccept), this.addChild(this.textWin), this.game.config.get("balanceHide", !1) || this.addChild(this.textBalance), this.addChild(this.freeRoundTotalWin.container), this.addChild(this.freeRoundLeft.container), this.textWin.update(this.game.wallet.coins), this.textBalance.update(this.game.wallet.balance), this.game.freeRound.onStart.once((t => {
                            ...
                            var i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0,
                                s = zi.isFreespin();
                            s || t.textBalance.update(t.game.wallet.balance - (jt.store.get("free:isStart", !1) ? 0 : i))
                        }))
                    }
                    lock() {
                ...
                class ro extends(zt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "state", void 0), (0, n.Z)(this, "textBet", void 0), (0, n.Z)(this, "textWin", void 0), (0, n.Z)(this, "textBalance", void 0), (0, n.Z)(this, "textFreeRound", void 0), (0, n.Z)(this, "textFree", void 0), (0, n.Z)(this, "textTotalWin", void 0), (0, n.Z)(this, "textBonus", void 0), (0, n.Z)(this, "delimiter", void 0), this.state = no.Normal, this.textBet = new Pe("", so(so({}, ao), {}, {
                            default: so(so({}, ao.default), {}, {
                                align: "left"
                            })
                        })), this.textBet.anchor.set(0, 0), this.textWin = new Pe("", ao), this.textWin.anchor.set(.5, 0), this.textBalance = new Pe("", so(so({}, ao), {}, {
                            default: so(so({}, ao.default), {}, {
                                align: "right"
                            })
                        })), this.textBalance.anchor.set(1, 0), this.textFreeRound = new Pe("", so(so({}, ao), {}, {
                            default: so(so({}, ao.default), {}, {
                                align: "center",
                                wordWrap: !0,
                                wordWrapWidth: 300
                            })
                        })), this.textFreeRound.anchor.set(1, 1), this.textFree = new Pe("", so(so({}, ho), {}, {
                            default: so(so({}, ho.default), {}, {
                                fontSize: 30,
                                wordWrapWidth: 340
                            })
                        })), this.textFree.anchor.set(0, 1), this.textTotalWin = new Pe("", so(so({}, ho), {}, {
                            default: so(so({}, ho.default), {}, {
                                fontFamily: "Avenir-Bold",
                                fill: this.game.config.get("colors.primary"),
                                fontSize: 30,
                        ...
                        })), this.textTotalWin.anchor.set(.5, 1), this.textBonus = new Pe("", so(so({}, ho), {}, {
                            default: so(so({}, ho.default), {}, {
                                fontSize: 27,
                                wordWrapWidth: 340
                            })
                ...
                class co extends Os {
                    constructor() {
                        ...
                        })), this.buttonMenu = new ws, this.buttonSound = new Fs, this.buttonSpin = new lo, this.game.interaction.hover(this.buttonSpin, (() => {
                        ...
                        })), this.buttonAccept = new fs, this.buttonQuickSpin = new ys, this.autoPlayButton = new bs, this.autoPlayButton.scale.set(1.6), this.betButton = new Zs, this.betButton.disable(), this.betButton.onClick.add((() => this.game.action.emit("clickMaxBet"))), this.game.action.on("update:win", (t => {
                            this.game.freeRound.enabled ? this.statusBar.update({
                                type: oo.Win,
                                value: zi.isFreespin() ? this.game.wallet.coins : this.game.wallet.totalCoins
                            }) : this.statusBar.update({
                                type: oo.Win,
                                value: t
                            })
                        ...
                        })), this.game.action.on("update:balance", (t => {
                ...
                class po extends(zt(Q.W2)) {
                    ...
                    createLoadingText(t) {
                        return this.addChild(new uo(t))
                    }
                }
                class go extends(zt($.j)) {
                    constructor(t) {
                ...
                class mo extends(zt(Q.W2)) {
                    constructor(t) {
                        super(), (0, n.Z)(this, "left", void 0), (0, n.Z)(this, "right", void 0), this.renderable = t > 1, this.left = this.addChild(new go("left")), this.left.position.set(0, 0), this.right = this.addChild(new go("right")), this.right.position.set(910, 0)
                    }
                    get allArrows() {
                ...
                class vo extends(zt(Q.W2)) {
                    constructor(t, e) {
                        ...
                        for (var i = 0; i < t; i++) {
                            var s = this.buttonsContainer.addChild(new Ao);
                ...
                class fo extends(zt(Q.W2)) {
                    constructor(t) {
                        super(), (0, n.Z)(this, "button", void 0), (0, n.Z)(this, "buttonText", void 0), (0, n.Z)(this, "checked", void 0), (0, n.Z)(this, "onClick", void 0), this.interactive = !0, this.cursor = "pointer", this.checked = !1, this.onClick = new(S()), this.button = this.addChild(new Ao), this.buttonText = this.addChild(new Pe("", {
                            default: {
                                fill: t,
                                fontFamily: "Avenir-Bold",
                                fontSize: 20,
                ...
                class wo extends fo {
                    resize() {
                        this.game.device.desktop ? (this.position.set(458, 905), this.button.scale.set(1), this.buttonText.position.set(40, 22)) : (this.position.set(this.game.device.landscape ? 410 : 330, this.game.device.landscape ? 975 : 1050), this.button.scale.set(1.6), this.buttonText.scale.set(1.5), this.buttonText.position.set(70, 35))
                    }
                }
                ...
                class So extends yo {
                    resize() {
                        this.description.setTagStyle("default", {
                            wordWrapWidth: this.game.viewport.width / 3.8
                        }), this.game.device.desktop ? (this.scale.set(1.1), this.position.set(960, 90)) : this.game.device.landscape ? (this.description.setTagStyle("default", {
                            wordWrapWidth: this.game.viewport.width / 3.8,
                            align: "left"
                        }), this.scale.set(1.2), this.position.set(960, 90), this.description.anchor.x = 0, this.description.position.set(-456, this.featurePreview.y + this.featurePreview.height - 20)) : (this.description.setTagStyle("default", {
                            wordWrapWidth: this.game.viewport.width / 2,
                            align: "center"
                        }), this.scale.set(1.4), this.position.set(530, 10), this.description.anchor.x = .5, this.description.position.set(0, this.featurePreview.y + this.featurePreview.height - 20))
                    }
                }
                class xo extends So {
                    resize() {
                        super.resize(), this.description.setTagStyle("default", {
                            breakWords: ["ja", "cn"].includes(this.game.i18n.language)
                        })
                    }
                }
                class ko extends po {
                    constructor() {
                        super(), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "logo", void 0), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "playButtonBg", void 0), this.overlay = this.addChild(new Jt(.75)), this.content = this.addChild(new Q.W2), this.logo = this.content.addChild(new $.j(this.game.loader.getAsset("assets/images/introScreen/texture.json", "introLogo"))), this.logo.anchor.x = .5, this.logo.position.set(this.game.viewport.width / 2, 60), this.slides.push(this.content.addChild(new So(0))), this.slides.push(this.content.addChild(new xo(1, !0))), this.pagination = this.content.addChild(new vo(this.visibleViewsCount, 50)), this.pagination.position.set(480, 675), this.hideButton = this.content.addChild(new wo("#40fa21")), this.arrows = this.content.addChild(new mo(this.visibleViewsCount)), this.arrows.position.set(500, 420), this.playButtonBg = this.content.addChild(new $.j(this.game.loader.getAsset("assets/images/introScreen/texture.json", "btn-bg"))), this.playButtonBg.position.set(960, 890), this.playButton = this.playButtonBg.addChild(new bo), this.playButton.anchor.set(.5), this.playButton.position.set(this.playButtonBg.width / 2, this.playButtonBg.height / 2), this.setupArrows(), this.setupPagination(), this.setupHideButton(), this.setupSlides()
                    }
                    resize() {
                        this.logo.position.set(this.game.viewport.width / 2, 60), this.game.device.desktop ? (this.pagination.scale.set(1), this.pagination.position.set(480, 675)) : (this.pagination.scale.set(1.6), this.pagination.position.set(this.game.device.landscape ? 450 : 140, this.game.device.landscape ? 705 : 1050)), this.game.device.tablet && this.game.device.portrait ? (this.content.scale.set(1.2), this.content.position.set(-100, 240)) : (this.content.scale.set(1), this.content.position.set(0, this.game.device.portrait && !this.game.device.desktop ? 400 : 0)), this.game.device.portrait && !this.game.device.desktop ? (this.playButtonBg.scale.set(1.4), this.playButtonBg.position.set(310, 1220), this.logo.scale.set(1.5), this.logo.position.set(this.game.viewport.width / 2, -110)) : (this.logo.scale.set(1), this.logo.position.set(this.game.viewport.width / 2, 60), this.playButtonBg.scale.set(1), this.playButtonBg.position.set(1190, 740))
                    }
                }
                class Co extends(zt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "name", "FeatureProgressText"), (0, n.Z)(this, "timeline", void 0), (0, n.Z)(this, "textValue", void 0), (0, n.Z)(this, "textDescription", void 0), this.alpha = 0, this.timeline = new C, this.textValue = this.addChild(new v.Xz("", {
                            fontName: "WinFont"
                        })), this.textValue.scale.set(.7), this.textValue.anchor.y = .5, this.textValue.rotation = -.2, this.textDescription = this.addChild(new $.j(this.game.loader.getAsset("assets/images/scaleFeature/texture.json", "instant-win")))
                    }
                    show(t, e) {
                        return new Promise((i => {
                            ...
                            }, this.textValue.text = "fs" === e ? "".concat(t) : "".concat(this.game.helpers.toMoney(t), " ").concat(this.game.i18n.currency()), this.textDescription.texture = jt.loader.getAsset("assets/images/scaleFeature/texture.json", "fs" === e ? "free-spins-won" : "instant-win"), this.position.set("fs" === e ? 600 : this.game.leftHand.enabled ? -1094 : 470, 130), this.textValue.position.set("fs" === e ? -this.textValue.width : this.textDescription.width, "fs" === e ? this.textDescription.height / 2 + this.textValue.height / 2 : this.textDescription.height / 2 - this.textValue.height / 2), this.timeline.set(this, {
                                pixi: {
                                    alpha: 0,
                                    scale: 1
                                }
                ...
                var Bo, Po = 426,
                    Eo = 108,
                    To = Symbol("FeatureProgress");
                class Fo extends(zt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "id", To), (0, n.Z)(this, "bg", void 0), (0, n.Z)(this, "fsScaleImage", void 0), (0, n.Z)(this, "coinsScaleImage", void 0), (0, n.Z)(this, "fsFeatureName", void 0), (0, n.Z)(this, "coinsFeatureName", void 0), (0, n.Z)(this, "fsPotential", void 0), (0, n.Z)(this, "coinsPotential", void 0), (0, n.Z)(this, "fsCount", void 0), (0, n.Z)(this, "coinsCount", void 0), (0, n.Z)(this, "fsScaleAmmount", void 0), (0, n.Z)(this, "coinScaleAmmount", void 0), (0, n.Z)(this, "fsScaleAnimation", void 0), (0, n.Z)(this, "coinScaleAnimation", void 0), (0, n.Z)(this, "featureProgressText", void 0), (0, n.Z)(this, "currentFsPosition", void 0), (0, n.Z)(this, "currentCoinPosition", void 0), (0, n.Z)(this, "currentFsCount", void 0), (0, n.Z)(this, "currentCoinCount", void 0), this.currentFsPosition = Po, this.currentCoinPosition = Eo, this.currentFsCount = 0, this.currentCoinCount = 0, this.fsScaleAmmount = jt.config.get("scatScale", 0), this.coinScaleAmmount = jt.config.get("coinScale", 0), this.bg = this.addChild(new $.j(this.game.loader.getAsset("assets/images/scaleFeature/texture.json", "border"))), this.fsScaleImage = this.bg.addChild(new $.j(this.game.loader.getAsset("assets/images/scaleFeature/texture.json", "scale-fs"))), this.fsScaleImage.anchor.set(.5), this.fsScaleImage.position.set(this.bg.width / 2, Po), this.coinsScaleImage = this.bg.addChild(new $.j(this.game.loader.getAsset("assets/images/scaleFeature/texture.json", "scale-coins"))), this.coinsScaleImage.anchor.set(.5), this.coinsScaleImage.position.set(this.bg.width / 2, Eo), this.fsScaleAnimation = this.addChild(new ms(this.game.loader.getAsset("assets/images/effects/counter/skeleton.json"))), this.fsScaleAnimation.changeSkin("free-spins"), this.fsScaleAnimation.position.set(-126, -230), this.fsScaleAnimation.alpha = 0, this.coinScaleAnimation = this.addChild(new ms(this.game.loader.getAsset("assets/images/effects/counter/skeleton.json"))), this.coinScaleAnimation.changeSkin("coins"), this.coinScaleAnimation.position.set(-126, -230), this.coinScaleAnimation.alpha = 0, this.fsFeatureName = this.addChild(new $.j(this.game.loader.getAsset("assets/images/scaleFeature/texture.json", "free spins"))), this.fsFeatureName.position.set(-70, 20), this.coinsFeatureName = this.addChild(new $.j(this.game.loader.getAsset("assets/images/scaleFeature/texture.json", "coins"))), this.coinsFeatureName.position.set(-70, 330);
                        var t = this.bg.addChild(new u.TC);
                        t.beginFill(0, 1), t.drawRect(0, -24, 100, 310), t.endFill(), this.fsScaleImage.mask = t;
                        var e = this.bg.addChild(new u.TC);
                        e.beginFill(0, 1), e.drawRect(0, 284, 100, 310), e.endFill(), this.coinsScaleImage.mask = e, this.fsPotential = this.addChild(new Pe("", {
                            default: {
                                fontSize: 40,
                                fontFamily: "Valorant",
                                fill: "#40fa21",
                        ...
                        })), this.fsPotential.anchor.x = .5, this.fsPotential.position.set(this.bg.width / 2, -90), this.coinsPotential = this.addChild(new Pe("", {
                            default: {
                                fontSize: 40,
                                fontFamily: "Valorant",
                                fill: "#ffe829",
                        ...
                        })), this.coinsPotential.anchor.x = .5, this.coinsPotential.position.set(this.bg.width / 2, 578), this.fsCount = this.addChild(new Pe("", {
                            default: {
                                fontSize: 35,
                                fontFamily: "Valorant",
                                fill: "#ffffff",
                        ...
                        })), this.fsCount.position.set(25, 40), this.fsCount.rotation = -.1, this.fsCount.text = "0/".concat(this.fsScaleAmmount), this.coinsCount = this.addChild(new Pe("", {
                            default: {
                                fontSize: 35,
                                fontFamily: "Valorant",
                                fill: "#ffffff",
                        ...
                        })), this.coinsCount.position.set(25, 490), this.coinsCount.rotation = -.1, this.coinsCount.text = "0/".concat(this.coinScaleAmmount), this.featureProgressText = this.addChild(new Co)
                    }
                    setFsCount(t) {
                        this.fsPotential.text = "".concat(t, "\nFS")
                    }
                    setCoins(t) {
                        this.coinsPotential.text = "".concat(this.game.helpers.toMoney(t), "\n").concat(this.game.i18n.currency())
                    }
                    updatePotential() {
                        var t = this.game.store.get("reward:potential", {});
                        0 !== Object.keys(t).length && (this.setFsCount(t.scat), this.fsPotential.position.set(this.bg.width / 2, -90), this.setCoins(t.coin), this.coinsPotential.position.set(this.bg.width / 2, 578))
                    }
                    update() {
                        var t = arguments,
                            e = this;
                        return (0, o.Z)((function*() {
                            var i = t.length > 0 && void 0 !== t[0] ? t[0] : "regular",
                                s = t.length > 1 && void 0 !== t[1] && t[1],
                                o = t.length > 2 && void 0 !== t[2] && t[2],
                                n = e.game.store.get("reward:collection", {}),
                                a = e.game.store.get("reward:potential", {}),
                                h = !1;
                            if (0 !== Object.keys(n).length) {
                                e.setFsCount(a.scat), e.fsPotential.position.set(e.bg.width / 2, -90), e.setCoins(a.coin), e.coinsPotential.position.set(e.bg.width / 2, 578);
                                var r = n[e.game.betLevel.bet] ? n[e.game.betLevel.bet].scat : 0,
                                    l = n[e.game.betLevel.bet] ? n[e.game.betLevel.bet].coin : 0;
                                "changeBet" === i && (s = r >= e.fsScaleAmmount, o = l >= e.coinScaleAmmount), o || s || "afterFs" === i || (r = n[e.game.betLevel.bet] ? n[e.game.betLevel.bet].scat > e.fsScaleAmmount ? e.fsScaleAmmount : n[e.game.betLevel.bet].scat : 0, l = n[e.game.betLevel.bet] ? n[e.game.betLevel.bet].coin > e.coinScaleAmmount ? e.coinScaleAmmount : n[e.game.betLevel.bet].coin : 0);
                                var c = r >= e.fsScaleAmmount ? r - e.fsScaleAmmount : 0,
                                    d = l >= e.coinScaleAmmount ? l - e.coinScaleAmmount : 0;
                                r = c > 0 || s ? c : r !== e.fsScaleAmmount || "update" !== i && "afterFs" !== i ? r : 0, l = d > 0 || o ? d : l !== e.coinScaleAmmount || "update" !== i && "afterFs" !== i ? l : 0, e.fsCount.text = "".concat(r, "/").concat(e.fsScaleAmmount), e.coinsCount.text = "".concat(l, "/").concat(e.coinScaleAmmount);
                                var u = (e.fsScaleImage.height - 52) / e.fsScaleAmmount * r,
                                    p = (e.coinsScaleImage.height - 52) / e.coinScaleAmmount * l;
                                if ("regular" === i || "update" === i) {
                                    if (k.to(e.fsScaleImage, .2, {
                                            pixi: {
                                                y: r > 0 ? Po - u - 26 : Po
                                            }
                                        }), k.to(e.coinsScaleImage, .2, {
                                            pixi: {
                                                y: l > 0 ? Eo + p + 62 : Eo
                                            }
                                        }), e.currentCoinPosition !== Eo + p && !s && e.currentCoinCount !== l) {
                                        e.currentCoinPosition = Eo + p, e.coinScaleAnimation.alpha = 1;
                                        var g = e.coinsCount.scale.x;
                                        k.fromTo(e.coinsCount, .2, {
                                            pixi: {
                                                scale: g
                                            }
                                        }, {
                                            ...
                                            yoyo: !0,
                                            repeat: 1
                                        }), e.coinScaleAnimation.play("fill"), e.game.action.emit("sound:scale", "fill"), h = !0
                                    }
                                    if (e.currentFsPosition !== Po - u && !o && e.currentFsCount !== r) {
                                        e.currentFsPosition = Po - u, e.fsScaleAnimation.alpha = 1;
                                        var m = e.fsCount.scale.x;
                                        k.fromTo(e.fsCount, .2, {
                                            pixi: {
                                                scale: m
                                            }
                                        }, {
                                            ...
                                            yoyo: !0,
                                            repeat: 1
                                        }), e.fsScaleAnimation.play("fill"), e.game.action.emit("sound:scale", "fill"), h = !0
                                    }
                                    l === e.coinScaleAmmount && (e.coinScaleAnimation.play("fill-end"), e.game.action.emit("sound:scale", "fill-end"), e.featureProgressText.show(a.coin, "coin "), yield e.game.delay(2e3), jt.action.emit("update:win", jt.wallet.progressCoinsWin + jt.wallet.coins, "progress"), 0 === e.game.freeRound.left && (yield e.game.delay(300)), h = !0), r === e.fsScaleAmmount && (e.fsScaleAnimation.play("fill-end"), e.game.action.emit("sound:scale", "fill-end"), yield e.featureProgressText.show(a.scat, "fs"), h = !0)
                                } else "changeBet" === i && e.game.action.emit("sound:scale", "fill"), e.fsScaleImage.y = r > 0 ? Po - u - 26 : Po, e.coinsScaleImage.y = l > 0 ? Eo + p + 62 : Eo, e.currentFsPosition = Po - u, e.currentCoinPosition = Eo + p;
                                yield e.game.delay(h || s || o ? 500 : 0), e.currentFsCount = r, e.currentCoinCount = l
                            }
                        }))()
                    }
                    hide() {
                        "regular" === (arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "regular") ? k.fromTo(this, .3, {
                            pixi: {
                                alpha: 1
                            }
                        }, {
                    ...
                    showText() {
                        var t = this;
                        return (0, o.Z)((function*() {
                            var e, i, s, o, n = t.game.store.get("reward:collection", {}),
                                a = null !== (e = null === (i = n[t.game.betLevel.bet]) || void 0 === i ? void 0 : i.scat) && void 0 !== e ? e : 0,
                                h = null !== (s = null === (o = n[t.game.betLevel.bet]) || void 0 === o ? void 0 : o.coin) && void 0 !== s ? s : 0;
                            0 !== Object.keys(n).length && ((h >= t.coinScaleAmmount || a >= t.fsScaleAmmount) && t.update("update", a >= t.fsScaleAmmount, h >= t.coinScaleAmmount), t.game.store.get("free:isStart", !1) && (yield t.game.delay(1e3)))
                        }))()
                    }
                    resize() {
                        this.game.device.desktop || this.game.device.landscape ? (this.scale.set(1), this.game.leftHand.enabled ? this.position.set(1690, 220) : this.position.set(this.game.device.desktop ? 150 : 247, 220), this.coinsPotential.setTagStyle("default", {
                            fontSize: 56
                        })) : (this.scale.set(.8), this.position.set(80, 620), this.coinsPotential.setTagStyle("default", {
                            fontSize: 44
                        }))
                    }
                }! function(t) {
                ...
                class Oo extends(zt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "_timeline", void 0), (0, n.Z)(this, "_keyboardSpace", void 0), (0, n.Z)(this, "_content", void 0), (0, n.Z)(this, "_overlay", void 0), (0, n.Z)(this, "_image", void 0), (0, n.Z)(this, "_title", void 0), (0, n.Z)(this, "_win", void 0), (0, n.Z)(this, "_description", void 0), (0, n.Z)(this, "_buttonText", void 0), (0, n.Z)(this, "completeResolve", void 0), (0, n.Z)(this, "tweenAutoTimeout", void 0), this.visible = !1, this.completeResolve = !1, this.cursor = "pointer", this.interactive = !1, this._overlay = this.addChild(new Jt(.7)), this._content = this.addChild(new Q.W2), this._content.interactive = !1, this._content.interactiveChildren = !1, this._image = this._content.addChild(new $.j(this.game.loader.getAsset("assets/images/freespin/popup-image.png"))), this._image.anchor.set(.5, -.5), this._image.y = -110, this._title = this._content.addChild(new Pe("", {
                            default: {
                                fill: "#fffb91",
                                fontFamily: "Avenir-Bold",
                                fontSize: 45,
                        ...
                        })), this._title.anchor.set(.5, 1), this._title.position.set(0, 20), this._win = this._content.addChild(new Pe("", {
                            default: {
                                fill: "#ffffff",
                                fontFamily: "Avenir-Bold",
                                align: "center",
                        ...
                        })), this._win.anchor.set(.5), this._win.position.set(0, 210), this._description = this._content.addChild(new Pe("", {
                            default: {
                                fontFamily: "Avenir-Bold",
                                fill: "#ffffff",
                                align: "center",
                        ...
                        })), this._description.anchor.set(.5), this._description.position.set(0, 440), this._buttonText = this._content.addChild(new Pe("", {
                            default: {
                                fontFamily: "Avenir-Bold",
                                fill: "#f391ff",
                                fontSize: 45,
                    ...
                    show(t) {
                        ...
                        return new Promise((i => {
                            ...
                            if (t === Bo.START) {
                                ...
                                this._title.text = this.game.i18n.t("PopupFreeSpinsTitleNew"), this._win.text = this.game.i18n.t("PopupFreeSpinsWinStartNew", o), this._description.text = this.game.i18n.t("PopupFreeSpinsDescription"), this._buttonText.text = this.game.i18n.t("PopupFreeSpinsButton"), e && (this.tweenAutoTimeout = k.to(this._buttonText, 1, {
                                    pixi: {
                                        scale: 1.1
                                    },
                                    repeat: 5,
                                ...
                                var n = this.game.helpers.toMoney(this.game.freeRound.enabled ? this.game.wallet.freespinCoins : this.game.wallet.totalCoins),
                                    a = this.game.store.get("free:count", 0);
                                this._title.text = this.game.i18n.t("PopupFreeSpinsTitleNew"), this._win.text = this.game.i18n.t("PopupFreeSpinsWinStopNew", "".concat(n, "\t").concat(this.game.i18n.currency())), this._description.text = this.game.i18n.t("PopupFreeSpinsStopDescriptionNew", a), this._buttonText.text = this.game.i18n.t("PopupFreeSpinsButton"), e && (this.tweenAutoTimeout = k.to(this._buttonText, 1, {
                                    pixi: {
                                        scale: 1.1
                                    },
                                    repeat: 5,
                    ...
                    showContent(t) {
                        return t === Bo.RESTORE ? Promise.resolve() : new Promise((t => {
                    ...
                    resize() {
                        ...
                        }), this._title.position.set(0, this.game.device.portrait ? 70 : 20), this._win.setTagStyle("default", {
                            wordWrapWidth: this.game.viewport.width / 1.2
                        }), this._win.position.set(0, this.game.device.portrait ? 410 : 210), this._description.setTagStyle("default", {
                            wordWrapWidth: this.game.device.portrait ? this.game.viewport.width / 1.2 : this.game.viewport.width / 2.2
                        }), this._description.position.set(0, this.game.device.portrait ? 670 : 440), this._buttonText.setTagStyle("default", {
                            wordWrapWidth: this.game.viewport.width,
                            breakWords: "ja" === window.language
                        }), this._buttonText.position.set(0, this.game.device.portrait ? 820 : 600), this._content.pivot.set(0, this._content.height / 2), this.game.device.portrait ? this._content.position.set(this.game.viewport.width / 2, this.game.viewport.height / 2.3) : this._content.position.set(this.game.viewport.width / 2, this.game.viewport.height / 2)
                    }
                }
                ...
                class Lo extends(zt(Q.W2)) {
                    constructor(t) {
                        var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [];
                        super(), (0, n.Z)(this, "_payTableBetLineBoxs", void 0), (0, n.Z)(this, "_payTableParagraph", void 0), (0, n.Z)(this, "_payTableTitle", void 0), this._payTableBetLineBoxs = new Q.W2, this._payTableTitle = new Do(this.game.i18n.t("PaytableSectionBetLinesTitle").toUpperCase()), this._payTableParagraph = new Wo(this.game.i18n.t("PaytableSectionBetLinesContent1")), t.forEach(((t, i) => {
                ...
                class No extends(zt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "_sectionParagraph1", void 0), (0, n.Z)(this, "_sectionTitle", void 0), this.visible = this.game.config.get("rnb", !0), this._sectionTitle = new Do(this.game.i18n.t("PaytableSectionRiskTitle").toUpperCase()), this._sectionTitle.position.set(0, 0), this._sectionParagraph1 = new Wo(this.game.i18n.t("PaytableSectionRiskContent1")), this._sectionParagraph1.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this.addChild(this._sectionTitle), this.addChild(this._sectionParagraph1)
                    }
                    resize() {
                ...
                class Vo extends(zt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "_sectionParagraph1", void 0), (0, n.Z)(this, "_sectionTitle", void 0), (0, n.Z)(this, "_symbolBonus", void 0), this._sectionTitle = new Do(jt.i18n.t("PaytableSectionBonusTitle").toUpperCase()), this._sectionTitle.position.set(0, 0), this._symbolBonus = new Uo("coin"), this._symbolBonus.withoutPayout(), this._symbolBonus.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this._sectionParagraph1 = new Wo(jt.i18n.t("PaytableSectionBonusContent1")), this._sectionParagraph1.position.set(0, this._symbolBonus.y + this._symbolBonus.height + 30), this.addChild(this._sectionTitle), this.addChild(this._sectionParagraph1), this.addChild(this._symbolBonus)
                    }
                    resize() {
                ...
                class zo extends(zt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "_sectionParagraph1", void 0), (0, n.Z)(this, "_sectionTitle", void 0), this._sectionTitle = new Do(jt.i18n.t("PaytableSectionFreeTitle").toUpperCase()), this._sectionTitle.position.set(0, 0), this._sectionParagraph1 = new Wo(jt.i18n.t("PaytableSectionFreeContent1")), this._sectionParagraph1.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this.addChild(this._sectionTitle), this.addChild(this._sectionParagraph1)
                    }
                    resize() {
                        this.game.device.desktop || this._sectionParagraph1.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30)
                    }
                ...
                class Go extends(zt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "sectionTitle", void 0), (0, n.Z)(this, "symbolA", void 0), (0, n.Z)(this, "symbolAir", void 0), (0, n.Z)(this, "symbolBlue", void 0), (0, n.Z)(this, "symbolJ", void 0), (0, n.Z)(this, "symbolK", void 0), (0, n.Z)(this, "symbolLava", void 0), (0, n.Z)(this, "symbolQ", void 0), (0, n.Z)(this, "symbolSattelite", void 0), (0, n.Z)(this, "symbolTen", void 0), (0, n.Z)(this, "symbolViolet", void 0), (0, n.Z)(this, "symbols", void 0), this.sectionTitle = new Do(jt.i18n.t("PaytableSectionPayoutTitle").toUpperCase()), this.symbolLava = new Uo("lava", "default", "fs"), this.symbolLava.position.set(0, this.sectionTitle.y + this.sectionTitle.height + 30), this.symbolAir = new Uo("air", "default", "fs"), this.symbolAir.position.set(600, this.sectionTitle.y + this.sectionTitle.height + 30), this.symbolSattelite = new Uo("sattelite", "default", "fs"), this.symbolSattelite.position.set(0, this.symbolLava.y + this.symbolLava.height + 30), this.symbolViolet = new Uo("violet"), this.symbolViolet.position.set(600, this.symbolAir.y + this.symbolAir.height + 30), this.symbolBlue = new Uo("blue"), this.symbolBlue.position.set(0, this.symbolSattelite.y + this.symbolSattelite.height + 30), this.symbolA = new Uo("A"), this.symbolA.position.set(600, this.symbolViolet.y + this.symbolViolet.height + 30), this.symbolK = new Uo("K"), this.symbolK.position.set(0, this.symbolBlue.y + this.symbolBlue.height + 30), this.symbolQ = new Uo("Q"), this.symbolQ.position.set(600, this.symbolA.y + this.symbolA.height + 30), this.symbolJ = new Uo("J"), this.symbolJ.position.set(0, this.symbolK.y + this.symbolK.height + 30), this.symbolTen = new Uo("Ten"), this.symbolTen.position.set(600, this.symbolQ.y + this.symbolQ.height + 30), this.symbols = [this.symbolLava, this.symbolAir, this.symbolSattelite, this.symbolViolet, this.symbolBlue, this.symbolA, this.symbolK, this.symbolQ, this.symbolJ, this.symbolTen], this.addChild(this.sectionTitle, ...this.symbols)
                    }
                    updateBet(t) {
                        this.symbols.forEach((e => e.updateBet(t)))
                    }
                    resize() {
                        this.game.device.desktop || (this.game.device.landscape ? (this.symbolLava.position.set(0, this.sectionTitle.y + this.sectionTitle.height + 30), this.symbolAir.position.set(820, this.sectionTitle.y + this.sectionTitle.height + 30), this.symbolSattelite.position.set(0, this.symbolLava.y + this.symbolLava.height + 30), this.symbolViolet.position.set(820, this.symbolAir.y + this.symbolAir.height + 30), this.symbolBlue.position.set(0, this.symbolSattelite.y + this.symbolSattelite.height + 30), this.symbolA.position.set(820, this.symbolViolet.y + this.symbolViolet.height + 30), this.symbolK.position.set(0, this.symbolBlue.y + this.symbolBlue.height + 30), this.symbolQ.position.set(820, this.symbolA.y + this.symbolA.height + 30), this.symbolJ.position.set(0, this.symbolK.y + this.symbolK.height + 30), this.symbolTen.position.set(820, this.symbolQ.y + this.symbolQ.height + 30)) : (this.symbolLava.position.set(0, this.sectionTitle.y + this.sectionTitle.height + 30), this.symbolAir.position.set(0, this.symbolLava.y + this.symbolLava.height + 30), this.symbolSattelite.position.set(0, this.symbolAir.y + this.symbolAir.height + 30), this.symbolViolet.position.set(0, this.symbolSattelite.y + this.symbolSattelite.height + 30), this.symbolBlue.position.set(0, this.symbolViolet.y + this.symbolViolet.height + 30), this.symbolA.position.set(0, this.symbolBlue.y + this.symbolBlue.height + 30), this.symbolK.position.set(0, this.symbolA.y + this.symbolA.height + 30), this.symbolQ.position.set(0, this.symbolK.y + this.symbolK.height + 30), this.symbolJ.position.set(0, this.symbolQ.y + this.symbolQ.height + 30), this.symbolTen.position.set(0, this.symbolJ.y + this.symbolJ.height + 30)))
                    }
                }
                class Ho extends(zt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "_sectionParagraph1", void 0), (0, n.Z)(this, "_sectionTitle", void 0), (0, n.Z)(this, "_symbolScatter", void 0), this._sectionTitle = new Do(jt.i18n.t("PaytableSectionScatterTitle").toUpperCase()), this._sectionTitle.position.set(0, 0), this._symbolScatter = new Uo("scat"), this._symbolScatter.withoutPayout(), this._symbolScatter.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this._sectionParagraph1 = new Wo(jt.i18n.t("PaytableSectionScatterContent1")), this._sectionParagraph1.position.set(0, this._symbolScatter.y + this._symbolScatter.height + 30), this.addChild(this._sectionTitle), this.addChild(this._sectionParagraph1), this.addChild(this._symbolScatter)
                    }
                    resize() {
                        this.game.device.desktop || (this._symbolScatter.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this._sectionParagraph1.position.set(0, this._symbolScatter.y + this._symbolScatter.height + 30))
                    }
                }
                class Qo extends(zt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "_sectionParagraph1", void 0), (0, n.Z)(this, "_sectionTitle", void 0), (0, n.Z)(this, "_symbolWild", void 0), this._sectionTitle = new Do(jt.i18n.t("PaytableSectionWildTitle").toUpperCase()), this._sectionTitle.position.set(0, 0), this._symbolWild = new Uo("wild"), this._symbolWild.withoutPayout(), this._symbolWild.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this._sectionParagraph1 = new Wo(jt.i18n.t("PaytableSectionWildContent1")), this._sectionParagraph1.position.set(0, this._symbolWild.y + this._symbolWild.height + 30), this.addChild(this._sectionTitle), this.addChild(this._sectionParagraph1), this.addChild(this._symbolWild)
                    }
                    resize() {
                        this.game.device.desktop || (this._symbolWild.position.set(0, this._sectionTitle.y + this._sectionTitle.height + 30), this._sectionParagraph1.position.set(0, this._symbolWild.y + this._symbolWild.height + 30))
                    }
                }
                class Yo extends Zo {
                    constructor(t) {
                        super(), (0, n.Z)(this, "_payTableSectionRisk", void 0), (0, n.Z)(this, "_paytableSectionBetLines", void 0), (0, n.Z)(this, "_paytableSectionBonus", void 0), (0, n.Z)(this, "_paytableSectionFree", void 0), (0, n.Z)(this, "_paytableSectionPayout", void 0), (0, n.Z)(this, "_paytableSectionScatter", void 0), (0, n.Z)(this, "_paytableSectionWild", void 0), (0, n.Z)(this, "payTableDelimiter", void 0), this.payTableDelimiter = new _o, this._payTableSectionRisk = new No, this._paytableSectionPayout = new Go, this._paytableSectionWild = new Qo, this._paytableSectionScatter = new Ho, this._paytableSectionBonus = new Vo, this._paytableSectionFree = new zo, this._paytableSectionBetLines = new jo(t), this.content.addChild(this._payTableSectionRisk, this._paytableSectionPayout, this._paytableSectionWild, this._paytableSectionScatter, this._paytableSectionBonus, this._paytableSectionFree, this.payTableDelimiter, this._paytableSectionBetLines)
                    }
                    updateBet(t) {
                ...
                function pn(t) {
                    for (var e = 1; e < arguments.length; e++) {
                        var i = null != arguments[e] ? arguments[e] : {};
                        e % 2 ? un(Object(i), !0).forEach((function(e) {
                            (0, n.Z)(t, e, i[e])
                        })) : Object.getOwnPropertyDescriptors ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(i)) : un(Object(i)).forEach((function(e) {
                            Object.defineProperty(t, e, Object.getOwnPropertyDescriptor(i, e))
                        }))
                    }
                    return t
                }
                class gn extends(zt(Pe)) {
                    constructor() {
                        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                        super("", pn(pn({}, t), {}, {
                            default: pn({
                ...
                class mn extends en {
                    constructor() {
                        super(), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "backgroundContent", void 0), (0, n.Z)(this, "buyFor", void 0), (0, n.Z)(this, "buyValue", void 0), (0, n.Z)(this, "featureButton", void 0), (0, n.Z)(this, "header", void 0), (0, n.Z)(this, "labelDescription", void 0), (0, n.Z)(this, "labelHeader", void 0), (0, n.Z)(this, "onBet", void 0), (0, n.Z)(this, "onBetValue", void 0), (0, n.Z)(this, "onPress", void 0), this.name = "RiskFeature", this.onPress = new(S()), this.backgroundContent = this.addChild(new Q.W2), this.backgroundContent.renderable = !0, this.background = this.backgroundContent.addChild(new $.j(this.game.loader.getAsset("assets/images/risk/texture.json", "bg-buy"))), this.header = this.background.addChild(new rn({
                            default: {
                                fill: "#64c51d",
                                fontSize: 22,
                                wordWrapWidth: 260
                            }
                        })), this.labelHeader = this.background.addChild(new v.Xz("", {
                            fontName: "WinFont"
                        })), this.labelHeader.scale.set(.8), this.labelHeader.anchor.x = .5, this.labelDescription = this.backgroundContent.addChild(new nn({
                            default: {
                                fontSize: 32
                            }
                        })), this.buyFor = this.backgroundContent.addChild(new qo({
                            default: {
                                fill: "#64c51d",
                                fontSize: 22,
                                wordWrapWidth: 220
                            }
                        })), this.buyValue = this.backgroundContent.addChild(new tn), this.onBet = this.backgroundContent.addChild(new dn({
                            default: {
                                fill: "#1dc3c5",
                                fontSize: 22
                            }
                        })), this.onBetValue = this.backgroundContent.addChild(new gn), this.featureButton = this.backgroundContent.addChild(new $.j(this.game.loader.getAsset("assets/images/risk/texture.json", "btn-buy"))), this.featureButton.cursor = "pointer", this.featureButton.interactive = !1, this.game.interaction.click(this.featureButton, (() => {
                            this.featureButton.interactive = !1, this.onPress.dispatch()
                        })), this.featureButton.anchor.x = .5
                    }
                    show(t) {
                        if (this.game.store.get("isRiskNBuy", !1) && (super.show(t), this.visible)) {
                            var e = this.game.store.get("risk", !1),
                                i = this.game.store.get("buy", !1);
                            this.featureButton.interactive = !0, this.backgroundContent.renderable = !0, k.to(this.background, .5, {
                                pixi: {
                                    alpha: 1
                                }
                            }), setTimeout((() => {
                                this.featureButton.interactive = !0
                            }), 150), e ? (this.background.texture = this.game.loader.getAsset("assets/images/risk/texture.json", "bg-risk"), this.header.show(), this.buyFor.hide(), this.buyValue.hide(), this.featureButton.texture = this.game.loader.getAsset("assets/images/risk/texture.json", "btn-risk"), this.labelHeader.text = e.freespins, this.onBetValue.text = "".concat(jt.helpers.toMoneySS(this.game.betLevel.toCoins())), this.buyFor.setTagStyle("default", {
                                fill: "#64c51d"
                            }), this.header.position.set(this.background.width / 2, 90), this.labelHeader.position.set(this.background.width / 2, 110), this.labelDescription.position.set(this.background.width / 2, 300), this.onBet.position.set(this.background.width / 2, this.labelDescription.height + this.labelDescription.y + 30), this.onBetValue.position.set(this.background.width / 2, this.onBet.height + this.onBet.y + 10), this.featureButton.position.set(this.background.width / 2, 486)) : (this.background.texture = this.game.loader.getAsset("assets/images/risk/texture.json", "bg-buy"), this.header.hide(), this.buyFor.show(), this.buyValue.show(), this.featureButton.texture = this.game.loader.getAsset("assets/images/risk/texture.json", "btn-buy"), this.labelHeader.text = i.freespins, this.buyValue.text = "".concat(jt.helpers.toMoneySS(i.bet)), this.onBetValue.text = "".concat(jt.helpers.toMoneySS(this.game.betLevel.toCoins())), this.buyFor.setTagStyle("default", {
                                fill: "#1dc3c5"
                            }), this.labelHeader.position.set(this.background.width / 2, -20), this.labelDescription.position.set(this.background.width / 2, 180), this.buyFor.position.set(this.background.width / 2, this.labelDescription.y + this.labelDescription.height + 20), this.buyValue.position.set(this.background.width / 2, this.buyFor.height + this.buyFor.y + 10), this.onBet.position.set(this.background.width / 2, this.buyValue.height + this.buyValue.y + 20), this.onBetValue.position.set(this.background.width / 2, this.onBet.height + this.onBet.y + 10), this.featureButton.position.set(this.background.width / 2, 486))
                        }
                    }
                    hide() {
                        super.hide();
                        this.game.store.get("risk", !1), this.game.store.get("buy", !1);
                        this.backgroundContent.renderable = !1, this.background.scale.set(1), this.backgroundContent.scale.set(1), this.featureButton.interactive = !1
                    }
                    resize() {
                        this.game.device.desktop ? this.position.set(1576, 170) : this.game.device.landscape ? this.game.leftHand.enabled ? this.position.set(1440, 190) : this.position.set(10, 160) : this.position.set(this.game.viewport.paddingX + 840, 500)
                    }
                }
                ...
                class fn extends(zt(Q.W2)) {
                    constructor(t) {
                        var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [];
                        super(), (0, n.Z)(this, "lines", void 0), (0, n.Z)(this, "points", new Map), this.lines = t.map((t => this.addChild(new vn(t)))), this.game.device.desktop && e.map((t => this.points.set(t.line, t.position.map((e => {
                            var i = this.addChild(new bn(t.line));
                ...
                class xn {
                    constructor() {
                        (0, n.Z)(this, "container", void 0), (0, n.Z)(this, "timeline", void 0), (0, n.Z)(this, "textValue", void 0), (0, n.Z)(this, "textDescription", void 0), this.timeline = new C, this.container = new Q.W2, this.container.name = "TextFreeLeft", this.container.alpha = 0, this.textValue = new v.Xz("", {
                            fontName: "WinFont"
                        }), this.textValue.scale.set(.6), this.textValue.anchor = .5, this.textDescription = new $.j(jt.loader.getAsset("textLastFreeSpin")), this.textDescription.scale.set(1), this.textDescription.texture = jt.loader.getAsset("textFreeSpinLeft"), this.container.addChild(this.textValue), this.container.addChild(this.textDescription)
                    }
                    show(t) {
                        return new Promise((e => {
                            this.timeline.clear(), this.timeline.vars = {
                            ...
                            }, t < 1 ? (this.textValue.text = "", this.textDescription.texture = jt.loader.getAsset("textLastFreeSpin"), this.textDescription.position.set(-190, 50), this.timeline.set(this.container, {
                                pixi: {
                                    alpha: 0,
                                    scale: 1
                                }
                            ...
                            }, "+=0.75")) : (this.textValue.text = "".concat(t), this.textDescription.texture = jt.loader.getAsset("textFreeSpinLeft"), this.textValue.position.set(0, 30), this.textDescription.position.set(-190, 120), this.timeline.set(this.container, {
                                pixi: {
                                    alpha: 0,
                                    scale: 1
                                }
                ...
                const Cn = class extends kn {
                    ...
                    allPayment(t) {
                        var e = this;
                        return (0, o.Z)((function*() {
                            e.slot.staticAnimation.hide(e.slot.reels);
                            var i = jt.store.get("reward:collection", {}),
                                s = jt.store.get("reward:potential", {});
                            e.slot.reels.forEach((t => t.overlay())), e.slot.lines.show(t);
                            for (var o = 0, n = t.length; o < n; o++) {
                                var a = t[o];
                                e._wins.push(a), e._runSymbolAnimation(a)
                            }
                            var h = e._getWinSoundNumber();
                            jt.action.emit("sound:win", h);
                            var r = jt.wallet.balance;
                            yield e.slot.textTotalWin.show(jt.wallet.coins, (() => {
                                jt.action.emit("update:win", jt.wallet.coins), jt.action.emit("update:totalWin", jt.wallet.totalCoins), jt.action.emit("update:balance", r, 0 !== Object.keys(i).length && i[jt.betLevel.bet].coin >= jt.config.get("coinScale", 0) ? s.coin : 0)
                            }))
                        }))()
                    }
                    breakAllPayment() {
                    ...
                    scatterPayment(t) {
                        var e = this;
                        return (0, o.Z)((function*() {
                            if (e.slot.staticAnimation.hide(e.slot.reels), e.slot.reels.forEach((t => t.stopAnimation())), e.slot.lines.hide(), e.slot.textLineWin.clear(), e.slot.reels.forEach((t => t.overlay())), jt.action.emit("sound:scatterWin"), e.slot.lines.hide(), jt.action.emit("textLineWin:hide"), jt.store.get("free:winAdditional", !1)) {
                                e._runSymbolAnimation(t, !1, "extraFree");
                            ...
                            } else e._runSymbolAnimation(t, !1, "free"), yield jt.delay(Ni.get("reward_scatter"))
                        }))()
                    }
                    scalePayment() {
                        var t = this;
                        return (0, o.Z)((function*() {
                            var e = jt.store.get("reward:lines", []),
                                i = !1;
                            t.slot.reels.forEach(((t, e) => {
                                t.visibleSymbols.forEach(((t, e) => {
                                    "scat" !== t.data.assetName && "coin" !== t.data.assetName || (i = !0)
                                }))
                            })), i && t.slot.staticAnimation.hide(t.slot.reels), t.slot.reels.forEach(((t, e) => {
                                t.visibleSymbols.forEach(((t, s) => {
                                    "scat" !== t.data.assetName && "coin" !== t.data.assetName || (t.playAnimation(jt.leftHand.enabled && jt.device.landscape ? "scaleLeft" : "scale", s, e, 0), i = !0)
                                }))
                            })), i && (jt.action.emit("sound:progressSymbols"), yield jt.delay(1500), e.length <= 0 && t.slot.staticAnimation.runStatic(t.slot.reels))
                        }))()
                    }
                    complete() {
                        var t = this;
                        return (0, o.Z)((function*() {
                            t.isStop ? t.stop() : t._wins.length > 0 ? t._flush() : t.slot.lines.enable()
                        }))()
                    }
                    _flush() {
                        var t = !0,
                        ...
                        for (var s = 0; s < e.length; s++)
                            if (-1 !== e[s]) {
                                var o = e[s],
                                    ...
                                    a = jt.config.get("slot.size[0]") * o + s;
                                n.playAnimation(i, a, s, 100 * s)
                            }
                    }
                    _showLineText(t) {
                        var {
                        ...
                        for (var h = 0, r = this.validBlendModes[h], l = !0; l;) {
                            for (var c of (l = !1, i)) {
                                ...
                                if (!c.isComplete) {
                                    ...
                                    c.index = u, u === d.length && (c.isComplete = !0)
                                }
                            }
                ...
                function Tn() {
                    ...
                    return jt.action.on("symbol:playAnimation", (o => {
                        var {
                            x: n,
                            y: a
                        } = o, h = (0, Pn.Z)(o, En);
                        if (function(t, i) {
                            ...
                            if (h.assetName) {
                                var r = t.children.find((t => t.x === n && t.y === a));
                                if (r)
                                    if ("string" == typeof h.effectName) r.play(h.effectName);
                                    else {
                                        var l = h.effectName[h.type] || h.effectName.normal;
                                        r.play(l, !1)
                                    }
                            }
                        } else {
                            ...
                            var c = i.sort(s).indexOf(h.pos);
                            if (h.assetName) {
                                var d = new ms(jt.loader.getAsset(h.assetName));
                                if (d.name = h.assetName, d.alpha = 1, d.position.set(n, a), h.skin && d.changeSkin(h.skin), t.addChildAt(d, c), "string" == typeof h.effectName) d.play(h.effectName);
                                else {
                                    var u = h.effectName[h.type] || h.effectName.normal;
                                    d.play(u, !1).then((() => {
                                        "scale" !== h.type && "scaleLeft" !== h.type || (k.fromTo(d, .5, {
                                            pixi: {
                                                x: d.x
                                            }
                                        }, {
                                            pixi: {
                                                x: "scale" === h.type ? d.x - d.x - 100 : d.x + (1080 - d.x) + 100
                                            }
                                        }), setTimeout((() => {
                                            k.fromTo(d, .3, {
                                                pixi: {
                                ...
                                var p = new $.j(h.texture);
                                p.alpha = 1, p.position.set(n, a), t.addChildAt(p, c)
                            }
                        }
                    })), jt.action.on("symbol:stopAnimation", (() => {
                        e.length = 0, i.length = 0, t.removeChildren()
                    })), t
                }
                class Fn extends(zt($.j)) {
                    constructor() {
                        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : -1;
                ...
                class Rn extends Fn {
                    constructor(t, e, i) {
                        super(i), (0, n.Z)(this, "data", void 0), (0, n.Z)(this, "isPlaying", void 0), (0, n.Z)(this, "layoutType", void 0), (0, n.Z)(this, "timeoutId", void 0), this.position.set(t, e), this.timeoutId = null, this.isPlaying = !1, this.layoutType = "default", this.replaceTexture(i)
                    }
                    replaceTexture(t) {
                        this.currentTextureIndex = t, this.data = this.game.config.get("slot.layout.".concat(this.layoutType, "[").concat(t, "]"), null), this.texture = this.game.loader.getAsset(this.data.textureAtlas, this.data.assetName), this.visible = !0
                    }
                    playAnimation(t, e, i) {
                        var s = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 0;
                        this.renderable && (this.timeoutId = setTimeout((() => {
                            this.isPlaying = !0, this.hide(), this.visible = "scale" !== t && "scaleLeft" !== t, this.game.action.emit("symbol:playAnimation", Zn(Zn({}, this.data.animation), {}, {
                                x: this.x,
                                y: this.y,
                    ...
                    stopAnimation() {
                        this.timeoutId && clearTimeout(this.timeoutId), this.isPlaying = !1, this.show(), this.game.action.emit("symbol:stopAnimation", this.data.animation)
                    }
                    showProgressSymbol() {
                        this.visible = !0
                    }
                ...
                class Mn extends Q.W2 {
                    ...
                    start() {
                        ...
                        this._endTween.duration(t), this._stopTimeoutDuration = jt.quickSpin.enabled ? jt.config.get("wheel.durationQuickStop") : jt.config.get("wheel.durationStop"), this.children[0].alpha = 1, this.children[this.children.length - 1].alpha = 1, this._startTween.restart()
                    }
                    stop() {
                        if (!this.isStop) {
                            ...
                            this._reel = e[this._reelIndex].concat(), jt.store.get("spin:isFast", !1) ? (jt.action.emit("sound:spinFast"), clearTimeout(this._stopTimeout), this.isStop = !0) : this._stopTimeout = setTimeout((() => {
                                this.isStop = !0
                    ...
                    _setup() {
                        var t = jt.store.get("reward:nReels", []);
                        this._nReel = t[this._reelIndex].concat();
                        var e, i = jt.store.get("reward:reels", []);
                    ...
                    _spin() {
                        if (this._flip(), this.isStop)
                            ...
                            } else this.y = 0, this.children[0].y = this._startY, this._updateVisibleSymbols(), this.visible && jt.action.emit("wheel:stop_down", this._reelIndex), this._spinTween.pause(), this._endTween.restart(), this.children[this.children.length - 1].alpha = 0
                    }
                    _flip() {
                        var t = this.children.pop();
                        t.y = this._startY, !this.isStop && this._nReel.length > 0 && t.showProgressSymbol();
                        for (var e = 0, i = this.children.length; e < i; e++) this.children[e].y = e * -this._startY;
                        this.children.unshift(t)
                    }
                    _complete() {
                        this.children[0].alpha = 0, this.y = 0, this._reel.length = 0, this._endTween.pause(), clearTimeout(this._stopTimeout), jt.action.emit("wheel:stop", this._reelIndex)
                    }
                    _restoreWheelAfterFree() {
                        for (var t = jt.store.get("reward:preReels")[this._reelIndex], e = this.visibleSymbols.length, i = 0; i < e; i++) this.visibleSymbols[i].replaceTexture(t[i])
                    }
                    update(t) {
                    ...
                    hideProgressSymbols() {
                        this.children.forEach((t => {
                            "scat" !== t.data.assetName && "coin" !== t.data.assetName || (t.visible = !1)
                        }))
                    }
                }
                class In extends yn {
                    constructor() {
                        super(), (0, n.Z)(this, "animation", void 0), (0, n.Z)(this, "animationContainer", void 0), (0, n.Z)(this, "lines", void 0), (0, n.Z)(this, "reels", void 0), (0, n.Z)(this, "reelsContainer", void 0), (0, n.Z)(this, "slotData", void 0), (0, n.Z)(this, "staticAnimation", void 0), (0, n.Z)(this, "stopReelCounter", void 0), (0, n.Z)(this, "symbolsPositions", void 0), (0, n.Z)(this, "textExtraFree", void 0), (0, n.Z)(this, "textFreeLeft", void 0), (0, n.Z)(this, "textLineWin", void 0), (0, n.Z)(this, "textTotalWin", void 0), this.pivot.set(640, 0), this.reels = [], this.symbolsPositions = this.game.config.get("slot.symbolsPositions", []), this.animation = new Cn(this), this.stopReelCounter = 0, this.init(), this.setupEvents()
                    }
                    createGradientMask(t, e) {
                        var i = document.createElement("canvas"),
                            s = i.getContext("2d"),
                            o = s.createLinearGradient(0, 0, 0, e);
                        return i.width = t, i.height = e, o.addColorStop(0, "rgba(255, 255, 255, 0.0)"), o.addColorStop(.05, "rgba(255, 255, 255, 1.0)"), o.addColorStop(.95, "rgba(255, 255, 255, 1.0)"), o.addColorStop(1, "rgba(255, 255, 255, 0.0)"), s.fillStyle = o, s.fillRect(0, 0, t, e), new c.xE(c.VL.from(i))
                    }
                    createMask(t, e) {
                        if (this.game.device.desktop && it.isWebGLSupported()) {
                            var i = this.createGradientMask(t, e);
                            return new $.j(i)
                        }
                        var s = new u.TC;
                        return s.beginFill(), s.drawRect(0, 0, t, e), s.endFill(), s
                    }
                    init() {
                        var t, e, i = this.createMask(this.game.config.get("slot.width"), this.game.config.get("slot.height"));
                        ...
                        this.slotData = {
                        ...
                        }, this.lines = new fn(this.slotData.lines.map((t => ({
                            color: 16777215,
                            width: 2,
                            padding: 125,
                            points: t.map(((t, e) => {
                        ...
                        })))), this.textFreeLeft = new xn, this.textFreeLeft.container.position.set(690, 370), this.textExtraFree = new An, this.textExtraFree.position.set(450, 580), this.textExtraFree.description.position.set(200, 120), this.textExtraFree.value.position.set(this.textExtraFree.description.width / 2 + this.textExtraFree.description.x, 0), this.textTotalWin = new Sn(1, "1.4"), this.textTotalWin.position.set(640, 580), this.textLineWin = new wn, this.textLineWin.scale.set(.3), this.animationContainer = Tn(), this.staticAnimation = ((s = new Bn).name = "animationStatic", {
                            container: s,
                            onStop: (t, e) => (0, o.Z)((function*() {
                                var i = jt.config.get("slot.layout.default");
                                t.visibleSymbols.forEach((t => {
                                    if (t.renderable) {
                                        var o = t._texture.textureCacheIds[0],
                                            n = i.find((t => t.assetName === o));
                                        if (n) {
                                            var a = new ms(jt.loader.getAsset(n.animation.assetName));
                                            a.changeSkin(o), a.position.set(t.x, t.y), a.reelIndex = e, s.addChild(a), t.renderable = !1, a.play("spin").then((() => {
                                                jt.autoPlay.enabled || zi.isFreespin() || a.play("idle", !0)
                                            }))
                                        }
                                    }
                                }))
                            ...
                            runStatic(t) {
                                var e = jt.config.get("slot.layout.default");
                                s.children.length < 1 && t.forEach((t => {
                                    t.visibleSymbols.forEach((t => {
                                        ...
                                        if (o && t.visible) {
                                            t.renderable = !1;
                                            var n = new ms(jt.loader.getAsset(o.animation.assetName));
                            ...
                            hide(t) {
                                t.forEach((t => {
                                    t.visibleSymbols.forEach((t => {
                                        t.renderable = !0, s.removeChildren()
                                    }))
                                }))
                            }
                        }), this.addChild(this.reelsContainer), this.addChild(this.lines), this.addChild(this.animationContainer), this.addChild(this.staticAnimation.container), this.addChild(this.textLineWin), this.addChild(this.textTotalWin), this.addChild(this.textFreeLeft.container), this.addChild(this.textExtraFree)
                    }
                    setupEvents() {
                        this.game.action.on("state:ready_enter", this._onReadyEnter, this), this.game.action.on("state:spin_enter", this._onSpinEnter, this), this.game.action.on("state:stop_enter", this._onStopEnter, this), this.game.action.on("free:select_start", (() => {
                            ...
                            k.fromTo(this, .5, {
                                ...
                                t.hideProgressSymbols()
                            })), this.staticAnimation.hide(this.reels), this.staticAnimation.runStatic(this.reels)
                        })), this.game.action.on("free:start", (() => {
                        ...
                        })), this.game.action.on("state:finish_enter", this._onFinishEnter, this), this.game.action.on("wheel:stop", this._onStopWheel, this), this.game.action.on("wheel:stop_down", this._onStopWheelDown, this), this.game.action.on("reward:reset", this._onResetReward, this)
                    }
                    restoreFreeSpins() {
                        this.alpha = 0
                    }
                    ...
                    _onReadyEnter() {
                        ...
                        return (0, o.Z)((function*() {
                            ...
                            if (zi.isFreespin()) {
                                var i = t.game.store.get("free:isStart", !1) ? Ni.get("beforeFreeSpins") : Ni.get("inFreeSpins");
                                setTimeout((() => {
                    ...
                    _onSpinEnter() {
                        var t = this;
                        return (0, o.Z)((function*() {
                            t.animation.stop(), t.lines.disable(), t.staticAnimation.hide(t.reels);
                            try {
                                yield t.game.beforeSpin(), t.reels.forEach((t => t.start())), yield t.updateFreeLeft(), yield t.requestSpin(), t.game.get(To).updatePotential(), t.game.state.goTo("stop")
                            } catch (e) {
                    ...
                    _onStopWheel(t) {
                        ...
                        return (0, o.Z)((function*() {
                            try {
                                ...
                                e.staticAnimation.onStop(e.reels[t], t), e.stopReelCounter++, e.stopReelCounter >= e.reels.length && (e.game.afterReelsStop(), e.game.state.goTo("reward"))
                            } catch (t) {
                    ...
                    _onStopWheelDown() {
                        this.game.action.emit("sound:wheel_stop_down")
                    }
                    _onResetReward() {
                        var t = this;
                        return (0, o.Z)((function*() {
                            t.animation.stop(), t.lines.enable(), t.staticAnimation.runStatic(t.reels)
                        }))()
                    }
                    beforeFreeSpinsPopup() {
                        k.fromTo(this, .5, {
                    ...
                    resize() {
                        this.game.device.desktop || this.game.device.landscape ? (this.scale.set(this.game.device.desktop ? .9 : .85), this.position.set(this.game.device.desktop ? 940 : this.game.leftHand.enabled ? 870 : 980, this.game.device.desktop ? 40 : 80)) : (this.scale.set(.65), this.position.set(600, 485))
                    }
                }
                class Wn extends(zt(Q.W2)) {
                    constructor() {
                        super(), (0, n.Z)(this, "onPress", void 0), (0, n.Z)(this, "content", void 0), (0, n.Z)(this, "overlay", void 0), (0, n.Z)(this, "title", void 0), (0, n.Z)(this, "value", void 0), (0, n.Z)(this, "timeline", void 0), (0, n.Z)(this, "light", void 0), (0, n.Z)(this, "coins", void 0), this.visible = !1, this.interactive = !0, this.onPress = new(S()), this.game.interaction.click(this, (() => this.onPress.dispatch())), this.timeline = new C, this.content = new Q.W2, this.overlay = new Jt(.75), this.title = new $.j, this.title.anchor.set(.5), this.value = new v.Xz("", {
                            fontName: "WinFont"
                        }), this.value.anchor = .5, this.light = new ms(this.game.loader.getAsset("assets/images/effects/big-win/skeleton.json")), this.light.alpha = 0, this.coins = new ms(this.game.loader.getAsset("assets/images/effects/giant-win/skeleton.json")), this.coins.alpha = 0, this.content.addChild(this.title), this.content.addChild(this.value), this.addChild(this.overlay), this.addChild(this.light), this.addChild(this.coins), this.addChild(this.content)
                    }
                    show(t, e) {
                        var i = this;
                        return (0, o.Z)((function*() {
                            ...
                            return i.value.scale.set(n), new Promise((a => {
                                ...
                                i.timeline.to(i, .35, {
                                    ...
                                    onUpdate: () => {
                                        !o && t === ye && h.coins > e / 2 && (i.title.texture = i.game.loader.getAsset("textGiantWin"), o = !0, i.coins.play("win", !0), i.coins.alpha = 1, k.to(i.value, s / 2, {
                                            pixi: {
                                                scale: n + .1
                                            }
                                        })), i.value.text = "".concat(i.game.i18n.currency.custom, "<value>").concat(i.game.helpers.toMoney(h.coins), "</value>")
                                    }
                    ...
                    resize() {
                        this.game.device.desktop || this.game.device.landscape ? (this.content.position.set(this.game.viewport.width / 2, 480), this.light.pivot.set(0, 0), this.coins.pivot.set(0, 0), this.title.scale.set(1), this.value.position.set(0, this.title.height - 20)) : (this.content.position.set(this.game.viewport.width / 2, this.game.viewport.height / 2), this.light.pivot.set(420, -500), this.coins.pivot.set(420, -500), this.title.scale.set(1), this.value.position.set(0, this.title.height))
                    }
                }
                new class extends class extends class extends class {
                    constructor(t) {
                        ...
                        })), jt = this, et.vB.shared.autoStart = !1, et.vB.shared.stop(), this.config = new ht(It), this.logger = new Ct, this.rootNode = this.createRootNode(), this.renderer = new Bt, this.i18n = new bt(e), this.helpers = new vt(this.config), this.keyboard = new yt, this.device = new mt(this.renderer), this.viewport = new Zt, this.leftHand = new ut, this.fullscreen = this.device.ios || this.device.iPadPro ? new ct : new dt(this.device), this.visibility = new Vt, this.preferences = new Ut, this.sound = new Z(this.device, this.visibility, this.preferences), this.state = new Ot, this.store = new ht, this.action = new gt, this.loader = new kt(this.device), this.error = new At, this.interaction = new ft(this.device), this.externalApi = new Mt(this), this.popupManager = new Lt(this.rootNode), this.create(), this.initAnalytics()
                    }
                    initAnalytics() {
                        return (0, o.Z)((function*() {
                            try {
                    ...
                    initPopups() {
                        this.popupManager.add([new Ti, new Bi, new Pi, new xi, new Ri, new Ci, new Fi, new Oi, new Ei, new ki, new Zi])
                    }
                    loadAssets(t) {
                        ...
                        return (0, o.Z)((function*() {
                            ...
                            if ("en" !== e.i18n.language) {
                                ...
                                try {
                                    ...
                                    e.i18n.setTranslations(Ii(Ii(Ii({}, i), n), o))
                                } catch (t) {
                    ...
                    initModules(t) {
                        ...
                        this.wallet = new Je(this.server), this.betLevel = new Wt(null == o ? void 0 : o.bet, null == o ? void 0 : o.bets, null !== (e = null == o ? void 0 : o.betCoins) && void 0 !== e ? e : 1), this.autoPlay = new Qe({
                    ...
                    constructor() {
                        super({}), (0, n.Z)(this, "autoPlaySettings", void 0), (0, n.Z)(this, "background", void 0), (0, n.Z)(this, "betSettings", void 0), (0, n.Z)(this, "bigWinAnimation", void 0), (0, n.Z)(this, "fastStopLayout", void 0), (0, n.Z)(this, "featureProgress", void 0), (0, n.Z)(this, "freeOverlay", void 0), (0, n.Z)(this, "gameRules", void 0), (0, n.Z)(this, "introScreen", void 0), (0, n.Z)(this, "menu", void 0), (0, n.Z)(this, "paytable", void 0), (0, n.Z)(this, "slot", void 0), Xi.init(), this.init(Li, ji)
                    }
                    loadTranslations() {
                    ...
                    showIntroScreen() {
                        ...
                        return (0, o.Z)((function*() {
                            var e;
                            if (t.background = t.rootNode.addChild(new As), null === (e = t.sound.get("backgroundNormal")) || void 0 === e || e.fade(2), t.preferences.get("showIntroScreen", !0) && "freespin" !== t.server.response.feature) return t.introScreen = t.rootNode.addChild(new ko), t.introScreen.play()
                        }))()
                    }
                    initModules(t) {
                    ...
                    initViews() {
                        var t, e, i = this;
                        super.initViews(), this.background.gameStart(), this.slot = this.rootNode.addChild(new In), this.featureProgress = this.rootNode.addChild(new Fo), this.featureProgress.update("init"), this.riskFeature = this.rootNode.addChild(new mn), this.paytable = new Yo(null !== (t = null === (e = this.server) || void 0 === e ? void 0 : e.response.lines) && void 0 !== t ? t : []), this.gameSettings = new Ue, this.config.get("quickSpin.available", !0) && this.gameSettings.addItem(this.createQuickSpinCheckbox()), this.gameSettings.addItem(this.createFullscreenCheckbox()), this.gameSettings.addItem(this.createLeftHandCheckbox()), this.gameSettings.addItem(this.createGameSoundsCheckbox()), this.gameSettings.addItem(this.createBackgroundSoundsCheckbox()), this.gameSettings.addItem(this.createIntroScreenCheckbox()), this.gameSettings.addItem(this.createRiskFeatureCheckbox()), this.bigWinAnimation = new Wn, this.fastStopLayout = new Te, this.controls = this.device.desktop ? new to : new co, this.betSettings = this.rootNode.addChild(new Ee), this.betSettings.setBets(this.betLevel.bets, this.betLevel.betCoins), this.betSettings.setPayLines(20), this.betSettings.setBet(this.betLevel.bet), this.autoPlaySettings = this.rootNode.addChild(new ce), this.autoPlaySettings.setAutoPlayCounts(this.autoPlay.counts), this.autoPlaySettings.stopSection.addItem(new xe), this.autoPlaySettings.stopSection.addItem(new be), this.autoPlaySettings.stopSection.addItem(new Ae), this.autoPlaySettings.stopSection.addItem(new ve), this.gameRules = new Ne, this.menu = new Ge, this.menu.addItem(this.loader.getAsset("iconPaytable"), this.paytable), this.menu.addItem(this.loader.getAsset("iconSettings"), this.gameSettings), this.menu.addItem(this.loader.getAsset("iconRules"), this.gameRules), this.rootNode.addChild(this.fastStopLayout), this.rootNode.addChild(this.menu), this.rootNode.addChild(this.controls), this.rootNode.addChild(this.bigWinAnimation), this.freeOverlay = this.rootNode.addChild(new Oo), this.paytable.updateBet(this.betLevel), this.controls.updateBet(this.betLevel), this.betSettings.on("open", (() => {
                            ...
                            this.featureProgress.update("changeBet"), this.paytable.updateBet(this.betLevel), this.controls.updateBet(this.betLevel), this.betSettings.setBet(this.betLevel.bet)
                            ...
                            this.menu.close(), this.betSettings.close(), this.autoPlaySettings.close(), this.state.oneOf(["ready", "spin", "stop"]) && (this.store.get("spin:isSpin", !1) ? (this.fastStopLayout.disable(), this.action.emit("spin:start")) : this.checkBalance().then((() => {
                                this.autoPlay.enabled || (this.state.is("ready") && !this.config.get("quickSpin.available", !0) && this.controls.buttonSpin.disable(), zi.isFreespin() || this.action.emit("sound:click"), this.action.emit("spin:start"))
                            })))
                            ...
                            if (i.action.emit("sound:click"), i.onPopupShow(), i.riskFeature.hide(), i.wallet.balance - i.store.get("buy").bet < 0) yield i.popupManager.show("PopupZeroBalance"), i.onPopupHide();
                                ...
                                try {
                                    if (s) {
                                        ...
                                        }), zi.set(i.store.get("reward:feature", Vi.Basic)), i.onRNBStart();
                                        var o = i.store.get("free:left", 0);
                                        i.action.emit("free:updateLeft", o), i.beforeFreeSpinsPopup(), i.featureProgress.hide(), yield i.freeOverlay.show(Bo.START), setTimeout((() => {
                    ...
                    start() {
                        var t = () => super.start,
                            e = this;
                        return (0, o.Z)((function*() {
                            if (t().call(e), zi.set(e.store.get("reward:feature", Vi.Basic)), yield e.freeRound.start(), e.state.goTo("setup"), zi.isFreespin()) {
                                e.slot.restoreFreeSpins(), e.featureProgress.hide("init");
                                var i = e.store.get("free:played", 0) + 1;
                                e.action.emit("free:updateLeft", i), yield e.freeOverlay.show(Bo.RESTORE)
                    ...
                    reward() {
                        ...
                        return (0, o.Z)((function*() {
                            ...
                            if (n.length > 0 && (t.controls.disableButtonSpin(), t.slot.textTotalWin.once("show", (() => {
                                    t.fastStopLayout.press(s, !1), t.controls.pressButtonSpin(s)
                                })), yield t.slot.animation.allPayment(n), e()), zi.isFreespin() || (yield t.slot.animation.scalePayment(), yield t.featureProgress.update(), yield t.featureProgress.showText()), a && t.store.get("free:isFree", !1) && (t.controls.disableButtonSpin(), yield t.slot.animation.scatterPayment(a)), t.store.get("free:isStart", !1)) {
                                var h = t.store.get("free:left", 0);
                                t.action.emit("free:updateLeft", h), t.beforeFreeSpinsPopup(), t.featureProgress.hide(), yield t.freeOverlay.show(Bo.START)
                            } else t.store.get("free:isEnd", !1) && (t.featureProgress.update("afterFs"), yield t.delay(Ni.get("afterFreeSpins")), t.beforeFreeSpinsPopup(), yield t.freeOverlay.show(Bo.END, t.wallet.freespinCoins), yield t.delay(200), t.featureProgress.show());
                            t.slot.animation.complete(), t.action.emit("update:balance", t.wallet.balance), t.state.goTo("finish")
                        }))
                    }
                    checkBalance() {
                        var t = this;
                        return (0, o.Z)((function*() {
                            if (!t.freeRound.enabled && !t.store.get("free:isFree", !1) && t.wallet.balance < t.betLevel.toCoins()) {
                                try {
                                    yield t.server.request({
                                        action: "balance"
                                    }), t.action.emit("update:balance", t.wallet.balance)
                                } catch (e) {
    ...
    n.m = s, t = [], n.O = (e, i, s, o) => {
    ...
    }), t), n.o = (t, e) => Object.prototype.hasOwnProperty.call(t, e), e = {}, i = "across_the_universe:", n.l = (t, s, o, a) => {
        if (e[t]) e[t].push(s);
        else {
            var h, r;
            if (void 0 !== o)
        ...
        var e = (e, i) => {
            ...
            i = self.webpackChunkacross_the_universe = self.webpackChunkacross_the_universe || [];
        i.forEach(e.bind(null, 0)), i.push = e.bind(null, i.push.bind(i))
    })();
    var a = n.O(void 0, [216], (() => n(1982)));
    a = n.O(a)
})();